...
public partial record AdditionalRightThresholdPercentage : AdditionalRightThreshold1Choice_
     , IIsoXmlSerilizable<AdditionalRightThresholdPercentage>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "AddtlRghtThrshldPctg", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoPercentageRate(Value)); // data type PercentageRate System.Decimal
        writer.WriteEndElement();
    }
    public static new AdditionalRightThresholdPercentage Deserialize(XElement element)
    {
