...
public partial record AmountWithCurrency : Amount3Choice_
     , IIsoXmlSerilizable<AmountWithCurrency>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "AmtWthCcy", xmlNamespace );
    ...
    public static new AmountWithCurrency Deserialize(XElement element)
    {
