...
public partial record Distillates : AssetClassCommodityEnergy3Choice_
     , IIsoXmlSerilizable<Distillates>
{
    #nullable enable
    ...
    public override void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubProduct is AssetClassSubProductType25Code SubProductValue)
        {
    ...
    public static new Distillates Deserialize(XElement element)
    {
