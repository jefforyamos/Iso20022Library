...
public partial record OtherRulesAndVersion : BPOApplicableRules1Choice_
     , IIsoXmlSerilizable<OtherRulesAndVersion>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "OthrRulesAndVrsn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax35Text(Value)); // data type Max35Text System.String
        writer.WriteEndElement();
    }
    public static new OtherRulesAndVersion Deserialize(XElement element)
    {
