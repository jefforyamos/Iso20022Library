...
public partial record HoldingsIndicator : FinancialInstrumentAggregateBalance1Choice_
     , IIsoXmlSerilizable<HoldingsIndicator>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "HldgsInd", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoYesNoIndicator(Value)); // data type YesNoIndicator System.String
        writer.WriteEndElement();
    }
    public static new HoldingsIndicator Deserialize(XElement element)
    {
