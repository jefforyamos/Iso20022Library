...
public partial record ComplianceIdentification : IdentificationReference8Choice_
     , IIsoXmlSerilizable<ComplianceIdentification>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "CmplcId", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax35Text(Value)); // data type Max35Text System.String
        writer.WriteEndElement();
    }
    public static new ComplianceIdentification Deserialize(XElement element)
    {
