...
public partial record DirectDebitDetails : IPaymentInstrument18Choice
{
    ...
    /// </summary>
    public IPartyIdentification70Choice? Debtor { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPartyIdentification70Choice? Creditor { get; init; } 
    /// <summary>
    /// Financial institution that receives the direct debit instruction from the creditor or other authorised party.
    /// </summary>
    public required IFinancialInstitutionIdentification7Choice DebtorAgent { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IFinancialInstitutionIdentification7Choice? CreditorAgent { get; init; } 
    /// <summary>
    /// Information identifying a specific branch of a financial institution.||Usage: this component should be used in case the identification information in the financial institution component does not provide identification up to branch level.
    /// </summary>
