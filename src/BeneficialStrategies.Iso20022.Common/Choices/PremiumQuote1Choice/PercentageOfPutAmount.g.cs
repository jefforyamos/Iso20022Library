...
public partial record PercentageOfPutAmount : PremiumQuote1Choice_
     , IIsoXmlSerilizable<PercentageOfPutAmount>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "PctgOfPutAmt", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoPercentageRate(Value)); // data type PercentageRate System.Decimal
        writer.WriteEndElement();
    }
    public static new PercentageOfPutAmount Deserialize(XElement element)
    {
