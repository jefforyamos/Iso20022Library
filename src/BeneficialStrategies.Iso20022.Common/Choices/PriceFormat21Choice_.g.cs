...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(PriceFormat21Choice.PercentagePrice),"PriceFormat21Choice.PercentagePrice")]
    [JsonDerivedType(typeof(PriceFormat21Choice.AmountPrice),"PriceFormat21Choice.AmountPrice")]
    [JsonDerivedType(typeof(PriceFormat21Choice.NotSpecifiedPrice),"PriceFormat21Choice.NotSpecifiedPrice")]
    [JsonDerivedType(typeof(PriceFormat21Choice.AmountPricePerFinancialInstrumentQuantity),"PriceFormat21Choice.AmountPricePerFinancialInstrumentQuantity")]
    [JsonDerivedType(typeof(PriceFormat21Choice.AmountPricePerAmount),"PriceFormat21Choice.AmountPricePerAmount")]
    #endif
