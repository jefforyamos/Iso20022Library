...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(PriceFormat53Choice.PercentagePrice),"PriceFormat53Choice.PercentagePrice")]
    [JsonDerivedType(typeof(PriceFormat53Choice.AmountPrice),"PriceFormat53Choice.AmountPrice")]
    [JsonDerivedType(typeof(PriceFormat53Choice.NotSpecifiedPrice),"PriceFormat53Choice.NotSpecifiedPrice")]
    [JsonDerivedType(typeof(PriceFormat53Choice.AmountPricePerFinancialInstrumentQuantity),"PriceFormat53Choice.AmountPricePerFinancialInstrumentQuantity")]
    [JsonDerivedType(typeof(PriceFormat53Choice.AmountPricePerAmount),"PriceFormat53Choice.AmountPricePerAmount")]
    [JsonDerivedType(typeof(PriceFormat53Choice.IndexPoints),"PriceFormat53Choice.IndexPoints")]
    #endif
