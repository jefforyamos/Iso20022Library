...
namespace BeneficialStrategies.Iso20022.Choices
{
    ...
    [JsonDerivedType(typeof(RatioFormat4Choice.QuantityToQuantity),"RatioFormat4Choice.QuantityToQuantity")]
    [JsonDerivedType(typeof(RatioFormat4Choice.AmountToAmount),"RatioFormat4Choice.AmountToAmount")]
    [JsonDerivedType(typeof(RatioFormat4Choice.AmountToQuantity),"RatioFormat4Choice.AmountToQuantity")]
    [JsonDerivedType(typeof(RatioFormat4Choice.QuantityToAmount),"RatioFormat4Choice.QuantityToAmount")]
    #endif
