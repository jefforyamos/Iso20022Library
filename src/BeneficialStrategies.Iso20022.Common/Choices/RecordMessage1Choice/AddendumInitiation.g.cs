...
public partial record AddendumInitiation : RecordMessage1Choice_
     , IIsoXmlSerilizable<AddendumInitiation>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "AdddmInitn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new AddendumInitiation Deserialize(XElement element)
    {
