...
public partial record AddendumResponse : RecordMessage1Choice_
     , IIsoXmlSerilizable<AddendumResponse>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "AdddmRspn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new AddendumResponse Deserialize(XElement element)
    {
