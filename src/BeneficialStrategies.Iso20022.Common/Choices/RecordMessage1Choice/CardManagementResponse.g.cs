...
public partial record CardManagementResponse : RecordMessage1Choice_
     , IIsoXmlSerilizable<CardManagementResponse>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "CardMgmtRspn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new CardManagementResponse Deserialize(XElement element)
    {
