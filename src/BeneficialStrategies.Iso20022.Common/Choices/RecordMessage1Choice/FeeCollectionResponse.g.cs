...
public partial record FeeCollectionResponse : RecordMessage1Choice_
     , IIsoXmlSerilizable<FeeCollectionResponse>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "FeeColltnRspn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new FeeCollectionResponse Deserialize(XElement element)
    {
