...
public partial record RetrievalFulfilmentInitiation : RecordMessage1Choice_
     , IIsoXmlSerilizable<RetrievalFulfilmentInitiation>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "RtrvlFlfmtInitn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new RetrievalFulfilmentInitiation Deserialize(XElement element)
    {
