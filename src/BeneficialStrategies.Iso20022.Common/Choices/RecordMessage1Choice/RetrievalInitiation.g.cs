...
public partial record RetrievalInitiation : RecordMessage1Choice_
     , IIsoXmlSerilizable<RetrievalInitiation>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "RtrvlInitn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new RetrievalInitiation Deserialize(XElement element)
    {
