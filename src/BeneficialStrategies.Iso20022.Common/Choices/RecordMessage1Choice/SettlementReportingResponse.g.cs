...
public partial record SettlementReportingResponse : RecordMessage1Choice_
     , IIsoXmlSerilizable<SettlementReportingResponse>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "SttlmRptgRspn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new SettlementReportingResponse Deserialize(XElement element)
    {
