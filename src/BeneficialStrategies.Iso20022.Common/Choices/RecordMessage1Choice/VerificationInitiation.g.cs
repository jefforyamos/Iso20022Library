...
public partial record VerificationInitiation : RecordMessage1Choice_
     , IIsoXmlSerilizable<VerificationInitiation>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "VrfctnInitn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new VerificationInitiation Deserialize(XElement element)
    {
