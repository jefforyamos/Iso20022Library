...
public partial record VerificationResponse : RecordMessage1Choice_
     , IIsoXmlSerilizable<VerificationResponse>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "VrfctnRspn", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax2MBBinary(Value)); // data type Max2MBBinary System.Byte[]
        writer.WriteEndElement();
    }
    public static new VerificationResponse Deserialize(XElement element)
    {
