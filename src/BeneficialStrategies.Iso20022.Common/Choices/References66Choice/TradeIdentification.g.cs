...
//
// Generated by ConcreteChoiceGenerator for TradeIdentification.  ISO2002 ID# _MMl9B_yjEeiM0vtizCHcoA.
//
     ...
     , IIsoXmlSerilizable<TradeIdentification>
{
    ...
    public override void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoRestrictedFINXMax52Text(Value)); // data type RestrictedFINXMax52Text System.String
