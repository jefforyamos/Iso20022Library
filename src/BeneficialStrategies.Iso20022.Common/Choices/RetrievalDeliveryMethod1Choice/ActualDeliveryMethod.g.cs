...
public partial record ActualDeliveryMethod : RetrievalDeliveryMethod1Choice_
     , IIsoXmlSerilizable<ActualDeliveryMethod>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "ActlDlvryMtd", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax35Text(Value)); // data type Max35Text System.String
        writer.WriteEndElement();
    }
    public static new ActualDeliveryMethod Deserialize(XElement element)
    {
