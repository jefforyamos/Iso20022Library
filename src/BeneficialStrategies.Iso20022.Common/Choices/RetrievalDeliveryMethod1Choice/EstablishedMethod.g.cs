...
public partial record EstablishedMethod : RetrievalDeliveryMethod1Choice_
     , IIsoXmlSerilizable<EstablishedMethod>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "EstblishdMtd", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoMax35Text(Value)); // data type Max35Text System.String
        writer.WriteEndElement();
    }
    public static new EstablishedMethod Deserialize(XElement element)
    {
