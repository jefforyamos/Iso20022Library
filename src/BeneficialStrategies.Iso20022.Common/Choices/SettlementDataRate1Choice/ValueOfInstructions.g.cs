...
public partial record ValueOfInstructions : SettlementDataRate1Choice_
     , IIsoXmlSerilizable<ValueOfInstructions>
{
    #nullable enable
    ...
    {
        writer.WriteStartElement(null, "ValOfInstrs", xmlNamespace );
        writer.WriteValue(SerializationFormatter.IsoPercentageRate(Value)); // data type PercentageRate System.Decimal
        writer.WriteEndElement();
    }
    public static new ValueOfInstructions Deserialize(XElement element)
    {
