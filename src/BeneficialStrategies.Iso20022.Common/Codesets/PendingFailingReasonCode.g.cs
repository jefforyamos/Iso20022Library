...
[Derivations(typeof(PendingProcessingReason3Code),typeof(FailingReason1Code),typeof(PendingReason19Code),typeof(FailingReason2Code),typeof(PendingReason3Code),typeof(PendingReason4Code),typeof(PendingReason21Code),typeof(PendingReason7Code),typeof(PendingReason5Code),typeof(PendingReason1Code),typeof(PendingReason11Code),typeof(PendingReason9Code),typeof(PendingProcessingReason2Code),typeof(PendingProcessingReason1Code),typeof(FailingReason3Code),typeof(PendingReason8Code),typeof(PendingCancellationReason2Code),typeof(PendingReason13Code),typeof(PendingReason2Code),typeof(PendingCancellationReason1Code),typeof(PendingReason10Code),typeof(PendingCancellationReason7Code),typeof(PendingReason17Code),typeof(PendingReason6Code),typeof(PendingProcessingReason4Code))]
