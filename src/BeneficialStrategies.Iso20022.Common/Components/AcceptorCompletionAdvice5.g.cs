...
public partial record AcceptorCompletionAdvice5
     : IIsoXmlSerilizable<AcceptorCompletionAdvice5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Context is CardPaymentContext15 ContextValue)
        {
    ...
    public static AcceptorCompletionAdvice5 Deserialize(XElement element)
    {
