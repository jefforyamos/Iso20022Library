...
public partial record AcceptorCompletionAdvice6
     : IIsoXmlSerilizable<AcceptorCompletionAdvice6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Context is CardPaymentContext21 ContextValue)
        {
    ...
    public static AcceptorCompletionAdvice6 Deserialize(XElement element)
    {
