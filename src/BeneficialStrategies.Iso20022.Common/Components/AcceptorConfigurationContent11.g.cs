...
public partial record AcceptorConfigurationContent11
     : IIsoXmlSerilizable<AcceptorConfigurationContent11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TMSProtocolParameters is TMSProtocolParameters6 TMSProtocolParametersValue)
        {
            writer.WriteStartElement(null, "TMSPrtcolParams", xmlNamespace );
            TMSProtocolParametersValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (AcquirerProtocolParameters is AcquirerProtocolParameters15 AcquirerProtocolParametersValue)
        {
        ...
        if (ServiceProviderParameters is ServiceProviderParameters2 ServiceProviderParametersValue)
        {
        ...
        if (ApplicationParameters is ApplicationParameters11 ApplicationParametersValue)
        {
    ...
    public static AcceptorConfigurationContent11 Deserialize(XElement element)
    {
