...
public partial record AcceptorConfigurationContent5
     : IIsoXmlSerilizable<AcceptorConfigurationContent5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AcquirerProtocolParameters is AcquirerProtocolParameters9 AcquirerProtocolParametersValue)
        {
        ...
        if (MerchantParameters is MerchantConfigurationParameters2 MerchantParametersValue)
        {
            writer.WriteStartElement(null, "MrchntParams", xmlNamespace );
            MerchantParametersValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TerminalParameters is PaymentTerminalParameters3 TerminalParametersValue)
        {
            writer.WriteStartElement(null, "TermnlParams", xmlNamespace );
            TerminalParametersValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ApplicationParameters is ApplicationParameters5 ApplicationParametersValue)
        {
    ...
    public static AcceptorConfigurationContent5 Deserialize(XElement element)
    {
