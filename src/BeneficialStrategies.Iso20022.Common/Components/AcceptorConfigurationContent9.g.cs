...
public partial record AcceptorConfigurationContent9
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<AcquirerProtocolParameters13> AcquirerProtocolParameters { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Acceptor parameters dedicated to the merchant.
    /// </summary>
    [DataMember]
    public ValueList<MerchantConfigurationParameters5> MerchantParameters { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Manufacturer configuration parameters of the point of interaction.
    /// </summary>
    [DataMember]
    public ValueList<PaymentTerminalParameters7> TerminalParameters { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Acceptor parameters dedicated to a payment application of the point of interaction.
    /// </summary>
    [DataMember]
    public ValueList<ApplicationParameters9> ApplicationParameters { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecurityParameters12> SecurityParameters { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<TerminalPackageType1> TerminalPackage { get; init; } = []; // Warning: Don't know multiplicity.
