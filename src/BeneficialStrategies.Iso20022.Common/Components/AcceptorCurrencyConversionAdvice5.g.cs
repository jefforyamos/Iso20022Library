...
public partial record AcceptorCurrencyConversionAdvice5
     : IIsoXmlSerilizable<AcceptorCurrencyConversionAdvice5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CurrencyConversionResult is CurrencyConversion21 CurrencyConversionResultValue)
        {
    ...
    public static AcceptorCurrencyConversionAdvice5 Deserialize(XElement element)
    {
