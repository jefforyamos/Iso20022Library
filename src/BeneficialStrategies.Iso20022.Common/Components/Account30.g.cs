     ...
     : IIsoXmlSerilizable<Account30>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AccountServicer is PartyIdentification137Choice_ AccountServicerValue)
        {
    ...
    public static Account30 Deserialize(XElement element)
    {
