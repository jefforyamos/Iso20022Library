...
public partial record AccountAndBalance15
     : IIsoXmlSerilizable<AccountAndBalance15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Balance is CorporateActionBalanceDetails10 BalanceValue)
        {
    ...
    public static AccountAndBalance15 Deserialize(XElement element)
    {
