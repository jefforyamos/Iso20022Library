...
public partial record AccountAndBalance17
     : IIsoXmlSerilizable<AccountAndBalance17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Balance is CorporateActionBalanceDetails12 BalanceValue)
        {
    ...
    public static AccountAndBalance17 Deserialize(XElement element)
    {
