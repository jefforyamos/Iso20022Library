...
public partial record AccountAndBalance2
     : IIsoXmlSerilizable<AccountAndBalance2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Balance is CorporateActionBalanceDetails3 BalanceValue)
        {
    ...
    public static AccountAndBalance2 Deserialize(XElement element)
    {
