...
public partial record AccountAndBalance21
     : IIsoXmlSerilizable<AccountAndBalance21>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Balance is CorporateActionBalanceDetails17 BalanceValue)
        {
    ...
    public static AccountAndBalance21 Deserialize(XElement element)
    {
