...
public partial record AccountAndBalance37
     : IIsoXmlSerilizable<AccountAndBalance37>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Balance is CorporateActionBalanceDetails34 BalanceValue)
        {
    ...
    public static AccountAndBalance37 Deserialize(XElement element)
    {
