...
public partial record AccountAndBalance48
     : IIsoXmlSerilizable<AccountAndBalance48>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Balance is CorporateActionBalanceDetails42 BalanceValue)
        {
    ...
    public static AccountAndBalance48 Deserialize(XElement element)
    {
