...
public partial record AccountAndBalance51
     : IIsoXmlSerilizable<AccountAndBalance51>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Balance is CorporateActionBalanceDetails44 BalanceValue)
        {
    ...
    public static AccountAndBalance51 Deserialize(XElement element)
    {
