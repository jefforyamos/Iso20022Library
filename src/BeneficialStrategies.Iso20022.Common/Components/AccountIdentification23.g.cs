...
public partial record AccountIdentification23
     : IIsoXmlSerilizable<AccountIdentification23>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventAndBalance is CorporateActionEventAndBalance5 CorporateActionEventAndBalanceValue)
        {
    ...
    public static AccountIdentification23 Deserialize(XElement element)
    {
