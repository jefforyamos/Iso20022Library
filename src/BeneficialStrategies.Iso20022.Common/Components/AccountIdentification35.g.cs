...
public partial record AccountIdentification35
     : IIsoXmlSerilizable<AccountIdentification35>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventAndBalance is CorporateActionEventAndBalance10 CorporateActionEventAndBalanceValue)
        {
    ...
    public static AccountIdentification35 Deserialize(XElement element)
    {
