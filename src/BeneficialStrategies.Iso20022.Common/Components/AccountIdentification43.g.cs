...
public partial record AccountIdentification43
     : IIsoXmlSerilizable<AccountIdentification43>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventAndBalance is CorporateActionEventAndBalance13 CorporateActionEventAndBalanceValue)
        {
    ...
    public static AccountIdentification43 Deserialize(XElement element)
    {
