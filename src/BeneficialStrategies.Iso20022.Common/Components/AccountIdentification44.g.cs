...
public partial record AccountIdentification44
     : IIsoXmlSerilizable<AccountIdentification44>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventAndBalance is CorporateActionEventAndBalance14 CorporateActionEventAndBalanceValue)
        {
    ...
    public static AccountIdentification44 Deserialize(XElement element)
    {
