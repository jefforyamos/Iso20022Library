...
public partial record AccountIdentification45
     : IIsoXmlSerilizable<AccountIdentification45>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventAndBalance is CorporateActionEventAndBalance15 CorporateActionEventAndBalanceValue)
        {
    ...
    public static AccountIdentification45 Deserialize(XElement element)
    {
