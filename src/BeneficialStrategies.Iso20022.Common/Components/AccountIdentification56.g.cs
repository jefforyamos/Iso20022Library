...
public partial record AccountIdentification56
     : IIsoXmlSerilizable<AccountIdentification56>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventAndBalance is CorporateActionEventAndBalance20 CorporateActionEventAndBalanceValue)
        {
    ...
    public static AccountIdentification56 Deserialize(XElement element)
    {
