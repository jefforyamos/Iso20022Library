...
public partial record AccountIdentification57
     : IIsoXmlSerilizable<AccountIdentification57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventAndBalance is CorporateActionEventAndBalance21 CorporateActionEventAndBalanceValue)
        {
    ...
    public static AccountIdentification57 Deserialize(XElement element)
    {
