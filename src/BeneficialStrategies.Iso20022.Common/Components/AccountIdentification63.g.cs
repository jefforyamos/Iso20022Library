...
public partial record AccountIdentification63
     : IIsoXmlSerilizable<AccountIdentification63>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventAndBalance is CorporateActionEventAndBalance23 CorporateActionEventAndBalanceValue)
        {
    ...
    public static AccountIdentification63 Deserialize(XElement element)
    {
