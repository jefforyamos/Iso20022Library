...
public partial record AccountParties8
     : IIsoXmlSerilizable<AccountParties8>
{
    #nullable enable
    ...
    public static AccountParties8 Deserialize(XElement element)
    {
