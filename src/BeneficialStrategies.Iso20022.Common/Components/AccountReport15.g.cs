...
public partial record AccountReport15
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OperationMandate2> Mandate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Definition of a group of parties.
    /// </summary>
    [DataMember]
    public ValueList<Group1> Group { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
