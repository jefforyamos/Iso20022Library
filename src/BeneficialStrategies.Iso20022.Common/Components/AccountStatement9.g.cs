...
public partial record AccountStatement9
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CashBalance8> Balance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ReportEntry10> Entry { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
