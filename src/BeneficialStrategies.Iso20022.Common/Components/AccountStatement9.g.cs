...
public partial record AccountStatement9
     : IIsoXmlSerilizable<AccountStatement9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (StatementPagination is Pagination1 StatementPaginationValue)
        {
        ...
        if (Entry is ReportEntry10 EntryValue)
        {
    ...
    public static AccountStatement9 Deserialize(XElement element)
    {
