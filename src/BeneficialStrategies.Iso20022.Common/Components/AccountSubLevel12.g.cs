...
public partial record AccountSubLevel12
     : IIsoXmlSerilizable<AccountSubLevel12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AccountSubLevel3 is AccountSubLevel13 AccountSubLevel3Value)
        {
    ...
    public static AccountSubLevel12 Deserialize(XElement element)
    {
