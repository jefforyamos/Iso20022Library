...
public partial record AccountSubLevel13
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<AccountSubLevel14> AccountSubLevel4 { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Difference in holdings between the sub-account at level 3 and the sub-accounts of level 4.
    /// </summary>
    [DataMember]
    public ValueList<AggregateHoldingBalance2> AccountSubLevel4Difference { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
