...
public partial record AccountSubLevel13
     : IIsoXmlSerilizable<AccountSubLevel13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AccountSubLevel4 is AccountSubLevel14 AccountSubLevel4Value)
        {
    ...
    public static AccountSubLevel13 Deserialize(XElement element)
    {
