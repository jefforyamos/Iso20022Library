...
public partial record AccountSubLevel17
     : IIsoXmlSerilizable<AccountSubLevel17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AccountSubLevel8 is AccountSubLevel18 AccountSubLevel8Value)
        {
    ...
    public static AccountSubLevel17 Deserialize(XElement element)
    {
