...
public partial record AccountSubLevel18
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<AccountSubLevel19> AccountSubLevel9 { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Difference in holdings between the sub-account at level 8 and the sub-accounts of level 9.
    /// </summary>
    [DataMember]
    public ValueList<AggregateHoldingBalance2> AccountSubLevel9Difference { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
