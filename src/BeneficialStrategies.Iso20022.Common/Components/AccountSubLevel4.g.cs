...
public partial record AccountSubLevel4
     : IIsoXmlSerilizable<AccountSubLevel4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AccountSubLevel5 is AccountSubLevel5 AccountSubLevel5Value)
        {
    ...
    public static AccountSubLevel4 Deserialize(XElement element)
    {
