...
public partial record AcquirerHostConfiguration3
     : IIsoXmlSerilizable<AcquirerHostConfiguration3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MessageToSend is MessageFunction5Code MessageToSendValue)
        {
    ...
    public static AcquirerHostConfiguration3 Deserialize(XElement element)
    {
