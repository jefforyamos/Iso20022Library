...
public partial record AcquirerHostConfiguration7
     : IIsoXmlSerilizable<AcquirerHostConfiguration7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MessageToSend is MessageFunction40Code MessageToSendValue)
        {
    ...
    public static AcquirerHostConfiguration7 Deserialize(XElement element)
    {
