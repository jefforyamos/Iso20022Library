...
public partial record AcquirerProtocolParameters10
     : IIsoXmlSerilizable<AcquirerProtocolParameters10>
{
    #nullable enable
    ...
    public static AcquirerProtocolParameters10 Deserialize(XElement element)
    {
