...
public partial record AcquirerProtocolParameters11
     : IIsoXmlSerilizable<AcquirerProtocolParameters11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Host is AcquirerHostConfiguration5 HostValue)
        {
    ...
    public static AcquirerProtocolParameters11 Deserialize(XElement element)
    {
