...
public partial record AcquirerProtocolParameters12
     : IIsoXmlSerilizable<AcquirerProtocolParameters12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Host is AcquirerHostConfiguration6 HostValue)
        {
    ...
    public static AcquirerProtocolParameters12 Deserialize(XElement element)
    {
