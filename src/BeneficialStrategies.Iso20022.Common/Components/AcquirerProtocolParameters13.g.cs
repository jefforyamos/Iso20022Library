...
public partial record AcquirerProtocolParameters13
     : IIsoXmlSerilizable<AcquirerProtocolParameters13>
{
    #nullable enable
    ...
    public static AcquirerProtocolParameters13 Deserialize(XElement element)
    {
