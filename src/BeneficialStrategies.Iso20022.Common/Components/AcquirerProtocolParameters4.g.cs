...
public partial record AcquirerProtocolParameters4
     : IIsoXmlSerilizable<AcquirerProtocolParameters4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BatchTransfer is ExchangeConfiguration2 BatchTransferValue)
        {
            writer.WriteStartElement(null, "BtchTrf", xmlNamespace );
            BatchTransferValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CompletionExchange is ExchangeConfiguration3 CompletionExchangeValue)
        {
    ...
    public static AcquirerProtocolParameters4 Deserialize(XElement element)
    {
