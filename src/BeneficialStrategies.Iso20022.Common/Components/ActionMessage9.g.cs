...
public partial record ActionMessage9
     : IIsoXmlSerilizable<ActionMessage9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MessageContentSignature is ContentInformationType29 MessageContentSignatureValue)
        {
    ...
    public static ActionMessage9 Deserialize(XElement element)
    {
