...
public partial record AdditionalInformation16
     : IIsoXmlSerilizable<AdditionalInformation16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeliveringParty1 is PartyIdentificationAndAccount170 DeliveringParty1Value)
        {
            writer.WriteStartElement(null, "DlvrgPty1", xmlNamespace );
            DeliveringParty1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingParty1 is PartyIdentificationAndAccount170 ReceivingParty1Value)
        {
    ...
    public static AdditionalInformation16 Deserialize(XElement element)
    {
