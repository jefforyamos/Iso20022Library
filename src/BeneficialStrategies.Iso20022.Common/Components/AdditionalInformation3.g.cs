...
public partial record AdditionalInformation3
     : IIsoXmlSerilizable<AdditionalInformation3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Investor is PartyIdentification10Choice_ InvestorValue)
        {
            writer.WriteStartElement(null, "Invstr", xmlNamespace );
            InvestorValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DeliveringParty1 is PartyIdentificationAndAccount16 DeliveringParty1Value)
        {
            writer.WriteStartElement(null, "DlvrgPty1", xmlNamespace );
            DeliveringParty1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingParty1 is PartyIdentificationAndAccount16 ReceivingParty1Value)
        {
    ...
    public static AdditionalInformation3 Deserialize(XElement element)
    {
