...
public partial record AdditionalQueryParameters11
     : IIsoXmlSerilizable<AdditionalQueryParameters11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Reason is Reason16Choice_ ReasonValue)
        {
    ...
    public static AdditionalQueryParameters11 Deserialize(XElement element)
    {
