...
public partial record AdditionalQueryParameters3
     : IIsoXmlSerilizable<AdditionalQueryParameters3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Reason is Reason6Choice_ ReasonValue)
        {
    ...
    public static AdditionalQueryParameters3 Deserialize(XElement element)
    {
