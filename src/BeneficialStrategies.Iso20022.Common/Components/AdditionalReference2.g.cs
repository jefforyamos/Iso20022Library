...
public partial record AdditionalReference2
     : IIsoXmlSerilizable<AdditionalReference2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReferenceIssuer is PartyIdentification1Choice_ ReferenceIssuerValue)
        {
    ...
    public static AdditionalReference2 Deserialize(XElement element)
    {
