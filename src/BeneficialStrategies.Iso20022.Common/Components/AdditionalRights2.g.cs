...
public partial record AdditionalRights2
     : IIsoXmlSerilizable<AdditionalRights2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalRightDeadline is DateFormat29Choice_ AdditionalRightDeadlineValue)
        {
            writer.WriteStartElement(null, "AddtlRghtDdln", xmlNamespace );
            AdditionalRightDeadlineValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (AdditionalRightMarketDeadline is DateFormat29Choice_ AdditionalRightMarketDeadlineValue)
        {
    ...
    public static AdditionalRights2 Deserialize(XElement element)
    {
