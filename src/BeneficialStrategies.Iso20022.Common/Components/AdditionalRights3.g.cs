...
public partial record AdditionalRights3
     : IIsoXmlSerilizable<AdditionalRights3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalRightInformationURLAddress is IsoMax2048Text AdditionalRightInformationURLAddressValue)
        {
            writer.WriteStartElement(null, "AddtlRghtInfURLAdr", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax2048Text(AdditionalRightInformationURLAddressValue)); // data type Max2048Text System.String
            writer.WriteEndElement();
        }
        if (AdditionalRightDeadline is DateFormat58Choice_ AdditionalRightDeadlineValue)
        {
            writer.WriteStartElement(null, "AddtlRghtDdln", xmlNamespace );
            AdditionalRightDeadlineValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (AdditionalRightMarketDeadline is DateFormat58Choice_ AdditionalRightMarketDeadlineValue)
        {
    ...
    public static AdditionalRights3 Deserialize(XElement element)
    {
