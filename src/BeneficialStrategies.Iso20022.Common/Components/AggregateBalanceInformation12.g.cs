...
public partial record AggregateBalanceInformation12
     : IIsoXmlSerilizable<AggregateBalanceInformation12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace11 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation12 Deserialize(XElement element)
    {
