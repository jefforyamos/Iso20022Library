...
public partial record AggregateBalanceInformation13
     : IIsoXmlSerilizable<AggregateBalanceInformation13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown4 QuantityBreakdownValue)
        {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace12 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation13 Deserialize(XElement element)
    {
