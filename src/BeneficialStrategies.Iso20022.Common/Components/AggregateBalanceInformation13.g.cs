...
public partial record AggregateBalanceInformation13
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<QuantityBreakdown4> QuantityBreakdown { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<AggregateBalancePerSafekeepingPlace12> BalanceAtSafekeepingPlace { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
