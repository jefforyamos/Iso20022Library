...
public partial record AggregateBalanceInformation17
     : IIsoXmlSerilizable<AggregateBalanceInformation17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace16 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation17 Deserialize(XElement element)
    {
