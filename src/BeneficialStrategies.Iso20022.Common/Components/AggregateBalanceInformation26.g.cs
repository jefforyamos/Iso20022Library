...
public partial record AggregateBalanceInformation26
     : IIsoXmlSerilizable<AggregateBalanceInformation26>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace25 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation26 Deserialize(XElement element)
    {
