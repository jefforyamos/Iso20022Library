...
public partial record AggregateBalanceInformation31
     : IIsoXmlSerilizable<AggregateBalanceInformation31>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace29 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation31 Deserialize(XElement element)
    {
