...
public partial record AggregateBalanceInformation32
     : IIsoXmlSerilizable<AggregateBalanceInformation32>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown39 QuantityBreakdownValue)
        {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace30 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation32 Deserialize(XElement element)
    {
