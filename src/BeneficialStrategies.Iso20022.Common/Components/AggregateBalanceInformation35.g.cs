...
public partial record AggregateBalanceInformation35
     : IIsoXmlSerilizable<AggregateBalanceInformation35>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace32 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation35 Deserialize(XElement element)
    {
