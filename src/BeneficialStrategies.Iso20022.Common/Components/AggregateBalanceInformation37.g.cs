...
public partial record AggregateBalanceInformation37
     : IIsoXmlSerilizable<AggregateBalanceInformation37>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace34 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation37 Deserialize(XElement element)
    {
