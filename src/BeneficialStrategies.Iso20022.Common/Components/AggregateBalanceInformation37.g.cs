...
public partial record AggregateBalanceInformation37
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<QuantityBreakdown53> QuantityBreakdown { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<AggregateBalancePerSafekeepingPlace34> BalanceAtSafekeepingPlace { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
