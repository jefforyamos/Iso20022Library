...
public partial record AggregateBalanceInformation9
     : IIsoXmlSerilizable<AggregateBalanceInformation9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceAtSafekeepingPlace is AggregateBalancePerSafekeepingPlace8 BalanceAtSafekeepingPlaceValue)
        {
    ...
    public static AggregateBalanceInformation9 Deserialize(XElement element)
    {
