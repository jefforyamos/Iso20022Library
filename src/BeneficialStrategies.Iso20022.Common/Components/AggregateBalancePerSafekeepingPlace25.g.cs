...
public partial record AggregateBalancePerSafekeepingPlace25
     : IIsoXmlSerilizable<AggregateBalancePerSafekeepingPlace25>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Pledgee is PledgeeFormat1Choice_ PledgeeValue)
        {
        ...
        if (ExposureType is ExposureType12Choice_ ExposureTypeValue)
        {
    ...
    public static AggregateBalancePerSafekeepingPlace25 Deserialize(XElement element)
    {
