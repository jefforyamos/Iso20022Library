...
public partial record AggregateBalancePerSafekeepingPlace31
     : IIsoXmlSerilizable<AggregateBalancePerSafekeepingPlace31>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Pledgee is Pledgee2 PledgeeValue)
        {
    ...
    public static AggregateBalancePerSafekeepingPlace31 Deserialize(XElement element)
    {
