...
public partial record AggregateBalancePerSafekeepingPlace36
     : IIsoXmlSerilizable<AggregateBalancePerSafekeepingPlace36>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Pledgee is Pledgee4 PledgeeValue)
        {
    ...
    public static AggregateBalancePerSafekeepingPlace36 Deserialize(XElement element)
    {
