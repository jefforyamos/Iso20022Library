...
public partial record AgriculturalCommodityGrain1
     : IIsoXmlSerilizable<AgriculturalCommodityGrain1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AdditionalSubProduct is AssetClassDetailedSubProductType15Code AdditionalSubProductValue)
        {
    ...
    public static AgriculturalCommodityGrain1 Deserialize(XElement element)
    {
