...
public partial record AgriculturalCommodityOliveOil3
     : IIsoXmlSerilizable<AgriculturalCommodityOliveOil3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubProduct is AssetClassSubProductType3Code SubProductValue)
        {
            writer.WriteStartElement(null, "SubPdct", xmlNamespace );
            writer.WriteValue(SubProductValue.ToString()); // Enum value
            writer.WriteEndElement();
        }
        if (AdditionalSubProduct is AssetClassDetailedSubProductType29Code AdditionalSubProductValue)
        {
    ...
    public static AgriculturalCommodityOliveOil3 Deserialize(XElement element)
    {
