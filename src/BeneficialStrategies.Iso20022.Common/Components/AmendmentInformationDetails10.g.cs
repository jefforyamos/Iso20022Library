...
public partial record AmendmentInformationDetails10
     : IIsoXmlSerilizable<AmendmentInformationDetails10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalFrequency is Frequency21Choice_ OriginalFrequencyValue)
        {
    ...
    public static AmendmentInformationDetails10 Deserialize(XElement element)
    {
