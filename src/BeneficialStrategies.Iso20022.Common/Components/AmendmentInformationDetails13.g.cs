...
public partial record AmendmentInformationDetails13
     : IIsoXmlSerilizable<AmendmentInformationDetails13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalCreditorAgentAccount is CashAccount38 OriginalCreditorAgentAccountValue)
        {
        ...
        if (OriginalDebtorAccount is CashAccount38 OriginalDebtorAccountValue)
        {
        ...
        if (OriginalDebtorAgentAccount is CashAccount38 OriginalDebtorAgentAccountValue)
        {
    ...
    public static AmendmentInformationDetails13 Deserialize(XElement element)
    {
