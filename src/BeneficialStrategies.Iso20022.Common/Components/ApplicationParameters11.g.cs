...
public partial record ApplicationParameters11
     : IIsoXmlSerilizable<ApplicationParameters11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (EncryptedParameters is ContentInformationType32 EncryptedParametersValue)
        {
    ...
    public static ApplicationParameters11 Deserialize(XElement element)
    {
