...
public partial record ApplicationParameters9
     : IIsoXmlSerilizable<ApplicationParameters9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (EncryptedParameters is ContentInformationType22 EncryptedParametersValue)
        {
    ...
    public static ApplicationParameters9 Deserialize(XElement element)
    {
