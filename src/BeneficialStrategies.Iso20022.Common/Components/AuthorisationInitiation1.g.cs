...
public partial record AuthorisationInitiation1
     : IIsoXmlSerilizable<AuthorisationInitiation1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AddendumData is AddendumData1 AddendumDataValue)
        {
    ...
    public static AuthorisationInitiation1 Deserialize(XElement element)
    {
