...
public partial record AuthorisationResponse2
     : IIsoXmlSerilizable<AuthorisationResponse2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Context is Context13 ContextValue)
        {
        ...
        writer.WriteEndElement();
        if (AddendumData is AddendumData4 AddendumDataValue)
        {
    ...
    public static AuthorisationResponse2 Deserialize(XElement element)
    {
