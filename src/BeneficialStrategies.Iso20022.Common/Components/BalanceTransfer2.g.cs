...
public partial record BalanceTransfer2
     : IIsoXmlSerilizable<BalanceTransfer2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceTransferMethod is SettlementMethod2Choice_ BalanceTransferMethodValue)
        {
    ...
    public static BalanceTransfer2 Deserialize(XElement element)
    {
