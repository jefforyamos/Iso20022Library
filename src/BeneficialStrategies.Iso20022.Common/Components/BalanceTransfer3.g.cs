...
public partial record BalanceTransfer3
     : IIsoXmlSerilizable<BalanceTransfer3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceTransferMethod is SettlementMethod3Choice_ BalanceTransferMethodValue)
        {
    ...
    public static BalanceTransfer3 Deserialize(XElement element)
    {
