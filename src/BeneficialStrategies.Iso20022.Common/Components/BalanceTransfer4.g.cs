...
public partial record BalanceTransfer4
     : IIsoXmlSerilizable<BalanceTransfer4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BalanceTransferMethod is SettlementMethod4Choice_ BalanceTransferMethodValue)
        {
    ...
    public static BalanceTransfer4 Deserialize(XElement element)
    {
