     ...
     : IIsoXmlSerilizable<Baseline5>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherCertificateDataSetRequired is RequiredSubmission6 OtherCertificateDataSetRequiredValue)
        {
    ...
    public static Baseline5 Deserialize(XElement element)
    {
