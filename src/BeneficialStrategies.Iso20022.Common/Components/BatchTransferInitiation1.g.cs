...
public partial record BatchTransferInitiation1
     : IIsoXmlSerilizable<BatchTransferInitiation1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ProcessingResult is ProcessingResult3 ProcessingResultValue)
        {
    ...
    public static BatchTransferInitiation1 Deserialize(XElement element)
    {
