...
public partial record BillingTaxRegion2
     : IIsoXmlSerilizable<BillingTaxRegion2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SendingFinancialInstitution is BillingTaxIdentification2 SendingFinancialInstitutionValue)
        {
    ...
    public static BillingTaxRegion2 Deserialize(XElement element)
    {
