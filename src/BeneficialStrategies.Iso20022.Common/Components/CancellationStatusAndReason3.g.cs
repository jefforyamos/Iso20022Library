...
public partial record CancellationStatusAndReason3
     : IIsoXmlSerilizable<CancellationStatusAndReason3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (StatusInitiator is PartyIdentification70Choice_ StatusInitiatorValue)
        {
    ...
    public static CancellationStatusAndReason3 Deserialize(XElement element)
    {
