...
public partial record CardAccount12
     : IIsoXmlSerilizable<CardAccount12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AllowedService is ATMService19 AllowedServiceValue)
        {
            writer.WriteStartElement(null, "AllwdSvc", xmlNamespace );
            AllowedServiceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    }
    public static CardAccount12 Deserialize(XElement element)
    {
