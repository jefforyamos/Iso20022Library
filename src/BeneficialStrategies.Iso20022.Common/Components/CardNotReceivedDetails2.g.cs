...
public partial record CardNotReceivedDetails2
     : IIsoXmlSerilizable<CardNotReceivedDetails2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MailingAddress is Address2 MailingAddressValue)
        {
    ...
    public static CardNotReceivedDetails2 Deserialize(XElement element)
    {
