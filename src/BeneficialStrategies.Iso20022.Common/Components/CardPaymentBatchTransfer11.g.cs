...
public partial record CardPaymentBatchTransfer11
     : IIsoXmlSerilizable<CardPaymentBatchTransfer11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DataSet is CardPaymentDataSet34 DataSetValue)
        {
    ...
    public static CardPaymentBatchTransfer11 Deserialize(XElement element)
    {
