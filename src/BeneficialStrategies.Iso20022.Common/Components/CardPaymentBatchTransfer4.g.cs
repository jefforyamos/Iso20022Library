...
public partial record CardPaymentBatchTransfer4
     : IIsoXmlSerilizable<CardPaymentBatchTransfer4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DataSet is CardPaymentDataSet13 DataSetValue)
        {
    ...
    public static CardPaymentBatchTransfer4 Deserialize(XElement element)
    {
