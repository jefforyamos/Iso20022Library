...
public partial record CardPaymentBatchTransferResponse3
     : IIsoXmlSerilizable<CardPaymentBatchTransferResponse3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DataSet is CardPaymentDataSet12 DataSetValue)
        {
    ...
    public static CardPaymentBatchTransferResponse3 Deserialize(XElement element)
    {
