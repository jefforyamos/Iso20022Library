...
public partial record CardPaymentBatchTransferResponse4
     : IIsoXmlSerilizable<CardPaymentBatchTransferResponse4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DataSet is CardPaymentDataSet14 DataSetValue)
        {
    ...
    public static CardPaymentBatchTransferResponse4 Deserialize(XElement element)
    {
