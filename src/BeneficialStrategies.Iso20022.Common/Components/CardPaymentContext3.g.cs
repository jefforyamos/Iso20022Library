...
public partial record CardPaymentContext3
     : IIsoXmlSerilizable<CardPaymentContext3>
{
    #nullable enable
    ...
    {
        if (PaymentContext is PaymentContext1 PaymentContextValue)
        {
    ...
    public static CardPaymentContext3 Deserialize(XElement element)
    {
