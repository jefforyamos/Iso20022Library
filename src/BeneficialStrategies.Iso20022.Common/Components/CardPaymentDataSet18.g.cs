...
public partial record CardPaymentDataSet18
     : IIsoXmlSerilizable<CardPaymentDataSet18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RejectedTransaction is CardPaymentDataSet17 RejectedTransactionValue)
        {
    ...
    public static CardPaymentDataSet18 Deserialize(XElement element)
    {
