...
public partial record CardPaymentDataSet24
{
    ...
    /// </summary>
    public CardPaymentDataSet25[] RejectedTransaction { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Transaction in the batch, whose capture has been suspendeed.
    /// </summary>
    public CardPaymentDataSet25[] SuspendedTransaction { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Transaction in the batch, whose capture has been approved after suspension.
    /// </summary>
    public CardPaymentDataSet25[] ResumedApproval { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Transaction in the batch, whose capture has been rejected after suspension.
    /// </summary>
    public CardPaymentDataSet25[] ResumedRejection { get; init; } = []; // Warning: Don't know multiplicity.
