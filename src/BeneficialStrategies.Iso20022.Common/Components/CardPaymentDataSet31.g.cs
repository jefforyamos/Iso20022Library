...
public partial record CardPaymentDataSet31
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CardPaymentDataSet30> RejectedTransaction { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Transaction in the batch, whose capture has been suspended.
    /// </summary>
    [DataMember]
    public ValueList<CardPaymentDataSet30> SuspendedTransaction { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Transaction in the batch, whose capture has been approved after suspension.
    /// </summary>
    [DataMember]
    public ValueList<CardPaymentDataSet30> ResumedApproval { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Transaction in the batch, whose capture has been rejected after suspension.
    /// </summary>
    [DataMember]
    public ValueList<CardPaymentDataSet30> ResumedRejection { get; init; } = []; // Warning: Don't know multiplicity.
