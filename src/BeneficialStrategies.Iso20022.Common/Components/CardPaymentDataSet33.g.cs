...
public partial record CardPaymentDataSet33
     : IIsoXmlSerilizable<CardPaymentDataSet33>
{
    #nullable enable
    ...
    public static CardPaymentDataSet33 Deserialize(XElement element)
    {
