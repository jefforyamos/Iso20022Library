...
public partial record CardPaymentDataSet9
     : IIsoXmlSerilizable<CardPaymentDataSet9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RejectedTransaction is CardPaymentDataSet8 RejectedTransactionValue)
        {
    ...
    public static CardPaymentDataSet9 Deserialize(XElement element)
    {
