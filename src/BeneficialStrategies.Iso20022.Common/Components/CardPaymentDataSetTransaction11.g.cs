...
public partial record CardPaymentDataSetTransaction11
     : IIsoXmlSerilizable<CardPaymentDataSetTransaction11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Context is CardPaymentContext13 ContextValue)
        {
    ...
    public static CardPaymentDataSetTransaction11 Deserialize(XElement element)
    {
