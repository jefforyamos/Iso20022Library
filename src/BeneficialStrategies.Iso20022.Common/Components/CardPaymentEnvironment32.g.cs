...
public partial record CardPaymentEnvironment32
     : IIsoXmlSerilizable<CardPaymentEnvironment32>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Cardholder is Cardholder7 CardholderValue)
        {
    ...
    public static CardPaymentEnvironment32 Deserialize(XElement element)
    {
