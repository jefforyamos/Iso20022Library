...
public partial record CardPaymentEnvironment53
     : IIsoXmlSerilizable<CardPaymentEnvironment53>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Cardholder is Cardholder10 CardholderValue)
        {
    ...
    public static CardPaymentEnvironment53 Deserialize(XElement element)
    {
