...
public partial record CardPaymentEnvironment77
     : IIsoXmlSerilizable<CardPaymentEnvironment77>
{
    #nullable enable
    ...
    public static CardPaymentEnvironment77 Deserialize(XElement element)
    {
