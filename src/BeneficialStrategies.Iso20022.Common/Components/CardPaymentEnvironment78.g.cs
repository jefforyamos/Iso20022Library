...
public partial record CardPaymentEnvironment78
     : IIsoXmlSerilizable<CardPaymentEnvironment78>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Cardholder is Cardholder18 CardholderValue)
        {
            writer.WriteStartElement(null, "Crdhldr", xmlNamespace );
            CardholderValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ProtectedCardholderData is ContentInformationType32 ProtectedCardholderDataValue)
        {
    ...
    public static CardPaymentEnvironment78 Deserialize(XElement element)
    {
