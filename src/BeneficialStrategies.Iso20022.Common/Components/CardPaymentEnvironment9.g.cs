...
public partial record CardPaymentEnvironment9
     : IIsoXmlSerilizable<CardPaymentEnvironment9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Cardholder is Cardholder3 CardholderValue)
        {
    ...
    public static CardPaymentEnvironment9 Deserialize(XElement element)
    {
