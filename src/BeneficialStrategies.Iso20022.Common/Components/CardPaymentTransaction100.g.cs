...
public partial record CardPaymentTransaction100
     : IIsoXmlSerilizable<CardPaymentTransaction100>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalTransaction is CardPaymentTransaction102 OriginalTransactionValue)
        {
    ...
    public static CardPaymentTransaction100 Deserialize(XElement element)
    {
