...
public partial record CardPaymentTransaction103
     : IIsoXmlSerilizable<CardPaymentTransaction103>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalTransaction is CardPaymentTransaction106 OriginalTransactionValue)
        {
        ...
        writer.WriteEndElement();
        if (AuthorisationResult is AuthorisationResult15 AuthorisationResultValue)
        {
    ...
    public static CardPaymentTransaction103 Deserialize(XElement element)
    {
