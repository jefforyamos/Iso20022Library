...
public partial record CardPaymentTransaction104
     : IIsoXmlSerilizable<CardPaymentTransaction104>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AuthorisationResult is AuthorisationResult16 AuthorisationResultValue)
        {
    ...
    public static CardPaymentTransaction104 Deserialize(XElement element)
    {
