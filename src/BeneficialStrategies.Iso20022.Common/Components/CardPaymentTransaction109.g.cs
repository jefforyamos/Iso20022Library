...
public partial record CardPaymentTransaction109
     : IIsoXmlSerilizable<CardPaymentTransaction109>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedBalance is ContentInformationType28 ProtectedBalanceValue)
        {
        ...
        if (CurrencyConversionEligibility is CurrencyConversion20 CurrencyConversionEligibilityValue)
        {
    ...
    public static CardPaymentTransaction109 Deserialize(XElement element)
    {
