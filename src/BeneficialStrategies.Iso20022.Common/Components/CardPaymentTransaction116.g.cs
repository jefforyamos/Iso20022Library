...
public partial record CardPaymentTransaction116
     : IIsoXmlSerilizable<CardPaymentTransaction116>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AuthorisationResult is AuthorisationResult19 AuthorisationResultValue)
        {
    ...
    public static CardPaymentTransaction116 Deserialize(XElement element)
    {
