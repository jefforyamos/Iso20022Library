...
public partial record CardPaymentTransaction120
     : IIsoXmlSerilizable<CardPaymentTransaction120>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalTransaction is CardPaymentTransaction123 OriginalTransactionValue)
        {
    ...
    public static CardPaymentTransaction120 Deserialize(XElement element)
    {
