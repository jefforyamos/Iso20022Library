...
public partial record CardPaymentTransaction20
     : IIsoXmlSerilizable<CardPaymentTransaction20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AuthorisationResult is AuthorisationResult3 AuthorisationResultValue)
        {
    ...
    public static CardPaymentTransaction20 Deserialize(XElement element)
    {
