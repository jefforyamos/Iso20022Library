...
public partial record CardPaymentTransaction37
     : IIsoXmlSerilizable<CardPaymentTransaction37>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionResult is CardPaymentTransactionResult2 TransactionResultValue)
        {
    ...
    public static CardPaymentTransaction37 Deserialize(XElement element)
    {
