...
public partial record CardPaymentTransaction45
     : IIsoXmlSerilizable<CardPaymentTransaction45>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AuthorisationResult is AuthorisationResult4 AuthorisationResultValue)
        {
    ...
    public static CardPaymentTransaction45 Deserialize(XElement element)
    {
