...
public partial record CardPaymentTransaction46
     : IIsoXmlSerilizable<CardPaymentTransaction46>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AuthorisationResult is AuthorisationResult6 AuthorisationResultValue)
        {
    ...
    public static CardPaymentTransaction46 Deserialize(XElement element)
    {
