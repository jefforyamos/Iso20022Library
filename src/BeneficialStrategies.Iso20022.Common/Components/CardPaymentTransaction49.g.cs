...
public partial record CardPaymentTransaction49
     : IIsoXmlSerilizable<CardPaymentTransaction49>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalTransaction is CardPaymentTransaction50 OriginalTransactionValue)
        {
    ...
    public static CardPaymentTransaction49 Deserialize(XElement element)
    {
