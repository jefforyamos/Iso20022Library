...
public partial record CardPaymentTransaction60
     : IIsoXmlSerilizable<CardPaymentTransaction60>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AuthorisationResult is AuthorisationResult10 AuthorisationResultValue)
        {
    ...
    public static CardPaymentTransaction60 Deserialize(XElement element)
    {
