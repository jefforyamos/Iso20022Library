...
public partial record CardPaymentTransaction72
     : IIsoXmlSerilizable<CardPaymentTransaction72>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalTransaction is CardPaymentTransaction73 OriginalTransactionValue)
        {
    ...
    public static CardPaymentTransaction72 Deserialize(XElement element)
    {
