...
public partial record CardPaymentTransaction84
     : IIsoXmlSerilizable<CardPaymentTransaction84>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedBalance is ContentInformationType17 ProtectedBalanceValue)
        {
            writer.WriteStartElement(null, "PrtctdBal", xmlNamespace );
            ProtectedBalanceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Action is Action8 ActionValue)
        {
            writer.WriteStartElement(null, "Actn", xmlNamespace );
            ActionValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CurrencyConversionEligibility is CurrencyConversion14 CurrencyConversionEligibilityValue)
        {
    ...
    public static CardPaymentTransaction84 Deserialize(XElement element)
    {
