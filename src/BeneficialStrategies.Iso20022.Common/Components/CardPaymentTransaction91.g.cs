...
public partial record CardPaymentTransaction91
     : IIsoXmlSerilizable<CardPaymentTransaction91>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalTransaction is CardPaymentTransaction86 OriginalTransactionValue)
        {
        ...
        if (CustomerToken is CardPaymentToken4 CustomerTokenValue)
        {
    ...
    public static CardPaymentTransaction91 Deserialize(XElement element)
    {
