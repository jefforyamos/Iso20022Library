...
public partial record CardPaymentTransaction94
     : IIsoXmlSerilizable<CardPaymentTransaction94>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedBalance is ContentInformationType22 ProtectedBalanceValue)
        {
            writer.WriteStartElement(null, "PrtctdBal", xmlNamespace );
            ProtectedBalanceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Action is Action10 ActionValue)
        {
            writer.WriteStartElement(null, "Actn", xmlNamespace );
            ActionValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CurrencyConversionEligibility is CurrencyConversion19 CurrencyConversionEligibilityValue)
        {
    ...
    public static CardPaymentTransaction94 Deserialize(XElement element)
    {
