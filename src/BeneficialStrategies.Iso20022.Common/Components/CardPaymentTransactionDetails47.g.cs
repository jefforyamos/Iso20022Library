...
public partial record CardPaymentTransactionDetails47
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OnLineReason1Code> OnLineReason { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<IndustryData1> AdditionalInformation { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
