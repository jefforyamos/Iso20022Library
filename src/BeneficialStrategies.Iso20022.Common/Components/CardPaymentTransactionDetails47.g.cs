...
public partial record CardPaymentTransactionDetails47
     : IIsoXmlSerilizable<CardPaymentTransactionDetails47>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalInformation is IndustryData1 AdditionalInformationValue)
        {
    ...
    public static CardPaymentTransactionDetails47 Deserialize(XElement element)
    {
