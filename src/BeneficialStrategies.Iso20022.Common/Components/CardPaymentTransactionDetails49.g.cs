...
public partial record CardPaymentTransactionDetails49
     : IIsoXmlSerilizable<CardPaymentTransactionDetails49>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalInformation is ExternallyDefinedData2 AdditionalInformationValue)
        {
    ...
    public static CardPaymentTransactionDetails49 Deserialize(XElement element)
    {
