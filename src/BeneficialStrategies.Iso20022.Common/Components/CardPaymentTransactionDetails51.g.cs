...
public partial record CardPaymentTransactionDetails51
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OnLineReason2Code> OnLineReason { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<RecurringTransaction4> Instalment { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ExternallyDefinedData3> AdditionalInformation { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
