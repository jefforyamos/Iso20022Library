...
public partial record CardPaymentTransactionDetails52
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<RecurringTransaction5> Instalment { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ExternallyDefinedData4> AdditionalInformation { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
