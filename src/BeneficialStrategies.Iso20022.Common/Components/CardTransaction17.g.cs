...
public partial record CardTransaction17
     : IIsoXmlSerilizable<CardTransaction17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PrePaidAccount is CashAccount38 PrePaidAccountValue)
        {
    ...
    public static CardTransaction17 Deserialize(XElement element)
    {
