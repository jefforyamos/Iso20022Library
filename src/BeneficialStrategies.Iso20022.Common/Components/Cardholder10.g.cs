...
public partial record Cardholder10
     : IIsoXmlSerilizable<Cardholder10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication9 AuthenticationValue)
        {
    ...
    public static Cardholder10 Deserialize(XElement element)
    {
