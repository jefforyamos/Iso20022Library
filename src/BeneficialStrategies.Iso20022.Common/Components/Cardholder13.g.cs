...
public partial record Cardholder13
     : IIsoXmlSerilizable<Cardholder13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication11 AuthenticationValue)
        {
    ...
    public static Cardholder13 Deserialize(XElement element)
    {
