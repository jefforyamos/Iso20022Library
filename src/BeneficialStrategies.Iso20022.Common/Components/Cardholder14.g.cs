...
public partial record Cardholder14
     : IIsoXmlSerilizable<Cardholder14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication12 AuthenticationValue)
        {
        ...
        if (MobileData is MobileData1 MobileDataValue)
        {
    ...
    public static Cardholder14 Deserialize(XElement element)
    {
