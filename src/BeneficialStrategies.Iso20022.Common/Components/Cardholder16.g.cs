...
public partial record Cardholder16
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CardholderAuthentication13> Authentication { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<MobileData2> MobileData { get; init; } = []; // Warning: Don't know multiplicity.
