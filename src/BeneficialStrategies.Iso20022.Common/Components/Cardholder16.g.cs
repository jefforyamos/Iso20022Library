...
public partial record Cardholder16
     : IIsoXmlSerilizable<Cardholder16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication13 AuthenticationValue)
        {
        ...
        if (MobileData is MobileData2 MobileDataValue)
        {
    ...
    public static Cardholder16 Deserialize(XElement element)
    {
