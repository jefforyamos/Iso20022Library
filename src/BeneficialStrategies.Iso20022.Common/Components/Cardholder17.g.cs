...
public partial record Cardholder17
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CardholderAuthentication14> Authentication { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<MobileData3> MobileData { get; init; } = []; // Warning: Don't know multiplicity.
