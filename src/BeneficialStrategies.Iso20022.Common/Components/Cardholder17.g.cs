...
public partial record Cardholder17
     : IIsoXmlSerilizable<Cardholder17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication14 AuthenticationValue)
        {
        ...
        if (MobileData is MobileData3 MobileDataValue)
        {
    ...
    public static Cardholder17 Deserialize(XElement element)
    {
