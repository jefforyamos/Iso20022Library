...
public partial record Cardholder18
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CardholderAuthentication15> Authentication { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<MobileData4> MobileData { get; init; } = []; // Warning: Don't know multiplicity.
