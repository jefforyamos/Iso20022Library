...
public partial record Cardholder2
     : IIsoXmlSerilizable<Cardholder2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication2 AuthenticationValue)
        {
    ...
    public static Cardholder2 Deserialize(XElement element)
    {
