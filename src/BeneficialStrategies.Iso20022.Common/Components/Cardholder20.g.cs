...
public partial record Cardholder20
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CardholderAuthentication16> Authentication { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<MobileData5> MobileData { get; init; } = []; // Warning: Don't know multiplicity.
