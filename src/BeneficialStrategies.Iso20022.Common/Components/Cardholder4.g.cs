...
public partial record Cardholder4
     : IIsoXmlSerilizable<Cardholder4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication4 AuthenticationValue)
        {
    ...
    public static Cardholder4 Deserialize(XElement element)
    {
