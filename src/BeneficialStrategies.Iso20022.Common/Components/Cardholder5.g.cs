...
public partial record Cardholder5
     : IIsoXmlSerilizable<Cardholder5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication5 AuthenticationValue)
        {
    ...
    public static Cardholder5 Deserialize(XElement element)
    {
