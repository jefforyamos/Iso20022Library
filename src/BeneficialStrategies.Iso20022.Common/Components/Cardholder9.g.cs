...
public partial record Cardholder9
     : IIsoXmlSerilizable<Cardholder9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Authentication is CardholderAuthentication7 AuthenticationValue)
        {
    ...
    public static Cardholder9 Deserialize(XElement element)
    {
