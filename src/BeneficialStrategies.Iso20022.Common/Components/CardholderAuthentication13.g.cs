...
public partial record CardholderAuthentication13
     : IIsoXmlSerilizable<CardholderAuthentication13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedAuthenticationValue is ContentInformationType22 ProtectedAuthenticationValueValue)
        {
        ...
        if (CardholderOnLinePIN is OnLinePIN7 CardholderOnLinePINValue)
        {
        ...
        if (AuthenticationAdditionalInformation is ExternallyDefinedData1 AuthenticationAdditionalInformationValue)
        {
    ...
    public static CardholderAuthentication13 Deserialize(XElement element)
    {
