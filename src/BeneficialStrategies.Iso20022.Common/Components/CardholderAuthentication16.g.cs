...
public partial record CardholderAuthentication16
     : IIsoXmlSerilizable<CardholderAuthentication16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedAuthenticationValue is ContentInformationType35 ProtectedAuthenticationValueValue)
        {
        ...
        if (CardholderOnLinePIN is OnLinePIN10 CardholderOnLinePINValue)
        {
        ...
        if (AuthenticationAdditionalInformation is ExternallyDefinedData4 AuthenticationAdditionalInformationValue)
        {
    ...
    public static CardholderAuthentication16 Deserialize(XElement element)
    {
