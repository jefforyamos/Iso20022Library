...
public partial record CashAccount20
     : IIsoXmlSerilizable<CashAccount20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Owner is PartyIdentification32 OwnerValue)
        {
            writer.WriteStartElement(null, "Ownr", xmlNamespace );
            OwnerValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Servicer is BranchAndFinancialInstitutionIdentification4 ServicerValue)
        {
    ...
    public static CashAccount20 Deserialize(XElement element)
    {
