...
public partial record CashAccount42
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CashBalance13> MultilateralBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<BilateralLimit3> CurrentBilateralLimit { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<StandingOrder9> StandingOrder { get; init; } = []; // Warning: Don't know multiplicity.
