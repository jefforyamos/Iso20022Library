...
public partial record CashAccountCharacteristics1
     : IIsoXmlSerilizable<CashAccountCharacteristics1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ParentAccount is ParentCashAccount1 ParentAccountValue)
        {
    ...
    public static CashAccountCharacteristics1 Deserialize(XElement element)
    {
