...
public partial record CashAccountCharacteristics4
     : IIsoXmlSerilizable<CashAccountCharacteristics4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ParentAccount is ParentCashAccount4 ParentAccountValue)
        {
    ...
    public static CashAccountCharacteristics4 Deserialize(XElement element)
    {
