...
public partial record CashAccountReturnCriteria5
     : IIsoXmlSerilizable<CashAccountReturnCriteria5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MultilateralBalanceReturnCriteria is CashBalanceReturnCriteria2 MultilateralBalanceReturnCriteriaValue)
        {
        ...
        if (BilateralBalanceReturnCriteria is CashBalanceReturnCriteria2 BilateralBalanceReturnCriteriaValue)
        {
    ...
    public static CashAccountReturnCriteria5 Deserialize(XElement element)
    {
