...
public partial record CashOption18
     : IIsoXmlSerilizable<CashOption18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is RateDetails7 RateAndAmountDetailsValue)
        {
            writer.WriteStartElement(null, "RateAndAmtDtls", xmlNamespace );
            RateAndAmountDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PriceDetails is PriceDetails7 PriceDetailsValue)
        {
    ...
    public static CashOption18 Deserialize(XElement element)
    {
