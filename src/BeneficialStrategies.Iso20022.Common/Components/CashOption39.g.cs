...
public partial record CashOption39
     : IIsoXmlSerilizable<CashOption39>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashParties is CashParties21 CashPartiesValue)
        {
        ...
        if (RateAndAmountDetails is RateDetails15 RateAndAmountDetailsValue)
        {
            writer.WriteStartElement(null, "RateAndAmtDtls", xmlNamespace );
            RateAndAmountDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PriceDetails is PriceDetails14 PriceDetailsValue)
        {
    ...
    public static CashOption39 Deserialize(XElement element)
    {
