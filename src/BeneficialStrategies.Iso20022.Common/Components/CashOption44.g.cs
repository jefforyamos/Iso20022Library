...
public partial record CashOption44
     : IIsoXmlSerilizable<CashOption44>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashParties is CashParties28 CashPartiesValue)
        {
        ...
        if (RateAndAmountDetails is RateDetails23 RateAndAmountDetailsValue)
        {
            writer.WriteStartElement(null, "RateAndAmtDtls", xmlNamespace );
            RateAndAmountDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PriceDetails is PriceDetails23 PriceDetailsValue)
        {
    ...
    public static CashOption44 Deserialize(XElement element)
    {
