...
public partial record CashOption46
     : IIsoXmlSerilizable<CashOption46>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is RateDetails24 RateAndAmountDetailsValue)
        {
    ...
    public static CashOption46 Deserialize(XElement element)
    {
