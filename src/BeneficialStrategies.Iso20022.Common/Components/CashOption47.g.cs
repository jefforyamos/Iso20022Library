...
public partial record CashOption47
     : IIsoXmlSerilizable<CashOption47>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is RateDetails25 RateAndAmountDetailsValue)
        {
    ...
    public static CashOption47 Deserialize(XElement element)
    {
