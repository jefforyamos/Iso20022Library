...
public partial record CashOption51
     : IIsoXmlSerilizable<CashOption51>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is RateDetails26 RateAndAmountDetailsValue)
        {
    ...
    public static CashOption51 Deserialize(XElement element)
    {
