...
public partial record CashOption52
     : IIsoXmlSerilizable<CashOption52>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is RateDetails27 RateAndAmountDetailsValue)
        {
    ...
    public static CashOption52 Deserialize(XElement element)
    {
