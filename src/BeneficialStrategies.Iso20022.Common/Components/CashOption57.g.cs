...
public partial record CashOption57
     : IIsoXmlSerilizable<CashOption57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmountDetails is CorporateActionAmounts43 AmountDetailsValue)
        {
        ...
        if (RateAndAmountDetails is RateDetails31 RateAndAmountDetailsValue)
        {
    ...
    public static CashOption57 Deserialize(XElement element)
    {
