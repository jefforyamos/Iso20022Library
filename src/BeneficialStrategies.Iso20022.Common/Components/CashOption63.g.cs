...
public partial record CashOption63
     : IIsoXmlSerilizable<CashOption63>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmountDetails is CorporateActionAmounts47 AmountDetailsValue)
        {
        ...
        if (RateAndAmountDetails is RateDetails34 RateAndAmountDetailsValue)
        {
    ...
    public static CashOption63 Deserialize(XElement element)
    {
