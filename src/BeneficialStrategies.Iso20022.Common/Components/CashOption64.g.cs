...
public partial record CashOption64
     : IIsoXmlSerilizable<CashOption64>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is RateDetails32 RateAndAmountDetailsValue)
        {
    ...
    public static CashOption64 Deserialize(XElement element)
    {
