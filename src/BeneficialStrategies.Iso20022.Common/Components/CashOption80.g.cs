...
//
// Generated by ComponentGenerator for CashOption80.  ISO2002 ID# _plcfRTi7Eeydid5dcNPKvg.
//
...
public partial record CashOption80
     : IIsoXmlSerilizable<CashOption80>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PriceDetails is PriceDetails30 PriceDetailsValue)
        {
    ...
    public static CashOption80 Deserialize(XElement element)
    {
