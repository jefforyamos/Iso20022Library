...
public partial record CashOption81
     : IIsoXmlSerilizable<CashOption81>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmountDetails is CorporateActionAmounts58 AmountDetailsValue)
        {
        ...
        if (PriceDetails is PriceDetails29 PriceDetailsValue)
        {
    ...
    public static CashOption81 Deserialize(XElement element)
    {
