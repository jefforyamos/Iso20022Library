...
public partial record CashOption83
     : IIsoXmlSerilizable<CashOption83>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmountDetails is CorporateActionAmounts54 AmountDetailsValue)
        {
        ...
        if (PriceDetails is PriceDetails31 PriceDetailsValue)
        {
    ...
    public static CashOption83 Deserialize(XElement element)
    {
