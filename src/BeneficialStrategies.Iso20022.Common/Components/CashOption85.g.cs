...
public partial record CashOption85
     : IIsoXmlSerilizable<CashOption85>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashParties is CashParties34 CashPartiesValue)
        {
    ...
    public static CashOption85 Deserialize(XElement element)
    {
