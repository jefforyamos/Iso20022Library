...
public partial record CashOption87
     : IIsoXmlSerilizable<CashOption87>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashParties is CashParties37 CashPartiesValue)
        {
    ...
    public static CashOption87 Deserialize(XElement element)
    {
