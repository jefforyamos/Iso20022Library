...
public partial record CashOption87
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GenericIdentification47> OtherIncomeType { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ForeignExchangeTerms27> ForeignExchangeDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
