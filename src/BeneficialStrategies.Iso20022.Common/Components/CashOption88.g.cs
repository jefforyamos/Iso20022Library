...
public partial record CashOption88
     : IIsoXmlSerilizable<CashOption88>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmountDetails is CorporateActionAmounts62 AmountDetailsValue)
        {
        ...
        if (PriceDetails is PriceDetails34 PriceDetailsValue)
        {
    ...
    public static CashOption88 Deserialize(XElement element)
    {
