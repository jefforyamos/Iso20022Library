...
public partial record CashOptionSD11
     : IIsoXmlSerilizable<CashOptionSD11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DTCUSTaxInstructionPeriod is Period13 DTCUSTaxInstructionPeriodValue)
        {
    ...
    public static CashOptionSD11 Deserialize(XElement element)
    {
