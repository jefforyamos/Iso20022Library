...
public partial record CashOutForecast3
     : IIsoXmlSerilizable<CashOutForecast3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashOutBreakdownDetails is FundCashOutBreakdown2 CashOutBreakdownDetailsValue)
        {
    ...
    public static CashOutForecast3 Deserialize(XElement element)
    {
