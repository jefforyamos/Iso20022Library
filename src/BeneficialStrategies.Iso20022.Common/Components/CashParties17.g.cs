...
public partial record CashParties17
     : IIsoXmlSerilizable<CashParties17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Intermediary is PartyIdentificationAndAccount50 IntermediaryValue)
        {
    ...
    public static CashParties17 Deserialize(XElement element)
    {
