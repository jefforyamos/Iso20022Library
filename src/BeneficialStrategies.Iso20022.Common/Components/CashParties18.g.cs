...
public partial record CashParties18
     : IIsoXmlSerilizable<CashParties18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Intermediary is PartyIdentificationAndAccount80 IntermediaryValue)
        {
    ...
    public static CashParties18 Deserialize(XElement element)
    {
