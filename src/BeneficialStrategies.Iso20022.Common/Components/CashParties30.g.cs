...
public partial record CashParties30
     : IIsoXmlSerilizable<CashParties30>
{
    #nullable enable
    ...
    {
        if (Debtor is PartyIdentificationAndAccount133 DebtorValue)
        {
            writer.WriteStartElement(null, "Dbtr", xmlNamespace );
            DebtorValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DebtorAgent is PartyIdentificationAndAccount134 DebtorAgentValue)
        {
            writer.WriteStartElement(null, "DbtrAgt", xmlNamespace );
            DebtorAgentValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Creditor is PartyIdentificationAndAccount133 CreditorValue)
        {
            writer.WriteStartElement(null, "Cdtr", xmlNamespace );
            CreditorValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CreditorAgent is PartyIdentificationAndAccount134 CreditorAgentValue)
        {
            writer.WriteStartElement(null, "CdtrAgt", xmlNamespace );
            CreditorAgentValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Intermediary is PartyIdentificationAndAccount134 IntermediaryValue)
        {
    ...
    public static CashParties30 Deserialize(XElement element)
    {
