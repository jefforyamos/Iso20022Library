...
public partial record CashParties36
     : IIsoXmlSerilizable<CashParties36>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Intermediary is PartyIdentificationAndAccount171 IntermediaryValue)
        {
    ...
    public static CashParties36 Deserialize(XElement element)
    {
