...
public partial record CashParties38
     : IIsoXmlSerilizable<CashParties38>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Intermediary is PartyIdentificationAndAccount178 IntermediaryValue)
        {
    ...
    public static CashParties38 Deserialize(XElement element)
    {
