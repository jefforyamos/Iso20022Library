...
public partial record CashParties9
     : IIsoXmlSerilizable<CashParties9>
{
    #nullable enable
    ...
    {
        if (Debtor is PartyIdentificationAndAccount48 DebtorValue)
        {
        ...
        if (Creditor is PartyIdentificationAndAccount48 CreditorValue)
        {
    ...
    public static CashParties9 Deserialize(XElement element)
    {
