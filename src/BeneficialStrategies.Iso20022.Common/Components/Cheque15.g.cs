     ...
     : IIsoXmlSerilizable<Cheque15>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ChequeCancellationOrStopReason is ChequeCancellationReason1 ChequeCancellationOrStopReasonValue)
        {
            writer.WriteStartElement(null, "ChqCxlOrStopRsn", xmlNamespace );
            ChequeCancellationOrStopReasonValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    }
    public static Cheque15 Deserialize(XElement element)
    {
