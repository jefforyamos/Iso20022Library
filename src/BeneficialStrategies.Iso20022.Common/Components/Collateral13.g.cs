...
public partial record Collateral13
     : IIsoXmlSerilizable<Collateral13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CollateralValuation is CollateralValuation5 CollateralValuationValue)
        {
    ...
    public static Collateral13 Deserialize(XElement element)
    {
