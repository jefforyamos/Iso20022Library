...
public partial record Collateral55
     : IIsoXmlSerilizable<Collateral55>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesCollateral is SecuritiesCollateral10 SecuritiesCollateralValue)
        {
    ...
    public static Collateral55 Deserialize(XElement element)
    {
