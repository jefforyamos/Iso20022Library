...
public partial record CollateralResponse1
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CashCollateralResponse1> CashCollateralResponse { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides details on other collateral proposal.
    /// </summary>
    [DataMember]
    public ValueList<OtherCollateralResponse1> OtherCollateralResponse { get; init; } = []; // Warning: Don't know multiplicity.
