...
public partial record CollateralSubstitution2
     : IIsoXmlSerilizable<CollateralSubstitution2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesCollateral is SecuritiesCollateral4 SecuritiesCollateralValue)
        {
        ...
        if (OtherCollateral is OtherCollateral4 OtherCollateralValue)
        {
    ...
    public static CollateralSubstitution2 Deserialize(XElement element)
    {
