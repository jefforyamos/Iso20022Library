...
public partial record CollateralSubstitution5
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesCollateral7> SecuritiesCollateral { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<OtherCollateral7> OtherCollateral { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
