...
public partial record CollateralSubstitution7
     : IIsoXmlSerilizable<CollateralSubstitution7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesCollateral is SecuritiesCollateral11 SecuritiesCollateralValue)
        {
        ...
        if (OtherCollateral is OtherCollateral11 OtherCollateralValue)
        {
    ...
    public static CollateralSubstitution7 Deserialize(XElement element)
    {
