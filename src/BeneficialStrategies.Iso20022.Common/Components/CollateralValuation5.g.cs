...
public partial record CollateralValuation5
     : IIsoXmlSerilizable<CollateralValuation5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesCollateral is SecuritiesCollateral6 SecuritiesCollateralValue)
        {
        ...
        if (OtherCollateral is OtherCollateral6 OtherCollateralValue)
        {
    ...
    public static CollateralValuation5 Deserialize(XElement element)
    {
