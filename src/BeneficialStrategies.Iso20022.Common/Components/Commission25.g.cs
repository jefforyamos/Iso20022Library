...
public partial record Commission25
     : IIsoXmlSerilizable<Commission25>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RecipientIdentification is PartyIdentification267 RecipientIdentificationValue)
        {
    ...
    public static Commission25 Deserialize(XElement element)
    {
