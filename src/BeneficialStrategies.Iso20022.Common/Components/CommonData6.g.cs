...
public partial record CommonData6
     : IIsoXmlSerilizable<CommonData6>
{
    #nullable enable
    ...
    {
        if (Environment is CardPaymentEnvironment58 EnvironmentValue)
        {
            writer.WriteStartElement(null, "Envt", xmlNamespace );
            EnvironmentValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Context is CardPaymentContext24 ContextValue)
        {
    ...
    public static CommonData6 Deserialize(XElement element)
    {
