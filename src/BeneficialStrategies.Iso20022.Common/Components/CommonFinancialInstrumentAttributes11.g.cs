...
public partial record CommonFinancialInstrumentAttributes11
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<FinancialInstrumentName2> FinancialInstrumentName { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<FinancialInstrumentIdentificationValidity3> FinancialInstrumentIdentificationValidity { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecurityCSDLink7> SecurityCSDLink { get; init; } = []; // Warning: Don't know multiplicity.
