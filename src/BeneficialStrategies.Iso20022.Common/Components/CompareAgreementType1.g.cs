...
public partial record CompareAgreementType1
     : IIsoXmlSerilizable<CompareAgreementType1>
{
    #nullable enable
    ...
    {
        if (Value1 is AgreementType1Choice_ Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is AgreementType1Choice_ Value2Value)
        {
    ...
    public static CompareAgreementType1 Deserialize(XElement element)
    {
