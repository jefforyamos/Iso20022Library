...
public partial record CompareAmountAndDirection2
     : IIsoXmlSerilizable<CompareAmountAndDirection2>
{
    #nullable enable
    ...
    public static CompareAmountAndDirection2 Deserialize(XElement element)
    {
