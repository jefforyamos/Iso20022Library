...
public partial record CompareAssetClass1
     : IIsoXmlSerilizable<CompareAssetClass1>
{
    #nullable enable
    ...
    public static CompareAssetClass1 Deserialize(XElement element)
    {
