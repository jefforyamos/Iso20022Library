...
public partial record CompareDayCount1
     : IIsoXmlSerilizable<CompareDayCount1>
{
    #nullable enable
    ...
    {
        if (Value1 is InterestComputationMethodFormat7 Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is InterestComputationMethodFormat7 Value2Value)
        {
    ...
    public static CompareDayCount1 Deserialize(XElement element)
    {
