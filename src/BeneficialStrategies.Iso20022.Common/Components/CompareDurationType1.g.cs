...
public partial record CompareDurationType1
     : IIsoXmlSerilizable<CompareDurationType1>
{
    #nullable enable
    ...
    public static CompareDurationType1 Deserialize(XElement element)
    {
