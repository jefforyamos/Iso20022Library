...
public partial record CompareEnergyQuantityUnit1
     : IIsoXmlSerilizable<CompareEnergyQuantityUnit1>
{
    #nullable enable
    ...
    {
        if (Value1 is EnergyQuantityUnit2Choice_ Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is EnergyQuantityUnit2Choice_ Value2Value)
        {
    ...
    public static CompareEnergyQuantityUnit1 Deserialize(XElement element)
    {
