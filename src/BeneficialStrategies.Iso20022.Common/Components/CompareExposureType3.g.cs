...
public partial record CompareExposureType3
     : IIsoXmlSerilizable<CompareExposureType3>
{
    #nullable enable
    ...
    public static CompareExposureType3 Deserialize(XElement element)
    {
