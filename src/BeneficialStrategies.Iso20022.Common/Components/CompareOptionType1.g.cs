...
public partial record CompareOptionType1
     : IIsoXmlSerilizable<CompareOptionType1>
{
    #nullable enable
    ...
    public static CompareOptionType1 Deserialize(XElement element)
    {
