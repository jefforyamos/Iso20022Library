...
public partial record CompareSeniorityType1
     : IIsoXmlSerilizable<CompareSeniorityType1>
{
    #nullable enable
    ...
    {
        if (Value1 is DebtInstrumentSeniorityType2Code Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            writer.WriteValue(Value1Value.ToString()); // Enum value
            writer.WriteEndElement();
        }
        if (Value2 is DebtInstrumentSeniorityType2Code Value2Value)
        {
    ...
    public static CompareSeniorityType1 Deserialize(XElement element)
    {
