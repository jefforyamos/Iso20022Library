...
public partial record CompareTradeConfirmation2
     : IIsoXmlSerilizable<CompareTradeConfirmation2>
{
    #nullable enable
    ...
    {
        if (Value1 is TradeConfirmation3Choice_ Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is TradeConfirmation3Choice_ Value2Value)
        {
    ...
    public static CompareTradeConfirmation2 Deserialize(XElement element)
    {
