...
public partial record CompareTrancheIndicator1
     : IIsoXmlSerilizable<CompareTrancheIndicator1>
{
    #nullable enable
    ...
    {
        if (Value1 is TrancheIndicator3Choice_ Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is TrancheIndicator3Choice_ Value2Value)
        {
    ...
    public static CompareTrancheIndicator1 Deserialize(XElement element)
    {
