...
public partial record CompareUnderlyingInstrument3
     : IIsoXmlSerilizable<CompareUnderlyingInstrument3>
{
    #nullable enable
    ...
    {
        if (Value1 is SecurityIdentification41Choice_ Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is SecurityIdentification41Choice_ Value2Value)
        {
    ...
    public static CompareUnderlyingInstrument3 Deserialize(XElement element)
    {
