...
public partial record CompareUniqueProductIdentifier2
     : IIsoXmlSerilizable<CompareUniqueProductIdentifier2>
{
    #nullable enable
    ...
    {
        if (Value1 is UniqueProductIdentifier2Choice_ Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is UniqueProductIdentifier2Choice_ Value2Value)
        {
    ...
    public static CompareUniqueProductIdentifier2 Deserialize(XElement element)
    {
