...
public partial record CompareUnitOfMeasure2
     : IIsoXmlSerilizable<CompareUnitOfMeasure2>
{
    #nullable enable
    ...
    public static CompareUnitOfMeasure2 Deserialize(XElement element)
    {
