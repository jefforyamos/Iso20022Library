...
public partial record CompareUnitPrice3
     : IIsoXmlSerilizable<CompareUnitPrice3>
{
    #nullable enable
    ...
    {
        if (Value1 is SecuritiesTransactionPrice11Choice_ Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is SecuritiesTransactionPrice11Choice_ Value2Value)
        {
    ...
    public static CompareUnitPrice3 Deserialize(XElement element)
    {
