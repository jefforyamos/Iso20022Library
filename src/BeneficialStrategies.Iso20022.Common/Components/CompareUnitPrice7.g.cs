...
public partial record CompareUnitPrice7
     : IIsoXmlSerilizable<CompareUnitPrice7>
{
    #nullable enable
    ...
    {
        if (Value1 is SecuritiesTransactionPrice14Choice_ Value1Value)
        {
            writer.WriteStartElement(null, "Val1", xmlNamespace );
            Value1Value.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Value2 is SecuritiesTransactionPrice14Choice_ Value2Value)
        {
    ...
    public static CompareUnitPrice7 Deserialize(XElement element)
    {
