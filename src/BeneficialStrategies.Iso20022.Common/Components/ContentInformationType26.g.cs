...
public partial record ContentInformationType26
     : IIsoXmlSerilizable<ContentInformationType26>
{
    #nullable enable
    ...
    public static ContentInformationType26 Deserialize(XElement element)
    {
