...
public partial record ContractRegistrationStatement3
     : IIsoXmlSerilizable<ContractRegistrationStatement3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionJournal is TransactionCertificate4 TransactionJournalValue)
        {
            writer.WriteStartElement(null, "TxJrnl", xmlNamespace );
            TransactionJournalValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SupportingDocumentJournal is SupportingDocument3 SupportingDocumentJournalValue)
        {
            writer.WriteStartElement(null, "SpprtgDocJrnl", xmlNamespace );
            SupportingDocumentJournalValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (AdditionalSupportingDocumentJournal is SupportingDocument3 AdditionalSupportingDocumentJournalValue)
        {
    ...
    public static ContractRegistrationStatement3 Deserialize(XElement element)
    {
