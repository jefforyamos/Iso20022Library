...
public partial record CorporateAction31
     : IIsoXmlSerilizable<CorporateAction31>
{
    #nullable enable
    ...
    {
        if (DateDetails is CorporateActionDate44 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate66 RateAndAmountDetailsValue)
        {
        ...
        if (ConversionType is ConversionTypeFormat3Choice_ ConversionTypeValue)
        {
    ...
    public static CorporateAction31 Deserialize(XElement element)
    {
