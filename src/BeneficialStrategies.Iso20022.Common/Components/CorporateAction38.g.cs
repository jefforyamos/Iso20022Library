...
public partial record CorporateAction38
     : IIsoXmlSerilizable<CorporateAction38>
{
    #nullable enable
    ...
    {
        if (DateDetails is CorporateActionDate54 DateDetailsValue)
        {
    ...
    public static CorporateAction38 Deserialize(XElement element)
    {
