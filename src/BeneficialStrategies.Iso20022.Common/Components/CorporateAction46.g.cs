...
public partial record CorporateAction46
     : IIsoXmlSerilizable<CorporateAction46>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalBusinessProcessIndicator is AdditionalBusinessProcessFormat16Choice_ AdditionalBusinessProcessIndicatorValue)
        {
    ...
    public static CorporateAction46 Deserialize(XElement element)
    {
