...
public partial record CorporateAction5
     : IIsoXmlSerilizable<CorporateAction5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesQuantity is CorporateActionQuantity3 SecuritiesQuantityValue)
        {
        ...
        if (IntermediateSecuritiesDistributionType is IntermediateSecuritiesDistributionTypeFormat5Choice_ IntermediateSecuritiesDistributionTypeValue)
        {
    ...
    public static CorporateAction5 Deserialize(XElement element)
    {
