...
public partial record CorporateAction57
     : IIsoXmlSerilizable<CorporateAction57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalInformation is CorporateActionNarrative44 AdditionalInformationValue)
        {
    ...
    public static CorporateAction57 Deserialize(XElement element)
    {
