...
public partial record CorporateAction58
     : IIsoXmlSerilizable<CorporateAction58>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalInformation is CorporateActionNarrative47 AdditionalInformationValue)
        {
    ...
    public static CorporateAction58 Deserialize(XElement element)
    {
