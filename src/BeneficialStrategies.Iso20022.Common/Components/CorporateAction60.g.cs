...
public partial record CorporateAction60
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OfferTypeFormat12Choice_> OfferType { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<AdditionalBusinessProcessFormat17Choice_> AdditionalBusinessProcessIndicator { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<GenericIdentification30> TaxOnNonDistributedProceedsIndicator { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
