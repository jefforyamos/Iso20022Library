...
public partial record CorporateAction68
     : IIsoXmlSerilizable<CorporateAction68>
{
    #nullable enable
    ...
    {
        if (DateDetails is CorporateActionDate83 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate105 RateAndAmountDetailsValue)
        {
            writer.WriteStartElement(null, "RateAndAmtDtls", xmlNamespace );
            RateAndAmountDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PriceDetails is CorporateActionPrice72 PriceDetailsValue)
        {
            writer.WriteStartElement(null, "PricDtls", xmlNamespace );
            PriceDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SecuritiesQuantity is CorporateActionQuantity11 SecuritiesQuantityValue)
        {
        ...
        if (AdditionalBusinessProcessIndicator is AdditionalBusinessProcessFormat17Choice_ AdditionalBusinessProcessIndicatorValue)
        {
        ...
        if (AdditionalInformation is CorporateActionNarrative50 AdditionalInformationValue)
        {
    ...
    public static CorporateAction68 Deserialize(XElement element)
    {
