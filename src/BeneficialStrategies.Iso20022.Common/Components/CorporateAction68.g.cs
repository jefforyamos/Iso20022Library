...
public partial record CorporateAction68
{
    ...
    /// </summary>
    public OfferTypeFormat12Choice_[] OfferType { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public AdditionalBusinessProcessFormat17Choice_[] AdditionalBusinessProcessIndicator { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
