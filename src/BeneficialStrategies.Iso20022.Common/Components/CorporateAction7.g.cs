...
public partial record CorporateAction7
     : IIsoXmlSerilizable<CorporateAction7>
{
    #nullable enable
    ...
    {
        if (DateDetails is CorporateActionDate22 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate27 RateAndAmountDetailsValue)
        {
    ...
    public static CorporateAction7 Deserialize(XElement element)
    {
