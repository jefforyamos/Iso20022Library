...
public partial record CorporateAction77
     : IIsoXmlSerilizable<CorporateAction77>
{
    #nullable enable
    ...
    {
        if (DateDetails is CorporateActionDate93 DateDetailsValue)
        {
            writer.WriteStartElement(null, "DtDtls", xmlNamespace );
            DateDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SecuritiesQuantity is CorporateActionQuantity13 SecuritiesQuantityValue)
        {
        ...
        if (AdditionalBusinessProcessIndicator is AdditionalBusinessProcessFormat21Choice_ AdditionalBusinessProcessIndicatorValue)
        {
    ...
    public static CorporateAction77 Deserialize(XElement element)
    {
