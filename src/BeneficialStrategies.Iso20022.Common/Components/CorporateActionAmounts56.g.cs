...
public partial record CorporateActionAmounts56
     : IIsoXmlSerilizable<CorporateActionAmounts56>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ForeignIncomeAmount is IsoActiveCurrencyAndAmount ForeignIncomeAmountValue)
        {
            writer.WriteStartElement(null, "FrgnIncmAmt", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoActiveCurrencyAndAmount(ForeignIncomeAmountValue)); // data type ActiveCurrencyAndAmount System.Decimal
            writer.WriteEndElement();
        }
    ...
    public static CorporateActionAmounts56 Deserialize(XElement element)
    {
