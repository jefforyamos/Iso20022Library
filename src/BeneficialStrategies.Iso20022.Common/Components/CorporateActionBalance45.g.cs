...
public partial record CorporateActionBalance45
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<PendingBalance6> PendingDeliveryBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Balance of financial instruments that are pending receipt.
    /// </summary>
    [DataMember]
    public ValueList<PendingBalance6> PendingReceiptBalance { get; init; } = []; // Warning: Don't know multiplicity.
