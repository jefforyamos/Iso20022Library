...
public partial record CorporateActionBalance47
     : IIsoXmlSerilizable<CorporateActionBalance47>
{
    #nullable enable
    ...
    public static CorporateActionBalance47 Deserialize(XElement element)
    {
