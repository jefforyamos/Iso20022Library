...
public partial record CorporateActionBalance47
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<PendingBalance8> PendingDeliveryBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Balance of financial instruments that are pending receipt.
    /// </summary>
    [DataMember]
    public ValueList<PendingBalance8> PendingReceiptBalance { get; init; } = []; // Warning: Don't know multiplicity.
