...
public partial record CorporateActionBalanceDetails30
     : IIsoXmlSerilizable<CorporateActionBalanceDetails30>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PendingDeliveryBalance is PendingBalance3 PendingDeliveryBalanceValue)
        {
            writer.WriteStartElement(null, "PdgDlvryBal", xmlNamespace );
            PendingDeliveryBalanceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PendingReceiptBalance is PendingBalance3 PendingReceiptBalanceValue)
        {
    ...
    public static CorporateActionBalanceDetails30 Deserialize(XElement element)
    {
