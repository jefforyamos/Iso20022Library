...
public partial record CorporateActionBalanceDetails30
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<PendingBalance3> PendingDeliveryBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Balance of financial instruments that are pending receipt.
    /// </summary>
    [DataMember]
    public ValueList<PendingBalance3> PendingReceiptBalance { get; init; } = []; // Warning: Don't know multiplicity.
