...
public partial record CorporateActionBalanceDetails31
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<BalanceFormat6Choice_> PendingDeliveryBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Balance of financial instruments that are pending receipt.
    /// </summary>
    [DataMember]
    public ValueList<BalanceFormat6Choice_> PendingReceiptBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<BalanceFormat6Choice_> SettlementPositionBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
