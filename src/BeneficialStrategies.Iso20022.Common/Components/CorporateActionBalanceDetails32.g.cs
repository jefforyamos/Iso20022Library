...
public partial record CorporateActionBalanceDetails32
     : IIsoXmlSerilizable<CorporateActionBalanceDetails32>
{
    #nullable enable
    ...
    {
        if (TotalEligibleBalance is Quantity17Choice_ TotalEligibleBalanceValue)
        {
        ...
        if (PendingDeliveryBalance is BalanceFormat5Choice_ PendingDeliveryBalanceValue)
        {
            writer.WriteStartElement(null, "PdgDlvryBal", xmlNamespace );
            PendingDeliveryBalanceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PendingReceiptBalance is BalanceFormat5Choice_ PendingReceiptBalanceValue)
        {
        ...
        if (SettlementPositionBalance is BalanceFormat5Choice_ SettlementPositionBalanceValue)
        {
    ...
    public static CorporateActionBalanceDetails32 Deserialize(XElement element)
    {
