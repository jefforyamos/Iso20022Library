...
public partial record CorporateActionBalanceDetails32
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<BalanceFormat5Choice_> PendingDeliveryBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Balance of financial instruments that are pending receipt.
    /// </summary>
    [DataMember]
    public ValueList<BalanceFormat5Choice_> PendingReceiptBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
