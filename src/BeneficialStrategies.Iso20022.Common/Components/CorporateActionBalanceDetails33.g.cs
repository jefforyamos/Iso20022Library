...
public partial record CorporateActionBalanceDetails33
     : IIsoXmlSerilizable<CorporateActionBalanceDetails33>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PendingDeliveryBalance is PendingBalance4 PendingDeliveryBalanceValue)
        {
            writer.WriteStartElement(null, "PdgDlvryBal", xmlNamespace );
            PendingDeliveryBalanceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PendingReceiptBalance is PendingBalance4 PendingReceiptBalanceValue)
        {
    ...
    public static CorporateActionBalanceDetails33 Deserialize(XElement element)
    {
