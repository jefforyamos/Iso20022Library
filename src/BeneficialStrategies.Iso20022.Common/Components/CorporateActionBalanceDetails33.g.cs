...
public partial record CorporateActionBalanceDetails33
{
    ...
    /// </summary>
    public PendingBalance4[] PendingDeliveryBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Balance of financial instruments that are pending receipt.
    /// </summary>
    public PendingBalance4[] PendingReceiptBalance { get; init; } = []; // Warning: Don't know multiplicity.
