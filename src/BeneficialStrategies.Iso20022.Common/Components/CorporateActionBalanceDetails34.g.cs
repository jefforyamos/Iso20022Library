...
public partial record CorporateActionBalanceDetails34
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<BalanceFormat7Choice_> PendingDeliveryBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Balance of financial instruments that are pending receipt.
    /// </summary>
    [DataMember]
    public ValueList<BalanceFormat7Choice_> PendingReceiptBalance { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
