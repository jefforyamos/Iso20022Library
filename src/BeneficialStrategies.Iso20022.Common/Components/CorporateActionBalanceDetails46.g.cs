...
public partial record CorporateActionBalanceDetails46
     : IIsoXmlSerilizable<CorporateActionBalanceDetails46>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ObligatedBalance is BalanceFormat14Choice_ ObligatedBalanceValue)
        {
    ...
    public static CorporateActionBalanceDetails46 Deserialize(XElement element)
    {
