...
public partial record CorporateActionConfirmationCashMovementDetailsSD1
     : IIsoXmlSerilizable<CorporateActionConfirmationCashMovementDetailsSD1>
{
    #nullable enable
    ...
    public static CorporateActionConfirmationCashMovementDetailsSD1 Deserialize(XElement element)
    {
