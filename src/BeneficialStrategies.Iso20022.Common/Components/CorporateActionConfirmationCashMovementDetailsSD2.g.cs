...
public partial record CorporateActionConfirmationCashMovementDetailsSD2
     : IIsoXmlSerilizable<CorporateActionConfirmationCashMovementDetailsSD2>
{
    #nullable enable
    ...
    public static CorporateActionConfirmationCashMovementDetailsSD2 Deserialize(XElement element)
    {
