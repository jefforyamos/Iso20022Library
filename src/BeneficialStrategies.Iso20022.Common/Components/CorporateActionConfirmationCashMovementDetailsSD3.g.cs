...
public partial record CorporateActionConfirmationCashMovementDetailsSD3
     : IIsoXmlSerilizable<CorporateActionConfirmationCashMovementDetailsSD3>
{
    #nullable enable
    ...
    public static CorporateActionConfirmationCashMovementDetailsSD3 Deserialize(XElement element)
    {
