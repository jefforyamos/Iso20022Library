...
public partial record CorporateActionConfirmationCashMovementDetailsSD4
     : IIsoXmlSerilizable<CorporateActionConfirmationCashMovementDetailsSD4>
{
    #nullable enable
    ...
    public static CorporateActionConfirmationCashMovementDetailsSD4 Deserialize(XElement element)
    {
