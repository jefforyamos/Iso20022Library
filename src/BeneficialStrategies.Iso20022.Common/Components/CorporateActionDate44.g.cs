...
public partial record CorporateActionDate44
     : IIsoXmlSerilizable<CorporateActionDate44>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SpecialExDate is DateFormat31Choice_ SpecialExDateValue)
        {
            writer.WriteStartElement(null, "SpclExDt", xmlNamespace );
            SpecialExDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (GuaranteedParticipationDate is DateFormat31Choice_ GuaranteedParticipationDateValue)
        {
            writer.WriteStartElement(null, "GrntedPrtcptnDt", xmlNamespace );
            GuaranteedParticipationDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ElectionToCounterpartyMarketDeadline is DateFormat31Choice_ ElectionToCounterpartyMarketDeadlineValue)
        {
        ...
        if (ElectionToCounterpartyResponseDeadline is DateFormat31Choice_ ElectionToCounterpartyResponseDeadlineValue)
        {
    ...
    public static CorporateActionDate44 Deserialize(XElement element)
    {
