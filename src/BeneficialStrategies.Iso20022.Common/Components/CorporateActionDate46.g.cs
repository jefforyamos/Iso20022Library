...
public partial record CorporateActionDate46
     : IIsoXmlSerilizable<CorporateActionDate46>
{
    #nullable enable
    ...
    {
        if (ResponseDeadline is DateFormat31Choice_ ResponseDeadlineValue)
        {
        ...
        if (TradingDate is DateFormat31Choice_ TradingDateValue)
        {
    ...
    public static CorporateActionDate46 Deserialize(XElement element)
    {
