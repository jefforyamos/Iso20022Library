...
public partial record CorporateActionDate47
     : IIsoXmlSerilizable<CorporateActionDate47>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ValueDate is DateFormat33Choice_ ValueDateValue)
        {
            writer.WriteStartElement(null, "ValDt", xmlNamespace );
            ValueDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ForeignExchangeRateFixingDate is DateFormat31Choice_ ForeignExchangeRateFixingDateValue)
        {
    ...
    public static CorporateActionDate47 Deserialize(XElement element)
    {
