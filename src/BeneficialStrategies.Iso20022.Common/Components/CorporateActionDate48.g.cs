...
public partial record CorporateActionDate48
     : IIsoXmlSerilizable<CorporateActionDate48>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (StockLendingDeadline is DateFormat31Choice_ StockLendingDeadlineValue)
        {
            writer.WriteStartElement(null, "StockLndgDdln", xmlNamespace );
            StockLendingDeadlineValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (BorrowerStockLendingDeadline is BorrowerLendingDeadline1 BorrowerStockLendingDeadlineValue)
        {
    ...
    public static CorporateActionDate48 Deserialize(XElement element)
    {
