...
public partial record CorporateActionDate52
     : IIsoXmlSerilizable<CorporateActionDate52>
{
    #nullable enable
    ...
    {
        if (ResponseDeadline is DateFormat34Choice_ ResponseDeadlineValue)
        {
        ...
        if (TradingDate is DateFormat34Choice_ TradingDateValue)
        {
    ...
    public static CorporateActionDate52 Deserialize(XElement element)
    {
