...
public partial record CorporateActionDate61
     : IIsoXmlSerilizable<CorporateActionDate61>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CourtApprovalDate is DateFormat43Choice_ CourtApprovalDateValue)
        {
        ...
        if (EffectiveDate is DateFormat43Choice_ EffectiveDateValue)
        {
            writer.WriteStartElement(null, "FctvDt", xmlNamespace );
            EffectiveDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (EqualisationDate is DateFormat43Choice_ EqualisationDateValue)
        {
        ...
        if (LotteryDate is DateFormat43Choice_ LotteryDateValue)
        {
            writer.WriteStartElement(null, "LtryDt", xmlNamespace );
            LotteryDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NewMaturityDate is DateFormat43Choice_ NewMaturityDateValue)
        {
        ...
        if (SpecialExDate is DateFormat43Choice_ SpecialExDateValue)
        {
            writer.WriteStartElement(null, "SpclExDt", xmlNamespace );
            SpecialExDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (GuaranteedParticipationDate is DateFormat43Choice_ GuaranteedParticipationDateValue)
        {
        ...
        if (LapsedDate is DateFormat43Choice_ LapsedDateValue)
        {
            writer.WriteStartElement(null, "LpsdDt", xmlNamespace );
            LapsedDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PaymentDate is DateFormat43Choice_ PaymentDateValue)
        {
        ...
        if (MarketClaimTrackingEndDate is DateFormat43Choice_ MarketClaimTrackingEndDateValue)
        {
    ...
    public static CorporateActionDate61 Deserialize(XElement element)
    {
