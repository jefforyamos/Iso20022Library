...
public partial record CorporateActionDate77
     : IIsoXmlSerilizable<CorporateActionDate77>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (EndOfSecuritiesBlockingPeriod is DateFormat59Choice_ EndOfSecuritiesBlockingPeriodValue)
        {
            writer.WriteStartElement(null, "EndOfSctiesBlckgPrd", xmlNamespace );
            EndOfSecuritiesBlockingPeriodValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    }
    public static CorporateActionDate77 Deserialize(XElement element)
    {
