...
public partial record CorporateActionDate8
     : IIsoXmlSerilizable<CorporateActionDate8>
{
    #nullable enable
    ...
    {
        if (EarlyResponseDeadline is DateFormat6Choice_ EarlyResponseDeadlineValue)
        {
        ...
        if (ResponseDeadline is DateFormat7Choice_ ResponseDeadlineValue)
        {
        ...
        if (DepositoryCoverExpirationDate is DateFormat6Choice_ DepositoryCoverExpirationDateValue)
        {
        ...
        if (LeadPlaintiffDeadline is DateFormat6Choice_ LeadPlaintiffDeadlineValue)
        {
    ...
    public static CorporateActionDate8 Deserialize(XElement element)
    {
