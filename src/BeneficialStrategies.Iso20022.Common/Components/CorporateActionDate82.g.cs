...
public partial record CorporateActionDate82
{
    ...
    /// </summary>
    public IDateFormat49Choice? DepositoryCoverExpirationDate { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IDateFormat49Choice? StockLendingDeadline { get; init; } 
    /// <summary>
    /// Specifies the party borrowing stocks and the associated stock lending deadline assigned to the borrower.
    /// </summary>
    public BorrowerLendingDeadline6? BorrowerStockLendingDeadline { get; init;  } // Warning: Don't know multiplicity.
    /// <summary>
