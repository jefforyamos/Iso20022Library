...
public partial record CorporateActionDate96
     : IIsoXmlSerilizable<CorporateActionDate96>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CourtApprovalDate is DateFormat41Choice_ CourtApprovalDateValue)
        {
        ...
        if (EffectiveDate is DateFormat41Choice_ EffectiveDateValue)
        {
            writer.WriteStartElement(null, "FctvDt", xmlNamespace );
            EffectiveDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (EqualisationDate is DateFormat41Choice_ EqualisationDateValue)
        {
        ...
        if (LotteryDate is DateFormat41Choice_ LotteryDateValue)
        {
            writer.WriteStartElement(null, "LtryDt", xmlNamespace );
            LotteryDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NewMaturityDate is DateFormat41Choice_ NewMaturityDateValue)
        {
        ...
        if (MarginFixingDate is DateFormat41Choice_ MarginFixingDateValue)
        {
            writer.WriteStartElement(null, "MrgnFxgDt", xmlNamespace );
            MarginFixingDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ProrationDate is DateFormat41Choice_ ProrationDateValue)
        {
        ...
        if (UnconditionalDate is DateFormat41Choice_ UnconditionalDateValue)
        {
            writer.WriteStartElement(null, "UcondlDt", xmlNamespace );
            UnconditionalDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (WhollyUnconditionalDate is DateFormat41Choice_ WhollyUnconditionalDateValue)
        {
        ...
        if (SpecialExDate is DateFormat41Choice_ SpecialExDateValue)
        {
            writer.WriteStartElement(null, "SpclExDt", xmlNamespace );
            SpecialExDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (GuaranteedParticipationDate is DateFormat41Choice_ GuaranteedParticipationDateValue)
        {
        ...
        if (LapsedDate is DateFormat41Choice_ LapsedDateValue)
        {
        ...
        if (MarketClaimTrackingEndDate is DateFormat41Choice_ MarketClaimTrackingEndDateValue)
        {
    ...
    public static CorporateActionDate96 Deserialize(XElement element)
    {
