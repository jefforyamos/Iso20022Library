...
public partial record CorporateActionEventAndBalance13
     : IIsoXmlSerilizable<CorporateActionEventAndBalance13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Balance is CorporateActionBalanceDetails37 BalanceValue)
        {
    ...
    public static CorporateActionEventAndBalance13 Deserialize(XElement element)
    {
