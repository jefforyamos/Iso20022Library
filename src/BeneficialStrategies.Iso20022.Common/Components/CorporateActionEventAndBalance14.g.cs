...
public partial record CorporateActionEventAndBalance14
     : IIsoXmlSerilizable<CorporateActionEventAndBalance14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Balance is CorporateActionBalanceDetails38 BalanceValue)
        {
    ...
    public static CorporateActionEventAndBalance14 Deserialize(XElement element)
    {
