...
public partial record CorporateActionEventAndBalance18
     : IIsoXmlSerilizable<CorporateActionEventAndBalance18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Balance is CorporateActionBalance42 BalanceValue)
        {
    ...
    public static CorporateActionEventAndBalance18 Deserialize(XElement element)
    {
