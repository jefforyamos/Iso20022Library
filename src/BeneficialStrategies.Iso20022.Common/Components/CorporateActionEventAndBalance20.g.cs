...
public partial record CorporateActionEventAndBalance20
     : IIsoXmlSerilizable<CorporateActionEventAndBalance20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Balance is CorporateActionBalance44 BalanceValue)
        {
    ...
    public static CorporateActionEventAndBalance20 Deserialize(XElement element)
    {
