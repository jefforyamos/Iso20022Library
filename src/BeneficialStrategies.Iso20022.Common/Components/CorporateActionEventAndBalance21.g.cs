...
public partial record CorporateActionEventAndBalance21
     : IIsoXmlSerilizable<CorporateActionEventAndBalance21>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Balance is CorporateActionBalance45 BalanceValue)
        {
    ...
    public static CorporateActionEventAndBalance21 Deserialize(XElement element)
    {
