...
public partial record CorporateActionEventAndBalance22
     : IIsoXmlSerilizable<CorporateActionEventAndBalance22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Balance is CorporateActionBalance46 BalanceValue)
        {
    ...
    public static CorporateActionEventAndBalance22 Deserialize(XElement element)
    {
