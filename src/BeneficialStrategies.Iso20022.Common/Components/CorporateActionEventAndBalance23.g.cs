...
public partial record CorporateActionEventAndBalance23
     : IIsoXmlSerilizable<CorporateActionEventAndBalance23>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Balance is CorporateActionBalance47 BalanceValue)
        {
    ...
    public static CorporateActionEventAndBalance23 Deserialize(XElement element)
    {
