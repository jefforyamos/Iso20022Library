...
public partial record CorporateActionGeneralInformation164
     : IIsoXmlSerilizable<CorporateActionGeneralInformation164>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnderlyingSecurity is FinancialInstrumentAttributes109 UnderlyingSecurityValue)
        {
    ...
    public static CorporateActionGeneralInformation164 Deserialize(XElement element)
    {
