...
public partial record CorporateActionGeneralInformation166
     : IIsoXmlSerilizable<CorporateActionGeneralInformation166>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnderlyingSecurity is FinancialInstrumentAttributes120 UnderlyingSecurityValue)
        {
    ...
    public static CorporateActionGeneralInformation166 Deserialize(XElement element)
    {
