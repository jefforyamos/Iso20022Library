...
public partial record CorporateActionGeneralInformation167
     : IIsoXmlSerilizable<CorporateActionGeneralInformation167>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FractionalQuantity is FinancialInstrumentQuantity36Choice_ FractionalQuantityValue)
        {
    ...
    public static CorporateActionGeneralInformation167 Deserialize(XElement element)
    {
