...
public partial record CorporateActionGeneralInformation21
     : IIsoXmlSerilizable<CorporateActionGeneralInformation21>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnderlyingSecurity is FinancialInstrumentAttributes18 UnderlyingSecurityValue)
        {
    ...
    public static CorporateActionGeneralInformation21 Deserialize(XElement element)
    {
