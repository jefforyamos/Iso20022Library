...
public partial record CorporateActionGeneralInformation26
     : IIsoXmlSerilizable<CorporateActionGeneralInformation26>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnderlyingSecurityIdentification is SecurityIdentification14 UnderlyingSecurityIdentificationValue)
        {
    ...
    public static CorporateActionGeneralInformation26 Deserialize(XElement element)
    {
