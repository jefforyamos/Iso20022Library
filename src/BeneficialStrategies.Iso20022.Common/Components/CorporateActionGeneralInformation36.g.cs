...
public partial record CorporateActionGeneralInformation36
     : IIsoXmlSerilizable<CorporateActionGeneralInformation36>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnderlyingSecurity is FinancialInstrumentAttributes32 UnderlyingSecurityValue)
        {
    ...
    public static CorporateActionGeneralInformation36 Deserialize(XElement element)
    {
