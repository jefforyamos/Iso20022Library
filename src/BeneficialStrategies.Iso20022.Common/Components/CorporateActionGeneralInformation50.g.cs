...
public partial record CorporateActionGeneralInformation50
     : IIsoXmlSerilizable<CorporateActionGeneralInformation50>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AdditionalBusinessProcessIndicator is AdditionalBusinessProcessFormat7Choice_ AdditionalBusinessProcessIndicatorValue)
        {
    ...
    public static CorporateActionGeneralInformation50 Deserialize(XElement element)
    {
