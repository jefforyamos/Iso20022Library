...
public partial record CorporateActionGeneralInformation6
     : IIsoXmlSerilizable<CorporateActionGeneralInformation6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnderlyingSecurity is FinancialInstrumentAttributes6 UnderlyingSecurityValue)
        {
    ...
    public static CorporateActionGeneralInformation6 Deserialize(XElement element)
    {
