...
public partial record CorporateActionGeneralInformation71
     : IIsoXmlSerilizable<CorporateActionGeneralInformation71>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnderlyingSecurity is FinancialInstrumentAttributes50 UnderlyingSecurityValue)
        {
    ...
    public static CorporateActionGeneralInformation71 Deserialize(XElement element)
    {
