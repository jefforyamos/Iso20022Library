...
public partial record CorporateActionGeneralInformation88
     : IIsoXmlSerilizable<CorporateActionGeneralInformation88>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnderlyingSecurity is FinancialInstrumentAttributes65 UnderlyingSecurityValue)
        {
    ...
    public static CorporateActionGeneralInformation88 Deserialize(XElement element)
    {
