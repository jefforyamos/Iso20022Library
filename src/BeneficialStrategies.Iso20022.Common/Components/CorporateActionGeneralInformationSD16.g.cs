...
public partial record CorporateActionGeneralInformationSD16
     : IIsoXmlSerilizable<CorporateActionGeneralInformationSD16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnallocatedDetails is CorporateActionUnallocatedDetailsSD2 UnallocatedDetailsValue)
        {
    ...
    public static CorporateActionGeneralInformationSD16 Deserialize(XElement element)
    {
