...
public partial record CorporateActionGeneralInformationSD20
     : IIsoXmlSerilizable<CorporateActionGeneralInformationSD20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (UnallocatedDetails is CorporateActionUnallocatedDetailsSD4 UnallocatedDetailsValue)
        {
    ...
    public static CorporateActionGeneralInformationSD20 Deserialize(XElement element)
    {
