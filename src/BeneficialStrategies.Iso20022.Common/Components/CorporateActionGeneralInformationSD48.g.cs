...
public partial record CorporateActionGeneralInformationSD48
     : IIsoXmlSerilizable<CorporateActionGeneralInformationSD48>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (EventGroup is EventGroup4Code EventGroupValue)
        {
    ...
    public static CorporateActionGeneralInformationSD48 Deserialize(XElement element)
    {
