...
public partial record CorporateActionNarrative16
     : IIsoXmlSerilizable<CorporateActionNarrative16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeclarationDetails is UpdatedAdditionalInformation5 DeclarationDetailsValue)
        {
    ...
    public static CorporateActionNarrative16 Deserialize(XElement element)
    {
