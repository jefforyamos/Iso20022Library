...
public partial record CorporateActionNarrative26
     : IIsoXmlSerilizable<CorporateActionNarrative26>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (URLAddress is UpdatedURLlnformation2 URLAddressValue)
        {
    ...
    public static CorporateActionNarrative26 Deserialize(XElement element)
    {
