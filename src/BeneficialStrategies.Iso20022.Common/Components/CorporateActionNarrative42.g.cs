...
public partial record CorporateActionNarrative42
     : IIsoXmlSerilizable<CorporateActionNarrative42>
{
    #nullable enable
    ...
    public static CorporateActionNarrative42 Deserialize(XElement element)
    {
