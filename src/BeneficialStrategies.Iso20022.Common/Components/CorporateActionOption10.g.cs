...
public partial record CorporateActionOption10
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OptionFeaturesFormat2Choice_> OptionFeatures { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption4> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption3> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
