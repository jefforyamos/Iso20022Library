...
public partial record CorporateActionOption100
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OfferTypeFormat5Choice_> OfferType { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption40> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption31> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
