...
public partial record CorporateActionOption100
     : IIsoXmlSerilizable<CorporateActionOption100>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DateDetails is CorporateActionDate29 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate45 RateAndAmountDetailsValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption40 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption31 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption100 Deserialize(XElement element)
    {
