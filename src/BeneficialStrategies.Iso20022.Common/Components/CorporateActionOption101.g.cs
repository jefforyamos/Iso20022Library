...
public partial record CorporateActionOption101
     : IIsoXmlSerilizable<CorporateActionOption101>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionFeatures is OptionFeaturesFormat12Choice_ OptionFeaturesValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate44 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption32 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption101 Deserialize(XElement element)
    {
