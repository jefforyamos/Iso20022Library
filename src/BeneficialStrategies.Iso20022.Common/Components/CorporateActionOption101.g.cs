...
public partial record CorporateActionOption101
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OptionFeaturesFormat12Choice_> OptionFeatures { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<CashOption32> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
