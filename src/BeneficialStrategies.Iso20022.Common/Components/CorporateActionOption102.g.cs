...
public partial record CorporateActionOption102
     : IIsoXmlSerilizable<CorporateActionOption102>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashMovementDetails is CashOption30 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption102 Deserialize(XElement element)
    {
