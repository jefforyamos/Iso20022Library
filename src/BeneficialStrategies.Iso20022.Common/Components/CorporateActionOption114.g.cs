...
public partial record CorporateActionOption114
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OptionFeaturesFormat16Choice_> OptionFeatures { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption49> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption43> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
