...
public partial record CorporateActionOption114
     : IIsoXmlSerilizable<CorporateActionOption114>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionFeatures is OptionFeaturesFormat16Choice_ OptionFeaturesValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate68 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption43 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption114 Deserialize(XElement element)
    {
