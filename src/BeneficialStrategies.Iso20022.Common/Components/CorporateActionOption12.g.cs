...
public partial record CorporateActionOption12
     : IIsoXmlSerilizable<CorporateActionOption12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesMovementDetails is SecuritiesOption5 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption5 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption12 Deserialize(XElement element)
    {
