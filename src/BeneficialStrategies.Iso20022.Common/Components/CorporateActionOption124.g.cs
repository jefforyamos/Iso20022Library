...
public partial record CorporateActionOption124
     : IIsoXmlSerilizable<CorporateActionOption124>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate74 RateAndAmountDetailsValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption55 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption46 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption124 Deserialize(XElement element)
    {
