...
public partial record CorporateActionOption124
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption55> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement related to a corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption46> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
