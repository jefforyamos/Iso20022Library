...
public partial record CorporateActionOption125
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OptionFeaturesFormat20Choice_> OptionFeatures { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption57> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption47> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
