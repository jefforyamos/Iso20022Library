...
public partial record CorporateActionOption125
     : IIsoXmlSerilizable<CorporateActionOption125>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionFeatures is OptionFeaturesFormat20Choice_ OptionFeaturesValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate76 RateAndAmountDetailsValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption57 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption47 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption125 Deserialize(XElement element)
    {
