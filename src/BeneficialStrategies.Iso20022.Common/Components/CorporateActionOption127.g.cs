...
public partial record CorporateActionOption127
{
    ...
    /// </summary>
    public OptionFeaturesFormat21Choice_[] OptionFeatures { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public CashOption49[] CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
