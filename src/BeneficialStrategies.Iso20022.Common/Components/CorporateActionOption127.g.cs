...
public partial record CorporateActionOption127
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OptionFeaturesFormat21Choice_> OptionFeatures { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<CashOption49> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
