...
public partial record CorporateActionOption127
     : IIsoXmlSerilizable<CorporateActionOption127>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionFeatures is OptionFeaturesFormat21Choice_ OptionFeaturesValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate79 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption49 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption127 Deserialize(XElement element)
    {
