...
public partial record CorporateActionOption130
     : IIsoXmlSerilizable<CorporateActionOption130>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate80 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption50 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption130 Deserialize(XElement element)
    {
