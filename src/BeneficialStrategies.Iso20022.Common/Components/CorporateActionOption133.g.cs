...
public partial record CorporateActionOption133
     : IIsoXmlSerilizable<CorporateActionOption133>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate83 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption53 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption133 Deserialize(XElement element)
    {
