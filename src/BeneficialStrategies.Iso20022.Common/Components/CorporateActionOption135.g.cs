...
public partial record CorporateActionOption135
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OptionFeaturesFormat23Choice_> OptionFeatures { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption61> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption54> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
