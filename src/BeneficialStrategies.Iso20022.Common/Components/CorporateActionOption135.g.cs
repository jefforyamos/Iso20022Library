...
public partial record CorporateActionOption135
     : IIsoXmlSerilizable<CorporateActionOption135>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionFeatures is OptionFeaturesFormat23Choice_ OptionFeaturesValue)
        {
        ...
        if (DateDetails is CorporateActionDate55 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate84 RateAndAmountDetailsValue)
        {
            writer.WriteStartElement(null, "RateAndAmtDtls", xmlNamespace );
            RateAndAmountDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PriceDetails is CorporateActionPrice65 PriceDetailsValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption61 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption54 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption135 Deserialize(XElement element)
    {
