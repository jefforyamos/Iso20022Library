...
public partial record CorporateActionOption138
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption64> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption56> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
