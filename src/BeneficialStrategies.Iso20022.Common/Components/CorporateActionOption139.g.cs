...
public partial record CorporateActionOption139
     : IIsoXmlSerilizable<CorporateActionOption139>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashMovementDetails is CashOption57 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption139 Deserialize(XElement element)
    {
