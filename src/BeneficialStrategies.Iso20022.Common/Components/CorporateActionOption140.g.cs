...
public partial record CorporateActionOption140
     : IIsoXmlSerilizable<CorporateActionOption140>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DateDetails is CorporateActionDate60 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate88 RateAndAmountDetailsValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption65 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption58 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption140 Deserialize(XElement element)
    {
