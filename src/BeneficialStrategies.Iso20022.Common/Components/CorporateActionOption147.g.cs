...
public partial record CorporateActionOption147
     : IIsoXmlSerilizable<CorporateActionOption147>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DateDetails is CorporateActionDate68 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate92 RateAndAmountDetailsValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption67 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption60 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption147 Deserialize(XElement element)
    {
