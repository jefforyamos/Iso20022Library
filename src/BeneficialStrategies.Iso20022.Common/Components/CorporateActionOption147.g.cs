...
public partial record CorporateActionOption147
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption67> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement related to a corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption60> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
