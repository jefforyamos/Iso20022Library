...
public partial record CorporateActionOption148
     : IIsoXmlSerilizable<CorporateActionOption148>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DateDetails is CorporateActionDate71 DateDetailsValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption68 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption61 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption148 Deserialize(XElement element)
    {
