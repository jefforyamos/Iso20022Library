...
public partial record CorporateActionOption148
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption68> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption61> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
