...
public partial record CorporateActionOption150
     : IIsoXmlSerilizable<CorporateActionOption150>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashMovementDetails is CashOption63 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption150 Deserialize(XElement element)
    {
