...
public partial record CorporateActionOption152
     : IIsoXmlSerilizable<CorporateActionOption152>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashMovementDetails is CashOption65 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption152 Deserialize(XElement element)
    {
