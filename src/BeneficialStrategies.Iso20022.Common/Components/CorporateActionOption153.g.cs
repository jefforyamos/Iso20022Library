...
public partial record CorporateActionOption153
     : IIsoXmlSerilizable<CorporateActionOption153>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate86 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption66 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption153 Deserialize(XElement element)
    {
