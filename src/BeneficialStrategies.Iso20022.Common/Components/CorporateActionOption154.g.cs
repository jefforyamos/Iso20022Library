...
public partial record CorporateActionOption154
     : IIsoXmlSerilizable<CorporateActionOption154>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashMovementDetails is CashOption64 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption154 Deserialize(XElement element)
    {
