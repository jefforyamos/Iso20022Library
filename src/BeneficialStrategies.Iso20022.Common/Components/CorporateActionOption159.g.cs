...
public partial record CorporateActionOption159
     : IIsoXmlSerilizable<CorporateActionOption159>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashMovementDetails is CashOption67 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption159 Deserialize(XElement element)
    {
