...
public partial record CorporateActionOption160
     : IIsoXmlSerilizable<CorporateActionOption160>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DateDetails is CorporateActionDate76 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate94 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption68 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption160 Deserialize(XElement element)
    {
