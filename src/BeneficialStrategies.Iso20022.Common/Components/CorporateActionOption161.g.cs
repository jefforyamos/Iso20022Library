...
public partial record CorporateActionOption161
     : IIsoXmlSerilizable<CorporateActionOption161>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate97 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption69 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption161 Deserialize(XElement element)
    {
