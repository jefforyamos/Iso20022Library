...
public partial record CorporateActionOption162
     : IIsoXmlSerilizable<CorporateActionOption162>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate98 RateAndAmountDetailsValue)
        {
    ...
    public static CorporateActionOption162 Deserialize(XElement element)
    {
