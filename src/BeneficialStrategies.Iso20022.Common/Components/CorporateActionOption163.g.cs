...
public partial record CorporateActionOption163
     : IIsoXmlSerilizable<CorporateActionOption163>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate99 RateAndAmountDetailsValue)
        {
    ...
    public static CorporateActionOption163 Deserialize(XElement element)
    {
