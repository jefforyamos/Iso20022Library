...
public partial record CorporateActionOption174
     : IIsoXmlSerilizable<CorporateActionOption174>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate102 RateAndAmountDetailsValue)
        {
    ...
    public static CorporateActionOption174 Deserialize(XElement element)
    {
