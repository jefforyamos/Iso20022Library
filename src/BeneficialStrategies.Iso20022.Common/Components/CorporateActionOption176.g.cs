...
public partial record CorporateActionOption176
     : IIsoXmlSerilizable<CorporateActionOption176>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RateAndAmountDetails is CorporateActionRate103 RateAndAmountDetailsValue)
        {
    ...
    public static CorporateActionOption176 Deserialize(XElement element)
    {
