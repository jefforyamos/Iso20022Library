...
public partial record CorporateActionOption177
     : IIsoXmlSerilizable<CorporateActionOption177>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PriceDetails is CorporateActionPrice70 PriceDetailsValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption71 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption71 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption177 Deserialize(XElement element)
    {
