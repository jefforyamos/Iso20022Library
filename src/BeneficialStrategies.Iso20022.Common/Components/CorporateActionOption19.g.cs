...
public partial record CorporateActionOption19
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OptionFeaturesFormat5Choice_> OptionFeatures { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption14> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption10> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
