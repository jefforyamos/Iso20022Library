...
public partial record CorporateActionOption191
     : IIsoXmlSerilizable<CorporateActionOption191>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PriceDetails is CorporateActionPrice71 PriceDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption75 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption191 Deserialize(XElement element)
    {
