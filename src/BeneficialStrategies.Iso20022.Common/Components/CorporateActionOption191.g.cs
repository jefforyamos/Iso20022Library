...
public partial record CorporateActionOption191
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption75> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption75> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
