...
public partial record CorporateActionOption193
     : IIsoXmlSerilizable<CorporateActionOption193>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OfferType is OfferTypeFormat12Choice_ OfferTypeValue)
        {
            writer.WriteStartElement(null, "OfferTp", xmlNamespace );
            OfferTypeValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (OptionFeatures is OptionFeaturesFormat24Choice_ OptionFeaturesValue)
        {
        ...
        if (DateDetails is CorporateActionDate77 DateDetailsValue)
        {
    ...
    public static CorporateActionOption193 Deserialize(XElement element)
    {
