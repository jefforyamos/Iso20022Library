...
public partial record CorporateActionOption194
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption77> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption78> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
