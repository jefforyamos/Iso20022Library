...
public partial record CorporateActionOption194
     : IIsoXmlSerilizable<CorporateActionOption194>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DateDetails is CorporateActionDate78 DateDetailsValue)
        {
        ...
        if (RateAndAmountDetails is CorporateActionRate106 RateAndAmountDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOption78 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption194 Deserialize(XElement element)
    {
