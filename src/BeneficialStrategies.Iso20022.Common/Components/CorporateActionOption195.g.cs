...
public partial record CorporateActionOption195
     : IIsoXmlSerilizable<CorporateActionOption195>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption78 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption79 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption195 Deserialize(XElement element)
    {
