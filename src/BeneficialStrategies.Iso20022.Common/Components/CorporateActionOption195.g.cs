...
public partial record CorporateActionOption195
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption78> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement related to a corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption79> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
