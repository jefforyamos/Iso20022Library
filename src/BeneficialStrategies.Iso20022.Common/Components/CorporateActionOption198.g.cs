...
public partial record CorporateActionOption198
     : IIsoXmlSerilizable<CorporateActionOption198>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PriceDetails is CorporateActionPrice76 PriceDetailsValue)
        {
    ...
    public static CorporateActionOption198 Deserialize(XElement element)
    {
