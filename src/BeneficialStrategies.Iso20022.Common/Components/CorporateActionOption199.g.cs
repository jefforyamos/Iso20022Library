...
public partial record CorporateActionOption199
     : IIsoXmlSerilizable<CorporateActionOption199>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesMovementDetails is SecuritiesOption80 SecuritiesMovementDetailsValue)
        {
    ...
    public static CorporateActionOption199 Deserialize(XElement element)
    {
