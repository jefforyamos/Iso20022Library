...
public partial record CorporateActionOption20
     : IIsoXmlSerilizable<CorporateActionOption20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionFeatures is OptionFeaturesFormat6Choice_ OptionFeaturesValue)
        {
            writer.WriteStartElement(null, "OptnFeatrs", xmlNamespace );
            OptionFeaturesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (IntermediateSecuritiesDistributionType is IntermediateSecuritiesDistributionTypeFormat6Choice_ IntermediateSecuritiesDistributionTypeValue)
        {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption13 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption11 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption20 Deserialize(XElement element)
    {
