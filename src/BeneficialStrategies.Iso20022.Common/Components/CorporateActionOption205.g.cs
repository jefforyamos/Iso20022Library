...
public partial record CorporateActionOption205
     : IIsoXmlSerilizable<CorporateActionOption205>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption87 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption80 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption205 Deserialize(XElement element)
    {
