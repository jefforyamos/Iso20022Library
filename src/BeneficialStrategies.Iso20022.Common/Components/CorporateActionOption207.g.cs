...
public partial record CorporateActionOption207
     : IIsoXmlSerilizable<CorporateActionOption207>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesMovementDetails is SecuritiesOption86 SecuritiesMovementDetailsValue)
        {
    ...
    public static CorporateActionOption207 Deserialize(XElement element)
    {
