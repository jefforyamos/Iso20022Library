...
public partial record CorporateActionOption209
     : IIsoXmlSerilizable<CorporateActionOption209>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashMovementDetails is CashOption84 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption209 Deserialize(XElement element)
    {
