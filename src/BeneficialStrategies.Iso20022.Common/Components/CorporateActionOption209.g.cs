...
public partial record CorporateActionOption209
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption92> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption84> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
