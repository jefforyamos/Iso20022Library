...
public partial record CorporateActionOption210
     : IIsoXmlSerilizable<CorporateActionOption210>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption92 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption83 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption210 Deserialize(XElement element)
    {
