...
public partial record CorporateActionOption214
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption96> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption88> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
