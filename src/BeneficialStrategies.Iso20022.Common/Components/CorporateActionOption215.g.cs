...
public partial record CorporateActionOption215
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption97> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement related to a corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption89> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
