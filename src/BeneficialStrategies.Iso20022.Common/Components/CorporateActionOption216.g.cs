...
public partial record CorporateActionOption216
     : IIsoXmlSerilizable<CorporateActionOption216>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption98 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption90 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption216 Deserialize(XElement element)
    {
