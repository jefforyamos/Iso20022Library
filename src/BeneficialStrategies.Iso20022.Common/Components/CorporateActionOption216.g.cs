...
public partial record CorporateActionOption216
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption98> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption90> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
