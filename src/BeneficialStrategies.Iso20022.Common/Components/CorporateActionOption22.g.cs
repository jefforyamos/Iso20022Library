...
public partial record CorporateActionOption22
     : IIsoXmlSerilizable<CorporateActionOption22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AccountOwner is PartyIdentification41Choice_ AccountOwnerValue)
        {
    ...
    public static CorporateActionOption22 Deserialize(XElement element)
    {
