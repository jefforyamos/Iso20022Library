...
public partial record CorporateActionOption24
     : IIsoXmlSerilizable<CorporateActionOption24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesMovementDetails is SecuritiesOption19 SecuritiesMovementDetailsValue)
        {
    ...
    public static CorporateActionOption24 Deserialize(XElement element)
    {
