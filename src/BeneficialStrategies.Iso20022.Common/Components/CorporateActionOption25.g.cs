...
public partial record CorporateActionOption25
     : IIsoXmlSerilizable<CorporateActionOption25>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PriceDetails is CorporateActionPrice19 PriceDetailsValue)
        {
    ...
    public static CorporateActionOption25 Deserialize(XElement element)
    {
