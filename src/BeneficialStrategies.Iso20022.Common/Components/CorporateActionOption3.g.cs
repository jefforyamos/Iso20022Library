...
public partial record CorporateActionOption3
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption6> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption4> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
