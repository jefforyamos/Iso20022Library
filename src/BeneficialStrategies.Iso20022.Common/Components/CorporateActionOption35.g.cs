...
public partial record CorporateActionOption35
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption24> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption16> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
