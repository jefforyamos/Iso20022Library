...
public partial record CorporateActionOption35
     : IIsoXmlSerilizable<CorporateActionOption35>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption24 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption16 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption35 Deserialize(XElement element)
    {
