...
public partial record CorporateActionOption36
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption25> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption17> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
