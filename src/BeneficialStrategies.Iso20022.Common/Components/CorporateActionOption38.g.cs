...
public partial record CorporateActionOption38
     : IIsoXmlSerilizable<CorporateActionOption38>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FractionDisposition is FractionDispositionType10Choice_ FractionDispositionValue)
        {
    ...
    public static CorporateActionOption38 Deserialize(XElement element)
    {
