...
//
// Generated by ComponentGenerator for CorporateActionOption39.  ISO2002 ID# _gsrpQfo9EeCdeaSQAR2tKw.
//
...
public partial record CorporateActionOption39
     : IIsoXmlSerilizable<CorporateActionOption39>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesMovementDetails is SecuritiesOption27 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption19 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption39 Deserialize(XElement element)
    {
