...
public partial record CorporateActionOption4
     : IIsoXmlSerilizable<CorporateActionOption4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesMovementDetails is SecuritiesOption3 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashMovementDetails is CashOption2 CashMovementDetailsValue)
        {
    ...
    public static CorporateActionOption4 Deserialize(XElement element)
    {
