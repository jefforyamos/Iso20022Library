...
public partial record CorporateActionOption4
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption3> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement related to a corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption2> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
