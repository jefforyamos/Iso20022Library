...
public partial record CorporateActionOption5
     : IIsoXmlSerilizable<CorporateActionOption5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FractionDisposition is FractionDispositionType2Choice_ FractionDispositionValue)
        {
        ...
        if (PriceDetails is CorporateActionPrice8 PriceDetailsValue)
        {
    ...
    public static CorporateActionOption5 Deserialize(XElement element)
    {
