...
public partial record CorporateActionOption52
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption38> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement linked to the corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption25> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
