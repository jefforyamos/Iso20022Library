...
public partial record CorporateActionOption53
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecuritiesOption35> SecuritiesMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides information about the cash movement related to a corporate action option.
    /// </summary>
    [DataMember]
    public ValueList<CashOption26> CashMovementDetails { get; init; } = []; // Warning: Don't know multiplicity.
