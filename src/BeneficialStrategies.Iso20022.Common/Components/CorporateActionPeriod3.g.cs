...
public partial record CorporateActionPeriod3
{
    ...
    /// </summary>
    public IPeriod1Choice? InterestPeriod { get; init; } 
    /// <summary>
    /// Period during a take-over where any outstanding equity must be purchased by the take-over company.
    /// </summary>
    public IPeriod1Choice? CompulsoryPurchasePeriod { get; init; } 
    /// <summary>
    /// Period during which the security is blocked.
    /// </summary>
    public IPeriod1Choice? BlockingPeriod { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? ClaimPeriod { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? DepositorySuspensionPeriodForBookEntryTransfer { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? DepositorySuspensionPeriodForDepositAtAgent { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? DepositorySuspensionPeriodForDeposit { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? DepositorySuspensionPeriodForPledge { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? DepositorySuspensionPeriodForSegregation { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? DepositorySuspensionPeriodForWithdrawalAtAgent { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? DepositorySuspensionPeriodForWithdrawalInNomineeName { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? DepositorySuspensionPeriodForWithdrawalInStreetName { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IPeriod1Choice? BookClosurePeriod { get; init; } 
