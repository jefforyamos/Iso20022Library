...
public partial record CorporateActionPrice59
     : IIsoXmlSerilizable<CorporateActionPrice59>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GenericCashPriceReceivedPerProduct is PriceFormat48Choice_ GenericCashPriceReceivedPerProductValue)
        {
    ...
    public static CorporateActionPrice59 Deserialize(XElement element)
    {
