...
public partial record CorporateActionPrice60
     : IIsoXmlSerilizable<CorporateActionPrice60>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GenericCashPriceReceivedPerProduct is PriceFormat49Choice_ GenericCashPriceReceivedPerProductValue)
        {
    ...
    public static CorporateActionPrice60 Deserialize(XElement element)
    {
