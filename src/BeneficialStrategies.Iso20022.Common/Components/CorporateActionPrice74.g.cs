...
public partial record CorporateActionPrice74
     : IIsoXmlSerilizable<CorporateActionPrice74>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GenericCashPricePaidPerProduct is PriceFormat51Choice_ GenericCashPricePaidPerProductValue)
        {
        ...
        if (GenericCashPriceReceivedPerProduct is PriceFormat64Choice_ GenericCashPriceReceivedPerProductValue)
        {
    ...
    public static CorporateActionPrice74 Deserialize(XElement element)
    {
