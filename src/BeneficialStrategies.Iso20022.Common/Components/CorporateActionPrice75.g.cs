...
public partial record CorporateActionPrice75
     : IIsoXmlSerilizable<CorporateActionPrice75>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GenericCashPriceReceivedPerProduct is PriceFormat65Choice_ GenericCashPriceReceivedPerProductValue)
        {
    ...
    public static CorporateActionPrice75 Deserialize(XElement element)
    {
