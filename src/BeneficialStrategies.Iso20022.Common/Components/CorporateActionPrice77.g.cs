...
public partial record CorporateActionPrice77
     : IIsoXmlSerilizable<CorporateActionPrice77>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GenericCashPriceReceivedPerProduct is PriceFormat67Choice_ GenericCashPriceReceivedPerProductValue)
        {
    ...
    public static CorporateActionPrice77 Deserialize(XElement element)
    {
