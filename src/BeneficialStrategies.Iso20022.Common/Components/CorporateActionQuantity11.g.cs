...
public partial record CorporateActionQuantity11
     : IIsoXmlSerilizable<CorporateActionQuantity11>
{
    #nullable enable
    ...
    {
        if (MaximumQuantity is FinancialInstrumentQuantity34Choice_ MaximumQuantityValue)
        {
            writer.WriteStartElement(null, "MaxQty", xmlNamespace );
            MaximumQuantityValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (MinimumQuantitySought is FinancialInstrumentQuantity34Choice_ MinimumQuantitySoughtValue)
        {
    ...
    public static CorporateActionQuantity11 Deserialize(XElement element)
    {
