...
public partial record CorporateActionQuantity8
     : IIsoXmlSerilizable<CorporateActionQuantity8>
{
    #nullable enable
    ...
    {
        if (MaximumQuantity is FinancialInstrumentQuantity21Choice_ MaximumQuantityValue)
        {
            writer.WriteStartElement(null, "MaxQty", xmlNamespace );
            MaximumQuantityValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (MinimumQuantitySought is FinancialInstrumentQuantity21Choice_ MinimumQuantitySoughtValue)
        {
    ...
    public static CorporateActionQuantity8 Deserialize(XElement element)
    {
