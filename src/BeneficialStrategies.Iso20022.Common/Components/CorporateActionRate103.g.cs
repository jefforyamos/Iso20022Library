...
public partial record CorporateActionRate103
{
    ...
    /// </summary>
    public GrossDividendRateFormat41Choice_[] GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Cash dividend amount per equity after deductions or allowances have been made.
    /// </summary>
    public NetDividendRateFormat43Choice_[] NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
