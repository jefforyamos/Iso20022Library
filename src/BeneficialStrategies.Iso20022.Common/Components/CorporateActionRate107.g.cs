...
public partial record CorporateActionRate107
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat35Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Cash dividend amount per equity after deductions or allowances have been made.
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat37Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
