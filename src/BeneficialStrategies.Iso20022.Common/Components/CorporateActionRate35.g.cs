...
public partial record CorporateActionRate35
     : IIsoXmlSerilizable<CorporateActionRate35>
{
    #nullable enable
    ...
    public static CorporateActionRate35 Deserialize(XElement element)
    {
