...
public partial record CorporateActionRate66
     : IIsoXmlSerilizable<CorporateActionRate66>
{
    #nullable enable
    ...
    {
        if (Interest is RateAndAmountFormat37Choice_ InterestValue)
        {
    ...
    public static CorporateActionRate66 Deserialize(XElement element)
    {
