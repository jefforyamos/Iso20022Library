...
public partial record CorporateActionRate68
     : IIsoXmlSerilizable<CorporateActionRate68>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat19Choice_ GrossDividendRateValue)
        {
            writer.WriteStartElement(null, "GrssDvddRate", xmlNamespace );
            GrossDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NetDividendRate is NetDividendRateFormat21Choice_ NetDividendRateValue)
        {
    ...
    public static CorporateActionRate68 Deserialize(XElement element)
    {
