...
public partial record CorporateActionRate69
     : IIsoXmlSerilizable<CorporateActionRate69>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TaxCreditRate is TaxCreditRateFormat8Choice_ TaxCreditRateValue)
        {
    ...
    public static CorporateActionRate69 Deserialize(XElement element)
    {
