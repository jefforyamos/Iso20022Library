...
public partial record CorporateActionRate71
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<RateAndAmountFormat40Choice_> RequestedWithholdingTaxRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<RateAndAmountFormat40Choice_> RequestedSecondLevelTaxRate { get; init; } = []; // Warning: Don't know multiplicity.
