...
public partial record CorporateActionRate74
     : IIsoXmlSerilizable<CorporateActionRate74>
{
    #nullable enable
    ...
    {
        if (GrossDividendRate is GrossDividendRateFormat23Choice_ GrossDividendRateValue)
        {
            writer.WriteStartElement(null, "GrssDvddRate", xmlNamespace );
            GrossDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NetDividendRate is NetDividendRateFormat25Choice_ NetDividendRateValue)
        {
            writer.WriteStartElement(null, "NetDvddRate", xmlNamespace );
            NetDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (IndexFactor is RateAndAmountFormat43Choice_ IndexFactorValue)
        {
    ...
    public static CorporateActionRate74 Deserialize(XElement element)
    {
