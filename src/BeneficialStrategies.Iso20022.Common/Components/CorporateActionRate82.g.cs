...
public partial record CorporateActionRate82
     : IIsoXmlSerilizable<CorporateActionRate82>
{
    #nullable enable
    ...
    {
        if (GrossDividendRate is GrossDividendRateFormat21Choice_ GrossDividendRateValue)
        {
            writer.WriteStartElement(null, "GrssDvddRate", xmlNamespace );
            GrossDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NetDividendRate is NetDividendRateFormat23Choice_ NetDividendRateValue)
        {
    ...
    public static CorporateActionRate82 Deserialize(XElement element)
    {
