...
public partial record CorporateActionRate84
     : IIsoXmlSerilizable<CorporateActionRate84>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat25Choice_ GrossDividendRateValue)
        {
            writer.WriteStartElement(null, "GrssDvddRate", xmlNamespace );
            GrossDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NetDividendRate is NetDividendRateFormat27Choice_ NetDividendRateValue)
        {
    ...
    public static CorporateActionRate84 Deserialize(XElement element)
    {
