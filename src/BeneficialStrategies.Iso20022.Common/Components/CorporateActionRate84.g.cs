...
public partial record CorporateActionRate84
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat25Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Cash dividend amount per equity after deductions or allowances have been made.
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat27Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
