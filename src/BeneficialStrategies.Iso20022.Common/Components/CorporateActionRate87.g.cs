...
public partial record CorporateActionRate87
     : IIsoXmlSerilizable<CorporateActionRate87>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat27Choice_ GrossDividendRateValue)
        {
            writer.WriteStartElement(null, "GrssDvddRate", xmlNamespace );
            GrossDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NetDividendRate is NetDividendRateFormat29Choice_ NetDividendRateValue)
        {
    ...
    public static CorporateActionRate87 Deserialize(XElement element)
    {
