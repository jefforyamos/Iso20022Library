...
public partial record CorporateActionRate87
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat27Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Cash dividend amount per equity after deductions or allowances have been made.
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat29Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
