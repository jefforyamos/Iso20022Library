...
public partial record CorporateActionRate88
     : IIsoXmlSerilizable<CorporateActionRate88>
{
    #nullable enable
    ...
    {
        if (GrossDividendRate is GrossDividendRateFormat28Choice_ GrossDividendRateValue)
        {
            writer.WriteStartElement(null, "GrssDvddRate", xmlNamespace );
            GrossDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NetDividendRate is NetDividendRateFormat30Choice_ NetDividendRateValue)
        {
    ...
    public static CorporateActionRate88 Deserialize(XElement element)
    {
