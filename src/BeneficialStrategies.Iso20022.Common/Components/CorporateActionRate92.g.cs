...
public partial record CorporateActionRate92
     : IIsoXmlSerilizable<CorporateActionRate92>
{
    #nullable enable
    ...
    {
        if (GrossDividendRate is GrossDividendRateFormat31Choice_ GrossDividendRateValue)
        {
            writer.WriteStartElement(null, "GrssDvddRate", xmlNamespace );
            GrossDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NetDividendRate is NetDividendRateFormat33Choice_ NetDividendRateValue)
        {
    ...
    public static CorporateActionRate92 Deserialize(XElement element)
    {
