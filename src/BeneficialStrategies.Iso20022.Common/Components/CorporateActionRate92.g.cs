...
public partial record CorporateActionRate92
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat31Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Cash dividend amount per equity after deductions or allowances have been made.
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat33Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
