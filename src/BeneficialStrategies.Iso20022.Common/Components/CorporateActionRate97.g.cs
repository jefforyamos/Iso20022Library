...
public partial record CorporateActionRate97
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat33Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Cash dividend amount per equity after deductions or allowances have been made.
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat35Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
