...
public partial record CorporateActionRate97
     : IIsoXmlSerilizable<CorporateActionRate97>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat33Choice_ GrossDividendRateValue)
        {
            writer.WriteStartElement(null, "GrssDvddRate", xmlNamespace );
            GrossDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NetDividendRate is NetDividendRateFormat35Choice_ NetDividendRateValue)
        {
    ...
    public static CorporateActionRate97 Deserialize(XElement element)
    {
