...
public partial record CorporateActionSD13
     : IIsoXmlSerilizable<CorporateActionSD13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DividendType is CorporateActionFrequencyType4Code DividendTypeValue)
        {
            writer.WriteStartElement(null, "DvddTp", xmlNamespace );
            writer.WriteValue(DividendTypeValue.ToString()); // Enum value
            writer.WriteEndElement();
        }
    }
    public static CorporateActionSD13 Deserialize(XElement element)
    {
