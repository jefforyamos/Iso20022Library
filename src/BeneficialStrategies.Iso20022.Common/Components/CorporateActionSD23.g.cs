...
public partial record CorporateActionSD23
     : IIsoXmlSerilizable<CorporateActionSD23>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DissenterRightsApplicableFlag is IsoYesNoIndicator DissenterRightsApplicableFlagValue)
        {
            writer.WriteStartElement(null, "DsstrRghtsAplblFlg", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoYesNoIndicator(DissenterRightsApplicableFlagValue)); // data type YesNoIndicator System.String
            writer.WriteEndElement();
        }
        if (NonExemptAllowedIndicator is IsoYesNoIndicator NonExemptAllowedIndicatorValue)
        {
            writer.WriteStartElement(null, "NonXmptAllwdInd", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoYesNoIndicator(NonExemptAllowedIndicatorValue)); // data type YesNoIndicator System.String
            writer.WriteEndElement();
        }
        if (DTCInstructionLockoutIndicator is InstructionLockoutType1Code DTCInstructionLockoutIndicatorValue)
        {
            writer.WriteStartElement(null, "DTCInstrLckoutInd", xmlNamespace );
            writer.WriteValue(DTCInstructionLockoutIndicatorValue.ToString()); // Enum value
            writer.WriteEndElement();
        }
        if (CertificateDetails is CorporateActionSD15 CertificateDetailsValue)
        {
        ...
        if (DTCForeignTaxElectionFlag is IsoYesNoIndicator DTCForeignTaxElectionFlagValue)
        {
            writer.WriteStartElement(null, "DTCFrgnTaxElctnFlg", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoYesNoIndicator(DTCForeignTaxElectionFlagValue)); // data type YesNoIndicator System.String
            writer.WriteEndElement();
        }
    }
    public static CorporateActionSD23 Deserialize(XElement element)
    {
