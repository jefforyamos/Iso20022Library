...
public partial record CorporateActionSD3
     : IIsoXmlSerilizable<CorporateActionSD3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DTCInstructionLockoutIndicator is InstructionLockout1Code DTCInstructionLockoutIndicatorValue)
        {
        ...
        if (InterimFinalIndicator is InterimFinalPayment1Code InterimFinalIndicatorValue)
        {
            writer.WriteStartElement(null, "IntrmFnlInd", xmlNamespace );
            writer.WriteValue(InterimFinalIndicatorValue.ToString()); // Enum value
            writer.WriteEndElement();
        }
    ...
    public static CorporateActionSD3 Deserialize(XElement element)
    {
