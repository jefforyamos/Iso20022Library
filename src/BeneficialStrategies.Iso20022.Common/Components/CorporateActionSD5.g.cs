...
public partial record CorporateActionSD5
     : IIsoXmlSerilizable<CorporateActionSD5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoMax15NumericText(CertificateNumber)); // data type Max15NumericText System.String
    ...
    public static CorporateActionSD5 Deserialize(XElement element)
    {
