...
public partial record CorporateActionUnallocatedCashTransactionDetailsSD2
     : IIsoXmlSerilizable<CorporateActionUnallocatedCashTransactionDetailsSD2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnallocatedReasonCode is DTCUnallocatedAdjustmentReason1Code UnallocatedReasonCodeValue)
        {
    ...
    public static CorporateActionUnallocatedCashTransactionDetailsSD2 Deserialize(XElement element)
    {
