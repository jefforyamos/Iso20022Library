...
public partial record CorporateActionUnallocatedDetailsSD6
     : IIsoXmlSerilizable<CorporateActionUnallocatedDetailsSD6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnallocatedSecuritiesTransactionDetails is CorporateActionUnallocatedSecuritiesTransactionDetailsSD7 UnallocatedSecuritiesTransactionDetailsValue)
        {
        ...
        if (UnallocatedCashTransactionDetails is CorporateActionUnallocatedCashTransactionDetailsSD6 UnallocatedCashTransactionDetailsValue)
        {
    ...
    public static CorporateActionUnallocatedDetailsSD6 Deserialize(XElement element)
    {
