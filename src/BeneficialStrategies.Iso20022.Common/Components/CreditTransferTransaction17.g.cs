...
public partial record CreditTransferTransaction17
     : IIsoXmlSerilizable<CreditTransferTransaction17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnderlyingCustomerCreditTransfer is CreditTransferTransaction18 UnderlyingCustomerCreditTransferValue)
        {
    ...
    public static CreditTransferTransaction17 Deserialize(XElement element)
    {
