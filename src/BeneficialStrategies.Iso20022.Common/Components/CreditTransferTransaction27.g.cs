...
public partial record CreditTransferTransaction27
     : IIsoXmlSerilizable<CreditTransferTransaction27>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RemittanceInformation is RemittanceInformation14 RemittanceInformationValue)
        {
    ...
    public static CreditTransferTransaction27 Deserialize(XElement element)
    {
