...
public partial record CreditTransferTransaction32
     : IIsoXmlSerilizable<CreditTransferTransaction32>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (InitiatingParty is PartyIdentification125 InitiatingPartyValue)
        {
    ...
    public static CreditTransferTransaction32 Deserialize(XElement element)
    {
