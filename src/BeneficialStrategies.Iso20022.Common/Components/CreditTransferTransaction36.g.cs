...
public partial record CreditTransferTransaction36
     : IIsoXmlSerilizable<CreditTransferTransaction36>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UltimateDebtor is BranchAndFinancialInstitutionIdentification6 UltimateDebtorValue)
        {
        ...
        if (UnderlyingCustomerCreditTransfer is CreditTransferTransaction37 UnderlyingCustomerCreditTransferValue)
        {
    ...
    public static CreditTransferTransaction36 Deserialize(XElement element)
    {
