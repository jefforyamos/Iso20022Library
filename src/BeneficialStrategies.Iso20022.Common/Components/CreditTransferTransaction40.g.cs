...
public partial record CreditTransferTransaction40
     : IIsoXmlSerilizable<CreditTransferTransaction40>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (InstructionForDebtorAgent is InstructionForDebtorAgent1 InstructionForDebtorAgentValue)
        {
            writer.WriteStartElement(null, "InstrForDbtrAgt", xmlNamespace );
            InstructionForDebtorAgentValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    ...
    public static CreditTransferTransaction40 Deserialize(XElement element)
    {
