...
public partial record CreditTransferTransaction44
     : IIsoXmlSerilizable<CreditTransferTransaction44>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnderlyingCustomerCreditTransfer is CreditTransferTransaction45 UnderlyingCustomerCreditTransferValue)
        {
    ...
    public static CreditTransferTransaction44 Deserialize(XElement element)
    {
