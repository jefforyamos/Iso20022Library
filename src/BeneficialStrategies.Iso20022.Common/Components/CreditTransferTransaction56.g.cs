...
public partial record CreditTransferTransaction56
     : IIsoXmlSerilizable<CreditTransferTransaction56>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnderlyingCustomerCreditTransfer is CreditTransferTransaction52 UnderlyingCustomerCreditTransferValue)
        {
    ...
    public static CreditTransferTransaction56 Deserialize(XElement element)
    {
