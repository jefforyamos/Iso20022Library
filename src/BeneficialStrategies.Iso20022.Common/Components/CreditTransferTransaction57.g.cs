...
public partial record CreditTransferTransaction57
     : IIsoXmlSerilizable<CreditTransferTransaction57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ChequeInstruction is Cheque16 ChequeInstructionValue)
        {
    ...
    public static CreditTransferTransaction57 Deserialize(XElement element)
    {
