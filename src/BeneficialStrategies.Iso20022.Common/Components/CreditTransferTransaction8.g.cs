...
public partial record CreditTransferTransaction8
     : IIsoXmlSerilizable<CreditTransferTransaction8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnderlyingCustomerCreditTransfer is CreditTransferTransaction3 UnderlyingCustomerCreditTransferValue)
        {
    ...
    public static CreditTransferTransaction8 Deserialize(XElement element)
    {
