...
public partial record CreditTransferTransactionInformation13
     : IIsoXmlSerilizable<CreditTransferTransactionInformation13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PaymentTypeInformation is PaymentTypeInformation23 PaymentTypeInformationValue)
        {
        ...
        if (UltimateDebtor is BranchAndFinancialInstitutionIdentification4 UltimateDebtorValue)
        {
        ...
        if (UltimateCreditor is BranchAndFinancialInstitutionIdentification4 UltimateCreditorValue)
        {
        ...
        if (UnderlyingCustomerCreditTransfer is CreditTransferTransactionInformation12 UnderlyingCustomerCreditTransferValue)
        {
    ...
    public static CreditTransferTransactionInformation13 Deserialize(XElement element)
    {
