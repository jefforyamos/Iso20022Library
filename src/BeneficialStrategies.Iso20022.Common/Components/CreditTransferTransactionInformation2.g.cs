...
public partial record CreditTransferTransactionInformation2
     : IIsoXmlSerilizable<CreditTransferTransactionInformation2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PaymentTypeInformation is PaymentTypeInformation3 PaymentTypeInformationValue)
        {
        ...
        if (SettlementTimeRequest is SettlementTimeRequest1 SettlementTimeRequestValue)
        {
        ...
        if (PreviousInstructingAgent is BranchAndFinancialInstitutionIdentification3 PreviousInstructingAgentValue)
        {
            writer.WriteStartElement(null, "PrvsInstgAgt", xmlNamespace );
            PreviousInstructingAgentValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PreviousInstructingAgentAccount is CashAccount7 PreviousInstructingAgentAccountValue)
        {
    ...
    public static CreditTransferTransactionInformation2 Deserialize(XElement element)
    {
