...
public partial record CreditTransferTransactionInformation3
     : IIsoXmlSerilizable<CreditTransferTransactionInformation3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PaymentTypeInformation is PaymentTypeInformation5 PaymentTypeInformationValue)
        {
        ...
        if (UltimateDebtor is BranchAndFinancialInstitutionIdentification3 UltimateDebtorValue)
        {
        ...
        if (UltimateCreditor is BranchAndFinancialInstitutionIdentification3 UltimateCreditorValue)
        {
    ...
    public static CreditTransferTransactionInformation3 Deserialize(XElement element)
    {
