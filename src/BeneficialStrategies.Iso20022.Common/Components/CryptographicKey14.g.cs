...
public partial record CryptographicKey14
     : IIsoXmlSerilizable<CryptographicKey14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (KeyValue is ContentInformationType23 KeyValueValue)
        {
    ...
    public static CryptographicKey14 Deserialize(XElement element)
    {
