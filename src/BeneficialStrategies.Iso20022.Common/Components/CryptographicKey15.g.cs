...
public partial record CryptographicKey15
     : IIsoXmlSerilizable<CryptographicKey15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (KeyValue is ContentInformationType26 KeyValueValue)
        {
    ...
    public static CryptographicKey15 Deserialize(XElement element)
    {
