...
public partial record CurrencyConversion11
     : IIsoXmlSerilizable<CurrencyConversion11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ConversionDetails is CurrencyConversion12 ConversionDetailsValue)
        {
    ...
    public static CurrencyConversion11 Deserialize(XElement element)
    {
