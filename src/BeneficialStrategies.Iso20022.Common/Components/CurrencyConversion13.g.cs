...
public partial record CurrencyConversion13
     : IIsoXmlSerilizable<CurrencyConversion13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Conversion is CurrencyConversion12 ConversionValue)
        {
    ...
    public static CurrencyConversion13 Deserialize(XElement element)
    {
