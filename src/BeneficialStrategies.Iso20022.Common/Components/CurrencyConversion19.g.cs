...
public partial record CurrencyConversion19
     : IIsoXmlSerilizable<CurrencyConversion19>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeclarationDetails is ActionMessage7 DeclarationDetailsValue)
        {
    ...
    public static CurrencyConversion19 Deserialize(XElement element)
    {
