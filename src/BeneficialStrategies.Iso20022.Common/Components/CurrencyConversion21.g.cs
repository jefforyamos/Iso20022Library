...
public partial record CurrencyConversion21
     : IIsoXmlSerilizable<CurrencyConversion21>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Conversion is CurrencyConversion20 ConversionValue)
        {
    ...
    public static CurrencyConversion21 Deserialize(XElement element)
    {
