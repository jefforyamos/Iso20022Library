...
public partial record CurrencyConversion23
     : IIsoXmlSerilizable<CurrencyConversion23>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeclarationDetails is ActionMessage9 DeclarationDetailsValue)
        {
    ...
    public static CurrencyConversion23 Deserialize(XElement element)
    {
