...
public partial record CurrencyConversion7
     : IIsoXmlSerilizable<CurrencyConversion7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ConversionDetails is CurrencyConversion6 ConversionDetailsValue)
        {
    ...
    public static CurrencyConversion7 Deserialize(XElement element)
    {
