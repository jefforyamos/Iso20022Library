...
public partial record CurrencyConversion8
     : IIsoXmlSerilizable<CurrencyConversion8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Conversion is CurrencyConversion6 ConversionValue)
        {
    ...
    public static CurrencyConversion8 Deserialize(XElement element)
    {
