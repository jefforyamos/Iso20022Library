...
public partial record CurrencyExchange6
     : IIsoXmlSerilizable<CurrencyExchange6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Comments is IsoMax70Text CommentsValue)
        {
            writer.WriteStartElement(null, "Cmnts", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax70Text(CommentsValue)); // data type Max70Text System.String
            writer.WriteEndElement();
        }
    ...
    public static CurrencyExchange6 Deserialize(XElement element)
    {
