...
public partial record DeliverInformation14
     : IIsoXmlSerilizable<DeliverInformation14>
{
    #nullable enable
    ...
    public static DeliverInformation14 Deserialize(XElement element)
    {
