...
public partial record DeliverInformation17
     : IIsoXmlSerilizable<DeliverInformation17>
{
    #nullable enable
    ...
    {
        if (Transferor is PartyIdentification70Choice_ TransferorValue)
        {
            writer.WriteStartElement(null, "Trfr", xmlNamespace );
            TransferorValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TransferorRegisteredAccount is Account19 TransferorRegisteredAccountValue)
        {
        ...
        if (SettlementPartiesDetails is DeliveringPartiesAndAccount13 SettlementPartiesDetailsValue)
        {
    ...
    public static DeliverInformation17 Deserialize(XElement element)
    {
