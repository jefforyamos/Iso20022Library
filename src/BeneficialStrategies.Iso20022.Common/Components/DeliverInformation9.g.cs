...
public partial record DeliverInformation9
     : IIsoXmlSerilizable<DeliverInformation9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementPartiesDetails is DeliveringPartiesAndAccount8 SettlementPartiesDetailsValue)
        {
    ...
    public static DeliverInformation9 Deserialize(XElement element)
    {
