...
public partial record DiagnosisResponse3
     : IIsoXmlSerilizable<DiagnosisResponse3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (POIStatus is StatusReportContent10 POIStatusValue)
        {
    ...
    public static DiagnosisResponse3 Deserialize(XElement element)
    {
