...
public partial record DirectDebitMandate6
     : IIsoXmlSerilizable<DirectDebitMandate6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CreditorAgent is FinancialInstitutionIdentification10 CreditorAgentValue)
        {
    ...
    public static DirectDebitMandate6 Deserialize(XElement element)
    {
