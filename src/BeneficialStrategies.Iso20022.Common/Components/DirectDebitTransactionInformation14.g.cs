...
public partial record DirectDebitTransactionInformation14
     : IIsoXmlSerilizable<DirectDebitTransactionInformation14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DirectDebitTransaction is DirectDebitTransaction7 DirectDebitTransactionValue)
        {
    ...
    public static DirectDebitTransactionInformation14 Deserialize(XElement element)
    {
