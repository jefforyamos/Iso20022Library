...
public partial record DirectDebitTransactionInformation20
     : IIsoXmlSerilizable<DirectDebitTransactionInformation20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DirectDebitTransaction is DirectDebitTransaction8 DirectDebitTransactionValue)
        {
    ...
    public static DirectDebitTransactionInformation20 Deserialize(XElement element)
    {
