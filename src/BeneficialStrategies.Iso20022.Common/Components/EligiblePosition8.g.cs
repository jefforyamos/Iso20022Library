...
public partial record EligiblePosition8
     : IIsoXmlSerilizable<EligiblePosition8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AccountOwner is PartyIdentification223 AccountOwnerValue)
        {
    ...
    public static EligiblePosition8 Deserialize(XElement element)
    {
