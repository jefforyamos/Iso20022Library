...
public partial record EnergyCommodityLightEnd2
     : IIsoXmlSerilizable<EnergyCommodityLightEnd2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubProduct is AssetClassSubProductType27Code SubProductValue)
        {
    ...
    public static EnergyCommodityLightEnd2 Deserialize(XElement element)
    {
