...
public partial record EnergyCommodityNaturalGas1
     : IIsoXmlSerilizable<EnergyCommodityNaturalGas1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AdditionalSubProduct is AssetClassDetailedSubProductType6Code AdditionalSubProductValue)
        {
    ...
    public static EnergyCommodityNaturalGas1 Deserialize(XElement element)
    {
