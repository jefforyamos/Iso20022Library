...
public partial record EnergyCommodityOil1
     : IIsoXmlSerilizable<EnergyCommodityOil1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AdditionalSubProduct is AssetClassDetailedSubProductType7Code AdditionalSubProductValue)
        {
    ...
    public static EnergyCommodityOil1 Deserialize(XElement element)
    {
