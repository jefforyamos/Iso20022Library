...
public partial record EnergySpecificAttribute9
     : IIsoXmlSerilizable<EnergySpecificAttribute9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeliveryAttribute is EnergyDeliveryAttribute10 DeliveryAttributeValue)
        {
    ...
    public static EnergySpecificAttribute9 Deserialize(XElement element)
    {
