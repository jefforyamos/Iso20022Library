...
public partial record EntryDetails11
     : IIsoXmlSerilizable<EntryDetails11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is EntryTransaction12 TransactionDetailsValue)
        {
    ...
    public static EntryDetails11 Deserialize(XElement element)
    {
