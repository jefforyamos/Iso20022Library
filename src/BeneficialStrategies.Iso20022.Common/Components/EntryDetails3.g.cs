...
public partial record EntryDetails3
     : IIsoXmlSerilizable<EntryDetails3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is EntryTransaction4 TransactionDetailsValue)
        {
    ...
    public static EntryDetails3 Deserialize(XElement element)
    {
