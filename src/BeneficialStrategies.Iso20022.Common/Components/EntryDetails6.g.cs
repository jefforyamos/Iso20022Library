...
public partial record EntryDetails6
     : IIsoXmlSerilizable<EntryDetails6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is EntryTransaction7 TransactionDetailsValue)
        {
    ...
    public static EntryDetails6 Deserialize(XElement element)
    {
