...
public partial record EntryDetails7
     : IIsoXmlSerilizable<EntryDetails7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is EntryTransaction8 TransactionDetailsValue)
        {
    ...
    public static EntryDetails7 Deserialize(XElement element)
    {
