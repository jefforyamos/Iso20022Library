...
public partial record EntryDetails9
     : IIsoXmlSerilizable<EntryDetails9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is EntryTransaction10 TransactionDetailsValue)
        {
    ...
    public static EntryDetails9 Deserialize(XElement element)
    {
