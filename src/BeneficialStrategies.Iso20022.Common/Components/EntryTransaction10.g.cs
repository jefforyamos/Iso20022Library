...
public partial record EntryTransaction10
     : IIsoXmlSerilizable<EntryTransaction10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RelatedParties is TransactionParties6 RelatedPartiesValue)
        {
        ...
        if (CardTransaction is CardTransaction17 CardTransactionValue)
        {
    ...
    public static EntryTransaction10 Deserialize(XElement element)
    {
