...
public partial record EntryTransaction3
     : IIsoXmlSerilizable<EntryTransaction3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CardTransaction is CardTransaction1 CardTransactionValue)
        {
    ...
    public static EntryTransaction3 Deserialize(XElement element)
    {
