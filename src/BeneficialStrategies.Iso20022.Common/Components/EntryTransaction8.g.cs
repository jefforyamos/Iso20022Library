...
public partial record EntryTransaction8
     : IIsoXmlSerilizable<EntryTransaction8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RelatedParties is TransactionParties3 RelatedPartiesValue)
        {
            writer.WriteStartElement(null, "RltdPties", xmlNamespace );
            RelatedPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (RelatedAgents is TransactionAgents3 RelatedAgentsValue)
        {
        ...
        if (RelatedPrice is TransactionPrice3Choice_ RelatedPriceValue)
        {
        ...
        if (ReturnInformation is PaymentReturnReason2 ReturnInformationValue)
        {
        ...
        if (CardTransaction is CardTransaction2 CardTransactionValue)
        {
    ...
    public static EntryTransaction8 Deserialize(XElement element)
    {
