...
public partial record EnvelopedData5
     : IIsoXmlSerilizable<EnvelopedData5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (EncryptedContent is EncryptedContent4 EncryptedContentValue)
        {
    ...
    public static EnvelopedData5 Deserialize(XElement element)
    {
