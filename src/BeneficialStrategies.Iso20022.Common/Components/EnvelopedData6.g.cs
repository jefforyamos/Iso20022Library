...
public partial record EnvelopedData6
     : IIsoXmlSerilizable<EnvelopedData6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (EncryptedContent is EncryptedContent5 EncryptedContentValue)
        {
    ...
    public static EnvelopedData6 Deserialize(XElement element)
    {
