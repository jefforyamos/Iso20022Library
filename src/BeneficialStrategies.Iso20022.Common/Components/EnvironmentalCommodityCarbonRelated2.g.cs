...
public partial record EnvironmentalCommodityCarbonRelated2
     : IIsoXmlSerilizable<EnvironmentalCommodityCarbonRelated2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubProduct is AssetClassSubProductType29Code SubProductValue)
        {
    ...
    public static EnvironmentalCommodityCarbonRelated2 Deserialize(XElement element)
    {
