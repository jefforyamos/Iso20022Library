...
public partial record EstimatedFundCashForecast3
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CashInForecast4> EstimatedCashInForecastDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Estimated cash movements out of the fund as a result of investment funds transactions, eg, redemptions or switch-out.
    /// </summary>
    [DataMember]
    public ValueList<CashOutForecast4> EstimatedCashOutForecastDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
