...
public partial record EstimatedFundCashForecast6
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<CashInForecast6> EstimatedCashInForecastDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<CashOutForecast6> EstimatedCashOutForecastDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
