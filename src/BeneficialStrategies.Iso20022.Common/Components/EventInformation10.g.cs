...
public partial record EventInformation10
     : IIsoXmlSerilizable<EventInformation10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (LastNotificationIdentification is NotificationIdentification4 LastNotificationIdentificationValue)
        {
    ...
    public static EventInformation10 Deserialize(XElement element)
    {
