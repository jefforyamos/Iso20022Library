...
public partial record EventInformation13
     : IIsoXmlSerilizable<EventInformation13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (LastNotificationIdentification is NotificationIdentification5 LastNotificationIdentificationValue)
        {
    ...
    public static EventInformation13 Deserialize(XElement element)
    {
