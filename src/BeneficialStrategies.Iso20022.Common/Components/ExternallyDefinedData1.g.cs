...
public partial record ExternallyDefinedData1
     : IIsoXmlSerilizable<ExternallyDefinedData1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedValue is ContentInformationType23 ProtectedValueValue)
        {
    ...
    public static ExternallyDefinedData1 Deserialize(XElement element)
    {
