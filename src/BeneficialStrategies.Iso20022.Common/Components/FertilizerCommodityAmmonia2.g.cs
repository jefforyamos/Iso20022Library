...
public partial record FertilizerCommodityAmmonia2
     : IIsoXmlSerilizable<FertilizerCommodityAmmonia2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubProduct is AssetClassSubProductType39Code SubProductValue)
        {
    ...
    public static FertilizerCommodityAmmonia2 Deserialize(XElement element)
    {
