...
public partial record FertilizerCommodityUrea2
     : IIsoXmlSerilizable<FertilizerCommodityUrea2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubProduct is AssetClassSubProductType43Code SubProductValue)
        {
    ...
    public static FertilizerCommodityUrea2 Deserialize(XElement element)
    {
