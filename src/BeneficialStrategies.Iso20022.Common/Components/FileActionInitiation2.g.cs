...
public partial record FileActionInitiation2
     : IIsoXmlSerilizable<FileActionInitiation2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ProcessingResult is ResultData9 ProcessingResultValue)
        {
    ...
    public static FileActionInitiation2 Deserialize(XElement element)
    {
