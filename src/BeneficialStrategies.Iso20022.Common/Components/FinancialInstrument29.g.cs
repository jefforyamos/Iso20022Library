...
public partial record FinancialInstrument29
     : IIsoXmlSerilizable<FinancialInstrument29>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BlockedHoldingDetails is BlockedHoldingDetails1 BlockedHoldingDetailsValue)
        {
    ...
    public static FinancialInstrument29 Deserialize(XElement element)
    {
