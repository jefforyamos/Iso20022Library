...
public partial record FinancialInstrument57
     : IIsoXmlSerilizable<FinancialInstrument57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SeriesIdentification is Series1 SeriesIdentificationValue)
        {
            writer.WriteStartElement(null, "SrsId", xmlNamespace );
            SeriesIdentificationValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    }
    public static FinancialInstrument57 Deserialize(XElement element)
    {
