...
public partial record FinancialInstrumentAttributes107
     : IIsoXmlSerilizable<FinancialInstrumentAttributes107>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MinimumQuantityToInstruct is FinancialInstrumentQuantity33Choice_ MinimumQuantityToInstructValue)
        {
            writer.WriteStartElement(null, "MinQtyToInst", xmlNamespace );
            MinimumQuantityToInstructValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (MinimumMultipleQuantityToInstruct is FinancialInstrumentQuantity33Choice_ MinimumMultipleQuantityToInstructValue)
        {
    ...
    public static FinancialInstrumentAttributes107 Deserialize(XElement element)
    {
