...
public partial record FinancialInstrumentAttributes112
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<QuantityBreakdown60> QuantityBreakdown { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecurityIdentification19> UnderlyingFinancialInstrumentIdentification { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
