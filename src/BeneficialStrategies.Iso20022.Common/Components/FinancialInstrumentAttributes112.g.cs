...
public partial record FinancialInstrumentAttributes112
     : IIsoXmlSerilizable<FinancialInstrumentAttributes112>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionStyle is OptionStyle8Choice_ OptionStyleValue)
        {
        ...
        if (CouponAttachedNumber is Number22Choice_ CouponAttachedNumberValue)
        {
        ...
        if (QuantityBreakdown is QuantityBreakdown60 QuantityBreakdownValue)
        {
        ...
        if (UnderlyingFinancialInstrumentIdentification is SecurityIdentification19 UnderlyingFinancialInstrumentIdentificationValue)
        {
    ...
    public static FinancialInstrumentAttributes112 Deserialize(XElement element)
    {
