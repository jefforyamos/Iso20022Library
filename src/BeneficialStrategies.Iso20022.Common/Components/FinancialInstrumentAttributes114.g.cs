...
public partial record FinancialInstrumentAttributes114
     : IIsoXmlSerilizable<FinancialInstrumentAttributes114>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (WarrantParity is QuantityToQuantityRatio2 WarrantParityValue)
        {
    ...
    public static FinancialInstrumentAttributes114 Deserialize(XElement element)
    {
