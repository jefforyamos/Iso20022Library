...
public partial record FinancialInstrumentAttributes115
     : IIsoXmlSerilizable<FinancialInstrumentAttributes115>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MinimumQuantityToInstruct is FinancialInstrumentQuantity36Choice_ MinimumQuantityToInstructValue)
        {
            writer.WriteStartElement(null, "MinQtyToInst", xmlNamespace );
            MinimumQuantityToInstructValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (MinimumMultipleQuantityToInstruct is FinancialInstrumentQuantity36Choice_ MinimumMultipleQuantityToInstructValue)
        {
    ...
    public static FinancialInstrumentAttributes115 Deserialize(XElement element)
    {
