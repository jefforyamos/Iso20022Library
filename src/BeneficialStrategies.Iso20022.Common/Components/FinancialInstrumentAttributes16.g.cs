...
public partial record FinancialInstrumentAttributes16
     : IIsoXmlSerilizable<FinancialInstrumentAttributes16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (IssuePrice is PriceFormat19Choice_ IssuePriceValue)
        {
    ...
    public static FinancialInstrumentAttributes16 Deserialize(XElement element)
    {
