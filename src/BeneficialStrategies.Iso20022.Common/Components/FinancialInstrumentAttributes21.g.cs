...
public partial record FinancialInstrumentAttributes21
     : IIsoXmlSerilizable<FinancialInstrumentAttributes21>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnderlyingFinancialInstrumentIdentification is SecurityIdentification14 UnderlyingFinancialInstrumentIdentificationValue)
        {
    ...
    public static FinancialInstrumentAttributes21 Deserialize(XElement element)
    {
