...
public partial record FinancialInstrumentAttributes3
{
    ...
    /// </summary>
    public IFractionDispositionType3Choice? FractionDisposition { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public required IDateFormat5Choice ExpiryDate { get; init; } 
    /// <summary>
    /// Date of the posting (credit or debit) to the account.
    /// </summary>
    public required IDateFormat5Choice PostingDate { get; init; } 
    /// <summary>
