...
public partial record FinancialInstrumentAttributes36
     : IIsoXmlSerilizable<FinancialInstrumentAttributes36>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown15 QuantityBreakdownValue)
        {
    ...
    public static FinancialInstrumentAttributes36 Deserialize(XElement element)
    {
