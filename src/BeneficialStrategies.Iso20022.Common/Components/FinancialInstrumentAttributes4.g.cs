...
public partial record FinancialInstrumentAttributes4
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<QuantityBreakdown5> QuantityBreakdown { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecurityIdentification11> UnderlyingFinancialInstrumentIdentification { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
