...
public partial record FinancialInstrumentAttributes46
     : IIsoXmlSerilizable<FinancialInstrumentAttributes46>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FractionDisposition is FractionDispositionType15Choice_ FractionDispositionValue)
        {
    ...
    public static FinancialInstrumentAttributes46 Deserialize(XElement element)
    {
