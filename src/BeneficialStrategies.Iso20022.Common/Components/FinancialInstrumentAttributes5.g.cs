...
public partial record FinancialInstrumentAttributes5
     : IIsoXmlSerilizable<FinancialInstrumentAttributes5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PlaceOfListing is MarketIdentification2 PlaceOfListingValue)
        {
        ...
        if (IssuePrice is PriceFormat11Choice_ IssuePriceValue)
        {
    ...
    public static FinancialInstrumentAttributes5 Deserialize(XElement element)
    {
