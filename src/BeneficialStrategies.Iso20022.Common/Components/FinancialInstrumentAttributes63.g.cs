...
public partial record FinancialInstrumentAttributes63
     : IIsoXmlSerilizable<FinancialInstrumentAttributes63>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown31 QuantityBreakdownValue)
        {
    ...
    public static FinancialInstrumentAttributes63 Deserialize(XElement element)
    {
