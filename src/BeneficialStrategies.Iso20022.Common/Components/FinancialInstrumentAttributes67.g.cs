...
public partial record FinancialInstrumentAttributes67
     : IIsoXmlSerilizable<FinancialInstrumentAttributes67>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MinimumQuantityToInstruct is FinancialInstrumentQuantity1Choice_ MinimumQuantityToInstructValue)
        {
            writer.WriteStartElement(null, "MinQtyToInst", xmlNamespace );
            MinimumQuantityToInstructValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (MinimumMultipleQuantityToInstruct is FinancialInstrumentQuantity1Choice_ MinimumMultipleQuantityToInstructValue)
        {
        ...
        if (IssuePrice is PriceFormat45Choice_ IssuePriceValue)
        {
    ...
    public static FinancialInstrumentAttributes67 Deserialize(XElement element)
    {
