...
public partial record FinancialInstrumentAttributes75
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<QuantityBreakdown33> QuantityBreakdown { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<SecurityIdentification32> UnderlyingFinancialInstrumentIdentification { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
