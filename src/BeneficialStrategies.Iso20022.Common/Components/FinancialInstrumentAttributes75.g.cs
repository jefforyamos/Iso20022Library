...
public partial record FinancialInstrumentAttributes75
     : IIsoXmlSerilizable<FinancialInstrumentAttributes75>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown33 QuantityBreakdownValue)
        {
    ...
    public static FinancialInstrumentAttributes75 Deserialize(XElement element)
    {
