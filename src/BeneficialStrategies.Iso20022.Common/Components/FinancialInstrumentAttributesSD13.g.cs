...
public partial record FinancialInstrumentAttributesSD13
     : IIsoXmlSerilizable<FinancialInstrumentAttributesSD13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DTCDisbursedSecurityAssetType is DTCAssetType2Code DTCDisbursedSecurityAssetTypeValue)
        {
    ...
    public static FinancialInstrumentAttributesSD13 Deserialize(XElement element)
    {
