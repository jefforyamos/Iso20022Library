...
public partial record FinancialInstrumentAttributesSD19
     : IIsoXmlSerilizable<FinancialInstrumentAttributesSD19>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DTCAssetType is DTCAssetType3Code DTCAssetTypeValue)
        {
        ...
        if (LinkedSecurity is SecurityIdentification20 LinkedSecurityValue)
        {
    ...
    public static FinancialInstrumentAttributesSD19 Deserialize(XElement element)
    {
