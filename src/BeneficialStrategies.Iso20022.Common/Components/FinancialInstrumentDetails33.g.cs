...
public partial record FinancialInstrumentDetails33
     : IIsoXmlSerilizable<FinancialInstrumentDetails33>
{
    #nullable enable
    ...
    /// Transaction details.
    /// </summary>
    public Transaction72? Transaction { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static FinancialInstrumentDetails33 Deserialize(XElement element)
    {
