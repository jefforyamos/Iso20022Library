...
public partial record FinancialInstrumentDetails41
     : IIsoXmlSerilizable<FinancialInstrumentDetails41>
{
    #nullable enable
    ...
    /// Transaction details.
    /// </summary>
    public Transaction123? Transaction { get; init;  } // Warning: Don't know multiplicity.
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OpeningBalance is OpeningBalance5 OpeningBalanceValue)
        {
            writer.WriteStartElement(null, "OpngBal", xmlNamespace );
            OpeningBalanceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ClosingBalance is ClosingBalance5 ClosingBalanceValue)
        {
    ...
    public static FinancialInstrumentDetails41 Deserialize(XElement element)
    {
