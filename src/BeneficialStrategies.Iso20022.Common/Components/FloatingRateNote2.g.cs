...
public partial record FloatingRateNote2
     : IIsoXmlSerilizable<FloatingRateNote2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoISINOct2015Identifier(ReferenceRateIndex)); // data type ISINOct2015Identifier System.String
    ...
    public static FloatingRateNote2 Deserialize(XElement element)
    {
