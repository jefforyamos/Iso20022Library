...
public partial record ForeignExchangeTerms17
     : IIsoXmlSerilizable<ForeignExchangeTerms17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoActiveCurrencyAndAmount(ResultingAmount)); // data type ActiveCurrencyAndAmount System.Decimal
        writer.WriteEndElement();
    }
    public static ForeignExchangeTerms17 Deserialize(XElement element)
    {
