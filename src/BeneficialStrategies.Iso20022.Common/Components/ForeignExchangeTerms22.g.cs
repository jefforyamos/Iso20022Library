...
public partial record ForeignExchangeTerms22
     : IIsoXmlSerilizable<ForeignExchangeTerms22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuotingInstitution is PartyIdentification71Choice_ QuotingInstitutionValue)
        {
    ...
    public static ForeignExchangeTerms22 Deserialize(XElement element)
    {
