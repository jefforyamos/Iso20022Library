...
public partial record ForeignExchangeTerms3
     : IIsoXmlSerilizable<ForeignExchangeTerms3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuotingInstitution is PartyIdentification1Choice_ QuotingInstitutionValue)
        {
    ...
    public static ForeignExchangeTerms3 Deserialize(XElement element)
    {
