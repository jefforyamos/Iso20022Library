...
public partial record ForeignExchangeTerms31
     : IIsoXmlSerilizable<ForeignExchangeTerms31>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuotingInstitution is PartyIdentification104Choice_ QuotingInstitutionValue)
        {
    ...
    public static ForeignExchangeTerms31 Deserialize(XElement element)
    {
