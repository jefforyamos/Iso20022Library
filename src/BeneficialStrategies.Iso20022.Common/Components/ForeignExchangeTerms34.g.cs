...
public partial record ForeignExchangeTerms34
     : IIsoXmlSerilizable<ForeignExchangeTerms34>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuotingInstitution is PartyIdentification120Choice_ QuotingInstitutionValue)
        {
    ...
    public static ForeignExchangeTerms34 Deserialize(XElement element)
    {
