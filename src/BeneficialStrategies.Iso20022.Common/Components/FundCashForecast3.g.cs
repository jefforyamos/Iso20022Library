...
public partial record FundCashForecast3
     : IIsoXmlSerilizable<FundCashForecast3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CashInForecastDetails is CashInForecast4 CashInForecastDetailsValue)
        {
            writer.WriteStartElement(null, "CshInFcstDtls", xmlNamespace );
            CashInForecastDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CashOutForecastDetails is CashOutForecast4 CashOutForecastDetailsValue)
        {
    ...
    public static FundCashForecast3 Deserialize(XElement element)
    {
