...
public partial record GeneralInformation8
     : IIsoXmlSerilizable<GeneralInformation8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BrokerIdentification is PartyIdentification242Choice_ BrokerIdentificationValue)
        {
        ...
        if (DealingBranchTradingSide is PartyIdentification242Choice_ DealingBranchTradingSideValue)
        {
            writer.WriteStartElement(null, "DealgBrnchTradgSd", xmlNamespace );
            DealingBranchTradingSideValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DealingBranchCounterpartySide is PartyIdentification242Choice_ DealingBranchCounterpartySideValue)
        {
    ...
    public static GeneralInformation8 Deserialize(XElement element)
    {
