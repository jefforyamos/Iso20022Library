...
public partial record GenericIdentification165
     : IIsoXmlSerilizable<GenericIdentification165>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SchemeName is SchemeIdentificationType1Code SchemeNameValue)
        {
            writer.WriteStartElement(null, "SchmeNm", xmlNamespace );
            writer.WriteValue(SchemeNameValue.ToString()); // Enum value
            writer.WriteEndElement();
        }
    }
    public static GenericIdentification165 Deserialize(XElement element)
    {
