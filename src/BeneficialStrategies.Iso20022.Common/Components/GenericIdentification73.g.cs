...
public partial record GenericIdentification73
     : IIsoXmlSerilizable<GenericIdentification73>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Type is PartyType9Code TypeValue)
        {
            writer.WriteStartElement(null, "Tp", xmlNamespace );
            writer.WriteValue(TypeValue.ToString()); // Enum value
            writer.WriteEndElement();
        }
        if (Issuer is PartyType9Code IssuerValue)
        {
    ...
    public static GenericIdentification73 Deserialize(XElement element)
    {
