...
public partial record GenericPersonIdentification1
     : IIsoXmlSerilizable<GenericPersonIdentification1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SchemeName is PersonIdentificationSchemeName1Choice_ SchemeNameValue)
        {
    ...
    public static GenericPersonIdentification1 Deserialize(XElement element)
    {
