...
public partial record GroupHeader2
     : IIsoXmlSerilizable<GroupHeader2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TotalInterbankSettlementAmount is IsoCurrencyAndAmount TotalInterbankSettlementAmountValue)
        {
            writer.WriteStartElement(null, "TtlIntrBkSttlmAmt", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoCurrencyAndAmount(TotalInterbankSettlementAmountValue)); // data type CurrencyAndAmount System.Decimal
            writer.WriteEndElement();
        }
    ...
    public static GroupHeader2 Deserialize(XElement element)
    {
