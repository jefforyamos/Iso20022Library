...
public partial record GroupHeader73
     : IIsoXmlSerilizable<GroupHeader73>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (MessageRecipient is PartyIdentification125 MessageRecipientValue)
        {
    ...
    public static GroupHeader73 Deserialize(XElement element)
    {
