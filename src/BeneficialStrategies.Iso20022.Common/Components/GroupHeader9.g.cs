...
public partial record GroupHeader9
     : IIsoXmlSerilizable<GroupHeader9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TotalReversedInterbankSettlementAmount is IsoCurrencyAndAmount TotalReversedInterbankSettlementAmountValue)
        {
            writer.WriteStartElement(null, "TtlRvsdIntrBkSttlmAmt", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoCurrencyAndAmount(TotalReversedInterbankSettlementAmountValue)); // data type CurrencyAndAmount System.Decimal
            writer.WriteEndElement();
        }
    ...
    public static GroupHeader9 Deserialize(XElement element)
    {
