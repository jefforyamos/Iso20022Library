...
//
// Generated by ComponentGenerator for Header36.  ISO2002 ID# _LECaAdnHEeeN3v2fup_Shw.
//
     ...
     : IIsoXmlSerilizable<Header36>
{
    ...
    public static Header36 Deserialize(XElement element)
    {
