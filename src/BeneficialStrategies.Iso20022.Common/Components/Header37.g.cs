     ...
     : IIsoXmlSerilizable<Header37>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RecipientParty is GenericIdentification171 RecipientPartyValue)
        {
            writer.WriteStartElement(null, "RcptPty", xmlNamespace );
            RecipientPartyValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Traceability is Traceability6 TraceabilityValue)
        {
    ...
    public static Header37 Deserialize(XElement element)
    {
