...
public partial record ISATransfer10
     : IIsoXmlSerilizable<ISATransfer10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument33 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer10 Deserialize(XElement element)
    {
