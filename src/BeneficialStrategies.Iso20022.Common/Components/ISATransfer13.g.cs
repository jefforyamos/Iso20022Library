...
public partial record ISATransfer13
     : IIsoXmlSerilizable<ISATransfer13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument35 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer13 Deserialize(XElement element)
    {
