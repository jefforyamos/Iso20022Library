...
public partial record ISATransfer14
     : IIsoXmlSerilizable<ISATransfer14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument37 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer14 Deserialize(XElement element)
    {
