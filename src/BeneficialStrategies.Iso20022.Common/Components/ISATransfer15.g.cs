...
public partial record ISATransfer15
     : IIsoXmlSerilizable<ISATransfer15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument36 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer15 Deserialize(XElement element)
    {
