...
public partial record ISATransfer21
     : IIsoXmlSerilizable<ISATransfer21>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument40 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer21 Deserialize(XElement element)
    {
