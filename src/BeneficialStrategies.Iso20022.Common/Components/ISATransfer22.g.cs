...
public partial record ISATransfer22
     : IIsoXmlSerilizable<ISATransfer22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument46 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer22 Deserialize(XElement element)
    {
