...
public partial record ISATransfer23
     : IIsoXmlSerilizable<ISATransfer23>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument47 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer23 Deserialize(XElement element)
    {
