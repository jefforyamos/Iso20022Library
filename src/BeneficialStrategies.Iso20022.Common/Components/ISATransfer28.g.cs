...
public partial record ISATransfer28
     : IIsoXmlSerilizable<ISATransfer28>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument65 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer28 Deserialize(XElement element)
    {
