...
public partial record ISATransfer3
     : IIsoXmlSerilizable<ISATransfer3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument25 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer3 Deserialize(XElement element)
    {
