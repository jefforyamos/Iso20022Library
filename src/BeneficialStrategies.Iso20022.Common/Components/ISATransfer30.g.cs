...
public partial record ISATransfer30
     : IIsoXmlSerilizable<ISATransfer30>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument61 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer30 Deserialize(XElement element)
    {
