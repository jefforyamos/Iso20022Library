...
public partial record ISATransfer4
     : IIsoXmlSerilizable<ISATransfer4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument26 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer4 Deserialize(XElement element)
    {
