...
public partial record ISATransfer6
     : IIsoXmlSerilizable<ISATransfer6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument30 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer6 Deserialize(XElement element)
    {
