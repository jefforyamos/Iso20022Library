...
public partial record ISATransfer7
     : IIsoXmlSerilizable<ISATransfer7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument31 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer7 Deserialize(XElement element)
    {
