...
public partial record ISATransfer8
     : IIsoXmlSerilizable<ISATransfer8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument32 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static ISATransfer8 Deserialize(XElement element)
    {
