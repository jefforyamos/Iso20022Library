...
public partial record IndividualPerson13
     : IIsoXmlSerilizable<IndividualPerson13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Identification is PersonIdentification2 IdentificationValue)
        {
    ...
    public static IndividualPerson13 Deserialize(XElement element)
    {
