...
public partial record IndividualPerson19
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<IndividualPersonNameLong1> PreviousName { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<PostalAddress6> PostalAddress { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
