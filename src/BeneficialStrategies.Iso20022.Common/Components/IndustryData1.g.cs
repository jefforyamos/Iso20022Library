...
public partial record IndustryData1
     : IIsoXmlSerilizable<IndustryData1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedValue is ContentInformationType19 ProtectedValueValue)
        {
    ...
    public static IndustryData1 Deserialize(XElement element)
    {
