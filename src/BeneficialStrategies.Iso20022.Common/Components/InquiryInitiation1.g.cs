...
public partial record InquiryInitiation1
     : IIsoXmlSerilizable<InquiryInitiation1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ProcessingResult is ProcessingResult5 ProcessingResultValue)
        {
    ...
    public static InquiryInitiation1 Deserialize(XElement element)
    {
