...
public partial record InstructedBalance14
     : IIsoXmlSerilizable<InstructedBalance14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionDetails is InstructedCorporateActionOption15 OptionDetailsValue)
        {
    ...
    public static InstructedBalance14 Deserialize(XElement element)
    {
