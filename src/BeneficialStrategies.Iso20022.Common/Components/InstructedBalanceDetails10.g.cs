...
public partial record InstructedBalanceDetails10
     : IIsoXmlSerilizable<InstructedBalanceDetails10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionDetails is InstructedCorporateActionOption11 OptionDetailsValue)
        {
    ...
    public static InstructedBalanceDetails10 Deserialize(XElement element)
    {
