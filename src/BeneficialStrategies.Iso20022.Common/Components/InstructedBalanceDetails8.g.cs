...
public partial record InstructedBalanceDetails8
     : IIsoXmlSerilizable<InstructedBalanceDetails8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionDetails is InstructedCorporateActionOption9 OptionDetailsValue)
        {
    ...
    public static InstructedBalanceDetails8 Deserialize(XElement element)
    {
