...
public partial record InstructedCorporateActionOption11
     : IIsoXmlSerilizable<InstructedCorporateActionOption11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OptionInstructionDetails is OptionInstructionDetails2 OptionInstructionDetailsValue)
        {
    ...
    public static InstructedCorporateActionOption11 Deserialize(XElement element)
    {
