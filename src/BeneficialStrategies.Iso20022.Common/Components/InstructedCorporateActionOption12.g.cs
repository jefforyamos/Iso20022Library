...
public partial record InstructedCorporateActionOption12
     : IIsoXmlSerilizable<InstructedCorporateActionOption12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OptionInstructionDetails is OptionInstructionDetails3 OptionInstructionDetailsValue)
        {
    ...
    public static InstructedCorporateActionOption12 Deserialize(XElement element)
    {
