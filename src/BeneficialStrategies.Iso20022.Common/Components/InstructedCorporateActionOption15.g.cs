...
public partial record InstructedCorporateActionOption15
     : IIsoXmlSerilizable<InstructedCorporateActionOption15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OptionInstructionDetails is OptionInstructionDetails5 OptionInstructionDetailsValue)
        {
    ...
    public static InstructedCorporateActionOption15 Deserialize(XElement element)
    {
