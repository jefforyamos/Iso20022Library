...
public partial record Instruction7
     : IIsoXmlSerilizable<Instruction7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SpecificInstructionRequest is SpecificInstructionRequest4 SpecificInstructionRequestValue)
        {
    ...
    public static Instruction7 Deserialize(XElement element)
    {
