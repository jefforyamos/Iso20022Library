...
public partial record InstructionForDebtorAgent1
     : IIsoXmlSerilizable<InstructionForDebtorAgent1>
{
    #nullable enable
    ...
    {
        if (Code is ExternalDebtorAgentInstruction1Code CodeValue)
        {
    ...
    public static InstructionForDebtorAgent1 Deserialize(XElement element)
    {
