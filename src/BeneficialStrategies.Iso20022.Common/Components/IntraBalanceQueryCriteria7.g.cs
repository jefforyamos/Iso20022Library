...
public partial record IntraBalanceQueryCriteria7
{
    ...
    /// </summary>
    public IsoMax35Text[] CancellationRequestIdentification { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides the status of settlement of a transaction.
    /// </summary>
    public CancellationProcessingStatus9Choice_[] ProcessingStatus { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
