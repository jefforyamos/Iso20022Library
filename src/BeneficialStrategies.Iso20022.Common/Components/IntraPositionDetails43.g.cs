...
public partial record IntraPositionDetails43
     : IIsoXmlSerilizable<IntraPositionDetails43>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventType is CorporateActionEventType69Choice_ CorporateActionEventTypeValue)
        {
    ...
    public static IntraPositionDetails43 Deserialize(XElement element)
    {
