...
public partial record IntraPositionDetails47
     : IIsoXmlSerilizable<IntraPositionDetails47>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventType is CorporateActionEventType83Choice_ CorporateActionEventTypeValue)
        {
    ...
    public static IntraPositionDetails47 Deserialize(XElement element)
    {
