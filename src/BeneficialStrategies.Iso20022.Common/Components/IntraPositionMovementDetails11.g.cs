...
public partial record IntraPositionMovementDetails11
     : IIsoXmlSerilizable<IntraPositionMovementDetails11>
{
    #nullable enable
    ...
    {
        if (Identification is References42Choice_ IdentificationValue)
        {
    ...
    public static IntraPositionMovementDetails11 Deserialize(XElement element)
    {
