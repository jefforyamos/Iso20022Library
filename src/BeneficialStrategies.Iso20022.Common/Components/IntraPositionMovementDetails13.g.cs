...
public partial record IntraPositionMovementDetails13
     : IIsoXmlSerilizable<IntraPositionMovementDetails13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventType is CorporateActionEventType56Choice_ CorporateActionEventTypeValue)
        {
    ...
    public static IntraPositionMovementDetails13 Deserialize(XElement element)
    {
