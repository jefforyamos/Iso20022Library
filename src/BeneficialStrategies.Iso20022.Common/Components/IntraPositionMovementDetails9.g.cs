...
public partial record IntraPositionMovementDetails9
     : IIsoXmlSerilizable<IntraPositionMovementDetails9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventType is CorporateActionEventType16Choice_ CorporateActionEventTypeValue)
        {
    ...
    public static IntraPositionMovementDetails9 Deserialize(XElement element)
    {
