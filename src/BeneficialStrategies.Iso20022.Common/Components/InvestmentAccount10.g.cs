...
public partial record InvestmentAccount10
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<PartyIdentification1Choice_> OwnerIdentification { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<Intermediary1> IntermediaryInformation { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
