...
public partial record InvestmentAccount22
     : IIsoXmlSerilizable<InvestmentAccount22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (IntermediaryInformation is Intermediary11 IntermediaryInformationValue)
        {
    ...
    public static InvestmentAccount22 Deserialize(XElement element)
    {
