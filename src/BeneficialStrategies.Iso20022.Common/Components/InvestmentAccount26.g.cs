...
public partial record InvestmentAccount26
     : IIsoXmlSerilizable<InvestmentAccount26>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FundDetails is FinancialInstrument10 FundDetailsValue)
        {
    ...
    public static InvestmentAccount26 Deserialize(XElement element)
    {
