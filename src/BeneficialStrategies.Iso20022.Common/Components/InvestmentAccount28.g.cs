...
public partial record InvestmentAccount28
     : IIsoXmlSerilizable<InvestmentAccount28>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OwnershipType is AccountOwnershipType3Code OwnershipTypeValue)
        {
            writer.WriteStartElement(null, "OwnrshTp", xmlNamespace );
            writer.WriteValue(OwnershipTypeValue.ToString()); // Enum value
            writer.WriteEndElement();
        }
        if (ExtendedOwnershipType is IsoExtended350Code ExtendedOwnershipTypeValue)
        {
            writer.WriteStartElement(null, "XtndedOwnrshTp", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoExtended350Code(ExtendedOwnershipTypeValue)); // data type Extended350Code System.String
            writer.WriteEndElement();
        }
        ...
        if (ModifiedFundDetails is ModificationScope12 ModifiedFundDetailsValue)
        {
    ...
    public static InvestmentAccount28 Deserialize(XElement element)
    {
