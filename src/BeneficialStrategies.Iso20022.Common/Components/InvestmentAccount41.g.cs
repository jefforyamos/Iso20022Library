...
public partial record InvestmentAccount41
     : IIsoXmlSerilizable<InvestmentAccount41>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (IntermediaryInformation is Intermediary26 IntermediaryInformationValue)
        {
    ...
    public static InvestmentAccount41 Deserialize(XElement element)
    {
