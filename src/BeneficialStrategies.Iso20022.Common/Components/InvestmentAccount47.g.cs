...
public partial record InvestmentAccount47
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<Reinvestment1> ReinvestmentDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ModificationScope13> ModifiedFundDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<Blocked1> BlockedStatus { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
