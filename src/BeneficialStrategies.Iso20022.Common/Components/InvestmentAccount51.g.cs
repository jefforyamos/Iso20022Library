...
public partial record InvestmentAccount51
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<Reinvestment2> ReinvestmentDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ModificationScope29> ModifiedFinancialInstrumentDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<Blocked2> BlockedStatus { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
