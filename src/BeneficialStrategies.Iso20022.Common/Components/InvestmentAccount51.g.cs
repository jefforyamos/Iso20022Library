...
public partial record InvestmentAccount51
     : IIsoXmlSerilizable<InvestmentAccount51>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ModifiedFinancialInstrumentDetails is ModificationScope29 ModifiedFinancialInstrumentDetailsValue)
        {
    ...
    public static InvestmentAccount51 Deserialize(XElement element)
    {
