...
public partial record InvestmentAccount53
     : IIsoXmlSerilizable<InvestmentAccount53>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OwnerIdentification is OwnerIdentification2Choice_ OwnerIdentificationValue)
        {
    ...
    public static InvestmentAccount53 Deserialize(XElement element)
    {
