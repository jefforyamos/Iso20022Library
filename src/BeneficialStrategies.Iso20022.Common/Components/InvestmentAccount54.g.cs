...
//
// Generated by ComponentGenerator for InvestmentAccount54.  ISO2002 ID# _loOlMSR9EeWWV-wpfEW00A.
//
...
public partial record InvestmentAccount54
     : IIsoXmlSerilizable<InvestmentAccount54>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementPartiesDetails is DeliveringPartiesAndAccount14 SettlementPartiesDetailsValue)
        {
    ...
    public static InvestmentAccount54 Deserialize(XElement element)
    {
