...
public partial record InvestmentAccount56
     : IIsoXmlSerilizable<InvestmentAccount56>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementPartiesDetails is ReceivingPartiesAndAccount14 SettlementPartiesDetailsValue)
        {
    ...
    public static InvestmentAccount56 Deserialize(XElement element)
    {
