...
public partial record InvestmentAccount57
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<PartyIdentification70Choice_> OwnerIdentification { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<Intermediary35> IntermediaryInformation { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
