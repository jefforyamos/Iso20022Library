...
public partial record InvestmentAccount57
     : IIsoXmlSerilizable<InvestmentAccount57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (IntermediaryInformation is Intermediary35 IntermediaryInformationValue)
        {
    ...
    public static InvestmentAccount57 Deserialize(XElement element)
    {
