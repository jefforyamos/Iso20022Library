...
public partial record InvestmentAccount62
     : IIsoXmlSerilizable<InvestmentAccount62>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrumentDetails is FinancialInstrument56 FinancialInstrumentDetailsValue)
        {
    ...
    public static InvestmentAccount62 Deserialize(XElement element)
    {
