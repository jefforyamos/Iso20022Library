...
public partial record InvestmentAccount62
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<Reinvestment3> ReinvestmentDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<TaxReporting2> TaxReporting { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<FinancialInstrument56> FinancialInstrumentDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<InvestorProfile1> InvestorProfile { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
