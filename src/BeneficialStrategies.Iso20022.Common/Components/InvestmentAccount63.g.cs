...
public partial record InvestmentAccount63
     : IIsoXmlSerilizable<InvestmentAccount63>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReinvestmentDetails is Reinvestment3 ReinvestmentDetailsValue)
        {
        ...
        if (ModifiedFinancialInstrumentDetails is ModificationScope36 ModifiedFinancialInstrumentDetailsValue)
        {
        ...
        if (ModifiedInvestorProfile is ModificationScope32 ModifiedInvestorProfileValue)
        {
    ...
    public static InvestmentAccount63 Deserialize(XElement element)
    {
