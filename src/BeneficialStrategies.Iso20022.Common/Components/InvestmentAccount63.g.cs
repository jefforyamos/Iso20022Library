...
public partial record InvestmentAccount63
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<ModificationScope36> ModifiedFinancialInstrumentDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ModificationScope32> ModifiedInvestorProfile { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
