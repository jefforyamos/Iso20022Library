...
public partial record InvestmentAccount67
     : IIsoXmlSerilizable<InvestmentAccount67>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementPartiesDetails is ReceivingPartiesAndAccount18 SettlementPartiesDetailsValue)
        {
    ...
    public static InvestmentAccount67 Deserialize(XElement element)
    {
