...
public partial record InvestmentAccount75
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<ModificationScope42> ModifiedFinancialInstrumentDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ModificationScope46> ModifiedInvestorProfile { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
