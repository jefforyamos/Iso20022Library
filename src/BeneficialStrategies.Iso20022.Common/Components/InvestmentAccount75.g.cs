...
public partial record InvestmentAccount75
     : IIsoXmlSerilizable<InvestmentAccount75>
{
    #nullable enable
    ...
    {
        if (AccountStatusUpdateInstruction is AccountStatusUpdateInstruction1 AccountStatusUpdateInstructionValue)
        {
            writer.WriteStartElement(null, "AcctStsUpdInstr", xmlNamespace );
            AccountStatusUpdateInstructionValue.Serialize(writer, xmlNamespace);
        ...
        if (ModifiedFinancialInstrumentDetails is ModificationScope42 ModifiedFinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "ModfdFinInstrmDtls", xmlNamespace );
            ModifiedFinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        ...
        if (ModifiedInvestorProfile is ModificationScope46 ModifiedInvestorProfileValue)
        {
            writer.WriteStartElement(null, "ModfdInvstrPrfl", xmlNamespace );
            ModifiedInvestorProfileValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    ...
    public static InvestmentAccount75 Deserialize(XElement element)
    {
