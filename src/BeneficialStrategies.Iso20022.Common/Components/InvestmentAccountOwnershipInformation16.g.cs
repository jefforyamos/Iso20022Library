...
public partial record InvestmentAccountOwnershipInformation16
     : IIsoXmlSerilizable<InvestmentAccountOwnershipInformation16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (InvestorProfileValidation is PartyProfileInformation5 InvestorProfileValidationValue)
        {
    ...
    public static InvestmentAccountOwnershipInformation16 Deserialize(XElement element)
    {
