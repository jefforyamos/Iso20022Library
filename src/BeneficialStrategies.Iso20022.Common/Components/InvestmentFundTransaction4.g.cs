...
public partial record InvestmentFundTransaction4
     : IIsoXmlSerilizable<InvestmentFundTransaction4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (PriceDetails is UnitPrice20 PriceDetailsValue)
        {
    ...
    public static InvestmentFundTransaction4 Deserialize(XElement element)
    {
