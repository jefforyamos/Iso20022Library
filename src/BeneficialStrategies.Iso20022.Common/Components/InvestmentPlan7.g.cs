...
public partial record InvestmentPlan7
{
    ...
    /// </summary>
    public required IFrequency19Choice Frequency { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public IReadOnlyCollection<InvestmentFundCashSettlementInformation6> ModifiedCashSettlement { get; init; } = [];
    /// <summary>
