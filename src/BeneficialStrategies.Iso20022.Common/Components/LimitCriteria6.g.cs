...
public partial record LimitCriteria6
     : IIsoXmlSerilizable<LimitCriteria6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SearchCriteria is LimitSearchCriteria6 SearchCriteriaValue)
        {
    ...
    public static LimitCriteria6 Deserialize(XElement element)
    {
