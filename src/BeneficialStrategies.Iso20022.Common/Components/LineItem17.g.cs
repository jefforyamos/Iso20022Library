...
public partial record LineItem17
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<LineItemAllowanceCharge3> NetPriceAllowanceCharge { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<LineItemAllowanceCharge3> AllowanceCharge { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
