...
public partial record LoanData137
     : IIsoXmlSerilizable<LoanData137>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AssetType is SecurityCommodity9 AssetTypeValue)
        {
        ...
        if (RebateRate is InterestRate27Choice_ RebateRateValue)
        {
    ...
    public static LoanData137 Deserialize(XElement element)
    {
