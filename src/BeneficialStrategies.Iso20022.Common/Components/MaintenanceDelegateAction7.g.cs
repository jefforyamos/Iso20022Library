...
public partial record MaintenanceDelegateAction7
     : IIsoXmlSerilizable<MaintenanceDelegateAction7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Action is TMSAction10 ActionValue)
        {
    ...
    public static MaintenanceDelegateAction7 Deserialize(XElement element)
    {
