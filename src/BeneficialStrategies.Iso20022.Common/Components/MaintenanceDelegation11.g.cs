...
public partial record MaintenanceDelegation11
     : IIsoXmlSerilizable<MaintenanceDelegation11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DelegatedAction is MaintenanceDelegateAction6 DelegatedActionValue)
        {
        ...
        if (ParameterDataSet is AcceptorConfigurationDataSet2 ParameterDataSetValue)
        {
    ...
    public static MaintenanceDelegation11 Deserialize(XElement element)
    {
