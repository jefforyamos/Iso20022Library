...
public partial record MaintenanceDelegation15
     : IIsoXmlSerilizable<MaintenanceDelegation15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DelegatedAction is MaintenanceDelegateAction8 DelegatedActionValue)
        {
        ...
        if (ParameterDataSet is AcceptorConfigurationDataSet4 ParameterDataSetValue)
        {
    ...
    public static MaintenanceDelegation15 Deserialize(XElement element)
    {
