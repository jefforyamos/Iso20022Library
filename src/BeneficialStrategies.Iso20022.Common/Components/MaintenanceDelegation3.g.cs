...
public partial record MaintenanceDelegation3
     : IIsoXmlSerilizable<MaintenanceDelegation3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DelegatedAction is MaintenanceDelegateAction2 DelegatedActionValue)
        {
        ...
        if (ParameterDataSet is TerminalManagementDataSet19 ParameterDataSetValue)
        {
    ...
    public static MaintenanceDelegation3 Deserialize(XElement element)
    {
