...
public partial record MaintenanceDelegation5
     : IIsoXmlSerilizable<MaintenanceDelegation5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DelegatedAction is MaintenanceDelegateAction3 DelegatedActionValue)
        {
        ...
        if (ParameterDataSet is TerminalManagementDataSet20 ParameterDataSetValue)
        {
    ...
    public static MaintenanceDelegation5 Deserialize(XElement element)
    {
