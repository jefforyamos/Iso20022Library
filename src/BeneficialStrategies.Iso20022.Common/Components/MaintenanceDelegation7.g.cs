...
public partial record MaintenanceDelegation7
     : IIsoXmlSerilizable<MaintenanceDelegation7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ParameterDataSet is TerminalManagementDataSet23 ParameterDataSetValue)
        {
    ...
    public static MaintenanceDelegation7 Deserialize(XElement element)
    {
