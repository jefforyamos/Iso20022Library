...
public partial record MandateAcceptance5
     : IIsoXmlSerilizable<MandateAcceptance5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalMandate is OriginalMandate5Choice_ OriginalMandateValue)
        {
    ...
    public static MandateAcceptance5 Deserialize(XElement element)
    {
