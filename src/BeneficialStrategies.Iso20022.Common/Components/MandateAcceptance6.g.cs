...
public partial record MandateAcceptance6
     : IIsoXmlSerilizable<MandateAcceptance6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalMandate is OriginalMandate7Choice_ OriginalMandateValue)
        {
    ...
    public static MandateAcceptance6 Deserialize(XElement element)
    {
