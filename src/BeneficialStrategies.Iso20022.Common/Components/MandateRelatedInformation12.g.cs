...
public partial record MandateRelatedInformation12
     : IIsoXmlSerilizable<MandateRelatedInformation12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmendmentInformationDetails is AmendmentInformationDetails12 AmendmentInformationDetailsValue)
        {
    ...
    public static MandateRelatedInformation12 Deserialize(XElement element)
    {
