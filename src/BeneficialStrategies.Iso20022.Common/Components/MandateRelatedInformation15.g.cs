...
public partial record MandateRelatedInformation15
     : IIsoXmlSerilizable<MandateRelatedInformation15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmendmentInformationDetails is AmendmentInformationDetails14 AmendmentInformationDetailsValue)
        {
    ...
    public static MandateRelatedInformation15 Deserialize(XElement element)
    {
