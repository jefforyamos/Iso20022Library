...
public partial record MandateRelatedInformation9
     : IIsoXmlSerilizable<MandateRelatedInformation9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmendmentInformationDetails is AmendmentInformationDetails9 AmendmentInformationDetailsValue)
        {
    ...
    public static MandateRelatedInformation9 Deserialize(XElement element)
    {
