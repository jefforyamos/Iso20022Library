     ...
     : IIsoXmlSerilizable<Member6>
{
    ...
    {
        if (MemberReturnAddress is MemberIdentification3Choice_ MemberReturnAddressValue)
        {
    ...
    public static Member6 Deserialize(XElement element)
    {
