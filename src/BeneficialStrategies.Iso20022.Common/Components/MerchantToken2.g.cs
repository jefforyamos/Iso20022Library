...
public partial record MerchantToken2
     : IIsoXmlSerilizable<MerchantToken2>
{
    #nullable enable
    ...
    {
        if (Token is IsoMax35Text TokenValue)
        {
            writer.WriteStartElement(null, "Tkn", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax35Text(TokenValue)); // data type Max35Text System.String
    ...
    public static MerchantToken2 Deserialize(XElement element)
    {
