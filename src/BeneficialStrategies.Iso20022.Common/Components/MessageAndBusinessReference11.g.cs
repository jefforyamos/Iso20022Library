...
public partial record MessageAndBusinessReference11
     : IIsoXmlSerilizable<MessageAndBusinessReference11>
{
    #nullable enable
    ...
    {
        if (Reference is References63Choice_ ReferenceValue)
        {
        ...
        if (InvestmentAccountDetails is InvestmentAccount68 InvestmentAccountDetailsValue)
        {
    ...
    public static MessageAndBusinessReference11 Deserialize(XElement element)
    {
