...
public partial record MessageAndBusinessReference8
     : IIsoXmlSerilizable<MessageAndBusinessReference8>
{
    #nullable enable
    ...
    {
        if (Reference is References48Choice_ ReferenceValue)
        {
        ...
        if (InvestmentAccountDetails is InvestmentAccount57 InvestmentAccountDetailsValue)
        {
    ...
    public static MessageAndBusinessReference8 Deserialize(XElement element)
    {
