...
public partial record MissingCover4
     : IIsoXmlSerilizable<MissingCover4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CoverCorrection is SettlementInstruction6 CoverCorrectionValue)
        {
    ...
    public static MissingCover4 Deserialize(XElement element)
    {
