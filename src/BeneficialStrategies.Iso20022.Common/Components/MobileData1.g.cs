...
public partial record MobileData1
     : IIsoXmlSerilizable<MobileData1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedMobileData is ContentInformationType17 ProtectedMobileDataValue)
        {
    ...
    public static MobileData1 Deserialize(XElement element)
    {
