...
public partial record MobileData3
     : IIsoXmlSerilizable<MobileData3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedMobileData is ContentInformationType28 ProtectedMobileDataValue)
        {
    ...
    public static MobileData3 Deserialize(XElement element)
    {
