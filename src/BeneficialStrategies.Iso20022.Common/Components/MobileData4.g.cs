...
public partial record MobileData4
     : IIsoXmlSerilizable<MobileData4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedMobileData is ContentInformationType32 ProtectedMobileDataValue)
        {
    ...
    public static MobileData4 Deserialize(XElement element)
    {
