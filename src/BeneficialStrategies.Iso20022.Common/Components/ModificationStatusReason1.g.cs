...
public partial record ModificationStatusReason1
     : IIsoXmlSerilizable<ModificationStatusReason1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Reason is ModificationStatusReason1Choice_ ReasonValue)
        {
    ...
    public static ModificationStatusReason1 Deserialize(XElement element)
    {
