...
public partial record NetObligation1
     : IIsoXmlSerilizable<NetObligation1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CounterpartySettlementInstructions is SettlementParties29 CounterpartySettlementInstructionsValue)
        {
    ...
    public static NetObligation1 Deserialize(XElement element)
    {
