...
public partial record NotificationCancellationReason1
     : IIsoXmlSerilizable<NotificationCancellationReason1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Reason is NotificationCancellationReason1Choice_ ReasonValue)
        {
    ...
    public static NotificationCancellationReason1 Deserialize(XElement element)
    {
