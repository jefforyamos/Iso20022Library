...
public partial record NotificationItem6
     : IIsoXmlSerilizable<NotificationItem6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RelatedRemittanceInformation is RemittanceLocation4 RelatedRemittanceInformationValue)
        {
    ...
    public static NotificationItem6 Deserialize(XElement element)
    {
