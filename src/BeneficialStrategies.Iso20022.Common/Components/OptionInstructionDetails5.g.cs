...
public partial record OptionInstructionDetails5
     : IIsoXmlSerilizable<OptionInstructionDetails5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CustomerReference is IsoMax30Text CustomerReferenceValue)
        {
            writer.WriteStartElement(null, "CstmrRef", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax30Text(CustomerReferenceValue)); // data type Max30Text System.String
            writer.WriteEndElement();
        }
    ...
    public static OptionInstructionDetails5 Deserialize(XElement element)
    {
