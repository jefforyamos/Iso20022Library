...
public partial record OptionTransactionDetailsSD4
     : IIsoXmlSerilizable<OptionTransactionDetailsSD4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RefundedOversubscriptionAmount is IsoRestrictedFINActiveCurrencyAndAmount RefundedOversubscriptionAmountValue)
        {
            writer.WriteStartElement(null, "RfnddOvrsbcptAmt", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoRestrictedFINActiveCurrencyAndAmount(RefundedOversubscriptionAmountValue)); // data type RestrictedFINActiveCurrencyAndAmount System.Decimal
            writer.WriteEndElement();
        }
        if (FinalSubscriptionAdjustmentAmount is IsoRestrictedFINActiveCurrencyAndAmount FinalSubscriptionAdjustmentAmountValue)
        {
            writer.WriteStartElement(null, "FnlSbcptAdjstmntAmt", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoRestrictedFINActiveCurrencyAndAmount(FinalSubscriptionAdjustmentAmountValue)); // data type RestrictedFINActiveCurrencyAndAmount System.Decimal
            writer.WriteEndElement();
        }
    ...
    public static OptionTransactionDetailsSD4 Deserialize(XElement element)
    {
