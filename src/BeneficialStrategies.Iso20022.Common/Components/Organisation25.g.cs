...
public partial record Organisation25
     : IIsoXmlSerilizable<Organisation25>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (LocationAndContact is CommunicationAddress5 LocationAndContactValue)
        {
    ...
    public static Organisation25 Deserialize(XElement element)
    {
