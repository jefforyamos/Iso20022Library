...
public partial record Organisation31
     : IIsoXmlSerilizable<Organisation31>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Identification is PartyIdentification124 IdentificationValue)
        {
    ...
    public static Organisation31 Deserialize(XElement element)
    {
