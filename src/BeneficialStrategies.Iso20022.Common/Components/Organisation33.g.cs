...
public partial record Organisation33
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<PartyIdentification137> RepresentativeOfficer { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<PartyIdentification137> MainMandateHolder { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Person that may be the potential sender of a message related to the life cycle of the account.
    /// </summary>
    [DataMember]
    public ValueList<PartyIdentification137> Sender { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<PartyIdentification137> LegalRepresentative { get; init; } = []; // Warning: Don't know multiplicity.
