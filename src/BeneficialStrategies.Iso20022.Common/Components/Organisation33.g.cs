...
public partial record Organisation33
     : IIsoXmlSerilizable<Organisation33>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OperationalAddress is PostalAddress24 OperationalAddressValue)
        {
            writer.WriteStartElement(null, "OprlAdr", xmlNamespace );
            OperationalAddressValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (BusinessAddress is PostalAddress24 BusinessAddressValue)
        {
        ...
        writer.WriteEndElement();
        if (BillingAddress is PostalAddress24 BillingAddressValue)
        {
    ...
    public static Organisation33 Deserialize(XElement element)
    {
