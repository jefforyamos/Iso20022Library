...
public partial record Organisation35
     : IIsoXmlSerilizable<Organisation35>
{
    #nullable enable
    ...
    public static Organisation35 Deserialize(XElement element)
    {
