...
public partial record OrganisationIdentification28
     : IIsoXmlSerilizable<OrganisationIdentification28>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Identification is OrganisationIdentification8 IdentificationValue)
        {
        ...
        ContactDetails.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
    }
    public static OrganisationIdentification28 Deserialize(XElement element)
    {
