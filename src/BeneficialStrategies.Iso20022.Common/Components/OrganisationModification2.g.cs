...
public partial record OrganisationModification2
{
    ...
    /// </summary>
    public PartyModification2? RepresentativeOfficer { get; init;  } // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public PartyModification2? MainMandateHolder { get; init;  } // Warning: Don't know multiplicity.
    /// <summary>
    /// Person that may be the potential sender of a message related to the life cycle of the account.
    /// </summary>
    public PartyModification2? Sender { get; init;  } // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public PartyModification2? LegalRepresentative { get; init;  } // Warning: Don't know multiplicity.
