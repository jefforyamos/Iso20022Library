...
public partial record OriginalDataElements2
     : IIsoXmlSerilizable<OriginalDataElements2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MessageFunction is MessageFunction16Code MessageFunctionValue)
        {
            writer.WriteStartElement(null, "MsgFctn", xmlNamespace );
            writer.WriteValue(MessageFunctionValue.ToString()); // Enum value
            writer.WriteEndElement();
        }
    ...
    public static OriginalDataElements2 Deserialize(XElement element)
    {
