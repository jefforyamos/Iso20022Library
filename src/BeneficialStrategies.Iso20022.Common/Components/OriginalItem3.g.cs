...
public partial record OriginalItem3
     : IIsoXmlSerilizable<OriginalItem3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalItemReference is OriginalItemReference2 OriginalItemReferenceValue)
        {
    ...
    public static OriginalItem3 Deserialize(XElement element)
    {
