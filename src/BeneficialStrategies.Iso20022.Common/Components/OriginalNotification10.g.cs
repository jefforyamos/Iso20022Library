...
public partial record OriginalNotification10
     : IIsoXmlSerilizable<OriginalNotification10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalNotificationReference is OriginalNotificationReference8 OriginalNotificationReferenceValue)
        {
    ...
    public static OriginalNotification10 Deserialize(XElement element)
    {
