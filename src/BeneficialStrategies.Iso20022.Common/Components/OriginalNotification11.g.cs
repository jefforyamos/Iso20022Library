...
public partial record OriginalNotification11
     : IIsoXmlSerilizable<OriginalNotification11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalNotificationReference is OriginalNotificationReference9 OriginalNotificationReferenceValue)
        {
    ...
    public static OriginalNotification11 Deserialize(XElement element)
    {
