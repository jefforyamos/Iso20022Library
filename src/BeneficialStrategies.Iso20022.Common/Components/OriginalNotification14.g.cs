...
public partial record OriginalNotification14
     : IIsoXmlSerilizable<OriginalNotification14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalNotificationReference is OriginalNotificationReference12 OriginalNotificationReferenceValue)
        {
    ...
    public static OriginalNotification14 Deserialize(XElement element)
    {
