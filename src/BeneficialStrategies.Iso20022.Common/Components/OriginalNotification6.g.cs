...
public partial record OriginalNotification6
     : IIsoXmlSerilizable<OriginalNotification6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalNotificationReference is OriginalNotificationReference4 OriginalNotificationReferenceValue)
        {
    ...
    public static OriginalNotification6 Deserialize(XElement element)
    {
