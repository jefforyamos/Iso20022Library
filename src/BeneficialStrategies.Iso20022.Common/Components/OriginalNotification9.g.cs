...
public partial record OriginalNotification9
     : IIsoXmlSerilizable<OriginalNotification9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalNotificationReference is OriginalNotificationReference7 OriginalNotificationReferenceValue)
        {
    ...
    public static OriginalNotification9 Deserialize(XElement element)
    {
