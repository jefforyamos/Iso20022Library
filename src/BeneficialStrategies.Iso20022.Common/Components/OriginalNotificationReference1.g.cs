...
public partial record OriginalNotificationReference1
     : IIsoXmlSerilizable<OriginalNotificationReference1>
{
    #nullable enable
    ...
    /// </summary>
    public OriginalItem2? OriginalItem { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static OriginalNotificationReference1 Deserialize(XElement element)
    {
