...
public partial record OriginalNotificationReference2
     : IIsoXmlSerilizable<OriginalNotificationReference2>
{
    #nullable enable
    ...
    /// </summary>
    public OriginalItemAndStatus2? OriginalItemAndStatus { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static OriginalNotificationReference2 Deserialize(XElement element)
    {
