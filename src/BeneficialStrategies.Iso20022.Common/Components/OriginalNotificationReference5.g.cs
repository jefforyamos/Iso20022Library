...
public partial record OriginalNotificationReference5
     : IIsoXmlSerilizable<OriginalNotificationReference5>
{
    #nullable enable
    ...
    /// </summary>
    public OriginalItemAndStatus4? OriginalItemAndStatus { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static OriginalNotificationReference5 Deserialize(XElement element)
    {
