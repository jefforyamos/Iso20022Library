...
public partial record OriginalNotificationReference8
     : IIsoXmlSerilizable<OriginalNotificationReference8>
{
    #nullable enable
    ...
    /// </summary>
    public OriginalItem5? OriginalItem { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static OriginalNotificationReference8 Deserialize(XElement element)
    {
