...
public partial record OriginalPaymentInformation2
     : IIsoXmlSerilizable<OriginalPaymentInformation2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransactionInformation28 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInformation2 Deserialize(XElement element)
    {
