...
public partial record OriginalPaymentInstruction1
     : IIsoXmlSerilizable<OriginalPaymentInstruction1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction32 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction1 Deserialize(XElement element)
    {
