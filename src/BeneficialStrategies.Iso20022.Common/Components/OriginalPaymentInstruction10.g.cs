...
public partial record OriginalPaymentInstruction10
     : IIsoXmlSerilizable<OriginalPaymentInstruction10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction54 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction10 Deserialize(XElement element)
    {
