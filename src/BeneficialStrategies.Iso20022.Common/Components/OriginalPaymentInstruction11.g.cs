...
public partial record OriginalPaymentInstruction11
     : IIsoXmlSerilizable<OriginalPaymentInstruction11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction56 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction11 Deserialize(XElement element)
    {
