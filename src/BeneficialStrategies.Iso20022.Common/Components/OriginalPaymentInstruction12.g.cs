...
public partial record OriginalPaymentInstruction12
     : IIsoXmlSerilizable<OriginalPaymentInstruction12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction57 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction12 Deserialize(XElement element)
    {
