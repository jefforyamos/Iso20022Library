...
public partial record OriginalPaymentInstruction13
     : IIsoXmlSerilizable<OriginalPaymentInstruction13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction58 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction13 Deserialize(XElement element)
    {
