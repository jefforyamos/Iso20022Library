...
public partial record OriginalPaymentInstruction14
     : IIsoXmlSerilizable<OriginalPaymentInstruction14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction59 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction14 Deserialize(XElement element)
    {
