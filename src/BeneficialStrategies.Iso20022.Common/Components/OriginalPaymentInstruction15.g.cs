...
public partial record OriginalPaymentInstruction15
     : IIsoXmlSerilizable<OriginalPaymentInstruction15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction61 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction15 Deserialize(XElement element)
    {
