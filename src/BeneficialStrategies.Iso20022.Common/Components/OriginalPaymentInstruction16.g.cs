...
public partial record OriginalPaymentInstruction16
     : IIsoXmlSerilizable<OriginalPaymentInstruction16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction64 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction16 Deserialize(XElement element)
    {
