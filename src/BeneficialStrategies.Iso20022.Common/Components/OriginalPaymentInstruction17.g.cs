...
public partial record OriginalPaymentInstruction17
     : IIsoXmlSerilizable<OriginalPaymentInstruction17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction66 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction17 Deserialize(XElement element)
    {
