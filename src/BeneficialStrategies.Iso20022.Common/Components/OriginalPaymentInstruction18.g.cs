...
public partial record OriginalPaymentInstruction18
     : IIsoXmlSerilizable<OriginalPaymentInstruction18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction68 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction18 Deserialize(XElement element)
    {
