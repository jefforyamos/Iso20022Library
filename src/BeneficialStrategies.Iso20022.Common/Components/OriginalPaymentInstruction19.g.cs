...
public partial record OriginalPaymentInstruction19
     : IIsoXmlSerilizable<OriginalPaymentInstruction19>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction69 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction19 Deserialize(XElement element)
    {
