...
public partial record OriginalPaymentInstruction2
     : IIsoXmlSerilizable<OriginalPaymentInstruction2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction35 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction2 Deserialize(XElement element)
    {
