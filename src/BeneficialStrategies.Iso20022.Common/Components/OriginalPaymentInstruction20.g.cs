...
public partial record OriginalPaymentInstruction20
     : IIsoXmlSerilizable<OriginalPaymentInstruction20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction74 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction20 Deserialize(XElement element)
    {
