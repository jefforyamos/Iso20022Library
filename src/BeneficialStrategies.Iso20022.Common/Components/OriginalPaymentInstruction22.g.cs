...
public partial record OriginalPaymentInstruction22
     : IIsoXmlSerilizable<OriginalPaymentInstruction22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction78 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction22 Deserialize(XElement element)
    {
