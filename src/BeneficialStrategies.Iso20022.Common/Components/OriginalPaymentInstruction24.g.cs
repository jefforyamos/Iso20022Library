...
public partial record OriginalPaymentInstruction24
     : IIsoXmlSerilizable<OriginalPaymentInstruction24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction83 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction24 Deserialize(XElement element)
    {
