...
public partial record OriginalPaymentInstruction26
     : IIsoXmlSerilizable<OriginalPaymentInstruction26>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction84 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction26 Deserialize(XElement element)
    {
