...
public partial record OriginalPaymentInstruction27
     : IIsoXmlSerilizable<OriginalPaymentInstruction27>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction92 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction27 Deserialize(XElement element)
    {
