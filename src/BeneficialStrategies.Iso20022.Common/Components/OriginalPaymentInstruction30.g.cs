...
public partial record OriginalPaymentInstruction30
     : IIsoXmlSerilizable<OriginalPaymentInstruction30>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction103 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction30 Deserialize(XElement element)
    {
