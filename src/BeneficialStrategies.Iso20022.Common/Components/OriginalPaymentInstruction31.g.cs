...
public partial record OriginalPaymentInstruction31
     : IIsoXmlSerilizable<OriginalPaymentInstruction31>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction104 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction31 Deserialize(XElement element)
    {
