...
public partial record OriginalPaymentInstruction32
     : IIsoXmlSerilizable<OriginalPaymentInstruction32>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction105 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction32 Deserialize(XElement element)
    {
