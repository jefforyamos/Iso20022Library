...
public partial record OriginalPaymentInstruction33
     : IIsoXmlSerilizable<OriginalPaymentInstruction33>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction108 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction33 Deserialize(XElement element)
    {
