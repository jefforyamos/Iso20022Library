...
public partial record OriginalPaymentInstruction34
     : IIsoXmlSerilizable<OriginalPaymentInstruction34>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction109 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction34 Deserialize(XElement element)
    {
