...
public partial record OriginalPaymentInstruction35
     : IIsoXmlSerilizable<OriginalPaymentInstruction35>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction122 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction35 Deserialize(XElement element)
    {
