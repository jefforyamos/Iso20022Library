...
public partial record OriginalPaymentInstruction36
     : IIsoXmlSerilizable<OriginalPaymentInstruction36>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction124 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction36 Deserialize(XElement element)
    {
