...
public partial record OriginalPaymentInstruction36
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<PaymentCancellationReason5> CancellationReasonInformation { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Information concerning the original transactions, to which the cancellation request message refers.
    /// </summary>
    [DataMember]
    public ValueList<PaymentTransaction124> TransactionInformation { get; init; } = []; // Warning: Don't know multiplicity.
