...
public partial record OriginalPaymentInstruction37
     : IIsoXmlSerilizable<OriginalPaymentInstruction37>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction125 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction37 Deserialize(XElement element)
    {
