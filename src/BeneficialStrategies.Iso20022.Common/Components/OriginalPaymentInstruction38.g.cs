...
public partial record OriginalPaymentInstruction38
     : IIsoXmlSerilizable<OriginalPaymentInstruction38>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction126 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction38 Deserialize(XElement element)
    {
