...
public partial record OriginalPaymentInstruction39
     : IIsoXmlSerilizable<OriginalPaymentInstruction39>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction128 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction39 Deserialize(XElement element)
    {
