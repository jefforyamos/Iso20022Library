...
public partial record OriginalPaymentInstruction4
     : IIsoXmlSerilizable<OriginalPaymentInstruction4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction37 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction4 Deserialize(XElement element)
    {
