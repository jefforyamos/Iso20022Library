...
public partial record OriginalPaymentInstruction40
     : IIsoXmlSerilizable<OriginalPaymentInstruction40>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction129 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction40 Deserialize(XElement element)
    {
