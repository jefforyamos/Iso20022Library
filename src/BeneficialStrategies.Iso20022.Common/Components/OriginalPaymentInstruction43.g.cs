...
public partial record OriginalPaymentInstruction43
     : IIsoXmlSerilizable<OriginalPaymentInstruction43>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction139 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction43 Deserialize(XElement element)
    {
