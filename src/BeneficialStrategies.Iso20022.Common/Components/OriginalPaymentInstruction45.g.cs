...
public partial record OriginalPaymentInstruction45
     : IIsoXmlSerilizable<OriginalPaymentInstruction45>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction144 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction45 Deserialize(XElement element)
    {
