...
public partial record OriginalPaymentInstruction46
     : IIsoXmlSerilizable<OriginalPaymentInstruction46>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction145 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction46 Deserialize(XElement element)
    {
