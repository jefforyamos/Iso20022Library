...
public partial record OriginalPaymentInstruction5
     : IIsoXmlSerilizable<OriginalPaymentInstruction5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction41 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction5 Deserialize(XElement element)
    {
