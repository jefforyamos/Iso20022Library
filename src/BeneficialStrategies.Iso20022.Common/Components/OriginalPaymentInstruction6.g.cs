...
public partial record OriginalPaymentInstruction6
     : IIsoXmlSerilizable<OriginalPaymentInstruction6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction46 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction6 Deserialize(XElement element)
    {
