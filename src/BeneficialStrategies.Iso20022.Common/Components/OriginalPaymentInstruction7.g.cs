...
public partial record OriginalPaymentInstruction7
     : IIsoXmlSerilizable<OriginalPaymentInstruction7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction42 TransactionInformationValue)
        {
    ...
    public static OriginalPaymentInstruction7 Deserialize(XElement element)
    {
