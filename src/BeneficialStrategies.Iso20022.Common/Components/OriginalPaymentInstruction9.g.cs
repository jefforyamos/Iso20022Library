...
public partial record OriginalPaymentInstruction9
     : IIsoXmlSerilizable<OriginalPaymentInstruction9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction49 TransactionInformationAndStatusValue)
        {
    ...
    public static OriginalPaymentInstruction9 Deserialize(XElement element)
    {
