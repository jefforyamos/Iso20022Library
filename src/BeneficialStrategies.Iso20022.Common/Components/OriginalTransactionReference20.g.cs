...
public partial record OriginalTransactionReference20
     : IIsoXmlSerilizable<OriginalTransactionReference20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MandateRelatedInformation is MandateRelatedInformation10 MandateRelatedInformationValue)
        {
    ...
    public static OriginalTransactionReference20 Deserialize(XElement element)
    {
