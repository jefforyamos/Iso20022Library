...
public partial record OriginalTransactionReference27
     : IIsoXmlSerilizable<OriginalTransactionReference27>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CreditorSchemeIdentification is PartyIdentification125 CreditorSchemeIdentificationValue)
        {
        ...
        if (MandateRelatedInformation is MandateRelatedInformation12 MandateRelatedInformationValue)
        {
    ...
    public static OriginalTransactionReference27 Deserialize(XElement element)
    {
