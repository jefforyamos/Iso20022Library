...
public partial record OriginalTransactionReference28
     : IIsoXmlSerilizable<OriginalTransactionReference28>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MandateRelatedInformation is MandateRelatedInformation14 MandateRelatedInformationValue)
        {
    ...
    public static OriginalTransactionReference28 Deserialize(XElement element)
    {
