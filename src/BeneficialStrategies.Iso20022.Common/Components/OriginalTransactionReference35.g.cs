...
public partial record OriginalTransactionReference35
     : IIsoXmlSerilizable<OriginalTransactionReference35>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (MandateRelatedInformation is MandateRelatedData2Choice_ MandateRelatedInformationValue)
        {
    ...
    public static OriginalTransactionReference35 Deserialize(XElement element)
    {
