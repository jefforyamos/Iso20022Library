...
public partial record OtherCollateral10
     : IIsoXmlSerilizable<OtherCollateral10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherTypeOfCollateral is OtherTypeOfCollateral3 OtherTypeOfCollateralValue)
        {
        ...
        if (BlockedQuantity is FinancialInstrumentQuantity33Choice_ BlockedQuantityValue)
        {
    ...
    public static OtherCollateral10 Deserialize(XElement element)
    {
