...
public partial record OtherParties19
     : IIsoXmlSerilizable<OtherParties19>
{
    #nullable enable
    ...
    {
        if (Investor is PartyIdentificationAndAccount81 InvestorValue)
        {
        ...
        if (StockExchange is PartyIdentificationAndAccount86 StockExchangeValue)
        {
            writer.WriteStartElement(null, "StockXchg", xmlNamespace );
            StockExchangeValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TradeRegulator is PartyIdentificationAndAccount86 TradeRegulatorValue)
        {
    ...
    public static OtherParties19 Deserialize(XElement element)
    {
