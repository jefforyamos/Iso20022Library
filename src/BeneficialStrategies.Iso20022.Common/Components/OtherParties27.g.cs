...
public partial record OtherParties27
     : IIsoXmlSerilizable<OtherParties27>
{
    #nullable enable
    ...
    public static OtherParties27 Deserialize(XElement element)
    {
