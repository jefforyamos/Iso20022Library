...
public partial record OtherParties28
     : IIsoXmlSerilizable<OtherParties28>
{
    #nullable enable
    ...
    public static OtherParties28 Deserialize(XElement element)
    {
