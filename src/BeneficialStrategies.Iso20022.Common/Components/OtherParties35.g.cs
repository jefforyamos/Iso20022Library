...
public partial record OtherParties35
     : IIsoXmlSerilizable<OtherParties35>
{
    #nullable enable
    ...
    {
        if (Investor is PartyIdentificationAndAccount179 InvestorValue)
        {
            writer.WriteStartElement(null, "Invstr", xmlNamespace );
            InvestorValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (QualifiedForeignIntermediary is PartyIdentificationAndAccount180 QualifiedForeignIntermediaryValue)
        {
        ...
        if (TripartyAgent is PartyIdentificationAndAccount180 TripartyAgentValue)
        {
            writer.WriteStartElement(null, "TrptyAgt", xmlNamespace );
            TripartyAgentValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Broker is PartyIdentificationAndAccount180 BrokerValue)
        {
    ...
    public static OtherParties35 Deserialize(XElement element)
    {
