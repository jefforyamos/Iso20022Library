...
public partial record OtherParties43
     : IIsoXmlSerilizable<OtherParties43>
{
    #nullable enable
    ...
    {
        if (Investor is PartyIdentificationAndAccount197 InvestorValue)
        {
            writer.WriteStartElement(null, "Invstr", xmlNamespace );
            InvestorValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (QualifiedForeignIntermediary is PartyIdentificationAndAccount198 QualifiedForeignIntermediaryValue)
        {
        ...
        if (TripartyAgent is PartyIdentificationAndAccount198 TripartyAgentValue)
        {
            writer.WriteStartElement(null, "TrptyAgt", xmlNamespace );
            TripartyAgentValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Broker is PartyIdentificationAndAccount198 BrokerValue)
        {
    ...
    public static OtherParties43 Deserialize(XElement element)
    {
