...
public partial record OtherParties8
     : IIsoXmlSerilizable<OtherParties8>
{
    #nullable enable
    ...
    public static OtherParties8 Deserialize(XElement element)
    {
