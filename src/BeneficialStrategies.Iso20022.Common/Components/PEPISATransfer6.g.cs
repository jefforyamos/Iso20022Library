...
public partial record PEPISATransfer6
     : IIsoXmlSerilizable<PEPISATransfer6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument12 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static PEPISATransfer6 Deserialize(XElement element)
    {
