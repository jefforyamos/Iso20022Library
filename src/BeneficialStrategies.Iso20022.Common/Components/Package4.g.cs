     ...
     : IIsoXmlSerilizable<Package4>
{
    ...
    {
        if (ComplexTradeIdentification is IsoMax100Text ComplexTradeIdentificationValue)
        {
            writer.WriteStartElement(null, "CmplxTradId", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax100Text(ComplexTradeIdentificationValue)); // data type Max100Text System.String
            writer.WriteEndElement();
        }
        if (FXSwapLinkIdentification is IsoMax100Text FXSwapLinkIdentificationValue)
        {
            writer.WriteStartElement(null, "FxSwpLkId", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax100Text(FXSwapLinkIdentificationValue)); // data type Max100Text System.String
            writer.WriteEndElement();
        }
    ...
    public static Package4 Deserialize(XElement element)
    {
