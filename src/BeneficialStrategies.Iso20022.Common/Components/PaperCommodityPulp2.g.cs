...
public partial record PaperCommodityPulp2
     : IIsoXmlSerilizable<PaperCommodityPulp2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubProduct is AssetClassSubProductType37Code SubProductValue)
        {
    ...
    public static PaperCommodityPulp2 Deserialize(XElement element)
    {
