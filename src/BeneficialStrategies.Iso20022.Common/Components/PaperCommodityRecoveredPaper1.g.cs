...
public partial record PaperCommodityRecoveredPaper1
     : IIsoXmlSerilizable<PaperCommodityRecoveredPaper1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubProduct is AssetClassSubProductType38Code SubProductValue)
        {
    ...
    public static PaperCommodityRecoveredPaper1 Deserialize(XElement element)
    {
