...
public partial record Parameter14
     : IIsoXmlSerilizable<Parameter14>
{
    #nullable enable
    ...
    {
        if (EncryptionFormat is EncryptionFormat3Code EncryptionFormatValue)
        {
    ...
    public static Parameter14 Deserialize(XElement element)
    {
