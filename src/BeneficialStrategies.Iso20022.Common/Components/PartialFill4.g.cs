...
public partial record PartialFill4
     : IIsoXmlSerilizable<PartialFill4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TradeDate is TradeDate7Choice_ TradeDateValue)
        {
            writer.WriteStartElement(null, "TradDt", xmlNamespace );
            TradeDateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PlaceOfTrade is MarketIdentification97 PlaceOfTradeValue)
        {
        ...
        writer.WriteEndElement();
        if (MatchIncrementQuantity is QuantityOrAmount2Choice_ MatchIncrementQuantityValue)
        {
    ...
    public static PartialFill4 Deserialize(XElement element)
    {
