...
public partial record PartyIdentification137
     : IIsoXmlSerilizable<PartyIdentification137>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Identification is PersonIdentification13 IdentificationValue)
        {
    ...
    public static PartyIdentification137 Deserialize(XElement element)
    {
