...
public partial record PartyIdentification203
     : IIsoXmlSerilizable<PartyIdentification203>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SponsoredMerchant is SponsoredMerchant1 SponsoredMerchantValue)
        {
    ...
    public static PartyIdentification203 Deserialize(XElement element)
    {
