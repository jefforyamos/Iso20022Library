...
public partial record PartyIdentification233
     : IIsoXmlSerilizable<PartyIdentification233>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CertificationType is BeneficiaryCertificationType10Choice_ CertificationTypeValue)
        {
            writer.WriteStartElement(null, "CertfctnTp", xmlNamespace );
            CertificationTypeValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (WithholdingTaxRate is RateAndAmountFormat37Choice_ WithholdingTaxRateValue)
        {
    ...
    public static PartyIdentification233 Deserialize(XElement element)
    {
