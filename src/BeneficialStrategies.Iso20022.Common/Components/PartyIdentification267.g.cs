...
public partial record PartyIdentification267
     : IIsoXmlSerilizable<PartyIdentification267>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoAnyBICDec2014Identifier(BIC)); // data type AnyBICDec2014Identifier System.String
    ...
    public static PartyIdentification267 Deserialize(XElement element)
    {
