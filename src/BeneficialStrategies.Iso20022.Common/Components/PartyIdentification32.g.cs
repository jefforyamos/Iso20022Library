...
public partial record PartyIdentification32
     : IIsoXmlSerilizable<PartyIdentification32>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Identification is Party6Choice_ IdentificationValue)
        {
    ...
    public static PartyIdentification32 Deserialize(XElement element)
    {
