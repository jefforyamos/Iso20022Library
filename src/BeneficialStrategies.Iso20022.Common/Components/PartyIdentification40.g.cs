...
public partial record PartyIdentification40
     : IIsoXmlSerilizable<PartyIdentification40>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Identification is PersonIdentification5 IdentificationValue)
        {
    ...
    public static PartyIdentification40 Deserialize(XElement element)
    {
