...
public partial record PartyIdentification56
     : IIsoXmlSerilizable<PartyIdentification56>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CertificationType is BeneficiaryCertificationType6Choice_ CertificationTypeValue)
        {
    ...
    public static PartyIdentification56 Deserialize(XElement element)
    {
