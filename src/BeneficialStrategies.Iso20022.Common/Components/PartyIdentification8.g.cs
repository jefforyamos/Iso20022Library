...
public partial record PartyIdentification8
     : IIsoXmlSerilizable<PartyIdentification8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Identification is Party2Choice_ IdentificationValue)
        {
    ...
    public static PartyIdentification8 Deserialize(XElement element)
    {
