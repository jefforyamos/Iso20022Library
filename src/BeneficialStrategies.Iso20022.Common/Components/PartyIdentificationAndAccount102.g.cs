...
public partial record PartyIdentificationAndAccount102
     : IIsoXmlSerilizable<PartyIdentificationAndAccount102>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubAccount is SubAccount4 SubAccountValue)
        {
    ...
    public static PartyIdentificationAndAccount102 Deserialize(XElement element)
    {
