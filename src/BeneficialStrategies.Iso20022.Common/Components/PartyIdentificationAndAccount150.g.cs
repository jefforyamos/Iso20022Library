...
public partial record PartyIdentificationAndAccount150
     : IIsoXmlSerilizable<PartyIdentificationAndAccount150>
{
    #nullable enable
    ...
    {
        if (Identification is PartyIdentification117Choice_ IdentificationValue)
        {
    ...
    public static PartyIdentificationAndAccount150 Deserialize(XElement element)
    {
