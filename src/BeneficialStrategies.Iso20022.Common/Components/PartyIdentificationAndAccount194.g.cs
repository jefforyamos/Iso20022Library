...
public partial record PartyIdentificationAndAccount194
     : IIsoXmlSerilizable<PartyIdentificationAndAccount194>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalInformation is PartyTextInformation6 AdditionalInformationValue)
        {
    ...
    public static PartyIdentificationAndAccount194 Deserialize(XElement element)
    {
