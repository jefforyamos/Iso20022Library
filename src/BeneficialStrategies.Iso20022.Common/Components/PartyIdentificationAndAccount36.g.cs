...
public partial record PartyIdentificationAndAccount36
     : IIsoXmlSerilizable<PartyIdentificationAndAccount36>
{
    #nullable enable
    ...
    {
        if (Identification is PartyIdentification49Choice_ IdentificationValue)
        {
    ...
    public static PartyIdentificationAndAccount36 Deserialize(XElement element)
    {
