...
public partial record PartyIdentificationAndAccount40
     : IIsoXmlSerilizable<PartyIdentificationAndAccount40>
{
    #nullable enable
    ...
    {
        if (Identification is PartyIdentification43Choice_ IdentificationValue)
        {
    ...
    public static PartyIdentificationAndAccount40 Deserialize(XElement element)
    {
