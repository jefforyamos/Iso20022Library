...
public partial record PaymentCancellationReason2
     : IIsoXmlSerilizable<PaymentCancellationReason2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Reason is CancellationReason14Choice_ ReasonValue)
        {
    ...
    public static PaymentCancellationReason2 Deserialize(XElement element)
    {
