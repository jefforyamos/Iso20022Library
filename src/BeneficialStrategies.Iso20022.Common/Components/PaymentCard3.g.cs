...
public partial record PaymentCard3
     : IIsoXmlSerilizable<PaymentCard3>
{
    #nullable enable
    ...
    {
        if (ProtectedCardData is ContentInformationType2 ProtectedCardDataValue)
        {
    ...
    public static PaymentCard3 Deserialize(XElement element)
    {
