...
public partial record PaymentCard31
     : IIsoXmlSerilizable<PaymentCard31>
{
    #nullable enable
    ...
    {
        if (ProtectedCardData is ContentInformationType28 ProtectedCardDataValue)
        {
    ...
    public static PaymentCard31 Deserialize(XElement element)
    {
