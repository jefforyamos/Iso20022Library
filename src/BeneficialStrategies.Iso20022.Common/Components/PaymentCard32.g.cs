...
public partial record PaymentCard32
     : IIsoXmlSerilizable<PaymentCard32>
{
    #nullable enable
    ...
    {
        if (ProtectedCardData is ContentInformationType32 ProtectedCardDataValue)
        {
    ...
    public static PaymentCard32 Deserialize(XElement element)
    {
