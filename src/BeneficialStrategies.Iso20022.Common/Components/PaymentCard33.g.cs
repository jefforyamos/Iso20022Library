...
public partial record PaymentCard33
     : IIsoXmlSerilizable<PaymentCard33>
{
    #nullable enable
    ...
    {
        if (ProtectedCardData is ContentInformationType35 ProtectedCardDataValue)
        {
    ...
    public static PaymentCard33 Deserialize(XElement element)
    {
