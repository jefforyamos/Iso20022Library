...
public partial record PaymentComplementaryInformation2
     : IIsoXmlSerilizable<PaymentComplementaryInformation2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementInformation is SettlementInformation13 SettlementInformationValue)
        {
    ...
    public static PaymentComplementaryInformation2 Deserialize(XElement element)
    {
