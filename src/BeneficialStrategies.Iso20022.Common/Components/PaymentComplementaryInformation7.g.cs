...
public partial record PaymentComplementaryInformation7
     : IIsoXmlSerilizable<PaymentComplementaryInformation7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UltimateDebtor is PartyIdentification125 UltimateDebtorValue)
        {
            writer.WriteStartElement(null, "UltmtDbtr", xmlNamespace );
            UltimateDebtorValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Debtor is PartyIdentification125 DebtorValue)
        {
        ...
        if (Creditor is PartyIdentification125 CreditorValue)
        {
        ...
        if (UltimateCreditor is PartyIdentification125 UltimateCreditorValue)
        {
        ...
        if (PreviousInstructingAgent1Account is CashAccount24 PreviousInstructingAgent1AccountValue)
        {
        ...
        if (PreviousInstructingAgent2Account is CashAccount24 PreviousInstructingAgent2AccountValue)
        {
        ...
        if (PreviousInstructingAgent3Account is CashAccount24 PreviousInstructingAgent3AccountValue)
        {
    ...
    public static PaymentComplementaryInformation7 Deserialize(XElement element)
    {
