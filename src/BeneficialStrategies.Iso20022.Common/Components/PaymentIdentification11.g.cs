...
public partial record PaymentIdentification11
     : IIsoXmlSerilizable<PaymentIdentification11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoRestrictedFINXMax16Text(InstructionIdentification)); // data type RestrictedFINXMax16Text System.String
        writer.WriteEndElement();
        if (EndToEndIdentification is IsoRestrictedFINXMax35Text EndToEndIdentificationValue)
        {
            writer.WriteStartElement(null, "EndToEndId", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoRestrictedFINXMax35Text(EndToEndIdentificationValue)); // data type RestrictedFINXMax35Text System.String
            writer.WriteEndElement();
        }
    ...
    public static PaymentIdentification11 Deserialize(XElement element)
    {
