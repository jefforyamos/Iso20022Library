...
public partial record PaymentInstruction15
     : IIsoXmlSerilizable<PaymentInstruction15>
{
    #nullable enable
    ...
    /// </summary>
    public DirectDebitTransactionInformation18? DirectDebitTransactionInformation { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static PaymentInstruction15 Deserialize(XElement element)
    {
