...
public partial record PaymentInstruction24
     : IIsoXmlSerilizable<PaymentInstruction24>
{
    #nullable enable
    ...
    /// </summary>
    public CreditTransferTransaction27? CreditTransferTransactionInformation { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static PaymentInstruction24 Deserialize(XElement element)
    {
