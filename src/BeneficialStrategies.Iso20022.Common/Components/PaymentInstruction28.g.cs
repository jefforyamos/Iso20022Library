...
public partial record PaymentInstruction28
     : IIsoXmlSerilizable<PaymentInstruction28>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ChargesAccount is CashAccount38 ChargesAccountValue)
        {
    ...
    public static PaymentInstruction28 Deserialize(XElement element)
    {
