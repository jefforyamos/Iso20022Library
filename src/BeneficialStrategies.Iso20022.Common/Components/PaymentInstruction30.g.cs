...
public partial record PaymentInstruction30
     : IIsoXmlSerilizable<PaymentInstruction30>
{
    #nullable enable
    ...
    /// </summary>
    public CreditTransferTransaction34? CreditTransferTransactionInformation { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static PaymentInstruction30 Deserialize(XElement element)
    {
