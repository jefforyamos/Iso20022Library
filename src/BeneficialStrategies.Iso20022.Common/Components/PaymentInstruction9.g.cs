...
//
// Generated by ComponentGenerator for PaymentInstruction9.  ISO2002 ID# _QQntYSHQEeKGep4bhmamiA.
//
...
public partial record PaymentInstruction9
     : IIsoXmlSerilizable<PaymentInstruction9>
{
    #nullable enable
    ...
    /// </summary>
    public CreditTransferTransaction6? CreditTransferTransactionInformation { get; init;  } // Warning: Don't know multiplicity.
    ...
    public static PaymentInstruction9 Deserialize(XElement element)
    {
