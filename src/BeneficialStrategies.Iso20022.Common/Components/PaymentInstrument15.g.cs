...
public partial record PaymentInstrument15
     : IIsoXmlSerilizable<PaymentInstrument15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashSettlementDetails is PaymentInstrument23Choice_ CashSettlementDetailsValue)
        {
    ...
    public static PaymentInstrument15 Deserialize(XElement element)
    {
