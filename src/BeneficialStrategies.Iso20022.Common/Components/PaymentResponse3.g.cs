...
public partial record PaymentResponse3
     : IIsoXmlSerilizable<PaymentResponse3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (PaymentReceipt is PaymentReceipt3 PaymentReceiptValue)
        {
    ...
    public static PaymentResponse3 Deserialize(XElement element)
    {
