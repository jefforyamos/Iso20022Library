...
public partial record PaymentResponse4
     : IIsoXmlSerilizable<PaymentResponse4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (PaymentReceipt is PaymentReceipt4 PaymentReceiptValue)
        {
    ...
    public static PaymentResponse4 Deserialize(XElement element)
    {
