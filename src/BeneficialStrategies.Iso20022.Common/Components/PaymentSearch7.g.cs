...
public partial record PaymentSearch7
{
    ...
    /// </summary>
    public PaymentIdentification5Choice_[] PaymentIdentification { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public PriorityCode3Choice_[] Priority { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
