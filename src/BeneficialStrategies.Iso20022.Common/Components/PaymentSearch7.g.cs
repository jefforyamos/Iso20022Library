...
public partial record PaymentSearch7
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<PaymentIdentification5Choice_> PaymentIdentification { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Detailed information about the status of a transfer.||.
    /// </summary>
    [DataMember]
    public ValueList<InstructionStatusSearch4> Status { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<PriorityCode3Choice_> Priority { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
