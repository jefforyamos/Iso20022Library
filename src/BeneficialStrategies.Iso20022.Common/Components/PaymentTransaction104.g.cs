...
public partial record PaymentTransaction104
     : IIsoXmlSerilizable<PaymentTransaction104>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference29 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction104 Deserialize(XElement element)
    {
