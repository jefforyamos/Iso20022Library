...
public partial record PaymentTransaction112
     : IIsoXmlSerilizable<PaymentTransaction112>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReturnChain is TransactionParties7 ReturnChainValue)
        {
    ...
    public static PaymentTransaction112 Deserialize(XElement element)
    {
