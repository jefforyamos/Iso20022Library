...
public partial record PaymentTransaction118
     : IIsoXmlSerilizable<PaymentTransaction118>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference32 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction118 Deserialize(XElement element)
    {
