...
public partial record PaymentTransaction128
     : IIsoXmlSerilizable<PaymentTransaction128>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PaymentConditionStatus is PaymentConditionStatus1 PaymentConditionStatusValue)
        {
            writer.WriteStartElement(null, "PmtCondSts", xmlNamespace );
            PaymentConditionStatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        ...
        if (DebtorDecisionDateTime is IsoISODateTime DebtorDecisionDateTimeValue)
        {
            writer.WriteStartElement(null, "DbtrDcsnDtTm", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoISODateTime(DebtorDecisionDateTimeValue)); // data type ISODateTime System.DateTime
            writer.WriteEndElement();
        }
        ...
        if (OriginalTransactionReference is OriginalTransactionReference33 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction128 Deserialize(XElement element)
    {
