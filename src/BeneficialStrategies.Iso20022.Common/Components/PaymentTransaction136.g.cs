...
public partial record PaymentTransaction136
     : IIsoXmlSerilizable<PaymentTransaction136>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference37 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction136 Deserialize(XElement element)
    {
