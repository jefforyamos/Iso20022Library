...
public partial record PaymentTransaction137
     : IIsoXmlSerilizable<PaymentTransaction137>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Assigner is BranchAndFinancialInstitutionIdentification6 AssignerValue)
        {
            writer.WriteStartElement(null, "Assgnr", xmlNamespace );
            AssignerValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Assignee is BranchAndFinancialInstitutionIdentification6 AssigneeValue)
        {
    ...
    public static PaymentTransaction137 Deserialize(XElement element)
    {
