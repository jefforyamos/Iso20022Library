...
public partial record PaymentTransaction14
     : IIsoXmlSerilizable<PaymentTransaction14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashInOrOutChoice is CashInOrOut3Choice_ CashInOrOutChoiceValue)
        {
            writer.WriteStartElement(null, "CshInOrOutChc", xmlNamespace );
            CashInOrOutChoiceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    }
    public static PaymentTransaction14 Deserialize(XElement element)
    {
