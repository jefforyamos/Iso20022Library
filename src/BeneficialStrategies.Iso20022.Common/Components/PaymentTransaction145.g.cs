...
public partial record PaymentTransaction145
     : IIsoXmlSerilizable<PaymentTransaction145>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ChargesInformation is Charges12 ChargesInformationValue)
        {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference38 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction145 Deserialize(XElement element)
    {
