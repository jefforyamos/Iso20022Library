...
public partial record PaymentTransaction41
     : IIsoXmlSerilizable<PaymentTransaction41>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference17 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction41 Deserialize(XElement element)
    {
