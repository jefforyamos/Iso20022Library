...
public partial record PaymentTransaction49
     : IIsoXmlSerilizable<PaymentTransaction49>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference19 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction49 Deserialize(XElement element)
    {
