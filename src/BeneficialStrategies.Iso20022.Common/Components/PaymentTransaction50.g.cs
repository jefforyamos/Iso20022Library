...
//
// Generated by ComponentGenerator for PaymentTransaction50.  ISO2002 ID# _hLYzERmHEeS15voCZPa1ZA.
//
...
public partial record PaymentTransaction50
     : IIsoXmlSerilizable<PaymentTransaction50>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReturnReasonInformation is PaymentReturnReason1 ReturnReasonInformationValue)
        {
    ...
    public static PaymentTransaction50 Deserialize(XElement element)
    {
