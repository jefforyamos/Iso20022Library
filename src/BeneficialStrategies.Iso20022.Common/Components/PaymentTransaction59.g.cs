...
public partial record PaymentTransaction59
     : IIsoXmlSerilizable<PaymentTransaction59>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference21 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction59 Deserialize(XElement element)
    {
