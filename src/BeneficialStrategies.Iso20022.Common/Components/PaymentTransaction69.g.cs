...
public partial record PaymentTransaction69
     : IIsoXmlSerilizable<PaymentTransaction69>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference23 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction69 Deserialize(XElement element)
    {
