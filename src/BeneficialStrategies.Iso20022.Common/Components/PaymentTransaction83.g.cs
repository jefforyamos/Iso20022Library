...
public partial record PaymentTransaction83
     : IIsoXmlSerilizable<PaymentTransaction83>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference26 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransaction83 Deserialize(XElement element)
    {
