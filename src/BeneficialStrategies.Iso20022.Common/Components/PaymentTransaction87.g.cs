...
public partial record PaymentTransaction87
     : IIsoXmlSerilizable<PaymentTransaction87>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReturnChain is TransactionParties5 ReturnChainValue)
        {
            writer.WriteStartElement(null, "RtrChain", xmlNamespace );
            ReturnChainValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReturnReasonInformation is PaymentReturnReason4 ReturnReasonInformationValue)
        {
    ...
    public static PaymentTransaction87 Deserialize(XElement element)
    {
