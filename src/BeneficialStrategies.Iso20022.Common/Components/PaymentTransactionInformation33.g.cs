...
public partial record PaymentTransactionInformation33
     : IIsoXmlSerilizable<PaymentTransactionInformation33>
{
    #nullable enable
    ...
    public static PaymentTransactionInformation33 Deserialize(XElement element)
    {
