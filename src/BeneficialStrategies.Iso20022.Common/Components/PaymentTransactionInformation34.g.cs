...
public partial record PaymentTransactionInformation34
     : IIsoXmlSerilizable<PaymentTransactionInformation34>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ChargesInformation is ChargesInformation7 ChargesInformationValue)
        {
        ...
        if (OriginalTransactionReference is OriginalTransactionReference15 OriginalTransactionReferenceValue)
        {
    ...
    public static PaymentTransactionInformation34 Deserialize(XElement element)
    {
