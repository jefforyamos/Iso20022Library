...
public partial record PerformedTransaction1
     : IIsoXmlSerilizable<PerformedTransaction1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PaymentResult is RetailerPaymentResult1 PaymentResultValue)
        {
    ...
    public static PerformedTransaction1 Deserialize(XElement element)
    {
