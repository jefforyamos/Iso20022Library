     ...
     : IIsoXmlSerilizable<Pledgee1>
{
    ...
    {
        if (PledgeeTypeAndIdentification is PledgeeFormat3Choice_ PledgeeTypeAndIdentificationValue)
        {
    ...
    public static Pledgee1 Deserialize(XElement element)
    {
