     ...
     : IIsoXmlSerilizable<Pledgee4>
{
    ...
    {
        if (PledgeeTypeAndIdentification is PledgeeFormat6Choice_ PledgeeTypeAndIdentificationValue)
        {
    ...
    public static Pledgee4 Deserialize(XElement element)
    {
