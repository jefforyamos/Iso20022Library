...
public partial record PointOfInteraction1
     : IIsoXmlSerilizable<PointOfInteraction1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Component is PointOfInteractionComponent1 ComponentValue)
        {
    ...
    public static PointOfInteraction1 Deserialize(XElement element)
    {
