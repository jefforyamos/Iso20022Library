...
//
// Generated by ComponentGenerator for PointOfInteraction11.  ISO2002 ID# _g0gcMS8SEeu125Ip9zFcsQ.
//
...
public partial record PointOfInteraction11
     : IIsoXmlSerilizable<PointOfInteraction11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Component is PointOfInteractionComponent11 ComponentValue)
        {
    ...
    public static PointOfInteraction11 Deserialize(XElement element)
    {
