...
public partial record PointOfInteraction12
     : IIsoXmlSerilizable<PointOfInteraction12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Component is PointOfInteractionComponent12 ComponentValue)
        {
    ...
    public static PointOfInteraction12 Deserialize(XElement element)
    {
