...
public partial record PointOfInteraction13
     : IIsoXmlSerilizable<PointOfInteraction13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Component is PointOfInteractionComponent14 ComponentValue)
        {
    ...
    public static PointOfInteraction13 Deserialize(XElement element)
    {
