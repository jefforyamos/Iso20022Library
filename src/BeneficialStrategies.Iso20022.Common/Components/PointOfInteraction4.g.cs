...
public partial record PointOfInteraction4
     : IIsoXmlSerilizable<PointOfInteraction4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Capabilities is PointOfInteractionCapabilities3 CapabilitiesValue)
        {
            writer.WriteStartElement(null, "Cpblties", xmlNamespace );
            CapabilitiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Component is PointOfInteractionComponent5 ComponentValue)
        {
    ...
    public static PointOfInteraction4 Deserialize(XElement element)
    {
