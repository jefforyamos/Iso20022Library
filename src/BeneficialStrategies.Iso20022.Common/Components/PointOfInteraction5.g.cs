...
public partial record PointOfInteraction5
     : IIsoXmlSerilizable<PointOfInteraction5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Component is PointOfInteractionComponent6 ComponentValue)
        {
    ...
    public static PointOfInteraction5 Deserialize(XElement element)
    {
