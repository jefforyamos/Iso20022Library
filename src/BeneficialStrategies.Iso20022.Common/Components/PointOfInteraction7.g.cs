...
public partial record PointOfInteraction7
     : IIsoXmlSerilizable<PointOfInteraction7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Component is PointOfInteractionComponent7 ComponentValue)
        {
    ...
    public static PointOfInteraction7 Deserialize(XElement element)
    {
