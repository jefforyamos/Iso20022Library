...
public partial record PointOfInteraction8
     : IIsoXmlSerilizable<PointOfInteraction8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Capabilities is PointOfInteractionCapabilities6 CapabilitiesValue)
        {
        ...
        if (Component is PointOfInteractionComponent8 ComponentValue)
        {
    ...
    public static PointOfInteraction8 Deserialize(XElement element)
    {
