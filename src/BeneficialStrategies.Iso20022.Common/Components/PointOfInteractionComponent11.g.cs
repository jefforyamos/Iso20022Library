...
public partial record PointOfInteractionComponent11
     : IIsoXmlSerilizable<PointOfInteractionComponent11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Characteristics is PointOfInteractionComponentCharacteristics7 CharacteristicsValue)
        {
        ...
        if (Package is PackageType2 PackageValue)
        {
    ...
    public static PointOfInteractionComponent11 Deserialize(XElement element)
    {
