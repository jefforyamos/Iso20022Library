...
public partial record PointOfInteractionComponent12
     : IIsoXmlSerilizable<PointOfInteractionComponent12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Characteristics is PointOfInteractionComponentCharacteristics8 CharacteristicsValue)
        {
        ...
        if (Package is PackageType3 PackageValue)
        {
    ...
    public static PointOfInteractionComponent12 Deserialize(XElement element)
    {
