...
public partial record PointOfInteractionComponent14
     : IIsoXmlSerilizable<PointOfInteractionComponent14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Characteristics is PointOfInteractionComponentCharacteristics9 CharacteristicsValue)
        {
        ...
        if (Package is PackageType4 PackageValue)
        {
    ...
    public static PointOfInteractionComponent14 Deserialize(XElement element)
    {
