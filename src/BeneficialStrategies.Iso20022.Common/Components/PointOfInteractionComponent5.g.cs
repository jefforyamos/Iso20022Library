...
public partial record PointOfInteractionComponent5
     : IIsoXmlSerilizable<PointOfInteractionComponent5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Status is PointOfInteractionComponentStatus2 StatusValue)
        {
        ...
        if (Characteristics is PointOfInteractionComponentCharacteristics2 CharacteristicsValue)
        {
    ...
    public static PointOfInteractionComponent5 Deserialize(XElement element)
    {
