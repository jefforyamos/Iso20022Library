...
public partial record PointOfInteractionComponent7
     : IIsoXmlSerilizable<PointOfInteractionComponent7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Characteristics is PointOfInteractionComponentCharacteristics3 CharacteristicsValue)
        {
    ...
    public static PointOfInteractionComponent7 Deserialize(XElement element)
    {
