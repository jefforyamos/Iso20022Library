...
public partial record PointOfInteractionComponentCharacteristics6
     : IIsoXmlSerilizable<PointOfInteractionComponentCharacteristics6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecurityElement is CryptographicKey14 SecurityElementValue)
        {
    ...
    public static PointOfInteractionComponentCharacteristics6 Deserialize(XElement element)
    {
