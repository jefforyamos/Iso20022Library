...
public partial record PointOfInteractionComponentCharacteristics8
     : IIsoXmlSerilizable<PointOfInteractionComponentCharacteristics8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Communication is CommunicationCharacteristics5 CommunicationValue)
        {
        ...
        if (SecurityElement is CryptographicKey16 SecurityElementValue)
        {
    ...
    public static PointOfInteractionComponentCharacteristics8 Deserialize(XElement element)
    {
