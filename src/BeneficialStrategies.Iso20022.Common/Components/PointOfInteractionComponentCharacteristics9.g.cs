...
public partial record PointOfInteractionComponentCharacteristics9
     : IIsoXmlSerilizable<PointOfInteractionComponentCharacteristics9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecurityElement is CryptographicKey17 SecurityElementValue)
        {
    ...
    public static PointOfInteractionComponentCharacteristics9 Deserialize(XElement element)
    {
