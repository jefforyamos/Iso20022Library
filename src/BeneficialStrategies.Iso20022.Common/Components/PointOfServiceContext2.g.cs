...
public partial record PointOfServiceContext2
     : IIsoXmlSerilizable<PointOfServiceContext2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CardDataEntryMode is CardDataReading7Code CardDataEntryModeValue)
        {
    ...
    public static PointOfServiceContext2 Deserialize(XElement element)
    {
