...
public partial record PortfolioTransfer11
     : IIsoXmlSerilizable<PortfolioTransfer11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Portfolio is FundPortfolio8Choice_ PortfolioValue)
        {
        ...
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument102 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static PortfolioTransfer11 Deserialize(XElement element)
    {
