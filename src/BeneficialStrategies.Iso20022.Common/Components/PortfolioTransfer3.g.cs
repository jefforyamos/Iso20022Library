...
public partial record PortfolioTransfer3
     : IIsoXmlSerilizable<PortfolioTransfer3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Portfolio is FundPortfolio3Choice_ PortfolioValue)
        {
        ...
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument69 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static PortfolioTransfer3 Deserialize(XElement element)
    {
