...
public partial record PortfolioTransfer4
     : IIsoXmlSerilizable<PortfolioTransfer4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument70 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static PortfolioTransfer4 Deserialize(XElement element)
    {
