...
public partial record PortfolioTransfer5
     : IIsoXmlSerilizable<PortfolioTransfer5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrumentAssetForTransfer is FinancialInstrument83 FinancialInstrumentAssetForTransferValue)
        {
    ...
    public static PortfolioTransfer5 Deserialize(XElement element)
    {
