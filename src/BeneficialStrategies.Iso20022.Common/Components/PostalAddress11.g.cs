...
public partial record PostalAddress11
     : IIsoXmlSerilizable<PostalAddress11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BuildingName is IsoMax70Text BuildingNameValue)
        {
            writer.WriteStartElement(null, "BldgNm", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax70Text(BuildingNameValue)); // data type Max70Text System.String
            writer.WriteEndElement();
        }
    ...
    public static PostalAddress11 Deserialize(XElement element)
    {
