...
public partial record PriceDetails24
     : IIsoXmlSerilizable<PriceDetails24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GenericCashPriceReceivedPerProduct is PriceFormat56Choice_ GenericCashPriceReceivedPerProductValue)
        {
    ...
    public static PriceDetails24 Deserialize(XElement element)
    {
