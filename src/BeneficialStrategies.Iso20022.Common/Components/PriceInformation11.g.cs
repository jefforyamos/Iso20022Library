...
public partial record PriceInformation11
     : IIsoXmlSerilizable<PriceInformation11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SourceOfPrice is MarketIdentification79 SourceOfPriceValue)
        {
    ...
    public static PriceInformation11 Deserialize(XElement element)
    {
