...
public partial record ProcessingCharacteristics6
     : IIsoXmlSerilizable<ProcessingCharacteristics6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SwitchAuthorisation is Forms1 SwitchAuthorisationValue)
        {
            writer.WriteStartElement(null, "SwtchAuthstn", xmlNamespace );
            SwitchAuthorisationValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    ...
    public static ProcessingCharacteristics6 Deserialize(XElement element)
    {
