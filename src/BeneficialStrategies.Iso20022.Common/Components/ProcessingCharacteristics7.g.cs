...
public partial record ProcessingCharacteristics7
     : IIsoXmlSerilizable<ProcessingCharacteristics7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DealConfirmationTimeFrame is TimeFrame6 DealConfirmationTimeFrameValue)
        {
    ...
    public static ProcessingCharacteristics7 Deserialize(XElement element)
    {
