...
public partial record ProcessingCharacteristics8
     : IIsoXmlSerilizable<ProcessingCharacteristics8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DealConfirmationTimeFrame is TimeFrame7 DealConfirmationTimeFrameValue)
        {
    ...
    public static ProcessingCharacteristics8 Deserialize(XElement element)
    {
