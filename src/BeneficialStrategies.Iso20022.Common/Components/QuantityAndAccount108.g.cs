...
public partial record QuantityAndAccount108
     : IIsoXmlSerilizable<QuantityAndAccount108>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown75 QuantityBreakdownValue)
        {
    ...
    public static QuantityAndAccount108 Deserialize(XElement element)
    {
