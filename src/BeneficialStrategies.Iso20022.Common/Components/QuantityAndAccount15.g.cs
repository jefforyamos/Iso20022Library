...
public partial record QuantityAndAccount15
     : IIsoXmlSerilizable<QuantityAndAccount15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown9 QuantityBreakdownValue)
        {
    ...
    public static QuantityAndAccount15 Deserialize(XElement element)
    {
