...
public partial record QuantityAndAccount41
     : IIsoXmlSerilizable<QuantityAndAccount41>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown29 QuantityBreakdownValue)
        {
    ...
    public static QuantityAndAccount41 Deserialize(XElement element)
    {
