...
public partial record QuantityAndAccount57
     : IIsoXmlSerilizable<QuantityAndAccount57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityBreakdown is QuantityBreakdown44 QuantityBreakdownValue)
        {
    ...
    public static QuantityAndAccount57 Deserialize(XElement element)
    {
