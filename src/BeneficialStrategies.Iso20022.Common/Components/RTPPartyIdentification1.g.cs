...
public partial record RTPPartyIdentification1
     : IIsoXmlSerilizable<RTPPartyIdentification1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Identification is Party49Choice_ IdentificationValue)
        {
    ...
    public static RTPPartyIdentification1 Deserialize(XElement element)
    {
