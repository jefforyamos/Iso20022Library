     ...
     : IIsoXmlSerilizable<Rate35>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat37Choice_ GrossDividendRateValue)
        {
        ...
        if (NetDividendRate is NetDividendRateFormat40Choice_ NetDividendRateValue)
        {
    ...
    public static Rate35 Deserialize(XElement element)
    {
