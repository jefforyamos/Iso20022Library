...
public partial record Rate35
{
    ...
    /// </summary>
    public GrossDividendRateFormat37Choice_[] GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public NetDividendRateFormat40Choice_[] NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
