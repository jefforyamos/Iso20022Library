     ...
     : IIsoXmlSerilizable<Rate36>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat38Choice_ GrossDividendRateValue)
        {
        ...
        if (NetDividendRate is NetDividendRateFormat39Choice_ NetDividendRateValue)
        {
    ...
    public static Rate36 Deserialize(XElement element)
    {
