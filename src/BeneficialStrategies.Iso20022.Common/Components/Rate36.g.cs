...
public partial record Rate36
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat38Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat39Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
