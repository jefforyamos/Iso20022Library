...
public partial record Rate37
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat40Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat42Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
