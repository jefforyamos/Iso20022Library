     ...
     : IIsoXmlSerilizable<Rate37>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat40Choice_ GrossDividendRateValue)
        {
        ...
        if (NetDividendRate is NetDividendRateFormat42Choice_ NetDividendRateValue)
        {
    ...
    public static Rate37 Deserialize(XElement element)
    {
