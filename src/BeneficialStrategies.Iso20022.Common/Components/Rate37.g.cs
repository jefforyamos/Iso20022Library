...
public partial record Rate37
{
    ...
    /// </summary>
    public GrossDividendRateFormat40Choice_[] GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public NetDividendRateFormat42Choice_[] NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
