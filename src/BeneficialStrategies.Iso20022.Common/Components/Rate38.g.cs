     ...
     : IIsoXmlSerilizable<Rate38>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat42Choice_ GrossDividendRateValue)
        {
        ...
        if (NetDividendRate is NetDividendRateFormat44Choice_ NetDividendRateValue)
        {
    ...
    public static Rate38 Deserialize(XElement element)
    {
