...
public partial record RateDetails22
     : IIsoXmlSerilizable<RateDetails22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat20Choice_ GrossDividendRateValue)
        {
        ...
        if (FullyFrankedRate is RateAndAmountFormat37Choice_ FullyFrankedRateValue)
        {
        ...
        if (NetDividendRate is NetDividendRateFormat22Choice_ NetDividendRateValue)
        {
            writer.WriteStartElement(null, "NetDvddRate", xmlNamespace );
            NetDividendRateValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (NonResidentRate is RateAndAmountFormat37Choice_ NonResidentRateValue)
        {
    ...
    public static RateDetails22 Deserialize(XElement element)
    {
