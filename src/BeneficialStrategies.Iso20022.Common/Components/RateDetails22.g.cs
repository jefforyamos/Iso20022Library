...
public partial record RateDetails22
{
    ...
    /// </summary>
    public GrossDividendRateFormat20Choice_[] GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public NetDividendRateFormat22Choice_[] NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public TaxCreditRateFormat8Choice_[] TaxCreditRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
