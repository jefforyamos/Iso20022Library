...
public partial record RateDetails23
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat22Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat24Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<TaxCreditRateFormat7Choice_> TaxCreditRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
