...
public partial record RateDetails24
     : IIsoXmlSerilizable<RateDetails24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FullyFrankedRate is RateAndAmountFormat43Choice_ FullyFrankedRateValue)
        {
    ...
    public static RateDetails24 Deserialize(XElement element)
    {
