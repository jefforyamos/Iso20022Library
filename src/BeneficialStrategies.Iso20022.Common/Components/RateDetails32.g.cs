...
public partial record RateDetails32
     : IIsoXmlSerilizable<RateDetails32>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat29Choice_ GrossDividendRateValue)
        {
        ...
        if (NetDividendRate is NetDividendRateFormat32Choice_ NetDividendRateValue)
        {
        ...
        if (DeemedRate is RateAndAmountFormat52Choice_ DeemedRateValue)
        {
    ...
    public static RateDetails32 Deserialize(XElement element)
    {
