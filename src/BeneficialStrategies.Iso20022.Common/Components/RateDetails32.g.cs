...
public partial record RateDetails32
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat29Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat32Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
