...
public partial record RateDetails33
     : IIsoXmlSerilizable<RateDetails33>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GrossDividendRate is GrossDividendRateFormat32Choice_ GrossDividendRateValue)
        {
        ...
        if (NetDividendRate is NetDividendRateFormat34Choice_ NetDividendRateValue)
        {
        ...
        if (DeemedRate is RateAndAmountFormat54Choice_ DeemedRateValue)
        {
    ...
    public static RateDetails33 Deserialize(XElement element)
    {
