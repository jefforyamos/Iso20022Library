...
public partial record RateDetails33
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat32Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat34Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<RateAndAmountFormat54Choice_> DeemedRate { get; init; } = []; // Warning: Don't know multiplicity.
