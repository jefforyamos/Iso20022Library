...
public partial record RateDetails34
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<GrossDividendRateFormat34Choice_> GrossDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<NetDividendRateFormat36Choice_> NetDividendRate { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
