...
public partial record ReceiveInformation15
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<Charge27> ChargeDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Commission related to the transfer of a financial instrument.
    /// </summary>
    [DataMember]
    public ValueList<Commission22> CommissionDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Tax related to the transfer of a financial instrument.
    /// </summary>
    [DataMember]
    public ValueList<Tax25> TaxDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
