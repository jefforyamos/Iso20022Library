...
public partial record ReceiveInformation18
     : IIsoXmlSerilizable<ReceiveInformation18>
{
    #nullable enable
    ...
    {
        if (Transferee is PartyIdentification113 TransfereeValue)
        {
            writer.WriteStartElement(null, "Trfee", xmlNamespace );
            TransfereeValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TransfereeRegisteredAccount is Account24 TransfereeRegisteredAccountValue)
        {
        ...
        if (SettlementPartiesDetails is ReceivingPartiesAndAccount17 SettlementPartiesDetailsValue)
        {
    ...
    public static ReceiveInformation18 Deserialize(XElement element)
    {
