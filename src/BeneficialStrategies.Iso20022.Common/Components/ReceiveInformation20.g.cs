...
public partial record ReceiveInformation20
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<Fees2> Fees { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Tax related to the transfer of the financial instrument.
    /// </summary>
    [DataMember]
    public ValueList<Tax38> IndividualTax { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<ForeignExchangeTerms37> ForeignExchangeDetails { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
