...
public partial record ReceivingPartiesAndAccount10
     : IIsoXmlSerilizable<ReceivingPartiesAndAccount10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Party2 is PartyIdentificationAndAccount77 Party2Value)
        {
    ...
    public static ReceivingPartiesAndAccount10 Deserialize(XElement element)
    {
