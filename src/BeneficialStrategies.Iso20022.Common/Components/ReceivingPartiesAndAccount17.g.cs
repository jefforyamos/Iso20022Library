...
public partial record ReceivingPartiesAndAccount17
     : IIsoXmlSerilizable<ReceivingPartiesAndAccount17>
{
    #nullable enable
    ...
    {
        if (ReceiverDetails is InvestmentAccount65 ReceiverDetailsValue)
        {
    ...
    public static ReceivingPartiesAndAccount17 Deserialize(XElement element)
    {
