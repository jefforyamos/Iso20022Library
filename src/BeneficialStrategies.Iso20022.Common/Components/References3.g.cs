...
public partial record References3
     : IIsoXmlSerilizable<References3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteStartElement(null, "ReqToBeCmpltdId", xmlNamespace );
        RequestToBeCompletedIdentification.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
        writer.WriteStartElement(null, "PrcId", xmlNamespace );
        ProcessIdentification.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
        // Not sure how to serialize RequestReason, multiplicity Unknown
    ...
    public static References3 Deserialize(XElement element)
    {
