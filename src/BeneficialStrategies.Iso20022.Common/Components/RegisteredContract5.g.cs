...
public partial record RegisteredContract5
     : IIsoXmlSerilizable<RegisteredContract5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RegisteredContractJournal is RegisteredContractJournal1 RegisteredContractJournalValue)
        {
    ...
    public static RegisteredContract5 Deserialize(XElement element)
    {
