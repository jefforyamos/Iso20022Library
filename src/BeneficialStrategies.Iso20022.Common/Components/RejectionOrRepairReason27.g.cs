...
public partial record RejectionOrRepairReason27
     : IIsoXmlSerilizable<RejectionOrRepairReason27>
{
    #nullable enable
    ...
    {
        if (Code is RejectionAndRepairReason27Choice_ CodeValue)
        {
    ...
    public static RejectionOrRepairReason27 Deserialize(XElement element)
    {
