...
public partial record RejectionOrRepairReason36
     : IIsoXmlSerilizable<RejectionOrRepairReason36>
{
    #nullable enable
    ...
    {
        if (Code is RejectionAndRepairReason36Choice_ CodeValue)
        {
    ...
    public static RejectionOrRepairReason36 Deserialize(XElement element)
    {
