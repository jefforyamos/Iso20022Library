...
public partial record RemittanceInformation14
     : IIsoXmlSerilizable<RemittanceInformation14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Structured is StructuredRemittanceInformation14 StructuredValue)
        {
    ...
    public static RemittanceInformation14 Deserialize(XElement element)
    {
