...
public partial record RemittanceInformation16
     : IIsoXmlSerilizable<RemittanceInformation16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Structured is StructuredRemittanceInformation16 StructuredValue)
        {
    ...
    public static RemittanceInformation16 Deserialize(XElement element)
    {
