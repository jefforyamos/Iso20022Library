...
public partial record RemittanceInformation5
     : IIsoXmlSerilizable<RemittanceInformation5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Structured is StructuredRemittanceInformation7 StructuredValue)
        {
    ...
    public static RemittanceInformation5 Deserialize(XElement element)
    {
