...
//
// Generated by ComponentGenerator for RemittanceInformation7.  ISO2002 ID# _tdoSMFkyEeGeoaLUQk__nA_-54731938.
//
...
public partial record RemittanceInformation7
     : IIsoXmlSerilizable<RemittanceInformation7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Structured is StructuredRemittanceInformation9 StructuredValue)
        {
    ...
    public static RemittanceInformation7 Deserialize(XElement element)
    {
