...
public partial record ReorganisationInstructionSD12
     : IIsoXmlSerilizable<ReorganisationInstructionSD12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesQuantityDetails is SecuritiesQuantitySD9 SecuritiesQuantityDetailsValue)
        {
    ...
    public static ReorganisationInstructionSD12 Deserialize(XElement element)
    {
