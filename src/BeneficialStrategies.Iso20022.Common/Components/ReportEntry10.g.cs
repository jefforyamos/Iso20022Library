...
public partial record ReportEntry10
     : IIsoXmlSerilizable<ReportEntry10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CardTransaction is CardEntry4 CardTransactionValue)
        {
            writer.WriteStartElement(null, "CardTx", xmlNamespace );
            CardTransactionValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (EntryDetails is EntryDetails9 EntryDetailsValue)
        {
    ...
    public static ReportEntry10 Deserialize(XElement element)
    {
