...
public partial record ReportEntry13
     : IIsoXmlSerilizable<ReportEntry13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AmountDetails is AmountAndCurrencyExchange4 AmountDetailsValue)
        {
        ...
        if (CardTransaction is CardEntry5 CardTransactionValue)
        {
            writer.WriteStartElement(null, "CardTx", xmlNamespace );
            CardTransactionValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (EntryDetails is EntryDetails12 EntryDetailsValue)
        {
    ...
    public static ReportEntry13 Deserialize(XElement element)
    {
