...
public partial record ReportEntry2
{
    ...
    /// </summary>
    public ReportEntry2( System.Decimal reqAmount,CreditDebitCode reqCreditDebitIndicator,EntryStatus2Code reqStatus,BankTransactionCodeStructure4 reqBankTransactionCode )
    {
        Amount = reqAmount;
