...
public partial record ReportEntry3
     : IIsoXmlSerilizable<ReportEntry3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CardTransaction is CardEntry1 CardTransactionValue)
        {
            writer.WriteStartElement(null, "CardTx", xmlNamespace );
            CardTransactionValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (EntryDetails is EntryDetails2 EntryDetailsValue)
        {
    ...
    public static ReportEntry3 Deserialize(XElement element)
    {
