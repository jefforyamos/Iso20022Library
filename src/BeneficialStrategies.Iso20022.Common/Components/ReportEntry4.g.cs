...
public partial record ReportEntry4
{
    ...
    /// </summary>
    public ReportEntry4( System.Decimal reqAmount,CreditDebitCode reqCreditDebitIndicator,EntryStatus2Code reqStatus,BankTransactionCodeStructure4 reqBankTransactionCode )
    {
        Amount = reqAmount;
