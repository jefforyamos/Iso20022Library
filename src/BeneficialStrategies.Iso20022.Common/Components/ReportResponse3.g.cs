...
public partial record ReportResponse3
     : IIsoXmlSerilizable<ReportResponse3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ReportTransactionResponse is ReportTransactionResponse2 ReportTransactionResponseValue)
        {
    ...
    public static ReportResponse3 Deserialize(XElement element)
    {
