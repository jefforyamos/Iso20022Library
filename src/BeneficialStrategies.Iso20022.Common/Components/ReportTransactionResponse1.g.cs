...
public partial record ReportTransactionResponse1
     : IIsoXmlSerilizable<ReportTransactionResponse1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionReport is PointOfInteractionTransactionReport1 TransactionReportValue)
        {
    ...
    public static ReportTransactionResponse1 Deserialize(XElement element)
    {
