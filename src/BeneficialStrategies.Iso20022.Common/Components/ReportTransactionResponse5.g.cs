...
public partial record ReportTransactionResponse5
     : IIsoXmlSerilizable<ReportTransactionResponse5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionReport is ServiceResponse7 TransactionReportValue)
        {
    ...
    public static ReportTransactionResponse5 Deserialize(XElement element)
    {
