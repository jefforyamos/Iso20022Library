...
public partial record ReportingPeriod2
     : IIsoXmlSerilizable<ReportingPeriod2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FromToTime is TimePeriodDetails1 FromToTimeValue)
        {
            writer.WriteStartElement(null, "FrToTm", xmlNamespace );
            FromToTimeValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    ...
    public static ReportingPeriod2 Deserialize(XElement element)
    {
