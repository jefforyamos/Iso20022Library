...
public partial record ReportingRequest3
     : IIsoXmlSerilizable<ReportingRequest3>
{
    #nullable enable
    ...
    public static ReportingRequest3 Deserialize(XElement element)
    {
