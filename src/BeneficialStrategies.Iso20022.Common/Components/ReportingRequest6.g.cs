...
public partial record ReportingRequest6
     : IIsoXmlSerilizable<ReportingRequest6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReportingPeriod is ReportingPeriod5 ReportingPeriodValue)
        {
    ...
    public static ReportingRequest6 Deserialize(XElement element)
    {
