...
public partial record RequestDetails20
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<RestrictionIdentification1> RestrictionReference { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    [DataMember]
    public ValueList<Linkages53> Linkages { get; init; } = []; // Warning: Don't know multiplicity.
