...
public partial record RequestDetails27
     : IIsoXmlSerilizable<RequestDetails27>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RestrictionReference is RestrictionIdentification1 RestrictionReferenceValue)
        {
        ...
        if (Linkages is Linkages62 LinkagesValue)
        {
    ...
    public static RequestDetails27 Deserialize(XElement element)
    {
