...
public partial record RequestedModification10
     : IIsoXmlSerilizable<RequestedModification10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementInformation is SettlementInstruction13 SettlementInformationValue)
        {
    ...
    public static RequestedModification10 Deserialize(XElement element)
    {
