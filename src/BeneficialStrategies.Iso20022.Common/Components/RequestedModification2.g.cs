...
public partial record RequestedModification2
     : IIsoXmlSerilizable<RequestedModification2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementInformation is SettlementInformation15 SettlementInformationValue)
        {
    ...
    public static RequestedModification2 Deserialize(XElement element)
    {
