...
public partial record RequestedModification7
     : IIsoXmlSerilizable<RequestedModification7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementInformation is SettlementInstruction3 SettlementInformationValue)
        {
    ...
    public static RequestedModification7 Deserialize(XElement element)
    {
