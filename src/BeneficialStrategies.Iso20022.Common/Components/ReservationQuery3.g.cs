...
public partial record ReservationQuery3
     : IIsoXmlSerilizable<ReservationQuery3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReservationCriteria is ReservationCriteria3Choice_ ReservationCriteriaValue)
        {
    ...
    public static ReservationQuery3 Deserialize(XElement element)
    {
