...
public partial record ReservationSearchCriteria5
     : IIsoXmlSerilizable<ReservationSearchCriteria5>
{
    #nullable enable
    ...
    {
        if (DateTime is DateTimeSearch2Choice_ DateTimeValue)
        {
    ...
    public static ReservationSearchCriteria5 Deserialize(XElement element)
    {
