...
public partial record ResolutionData1
     : IIsoXmlSerilizable<ResolutionData1>
{
    #nullable enable
    ...
    public static ResolutionData1 Deserialize(XElement element)
    {
