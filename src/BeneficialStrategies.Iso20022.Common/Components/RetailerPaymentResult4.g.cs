...
public partial record RetailerPaymentResult4
     : IIsoXmlSerilizable<RetailerPaymentResult4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RequestedTransaction is CardPaymentTransaction120 RequestedTransactionValue)
        {
            writer.WriteStartElement(null, "ReqdTx", xmlNamespace );
            RequestedTransactionValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TransactionResponse is CardPaymentTransaction114 TransactionResponseValue)
        {
        ...
        if (ProtectedCapturedSignature is ContentInformationType32 ProtectedCapturedSignatureValue)
        {
    ...
    public static RetailerPaymentResult4 Deserialize(XElement element)
    {
