...
public partial record RetailerPaymentResult5
     : IIsoXmlSerilizable<RetailerPaymentResult5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RequestedTransaction is CardPaymentTransaction127 RequestedTransactionValue)
        {
            writer.WriteStartElement(null, "ReqdTx", xmlNamespace );
            RequestedTransactionValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TransactionResponse is CardPaymentTransaction128 TransactionResponseValue)
        {
        ...
        if (ProtectedCapturedSignature is ContentInformationType35 ProtectedCapturedSignatureValue)
        {
    ...
    public static RetailerPaymentResult5 Deserialize(XElement element)
    {
