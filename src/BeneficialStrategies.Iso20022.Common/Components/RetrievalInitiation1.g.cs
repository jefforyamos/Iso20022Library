...
public partial record RetrievalInitiation1
     : IIsoXmlSerilizable<RetrievalInitiation1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RetrievalFulfilmentDestination is PartyIdentification197 RetrievalFulfilmentDestinationValue)
        {
    ...
    public static RetrievalInitiation1 Deserialize(XElement element)
    {
