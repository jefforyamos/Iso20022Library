...
public partial record ReversalRequest3
     : IIsoXmlSerilizable<ReversalRequest3>
{
    #nullable enable
    ...
    {
        if (ReversalTransaction is CardPaymentTransaction110 ReversalTransactionValue)
        {
    ...
    public static ReversalRequest3 Deserialize(XElement element)
    {
