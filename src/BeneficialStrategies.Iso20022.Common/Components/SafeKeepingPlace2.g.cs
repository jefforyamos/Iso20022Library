...
public partial record SafeKeepingPlace2
     : IIsoXmlSerilizable<SafeKeepingPlace2>
{
    #nullable enable
    ...
    {
        if (SafekeepingPlaceFormat is SafekeepingPlaceFormat17Choice_ SafekeepingPlaceFormatValue)
        {
    ...
    public static SafeKeepingPlace2 Deserialize(XElement element)
    {
