...
public partial record SafekeepingAccount5
     : IIsoXmlSerilizable<SafekeepingAccount5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Agent is Intermediary28 AgentValue)
        {
            writer.WriteStartElement(null, "Agt", xmlNamespace );
            AgentValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (AccountSubLevel1 is AccountSubLevel1 AccountSubLevel1Value)
        {
    ...
    public static SafekeepingAccount5 Deserialize(XElement element)
    {
