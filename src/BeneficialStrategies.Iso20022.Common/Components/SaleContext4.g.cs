...
public partial record SaleContext4
     : IIsoXmlSerilizable<SaleContext4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AllowedEntryMode is CardDataReading8Code AllowedEntryModeValue)
        {
    ...
    public static SaleContext4 Deserialize(XElement element)
    {
