...
public partial record SecuritiesCollateral8
     : IIsoXmlSerilizable<SecuritiesCollateral8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails118 SettlementParametersValue)
        {
    ...
    public static SecuritiesCollateral8 Deserialize(XElement element)
    {
