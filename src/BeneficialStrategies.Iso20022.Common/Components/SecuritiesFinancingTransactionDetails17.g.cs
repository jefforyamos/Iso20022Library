...
public partial record SecuritiesFinancingTransactionDetails17
     : IIsoXmlSerilizable<SecuritiesFinancingTransactionDetails17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails61 SettlementParametersValue)
        {
    ...
    public static SecuritiesFinancingTransactionDetails17 Deserialize(XElement element)
    {
