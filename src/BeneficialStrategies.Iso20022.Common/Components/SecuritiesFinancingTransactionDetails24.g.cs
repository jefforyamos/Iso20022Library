...
public partial record SecuritiesFinancingTransactionDetails24
     : IIsoXmlSerilizable<SecuritiesFinancingTransactionDetails24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails73 SettlementParametersValue)
        {
    ...
    public static SecuritiesFinancingTransactionDetails24 Deserialize(XElement element)
    {
