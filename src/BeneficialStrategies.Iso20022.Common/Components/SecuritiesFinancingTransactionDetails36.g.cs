...
public partial record SecuritiesFinancingTransactionDetails36
     : IIsoXmlSerilizable<SecuritiesFinancingTransactionDetails36>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails107 SettlementParametersValue)
        {
    ...
    public static SecuritiesFinancingTransactionDetails36 Deserialize(XElement element)
    {
