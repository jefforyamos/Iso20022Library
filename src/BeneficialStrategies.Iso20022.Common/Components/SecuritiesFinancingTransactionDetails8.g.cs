...
public partial record SecuritiesFinancingTransactionDetails8
     : IIsoXmlSerilizable<SecuritiesFinancingTransactionDetails8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails29 SettlementParametersValue)
        {
    ...
    public static SecuritiesFinancingTransactionDetails8 Deserialize(XElement element)
    {
