...
public partial record SecuritiesOption1
     : IIsoXmlSerilizable<SecuritiesOption1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FrontEndOddLotQuantity is FinancialInstrumentQuantity2Choice_ FrontEndOddLotQuantityValue)
        {
            writer.WriteStartElement(null, "FrntEndOddLotQty", xmlNamespace );
            FrontEndOddLotQuantityValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (BackEndOddLotQuantity is FinancialInstrumentQuantity2Choice_ BackEndOddLotQuantityValue)
        {
    ...
    public static SecuritiesOption1 Deserialize(XElement element)
    {
