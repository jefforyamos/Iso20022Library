...
public partial record SecuritiesOption13
     : IIsoXmlSerilizable<SecuritiesOption13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RateDetails is CorporateActionRate17 RateDetailsValue)
        {
            writer.WriteStartElement(null, "RateDtls", xmlNamespace );
            RateDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PriceDetails is CorporateActionPrice18 PriceDetailsValue)
        {
    ...
    public static SecuritiesOption13 Deserialize(XElement element)
    {
