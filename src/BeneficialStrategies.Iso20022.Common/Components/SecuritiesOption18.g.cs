...
public partial record SecuritiesOption18
     : IIsoXmlSerilizable<SecuritiesOption18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RateDetails is CorporateActionRate21 RateDetailsValue)
        {
        ...
        if (ReceivingSettlementParties is SettlementParties15 ReceivingSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "RcvgSttlmPties", xmlNamespace );
            ReceivingSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DeliveringSettlementParties is SettlementParties15 DeliveringSettlementPartiesValue)
        {
    ...
    public static SecuritiesOption18 Deserialize(XElement element)
    {
