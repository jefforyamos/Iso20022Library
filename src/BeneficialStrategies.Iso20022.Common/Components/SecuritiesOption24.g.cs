...
public partial record SecuritiesOption24
     : IIsoXmlSerilizable<SecuritiesOption24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PriceDetails is CorporateActionPrice26 PriceDetailsValue)
        {
    ...
    public static SecuritiesOption24 Deserialize(XElement element)
    {
