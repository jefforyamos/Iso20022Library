...
public partial record SecuritiesOption35
     : IIsoXmlSerilizable<SecuritiesOption35>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PriceDetails is CorporateActionPrice39 PriceDetailsValue)
        {
    ...
    public static SecuritiesOption35 Deserialize(XElement element)
    {
