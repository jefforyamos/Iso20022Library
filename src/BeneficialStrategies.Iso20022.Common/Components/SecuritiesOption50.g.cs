...
public partial record SecuritiesOption50
     : IIsoXmlSerilizable<SecuritiesOption50>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RateDetails is CorporateActionRate72 RateDetailsValue)
        {
    ...
    public static SecuritiesOption50 Deserialize(XElement element)
    {
