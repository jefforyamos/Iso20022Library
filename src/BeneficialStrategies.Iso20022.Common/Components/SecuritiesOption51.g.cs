...
public partial record SecuritiesOption51
     : IIsoXmlSerilizable<SecuritiesOption51>
{
    #nullable enable
    ...
    {
        if (MaximumQuantityToInstruct is FinancialInstrumentQuantity19Choice_ MaximumQuantityToInstructValue)
        {
            writer.WriteStartElement(null, "MaxQtyToInst", xmlNamespace );
            MaximumQuantityToInstructValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (MinimumQuantityToInstruct is FinancialInstrumentQuantity19Choice_ MinimumQuantityToInstructValue)
        {
            writer.WriteStartElement(null, "MinQtyToInst", xmlNamespace );
            MinimumQuantityToInstructValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (MinimumMultipleQuantityToInstruct is FinancialInstrumentQuantity20Choice_ MinimumMultipleQuantityToInstructValue)
        {
    ...
    public static SecuritiesOption51 Deserialize(XElement element)
    {
