...
public partial record SecuritiesOption55
     : IIsoXmlSerilizable<SecuritiesOption55>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReceivingSettlementParties is SettlementParties43 ReceivingSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "RcvgSttlmPties", xmlNamespace );
            ReceivingSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DeliveringSettlementParties is SettlementParties43 DeliveringSettlementPartiesValue)
        {
    ...
    public static SecuritiesOption55 Deserialize(XElement element)
    {
