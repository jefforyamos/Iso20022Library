...
public partial record SecuritiesOption74
     : IIsoXmlSerilizable<SecuritiesOption74>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RateDetails is CorporateActionRate93 RateDetailsValue)
        {
        ...
        if (ReceivingSettlementParties is SettlementParties80 ReceivingSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "RcvgSttlmPties", xmlNamespace );
            ReceivingSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DeliveringSettlementParties is SettlementParties80 DeliveringSettlementPartiesValue)
        {
    ...
    public static SecuritiesOption74 Deserialize(XElement element)
    {
