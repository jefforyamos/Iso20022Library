...
public partial record SecuritiesOption85
     : IIsoXmlSerilizable<SecuritiesOption85>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RateDetails is CorporateActionRate95 RateDetailsValue)
        {
    ...
    public static SecuritiesOption85 Deserialize(XElement element)
    {
