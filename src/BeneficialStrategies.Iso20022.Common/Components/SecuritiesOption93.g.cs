...
public partial record SecuritiesOption93
     : IIsoXmlSerilizable<SecuritiesOption93>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RateDetails is CorporateActionRate113 RateDetailsValue)
        {
        ...
        if (AmountDetails is CorporateActionAmounts60 AmountDetailsValue)
        {
    ...
    public static SecuritiesOption93 Deserialize(XElement element)
    {
