...
public partial record SecuritiesOption96
     : IIsoXmlSerilizable<SecuritiesOption96>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (RateDetails is CorporateActionRate115 RateDetailsValue)
        {
    ...
    public static SecuritiesOption96 Deserialize(XElement element)
    {
