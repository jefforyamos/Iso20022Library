...
public partial record SecuritiesOption98
     : IIsoXmlSerilizable<SecuritiesOption98>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (EntitledQuantity is Quantity54Choice_ EntitledQuantityValue)
        {
        ...
        writer.WriteEndElement();
        if (RateDetails is CorporateActionRate116 RateDetailsValue)
        {
            writer.WriteStartElement(null, "RateDtls", xmlNamespace );
            RateDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (PriceDetails is CorporateActionPrice79 PriceDetailsValue)
        {
    ...
    public static SecuritiesOption98 Deserialize(XElement element)
    {
