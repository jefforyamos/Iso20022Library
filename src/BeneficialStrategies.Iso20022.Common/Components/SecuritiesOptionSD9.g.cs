...
public partial record SecuritiesOptionSD9
     : IIsoXmlSerilizable<SecuritiesOptionSD9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DTCFractionalShareInstructionPeriod is Period13 DTCFractionalShareInstructionPeriodValue)
        {
    ...
    public static SecuritiesOptionSD9 Deserialize(XElement element)
    {
