...
public partial record SecuritiesSettlementTransactionDetails14
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TradeDetails is SecuritiesTradeDetails34 TradeDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails14 Deserialize(XElement element)
    {
