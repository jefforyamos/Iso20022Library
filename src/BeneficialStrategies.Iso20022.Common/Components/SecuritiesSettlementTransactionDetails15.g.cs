...
public partial record SecuritiesSettlementTransactionDetails15
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TradeDetails is SecuritiesTradeDetails32 TradeDetailsValue)
        {
        ...
        if (SettlementParameters is SettlementDetails68 SettlementParametersValue)
        {
        ...
        if (SettlementAmount is AmountAndDirection37 SettlementAmountValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails15 Deserialize(XElement element)
    {
