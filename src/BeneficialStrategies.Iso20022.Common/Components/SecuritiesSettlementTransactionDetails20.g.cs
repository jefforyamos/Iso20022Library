...
public partial record SecuritiesSettlementTransactionDetails20
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementParameters is SettlementDetails94 SettlementParametersValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails20 Deserialize(XElement element)
    {
