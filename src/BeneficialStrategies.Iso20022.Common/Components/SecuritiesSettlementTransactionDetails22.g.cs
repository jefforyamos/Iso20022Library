...
public partial record SecuritiesSettlementTransactionDetails22
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TradeDetails is SecuritiesTradeDetails52 TradeDetailsValue)
        {
        ...
        if (QuantityAndAccountDetails is QuantityAndAccount43 QuantityAndAccountDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails22 Deserialize(XElement element)
    {
