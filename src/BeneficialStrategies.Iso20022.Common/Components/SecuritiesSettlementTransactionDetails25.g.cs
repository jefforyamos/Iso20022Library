...
public partial record SecuritiesSettlementTransactionDetails25
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails25>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityAndAccountDetails is QuantityAndAccount55 QuantityAndAccountDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails25 Deserialize(XElement element)
    {
