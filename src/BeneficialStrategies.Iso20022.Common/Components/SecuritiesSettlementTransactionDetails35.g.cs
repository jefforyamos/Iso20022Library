...
public partial record SecuritiesSettlementTransactionDetails35
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails35>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TradeDetails is SecuritiesTradeDetails89 TradeDetailsValue)
        {
        ...
        if (QuantityAndAccountDetails is QuantityAndAccount75 QuantityAndAccountDetailsValue)
        {
        ...
        if (DeliveringSettlementParties is SettlementParties73 DeliveringSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "DlvrgSttlmPties", xmlNamespace );
            DeliveringSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingSettlementParties is SettlementParties73 ReceivingSettlementPartiesValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails35 Deserialize(XElement element)
    {
