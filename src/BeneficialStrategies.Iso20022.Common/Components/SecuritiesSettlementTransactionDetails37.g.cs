...
public partial record SecuritiesSettlementTransactionDetails37
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails37>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TradeDetails is SecuritiesTradeDetails90 TradeDetailsValue)
        {
        ...
        if (QuantityAndAccountDetails is QuantityAndAccount76 QuantityAndAccountDetailsValue)
        {
            writer.WriteStartElement(null, "QtyAndAcctDtls", xmlNamespace );
            QuantityAndAccountDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SettlementParameters is SettlementDetails158 SettlementParametersValue)
        {
        ...
        if (SettlementAmount is AmountAndDirection91 SettlementAmountValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails37 Deserialize(XElement element)
    {
