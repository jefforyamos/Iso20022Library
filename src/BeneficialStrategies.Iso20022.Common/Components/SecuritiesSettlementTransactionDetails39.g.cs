...
public partial record SecuritiesSettlementTransactionDetails39
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails39>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TradeDetails is SecuritiesTradeDetails91 TradeDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails39 Deserialize(XElement element)
    {
