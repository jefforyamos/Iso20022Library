...
public partial record SecuritiesSettlementTransactionDetails51
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails51>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityAndAccountDetails is QuantityAndAccount98 QuantityAndAccountDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails51 Deserialize(XElement element)
    {
