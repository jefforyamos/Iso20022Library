...
//
// Generated by ComponentGenerator for SecuritiesSettlementTransactionDetails53.  ISO2002 ID# _eZThnzi8Eeydid5dcNPKvg.
//
...
public partial record SecuritiesSettlementTransactionDetails53
     : IIsoXmlSerilizable<SecuritiesSettlementTransactionDetails53>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (QuantityAndAccountDetails is QuantityAndAccount111 QuantityAndAccountDetailsValue)
        {
        ...
        if (DeliveringSettlementParties is SettlementParties119 DeliveringSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "DlvrgSttlmPties", xmlNamespace );
            DeliveringSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingSettlementParties is SettlementParties119 ReceivingSettlementPartiesValue)
        {
    ...
    public static SecuritiesSettlementTransactionDetails53 Deserialize(XElement element)
    {
