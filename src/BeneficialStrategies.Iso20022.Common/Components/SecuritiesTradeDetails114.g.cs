...
public partial record SecuritiesTradeDetails114
     : IIsoXmlSerilizable<SecuritiesTradeDetails114>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeliveringSettlementParties is SettlementParties96 DeliveringSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "DlvrgSttlmPties", xmlNamespace );
            DeliveringSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingSettlementParties is SettlementParties96 ReceivingSettlementPartiesValue)
        {
        ...
        if (OtherBusinessParties is OtherParties42 OtherBusinessPartiesValue)
        {
    ...
    public static SecuritiesTradeDetails114 Deserialize(XElement element)
    {
