...
public partial record SecuritiesTradeDetails139
     : IIsoXmlSerilizable<SecuritiesTradeDetails139>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeliveringSettlementParties is SettlementParties104 DeliveringSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "DlvrgSttlmPties", xmlNamespace );
            DeliveringSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingSettlementParties is SettlementParties104 ReceivingSettlementPartiesValue)
        {
    ...
    public static SecuritiesTradeDetails139 Deserialize(XElement element)
    {
