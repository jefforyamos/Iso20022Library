...
public partial record SecuritiesTradeDetails19
     : IIsoXmlSerilizable<SecuritiesTradeDetails19>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherBusinessParties is OtherParties10 OtherBusinessPartiesValue)
        {
    ...
    public static SecuritiesTradeDetails19 Deserialize(XElement element)
    {
