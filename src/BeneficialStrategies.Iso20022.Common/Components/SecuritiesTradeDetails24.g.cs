...
public partial record SecuritiesTradeDetails24
     : IIsoXmlSerilizable<SecuritiesTradeDetails24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherAmounts is OtherAmounts15 OtherAmountsValue)
        {
    ...
    public static SecuritiesTradeDetails24 Deserialize(XElement element)
    {
