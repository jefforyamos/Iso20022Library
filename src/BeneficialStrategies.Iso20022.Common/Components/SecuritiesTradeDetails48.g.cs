...
public partial record SecuritiesTradeDetails48
     : IIsoXmlSerilizable<SecuritiesTradeDetails48>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherBusinessParties is OtherParties26 OtherBusinessPartiesValue)
        {
    ...
    public static SecuritiesTradeDetails48 Deserialize(XElement element)
    {
