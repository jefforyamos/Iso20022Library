...
public partial record SecuritiesTradeDetails93
     : IIsoXmlSerilizable<SecuritiesTradeDetails93>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Reporting is Reporting10Choice_ ReportingValue)
        {
    ...
    public static SecuritiesTradeDetails93 Deserialize(XElement element)
    {
