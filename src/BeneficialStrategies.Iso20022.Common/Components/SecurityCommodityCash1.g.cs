...
public partial record SecurityCommodityCash1
     : IIsoXmlSerilizable<SecurityCommodityCash1>
{
    #nullable enable
    ...
    public static SecurityCommodityCash1 Deserialize(XElement element)
    {
