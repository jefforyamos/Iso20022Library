...
public partial record SecurityDate14
     : IIsoXmlSerilizable<SecurityDate14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (LastTradingDate is DateFormat34Choice_ LastTradingDateValue)
        {
    ...
    public static SecurityDate14 Deserialize(XElement element)
    {
