...
public partial record SecurityDate18
     : IIsoXmlSerilizable<SecurityDate18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (LastTradingDate is DateFormat49Choice_ LastTradingDateValue)
        {
    ...
    public static SecurityDate18 Deserialize(XElement element)
    {
