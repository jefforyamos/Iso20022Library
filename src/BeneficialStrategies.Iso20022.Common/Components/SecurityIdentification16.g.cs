...
public partial record SecurityIdentification16
     : IIsoXmlSerilizable<SecurityIdentification16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherIdentification is OtherIdentification3 OtherIdentificationValue)
        {
    ...
    public static SecurityIdentification16 Deserialize(XElement element)
    {
