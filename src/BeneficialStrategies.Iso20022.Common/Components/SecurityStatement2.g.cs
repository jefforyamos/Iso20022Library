...
public partial record SecurityStatement2
     : IIsoXmlSerilizable<SecurityStatement2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Change is SecuritiesReferenceDataChange2 ChangeValue)
        {
    ...
    public static SecurityStatement2 Deserialize(XElement element)
    {
