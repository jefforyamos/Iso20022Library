...
public partial record ServiceResponse7
     : IIsoXmlSerilizable<ServiceResponse7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (StoredValueResponse is StoredValueResponse6 StoredValueResponseValue)
        {
            writer.WriteStartElement(null, "StordValRspn", xmlNamespace );
            StoredValueResponseValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (BatchResponse is BatchResponse5 BatchResponseValue)
        {
    ...
    public static ServiceResponse7 Deserialize(XElement element)
    {
