...
public partial record SessionManagementRequest4
     : IIsoXmlSerilizable<SessionManagementRequest4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (LoginRequest is LoginRequest3 LoginRequestValue)
        {
    ...
    public static SessionManagementRequest4 Deserialize(XElement element)
    {
