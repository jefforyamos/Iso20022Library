...
public partial record SessionManagementResponse2
     : IIsoXmlSerilizable<SessionManagementResponse2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (LoginResponse is LoginResponse1 LoginResponseValue)
        {
            writer.WriteStartElement(null, "LgnRspn", xmlNamespace );
            LoginResponseValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DiagnosisResponse is DiagnosisResponse1 DiagnosisResponseValue)
        {
    ...
    public static SessionManagementResponse2 Deserialize(XElement element)
    {
