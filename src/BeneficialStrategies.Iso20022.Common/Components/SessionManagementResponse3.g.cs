...
public partial record SessionManagementResponse3
     : IIsoXmlSerilizable<SessionManagementResponse3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (LoginResponse is LoginResponse2 LoginResponseValue)
        {
            writer.WriteStartElement(null, "LgnRspn", xmlNamespace );
            LoginResponseValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DiagnosisResponse is DiagnosisResponse2 DiagnosisResponseValue)
        {
    ...
    public static SessionManagementResponse3 Deserialize(XElement element)
    {
