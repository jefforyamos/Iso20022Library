...
public partial record SessionManagementResponse4
     : IIsoXmlSerilizable<SessionManagementResponse4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (LoginResponse is LoginResponse3 LoginResponseValue)
        {
            writer.WriteStartElement(null, "LgnRspn", xmlNamespace );
            LoginResponseValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DiagnosisResponse is DiagnosisResponse3 DiagnosisResponseValue)
        {
    ...
    public static SessionManagementResponse4 Deserialize(XElement element)
    {
