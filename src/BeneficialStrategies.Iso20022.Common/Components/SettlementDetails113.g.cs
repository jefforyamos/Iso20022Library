...
public partial record SettlementDetails113
     : IIsoXmlSerilizable<SettlementDetails113>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType25Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails113 Deserialize(XElement element)
    {
