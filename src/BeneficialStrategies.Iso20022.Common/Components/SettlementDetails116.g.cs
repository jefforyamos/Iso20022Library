...
public partial record SettlementDetails116
     : IIsoXmlSerilizable<SettlementDetails116>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RepurchaseType is RepurchaseType19Choice_ RepurchaseTypeValue)
        {
    ...
    public static SettlementDetails116 Deserialize(XElement element)
    {
