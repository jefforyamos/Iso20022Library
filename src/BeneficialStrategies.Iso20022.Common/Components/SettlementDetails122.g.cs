...
public partial record SettlementDetails122
     : IIsoXmlSerilizable<SettlementDetails122>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType32Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails122 Deserialize(XElement element)
    {
