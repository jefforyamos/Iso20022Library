...
public partial record SettlementDetails138
     : IIsoXmlSerilizable<SettlementDetails138>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType34Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails138 Deserialize(XElement element)
    {
