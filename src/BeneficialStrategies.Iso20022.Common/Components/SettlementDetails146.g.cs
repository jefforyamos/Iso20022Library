...
public partial record SettlementDetails146
     : IIsoXmlSerilizable<SettlementDetails146>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType37Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails146 Deserialize(XElement element)
    {
