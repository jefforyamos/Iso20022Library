...
public partial record SettlementDetails158
     : IIsoXmlSerilizable<SettlementDetails158>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType42Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails158 Deserialize(XElement element)
    {
