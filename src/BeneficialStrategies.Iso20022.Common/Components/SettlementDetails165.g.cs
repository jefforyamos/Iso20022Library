...
public partial record SettlementDetails165
     : IIsoXmlSerilizable<SettlementDetails165>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType47Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails165 Deserialize(XElement element)
    {
