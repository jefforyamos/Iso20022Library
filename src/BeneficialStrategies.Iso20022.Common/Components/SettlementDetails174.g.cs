...
public partial record SettlementDetails174
     : IIsoXmlSerilizable<SettlementDetails174>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementTransactionCondition is SettlementTransactionCondition26Choice_ SettlementTransactionConditionValue)
        {
    ...
    public static SettlementDetails174 Deserialize(XElement element)
    {
