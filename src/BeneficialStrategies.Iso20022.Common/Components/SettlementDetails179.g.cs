...
public partial record SettlementDetails179
     : IIsoXmlSerilizable<SettlementDetails179>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType53Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails179 Deserialize(XElement element)
    {
