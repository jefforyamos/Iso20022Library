...
public partial record SettlementDetails187
     : IIsoXmlSerilizable<SettlementDetails187>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementTransactionCondition is SettlementTransactionCondition35Choice_ SettlementTransactionConditionValue)
        {
    ...
    public static SettlementDetails187 Deserialize(XElement element)
    {
