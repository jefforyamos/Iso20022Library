...
public partial record SettlementDetails189
     : IIsoXmlSerilizable<SettlementDetails189>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType59Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails189 Deserialize(XElement element)
    {
