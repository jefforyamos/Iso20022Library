...
//
// Generated by ComponentGenerator for SettlementDetails205.  ISO2002 ID# _Sw3zQSqSEeyR9JrVGfaMKw.
//
...
public partial record SettlementDetails205
     : IIsoXmlSerilizable<SettlementDetails205>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementParties is SettlementParties35Choice_ SettlementPartiesValue)
        {
    ...
    public static SettlementDetails205 Deserialize(XElement element)
    {
