...
public partial record SettlementDetails213
     : IIsoXmlSerilizable<SettlementDetails213>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementInstructionGeneration is SettlementInstructionGeneration2Choice_ SettlementInstructionGenerationValue)
        {
        ...
        if (SettlementTransactionCondition is SettlementTransactionCondition31Choice_ SettlementTransactionConditionValue)
        {
        ...
        if (ExposureType is ExposureType18Choice_ ExposureTypeValue)
        {
        ...
        if (SettlingCapacity is SettlingCapacity9Choice_ SettlingCapacityValue)
        {
    ...
    public static SettlementDetails213 Deserialize(XElement element)
    {
