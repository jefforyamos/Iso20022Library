...
public partial record SettlementDetails23
     : IIsoXmlSerilizable<SettlementDetails23>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionCondition is SettlementTransactionCondition6Choice_ SettlementTransactionConditionValue)
        {
    ...
    public static SettlementDetails23 Deserialize(XElement element)
    {
