...
public partial record SettlementDetails88
     : IIsoXmlSerilizable<SettlementDetails88>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementParties is SettlementParties3Choice_ SettlementPartiesValue)
        {
    ...
    public static SettlementDetails88 Deserialize(XElement element)
    {
