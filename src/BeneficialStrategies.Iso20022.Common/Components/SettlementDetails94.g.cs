...
public partial record SettlementDetails94
     : IIsoXmlSerilizable<SettlementDetails94>
{
    #nullable enable
    ...
    {
        if (SecuritiesTransactionType is SecuritiesTransactionType21Choice_ SecuritiesTransactionTypeValue)
        {
    ...
    public static SettlementDetails94 Deserialize(XElement element)
    {
