...
public partial record SettlementFailsDailyInstrument3
{
    ...
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice Equity { get; init; } 
    /// <summary>
    /// Debt instrument issued by a sovereign issuer.
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice SovereignDebt { get; init; } 
    /// <summary>
    /// Bonds other than sovereign debt.
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice Bond { get; init; } 
    /// <summary>
    /// Securities meeting the criteria laid down in the relevant legislation.
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice OtherTransferableSecurities { get; init; } 
    /// <summary>
    ...
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice ExchangeTradedFunds { get; init; } 
    /// <summary>
    /// Units in collective investment undertakings, other than ETFs.
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice CollectiveInvestmentUndertakings { get; init; } 
    /// <summary>
    /// Money market instruments other than sovereign debts.
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice MoneyMarketInstrument { get; init; } 
    /// <summary>
    /// Relates to emission allowances which are tradable according to the relevant legislation.
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice EmissionAllowance { get; init; } 
    /// <summary>
    /// Covers any financial instruments not covered as a dedicated category.
    /// </summary>
    public required ISettlementFailsDailyTransactionType1Choice Other { get; init; } 
