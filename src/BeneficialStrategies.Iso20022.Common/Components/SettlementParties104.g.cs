...
//
// Generated by ComponentGenerator for SettlementParties104.  ISO2002 ID# _cegCpTi8Eeydid5dcNPKvg.
//
...
public partial record SettlementParties104
     : IIsoXmlSerilizable<SettlementParties104>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Party1 is PartyIdentificationAndAccount206 Party1Value)
        {
    ...
    public static SettlementParties104 Deserialize(XElement element)
    {
