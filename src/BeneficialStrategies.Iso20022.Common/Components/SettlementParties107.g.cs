...
public partial record SettlementParties107
     : IIsoXmlSerilizable<SettlementParties107>
{
    #nullable enable
    ...
    public static SettlementParties107 Deserialize(XElement element)
    {
