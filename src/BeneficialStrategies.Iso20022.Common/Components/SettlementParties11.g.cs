...
public partial record SettlementParties11
     : IIsoXmlSerilizable<SettlementParties11>
{
    #nullable enable
    ...
    public static SettlementParties11 Deserialize(XElement element)
    {
