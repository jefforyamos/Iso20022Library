...
public partial record SettlementParties2
     : IIsoXmlSerilizable<SettlementParties2>
{
    #nullable enable
    ...
    public static SettlementParties2 Deserialize(XElement element)
    {
