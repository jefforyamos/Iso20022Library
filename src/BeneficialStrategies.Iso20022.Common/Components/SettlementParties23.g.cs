...
public partial record SettlementParties23
     : IIsoXmlSerilizable<SettlementParties23>
{
    #nullable enable
    ...
    public static SettlementParties23 Deserialize(XElement element)
    {
