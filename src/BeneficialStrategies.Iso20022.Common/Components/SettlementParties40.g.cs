...
public partial record SettlementParties40
     : IIsoXmlSerilizable<SettlementParties40>
{
    #nullable enable
    ...
    public static SettlementParties40 Deserialize(XElement element)
    {
