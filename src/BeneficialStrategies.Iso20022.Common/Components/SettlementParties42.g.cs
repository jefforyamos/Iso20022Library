...
public partial record SettlementParties42
     : IIsoXmlSerilizable<SettlementParties42>
{
    #nullable enable
    ...
    public static SettlementParties42 Deserialize(XElement element)
    {
