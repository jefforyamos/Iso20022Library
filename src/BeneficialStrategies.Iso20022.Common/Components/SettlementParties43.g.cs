...
public partial record SettlementParties43
     : IIsoXmlSerilizable<SettlementParties43>
{
    #nullable enable
    ...
    {
        if (Depository is PartyIdentification102 DepositoryValue)
        {
    ...
    public static SettlementParties43 Deserialize(XElement element)
    {
