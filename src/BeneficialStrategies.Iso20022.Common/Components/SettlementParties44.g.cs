...
public partial record SettlementParties44
     : IIsoXmlSerilizable<SettlementParties44>
{
    #nullable enable
    ...
    public static SettlementParties44 Deserialize(XElement element)
    {
