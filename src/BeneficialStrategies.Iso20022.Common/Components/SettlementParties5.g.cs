...
public partial record SettlementParties5
     : IIsoXmlSerilizable<SettlementParties5>
{
    #nullable enable
    ...
    public static SettlementParties5 Deserialize(XElement element)
    {
