...
public partial record SettlementParties61
     : IIsoXmlSerilizable<SettlementParties61>
{
    #nullable enable
    ...
    public static SettlementParties61 Deserialize(XElement element)
    {
