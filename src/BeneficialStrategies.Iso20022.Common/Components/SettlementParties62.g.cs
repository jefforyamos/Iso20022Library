...
public partial record SettlementParties62
     : IIsoXmlSerilizable<SettlementParties62>
{
    #nullable enable
    ...
    {
        if (Depository is PartyIdentification127 DepositoryValue)
        {
            writer.WriteStartElement(null, "Dpstry", xmlNamespace );
            DepositoryValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Party1 is PartyIdentificationAndAccount159 Party1Value)
        {
    ...
    public static SettlementParties62 Deserialize(XElement element)
    {
