...
public partial record SettlementParties64
     : IIsoXmlSerilizable<SettlementParties64>
{
    #nullable enable
    ...
    public static SettlementParties64 Deserialize(XElement element)
    {
