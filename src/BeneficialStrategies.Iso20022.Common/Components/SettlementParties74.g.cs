...
public partial record SettlementParties74
     : IIsoXmlSerilizable<SettlementParties74>
{
    #nullable enable
    ...
    public static SettlementParties74 Deserialize(XElement element)
    {
