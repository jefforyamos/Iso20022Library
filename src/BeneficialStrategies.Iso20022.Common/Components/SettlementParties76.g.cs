...
public partial record SettlementParties76
     : IIsoXmlSerilizable<SettlementParties76>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Party1 is PartyIdentificationAndAccount168 Party1Value)
        {
    ...
    public static SettlementParties76 Deserialize(XElement element)
    {
