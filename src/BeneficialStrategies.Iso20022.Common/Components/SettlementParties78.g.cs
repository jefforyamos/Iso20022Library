...
public partial record SettlementParties78
     : IIsoXmlSerilizable<SettlementParties78>
{
    #nullable enable
    ...
    public static SettlementParties78 Deserialize(XElement element)
    {
