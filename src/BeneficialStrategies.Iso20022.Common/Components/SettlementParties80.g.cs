...
public partial record SettlementParties80
     : IIsoXmlSerilizable<SettlementParties80>
{
    #nullable enable
    ...
    public static SettlementParties80 Deserialize(XElement element)
    {
