...
public partial record SettlementParties94
     : IIsoXmlSerilizable<SettlementParties94>
{
    #nullable enable
    ...
    public static SettlementParties94 Deserialize(XElement element)
    {
