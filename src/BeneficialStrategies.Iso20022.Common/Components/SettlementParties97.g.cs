...
public partial record SettlementParties97
     : IIsoXmlSerilizable<SettlementParties97>
{
    #nullable enable
    ...
    public static SettlementParties97 Deserialize(XElement element)
    {
