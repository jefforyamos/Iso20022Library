...
public partial record SettlementTypeAndAdditionalParameters20
     : IIsoXmlSerilizable<SettlementTypeAndAdditionalParameters20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ClientCollateralTransactionIdentification is IsoRestrictedFINXMax16Text ClientCollateralTransactionIdentificationValue)
        {
            writer.WriteStartElement(null, "ClntCollTxId", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoRestrictedFINXMax16Text(ClientCollateralTransactionIdentificationValue)); // data type RestrictedFINXMax16Text System.String
            writer.WriteEndElement();
        }
    ...
    public static SettlementTypeAndAdditionalParameters20 Deserialize(XElement element)
    {
