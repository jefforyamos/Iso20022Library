...
public partial record StandingOrderCriteria4
     : IIsoXmlSerilizable<StandingOrderCriteria4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SearchCriteria is StandingOrderSearchCriteria4 SearchCriteriaValue)
        {
    ...
    public static StandingOrderCriteria4 Deserialize(XElement element)
    {
