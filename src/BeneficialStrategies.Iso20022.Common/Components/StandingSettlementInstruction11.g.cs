...
public partial record StandingSettlementInstruction11
     : IIsoXmlSerilizable<StandingSettlementInstruction11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherDeliveringSettlementParties is SettlementParties36 OtherDeliveringSettlementPartiesValue)
        {
        ...
        if (OtherReceivingSettlementParties is SettlementParties36 OtherReceivingSettlementPartiesValue)
        {
    ...
    public static StandingSettlementInstruction11 Deserialize(XElement element)
    {
