...
public partial record StandingSettlementInstruction12
     : IIsoXmlSerilizable<StandingSettlementInstruction12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherDeliveringSettlementParties is SettlementParties44 OtherDeliveringSettlementPartiesValue)
        {
        ...
        if (OtherReceivingSettlementParties is SettlementParties44 OtherReceivingSettlementPartiesValue)
        {
    ...
    public static StandingSettlementInstruction12 Deserialize(XElement element)
    {
