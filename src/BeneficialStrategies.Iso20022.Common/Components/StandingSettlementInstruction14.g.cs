...
public partial record StandingSettlementInstruction14
     : IIsoXmlSerilizable<StandingSettlementInstruction14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Vendor is PartyIdentification100 VendorValue)
        {
            writer.WriteStartElement(null, "Vndr", xmlNamespace );
            VendorValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (OtherDeliveringSettlementParties is SettlementParties62 OtherDeliveringSettlementPartiesValue)
        {
        ...
        if (OtherReceivingSettlementParties is SettlementParties62 OtherReceivingSettlementPartiesValue)
        {
    ...
    public static StandingSettlementInstruction14 Deserialize(XElement element)
    {
