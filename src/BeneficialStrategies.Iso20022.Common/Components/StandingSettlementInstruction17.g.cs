...
public partial record StandingSettlementInstruction17
     : IIsoXmlSerilizable<StandingSettlementInstruction17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherDeliveringSettlementParties is SettlementParties81 OtherDeliveringSettlementPartiesValue)
        {
        ...
        if (OtherReceivingSettlementParties is SettlementParties81 OtherReceivingSettlementPartiesValue)
        {
    ...
    public static StandingSettlementInstruction17 Deserialize(XElement element)
    {
