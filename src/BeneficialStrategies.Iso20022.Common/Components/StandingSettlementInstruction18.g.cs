...
public partial record StandingSettlementInstruction18
     : IIsoXmlSerilizable<StandingSettlementInstruction18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OtherDeliveringSettlementParties is SettlementParties100 OtherDeliveringSettlementPartiesValue)
        {
        ...
        if (OtherReceivingSettlementParties is SettlementParties100 OtherReceivingSettlementPartiesValue)
        {
    ...
    public static StandingSettlementInstruction18 Deserialize(XElement element)
    {
