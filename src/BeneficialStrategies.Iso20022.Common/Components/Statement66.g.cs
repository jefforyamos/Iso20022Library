...
public partial record Statement66
     : IIsoXmlSerilizable<Statement66>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (NotificationDeadlinePeriod is DateOrDateTimePeriod2Choice_ NotificationDeadlinePeriodValue)
        {
    ...
    public static Statement66 Deserialize(XElement element)
    {
