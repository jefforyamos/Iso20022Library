...
public partial record StatisticsByPredefinedTimePeriods2
     : IIsoXmlSerilizable<StatisticsByPredefinedTimePeriods2>
{
    #nullable enable
    ...
    {
        if (HighestPriceValue12Months is PriceValue5 HighestPriceValue12MonthsValue)
        {
    ...
    public static StatisticsByPredefinedTimePeriods2 Deserialize(XElement element)
    {
