...
public partial record StatusAndReason28
     : IIsoXmlSerilizable<StatusAndReason28>
{
    #nullable enable
    ...
    {
        if (ProcessingStatus is ProcessingStatus52Choice_ ProcessingStatusValue)
        {
    ...
    public static StatusAndReason28 Deserialize(XElement element)
    {
