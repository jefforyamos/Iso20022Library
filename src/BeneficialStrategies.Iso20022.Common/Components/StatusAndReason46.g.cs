...
public partial record StatusAndReason46
     : IIsoXmlSerilizable<StatusAndReason46>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnaffirmedReason is UnaffirmedReason3Choice_ UnaffirmedReasonValue)
        {
    ...
    public static StatusAndReason46 Deserialize(XElement element)
    {
