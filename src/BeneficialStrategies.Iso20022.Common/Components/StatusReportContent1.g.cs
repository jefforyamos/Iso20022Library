...
public partial record StatusReportContent1
     : IIsoXmlSerilizable<StatusReportContent1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (POIComponent is PointOfInteractionComponent2 POIComponentValue)
        {
    ...
    public static StatusReportContent1 Deserialize(XElement element)
    {
