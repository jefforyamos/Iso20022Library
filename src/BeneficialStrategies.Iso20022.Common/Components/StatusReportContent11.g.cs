...
public partial record StatusReportContent11
     : IIsoXmlSerilizable<StatusReportContent11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (POIComponent is PointOfInteractionComponent12 POIComponentValue)
        {
    ...
    public static StatusReportContent11 Deserialize(XElement element)
    {
