...
public partial record StatusReportContent5
{
    ...
    /// </summary>
    public PointOfInteractionComponent6[] POIComponent { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    ...
    /// </summary>
    public TMSEvent4[] Event { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
