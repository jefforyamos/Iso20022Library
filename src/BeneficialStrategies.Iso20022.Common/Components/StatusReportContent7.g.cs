...
public partial record StatusReportContent7
     : IIsoXmlSerilizable<StatusReportContent7>
{
    #nullable enable
    ...
    public static StatusReportContent7 Deserialize(XElement element)
    {
