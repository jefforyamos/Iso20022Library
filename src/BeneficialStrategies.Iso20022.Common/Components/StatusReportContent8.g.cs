...
public partial record StatusReportContent8
     : IIsoXmlSerilizable<StatusReportContent8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (POIComponent is PointOfInteractionComponent9 POIComponentValue)
        {
    ...
    public static StatusReportContent8 Deserialize(XElement element)
    {
