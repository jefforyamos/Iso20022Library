...
public partial record StatusReportContent9
     : IIsoXmlSerilizable<StatusReportContent9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (POIComponent is PointOfInteractionComponent10 POIComponentValue)
        {
    ...
    public static StatusReportContent9 Deserialize(XElement element)
    {
