...
public partial record StatusTrail4
     : IIsoXmlSerilizable<StatusTrail4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ModificationProcessingStatus is ModificationProcessingStatus4Choice_ ModificationProcessingStatusValue)
        {
    ...
    public static StatusTrail4 Deserialize(XElement element)
    {
