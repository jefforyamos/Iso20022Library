...
public partial record StatusTrail6
     : IIsoXmlSerilizable<StatusTrail6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProcessingStatus is ProcessingStatus49Choice_ ProcessingStatusValue)
        {
    ...
    public static StatusTrail6 Deserialize(XElement element)
    {
