...
public partial record StatusTrail7
     : IIsoXmlSerilizable<StatusTrail7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SendingOrganisationIdentification is OrganisationIdentification9 SendingOrganisationIdentificationValue)
        {
        ...
        if (ProcessingStatus is ProcessingStatus60Choice_ ProcessingStatusValue)
        {
    ...
    public static StatusTrail7 Deserialize(XElement element)
    {
