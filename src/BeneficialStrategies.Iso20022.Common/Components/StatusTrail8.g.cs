...
public partial record StatusTrail8
     : IIsoXmlSerilizable<StatusTrail8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProcessingStatus is ProcessingStatus75Choice_ ProcessingStatusValue)
        {
        ...
        if (ModificationProcessingStatus is ModificationProcessingStatus7Choice_ ModificationProcessingStatusValue)
        {
            writer.WriteStartElement(null, "ModPrcgSts", xmlNamespace );
            ModificationProcessingStatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CancellationStatus is ProcessingStatus53Choice_ CancellationStatusValue)
        {
    ...
    public static StatusTrail8 Deserialize(XElement element)
    {
