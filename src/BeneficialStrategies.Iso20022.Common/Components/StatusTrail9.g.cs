...
public partial record StatusTrail9
     : IIsoXmlSerilizable<StatusTrail9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProcessingStatus is ProcessingStatus76Choice_ ProcessingStatusValue)
        {
        ...
        if (ModificationProcessingStatus is ModificationProcessingStatus8Choice_ ModificationProcessingStatusValue)
        {
            writer.WriteStartElement(null, "ModPrcgSts", xmlNamespace );
            ModificationProcessingStatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CancellationStatus is ProcessingStatus61Choice_ CancellationStatusValue)
        {
    ...
    public static StatusTrail9 Deserialize(XElement element)
    {
