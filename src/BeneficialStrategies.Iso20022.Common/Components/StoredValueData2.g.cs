...
public partial record StoredValueData2
     : IIsoXmlSerilizable<StoredValueData2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AccountIdentification is StoredValueAccount1 AccountIdentificationValue)
        {
    ...
    public static StoredValueData2 Deserialize(XElement element)
    {
