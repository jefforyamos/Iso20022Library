...
public partial record StructuredRemittanceInformation15
     : IIsoXmlSerilizable<StructuredRemittanceInformation15>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GarnishmentRemittance is Garnishment2 GarnishmentRemittanceValue)
        {
    ...
    public static StructuredRemittanceInformation15 Deserialize(XElement element)
    {
