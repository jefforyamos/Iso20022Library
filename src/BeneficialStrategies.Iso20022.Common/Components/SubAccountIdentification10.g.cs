...
public partial record SubAccountIdentification10
     : IIsoXmlSerilizable<SubAccountIdentification10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation8 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification10 Deserialize(XElement element)
    {
