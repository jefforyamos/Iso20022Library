...
public partial record SubAccountIdentification16
     : IIsoXmlSerilizable<SubAccountIdentification16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation13 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification16 Deserialize(XElement element)
    {
