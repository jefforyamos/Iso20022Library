...
public partial record SubAccountIdentification17
     : IIsoXmlSerilizable<SubAccountIdentification17>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation12 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification17 Deserialize(XElement element)
    {
