...
public partial record SubAccountIdentification22
     : IIsoXmlSerilizable<SubAccountIdentification22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation16 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification22 Deserialize(XElement element)
    {
