...
//
// Generated by ComponentGenerator for SubAccountIdentification23.  ISO2002 ID# _IB1Vgf_iEeCcv6nahBzk1w.
//
...
public partial record SubAccountIdentification23
     : IIsoXmlSerilizable<SubAccountIdentification23>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation17 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification23 Deserialize(XElement element)
    {
