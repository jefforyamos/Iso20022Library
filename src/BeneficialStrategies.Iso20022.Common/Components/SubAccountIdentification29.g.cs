...
public partial record SubAccountIdentification29
     : IIsoXmlSerilizable<SubAccountIdentification29>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation22 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification29 Deserialize(XElement element)
    {
