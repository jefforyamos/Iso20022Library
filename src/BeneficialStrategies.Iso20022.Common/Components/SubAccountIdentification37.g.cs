...
public partial record SubAccountIdentification37
     : IIsoXmlSerilizable<SubAccountIdentification37>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation25 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification37 Deserialize(XElement element)
    {
