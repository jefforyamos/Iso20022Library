...
public partial record SubAccountIdentification42
     : IIsoXmlSerilizable<SubAccountIdentification42>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation30 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification42 Deserialize(XElement element)
    {
