...
public partial record SubAccountIdentification45
     : IIsoXmlSerilizable<SubAccountIdentification45>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation32 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification45 Deserialize(XElement element)
    {
