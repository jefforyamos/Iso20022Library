...
public partial record SubAccountIdentification55
     : IIsoXmlSerilizable<SubAccountIdentification55>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation35 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification55 Deserialize(XElement element)
    {
