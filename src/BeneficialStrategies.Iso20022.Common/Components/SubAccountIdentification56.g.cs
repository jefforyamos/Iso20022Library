...
public partial record SubAccountIdentification56
     : IIsoXmlSerilizable<SubAccountIdentification56>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation37 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification56 Deserialize(XElement element)
    {
