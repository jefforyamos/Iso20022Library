...
public partial record SubAccountIdentification57
     : IIsoXmlSerilizable<SubAccountIdentification57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation38 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification57 Deserialize(XElement element)
    {
