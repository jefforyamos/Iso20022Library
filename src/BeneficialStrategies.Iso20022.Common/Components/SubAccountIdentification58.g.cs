...
//
// Generated by ComponentGenerator for SubAccountIdentification58.  ISO2002 ID# _uLgL_ffVEeiNZp_PtLohLw.
//
...
public partial record SubAccountIdentification58
     : IIsoXmlSerilizable<SubAccountIdentification58>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation39 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification58 Deserialize(XElement element)
    {
