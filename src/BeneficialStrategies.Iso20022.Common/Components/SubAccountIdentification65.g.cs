...
public partial record SubAccountIdentification65
     : IIsoXmlSerilizable<SubAccountIdentification65>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForSubAccount is AggregateBalanceInformation40 BalanceForSubAccountValue)
        {
    ...
    public static SubAccountIdentification65 Deserialize(XElement element)
    {
