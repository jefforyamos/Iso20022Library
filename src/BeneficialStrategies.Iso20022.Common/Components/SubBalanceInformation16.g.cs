...
public partial record SubBalanceInformation16
     : IIsoXmlSerilizable<SubBalanceInformation16>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalBalanceBreakdownDetails is AdditionalBalanceInformation16 AdditionalBalanceBreakdownDetailsValue)
        {
    ...
    public static SubBalanceInformation16 Deserialize(XElement element)
    {
