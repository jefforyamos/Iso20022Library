...
public partial record SubBalanceInformation18
     : IIsoXmlSerilizable<SubBalanceInformation18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalBalanceBreakdownDetails is AdditionalBalanceInformation18 AdditionalBalanceBreakdownDetailsValue)
        {
    ...
    public static SubBalanceInformation18 Deserialize(XElement element)
    {
