...
public partial record SubBalanceInformation22
     : IIsoXmlSerilizable<SubBalanceInformation22>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalBalanceBreakdownDetails is AdditionalBalanceInformation22 AdditionalBalanceBreakdownDetailsValue)
        {
    ...
    public static SubBalanceInformation22 Deserialize(XElement element)
    {
