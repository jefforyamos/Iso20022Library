...
public partial record SubBalanceInformation24
     : IIsoXmlSerilizable<SubBalanceInformation24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalBalanceBreakdownDetails is AdditionalBalanceInformation24 AdditionalBalanceBreakdownDetailsValue)
        {
    ...
    public static SubBalanceInformation24 Deserialize(XElement element)
    {
