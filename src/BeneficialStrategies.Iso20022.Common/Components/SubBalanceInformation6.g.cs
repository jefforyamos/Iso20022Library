...
public partial record SubBalanceInformation6
     : IIsoXmlSerilizable<SubBalanceInformation6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalBalanceBreakdownDetails is AdditionalBalanceInformation6 AdditionalBalanceBreakdownDetailsValue)
        {
    ...
    public static SubBalanceInformation6 Deserialize(XElement element)
    {
