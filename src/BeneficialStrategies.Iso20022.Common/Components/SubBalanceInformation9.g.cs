...
public partial record SubBalanceInformation9
     : IIsoXmlSerilizable<SubBalanceInformation9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalBalanceBreakdownDetails is AdditionalBalanceInformation9 AdditionalBalanceBreakdownDetailsValue)
        {
    ...
    public static SubBalanceInformation9 Deserialize(XElement element)
    {
