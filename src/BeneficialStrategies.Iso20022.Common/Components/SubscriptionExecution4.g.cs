...
public partial record SubscriptionExecution4
     : IIsoXmlSerilizable<SubscriptionExecution4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashSettlementDetails is PaymentTransaction13 CashSettlementDetailsValue)
        {
    ...
    public static SubscriptionExecution4 Deserialize(XElement element)
    {
