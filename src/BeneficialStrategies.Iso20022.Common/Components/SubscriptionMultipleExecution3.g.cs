...
public partial record SubscriptionMultipleExecution3
     : IIsoXmlSerilizable<SubscriptionMultipleExecution3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (BulkCashSettlementDetails is PaymentTransaction24 BulkCashSettlementDetailsValue)
        {
    ...
    public static SubscriptionMultipleExecution3 Deserialize(XElement element)
    {
