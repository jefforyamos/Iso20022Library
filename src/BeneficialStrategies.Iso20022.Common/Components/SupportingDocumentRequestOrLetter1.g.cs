...
public partial record SupportingDocumentRequestOrLetter1
     : IIsoXmlSerilizable<SupportingDocumentRequestOrLetter1>
{
    #nullable enable
    ...
    public static SupportingDocumentRequestOrLetter1 Deserialize(XElement element)
    {
