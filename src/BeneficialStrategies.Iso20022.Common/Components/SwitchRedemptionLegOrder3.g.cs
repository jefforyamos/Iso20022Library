...
public partial record SwitchRedemptionLegOrder3
     : IIsoXmlSerilizable<SwitchRedemptionLegOrder3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentQuantityChoice is FinancialInstrumentQuantity5Choice_ FinancialInstrumentQuantityChoiceValue)
        {
    ...
    public static SwitchRedemptionLegOrder3 Deserialize(XElement element)
    {
