...
public partial record SystemSearch4
     : IIsoXmlSerilizable<SystemSearch4>
{
    #nullable enable
    ...
    {
        if (SystemIdentification is ClearingSystemIdentification3Choice_ SystemIdentificationValue)
        {
            writer.WriteStartElement(null, "SysId", xmlNamespace );
            SystemIdentificationValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (MemberIdentification is BranchAndFinancialInstitutionIdentification6 MemberIdentificationValue)
        {
    ...
    public static SystemSearch4 Deserialize(XElement element)
    {
