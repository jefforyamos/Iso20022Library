...
public partial record TargetMarket2
     : IIsoXmlSerilizable<TargetMarket2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ClientObjectivesAndNeeds is InvestorRequirements2 ClientObjectivesAndNeedsValue)
        {
    ...
    public static TargetMarket2 Deserialize(XElement element)
    {
