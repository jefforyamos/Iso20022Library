     ...
     : IIsoXmlSerilizable<Tax38>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TaxCalculationDetails is TaxCalculationInformation11 TaxCalculationDetailsValue)
        {
    ...
    public static Tax38 Deserialize(XElement element)
    {
