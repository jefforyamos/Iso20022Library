...
public partial record TaxInformation3
     : IIsoXmlSerilizable<TaxInformation3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        {
            writer.WriteStartElement(null, "AdmstnZn", xmlNamespace );
        ...
        if (Record is TaxRecord1 RecordValue)
        {
    ...
    public static TaxInformation3 Deserialize(XElement element)
    {
