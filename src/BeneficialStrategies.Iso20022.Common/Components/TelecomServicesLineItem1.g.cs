...
public partial record TelecomServicesLineItem1
     : IIsoXmlSerilizable<TelecomServicesLineItem1>
{
    #nullable enable
    ...
    public static TelecomServicesLineItem1 Deserialize(XElement element)
    {
