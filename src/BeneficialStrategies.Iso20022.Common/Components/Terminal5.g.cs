     ...
     : IIsoXmlSerilizable<Terminal5>
{
    ...
    {
        if (TerminalIdentification is TerminalIdentification3 TerminalIdentificationValue)
        {
    ...
    public static Terminal5 Deserialize(XElement element)
    {
