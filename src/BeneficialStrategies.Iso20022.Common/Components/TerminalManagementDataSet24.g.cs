...
public partial record TerminalManagementDataSet24
     : IIsoXmlSerilizable<TerminalManagementDataSet24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Content is ManagementPlanContent7 ContentValue)
        {
    ...
    public static TerminalManagementDataSet24 Deserialize(XElement element)
    {
