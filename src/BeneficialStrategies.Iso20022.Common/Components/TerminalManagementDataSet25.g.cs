...
public partial record TerminalManagementDataSet25
     : IIsoXmlSerilizable<TerminalManagementDataSet25>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SessionKey is CryptographicKey13 SessionKeyValue)
        {
    ...
    public static TerminalManagementDataSet25 Deserialize(XElement element)
    {
