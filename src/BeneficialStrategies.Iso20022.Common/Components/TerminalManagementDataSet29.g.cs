...
public partial record TerminalManagementDataSet29
     : IIsoXmlSerilizable<TerminalManagementDataSet29>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Content is ManagementPlanContent8 ContentValue)
        {
    ...
    public static TerminalManagementDataSet29 Deserialize(XElement element)
    {
