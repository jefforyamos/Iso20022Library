...
public partial record TerminalManagementDataSet30
     : IIsoXmlSerilizable<TerminalManagementDataSet30>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Content is ManagementPlanContent9 ContentValue)
        {
    ...
    public static TerminalManagementDataSet30 Deserialize(XElement element)
    {
