...
public partial record ThirdPartyRights2
     : IIsoXmlSerilizable<ThirdPartyRights2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Holder is PartyIdentification125Choice_ HolderValue)
        {
    ...
    public static ThirdPartyRights2 Deserialize(XElement element)
    {
