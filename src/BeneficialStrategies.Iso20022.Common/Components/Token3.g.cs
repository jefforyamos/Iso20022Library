     ...
     : IIsoXmlSerilizable<Token3>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalToken is Token4 OriginalTokenValue)
        {
            writer.WriteStartElement(null, "OrgnlTkn", xmlNamespace );
            OriginalTokenValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    ...
    public static Token3 Deserialize(XElement element)
    {
