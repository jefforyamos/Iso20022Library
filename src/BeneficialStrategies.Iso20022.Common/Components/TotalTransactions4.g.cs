...
public partial record TotalTransactions4
     : IIsoXmlSerilizable<TotalTransactions4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TotalEntriesPerBankTransactionCode is TotalsPerBankTransactionCode3 TotalEntriesPerBankTransactionCodeValue)
        {
    ...
    public static TotalTransactions4 Deserialize(XElement element)
    {
