...
public partial record TotalValueInPageAndStatement3
     : IIsoXmlSerilizable<TotalValueInPageAndStatement3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TotalEligibleCollateralValue is AmountAndDirection14 TotalEligibleCollateralValueValue)
        {
    ...
    public static TotalValueInPageAndStatement3 Deserialize(XElement element)
    {
