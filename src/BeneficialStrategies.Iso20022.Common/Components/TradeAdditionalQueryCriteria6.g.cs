...
public partial record TradeAdditionalQueryCriteria6
     : IIsoXmlSerilizable<TradeAdditionalQueryCriteria6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateSector is CorporateSectorCriteria4 CorporateSectorValue)
        {
    ...
    public static TradeAdditionalQueryCriteria6 Deserialize(XElement element)
    {
