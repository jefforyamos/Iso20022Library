...
public partial record TradeData40
     : IIsoXmlSerilizable<TradeData40>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CurrentSettlementDate is IsoISODate CurrentSettlementDateValue)
        {
            writer.WriteStartElement(null, "CurSttlmDt", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoISODate(CurrentSettlementDateValue)); // data type ISODate System.DateOnly
            writer.WriteEndElement();
        }
        if (NewSettlementDate is IsoISODate NewSettlementDateValue)
        {
            writer.WriteStartElement(null, "NewSttlmDt", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoISODate(NewSettlementDateValue)); // data type ISODate System.DateOnly
            writer.WriteEndElement();
        }
    ...
    public static TradeData40 Deserialize(XElement element)
    {
