     ...
     : IIsoXmlSerilizable<TradeLeg9>
{
    ...
    {
        if (MarginAccount is SecuritiesAccount19 MarginAccountValue)
        {
            writer.WriteStartElement(null, "MrgnAcct", xmlNamespace );
            MarginAccountValue.Serialize(writer, xmlNamespace);
        ...
        if (SettlementDetails is Settlement1 SettlementDetailsValue)
        {
    ...
    public static TradeLeg9 Deserialize(XElement element)
    {
