...
public partial record TradeProduct2
     : IIsoXmlSerilizable<TradeProduct2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProductCharacteristics is ProductCharacteristics3 ProductCharacteristicsValue)
        {
    ...
    public static TradeProduct2 Deserialize(XElement element)
    {
