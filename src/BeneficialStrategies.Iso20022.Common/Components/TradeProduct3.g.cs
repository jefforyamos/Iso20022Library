...
public partial record TradeProduct3
     : IIsoXmlSerilizable<TradeProduct3>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProductCharacteristics is ProductCharacteristics4 ProductCharacteristicsValue)
        {
    ...
    public static TradeProduct3 Deserialize(XElement element)
    {
