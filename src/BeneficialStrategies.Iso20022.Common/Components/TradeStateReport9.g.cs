...
public partial record TradeStateReport9
     : IIsoXmlSerilizable<TradeStateReport9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CollateralData is TransactionCollateralData15Choice_ CollateralDataValue)
        {
    ...
    public static TradeStateReport9 Deserialize(XElement element)
    {
