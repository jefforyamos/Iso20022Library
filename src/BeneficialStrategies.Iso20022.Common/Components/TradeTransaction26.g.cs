...
public partial record TradeTransaction26
     : IIsoXmlSerilizable<TradeTransaction26>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoISODate(TerminationDate)); // data type ISODate System.DateOnly
        writer.WriteEndElement();
    ...
    public static TradeTransaction26 Deserialize(XElement element)
    {
