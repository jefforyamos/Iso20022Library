...
public partial record TradeTypeQueryCriteria2
     : IIsoXmlSerilizable<TradeTypeQueryCriteria2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SecuritiesFinancingTransactionType is ExposureType10Code SecuritiesFinancingTransactionTypeValue)
        {
    ...
    public static TradeTypeQueryCriteria2 Deserialize(XElement element)
    {
