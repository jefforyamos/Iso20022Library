...
public partial record TradingVenueAttributes2
     : IIsoXmlSerilizable<TradingVenueAttributes2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (IssuerRequest is IsoTrueFalseIndicator IssuerRequestValue)
        {
            writer.WriteStartElement(null, "IssrReq", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoTrueFalseIndicator(IssuerRequestValue)); // data type TrueFalseIndicator System.String
            writer.WriteEndElement();
        }
    ...
    public static TradingVenueAttributes2 Deserialize(XElement element)
    {
