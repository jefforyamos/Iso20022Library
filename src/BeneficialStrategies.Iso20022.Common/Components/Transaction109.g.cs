...
public partial record Transaction109
     : IIsoXmlSerilizable<Transaction109>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails128 TransactionDetailsValue)
        {
            writer.WriteStartElement(null, "TxDtls", xmlNamespace );
            TransactionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatusAndReason is Status29Choice_ StatusAndReasonValue)
        {
    ...
    public static Transaction109 Deserialize(XElement element)
    {
