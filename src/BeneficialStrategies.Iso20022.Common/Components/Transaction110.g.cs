...
public partial record Transaction110
     : IIsoXmlSerilizable<Transaction110>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails129 TransactionDetailsValue)
        {
    ...
    public static Transaction110 Deserialize(XElement element)
    {
