...
public partial record Transaction112
     : IIsoXmlSerilizable<Transaction112>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails130 TransactionDetailsValue)
        {
            writer.WriteStartElement(null, "TxDtls", xmlNamespace );
            TransactionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatusAndReason is Status30Choice_ StatusAndReasonValue)
        {
    ...
    public static Transaction112 Deserialize(XElement element)
    {
