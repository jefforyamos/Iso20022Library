...
public partial record Transaction113
     : IIsoXmlSerilizable<Transaction113>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails131 TransactionDetailsValue)
        {
    ...
    public static Transaction113 Deserialize(XElement element)
    {
