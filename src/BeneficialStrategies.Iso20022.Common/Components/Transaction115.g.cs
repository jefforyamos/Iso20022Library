...
public partial record Transaction115
     : IIsoXmlSerilizable<Transaction115>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails133 TransactionDetailsValue)
        {
            writer.WriteStartElement(null, "TxDtls", xmlNamespace );
            TransactionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatusAndReason is Status32Choice_ StatusAndReasonValue)
        {
    ...
    public static Transaction115 Deserialize(XElement element)
    {
