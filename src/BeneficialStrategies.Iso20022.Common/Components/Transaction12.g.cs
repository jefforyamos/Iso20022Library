...
public partial record Transaction12
     : IIsoXmlSerilizable<Transaction12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails25 TransactionDetailsValue)
        {
    ...
    public static Transaction12 Deserialize(XElement element)
    {
