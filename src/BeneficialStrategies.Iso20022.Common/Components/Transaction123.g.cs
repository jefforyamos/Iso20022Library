...
public partial record Transaction123
     : IIsoXmlSerilizable<Transaction123>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails154 TransactionDetailsValue)
        {
    ...
    public static Transaction123 Deserialize(XElement element)
    {
