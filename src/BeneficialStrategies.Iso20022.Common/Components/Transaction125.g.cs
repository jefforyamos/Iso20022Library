...
public partial record Transaction125
     : IIsoXmlSerilizable<Transaction125>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails164 TransactionDetailsValue)
        {
            writer.WriteStartElement(null, "TxDtls", xmlNamespace );
            TransactionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatusAndReason is Status39Choice_ StatusAndReasonValue)
        {
    ...
    public static Transaction125 Deserialize(XElement element)
    {
