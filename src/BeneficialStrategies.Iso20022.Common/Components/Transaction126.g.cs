...
public partial record Transaction126
     : IIsoXmlSerilizable<Transaction126>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails165 TransactionDetailsValue)
        {
    ...
    public static Transaction126 Deserialize(XElement element)
    {
