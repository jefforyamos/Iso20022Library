...
//
// Generated by ComponentGenerator for Transaction13.  ISO2002 ID# _3LD7WeEAEd-udr336SN7mQ.
//
...
public partial record Transaction13
     : IIsoXmlSerilizable<Transaction13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails24 TransactionDetailsValue)
        {
    ...
    public static Transaction13 Deserialize(XElement element)
    {
