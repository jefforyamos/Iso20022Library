...
public partial record Transaction136
     : IIsoXmlSerilizable<Transaction136>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RetrievalFulfilmentInstructions is RetrievalFulfilmentInstructions2 RetrievalFulfilmentInstructionsValue)
        {
    ...
    public static Transaction136 Deserialize(XElement element)
    {
