...
public partial record Transaction14
     : IIsoXmlSerilizable<Transaction14>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails26 TransactionDetailsValue)
        {
    ...
    public static Transaction14 Deserialize(XElement element)
    {
