...
public partial record Transaction151
     : IIsoXmlSerilizable<Transaction151>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CollectionIdentificationList is IsoMax70Text CollectionIdentificationListValue)
        {
            writer.WriteStartElement(null, "ColltnIdList", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax70Text(CollectionIdentificationListValue)); // data type Max70Text System.String
            writer.WriteEndElement();
        }
        ...
        if (CollectionChecksum is IsoMax35Binary CollectionChecksumValue)
        {
            writer.WriteStartElement(null, "ColltnChcksm", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax35Binary(CollectionChecksumValue)); // data type Max35Binary System.Byte[]
            writer.WriteEndElement();
        }
    ...
    public static Transaction151 Deserialize(XElement element)
    {
