...
public partial record Transaction18
     : IIsoXmlSerilizable<Transaction18>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails37 TransactionDetailsValue)
        {
    ...
    public static Transaction18 Deserialize(XElement element)
    {
