...
public partial record Transaction19
     : IIsoXmlSerilizable<Transaction19>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails39 TransactionDetailsValue)
        {
    ...
    public static Transaction19 Deserialize(XElement element)
    {
