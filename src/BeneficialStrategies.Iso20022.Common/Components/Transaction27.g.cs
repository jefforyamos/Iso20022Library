...
public partial record Transaction27
     : IIsoXmlSerilizable<Transaction27>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails56 TransactionDetailsValue)
        {
            writer.WriteStartElement(null, "TxDtls", xmlNamespace );
            TransactionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatusAndReason is Status9Choice_ StatusAndReasonValue)
        {
    ...
    public static Transaction27 Deserialize(XElement element)
    {
