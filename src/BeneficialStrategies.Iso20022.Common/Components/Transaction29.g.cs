...
public partial record Transaction29
     : IIsoXmlSerilizable<Transaction29>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails57 TransactionDetailsValue)
        {
    ...
    public static Transaction29 Deserialize(XElement element)
    {
