...
public partial record Transaction34
     : IIsoXmlSerilizable<Transaction34>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails62 TransactionDetailsValue)
        {
            writer.WriteStartElement(null, "TxDtls", xmlNamespace );
            TransactionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatusAndReason is Status15Choice_ StatusAndReasonValue)
        {
    ...
    public static Transaction34 Deserialize(XElement element)
    {
