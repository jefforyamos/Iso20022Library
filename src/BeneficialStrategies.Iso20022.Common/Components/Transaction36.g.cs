...
public partial record Transaction36
     : IIsoXmlSerilizable<Transaction36>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails63 TransactionDetailsValue)
        {
    ...
    public static Transaction36 Deserialize(XElement element)
    {
