...
public partial record Transaction40
     : IIsoXmlSerilizable<Transaction40>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails69 TransactionDetailsValue)
        {
    ...
    public static Transaction40 Deserialize(XElement element)
    {
