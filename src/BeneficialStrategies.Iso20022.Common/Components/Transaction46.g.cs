...
public partial record Transaction46
     : IIsoXmlSerilizable<Transaction46>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails78 TransactionDetailsValue)
        {
    ...
    public static Transaction46 Deserialize(XElement element)
    {
