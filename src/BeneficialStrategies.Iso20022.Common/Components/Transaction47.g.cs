...
public partial record Transaction47
     : IIsoXmlSerilizable<Transaction47>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails75 TransactionDetailsValue)
        {
            writer.WriteStartElement(null, "TxDtls", xmlNamespace );
            TransactionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatusAndReason is Status18Choice_ StatusAndReasonValue)
        {
    ...
    public static Transaction47 Deserialize(XElement element)
    {
