...
//
// Generated by ComponentGenerator for Transaction52.  ISO2002 ID# _jsKFmW-SEeaxWKxOD2aB-w.
//
...
public partial record Transaction52
     : IIsoXmlSerilizable<Transaction52>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails95 TransactionDetailsValue)
        {
    ...
    public static Transaction52 Deserialize(XElement element)
    {
