...
public partial record Transaction53
     : IIsoXmlSerilizable<Transaction53>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails96 TransactionDetailsValue)
        {
    ...
    public static Transaction53 Deserialize(XElement element)
    {
