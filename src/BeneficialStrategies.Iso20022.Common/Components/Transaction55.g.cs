...
public partial record Transaction55
     : IIsoXmlSerilizable<Transaction55>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails98 TransactionDetailsValue)
        {
    ...
    public static Transaction55 Deserialize(XElement element)
    {
