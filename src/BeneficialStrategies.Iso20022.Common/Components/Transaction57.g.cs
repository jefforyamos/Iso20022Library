...
public partial record Transaction57
     : IIsoXmlSerilizable<Transaction57>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails99 TransactionDetailsValue)
        {
    ...
    public static Transaction57 Deserialize(XElement element)
    {
