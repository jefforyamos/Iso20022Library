...
public partial record Transaction6
     : IIsoXmlSerilizable<Transaction6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails6 TransactionDetailsValue)
        {
    ...
    public static Transaction6 Deserialize(XElement element)
    {
