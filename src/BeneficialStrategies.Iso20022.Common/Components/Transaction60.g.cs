...
public partial record Transaction60
     : IIsoXmlSerilizable<Transaction60>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails104 TransactionDetailsValue)
        {
    ...
    public static Transaction60 Deserialize(XElement element)
    {
