...
public partial record Transaction62
     : IIsoXmlSerilizable<Transaction62>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails103 TransactionDetailsValue)
        {
    ...
    public static Transaction62 Deserialize(XElement element)
    {
