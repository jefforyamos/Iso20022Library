...
public partial record Transaction63
     : IIsoXmlSerilizable<Transaction63>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails111 TransactionDetailsValue)
        {
    ...
    public static Transaction63 Deserialize(XElement element)
    {
