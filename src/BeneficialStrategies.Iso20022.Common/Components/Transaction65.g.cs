...
public partial record Transaction65
     : IIsoXmlSerilizable<Transaction65>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails112 TransactionDetailsValue)
        {
    ...
    public static Transaction65 Deserialize(XElement element)
    {
