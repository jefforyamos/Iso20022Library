...
public partial record Transaction72
     : IIsoXmlSerilizable<Transaction72>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails124 TransactionDetailsValue)
        {
    ...
    public static Transaction72 Deserialize(XElement element)
    {
