...
public partial record TransactionCertificateContract2
     : IIsoXmlSerilizable<TransactionCertificateContract2>
{
    #nullable enable
    ...
    {
        if (ContractReference is ContractRegistrationReference2Choice_ ContractReferenceValue)
        {
    ...
    public static TransactionCertificateContract2 Deserialize(XElement element)
    {
