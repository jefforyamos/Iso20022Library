...
public partial record TransactionCriteria10
     : IIsoXmlSerilizable<TransactionCriteria10>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SearchCriteria is TransactionSearchCriteria10 SearchCriteriaValue)
        {
    ...
    public static TransactionCriteria10 Deserialize(XElement element)
    {
