...
public partial record TransactionDetails103
     : IIsoXmlSerilizable<TransactionDetails103>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent22Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
    ...
    public static TransactionDetails103 Deserialize(XElement element)
    {
