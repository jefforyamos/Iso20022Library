...
public partial record TransactionDetails104
     : IIsoXmlSerilizable<TransactionDetails104>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent23Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
    ...
    public static TransactionDetails104 Deserialize(XElement element)
    {
