...
public partial record TransactionDetails108
     : IIsoXmlSerilizable<TransactionDetails108>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails109 TransactionDetailsValue)
        {
    ...
    public static TransactionDetails108 Deserialize(XElement element)
    {
