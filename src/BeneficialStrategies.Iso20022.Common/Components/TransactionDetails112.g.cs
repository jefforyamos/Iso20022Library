...
public partial record TransactionDetails112
     : IIsoXmlSerilizable<TransactionDetails112>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent25Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails162 SettlementParametersValue)
        {
    ...
    public static TransactionDetails112 Deserialize(XElement element)
    {
