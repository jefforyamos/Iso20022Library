...
public partial record TransactionDetails114
     : IIsoXmlSerilizable<TransactionDetails114>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent26Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
    ...
    public static TransactionDetails114 Deserialize(XElement element)
    {
