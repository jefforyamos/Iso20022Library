...
public partial record TransactionDetails123
     : IIsoXmlSerilizable<TransactionDetails123>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent28Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
    ...
    public static TransactionDetails123 Deserialize(XElement element)
    {
