...
public partial record TransactionDetails124
     : IIsoXmlSerilizable<TransactionDetails124>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent29Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
    ...
    public static TransactionDetails124 Deserialize(XElement element)
    {
