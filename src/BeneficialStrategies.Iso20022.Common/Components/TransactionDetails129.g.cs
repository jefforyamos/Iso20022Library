...
public partial record TransactionDetails129
     : IIsoXmlSerilizable<TransactionDetails129>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails150 SettlementParametersValue)
        {
    ...
    public static TransactionDetails129 Deserialize(XElement element)
    {
