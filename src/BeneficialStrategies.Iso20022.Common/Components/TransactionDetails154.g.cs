...
public partial record TransactionDetails154
     : IIsoXmlSerilizable<TransactionDetails154>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent31Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails190 SettlementParametersValue)
        {
    ...
    public static TransactionDetails154 Deserialize(XElement element)
    {
