...
public partial record TransactionDetails24
     : IIsoXmlSerilizable<TransactionDetails24>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent1Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails27 SettlementParametersValue)
        {
    ...
    public static TransactionDetails24 Deserialize(XElement element)
    {
