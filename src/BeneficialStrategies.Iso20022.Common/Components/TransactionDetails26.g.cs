...
public partial record TransactionDetails26
     : IIsoXmlSerilizable<TransactionDetails26>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails28 SettlementParametersValue)
        {
    ...
    public static TransactionDetails26 Deserialize(XElement element)
    {
