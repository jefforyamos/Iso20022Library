...
public partial record TransactionDetails39
     : IIsoXmlSerilizable<TransactionDetails39>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent6Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails47 SettlementParametersValue)
        {
    ...
    public static TransactionDetails39 Deserialize(XElement element)
    {
