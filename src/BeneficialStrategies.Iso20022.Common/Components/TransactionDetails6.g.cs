...
public partial record TransactionDetails6
     : IIsoXmlSerilizable<TransactionDetails6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails2 SettlementParametersValue)
        {
    ...
    public static TransactionDetails6 Deserialize(XElement element)
    {
