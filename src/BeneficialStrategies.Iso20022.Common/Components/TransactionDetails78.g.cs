...
public partial record TransactionDetails78
     : IIsoXmlSerilizable<TransactionDetails78>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent13Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails91 SettlementParametersValue)
        {
    ...
    public static TransactionDetails78 Deserialize(XElement element)
    {
