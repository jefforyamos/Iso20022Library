...
public partial record TransactionDetails90
     : IIsoXmlSerilizable<TransactionDetails90>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent15Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails116 SettlementParametersValue)
        {
    ...
    public static TransactionDetails90 Deserialize(XElement element)
    {
