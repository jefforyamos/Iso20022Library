...
public partial record TransactionDetails91
     : IIsoXmlSerilizable<TransactionDetails91>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent16Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails117 SettlementParametersValue)
        {
    ...
    public static TransactionDetails91 Deserialize(XElement element)
    {
