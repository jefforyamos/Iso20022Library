...
public partial record TransactionDetails96
     : IIsoXmlSerilizable<TransactionDetails96>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent17Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails127 SettlementParametersValue)
        {
    ...
    public static TransactionDetails96 Deserialize(XElement element)
    {
