...
public partial record TransactionDetails99
     : IIsoXmlSerilizable<TransactionDetails99>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementTransactionOrCorporateActionEventType is SettlementOrCorporateActionEvent21Choice_ SettlementTransactionOrCorporateActionEventTypeValue)
        {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails130 SettlementParametersValue)
        {
    ...
    public static TransactionDetails99 Deserialize(XElement element)
    {
