...
public partial record TransactionIdentification11
     : IIsoXmlSerilizable<TransactionIdentification11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AcquirerReferenceData is IsoMax99Text AcquirerReferenceDataValue)
        {
            writer.WriteStartElement(null, "AcqrrRefData", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax99Text(AcquirerReferenceDataValue)); // data type Max99Text System.String
            writer.WriteEndElement();
        }
    ...
    public static TransactionIdentification11 Deserialize(XElement element)
    {
