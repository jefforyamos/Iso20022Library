...
public partial record TransactionIdentification8
     : IIsoXmlSerilizable<TransactionIdentification8>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoISODateTime(LocalDateTime)); // data type ISODateTime System.DateTime
        ...
        if (OriginalDataElements is OriginalDataElements1 OriginalDataElementsValue)
        {
    ...
    public static TransactionIdentification8 Deserialize(XElement element)
    {
