...
public partial record TransactionIdentifications47
     : IIsoXmlSerilizable<TransactionIdentifications47>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (NettingServiceProviderIdentification is IsoMax35Text NettingServiceProviderIdentificationValue)
        {
            writer.WriteStartElement(null, "NetgSvcPrvdrId", xmlNamespace );
            writer.WriteValue(SerializationFormatter.IsoMax35Text(NettingServiceProviderIdentificationValue)); // data type Max35Text System.String
            writer.WriteEndElement();
        }
    }
    public static TransactionIdentifications47 Deserialize(XElement element)
    {
