...
public partial record TransactionQuery5
     : IIsoXmlSerilizable<TransactionQuery5>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionCriteria is TransactionCriteria5Choice_ TransactionCriteriaValue)
        {
    ...
    public static TransactionQuery5 Deserialize(XElement element)
    {
