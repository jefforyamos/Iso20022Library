...
public partial record TransactionReturnCriteria4
     : IIsoXmlSerilizable<TransactionReturnCriteria4>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PaymentReturnCriteria is PaymentReturnCriteria3 PaymentReturnCriteriaValue)
        {
    ...
    public static TransactionReturnCriteria4 Deserialize(XElement element)
    {
