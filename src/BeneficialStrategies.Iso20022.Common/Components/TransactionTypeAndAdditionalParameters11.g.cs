...
public partial record TransactionTypeAndAdditionalParameters11
     : IIsoXmlSerilizable<TransactionTypeAndAdditionalParameters11>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ModificationType is RepurchaseType15Choice_ ModificationTypeValue)
        {
    ...
    public static TransactionTypeAndAdditionalParameters11 Deserialize(XElement element)
    {
