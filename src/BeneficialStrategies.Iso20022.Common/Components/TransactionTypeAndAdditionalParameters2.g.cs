...
public partial record TransactionTypeAndAdditionalParameters2
     : IIsoXmlSerilizable<TransactionTypeAndAdditionalParameters2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ModificationType is RepurchaseType2Choice_ ModificationTypeValue)
        {
    ...
    public static TransactionTypeAndAdditionalParameters2 Deserialize(XElement element)
    {
