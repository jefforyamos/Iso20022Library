...
public partial record TransactionTypeAndAdditionalParameters20
     : IIsoXmlSerilizable<TransactionTypeAndAdditionalParameters20>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ModificationType is RepurchaseType31Choice_ ModificationTypeValue)
        {
    ...
    public static TransactionTypeAndAdditionalParameters20 Deserialize(XElement element)
    {
