...
//
// Generated by ComponentGenerator for TransactionTypeAndAdditionalParameters7.  ISO2002 ID# _Flq00duJEd-RF5yaMAVhAw.
//
...
public partial record TransactionTypeAndAdditionalParameters7
     : IIsoXmlSerilizable<TransactionTypeAndAdditionalParameters7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ModificationType is RepurchaseType7Choice_ ModificationTypeValue)
        {
    ...
    public static TransactionTypeAndAdditionalParameters7 Deserialize(XElement element)
    {
