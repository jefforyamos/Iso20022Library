     ...
     : IIsoXmlSerilizable<Transfer33>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (EffectiveTransferDate is DateAndDateTimeChoice_ EffectiveTransferDateValue)
        {
    ...
    public static Transfer33 Deserialize(XElement element)
    {
