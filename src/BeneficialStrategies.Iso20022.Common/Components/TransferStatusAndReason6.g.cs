...
public partial record TransferStatusAndReason6
     : IIsoXmlSerilizable<TransferStatusAndReason6>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PaymentDetails is PaymentInstrument15 PaymentDetailsValue)
        {
            writer.WriteStartElement(null, "PmtDtls", xmlNamespace );
            PaymentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (BenefitCrystallisationEvent is BenefitCrystallisationEvent1 BenefitCrystallisationEventValue)
        {
        ...
        if (DrawdownTranche is Drawdown1 DrawdownTrancheValue)
        {
    ...
    public static TransferStatusAndReason6 Deserialize(XElement element)
    {
