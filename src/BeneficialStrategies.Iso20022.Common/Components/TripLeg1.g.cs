     ...
     : IIsoXmlSerilizable<TripLeg1>
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Ticket is Ticket1 TicketValue)
        {
        ...
        if (TripLegAmount is AmountDetails1 TripLegAmountValue)
        {
    ...
    public static TripLeg1 Deserialize(XElement element)
    {
