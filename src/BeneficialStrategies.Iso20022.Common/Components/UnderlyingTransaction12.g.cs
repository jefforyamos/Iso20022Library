...
public partial record UnderlyingTransaction12
     : IIsoXmlSerilizable<UnderlyingTransaction12>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalPaymentInformationAndCancellation is OriginalPaymentInstruction15 OriginalPaymentInformationAndCancellationValue)
        {
    ...
    public static UnderlyingTransaction12 Deserialize(XElement element)
    {
