...
public partial record UnderlyingTransaction13
     : IIsoXmlSerilizable<UnderlyingTransaction13>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction62 TransactionInformationValue)
        {
    ...
    public static UnderlyingTransaction13 Deserialize(XElement element)
    {
