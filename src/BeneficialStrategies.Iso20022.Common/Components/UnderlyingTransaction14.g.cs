...
public partial record UnderlyingTransaction14
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OriginalPaymentInstruction17> OriginalPaymentInformationAndStatus { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides details on the original transactions to which the cancellation request message refers.
    /// </summary>
    [DataMember]
    public ValueList<PaymentTransaction67> TransactionInformationAndStatus { get; init; } = []; // Warning: Don't know multiplicity.
