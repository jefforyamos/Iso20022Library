...
public partial record UnderlyingTransaction22
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OriginalPaymentInstruction30> OriginalPaymentInformationAndStatus { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides details on the original transactions to which the cancellation request message refers.
    /// </summary>
    [DataMember]
    public ValueList<PaymentTransaction102> TransactionInformationAndStatus { get; init; } = []; // Warning: Don't know multiplicity.
