...
public partial record UnderlyingTransaction25
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OriginalPaymentInstruction35> OriginalPaymentInformationAndStatus { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides details on the original transactions to which the cancellation request message refers.
    /// </summary>
    [DataMember]
    public ValueList<PaymentTransaction127> TransactionInformationAndStatus { get; init; } = []; // Warning: Don't know multiplicity.
