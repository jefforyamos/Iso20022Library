...
public partial record UnderlyingTransaction25
{
    ...
    /// </summary>
    public OriginalPaymentInstruction35? OriginalPaymentInformationAndStatus { get; init;  } // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides details on the original transactions to which the cancellation request message refers.
    /// </summary>
    public PaymentTransaction127? TransactionInformationAndStatus { get; init;  } // Warning: Don't know multiplicity.
