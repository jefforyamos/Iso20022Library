...
public partial record UnderlyingTransaction28
     : IIsoXmlSerilizable<UnderlyingTransaction28>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction137 TransactionInformationValue)
        {
    ...
    public static UnderlyingTransaction28 Deserialize(XElement element)
    {
