...
public partial record UnderlyingTransaction31
     : IIsoXmlSerilizable<UnderlyingTransaction31>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction148 TransactionInformationAndStatusValue)
        {
    ...
    public static UnderlyingTransaction31 Deserialize(XElement element)
    {
