...
public partial record UnderlyingTransaction7
     : IIsoXmlSerilizable<UnderlyingTransaction7>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalPaymentInformationAndCancellation is OriginalPaymentInstruction8 OriginalPaymentInformationAndCancellationValue)
        {
    ...
    public static UnderlyingTransaction7 Deserialize(XElement element)
    {
