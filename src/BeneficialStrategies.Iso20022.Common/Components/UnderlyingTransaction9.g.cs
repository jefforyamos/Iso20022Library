...
public partial record UnderlyingTransaction9
     : IIsoXmlSerilizable<UnderlyingTransaction9>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInstruction10 OriginalPaymentInformationAndStatusValue)
        {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction53 TransactionInformationAndStatusValue)
        {
    ...
    public static UnderlyingTransaction9 Deserialize(XElement element)
    {
