...
public partial record UnderlyingTransaction9
{
    ...
    /// </summary>
    [DataMember]
    public ValueList<OriginalPaymentInstruction10> OriginalPaymentInformationAndStatus { get; init; } = []; // Warning: Don't know multiplicity.
    /// <summary>
    /// Provides details on the original transactions to which the cancellation request message refers.
    /// </summary>
    [DataMember]
    public ValueList<PaymentTransaction53> TransactionInformationAndStatus { get; init; } = []; // Warning: Don't know multiplicity.
