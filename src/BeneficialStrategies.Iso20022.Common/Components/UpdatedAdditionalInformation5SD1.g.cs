...
public partial record UpdatedAdditionalInformation5SD1
     : IIsoXmlSerilizable<UpdatedAdditionalInformation5SD1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DistributionAmountPerShare is RateAndAmountFormat2Choice_ DistributionAmountPerShareValue)
        {
        ...
        if (AccumulatedProfitPerShare is RateAndAmountFormat2Choice_ AccumulatedProfitPerShareValue)
        {
            writer.WriteStartElement(null, "AcmltdPrftPerShr", xmlNamespace );
            AccumulatedProfitPerShareValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (DeemedDividendPerShare is RateAndAmountFormat2Choice_ DeemedDividendPerShareValue)
        {
            writer.WriteStartElement(null, "DmdDvddPerShr", xmlNamespace );
            DeemedDividendPerShareValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ResidualDistributionAmountPerShare is RateAndAmountFormat2Choice_ ResidualDistributionAmountPerShareValue)
        {
    ...
    public static UpdatedAdditionalInformation5SD1 Deserialize(XElement element)
    {
