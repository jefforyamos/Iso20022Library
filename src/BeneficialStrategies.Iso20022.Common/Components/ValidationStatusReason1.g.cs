...
public partial record ValidationStatusReason1
     : IIsoXmlSerilizable<ValidationStatusReason1>
{
    #nullable enable
    ...
    {
        if (Originator is PartyIdentification77 OriginatorValue)
        {
    ...
    public static ValidationStatusReason1 Deserialize(XElement element)
    {
