...
public partial record VehicleRentalCustomer1
     : IIsoXmlSerilizable<VehicleRentalCustomer1>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (PrimaryDriver is DriverInParty1 PrimaryDriverValue)
        {
            writer.WriteStartElement(null, "PmryDrvr", xmlNamespace );
            PrimaryDriverValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (AdditionalDriver is DriverInParty1 AdditionalDriverValue)
        {
    ...
    public static VehicleRentalCustomer1 Deserialize(XElement element)
    {
