...
public partial record VerificationInitiation2
     : IIsoXmlSerilizable<VerificationInitiation2>
{
    #nullable enable
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProcessingResult is ProcessingResult12 ProcessingResultValue)
        {
    ...
    public static VerificationInitiation2 Deserialize(XElement element)
    {
