...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountAdditionalInformationRequestV02>;
...
public partial record AccountAdditionalInformationRequestV02 : IOuterRecord<AccountAdditionalInformationRequestV02,AccountAdditionalInformationRequestV02Document>
    ,IIsoXmlSerilizable<AccountAdditionalInformationRequestV02>, ISerializeInsideARootElement
{
    ...
    public static AccountAdditionalInformationRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountAdditionalInformationRequestV02Document : IOuterDocument<AccountAdditionalInformationRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountAdditionalInformationRequestV02.XmlTag)]
    public required AccountAdditionalInformationRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountAdditionalInformationRequestV02.XmlTag);
