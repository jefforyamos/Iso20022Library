...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountDetailsConfirmationV05>;
...
public partial record AccountDetailsConfirmationV05 : IOuterRecord<AccountDetailsConfirmationV05,AccountDetailsConfirmationV05Document>
    ,IIsoXmlSerilizable<AccountDetailsConfirmationV05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (InvestmentAccount is InvestmentAccount46 InvestmentAccountValue)
        {
            writer.WriteStartElement(null, "InvstmtAcct", xmlNamespace );
            InvestmentAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (AccountParties is AccountParties12 AccountPartiesValue)
        {
    ...
    public static AccountDetailsConfirmationV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountDetailsConfirmationV05Document : IOuterDocument<AccountDetailsConfirmationV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountDetailsConfirmationV05.XmlTag)]
    public required AccountDetailsConfirmationV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountDetailsConfirmationV05.XmlTag);
