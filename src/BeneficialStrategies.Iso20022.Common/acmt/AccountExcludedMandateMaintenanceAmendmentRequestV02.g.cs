...
//
// Generated by MainMessageGenerator for AccountExcludedMandateMaintenanceAmendmentRequestV02.  ISO2002 ID# _UlU6IQ1TEeKGXqvMN6jpiw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountExcludedMandateMaintenanceAmendmentRequestV02>;
...
public partial record AccountExcludedMandateMaintenanceAmendmentRequestV02 : IOuterRecord<AccountExcludedMandateMaintenanceAmendmentRequestV02,AccountExcludedMandateMaintenanceAmendmentRequestV02Document>
    ,IIsoXmlSerilizable<AccountExcludedMandateMaintenanceAmendmentRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountExcludedMandateMaintenanceAmendmentRequestV02Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="AccountExcludedMandateMaintenanceAmendmentRequestV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public AccountExcludedMandateMaintenanceAmendmentRequestV02Document ToDocument()
    {
        return new AccountExcludedMandateMaintenanceAmendmentRequestV02Document { Message = this };
    }
    ...
    public static AccountExcludedMandateMaintenanceAmendmentRequestV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="AccountExcludedMandateMaintenanceAmendmentRequestV02"/>.
/// </summary>
[Serializable]
public partial record AccountExcludedMandateMaintenanceAmendmentRequestV02Document : IOuterDocument<AccountExcludedMandateMaintenanceAmendmentRequestV02>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="AccountExcludedMandateMaintenanceAmendmentRequestV02"/> is required.
    /// </summary>
    [DataMember(Name=AccountExcludedMandateMaintenanceAmendmentRequestV02.XmlTag)]
    public required AccountExcludedMandateMaintenanceAmendmentRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountExcludedMandateMaintenanceAmendmentRequestV02.XmlTag);
