...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountManagementStatusReportV07>;
...
public partial record AccountManagementStatusReportV07 : IOuterRecord<AccountManagementStatusReportV07,AccountManagementStatusReportV07Document>
    ,IIsoXmlSerilizable<AccountManagementStatusReportV07>, ISerializeInsideARootElement
{
    ...
    public required ValueList<AdditionalReference13> RelatedReference { get; init; } = []; // Min=1, Max=2
    ...
    public static AccountManagementStatusReportV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountManagementStatusReportV07Document : IOuterDocument<AccountManagementStatusReportV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountManagementStatusReportV07.XmlTag)]
    public required AccountManagementStatusReportV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountManagementStatusReportV07.XmlTag);
