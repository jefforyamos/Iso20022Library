...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountMandateMaintenanceAmendmentRequestV02>;
...
public partial record AccountMandateMaintenanceAmendmentRequestV02 : IOuterRecord<AccountMandateMaintenanceAmendmentRequestV02,AccountMandateMaintenanceAmendmentRequestV02Document>
    ,IIsoXmlSerilizable<AccountMandateMaintenanceAmendmentRequestV02>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Mandate is OperationMandate3 MandateValue)
        {
    ...
    public static AccountMandateMaintenanceAmendmentRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountMandateMaintenanceAmendmentRequestV02Document : IOuterDocument<AccountMandateMaintenanceAmendmentRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountMandateMaintenanceAmendmentRequestV02.XmlTag)]
    public required AccountMandateMaintenanceAmendmentRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountMandateMaintenanceAmendmentRequestV02.XmlTag);
