...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountMandateMaintenanceRequestV03>;
...
public partial record AccountMandateMaintenanceRequestV03 : IOuterRecord<AccountMandateMaintenanceRequestV03,AccountMandateMaintenanceRequestV03Document>
    ,IIsoXmlSerilizable<AccountMandateMaintenanceRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountMandateMaintenanceRequestV03Document.DocumentNamespace;
    ...
    public static AccountMandateMaintenanceRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountMandateMaintenanceRequestV03Document : IOuterDocument<AccountMandateMaintenanceRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountMandateMaintenanceRequestV03.XmlTag)]
    public required AccountMandateMaintenanceRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountMandateMaintenanceRequestV03.XmlTag);
