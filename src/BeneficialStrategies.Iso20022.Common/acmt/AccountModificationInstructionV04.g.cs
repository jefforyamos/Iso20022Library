...
/// </summary>
[Serializable]
public partial record AccountModificationInstructionV04Document : IOuterDocument<AccountModificationInstructionV04>
{
    ...
    #else
    public AccountModificationInstructionV04 Message { get; init; }
    #endif
}
