...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountOpeningAdditionalInformationRequestV03>;
...
public partial record AccountOpeningAdditionalInformationRequestV03 : IOuterRecord<AccountOpeningAdditionalInformationRequestV03,AccountOpeningAdditionalInformationRequestV03Document>
    ,IIsoXmlSerilizable<AccountOpeningAdditionalInformationRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountOpeningAdditionalInformationRequestV03Document.DocumentNamespace;
    ...
    public static AccountOpeningAdditionalInformationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountOpeningAdditionalInformationRequestV03Document : IOuterDocument<AccountOpeningAdditionalInformationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountOpeningAdditionalInformationRequestV03.XmlTag)]
    public required AccountOpeningAdditionalInformationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountOpeningAdditionalInformationRequestV03.XmlTag);
