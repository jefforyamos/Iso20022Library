...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountOpeningInstructionV02>;
...
public partial record AccountOpeningInstructionV02 : IOuterRecord<AccountOpeningInstructionV02,AccountOpeningInstructionV02Document>
    ,IIsoXmlSerilizable<AccountOpeningInstructionV02>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("AcctOpngInstrV02");
    ...
    public static AccountOpeningInstructionV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountOpeningInstructionV02Document : IOuterDocument<AccountOpeningInstructionV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountOpeningInstructionV02.XmlTag)]
    public required AccountOpeningInstructionV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountOpeningInstructionV02.XmlTag);
