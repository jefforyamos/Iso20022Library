...
//
// Generated by MainMessageGenerator for AccountOpeningInstructionV06.  ISO2002 ID# _51Xr0R8KEeWpZde3LQh6dg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountOpeningInstructionV06>;
...
public partial record AccountOpeningInstructionV06 : IOuterRecord<AccountOpeningInstructionV06,AccountOpeningInstructionV06Document>
    ,IIsoXmlSerilizable<AccountOpeningInstructionV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountOpeningInstructionV06Document.DocumentNamespace;
    ...
    [Description(@"Intermediary or other party related to the management of the account. In some markets, when this intermediary is a party acting on behalf of the investor for which it has opened an account at, for example, a central securities depository or international central securities depository, this party is known by the investor as the 'account controller'.")]
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="AccountOpeningInstructionV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public AccountOpeningInstructionV06Document ToDocument()
    {
        return new AccountOpeningInstructionV06Document { Message = this };
    }
    ...
    public static AccountOpeningInstructionV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="AccountOpeningInstructionV06"/>.
/// </summary>
[Serializable]
public partial record AccountOpeningInstructionV06Document : IOuterDocument<AccountOpeningInstructionV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="AccountOpeningInstructionV06"/> is required.
    /// </summary>
    [DataMember(Name=AccountOpeningInstructionV06.XmlTag)]
    public required AccountOpeningInstructionV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountOpeningInstructionV06.XmlTag);
