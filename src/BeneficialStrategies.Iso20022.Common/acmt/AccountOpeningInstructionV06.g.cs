...
/// </summary>
[Serializable]
public partial record AccountOpeningInstructionV06Document : IOuterDocument<AccountOpeningInstructionV06>
{
    ...
    #else
    public AccountOpeningInstructionV06 Message { get; init; }
    #endif
}
