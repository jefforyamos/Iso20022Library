...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountOpeningInstructionV08>;
...
public partial record AccountOpeningInstructionV08 : IOuterRecord<AccountOpeningInstructionV08,AccountOpeningInstructionV08Document>
    ,IIsoXmlSerilizable<AccountOpeningInstructionV08>, ISerializeInsideARootElement
{
    ...
    public static AccountOpeningInstructionV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountOpeningInstructionV08Document : IOuterDocument<AccountOpeningInstructionV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountOpeningInstructionV08.XmlTag)]
    public required AccountOpeningInstructionV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountOpeningInstructionV08.XmlTag);
