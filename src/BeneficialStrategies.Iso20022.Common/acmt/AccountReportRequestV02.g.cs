...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountReportRequestV02>;
...
public partial record AccountReportRequestV02 : IOuterRecord<AccountReportRequestV02,AccountReportRequestV02Document>
    ,IIsoXmlSerilizable<AccountReportRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountReportRequestV02Document.DocumentNamespace;
    ...
    public static AccountReportRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountReportRequestV02Document : IOuterDocument<AccountReportRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountReportRequestV02.XmlTag)]
    public required AccountReportRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountReportRequestV02.XmlTag);
