...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountReportV02>;
...
public partial record AccountReportV02 : IOuterRecord<AccountReportV02,AccountReportV02Document>
    ,IIsoXmlSerilizable<AccountReportV02>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Report is AccountReport15 ReportValue)
        {
    ...
    public static AccountReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountReportV02Document : IOuterDocument<AccountReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountReportV02.XmlTag)]
    public required AccountReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountReportV02.XmlTag);
