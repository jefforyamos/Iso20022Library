...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountReportV04>;
...
public partial record AccountReportV04 : IOuterRecord<AccountReportV04,AccountReportV04Document>
    ,IIsoXmlSerilizable<AccountReportV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountReportV04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Report is AccountReport28 ReportValue)
        {
    ...
    public static AccountReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountReportV04Document : IOuterDocument<AccountReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountReportV04.XmlTag)]
    public required AccountReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountReportV04.XmlTag);
