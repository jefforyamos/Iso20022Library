...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountRequestAcknowledgementV01>;
...
public partial record AccountRequestAcknowledgementV01 : IOuterRecord<AccountRequestAcknowledgementV01,AccountRequestAcknowledgementV01Document>
    ,IIsoXmlSerilizable<AccountRequestAcknowledgementV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountRequestAcknowledgementV01Document.DocumentNamespace;
    ...
    public static AccountRequestAcknowledgementV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountRequestAcknowledgementV01Document : IOuterDocument<AccountRequestAcknowledgementV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountRequestAcknowledgementV01.XmlTag)]
    public required AccountRequestAcknowledgementV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountRequestAcknowledgementV01.XmlTag);
