...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchBalanceTransferAcknowledgementV02>;
...
public partial record AccountSwitchBalanceTransferAcknowledgementV02 : IOuterRecord<AccountSwitchBalanceTransferAcknowledgementV02,AccountSwitchBalanceTransferAcknowledgementV02Document>
    ,IIsoXmlSerilizable<AccountSwitchBalanceTransferAcknowledgementV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchBalanceTransferAcknowledgementV02Document.DocumentNamespace;
    ...
    public static AccountSwitchBalanceTransferAcknowledgementV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchBalanceTransferAcknowledgementV02Document : IOuterDocument<AccountSwitchBalanceTransferAcknowledgementV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchBalanceTransferAcknowledgementV02.XmlTag)]
    public required AccountSwitchBalanceTransferAcknowledgementV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchBalanceTransferAcknowledgementV02.XmlTag);
