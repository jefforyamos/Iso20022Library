...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchBalanceTransferAcknowledgementV03>;
...
public partial record AccountSwitchBalanceTransferAcknowledgementV03 : IOuterRecord<AccountSwitchBalanceTransferAcknowledgementV03,AccountSwitchBalanceTransferAcknowledgementV03Document>
    ,IIsoXmlSerilizable<AccountSwitchBalanceTransferAcknowledgementV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchBalanceTransferAcknowledgementV03Document.DocumentNamespace;
    ...
    public static AccountSwitchBalanceTransferAcknowledgementV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchBalanceTransferAcknowledgementV03Document : IOuterDocument<AccountSwitchBalanceTransferAcknowledgementV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchBalanceTransferAcknowledgementV03.XmlTag)]
    public required AccountSwitchBalanceTransferAcknowledgementV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchBalanceTransferAcknowledgementV03.XmlTag);
