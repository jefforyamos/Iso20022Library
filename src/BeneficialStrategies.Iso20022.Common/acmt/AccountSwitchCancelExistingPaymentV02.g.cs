...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchCancelExistingPaymentV02>;
...
public partial record AccountSwitchCancelExistingPaymentV02 : IOuterRecord<AccountSwitchCancelExistingPaymentV02,AccountSwitchCancelExistingPaymentV02Document>
    ,IIsoXmlSerilizable<AccountSwitchCancelExistingPaymentV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchCancelExistingPaymentV02Document.DocumentNamespace;
    ...
    public static AccountSwitchCancelExistingPaymentV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchCancelExistingPaymentV02Document : IOuterDocument<AccountSwitchCancelExistingPaymentV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchCancelExistingPaymentV02.XmlTag)]
    public required AccountSwitchCancelExistingPaymentV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchCancelExistingPaymentV02.XmlTag);
