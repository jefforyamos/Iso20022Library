...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchCancelExistingPaymentV04>;
...
public partial record AccountSwitchCancelExistingPaymentV04 : IOuterRecord<AccountSwitchCancelExistingPaymentV04,AccountSwitchCancelExistingPaymentV04Document>
    ,IIsoXmlSerilizable<AccountSwitchCancelExistingPaymentV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (PaymentInstruction is PaymentInstruction38 PaymentInstructionValue)
        {
    ...
    public static AccountSwitchCancelExistingPaymentV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchCancelExistingPaymentV04Document : IOuterDocument<AccountSwitchCancelExistingPaymentV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchCancelExistingPaymentV04.XmlTag)]
    public required AccountSwitchCancelExistingPaymentV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchCancelExistingPaymentV04.XmlTag);
