...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchInformationRequestV03>;
...
public partial record AccountSwitchInformationRequestV03 : IOuterRecord<AccountSwitchInformationRequestV03,AccountSwitchInformationRequestV03Document>
    ,IIsoXmlSerilizable<AccountSwitchInformationRequestV03>, ISerializeInsideARootElement
{
    ...
    public static AccountSwitchInformationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchInformationRequestV03Document : IOuterDocument<AccountSwitchInformationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchInformationRequestV03.XmlTag)]
    public required AccountSwitchInformationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchInformationRequestV03.XmlTag);
