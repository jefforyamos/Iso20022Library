...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchInformationRequestV04>;
...
public partial record AccountSwitchInformationRequestV04 : IOuterRecord<AccountSwitchInformationRequestV04,AccountSwitchInformationRequestV04Document>
    ,IIsoXmlSerilizable<AccountSwitchInformationRequestV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceTransfer is BalanceTransfer4 BalanceTransferValue)
        {
    ...
    public static AccountSwitchInformationRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchInformationRequestV04Document : IOuterDocument<AccountSwitchInformationRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchInformationRequestV04.XmlTag)]
    public required AccountSwitchInformationRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchInformationRequestV04.XmlTag);
