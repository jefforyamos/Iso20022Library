...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchInformationResponseV03>;
...
public partial record AccountSwitchInformationResponseV03 : IOuterRecord<AccountSwitchInformationResponseV03,AccountSwitchInformationResponseV03Document>
    ,IIsoXmlSerilizable<AccountSwitchInformationResponseV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchInformationResponseV03Document.DocumentNamespace;
    ...
    public static AccountSwitchInformationResponseV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchInformationResponseV03Document : IOuterDocument<AccountSwitchInformationResponseV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchInformationResponseV03.XmlTag)]
    public required AccountSwitchInformationResponseV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchInformationResponseV03.XmlTag);
