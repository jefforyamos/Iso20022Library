...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchInformationResponseV04>;
...
public partial record AccountSwitchInformationResponseV04 : IOuterRecord<AccountSwitchInformationResponseV04,AccountSwitchInformationResponseV04Document>
    ,IIsoXmlSerilizable<AccountSwitchInformationResponseV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchInformationResponseV04Document.DocumentNamespace;
    ...
    public static AccountSwitchInformationResponseV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchInformationResponseV04Document : IOuterDocument<AccountSwitchInformationResponseV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchInformationResponseV04.XmlTag)]
    public required AccountSwitchInformationResponseV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchInformationResponseV04.XmlTag);
