...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchRequestBalanceTransferV01>;
...
public partial record AccountSwitchRequestBalanceTransferV01 : IOuterRecord<AccountSwitchRequestBalanceTransferV01,AccountSwitchRequestBalanceTransferV01Document>
    ,IIsoXmlSerilizable<AccountSwitchRequestBalanceTransferV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchRequestBalanceTransferV01Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (NominatedAccount is CashAccount36 NominatedAccountValue)
        {
    ...
    public static AccountSwitchRequestBalanceTransferV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchRequestBalanceTransferV01Document : IOuterDocument<AccountSwitchRequestBalanceTransferV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchRequestBalanceTransferV01.XmlTag)]
    public required AccountSwitchRequestBalanceTransferV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchRequestBalanceTransferV01.XmlTag);
