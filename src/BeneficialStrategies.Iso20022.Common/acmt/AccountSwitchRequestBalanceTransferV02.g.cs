...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchRequestBalanceTransferV02>;
...
public partial record AccountSwitchRequestBalanceTransferV02 : IOuterRecord<AccountSwitchRequestBalanceTransferV02,AccountSwitchRequestBalanceTransferV02Document>
    ,IIsoXmlSerilizable<AccountSwitchRequestBalanceTransferV02>, ISerializeInsideARootElement
{
    ...
    public static AccountSwitchRequestBalanceTransferV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchRequestBalanceTransferV02Document : IOuterDocument<AccountSwitchRequestBalanceTransferV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchRequestBalanceTransferV02.XmlTag)]
    public required AccountSwitchRequestBalanceTransferV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchRequestBalanceTransferV02.XmlTag);
