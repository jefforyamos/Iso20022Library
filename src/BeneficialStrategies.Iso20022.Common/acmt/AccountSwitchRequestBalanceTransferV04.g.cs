...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchRequestBalanceTransferV04>;
...
public partial record AccountSwitchRequestBalanceTransferV04 : IOuterRecord<AccountSwitchRequestBalanceTransferV04,AccountSwitchRequestBalanceTransferV04Document>
    ,IIsoXmlSerilizable<AccountSwitchRequestBalanceTransferV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchRequestBalanceTransferV04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (NominatedAccount is CashAccount41 NominatedAccountValue)
        {
    ...
    public static AccountSwitchRequestBalanceTransferV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchRequestBalanceTransferV04Document : IOuterDocument<AccountSwitchRequestBalanceTransferV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchRequestBalanceTransferV04.XmlTag)]
    public required AccountSwitchRequestBalanceTransferV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchRequestBalanceTransferV04.XmlTag);
