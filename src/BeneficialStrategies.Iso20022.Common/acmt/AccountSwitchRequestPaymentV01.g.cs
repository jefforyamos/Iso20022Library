...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchRequestPaymentV01>;
...
public partial record AccountSwitchRequestPaymentV01 : IOuterRecord<AccountSwitchRequestPaymentV01,AccountSwitchRequestPaymentV01Document>
    ,IIsoXmlSerilizable<AccountSwitchRequestPaymentV01>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        writer.WriteStartElement(null, "CdtInstrs", xmlNamespace );
        CreditInstructions.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
    ...
    public static AccountSwitchRequestPaymentV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchRequestPaymentV01Document : IOuterDocument<AccountSwitchRequestPaymentV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchRequestPaymentV01.XmlTag)]
    public required AccountSwitchRequestPaymentV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchRequestPaymentV01.XmlTag);
