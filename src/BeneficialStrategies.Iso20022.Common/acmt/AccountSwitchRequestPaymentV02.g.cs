...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchRequestPaymentV02>;
...
public partial record AccountSwitchRequestPaymentV02 : IOuterRecord<AccountSwitchRequestPaymentV02,AccountSwitchRequestPaymentV02Document>
    ,IIsoXmlSerilizable<AccountSwitchRequestPaymentV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchRequestPaymentV02Document.DocumentNamespace;
    ...
    public static AccountSwitchRequestPaymentV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchRequestPaymentV02Document : IOuterDocument<AccountSwitchRequestPaymentV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchRequestPaymentV02.XmlTag)]
    public required AccountSwitchRequestPaymentV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchRequestPaymentV02.XmlTag);
