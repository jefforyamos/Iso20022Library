...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchRequestPaymentV03>;
...
public partial record AccountSwitchRequestPaymentV03 : IOuterRecord<AccountSwitchRequestPaymentV03,AccountSwitchRequestPaymentV03Document>
    ,IIsoXmlSerilizable<AccountSwitchRequestPaymentV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchRequestPaymentV03Document.DocumentNamespace;
    ...
    public static AccountSwitchRequestPaymentV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchRequestPaymentV03Document : IOuterDocument<AccountSwitchRequestPaymentV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchRequestPaymentV03.XmlTag)]
    public required AccountSwitchRequestPaymentV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchRequestPaymentV03.XmlTag);
