...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.AccountSwitchTechnicalRejectionV02>;
...
public partial record AccountSwitchTechnicalRejectionV02 : IOuterRecord<AccountSwitchTechnicalRejectionV02,AccountSwitchTechnicalRejectionV02Document>
    ,IIsoXmlSerilizable<AccountSwitchTechnicalRejectionV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountSwitchTechnicalRejectionV02Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("AcctSwtchTechRjctn");
    ...
    public static AccountSwitchTechnicalRejectionV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountSwitchTechnicalRejectionV02Document : IOuterDocument<AccountSwitchTechnicalRejectionV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountSwitchTechnicalRejectionV02.XmlTag)]
    public required AccountSwitchTechnicalRejectionV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountSwitchTechnicalRejectionV02.XmlTag);
