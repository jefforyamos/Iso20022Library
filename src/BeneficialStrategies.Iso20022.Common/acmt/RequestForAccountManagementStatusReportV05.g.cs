...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.acmt.RequestForAccountManagementStatusReportV05>;
...
public partial record RequestForAccountManagementStatusReportV05 : IOuterRecord<RequestForAccountManagementStatusReportV05,RequestForAccountManagementStatusReportV05Document>
    ,IIsoXmlSerilizable<RequestForAccountManagementStatusReportV05>, ISerializeInsideARootElement
{
    ...
    public static RequestForAccountManagementStatusReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RequestForAccountManagementStatusReportV05Document : IOuterDocument<RequestForAccountManagementStatusReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RequestForAccountManagementStatusReportV05.XmlTag)]
    public required RequestForAccountManagementStatusReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RequestForAccountManagementStatusReportV05.XmlTag);
