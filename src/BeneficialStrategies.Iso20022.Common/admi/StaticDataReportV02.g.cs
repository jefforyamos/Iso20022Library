...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.admi.StaticDataReportV02>;
...
public partial record StaticDataReportV02 : IOuterRecord<StaticDataReportV02,StaticDataReportV02Document>
    ,IIsoXmlSerilizable<StaticDataReportV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => StaticDataReportV02Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("StatcDataRpt");
    ...
    public static StaticDataReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record StaticDataReportV02Document : IOuterDocument<StaticDataReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=StaticDataReportV02.XmlTag)]
    public required StaticDataReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(StaticDataReportV02.XmlTag);
