...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.CCPClearedProductReportV01>;
...
public partial record CCPClearedProductReportV01 : IOuterRecord<CCPClearedProductReportV01,CCPClearedProductReportV01Document>
    ,IIsoXmlSerilizable<CCPClearedProductReportV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CCPClearedProductReportV01Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("CCPClrdPdctRpt");
    ...
    {
        writer.WriteStartElement(null, "ClrdPdct", xmlNamespace );
        ClearedProduct.Serialize(writer, xmlNamespace);
    ...
    public static CCPClearedProductReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CCPClearedProductReportV01Document : IOuterDocument<CCPClearedProductReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CCPClearedProductReportV01.XmlTag)]
    public required CCPClearedProductReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CCPClearedProductReportV01.XmlTag);
