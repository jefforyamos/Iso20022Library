...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.ContractRegistrationAmendmentRequestV01>;
...
public partial record ContractRegistrationAmendmentRequestV01 : IOuterRecord<ContractRegistrationAmendmentRequestV01,ContractRegistrationAmendmentRequestV01Document>
    ,IIsoXmlSerilizable<ContractRegistrationAmendmentRequestV01>, ISerializeInsideARootElement
{
    ...
    public static ContractRegistrationAmendmentRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ContractRegistrationAmendmentRequestV01Document : IOuterDocument<ContractRegistrationAmendmentRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ContractRegistrationAmendmentRequestV01.XmlTag)]
    public required ContractRegistrationAmendmentRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ContractRegistrationAmendmentRequestV01.XmlTag);
