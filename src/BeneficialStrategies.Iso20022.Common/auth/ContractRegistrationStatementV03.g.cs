...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.ContractRegistrationStatementV03>;
...
public partial record ContractRegistrationStatementV03 : IOuterRecord<ContractRegistrationStatementV03,ContractRegistrationStatementV03Document>
    ,IIsoXmlSerilizable<ContractRegistrationStatementV03>, ISerializeInsideARootElement
{
    ...
    public static ContractRegistrationStatementV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ContractRegistrationStatementV03Document : IOuterDocument<ContractRegistrationStatementV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ContractRegistrationStatementV03.XmlTag)]
    public required ContractRegistrationStatementV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ContractRegistrationStatementV03.XmlTag);
