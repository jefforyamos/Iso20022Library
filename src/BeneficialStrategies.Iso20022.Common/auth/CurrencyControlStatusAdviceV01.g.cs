...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.CurrencyControlStatusAdviceV01>;
...
public partial record CurrencyControlStatusAdviceV01 : IOuterRecord<CurrencyControlStatusAdviceV01,CurrencyControlStatusAdviceV01Document>
    ,IIsoXmlSerilizable<CurrencyControlStatusAdviceV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CurrencyControlStatusAdviceV01Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (PackageStatus is CurrencyControlPackageStatus1 PackageStatusValue)
        {
    ...
    public static CurrencyControlStatusAdviceV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CurrencyControlStatusAdviceV01Document : IOuterDocument<CurrencyControlStatusAdviceV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CurrencyControlStatusAdviceV01.XmlTag)]
    public required CurrencyControlStatusAdviceV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CurrencyControlStatusAdviceV01.XmlTag);
