...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.CurrencyControlSupportingDocumentDeliveryV01>;
...
public partial record CurrencyControlSupportingDocumentDeliveryV01 : IOuterRecord<CurrencyControlSupportingDocumentDeliveryV01,CurrencyControlSupportingDocumentDeliveryV01Document>
    ,IIsoXmlSerilizable<CurrencyControlSupportingDocumentDeliveryV01>, ISerializeInsideARootElement
{
    ...
    public static CurrencyControlSupportingDocumentDeliveryV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CurrencyControlSupportingDocumentDeliveryV01Document : IOuterDocument<CurrencyControlSupportingDocumentDeliveryV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CurrencyControlSupportingDocumentDeliveryV01.XmlTag)]
    public required CurrencyControlSupportingDocumentDeliveryV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CurrencyControlSupportingDocumentDeliveryV01.XmlTag);
