...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.DerivativesTradeMarginDataReportV01>;
...
public partial record DerivativesTradeMarginDataReportV01 : IOuterRecord<DerivativesTradeMarginDataReportV01,DerivativesTradeMarginDataReportV01Document>
    ,IIsoXmlSerilizable<DerivativesTradeMarginDataReportV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("DerivsTradMrgnDataRpt");
    ...
    public static DerivativesTradeMarginDataReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DerivativesTradeMarginDataReportV01Document : IOuterDocument<DerivativesTradeMarginDataReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DerivativesTradeMarginDataReportV01.XmlTag)]
    public required DerivativesTradeMarginDataReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DerivativesTradeMarginDataReportV01.XmlTag);
