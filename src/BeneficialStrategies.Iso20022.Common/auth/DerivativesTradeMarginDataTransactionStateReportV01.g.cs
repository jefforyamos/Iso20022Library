...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.DerivativesTradeMarginDataTransactionStateReportV01>;
...
public partial record DerivativesTradeMarginDataTransactionStateReportV01 : IOuterRecord<DerivativesTradeMarginDataTransactionStateReportV01,DerivativesTradeMarginDataTransactionStateReportV01Document>
    ,IIsoXmlSerilizable<DerivativesTradeMarginDataTransactionStateReportV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DerivativesTradeMarginDataTransactionStateReportV01Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("DerivsTradMrgnDataTxStatRpt");
    ...
    public static DerivativesTradeMarginDataTransactionStateReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DerivativesTradeMarginDataTransactionStateReportV01Document : IOuterDocument<DerivativesTradeMarginDataTransactionStateReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DerivativesTradeMarginDataTransactionStateReportV01.XmlTag)]
    public required DerivativesTradeMarginDataTransactionStateReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DerivativesTradeMarginDataTransactionStateReportV01.XmlTag);
