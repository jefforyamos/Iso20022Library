...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.DerivativesTradeReportV03>;
...
public partial record DerivativesTradeReportV03 : IOuterRecord<DerivativesTradeReportV03,DerivativesTradeReportV03Document>
    ,IIsoXmlSerilizable<DerivativesTradeReportV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DerivativesTradeReportV03Document.DocumentNamespace;
    ...
    public static DerivativesTradeReportV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DerivativesTradeReportV03Document : IOuterDocument<DerivativesTradeReportV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DerivativesTradeReportV03.XmlTag)]
    public required DerivativesTradeReportV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DerivativesTradeReportV03.XmlTag);
