...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.FinancialInstrumentReportingEquityTradingActivityResultV02>;
...
public partial record FinancialInstrumentReportingEquityTradingActivityResultV02 : IOuterRecord<FinancialInstrumentReportingEquityTradingActivityResultV02,FinancialInstrumentReportingEquityTradingActivityResultV02Document>
    ,IIsoXmlSerilizable<FinancialInstrumentReportingEquityTradingActivityResultV02>, ISerializeInsideARootElement
{
    ...
    public static FinancialInstrumentReportingEquityTradingActivityResultV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FinancialInstrumentReportingEquityTradingActivityResultV02Document : IOuterDocument<FinancialInstrumentReportingEquityTradingActivityResultV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FinancialInstrumentReportingEquityTradingActivityResultV02.XmlTag)]
    public required FinancialInstrumentReportingEquityTradingActivityResultV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FinancialInstrumentReportingEquityTradingActivityResultV02.XmlTag);
