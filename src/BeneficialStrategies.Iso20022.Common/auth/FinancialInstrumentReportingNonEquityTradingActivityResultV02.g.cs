...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.FinancialInstrumentReportingNonEquityTradingActivityResultV02>;
...
public partial record FinancialInstrumentReportingNonEquityTradingActivityResultV02 : IOuterRecord<FinancialInstrumentReportingNonEquityTradingActivityResultV02,FinancialInstrumentReportingNonEquityTradingActivityResultV02Document>
    ,IIsoXmlSerilizable<FinancialInstrumentReportingNonEquityTradingActivityResultV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FinancialInstrumentReportingNonEquityTradingActivityResultV02Document.DocumentNamespace;
    ...
    public static FinancialInstrumentReportingNonEquityTradingActivityResultV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FinancialInstrumentReportingNonEquityTradingActivityResultV02Document : IOuterDocument<FinancialInstrumentReportingNonEquityTradingActivityResultV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FinancialInstrumentReportingNonEquityTradingActivityResultV02.XmlTag)]
    public required FinancialInstrumentReportingNonEquityTradingActivityResultV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FinancialInstrumentReportingNonEquityTradingActivityResultV02.XmlTag);
