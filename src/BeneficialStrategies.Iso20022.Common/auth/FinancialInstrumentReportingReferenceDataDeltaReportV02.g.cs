...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.FinancialInstrumentReportingReferenceDataDeltaReportV02>;
...
public partial record FinancialInstrumentReportingReferenceDataDeltaReportV02 : IOuterRecord<FinancialInstrumentReportingReferenceDataDeltaReportV02,FinancialInstrumentReportingReferenceDataDeltaReportV02Document>
    ,IIsoXmlSerilizable<FinancialInstrumentReportingReferenceDataDeltaReportV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FinancialInstrumentReportingReferenceDataDeltaReportV02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrument is SecuritiesReferenceDeltaStatusReport3Choice_ FinancialInstrumentValue)
        {
    ...
    public static FinancialInstrumentReportingReferenceDataDeltaReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FinancialInstrumentReportingReferenceDataDeltaReportV02Document : IOuterDocument<FinancialInstrumentReportingReferenceDataDeltaReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FinancialInstrumentReportingReferenceDataDeltaReportV02.XmlTag)]
    public required FinancialInstrumentReportingReferenceDataDeltaReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FinancialInstrumentReportingReferenceDataDeltaReportV02.XmlTag);
