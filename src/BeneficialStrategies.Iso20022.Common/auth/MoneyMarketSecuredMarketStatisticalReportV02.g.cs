...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.MoneyMarketSecuredMarketStatisticalReportV02>;
...
public partial record MoneyMarketSecuredMarketStatisticalReportV02 : IOuterRecord<MoneyMarketSecuredMarketStatisticalReportV02,MoneyMarketSecuredMarketStatisticalReportV02Document>
    ,IIsoXmlSerilizable<MoneyMarketSecuredMarketStatisticalReportV02>, ISerializeInsideARootElement
{
    ...
    public static MoneyMarketSecuredMarketStatisticalReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MoneyMarketSecuredMarketStatisticalReportV02Document : IOuterDocument<MoneyMarketSecuredMarketStatisticalReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MoneyMarketSecuredMarketStatisticalReportV02.XmlTag)]
    public required MoneyMarketSecuredMarketStatisticalReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MoneyMarketSecuredMarketStatisticalReportV02.XmlTag);
