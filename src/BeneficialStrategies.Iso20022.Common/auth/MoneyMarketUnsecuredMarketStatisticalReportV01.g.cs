...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.MoneyMarketUnsecuredMarketStatisticalReportV01>;
...
public partial record MoneyMarketUnsecuredMarketStatisticalReportV01 : IOuterRecord<MoneyMarketUnsecuredMarketStatisticalReportV01,MoneyMarketUnsecuredMarketStatisticalReportV01Document>
    ,IIsoXmlSerilizable<MoneyMarketUnsecuredMarketStatisticalReportV01>, ISerializeInsideARootElement
{
    ...
    public static MoneyMarketUnsecuredMarketStatisticalReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MoneyMarketUnsecuredMarketStatisticalReportV01Document : IOuterDocument<MoneyMarketUnsecuredMarketStatisticalReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MoneyMarketUnsecuredMarketStatisticalReportV01.XmlTag)]
    public required MoneyMarketUnsecuredMarketStatisticalReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MoneyMarketUnsecuredMarketStatisticalReportV01.XmlTag);
