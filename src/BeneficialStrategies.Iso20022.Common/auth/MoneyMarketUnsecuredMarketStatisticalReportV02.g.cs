...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.MoneyMarketUnsecuredMarketStatisticalReportV02>;
...
public partial record MoneyMarketUnsecuredMarketStatisticalReportV02 : IOuterRecord<MoneyMarketUnsecuredMarketStatisticalReportV02,MoneyMarketUnsecuredMarketStatisticalReportV02Document>
    ,IIsoXmlSerilizable<MoneyMarketUnsecuredMarketStatisticalReportV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MoneyMarketUnsecuredMarketStatisticalReportV02Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("MnyMktUscrdMktSttstclRpt");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteStartElement(null, "UscrdMktRpt", xmlNamespace );
        UnsecuredMarketReport.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
    ...
    public static MoneyMarketUnsecuredMarketStatisticalReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MoneyMarketUnsecuredMarketStatisticalReportV02Document : IOuterDocument<MoneyMarketUnsecuredMarketStatisticalReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MoneyMarketUnsecuredMarketStatisticalReportV02.XmlTag)]
    public required MoneyMarketUnsecuredMarketStatisticalReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MoneyMarketUnsecuredMarketStatisticalReportV02.XmlTag);
