...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.SecuritiesFinancingReportingPositionSetReportV01>;
...
public partial record SecuritiesFinancingReportingPositionSetReportV01 : IOuterRecord<SecuritiesFinancingReportingPositionSetReportV01,SecuritiesFinancingReportingPositionSetReportV01Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingReportingPositionSetReportV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("SctiesFincgRptgPosSetRpt");
    ...
    {
        writer.WriteStartElement(null, "AggtdPoss", xmlNamespace );
        AggregatedPositions.Serialize(writer, xmlNamespace);
    ...
    public static SecuritiesFinancingReportingPositionSetReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingReportingPositionSetReportV01Document : IOuterDocument<SecuritiesFinancingReportingPositionSetReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingReportingPositionSetReportV01.XmlTag)]
    public required SecuritiesFinancingReportingPositionSetReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingReportingPositionSetReportV01.XmlTag);
