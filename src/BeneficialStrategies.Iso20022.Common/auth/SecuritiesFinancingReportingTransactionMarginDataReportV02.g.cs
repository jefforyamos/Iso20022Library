...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.auth.SecuritiesFinancingReportingTransactionMarginDataReportV02>;
...
public partial record SecuritiesFinancingReportingTransactionMarginDataReportV02 : IOuterRecord<SecuritiesFinancingReportingTransactionMarginDataReportV02,SecuritiesFinancingReportingTransactionMarginDataReportV02Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingReportingTransactionMarginDataReportV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingReportingTransactionMarginDataReportV02Document.DocumentNamespace;
    ...
    public static SecuritiesFinancingReportingTransactionMarginDataReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingReportingTransactionMarginDataReportV02Document : IOuterDocument<SecuritiesFinancingReportingTransactionMarginDataReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingReportingTransactionMarginDataReportV02.XmlTag)]
    public required SecuritiesFinancingReportingTransactionMarginDataReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingReportingTransactionMarginDataReportV02.XmlTag);
