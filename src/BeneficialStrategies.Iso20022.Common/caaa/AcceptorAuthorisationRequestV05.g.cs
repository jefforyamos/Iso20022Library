...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorAuthorisationRequestV05>;
...
public partial record AcceptorAuthorisationRequestV05 : IOuterRecord<AcceptorAuthorisationRequestV05,AcceptorAuthorisationRequestV05Document>
    ,IIsoXmlSerilizable<AcceptorAuthorisationRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorAuthorisationRequestV05Document.DocumentNamespace;
    ...
    public static AcceptorAuthorisationRequestV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorAuthorisationRequestV05Document : IOuterDocument<AcceptorAuthorisationRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorAuthorisationRequestV05.XmlTag)]
    public required AcceptorAuthorisationRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorAuthorisationRequestV05.XmlTag);
