...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorAuthorisationResponseV04>;
...
public partial record AcceptorAuthorisationResponseV04 : IOuterRecord<AcceptorAuthorisationResponseV04,AcceptorAuthorisationResponseV04Document>
    ,IIsoXmlSerilizable<AcceptorAuthorisationResponseV04>, ISerializeInsideARootElement
{
    ...
    public static AcceptorAuthorisationResponseV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorAuthorisationResponseV04Document : IOuterDocument<AcceptorAuthorisationResponseV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorAuthorisationResponseV04.XmlTag)]
    public required AcceptorAuthorisationResponseV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorAuthorisationResponseV04.XmlTag);
