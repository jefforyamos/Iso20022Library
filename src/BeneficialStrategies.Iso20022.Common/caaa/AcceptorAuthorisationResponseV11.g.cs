...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorAuthorisationResponseV11>;
...
public partial record AcceptorAuthorisationResponseV11 : IOuterRecord<AcceptorAuthorisationResponseV11,AcceptorAuthorisationResponseV11Document>
    ,IIsoXmlSerilizable<AcceptorAuthorisationResponseV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorAuthorisationResponseV11Document.DocumentNamespace;
    ...
    public static AcceptorAuthorisationResponseV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorAuthorisationResponseV11Document : IOuterDocument<AcceptorAuthorisationResponseV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorAuthorisationResponseV11.XmlTag)]
    public required AcceptorAuthorisationResponseV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorAuthorisationResponseV11.XmlTag);
