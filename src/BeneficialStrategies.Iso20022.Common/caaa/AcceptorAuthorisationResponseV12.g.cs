...
/// </summary>
[Serializable]
public partial record AcceptorAuthorisationResponseV12Document : IOuterDocument<AcceptorAuthorisationResponseV12>
{
    ...
    #else
    public AcceptorAuthorisationResponseV12 Message { get; init; }
    #endif
}
