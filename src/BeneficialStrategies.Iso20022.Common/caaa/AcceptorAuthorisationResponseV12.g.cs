...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorAuthorisationResponseV12>;
...
public partial record AcceptorAuthorisationResponseV12 : IOuterRecord<AcceptorAuthorisationResponseV12,AcceptorAuthorisationResponseV12Document>
    ,IIsoXmlSerilizable<AcceptorAuthorisationResponseV12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorAuthorisationResponseV12Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="AcceptorAuthorisationResponseV12Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public AcceptorAuthorisationResponseV12Document ToDocument()
    {
        return new AcceptorAuthorisationResponseV12Document { Message = this };
    }
    ...
    public static AcceptorAuthorisationResponseV12 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="AcceptorAuthorisationResponseV12"/>.
/// </summary>
[Serializable]
public partial record AcceptorAuthorisationResponseV12Document : IOuterDocument<AcceptorAuthorisationResponseV12>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="AcceptorAuthorisationResponseV12"/> is required.
    /// </summary>
    [DataMember(Name=AcceptorAuthorisationResponseV12.XmlTag)]
    public required AcceptorAuthorisationResponseV12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorAuthorisationResponseV12.XmlTag);
