...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorBatchTransferV05>;
...
public partial record AcceptorBatchTransferV05 : IOuterRecord<AcceptorBatchTransferV05,AcceptorBatchTransferV05Document>
    ,IIsoXmlSerilizable<AcceptorBatchTransferV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorBatchTransferV05Document.DocumentNamespace;
    ...
    public static AcceptorBatchTransferV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorBatchTransferV05Document : IOuterDocument<AcceptorBatchTransferV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorBatchTransferV05.XmlTag)]
    public required AcceptorBatchTransferV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorBatchTransferV05.XmlTag);
