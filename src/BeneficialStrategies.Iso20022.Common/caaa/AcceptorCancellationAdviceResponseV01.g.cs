...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCancellationAdviceResponseV01>;
...
public partial record AcceptorCancellationAdviceResponseV01 : IOuterRecord<AcceptorCancellationAdviceResponseV01,AcceptorCancellationAdviceResponseV01Document>
    ,IIsoXmlSerilizable<AcceptorCancellationAdviceResponseV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCancellationAdviceResponseV01Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteStartElement(null, "AccptrCxlAdvcRspn", xmlNamespace );
        AcceptorCancellationAdviceResponse.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
        writer.WriteStartElement(null, "SctyTrlr", xmlNamespace );
        SecurityTrailer.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
    }
    public static AcceptorCancellationAdviceResponseV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCancellationAdviceResponseV01Document : IOuterDocument<AcceptorCancellationAdviceResponseV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCancellationAdviceResponseV01.XmlTag)]
    public required AcceptorCancellationAdviceResponseV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCancellationAdviceResponseV01.XmlTag);
