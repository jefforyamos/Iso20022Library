...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCancellationAdviceResponseV04>;
...
public partial record AcceptorCancellationAdviceResponseV04 : IOuterRecord<AcceptorCancellationAdviceResponseV04,AcceptorCancellationAdviceResponseV04Document>
    ,IIsoXmlSerilizable<AcceptorCancellationAdviceResponseV04>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCancellationAdviceResponseV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCancellationAdviceResponseV04Document : IOuterDocument<AcceptorCancellationAdviceResponseV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCancellationAdviceResponseV04.XmlTag)]
    public required AcceptorCancellationAdviceResponseV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCancellationAdviceResponseV04.XmlTag);
