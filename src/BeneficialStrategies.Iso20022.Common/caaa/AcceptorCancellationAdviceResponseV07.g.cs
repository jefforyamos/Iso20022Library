...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCancellationAdviceResponseV07>;
...
public partial record AcceptorCancellationAdviceResponseV07 : IOuterRecord<AcceptorCancellationAdviceResponseV07,AcceptorCancellationAdviceResponseV07Document>
    ,IIsoXmlSerilizable<AcceptorCancellationAdviceResponseV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCancellationAdviceResponseV07Document.DocumentNamespace;
    ...
    public static AcceptorCancellationAdviceResponseV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCancellationAdviceResponseV07Document : IOuterDocument<AcceptorCancellationAdviceResponseV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCancellationAdviceResponseV07.XmlTag)]
    public required AcceptorCancellationAdviceResponseV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCancellationAdviceResponseV07.XmlTag);
