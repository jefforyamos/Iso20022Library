...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCancellationAdviceResponseV09>;
...
public partial record AcceptorCancellationAdviceResponseV09 : IOuterRecord<AcceptorCancellationAdviceResponseV09,AcceptorCancellationAdviceResponseV09Document>
    ,IIsoXmlSerilizable<AcceptorCancellationAdviceResponseV09>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCancellationAdviceResponseV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCancellationAdviceResponseV09Document : IOuterDocument<AcceptorCancellationAdviceResponseV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCancellationAdviceResponseV09.XmlTag)]
    public required AcceptorCancellationAdviceResponseV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCancellationAdviceResponseV09.XmlTag);
