...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCancellationAdviceResponseV11>;
...
public partial record AcceptorCancellationAdviceResponseV11 : IOuterRecord<AcceptorCancellationAdviceResponseV11,AcceptorCancellationAdviceResponseV11Document>
    ,IIsoXmlSerilizable<AcceptorCancellationAdviceResponseV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCancellationAdviceResponseV11Document.DocumentNamespace;
    ...
    public static AcceptorCancellationAdviceResponseV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCancellationAdviceResponseV11Document : IOuterDocument<AcceptorCancellationAdviceResponseV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCancellationAdviceResponseV11.XmlTag)]
    public required AcceptorCancellationAdviceResponseV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCancellationAdviceResponseV11.XmlTag);
