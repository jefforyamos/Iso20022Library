...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCancellationResponseV02>;
...
public partial record AcceptorCancellationResponseV02 : IOuterRecord<AcceptorCancellationResponseV02,AcceptorCancellationResponseV02Document>
    ,IIsoXmlSerilizable<AcceptorCancellationResponseV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCancellationResponseV02Document.DocumentNamespace;
    ...
    public static AcceptorCancellationResponseV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCancellationResponseV02Document : IOuterDocument<AcceptorCancellationResponseV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCancellationResponseV02.XmlTag)]
    public required AcceptorCancellationResponseV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCancellationResponseV02.XmlTag);
