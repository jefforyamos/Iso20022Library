...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCancellationResponseV07>;
...
public partial record AcceptorCancellationResponseV07 : IOuterRecord<AcceptorCancellationResponseV07,AcceptorCancellationResponseV07Document>
    ,IIsoXmlSerilizable<AcceptorCancellationResponseV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCancellationResponseV07Document.DocumentNamespace;
    ...
    public static AcceptorCancellationResponseV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCancellationResponseV07Document : IOuterDocument<AcceptorCancellationResponseV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCancellationResponseV07.XmlTag)]
    public required AcceptorCancellationResponseV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCancellationResponseV07.XmlTag);
