...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCompletionAdviceResponseV07>;
...
public partial record AcceptorCompletionAdviceResponseV07 : IOuterRecord<AcceptorCompletionAdviceResponseV07,AcceptorCompletionAdviceResponseV07Document>
    ,IIsoXmlSerilizable<AcceptorCompletionAdviceResponseV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCompletionAdviceResponseV07Document.DocumentNamespace;
    ...
    public static AcceptorCompletionAdviceResponseV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCompletionAdviceResponseV07Document : IOuterDocument<AcceptorCompletionAdviceResponseV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCompletionAdviceResponseV07.XmlTag)]
    public required AcceptorCompletionAdviceResponseV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCompletionAdviceResponseV07.XmlTag);
