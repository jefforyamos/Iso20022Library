...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCompletionAdviceResponseV08>;
...
public partial record AcceptorCompletionAdviceResponseV08 : IOuterRecord<AcceptorCompletionAdviceResponseV08,AcceptorCompletionAdviceResponseV08Document>
    ,IIsoXmlSerilizable<AcceptorCompletionAdviceResponseV08>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCompletionAdviceResponseV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCompletionAdviceResponseV08Document : IOuterDocument<AcceptorCompletionAdviceResponseV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCompletionAdviceResponseV08.XmlTag)]
    public required AcceptorCompletionAdviceResponseV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCompletionAdviceResponseV08.XmlTag);
