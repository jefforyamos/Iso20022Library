...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCompletionAdviceResponseV11>;
...
public partial record AcceptorCompletionAdviceResponseV11 : IOuterRecord<AcceptorCompletionAdviceResponseV11,AcceptorCompletionAdviceResponseV11Document>
    ,IIsoXmlSerilizable<AcceptorCompletionAdviceResponseV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCompletionAdviceResponseV11Document.DocumentNamespace;
    ...
    public static AcceptorCompletionAdviceResponseV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCompletionAdviceResponseV11Document : IOuterDocument<AcceptorCompletionAdviceResponseV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCompletionAdviceResponseV11.XmlTag)]
    public required AcceptorCompletionAdviceResponseV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCompletionAdviceResponseV11.XmlTag);
