...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCompletionAdviceV09>;
...
public partial record AcceptorCompletionAdviceV09 : IOuterRecord<AcceptorCompletionAdviceV09,AcceptorCompletionAdviceV09Document>
    ,IIsoXmlSerilizable<AcceptorCompletionAdviceV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCompletionAdviceV09Document.DocumentNamespace;
    ...
    public static AcceptorCompletionAdviceV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCompletionAdviceV09Document : IOuterDocument<AcceptorCompletionAdviceV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCompletionAdviceV09.XmlTag)]
    public required AcceptorCompletionAdviceV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCompletionAdviceV09.XmlTag);
