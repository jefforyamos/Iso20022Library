...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionAdviceResponseV02>;
...
public partial record AcceptorCurrencyConversionAdviceResponseV02 : IOuterRecord<AcceptorCurrencyConversionAdviceResponseV02,AcceptorCurrencyConversionAdviceResponseV02Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionAdviceResponseV02>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCurrencyConversionAdviceResponseV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionAdviceResponseV02Document : IOuterDocument<AcceptorCurrencyConversionAdviceResponseV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionAdviceResponseV02.XmlTag)]
    public required AcceptorCurrencyConversionAdviceResponseV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionAdviceResponseV02.XmlTag);
