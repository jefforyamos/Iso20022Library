...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionAdviceResponseV04>;
...
public partial record AcceptorCurrencyConversionAdviceResponseV04 : IOuterRecord<AcceptorCurrencyConversionAdviceResponseV04,AcceptorCurrencyConversionAdviceResponseV04Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionAdviceResponseV04>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCurrencyConversionAdviceResponseV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionAdviceResponseV04Document : IOuterDocument<AcceptorCurrencyConversionAdviceResponseV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionAdviceResponseV04.XmlTag)]
    public required AcceptorCurrencyConversionAdviceResponseV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionAdviceResponseV04.XmlTag);
