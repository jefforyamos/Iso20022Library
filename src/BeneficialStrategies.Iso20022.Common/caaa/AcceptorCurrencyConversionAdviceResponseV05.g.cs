...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionAdviceResponseV05>;
...
public partial record AcceptorCurrencyConversionAdviceResponseV05 : IOuterRecord<AcceptorCurrencyConversionAdviceResponseV05,AcceptorCurrencyConversionAdviceResponseV05Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionAdviceResponseV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCurrencyConversionAdviceResponseV05Document.DocumentNamespace;
    ...
    public static AcceptorCurrencyConversionAdviceResponseV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionAdviceResponseV05Document : IOuterDocument<AcceptorCurrencyConversionAdviceResponseV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionAdviceResponseV05.XmlTag)]
    public required AcceptorCurrencyConversionAdviceResponseV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionAdviceResponseV05.XmlTag);
