...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionAdviceV04>;
...
public partial record AcceptorCurrencyConversionAdviceV04 : IOuterRecord<AcceptorCurrencyConversionAdviceV04,AcceptorCurrencyConversionAdviceV04Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionAdviceV04>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCurrencyConversionAdviceV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionAdviceV04Document : IOuterDocument<AcceptorCurrencyConversionAdviceV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionAdviceV04.XmlTag)]
    public required AcceptorCurrencyConversionAdviceV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionAdviceV04.XmlTag);
