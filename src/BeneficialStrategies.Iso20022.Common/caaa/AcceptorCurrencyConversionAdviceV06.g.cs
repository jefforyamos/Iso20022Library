...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionAdviceV06>;
...
public partial record AcceptorCurrencyConversionAdviceV06 : IOuterRecord<AcceptorCurrencyConversionAdviceV06,AcceptorCurrencyConversionAdviceV06Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionAdviceV06>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCurrencyConversionAdviceV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionAdviceV06Document : IOuterDocument<AcceptorCurrencyConversionAdviceV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionAdviceV06.XmlTag)]
    public required AcceptorCurrencyConversionAdviceV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionAdviceV06.XmlTag);
