...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionAdviceV07>;
...
public partial record AcceptorCurrencyConversionAdviceV07 : IOuterRecord<AcceptorCurrencyConversionAdviceV07,AcceptorCurrencyConversionAdviceV07Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionAdviceV07>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCurrencyConversionAdviceV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionAdviceV07Document : IOuterDocument<AcceptorCurrencyConversionAdviceV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionAdviceV07.XmlTag)]
    public required AcceptorCurrencyConversionAdviceV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionAdviceV07.XmlTag);
