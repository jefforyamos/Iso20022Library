...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionRequestV04>;
...
public partial record AcceptorCurrencyConversionRequestV04 : IOuterRecord<AcceptorCurrencyConversionRequestV04,AcceptorCurrencyConversionRequestV04Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCurrencyConversionRequestV04Document.DocumentNamespace;
    ...
    public static AcceptorCurrencyConversionRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionRequestV04Document : IOuterDocument<AcceptorCurrencyConversionRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionRequestV04.XmlTag)]
    public required AcceptorCurrencyConversionRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionRequestV04.XmlTag);
