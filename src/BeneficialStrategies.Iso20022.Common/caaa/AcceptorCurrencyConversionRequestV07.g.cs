...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionRequestV07>;
...
public partial record AcceptorCurrencyConversionRequestV07 : IOuterRecord<AcceptorCurrencyConversionRequestV07,AcceptorCurrencyConversionRequestV07Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionRequestV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCurrencyConversionRequestV07Document.DocumentNamespace;
    ...
    public static AcceptorCurrencyConversionRequestV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionRequestV07Document : IOuterDocument<AcceptorCurrencyConversionRequestV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionRequestV07.XmlTag)]
    public required AcceptorCurrencyConversionRequestV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionRequestV07.XmlTag);
