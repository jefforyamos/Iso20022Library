...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionRequestV09>;
...
public partial record AcceptorCurrencyConversionRequestV09 : IOuterRecord<AcceptorCurrencyConversionRequestV09,AcceptorCurrencyConversionRequestV09Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionRequestV09>, ISerializeInsideARootElement
{
    ...
    public static AcceptorCurrencyConversionRequestV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionRequestV09Document : IOuterDocument<AcceptorCurrencyConversionRequestV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionRequestV09.XmlTag)]
    public required AcceptorCurrencyConversionRequestV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionRequestV09.XmlTag);
