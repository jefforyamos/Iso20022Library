...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionResponseV05>;
...
public partial record AcceptorCurrencyConversionResponseV05 : IOuterRecord<AcceptorCurrencyConversionResponseV05,AcceptorCurrencyConversionResponseV05Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionResponseV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCurrencyConversionResponseV05Document.DocumentNamespace;
    ...
    public static AcceptorCurrencyConversionResponseV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionResponseV05Document : IOuterDocument<AcceptorCurrencyConversionResponseV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionResponseV05.XmlTag)]
    public required AcceptorCurrencyConversionResponseV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionResponseV05.XmlTag);
