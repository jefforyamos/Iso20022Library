...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorCurrencyConversionResponseV06>;
...
public partial record AcceptorCurrencyConversionResponseV06 : IOuterRecord<AcceptorCurrencyConversionResponseV06,AcceptorCurrencyConversionResponseV06Document>
    ,IIsoXmlSerilizable<AcceptorCurrencyConversionResponseV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorCurrencyConversionResponseV06Document.DocumentNamespace;
    ...
    public static AcceptorCurrencyConversionResponseV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorCurrencyConversionResponseV06Document : IOuterDocument<AcceptorCurrencyConversionResponseV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorCurrencyConversionResponseV06.XmlTag)]
    public required AcceptorCurrencyConversionResponseV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorCurrencyConversionResponseV06.XmlTag);
