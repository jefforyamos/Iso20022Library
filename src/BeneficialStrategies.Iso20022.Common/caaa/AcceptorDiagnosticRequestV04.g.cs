...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorDiagnosticRequestV04>;
...
public partial record AcceptorDiagnosticRequestV04 : IOuterRecord<AcceptorDiagnosticRequestV04,AcceptorDiagnosticRequestV04Document>
    ,IIsoXmlSerilizable<AcceptorDiagnosticRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorDiagnosticRequestV04Document.DocumentNamespace;
    ...
    public static AcceptorDiagnosticRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorDiagnosticRequestV04Document : IOuterDocument<AcceptorDiagnosticRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorDiagnosticRequestV04.XmlTag)]
    public required AcceptorDiagnosticRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorDiagnosticRequestV04.XmlTag);
