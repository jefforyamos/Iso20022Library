...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorDiagnosticRequestV07>;
...
public partial record AcceptorDiagnosticRequestV07 : IOuterRecord<AcceptorDiagnosticRequestV07,AcceptorDiagnosticRequestV07Document>
    ,IIsoXmlSerilizable<AcceptorDiagnosticRequestV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorDiagnosticRequestV07Document.DocumentNamespace;
    ...
    public static AcceptorDiagnosticRequestV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorDiagnosticRequestV07Document : IOuterDocument<AcceptorDiagnosticRequestV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorDiagnosticRequestV07.XmlTag)]
    public required AcceptorDiagnosticRequestV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorDiagnosticRequestV07.XmlTag);
