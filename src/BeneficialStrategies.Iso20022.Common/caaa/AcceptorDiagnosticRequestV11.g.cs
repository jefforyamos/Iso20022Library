...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorDiagnosticRequestV11>;
...
public partial record AcceptorDiagnosticRequestV11 : IOuterRecord<AcceptorDiagnosticRequestV11,AcceptorDiagnosticRequestV11Document>
    ,IIsoXmlSerilizable<AcceptorDiagnosticRequestV11>, ISerializeInsideARootElement
{
    ...
    public static AcceptorDiagnosticRequestV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorDiagnosticRequestV11Document : IOuterDocument<AcceptorDiagnosticRequestV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorDiagnosticRequestV11.XmlTag)]
    public required AcceptorDiagnosticRequestV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorDiagnosticRequestV11.XmlTag);
