...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorDiagnosticResponseV03>;
...
public partial record AcceptorDiagnosticResponseV03 : IOuterRecord<AcceptorDiagnosticResponseV03,AcceptorDiagnosticResponseV03Document>
    ,IIsoXmlSerilizable<AcceptorDiagnosticResponseV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorDiagnosticResponseV03Document.DocumentNamespace;
    ...
    public static AcceptorDiagnosticResponseV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorDiagnosticResponseV03Document : IOuterDocument<AcceptorDiagnosticResponseV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorDiagnosticResponseV03.XmlTag)]
    public required AcceptorDiagnosticResponseV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorDiagnosticResponseV03.XmlTag);
