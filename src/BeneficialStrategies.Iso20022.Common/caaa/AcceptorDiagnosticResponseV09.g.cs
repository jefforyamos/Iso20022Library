...
/// </summary>
[Serializable]
public partial record AcceptorDiagnosticResponseV09Document : IOuterDocument<AcceptorDiagnosticResponseV09>
{
    ...
    #else
    public AcceptorDiagnosticResponseV09 Message { get; init; }
    #endif
}
