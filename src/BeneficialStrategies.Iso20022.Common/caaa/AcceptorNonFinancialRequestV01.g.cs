...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorNonFinancialRequestV01>;
...
public partial record AcceptorNonFinancialRequestV01 : IOuterRecord<AcceptorNonFinancialRequestV01,AcceptorNonFinancialRequestV01Document>
    ,IIsoXmlSerilizable<AcceptorNonFinancialRequestV01>, ISerializeInsideARootElement
{
    ...
    public static AcceptorNonFinancialRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorNonFinancialRequestV01Document : IOuterDocument<AcceptorNonFinancialRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorNonFinancialRequestV01.XmlTag)]
    public required AcceptorNonFinancialRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorNonFinancialRequestV01.XmlTag);
