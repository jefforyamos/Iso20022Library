...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorReconciliationRequestV02>;
...
public partial record AcceptorReconciliationRequestV02 : IOuterRecord<AcceptorReconciliationRequestV02,AcceptorReconciliationRequestV02Document>
    ,IIsoXmlSerilizable<AcceptorReconciliationRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorReconciliationRequestV02Document.DocumentNamespace;
    ...
    public static AcceptorReconciliationRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationRequestV02Document : IOuterDocument<AcceptorReconciliationRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorReconciliationRequestV02.XmlTag)]
    public required AcceptorReconciliationRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorReconciliationRequestV02.XmlTag);
