...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationRequestV04Document : IOuterDocument<AcceptorReconciliationRequestV04>
{
    ...
    #else
    public AcceptorReconciliationRequestV04 Message { get; init; }
    #endif
}
