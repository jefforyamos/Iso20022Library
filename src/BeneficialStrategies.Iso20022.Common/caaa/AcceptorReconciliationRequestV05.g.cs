...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorReconciliationRequestV05>;
...
public partial record AcceptorReconciliationRequestV05 : IOuterRecord<AcceptorReconciliationRequestV05,AcceptorReconciliationRequestV05Document>
    ,IIsoXmlSerilizable<AcceptorReconciliationRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorReconciliationRequestV05Document.DocumentNamespace;
    ...
    public static AcceptorReconciliationRequestV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationRequestV05Document : IOuterDocument<AcceptorReconciliationRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorReconciliationRequestV05.XmlTag)]
    public required AcceptorReconciliationRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorReconciliationRequestV05.XmlTag);
