...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorReconciliationRequestV07>;
...
public partial record AcceptorReconciliationRequestV07 : IOuterRecord<AcceptorReconciliationRequestV07,AcceptorReconciliationRequestV07Document>
    ,IIsoXmlSerilizable<AcceptorReconciliationRequestV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorReconciliationRequestV07Document.DocumentNamespace;
    ...
    public static AcceptorReconciliationRequestV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationRequestV07Document : IOuterDocument<AcceptorReconciliationRequestV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorReconciliationRequestV07.XmlTag)]
    public required AcceptorReconciliationRequestV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorReconciliationRequestV07.XmlTag);
