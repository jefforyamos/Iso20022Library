...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorReconciliationRequestV08>;
...
public partial record AcceptorReconciliationRequestV08 : IOuterRecord<AcceptorReconciliationRequestV08,AcceptorReconciliationRequestV08Document>
    ,IIsoXmlSerilizable<AcceptorReconciliationRequestV08>, ISerializeInsideARootElement
{
    ...
    public static AcceptorReconciliationRequestV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationRequestV08Document : IOuterDocument<AcceptorReconciliationRequestV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorReconciliationRequestV08.XmlTag)]
    public required AcceptorReconciliationRequestV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorReconciliationRequestV08.XmlTag);
