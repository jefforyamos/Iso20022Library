...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorReconciliationRequestV11>;
...
public partial record AcceptorReconciliationRequestV11 : IOuterRecord<AcceptorReconciliationRequestV11,AcceptorReconciliationRequestV11Document>
    ,IIsoXmlSerilizable<AcceptorReconciliationRequestV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorReconciliationRequestV11Document.DocumentNamespace;
    ...
    public static AcceptorReconciliationRequestV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationRequestV11Document : IOuterDocument<AcceptorReconciliationRequestV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorReconciliationRequestV11.XmlTag)]
    public required AcceptorReconciliationRequestV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorReconciliationRequestV11.XmlTag);
