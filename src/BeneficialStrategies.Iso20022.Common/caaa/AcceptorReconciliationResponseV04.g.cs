...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorReconciliationResponseV04>;
...
public partial record AcceptorReconciliationResponseV04 : IOuterRecord<AcceptorReconciliationResponseV04,AcceptorReconciliationResponseV04Document>
    ,IIsoXmlSerilizable<AcceptorReconciliationResponseV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorReconciliationResponseV04Document.DocumentNamespace;
    ...
    public static AcceptorReconciliationResponseV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationResponseV04Document : IOuterDocument<AcceptorReconciliationResponseV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorReconciliationResponseV04.XmlTag)]
    public required AcceptorReconciliationResponseV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorReconciliationResponseV04.XmlTag);
