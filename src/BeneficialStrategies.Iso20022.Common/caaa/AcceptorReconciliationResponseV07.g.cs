...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorReconciliationResponseV07>;
...
public partial record AcceptorReconciliationResponseV07 : IOuterRecord<AcceptorReconciliationResponseV07,AcceptorReconciliationResponseV07Document>
    ,IIsoXmlSerilizable<AcceptorReconciliationResponseV07>, ISerializeInsideARootElement
{
    ...
    public static AcceptorReconciliationResponseV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationResponseV07Document : IOuterDocument<AcceptorReconciliationResponseV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorReconciliationResponseV07.XmlTag)]
    public required AcceptorReconciliationResponseV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorReconciliationResponseV07.XmlTag);
