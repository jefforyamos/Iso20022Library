...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorReconciliationResponseV10>;
...
public partial record AcceptorReconciliationResponseV10 : IOuterRecord<AcceptorReconciliationResponseV10,AcceptorReconciliationResponseV10Document>
    ,IIsoXmlSerilizable<AcceptorReconciliationResponseV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorReconciliationResponseV10Document.DocumentNamespace;
    ...
    public static AcceptorReconciliationResponseV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorReconciliationResponseV10Document : IOuterDocument<AcceptorReconciliationResponseV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorReconciliationResponseV10.XmlTag)]
    public required AcceptorReconciliationResponseV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorReconciliationResponseV10.XmlTag);
