...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorRejectionV03>;
...
public partial record AcceptorRejectionV03 : IOuterRecord<AcceptorRejectionV03,AcceptorRejectionV03Document>
    ,IIsoXmlSerilizable<AcceptorRejectionV03>, ISerializeInsideARootElement
{
    ...
    public static AcceptorRejectionV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorRejectionV03Document : IOuterDocument<AcceptorRejectionV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorRejectionV03.XmlTag)]
    public required AcceptorRejectionV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorRejectionV03.XmlTag);
