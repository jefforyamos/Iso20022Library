...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorRejectionV05>;
...
public partial record AcceptorRejectionV05 : IOuterRecord<AcceptorRejectionV05,AcceptorRejectionV05Document>
    ,IIsoXmlSerilizable<AcceptorRejectionV05>, ISerializeInsideARootElement
{
    ...
    public static AcceptorRejectionV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorRejectionV05Document : IOuterDocument<AcceptorRejectionV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorRejectionV05.XmlTag)]
    public required AcceptorRejectionV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorRejectionV05.XmlTag);
