...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorTransactionLogReportRequestV01>;
...
public partial record AcceptorTransactionLogReportRequestV01 : IOuterRecord<AcceptorTransactionLogReportRequestV01,AcceptorTransactionLogReportRequestV01Document>
    ,IIsoXmlSerilizable<AcceptorTransactionLogReportRequestV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorTransactionLogReportRequestV01Document.DocumentNamespace;
    ...
    public static AcceptorTransactionLogReportRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorTransactionLogReportRequestV01Document : IOuterDocument<AcceptorTransactionLogReportRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorTransactionLogReportRequestV01.XmlTag)]
    public required AcceptorTransactionLogReportRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorTransactionLogReportRequestV01.XmlTag);
