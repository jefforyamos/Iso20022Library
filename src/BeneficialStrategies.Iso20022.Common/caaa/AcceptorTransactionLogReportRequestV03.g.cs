...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.AcceptorTransactionLogReportRequestV03>;
...
public partial record AcceptorTransactionLogReportRequestV03 : IOuterRecord<AcceptorTransactionLogReportRequestV03,AcceptorTransactionLogReportRequestV03Document>
    ,IIsoXmlSerilizable<AcceptorTransactionLogReportRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorTransactionLogReportRequestV03Document.DocumentNamespace;
    ...
    public static AcceptorTransactionLogReportRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorTransactionLogReportRequestV03Document : IOuterDocument<AcceptorTransactionLogReportRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorTransactionLogReportRequestV03.XmlTag)]
    public required AcceptorTransactionLogReportRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorTransactionLogReportRequestV03.XmlTag);
