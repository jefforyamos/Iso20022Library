...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.TransactionAdviceV01>;
...
public partial record TransactionAdviceV01 : IOuterRecord<TransactionAdviceV01,TransactionAdviceV01Document>
    ,IIsoXmlSerilizable<TransactionAdviceV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransactionAdviceV01Document.DocumentNamespace;
    ...
    public static TransactionAdviceV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransactionAdviceV01Document : IOuterDocument<TransactionAdviceV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransactionAdviceV01.XmlTag)]
    public required TransactionAdviceV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransactionAdviceV01.XmlTag);
