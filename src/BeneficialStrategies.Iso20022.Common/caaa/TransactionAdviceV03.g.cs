...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caaa.TransactionAdviceV03>;
...
public partial record TransactionAdviceV03 : IOuterRecord<TransactionAdviceV03,TransactionAdviceV03Document>
    ,IIsoXmlSerilizable<TransactionAdviceV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransactionAdviceV03Document.DocumentNamespace;
    ...
    public static TransactionAdviceV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransactionAdviceV03Document : IOuterDocument<TransactionAdviceV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransactionAdviceV03.XmlTag)]
    public required TransactionAdviceV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransactionAdviceV03.XmlTag);
