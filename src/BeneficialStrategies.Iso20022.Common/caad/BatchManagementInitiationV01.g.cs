...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caad.BatchManagementInitiationV01>;
...
public partial record BatchManagementInitiationV01 : IOuterRecord<BatchManagementInitiationV01,BatchManagementInitiationV01Document>
    ,IIsoXmlSerilizable<BatchManagementInitiationV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BatchManagementInitiationV01Document.DocumentNamespace;
    ...
    public static BatchManagementInitiationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BatchManagementInitiationV01Document : IOuterDocument<BatchManagementInitiationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BatchManagementInitiationV01.XmlTag)]
    public required BatchManagementInitiationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BatchManagementInitiationV01.XmlTag);
