...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caad.BatchManagementInitiationV02>;
...
public partial record BatchManagementInitiationV02 : IOuterRecord<BatchManagementInitiationV02,BatchManagementInitiationV02Document>
    ,IIsoXmlSerilizable<BatchManagementInitiationV02>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("BtchMgmtInitn");
    ...
    public static BatchManagementInitiationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BatchManagementInitiationV02Document : IOuterDocument<BatchManagementInitiationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BatchManagementInitiationV02.XmlTag)]
    public required BatchManagementInitiationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BatchManagementInitiationV02.XmlTag);
