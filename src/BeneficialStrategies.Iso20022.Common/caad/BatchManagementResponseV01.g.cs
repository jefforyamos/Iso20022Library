...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caad.BatchManagementResponseV01>;
...
public partial record BatchManagementResponseV01 : IOuterRecord<BatchManagementResponseV01,BatchManagementResponseV01Document>
    ,IIsoXmlSerilizable<BatchManagementResponseV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BatchManagementResponseV01Document.DocumentNamespace;
    ...
    public static BatchManagementResponseV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BatchManagementResponseV01Document : IOuterDocument<BatchManagementResponseV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BatchManagementResponseV01.XmlTag)]
    public required BatchManagementResponseV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BatchManagementResponseV01.XmlTag);
