...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caad.BatchTransferResponseV02>;
...
public partial record BatchTransferResponseV02 : IOuterRecord<BatchTransferResponseV02,BatchTransferResponseV02Document>
    ,IIsoXmlSerilizable<BatchTransferResponseV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BatchTransferResponseV02Document.DocumentNamespace;
    ...
    public static BatchTransferResponseV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="BatchTransferResponseV02"/>.
/// </summary>
[Serializable]
public partial record BatchTransferResponseV02Document : IOuterDocument<BatchTransferResponseV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BatchTransferResponseV02.XmlTag)]
    public required BatchTransferResponseV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BatchTransferResponseV02.XmlTag);
