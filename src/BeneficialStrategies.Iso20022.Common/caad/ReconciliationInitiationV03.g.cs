...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caad.ReconciliationInitiationV03>;
...
public partial record ReconciliationInitiationV03 : IOuterRecord<ReconciliationInitiationV03,ReconciliationInitiationV03Document>
    ,IIsoXmlSerilizable<ReconciliationInitiationV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ReconciliationInitiationV03Document.DocumentNamespace;
    ...
    public static ReconciliationInitiationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ReconciliationInitiationV03Document : IOuterDocument<ReconciliationInitiationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ReconciliationInitiationV03.XmlTag)]
    public required ReconciliationInitiationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ReconciliationInitiationV03.XmlTag);
