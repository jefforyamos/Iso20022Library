...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caad.ReconciliationResponseV03>;
...
public partial record ReconciliationResponseV03 : IOuterRecord<ReconciliationResponseV03,ReconciliationResponseV03Document>
    ,IIsoXmlSerilizable<ReconciliationResponseV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ReconciliationResponseV03Document.DocumentNamespace;
    ...
    public static ReconciliationResponseV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ReconciliationResponseV03Document : IOuterDocument<ReconciliationResponseV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ReconciliationResponseV03.XmlTag)]
    public required ReconciliationResponseV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ReconciliationResponseV03.XmlTag);
