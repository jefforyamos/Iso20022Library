...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caam.ATMDeviceControlV03>;
...
public partial record ATMDeviceControlV03 : IOuterRecord<ATMDeviceControlV03,ATMDeviceControlV03Document>
    ,IIsoXmlSerilizable<ATMDeviceControlV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMDeviceControl is ATMDeviceControl2 ATMDeviceControlValue)
        {
    ...
    public static ATMDeviceControlV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMDeviceControlV03Document : IOuterDocument<ATMDeviceControlV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMDeviceControlV03.XmlTag)]
    public required ATMDeviceControlV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMDeviceControlV03.XmlTag);
