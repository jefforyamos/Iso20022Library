...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caam.ATMDeviceReportV03>;
...
public partial record ATMDeviceReportV03 : IOuterRecord<ATMDeviceReportV03,ATMDeviceReportV03Document>
    ,IIsoXmlSerilizable<ATMDeviceReportV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ATMDeviceReportV03Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMDeviceReport is ATMDeviceReport3 ATMDeviceReportValue)
        {
    ...
    public static ATMDeviceReportV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMDeviceReportV03Document : IOuterDocument<ATMDeviceReportV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMDeviceReportV03.XmlTag)]
    public required ATMDeviceReportV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMDeviceReportV03.XmlTag);
