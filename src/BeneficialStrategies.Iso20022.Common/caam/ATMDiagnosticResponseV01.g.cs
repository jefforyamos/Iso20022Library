...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caam.ATMDiagnosticResponseV01>;
...
public partial record ATMDiagnosticResponseV01 : IOuterRecord<ATMDiagnosticResponseV01,ATMDiagnosticResponseV01Document>
    ,IIsoXmlSerilizable<ATMDiagnosticResponseV01>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMDiagnosticResponse is ATMDiagnosticResponse1 ATMDiagnosticResponseValue)
        {
    ...
    public static ATMDiagnosticResponseV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMDiagnosticResponseV01Document : IOuterDocument<ATMDiagnosticResponseV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMDiagnosticResponseV01.XmlTag)]
    public required ATMDiagnosticResponseV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMDiagnosticResponseV01.XmlTag);
