...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caam.ATMDiagnosticResponseV02>;
...
public partial record ATMDiagnosticResponseV02 : IOuterRecord<ATMDiagnosticResponseV02,ATMDiagnosticResponseV02Document>
    ,IIsoXmlSerilizable<ATMDiagnosticResponseV02>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("ATMDgnstcRspn");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedATMDiagnosticResponse is ContentInformationType10 ProtectedATMDiagnosticResponseValue)
        {
            writer.WriteStartElement(null, "PrtctdATMDgnstcRspn", xmlNamespace );
            ProtectedATMDiagnosticResponseValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ATMDiagnosticResponse is ATMDiagnosticResponse2 ATMDiagnosticResponseValue)
        {
            writer.WriteStartElement(null, "ATMDgnstcRspn", xmlNamespace );
            ATMDiagnosticResponseValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    ...
    public static ATMDiagnosticResponseV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMDiagnosticResponseV02Document : IOuterDocument<ATMDiagnosticResponseV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMDiagnosticResponseV02.XmlTag)]
    public required ATMDiagnosticResponseV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMDiagnosticResponseV02.XmlTag);
