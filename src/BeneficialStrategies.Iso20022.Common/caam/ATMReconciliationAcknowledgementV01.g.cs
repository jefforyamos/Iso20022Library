...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caam.ATMReconciliationAcknowledgementV01>;
...
public partial record ATMReconciliationAcknowledgementV01 : IOuterRecord<ATMReconciliationAcknowledgementV01,ATMReconciliationAcknowledgementV01Document>
    ,IIsoXmlSerilizable<ATMReconciliationAcknowledgementV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ATMReconciliationAcknowledgementV01Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMReconciliationAcknowledgement is ATMReconciliationAcknowledgement1 ATMReconciliationAcknowledgementValue)
        {
    ...
    public static ATMReconciliationAcknowledgementV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMReconciliationAcknowledgementV01Document : IOuterDocument<ATMReconciliationAcknowledgementV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMReconciliationAcknowledgementV01.XmlTag)]
    public required ATMReconciliationAcknowledgementV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMReconciliationAcknowledgementV01.XmlTag);
