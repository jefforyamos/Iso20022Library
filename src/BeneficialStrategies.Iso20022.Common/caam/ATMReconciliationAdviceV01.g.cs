...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caam.ATMReconciliationAdviceV01>;
...
public partial record ATMReconciliationAdviceV01 : IOuterRecord<ATMReconciliationAdviceV01,ATMReconciliationAdviceV01Document>
    ,IIsoXmlSerilizable<ATMReconciliationAdviceV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("ATMRcncltnAdvc");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProtectedATMReconciliationAdvice is ContentInformationType10 ProtectedATMReconciliationAdviceValue)
        {
            writer.WriteStartElement(null, "PrtctdATMRcncltnAdvc", xmlNamespace );
            ProtectedATMReconciliationAdviceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ATMReconciliationAdvice is ATMReconciliationAdvice1 ATMReconciliationAdviceValue)
        {
            writer.WriteStartElement(null, "ATMRcncltnAdvc", xmlNamespace );
            ATMReconciliationAdviceValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    ...
    public static ATMReconciliationAdviceV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMReconciliationAdviceV01Document : IOuterDocument<ATMReconciliationAdviceV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMReconciliationAdviceV01.XmlTag)]
    public required ATMReconciliationAdviceV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMReconciliationAdviceV01.XmlTag);
