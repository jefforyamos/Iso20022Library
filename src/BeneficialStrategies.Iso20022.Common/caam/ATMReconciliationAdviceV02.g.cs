...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.caam.ATMReconciliationAdviceV02>;
...
public partial record ATMReconciliationAdviceV02 : IOuterRecord<ATMReconciliationAdviceV02,ATMReconciliationAdviceV02Document>
    ,IIsoXmlSerilizable<ATMReconciliationAdviceV02>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMReconciliationAdvice is ATMReconciliationAdvice2 ATMReconciliationAdviceValue)
        {
    ...
    public static ATMReconciliationAdviceV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMReconciliationAdviceV02Document : IOuterDocument<ATMReconciliationAdviceV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMReconciliationAdviceV02.XmlTag)]
    public required ATMReconciliationAdviceV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMReconciliationAdviceV02.XmlTag);
