...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.cafc.FeeCollectionInitiationV02>;
...
public partial record FeeCollectionInitiationV02 : IOuterRecord<FeeCollectionInitiationV02,FeeCollectionInitiationV02Document>
    ,IIsoXmlSerilizable<FeeCollectionInitiationV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FeeCollectionInitiationV02Document.DocumentNamespace;
    ...
    public static FeeCollectionInitiationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FeeCollectionInitiationV02Document : IOuterDocument<FeeCollectionInitiationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FeeCollectionInitiationV02.XmlTag)]
    public required FeeCollectionInitiationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FeeCollectionInitiationV02.XmlTag);
