...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.cafc.FeeCollectionResponseV01>;
...
public partial record FeeCollectionResponseV01 : IOuterRecord<FeeCollectionResponseV01,FeeCollectionResponseV01Document>
    ,IIsoXmlSerilizable<FeeCollectionResponseV01>, ISerializeInsideARootElement
{
    ...
    public static FeeCollectionResponseV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FeeCollectionResponseV01Document : IOuterDocument<FeeCollectionResponseV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FeeCollectionResponseV01.XmlTag)]
    public required FeeCollectionResponseV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FeeCollectionResponseV01.XmlTag);
