...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.cain.CardManagementInitiationV02>;
...
public partial record CardManagementInitiationV02 : IOuterRecord<CardManagementInitiationV02,CardManagementInitiationV02Document>
    ,IIsoXmlSerilizable<CardManagementInitiationV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CardManagementInitiationV02Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("CardMgmtInitn");
    ...
    public static CardManagementInitiationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CardManagementInitiationV02Document : IOuterDocument<CardManagementInitiationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CardManagementInitiationV02.XmlTag)]
    public required CardManagementInitiationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CardManagementInitiationV02.XmlTag);
