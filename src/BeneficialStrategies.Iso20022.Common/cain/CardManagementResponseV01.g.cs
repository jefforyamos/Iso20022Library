...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.cain.CardManagementResponseV01>;
...
public partial record CardManagementResponseV01 : IOuterRecord<CardManagementResponseV01,CardManagementResponseV01Document>
    ,IIsoXmlSerilizable<CardManagementResponseV01>, ISerializeInsideARootElement
{
    ...
    public static CardManagementResponseV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CardManagementResponseV01Document : IOuterDocument<CardManagementResponseV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CardManagementResponseV01.XmlTag)]
    public required CardManagementResponseV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CardManagementResponseV01.XmlTag);
