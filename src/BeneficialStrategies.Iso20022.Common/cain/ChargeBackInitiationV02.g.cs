...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.cain.ChargeBackInitiationV02>;
...
public partial record ChargeBackInitiationV02 : IOuterRecord<ChargeBackInitiationV02,ChargeBackInitiationV02Document>
    ,IIsoXmlSerilizable<ChargeBackInitiationV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ChargeBackInitiationV02Document.DocumentNamespace;
    ...
    public static ChargeBackInitiationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ChargeBackInitiationV02Document : IOuterDocument<ChargeBackInitiationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ChargeBackInitiationV02.XmlTag)]
    public required ChargeBackInitiationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ChargeBackInitiationV02.XmlTag);
