...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.cain.RetrievalFulfilmentInitiationV01>;
...
public partial record RetrievalFulfilmentInitiationV01 : IOuterRecord<RetrievalFulfilmentInitiationV01,RetrievalFulfilmentInitiationV01Document>
    ,IIsoXmlSerilizable<RetrievalFulfilmentInitiationV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RetrievalFulfilmentInitiationV01Document.DocumentNamespace;
    ...
    public static RetrievalFulfilmentInitiationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RetrievalFulfilmentInitiationV01Document : IOuterDocument<RetrievalFulfilmentInitiationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RetrievalFulfilmentInitiationV01.XmlTag)]
    public required RetrievalFulfilmentInitiationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RetrievalFulfilmentInitiationV01.XmlTag);
