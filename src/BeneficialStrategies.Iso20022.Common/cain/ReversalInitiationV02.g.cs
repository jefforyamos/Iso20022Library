...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.cain.ReversalInitiationV02>;
...
public partial record ReversalInitiationV02 : IOuterRecord<ReversalInitiationV02,ReversalInitiationV02Document>
    ,IIsoXmlSerilizable<ReversalInitiationV02>, ISerializeInsideARootElement
{
    ...
    public static ReversalInitiationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ReversalInitiationV02Document : IOuterDocument<ReversalInitiationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ReversalInitiationV02.XmlTag)]
    public required ReversalInitiationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ReversalInitiationV02.XmlTag);
