...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.AdditionalPaymentInformationV03>;
...
public partial record AdditionalPaymentInformationV03 : IOuterRecord<AdditionalPaymentInformationV03,AdditionalPaymentInformationV03Document>
    ,IIsoXmlSerilizable<AdditionalPaymentInformationV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AdditionalPaymentInformationV03Document.DocumentNamespace;
    ...
    public static AdditionalPaymentInformationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV03Document : IOuterDocument<AdditionalPaymentInformationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AdditionalPaymentInformationV03.XmlTag)]
    public required AdditionalPaymentInformationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AdditionalPaymentInformationV03.XmlTag);
