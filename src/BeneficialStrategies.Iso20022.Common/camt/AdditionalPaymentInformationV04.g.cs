...
//
// Generated by MainMessageGenerator for AdditionalPaymentInformationV04.  ISO2002 ID# _sYCjIVkyEeGeoaLUQk__nA_-1513426724.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.AdditionalPaymentInformationV04>;
...
public partial record AdditionalPaymentInformationV04 : IOuterRecord<AdditionalPaymentInformationV04,AdditionalPaymentInformationV04Document>
    ,IIsoXmlSerilizable<AdditionalPaymentInformationV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AdditionalPaymentInformationV04Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="AdditionalPaymentInformationV04Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public AdditionalPaymentInformationV04Document ToDocument()
    {
        return new AdditionalPaymentInformationV04Document { Message = this };
    }
    ...
    public static AdditionalPaymentInformationV04 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="AdditionalPaymentInformationV04"/>.
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV04Document : IOuterDocument<AdditionalPaymentInformationV04>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="AdditionalPaymentInformationV04"/> is required.
    /// </summary>
    [DataMember(Name=AdditionalPaymentInformationV04.XmlTag)]
    public required AdditionalPaymentInformationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AdditionalPaymentInformationV04.XmlTag);
