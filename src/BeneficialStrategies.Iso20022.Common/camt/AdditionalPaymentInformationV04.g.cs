...
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV04Document : IOuterDocument<AdditionalPaymentInformationV04>
{
    ...
    #else
    public AdditionalPaymentInformationV04 Message { get; init; }
    #endif
}
