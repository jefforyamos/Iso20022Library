...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.AdditionalPaymentInformationV05>;
...
public partial record AdditionalPaymentInformationV05 : IOuterRecord<AdditionalPaymentInformationV05,AdditionalPaymentInformationV05Document>
    ,IIsoXmlSerilizable<AdditionalPaymentInformationV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AdditionalPaymentInformationV05Document.DocumentNamespace;
    ...
    public static AdditionalPaymentInformationV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="AdditionalPaymentInformationV05"/>.
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV05Document : IOuterDocument<AdditionalPaymentInformationV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AdditionalPaymentInformationV05.XmlTag)]
    public required AdditionalPaymentInformationV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AdditionalPaymentInformationV05.XmlTag);
