...
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV07Document : IOuterDocument<AdditionalPaymentInformationV07>
{
    ...
    #else
    public AdditionalPaymentInformationV07 Message { get; init; }
    #endif
}
