...
//
// Generated by MainMessageGenerator for AdditionalPaymentInformationV07.  ISO2002 ID# _xwzGIWXoEeap-P22vGV91g.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.AdditionalPaymentInformationV07>;
...
public partial record AdditionalPaymentInformationV07 : IOuterRecord<AdditionalPaymentInformationV07,AdditionalPaymentInformationV07Document>
    ,IIsoXmlSerilizable<AdditionalPaymentInformationV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AdditionalPaymentInformationV07Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="AdditionalPaymentInformationV07Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public AdditionalPaymentInformationV07Document ToDocument()
    {
        return new AdditionalPaymentInformationV07Document { Message = this };
    }
    ...
    public static AdditionalPaymentInformationV07 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="AdditionalPaymentInformationV07"/>.
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV07Document : IOuterDocument<AdditionalPaymentInformationV07>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="AdditionalPaymentInformationV07"/> is required.
    /// </summary>
    [DataMember(Name=AdditionalPaymentInformationV07.XmlTag)]
    public required AdditionalPaymentInformationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AdditionalPaymentInformationV07.XmlTag);
