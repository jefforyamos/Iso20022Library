...
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV08Document : IOuterDocument<AdditionalPaymentInformationV08>
{
    ...
    #else
    public AdditionalPaymentInformationV08 Message { get; init; }
    #endif
}
