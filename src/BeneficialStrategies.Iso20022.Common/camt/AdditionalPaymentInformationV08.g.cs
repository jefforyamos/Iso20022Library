...
//
// Generated by MainMessageGenerator for AdditionalPaymentInformationV08.  ISO2002 ID# _nNCyUaqDEeeMmtkfa8-zPg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.AdditionalPaymentInformationV08>;
...
public partial record AdditionalPaymentInformationV08 : IOuterRecord<AdditionalPaymentInformationV08,AdditionalPaymentInformationV08Document>
    ,IIsoXmlSerilizable<AdditionalPaymentInformationV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AdditionalPaymentInformationV08Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="AdditionalPaymentInformationV08Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public AdditionalPaymentInformationV08Document ToDocument()
    {
        return new AdditionalPaymentInformationV08Document { Message = this };
    }
    ...
    public static AdditionalPaymentInformationV08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="AdditionalPaymentInformationV08"/>.
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV08Document : IOuterDocument<AdditionalPaymentInformationV08>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="AdditionalPaymentInformationV08"/> is required.
    /// </summary>
    [DataMember(Name=AdditionalPaymentInformationV08.XmlTag)]
    public required AdditionalPaymentInformationV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AdditionalPaymentInformationV08.XmlTag);
