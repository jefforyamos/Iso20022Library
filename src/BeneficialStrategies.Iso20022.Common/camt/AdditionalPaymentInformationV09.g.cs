...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.AdditionalPaymentInformationV09>;
...
public partial record AdditionalPaymentInformationV09 : IOuterRecord<AdditionalPaymentInformationV09,AdditionalPaymentInformationV09Document>
    ,IIsoXmlSerilizable<AdditionalPaymentInformationV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AdditionalPaymentInformationV09Document.DocumentNamespace;
    ...
    public static AdditionalPaymentInformationV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AdditionalPaymentInformationV09Document : IOuterDocument<AdditionalPaymentInformationV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AdditionalPaymentInformationV09.XmlTag)]
    public required AdditionalPaymentInformationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AdditionalPaymentInformationV09.XmlTag);
