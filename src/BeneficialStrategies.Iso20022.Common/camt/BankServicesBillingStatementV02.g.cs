...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankServicesBillingStatementV02>;
...
public partial record BankServicesBillingStatementV02 : IOuterRecord<BankServicesBillingStatementV02,BankServicesBillingStatementV02Document>
    ,IIsoXmlSerilizable<BankServicesBillingStatementV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BankServicesBillingStatementV02Document.DocumentNamespace;
    ...
    public static BankServicesBillingStatementV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankServicesBillingStatementV02Document : IOuterDocument<BankServicesBillingStatementV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankServicesBillingStatementV02.XmlTag)]
    public required BankServicesBillingStatementV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankServicesBillingStatementV02.XmlTag);
