...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankServicesBillingStatementV04>;
...
public partial record BankServicesBillingStatementV04 : IOuterRecord<BankServicesBillingStatementV04,BankServicesBillingStatementV04Document>
    ,IIsoXmlSerilizable<BankServicesBillingStatementV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BankServicesBillingStatementV04Document.DocumentNamespace;
    ...
    public static BankServicesBillingStatementV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankServicesBillingStatementV04Document : IOuterDocument<BankServicesBillingStatementV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankServicesBillingStatementV04.XmlTag)]
    public required BankServicesBillingStatementV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankServicesBillingStatementV04.XmlTag);
