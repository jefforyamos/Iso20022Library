...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerAccountReportV03>;
...
public partial record BankToCustomerAccountReportV03 : IOuterRecord<BankToCustomerAccountReportV03,BankToCustomerAccountReportV03Document>
    ,IIsoXmlSerilizable<BankToCustomerAccountReportV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BankToCustomerAccountReportV03Document.DocumentNamespace;
    ...
    public static BankToCustomerAccountReportV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankToCustomerAccountReportV03Document : IOuterDocument<BankToCustomerAccountReportV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankToCustomerAccountReportV03.XmlTag)]
    public required BankToCustomerAccountReportV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerAccountReportV03.XmlTag);
