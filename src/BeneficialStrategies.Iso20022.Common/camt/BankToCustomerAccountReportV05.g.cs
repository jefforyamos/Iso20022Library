...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerAccountReportV05>;
...
public partial record BankToCustomerAccountReportV05 : IOuterRecord<BankToCustomerAccountReportV05,BankToCustomerAccountReportV05Document>
    ,IIsoXmlSerilizable<BankToCustomerAccountReportV05>, ISerializeInsideARootElement
{
    ...
    public static BankToCustomerAccountReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankToCustomerAccountReportV05Document : IOuterDocument<BankToCustomerAccountReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankToCustomerAccountReportV05.XmlTag)]
    public required BankToCustomerAccountReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerAccountReportV05.XmlTag);
