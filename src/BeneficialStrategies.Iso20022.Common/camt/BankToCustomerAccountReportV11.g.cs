...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerAccountReportV11>;
...
public partial record BankToCustomerAccountReportV11 : IOuterRecord<BankToCustomerAccountReportV11,BankToCustomerAccountReportV11Document>
    ,IIsoXmlSerilizable<BankToCustomerAccountReportV11>, ISerializeInsideARootElement
{
    ...
    public static BankToCustomerAccountReportV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankToCustomerAccountReportV11Document : IOuterDocument<BankToCustomerAccountReportV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankToCustomerAccountReportV11.XmlTag)]
    public required BankToCustomerAccountReportV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerAccountReportV11.XmlTag);
