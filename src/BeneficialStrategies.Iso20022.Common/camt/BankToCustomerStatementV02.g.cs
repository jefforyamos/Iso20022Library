...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerStatementV02>;
...
public partial record BankToCustomerStatementV02 : IOuterRecord<BankToCustomerStatementV02,BankToCustomerStatementV02Document>
    ,IIsoXmlSerilizable<BankToCustomerStatementV02>, ISerializeInsideARootElement
{
    ...
    public static BankToCustomerStatementV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankToCustomerStatementV02Document : IOuterDocument<BankToCustomerStatementV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankToCustomerStatementV02.XmlTag)]
    public required BankToCustomerStatementV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerStatementV02.XmlTag);
