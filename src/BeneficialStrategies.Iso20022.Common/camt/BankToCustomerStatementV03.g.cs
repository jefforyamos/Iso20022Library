...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerStatementV03>;
...
public partial record BankToCustomerStatementV03 : IOuterRecord<BankToCustomerStatementV03,BankToCustomerStatementV03Document>
    ,IIsoXmlSerilizable<BankToCustomerStatementV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BankToCustomerStatementV03Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="BankToCustomerStatementV03Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public BankToCustomerStatementV03Document ToDocument()
    {
        return new BankToCustomerStatementV03Document { Message = this };
    }
    ...
    public static BankToCustomerStatementV03 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="BankToCustomerStatementV03"/>.
/// </summary>
[Serializable]
public partial record BankToCustomerStatementV03Document : IOuterDocument<BankToCustomerStatementV03>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="BankToCustomerStatementV03"/> is required.
    /// </summary>
    [DataMember(Name=BankToCustomerStatementV03.XmlTag)]
    public required BankToCustomerStatementV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerStatementV03.XmlTag);
