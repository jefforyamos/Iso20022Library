...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerStatementV06>;
...
public partial record BankToCustomerStatementV06 : IOuterRecord<BankToCustomerStatementV06,BankToCustomerStatementV06Document>
    ,IIsoXmlSerilizable<BankToCustomerStatementV06>, ISerializeInsideARootElement
{
    ...
    public static BankToCustomerStatementV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankToCustomerStatementV06Document : IOuterDocument<BankToCustomerStatementV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankToCustomerStatementV06.XmlTag)]
    public required BankToCustomerStatementV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerStatementV06.XmlTag);
