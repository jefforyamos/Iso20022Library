...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerStatementV08>;
...
public partial record BankToCustomerStatementV08 : IOuterRecord<BankToCustomerStatementV08,BankToCustomerStatementV08Document>
    ,IIsoXmlSerilizable<BankToCustomerStatementV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BankToCustomerStatementV08Document.DocumentNamespace;
    ...
    public static BankToCustomerStatementV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankToCustomerStatementV08Document : IOuterDocument<BankToCustomerStatementV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankToCustomerStatementV08.XmlTag)]
    public required BankToCustomerStatementV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerStatementV08.XmlTag);
