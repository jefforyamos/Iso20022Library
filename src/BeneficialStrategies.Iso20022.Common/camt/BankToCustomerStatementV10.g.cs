...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerStatementV10>;
...
public partial record BankToCustomerStatementV10 : IOuterRecord<BankToCustomerStatementV10,BankToCustomerStatementV10Document>
    ,IIsoXmlSerilizable<BankToCustomerStatementV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BankToCustomerStatementV10Document.DocumentNamespace;
    ...
    public static BankToCustomerStatementV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankToCustomerStatementV10Document : IOuterDocument<BankToCustomerStatementV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankToCustomerStatementV10.XmlTag)]
    public required BankToCustomerStatementV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerStatementV10.XmlTag);
