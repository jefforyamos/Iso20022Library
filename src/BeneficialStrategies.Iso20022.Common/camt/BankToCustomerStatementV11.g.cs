...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.BankToCustomerStatementV11>;
...
public partial record BankToCustomerStatementV11 : IOuterRecord<BankToCustomerStatementV11,BankToCustomerStatementV11Document>
    ,IIsoXmlSerilizable<BankToCustomerStatementV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BankToCustomerStatementV11Document.DocumentNamespace;
    ...
    public static BankToCustomerStatementV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BankToCustomerStatementV11Document : IOuterDocument<BankToCustomerStatementV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BankToCustomerStatementV11.XmlTag)]
    public required BankToCustomerStatementV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BankToCustomerStatementV11.XmlTag);
