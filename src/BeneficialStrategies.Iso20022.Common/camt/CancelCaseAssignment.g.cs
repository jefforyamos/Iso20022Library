...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CancelCaseAssignment>;
...
public partial record CancelCaseAssignment : IOuterRecord<CancelCaseAssignment,CancelCaseAssignmentDocument>
    ,IIsoXmlSerilizable<CancelCaseAssignment>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("camt.032.001.01");
    ...
    public static CancelCaseAssignment Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CancelCaseAssignmentDocument : IOuterDocument<CancelCaseAssignment>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CancelCaseAssignment.XmlTag)]
    public required CancelCaseAssignment Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CancelCaseAssignment.XmlTag);
