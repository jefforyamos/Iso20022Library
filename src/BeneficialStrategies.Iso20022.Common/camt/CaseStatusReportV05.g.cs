...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CaseStatusReportV05>;
...
public partial record CaseStatusReportV05 : IOuterRecord<CaseStatusReportV05,CaseStatusReportV05Document>
    ,IIsoXmlSerilizable<CaseStatusReportV05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (NewAssignment is CaseAssignment5 NewAssignmentValue)
        {
    ...
    public static CaseStatusReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CaseStatusReportV05Document : IOuterDocument<CaseStatusReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CaseStatusReportV05.XmlTag)]
    public required CaseStatusReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CaseStatusReportV05.XmlTag);
