...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ChargesPaymentNotificationV01>;
...
public partial record ChargesPaymentNotificationV01 : IOuterRecord<ChargesPaymentNotificationV01,ChargesPaymentNotificationV01Document>
    ,IIsoXmlSerilizable<ChargesPaymentNotificationV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("ChrgsPmtNtfctn");
    ...
    public static ChargesPaymentNotificationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ChargesPaymentNotificationV01Document : IOuterDocument<ChargesPaymentNotificationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ChargesPaymentNotificationV01.XmlTag)]
    public required ChargesPaymentNotificationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ChargesPaymentNotificationV01.XmlTag);
