...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ClaimNonReceiptV03>;
...
public partial record ClaimNonReceiptV03 : IOuterRecord<ClaimNonReceiptV03,ClaimNonReceiptV03Document>
    ,IIsoXmlSerilizable<ClaimNonReceiptV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CoverDetails is MissingCover2 CoverDetailsValue)
        {
    ...
    public static ClaimNonReceiptV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ClaimNonReceiptV03Document : IOuterDocument<ClaimNonReceiptV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ClaimNonReceiptV03.XmlTag)]
    public required ClaimNonReceiptV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ClaimNonReceiptV03.XmlTag);
