...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ClaimNonReceiptV04>;
...
public partial record ClaimNonReceiptV04 : IOuterRecord<ClaimNonReceiptV04,ClaimNonReceiptV04Document>
    ,IIsoXmlSerilizable<ClaimNonReceiptV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ClaimNonReceiptV04Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="ClaimNonReceiptV04Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public ClaimNonReceiptV04Document ToDocument()
    {
        return new ClaimNonReceiptV04Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CoverDetails is MissingCover3 CoverDetailsValue)
        {
    ...
    public static ClaimNonReceiptV04 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="ClaimNonReceiptV04"/>.
/// </summary>
[Serializable]
public partial record ClaimNonReceiptV04Document : IOuterDocument<ClaimNonReceiptV04>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="ClaimNonReceiptV04"/> is required.
    /// </summary>
    [DataMember(Name=ClaimNonReceiptV04.XmlTag)]
    public required ClaimNonReceiptV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ClaimNonReceiptV04.XmlTag);
