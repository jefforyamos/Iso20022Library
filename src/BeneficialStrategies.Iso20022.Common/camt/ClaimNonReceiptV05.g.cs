...
//
// Generated by MainMessageGenerator for ClaimNonReceiptV05.  ISO2002 ID# _00NMwWXoEeap-P22vGV91g.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ClaimNonReceiptV05>;
...
public partial record ClaimNonReceiptV05 : IOuterRecord<ClaimNonReceiptV05,ClaimNonReceiptV05Document>
    ,IIsoXmlSerilizable<ClaimNonReceiptV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ClaimNonReceiptV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="ClaimNonReceiptV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public ClaimNonReceiptV05Document ToDocument()
    {
        return new ClaimNonReceiptV05Document { Message = this };
    }
    ...
    public static ClaimNonReceiptV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="ClaimNonReceiptV05"/>.
/// </summary>
[Serializable]
public partial record ClaimNonReceiptV05Document : IOuterDocument<ClaimNonReceiptV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="ClaimNonReceiptV05"/> is required.
    /// </summary>
    [DataMember(Name=ClaimNonReceiptV05.XmlTag)]
    public required ClaimNonReceiptV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ClaimNonReceiptV05.XmlTag);
