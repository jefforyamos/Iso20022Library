...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ClaimNonReceiptV07>;
...
public partial record ClaimNonReceiptV07 : IOuterRecord<ClaimNonReceiptV07,ClaimNonReceiptV07Document>
    ,IIsoXmlSerilizable<ClaimNonReceiptV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ClaimNonReceiptV07Document.DocumentNamespace;
    ...
    public static ClaimNonReceiptV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ClaimNonReceiptV07Document : IOuterDocument<ClaimNonReceiptV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ClaimNonReceiptV07.XmlTag)]
    public required ClaimNonReceiptV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ClaimNonReceiptV07.XmlTag);
