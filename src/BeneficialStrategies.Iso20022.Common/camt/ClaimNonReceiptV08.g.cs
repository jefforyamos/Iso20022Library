...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ClaimNonReceiptV08>;
...
public partial record ClaimNonReceiptV08 : IOuterRecord<ClaimNonReceiptV08,ClaimNonReceiptV08Document>
    ,IIsoXmlSerilizable<ClaimNonReceiptV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ClaimNonReceiptV08Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CoverDetails is MissingCover4 CoverDetailsValue)
        {
    ...
    public static ClaimNonReceiptV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ClaimNonReceiptV08Document : IOuterDocument<ClaimNonReceiptV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ClaimNonReceiptV08.XmlTag)]
    public required ClaimNonReceiptV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ClaimNonReceiptV08.XmlTag);
