...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV02>;
...
public partial record CustomerPaymentCancellationRequestV02 : IOuterRecord<CustomerPaymentCancellationRequestV02,CustomerPaymentCancellationRequestV02Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV02Document.DocumentNamespace;
    ...
    public static CustomerPaymentCancellationRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV02Document : IOuterDocument<CustomerPaymentCancellationRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV02.XmlTag)]
    public required CustomerPaymentCancellationRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV02.XmlTag);
