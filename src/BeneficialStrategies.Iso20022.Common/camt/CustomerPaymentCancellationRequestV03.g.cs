...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV03>;
...
public partial record CustomerPaymentCancellationRequestV03 : IOuterRecord<CustomerPaymentCancellationRequestV03,CustomerPaymentCancellationRequestV03Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV03Document.DocumentNamespace;
    ...
    public static CustomerPaymentCancellationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV03Document : IOuterDocument<CustomerPaymentCancellationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV03.XmlTag)]
    public required CustomerPaymentCancellationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV03.XmlTag);
