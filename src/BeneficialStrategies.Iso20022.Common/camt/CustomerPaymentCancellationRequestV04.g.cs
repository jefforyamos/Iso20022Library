...
//
// Generated by MainMessageGenerator for CustomerPaymentCancellationRequestV04.  ISO2002 ID# _wQzafRPeEeSVo-TFVwFHvA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV04>;
...
public partial record CustomerPaymentCancellationRequestV04 : IOuterRecord<CustomerPaymentCancellationRequestV04,CustomerPaymentCancellationRequestV04Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV04Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerPaymentCancellationRequestV04Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerPaymentCancellationRequestV04Document ToDocument()
    {
        return new CustomerPaymentCancellationRequestV04Document { Message = this };
    }
    ...
    public static CustomerPaymentCancellationRequestV04 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentCancellationRequestV04"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV04Document : IOuterDocument<CustomerPaymentCancellationRequestV04>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerPaymentCancellationRequestV04"/> is required.
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV04.XmlTag)]
    public required CustomerPaymentCancellationRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV04.XmlTag);
