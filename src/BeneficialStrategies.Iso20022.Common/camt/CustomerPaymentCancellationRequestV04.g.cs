...
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV04Document : IOuterDocument<CustomerPaymentCancellationRequestV04>
{
    ...
    #else
    public CustomerPaymentCancellationRequestV04 Message { get; init; }
    #endif
}
