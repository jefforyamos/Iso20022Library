...
//
// Generated by MainMessageGenerator for CustomerPaymentCancellationRequestV05.  ISO2002 ID# _akmd_zqxEeWZFYSPlduMhw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV05>;
...
public partial record CustomerPaymentCancellationRequestV05 : IOuterRecord<CustomerPaymentCancellationRequestV05,CustomerPaymentCancellationRequestV05Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerPaymentCancellationRequestV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerPaymentCancellationRequestV05Document ToDocument()
    {
        return new CustomerPaymentCancellationRequestV05Document { Message = this };
    }
    ...
    public static CustomerPaymentCancellationRequestV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentCancellationRequestV05"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV05Document : IOuterDocument<CustomerPaymentCancellationRequestV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerPaymentCancellationRequestV05"/> is required.
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV05.XmlTag)]
    public required CustomerPaymentCancellationRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV05.XmlTag);
