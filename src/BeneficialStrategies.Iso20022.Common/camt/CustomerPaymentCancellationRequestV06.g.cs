...
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV06Document : IOuterDocument<CustomerPaymentCancellationRequestV06>
{
    ...
    #else
    public CustomerPaymentCancellationRequestV06 Message { get; init; }
    #endif
}
