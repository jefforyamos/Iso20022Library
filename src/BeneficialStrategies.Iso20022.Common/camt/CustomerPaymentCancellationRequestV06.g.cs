...
//
// Generated by MainMessageGenerator for CustomerPaymentCancellationRequestV06.  ISO2002 ID# _pVGXgUggEeaGKYpLDboHPQ.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV06>;
...
public partial record CustomerPaymentCancellationRequestV06 : IOuterRecord<CustomerPaymentCancellationRequestV06,CustomerPaymentCancellationRequestV06Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerPaymentCancellationRequestV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerPaymentCancellationRequestV06Document ToDocument()
    {
        return new CustomerPaymentCancellationRequestV06Document { Message = this };
    }
    ...
    public static CustomerPaymentCancellationRequestV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentCancellationRequestV06"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV06Document : IOuterDocument<CustomerPaymentCancellationRequestV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerPaymentCancellationRequestV06"/> is required.
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV06.XmlTag)]
    public required CustomerPaymentCancellationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV06.XmlTag);
