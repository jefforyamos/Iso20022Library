...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV07>;
...
public partial record CustomerPaymentCancellationRequestV07 : IOuterRecord<CustomerPaymentCancellationRequestV07,CustomerPaymentCancellationRequestV07Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV07Document.DocumentNamespace;
    ...
    public static CustomerPaymentCancellationRequestV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV07Document : IOuterDocument<CustomerPaymentCancellationRequestV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV07.XmlTag)]
    public required CustomerPaymentCancellationRequestV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV07.XmlTag);
