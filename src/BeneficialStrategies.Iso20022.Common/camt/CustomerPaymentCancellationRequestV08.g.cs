...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV08>;
...
public partial record CustomerPaymentCancellationRequestV08 : IOuterRecord<CustomerPaymentCancellationRequestV08,CustomerPaymentCancellationRequestV08Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV08Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerPaymentCancellationRequestV08Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerPaymentCancellationRequestV08Document ToDocument()
    {
        return new CustomerPaymentCancellationRequestV08Document { Message = this };
    }
    ...
    public static CustomerPaymentCancellationRequestV08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentCancellationRequestV08"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV08Document : IOuterDocument<CustomerPaymentCancellationRequestV08>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerPaymentCancellationRequestV08"/> is required.
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV08.XmlTag)]
    public required CustomerPaymentCancellationRequestV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV08.XmlTag);
