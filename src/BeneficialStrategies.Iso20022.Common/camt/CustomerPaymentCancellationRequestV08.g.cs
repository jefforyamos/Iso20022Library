...
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV08Document : IOuterDocument<CustomerPaymentCancellationRequestV08>
{
    ...
    #else
    public CustomerPaymentCancellationRequestV08 Message { get; init; }
    #endif
}
