...
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV10Document : IOuterDocument<CustomerPaymentCancellationRequestV10>
{
    ...
    #else
    public CustomerPaymentCancellationRequestV10 Message { get; init; }
    #endif
}
