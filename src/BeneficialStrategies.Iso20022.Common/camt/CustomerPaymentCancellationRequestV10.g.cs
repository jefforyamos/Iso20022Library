...
//
// Generated by MainMessageGenerator for CustomerPaymentCancellationRequestV10.  ISO2002 ID# _IBiye9cBEeq_l4BJLVUF2Q.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV10>;
...
public partial record CustomerPaymentCancellationRequestV10 : IOuterRecord<CustomerPaymentCancellationRequestV10,CustomerPaymentCancellationRequestV10Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV10Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerPaymentCancellationRequestV10Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerPaymentCancellationRequestV10Document ToDocument()
    {
        return new CustomerPaymentCancellationRequestV10Document { Message = this };
    }
    ...
    public static CustomerPaymentCancellationRequestV10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentCancellationRequestV10"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV10Document : IOuterDocument<CustomerPaymentCancellationRequestV10>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerPaymentCancellationRequestV10"/> is required.
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV10.XmlTag)]
    public required CustomerPaymentCancellationRequestV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV10.XmlTag);
