...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.CustomerPaymentCancellationRequestV11>;
...
public partial record CustomerPaymentCancellationRequestV11 : IOuterRecord<CustomerPaymentCancellationRequestV11,CustomerPaymentCancellationRequestV11Document>
    ,IIsoXmlSerilizable<CustomerPaymentCancellationRequestV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentCancellationRequestV11Document.DocumentNamespace;
    ...
    public static CustomerPaymentCancellationRequestV11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentCancellationRequestV11"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentCancellationRequestV11Document : IOuterDocument<CustomerPaymentCancellationRequestV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentCancellationRequestV11.XmlTag)]
    public required CustomerPaymentCancellationRequestV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentCancellationRequestV11.XmlTag);
