...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.DebitAuthorisationRequest>;
...
public partial record DebitAuthorisationRequest : IOuterRecord<DebitAuthorisationRequest,DebitAuthorisationRequestDocument>
    ,IIsoXmlSerilizable<DebitAuthorisationRequest>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("camt.037.001.01");
    ...
    public static DebitAuthorisationRequest Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DebitAuthorisationRequestDocument : IOuterDocument<DebitAuthorisationRequest>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DebitAuthorisationRequest.XmlTag)]
    public required DebitAuthorisationRequest Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DebitAuthorisationRequest.XmlTag);
