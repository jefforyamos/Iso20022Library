...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.DebitAuthorisationRequestV09>;
...
public partial record DebitAuthorisationRequestV09 : IOuterRecord<DebitAuthorisationRequestV09,DebitAuthorisationRequestV09Document>
    ,IIsoXmlSerilizable<DebitAuthorisationRequestV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DebitAuthorisationRequestV09Document.DocumentNamespace;
    ...
    public static DebitAuthorisationRequestV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DebitAuthorisationRequestV09Document : IOuterDocument<DebitAuthorisationRequestV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DebitAuthorisationRequestV09.XmlTag)]
    public required DebitAuthorisationRequestV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DebitAuthorisationRequestV09.XmlTag);
