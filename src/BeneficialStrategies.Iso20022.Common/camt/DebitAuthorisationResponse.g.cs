...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.DebitAuthorisationResponse>;
...
public partial record DebitAuthorisationResponse : IOuterRecord<DebitAuthorisationResponse,DebitAuthorisationResponseDocument>
    ,IIsoXmlSerilizable<DebitAuthorisationResponse>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("camt.036.001.01");
    ...
    public static DebitAuthorisationResponse Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DebitAuthorisationResponseDocument : IOuterDocument<DebitAuthorisationResponse>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DebitAuthorisationResponse.XmlTag)]
    public required DebitAuthorisationResponse Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DebitAuthorisationResponse.XmlTag);
