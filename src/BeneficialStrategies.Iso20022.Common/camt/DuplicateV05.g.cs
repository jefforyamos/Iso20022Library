...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.DuplicateV05>;
...
public partial record DuplicateV05 : IOuterRecord<DuplicateV05,DuplicateV05Document>
    ,IIsoXmlSerilizable<DuplicateV05>, ISerializeInsideARootElement
{
    ...
    public static DuplicateV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DuplicateV05Document : IOuterDocument<DuplicateV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DuplicateV05.XmlTag)]
    public required DuplicateV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DuplicateV05.XmlTag);
