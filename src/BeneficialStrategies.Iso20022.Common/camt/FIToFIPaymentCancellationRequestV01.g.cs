...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV01>;
...
public partial record FIToFIPaymentCancellationRequestV01 : IOuterRecord<FIToFIPaymentCancellationRequestV01,FIToFIPaymentCancellationRequestV01Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV01>, ISerializeInsideARootElement
{
    ...
    public static FIToFIPaymentCancellationRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV01Document : IOuterDocument<FIToFIPaymentCancellationRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV01.XmlTag)]
    public required FIToFIPaymentCancellationRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV01.XmlTag);
