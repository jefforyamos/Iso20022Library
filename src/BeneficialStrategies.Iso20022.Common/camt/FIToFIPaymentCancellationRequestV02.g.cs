...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV02>;
...
public partial record FIToFIPaymentCancellationRequestV02 : IOuterRecord<FIToFIPaymentCancellationRequestV02,FIToFIPaymentCancellationRequestV02Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentCancellationRequestV02Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentCancellationRequestV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentCancellationRequestV02Document ToDocument()
    {
        return new FIToFIPaymentCancellationRequestV02Document { Message = this };
    }
    ...
    public static FIToFIPaymentCancellationRequestV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFIPaymentCancellationRequestV02"/>.
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV02Document : IOuterDocument<FIToFIPaymentCancellationRequestV02>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFIPaymentCancellationRequestV02"/> is required.
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV02.XmlTag)]
    public required FIToFIPaymentCancellationRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV02.XmlTag);
