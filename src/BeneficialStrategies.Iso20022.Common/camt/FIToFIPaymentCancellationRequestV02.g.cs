...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV02Document : IOuterDocument<FIToFIPaymentCancellationRequestV02>
{
    ...
    #else
    public FIToFIPaymentCancellationRequestV02 Message { get; init; }
    #endif
}
