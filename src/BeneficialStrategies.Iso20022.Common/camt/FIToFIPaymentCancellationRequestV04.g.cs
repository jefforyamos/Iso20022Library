...
//
// Generated by MainMessageGenerator for FIToFIPaymentCancellationRequestV04.  ISO2002 ID# _wQzamxPeEeSVo-TFVwFHvA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV04>;
...
public partial record FIToFIPaymentCancellationRequestV04 : IOuterRecord<FIToFIPaymentCancellationRequestV04,FIToFIPaymentCancellationRequestV04Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentCancellationRequestV04Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentCancellationRequestV04Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentCancellationRequestV04Document ToDocument()
    {
        return new FIToFIPaymentCancellationRequestV04Document { Message = this };
    }
    ...
    public static FIToFIPaymentCancellationRequestV04 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFIPaymentCancellationRequestV04"/>.
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV04Document : IOuterDocument<FIToFIPaymentCancellationRequestV04>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFIPaymentCancellationRequestV04"/> is required.
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV04.XmlTag)]
    public required FIToFIPaymentCancellationRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV04.XmlTag);
