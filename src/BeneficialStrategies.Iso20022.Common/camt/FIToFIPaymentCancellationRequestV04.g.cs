...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV04Document : IOuterDocument<FIToFIPaymentCancellationRequestV04>
{
    ...
    #else
    public FIToFIPaymentCancellationRequestV04 Message { get; init; }
    #endif
}
