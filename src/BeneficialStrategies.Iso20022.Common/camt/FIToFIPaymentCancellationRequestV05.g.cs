...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV05>;
...
public partial record FIToFIPaymentCancellationRequestV05 : IOuterRecord<FIToFIPaymentCancellationRequestV05,FIToFIPaymentCancellationRequestV05Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentCancellationRequestV05Document.DocumentNamespace;
    ...
    public static FIToFIPaymentCancellationRequestV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV05Document : IOuterDocument<FIToFIPaymentCancellationRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV05.XmlTag)]
    public required FIToFIPaymentCancellationRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV05.XmlTag);
