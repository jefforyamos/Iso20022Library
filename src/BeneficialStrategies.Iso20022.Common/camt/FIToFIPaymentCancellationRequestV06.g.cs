...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV06Document : IOuterDocument<FIToFIPaymentCancellationRequestV06>
{
    ...
    #else
    public FIToFIPaymentCancellationRequestV06 Message { get; init; }
    #endif
}
