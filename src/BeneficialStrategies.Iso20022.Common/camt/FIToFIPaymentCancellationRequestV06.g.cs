...
//
// Generated by MainMessageGenerator for FIToFIPaymentCancellationRequestV06.  ISO2002 ID# _O2OwMUgZEeaGKYpLDboHPQ.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV06>;
...
public partial record FIToFIPaymentCancellationRequestV06 : IOuterRecord<FIToFIPaymentCancellationRequestV06,FIToFIPaymentCancellationRequestV06Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentCancellationRequestV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentCancellationRequestV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentCancellationRequestV06Document ToDocument()
    {
        return new FIToFIPaymentCancellationRequestV06Document { Message = this };
    }
    ...
    public static FIToFIPaymentCancellationRequestV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFIPaymentCancellationRequestV06"/>.
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV06Document : IOuterDocument<FIToFIPaymentCancellationRequestV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFIPaymentCancellationRequestV06"/> is required.
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV06.XmlTag)]
    public required FIToFIPaymentCancellationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV06.XmlTag);
