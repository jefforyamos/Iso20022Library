...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV07Document : IOuterDocument<FIToFIPaymentCancellationRequestV07>
{
    ...
    #else
    public FIToFIPaymentCancellationRequestV07 Message { get; init; }
    #endif
}
