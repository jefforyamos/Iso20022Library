...
//
// Generated by MainMessageGenerator for FIToFIPaymentCancellationRequestV07.  ISO2002 ID# _AOwWHV1tEeehlLdFiIrRgQ.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV07>;
...
public partial record FIToFIPaymentCancellationRequestV07 : IOuterRecord<FIToFIPaymentCancellationRequestV07,FIToFIPaymentCancellationRequestV07Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentCancellationRequestV07Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentCancellationRequestV07Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentCancellationRequestV07Document ToDocument()
    {
        return new FIToFIPaymentCancellationRequestV07Document { Message = this };
    }
    ...
    public static FIToFIPaymentCancellationRequestV07 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFIPaymentCancellationRequestV07"/>.
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV07Document : IOuterDocument<FIToFIPaymentCancellationRequestV07>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFIPaymentCancellationRequestV07"/> is required.
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV07.XmlTag)]
    public required FIToFIPaymentCancellationRequestV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV07.XmlTag);
