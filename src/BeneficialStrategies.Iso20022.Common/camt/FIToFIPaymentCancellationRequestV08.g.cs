...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV08Document : IOuterDocument<FIToFIPaymentCancellationRequestV08>
{
    ...
    #else
    public FIToFIPaymentCancellationRequestV08 Message { get; init; }
    #endif
}
