...
//
// Generated by MainMessageGenerator for FIToFIPaymentCancellationRequestV08.  ISO2002 ID# _eYI_gW2PEei3KuUgpx7Xcw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV08>;
...
public partial record FIToFIPaymentCancellationRequestV08 : IOuterRecord<FIToFIPaymentCancellationRequestV08,FIToFIPaymentCancellationRequestV08Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentCancellationRequestV08Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentCancellationRequestV08Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentCancellationRequestV08Document ToDocument()
    {
        return new FIToFIPaymentCancellationRequestV08Document { Message = this };
    }
    ...
    public static FIToFIPaymentCancellationRequestV08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFIPaymentCancellationRequestV08"/>.
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV08Document : IOuterDocument<FIToFIPaymentCancellationRequestV08>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFIPaymentCancellationRequestV08"/> is required.
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV08.XmlTag)]
    public required FIToFIPaymentCancellationRequestV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV08.XmlTag);
