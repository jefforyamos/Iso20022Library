...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV09>;
...
public partial record FIToFIPaymentCancellationRequestV09 : IOuterRecord<FIToFIPaymentCancellationRequestV09,FIToFIPaymentCancellationRequestV09Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentCancellationRequestV09Document.DocumentNamespace;
    ...
    public static FIToFIPaymentCancellationRequestV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV09Document : IOuterDocument<FIToFIPaymentCancellationRequestV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV09.XmlTag)]
    public required FIToFIPaymentCancellationRequestV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV09.XmlTag);
