...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FIToFIPaymentCancellationRequestV10>;
...
public partial record FIToFIPaymentCancellationRequestV10 : IOuterRecord<FIToFIPaymentCancellationRequestV10,FIToFIPaymentCancellationRequestV10Document>
    ,IIsoXmlSerilizable<FIToFIPaymentCancellationRequestV10>, ISerializeInsideARootElement
{
    ...
    public static FIToFIPaymentCancellationRequestV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentCancellationRequestV10Document : IOuterDocument<FIToFIPaymentCancellationRequestV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentCancellationRequestV10.XmlTag)]
    public required FIToFIPaymentCancellationRequestV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentCancellationRequestV10.XmlTag);
