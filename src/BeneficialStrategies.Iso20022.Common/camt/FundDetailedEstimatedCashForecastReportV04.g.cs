...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.FundDetailedEstimatedCashForecastReportV04>;
...
public partial record FundDetailedEstimatedCashForecastReportV04 : IOuterRecord<FundDetailedEstimatedCashForecastReportV04,FundDetailedEstimatedCashForecastReportV04Document>
    ,IIsoXmlSerilizable<FundDetailedEstimatedCashForecastReportV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FundDetailedEstimatedCashForecastReportV04Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("FndDtldEstmtdCshFcstRpt");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FundOrSubFundDetails is Fund3 FundOrSubFundDetailsValue)
        {
    ...
    public static FundDetailedEstimatedCashForecastReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FundDetailedEstimatedCashForecastReportV04Document : IOuterDocument<FundDetailedEstimatedCashForecastReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FundDetailedEstimatedCashForecastReportV04.XmlTag)]
    public required FundDetailedEstimatedCashForecastReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FundDetailedEstimatedCashForecastReportV04.XmlTag);
