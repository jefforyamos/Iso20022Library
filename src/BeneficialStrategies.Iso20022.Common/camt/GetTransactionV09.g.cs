...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.GetTransactionV09>;
...
public partial record GetTransactionV09 : IOuterRecord<GetTransactionV09,GetTransactionV09Document>
    ,IIsoXmlSerilizable<GetTransactionV09>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionQueryDefinition is TransactionQuery6 TransactionQueryDefinitionValue)
        {
    ...
    public static GetTransactionV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record GetTransactionV09Document : IOuterDocument<GetTransactionV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=GetTransactionV09.XmlTag)]
    public required GetTransactionV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(GetTransactionV09.XmlTag);
