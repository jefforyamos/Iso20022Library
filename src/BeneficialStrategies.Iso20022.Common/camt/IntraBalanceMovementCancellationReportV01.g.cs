...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.IntraBalanceMovementCancellationReportV01>;
...
public partial record IntraBalanceMovementCancellationReportV01 : IOuterRecord<IntraBalanceMovementCancellationReportV01,IntraBalanceMovementCancellationReportV01Document>
    ,IIsoXmlSerilizable<IntraBalanceMovementCancellationReportV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("IntraBalMvmntCxlRpt");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ReportOrError is IntraBalanceOrOperationalError9Choice_ ReportOrErrorValue)
        {
    ...
    public static IntraBalanceMovementCancellationReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraBalanceMovementCancellationReportV01Document : IOuterDocument<IntraBalanceMovementCancellationReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraBalanceMovementCancellationReportV01.XmlTag)]
    public required IntraBalanceMovementCancellationReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraBalanceMovementCancellationReportV01.XmlTag);
