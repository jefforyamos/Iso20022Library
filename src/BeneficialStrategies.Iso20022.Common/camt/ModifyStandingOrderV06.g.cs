...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ModifyStandingOrderV06>;
...
public partial record ModifyStandingOrderV06 : IOuterRecord<ModifyStandingOrderV06,ModifyStandingOrderV06Document>
    ,IIsoXmlSerilizable<ModifyStandingOrderV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ModifyStandingOrderV06Document.DocumentNamespace;
    ...
    public static ModifyStandingOrderV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ModifyStandingOrderV06Document : IOuterDocument<ModifyStandingOrderV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ModifyStandingOrderV06.XmlTag)]
    public required ModifyStandingOrderV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ModifyStandingOrderV06.XmlTag);
