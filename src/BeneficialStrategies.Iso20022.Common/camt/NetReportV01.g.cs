...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.NetReportV01>;
...
public partial record NetReportV01 : IOuterRecord<NetReportV01,NetReportV01Document>
    ,IIsoXmlSerilizable<NetReportV01>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (NetServiceCounterpartyIdentification is PartyIdentification73Choice_ NetServiceCounterpartyIdentificationValue)
        {
    ...
    public static NetReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record NetReportV01Document : IOuterDocument<NetReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=NetReportV01.XmlTag)]
    public required NetReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(NetReportV01.XmlTag);
