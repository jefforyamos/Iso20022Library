...
/// </summary>
[Serializable]
public partial record NotificationToReceiveCancellationAdviceV02Document : IOuterDocument<NotificationToReceiveCancellationAdviceV02>
{
    ...
    #else
    public NotificationToReceiveCancellationAdviceV02 Message { get; init; }
    #endif
}
