...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.NotificationToReceiveCancellationAdviceV03>;
...
public partial record NotificationToReceiveCancellationAdviceV03 : IOuterRecord<NotificationToReceiveCancellationAdviceV03,NotificationToReceiveCancellationAdviceV03Document>
    ,IIsoXmlSerilizable<NotificationToReceiveCancellationAdviceV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => NotificationToReceiveCancellationAdviceV03Document.DocumentNamespace;
    ...
    public static NotificationToReceiveCancellationAdviceV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record NotificationToReceiveCancellationAdviceV03Document : IOuterDocument<NotificationToReceiveCancellationAdviceV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=NotificationToReceiveCancellationAdviceV03.XmlTag)]
    public required NotificationToReceiveCancellationAdviceV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(NotificationToReceiveCancellationAdviceV03.XmlTag);
