...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.NotificationToReceiveCancellationAdviceV06>;
...
public partial record NotificationToReceiveCancellationAdviceV06 : IOuterRecord<NotificationToReceiveCancellationAdviceV06,NotificationToReceiveCancellationAdviceV06Document>
    ,IIsoXmlSerilizable<NotificationToReceiveCancellationAdviceV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => NotificationToReceiveCancellationAdviceV06Document.DocumentNamespace;
    ...
    public static NotificationToReceiveCancellationAdviceV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record NotificationToReceiveCancellationAdviceV06Document : IOuterDocument<NotificationToReceiveCancellationAdviceV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=NotificationToReceiveCancellationAdviceV06.XmlTag)]
    public required NotificationToReceiveCancellationAdviceV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(NotificationToReceiveCancellationAdviceV06.XmlTag);
