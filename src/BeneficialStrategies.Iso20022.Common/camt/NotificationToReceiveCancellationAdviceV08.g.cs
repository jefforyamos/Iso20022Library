...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.NotificationToReceiveCancellationAdviceV08>;
...
public partial record NotificationToReceiveCancellationAdviceV08 : IOuterRecord<NotificationToReceiveCancellationAdviceV08,NotificationToReceiveCancellationAdviceV08Document>
    ,IIsoXmlSerilizable<NotificationToReceiveCancellationAdviceV08>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CancellationReason is NotificationCancellationReason1 CancellationReasonValue)
        {
    ...
    public static NotificationToReceiveCancellationAdviceV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record NotificationToReceiveCancellationAdviceV08Document : IOuterDocument<NotificationToReceiveCancellationAdviceV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=NotificationToReceiveCancellationAdviceV08.XmlTag)]
    public required NotificationToReceiveCancellationAdviceV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(NotificationToReceiveCancellationAdviceV08.XmlTag);
