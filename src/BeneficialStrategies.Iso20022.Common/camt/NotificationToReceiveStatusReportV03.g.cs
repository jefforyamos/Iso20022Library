...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.NotificationToReceiveStatusReportV03>;
...
public partial record NotificationToReceiveStatusReportV03 : IOuterRecord<NotificationToReceiveStatusReportV03,NotificationToReceiveStatusReportV03Document>
    ,IIsoXmlSerilizable<NotificationToReceiveStatusReportV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => NotificationToReceiveStatusReportV03Document.DocumentNamespace;
    ...
    public static NotificationToReceiveStatusReportV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record NotificationToReceiveStatusReportV03Document : IOuterDocument<NotificationToReceiveStatusReportV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=NotificationToReceiveStatusReportV03.XmlTag)]
    public required NotificationToReceiveStatusReportV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(NotificationToReceiveStatusReportV03.XmlTag);
