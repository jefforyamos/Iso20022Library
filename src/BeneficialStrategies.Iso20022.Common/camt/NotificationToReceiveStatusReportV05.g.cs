...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.NotificationToReceiveStatusReportV05>;
...
public partial record NotificationToReceiveStatusReportV05 : IOuterRecord<NotificationToReceiveStatusReportV05,NotificationToReceiveStatusReportV05Document>
    ,IIsoXmlSerilizable<NotificationToReceiveStatusReportV05>, ISerializeInsideARootElement
{
    ...
    public static NotificationToReceiveStatusReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record NotificationToReceiveStatusReportV05Document : IOuterDocument<NotificationToReceiveStatusReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=NotificationToReceiveStatusReportV05.XmlTag)]
    public required NotificationToReceiveStatusReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(NotificationToReceiveStatusReportV05.XmlTag);
