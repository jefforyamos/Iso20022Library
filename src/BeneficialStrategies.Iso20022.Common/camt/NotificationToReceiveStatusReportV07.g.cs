...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.NotificationToReceiveStatusReportV07>;
...
public partial record NotificationToReceiveStatusReportV07 : IOuterRecord<NotificationToReceiveStatusReportV07,NotificationToReceiveStatusReportV07Document>
    ,IIsoXmlSerilizable<NotificationToReceiveStatusReportV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => NotificationToReceiveStatusReportV07Document.DocumentNamespace;
    ...
    public static NotificationToReceiveStatusReportV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record NotificationToReceiveStatusReportV07Document : IOuterDocument<NotificationToReceiveStatusReportV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=NotificationToReceiveStatusReportV07.XmlTag)]
    public required NotificationToReceiveStatusReportV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(NotificationToReceiveStatusReportV07.XmlTag);
