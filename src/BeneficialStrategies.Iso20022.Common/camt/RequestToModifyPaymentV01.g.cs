...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.RequestToModifyPaymentV01>;
...
public partial record RequestToModifyPaymentV01 : IOuterRecord<RequestToModifyPaymentV01,RequestToModifyPaymentV01Document>
    ,IIsoXmlSerilizable<RequestToModifyPaymentV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RequestToModifyPaymentV01Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="RequestToModifyPaymentV01Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public RequestToModifyPaymentV01Document ToDocument()
    {
        return new RequestToModifyPaymentV01Document { Message = this };
    }
    ...
    public static RequestToModifyPaymentV01 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="RequestToModifyPaymentV01"/>.
/// </summary>
[Serializable]
public partial record RequestToModifyPaymentV01Document : IOuterDocument<RequestToModifyPaymentV01>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="RequestToModifyPaymentV01"/> is required.
    /// </summary>
    [DataMember(Name=RequestToModifyPaymentV01.XmlTag)]
    public required RequestToModifyPaymentV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RequestToModifyPaymentV01.XmlTag);
