...
//
// Generated by MainMessageGenerator for RequestToModifyPaymentV02.  ISO2002 ID# _wQzatxPeEeSVo-TFVwFHvA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.RequestToModifyPaymentV02>;
...
public partial record RequestToModifyPaymentV02 : IOuterRecord<RequestToModifyPaymentV02,RequestToModifyPaymentV02Document>
    ,IIsoXmlSerilizable<RequestToModifyPaymentV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RequestToModifyPaymentV02Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="RequestToModifyPaymentV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public RequestToModifyPaymentV02Document ToDocument()
    {
        return new RequestToModifyPaymentV02Document { Message = this };
    }
    ...
    public static RequestToModifyPaymentV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="RequestToModifyPaymentV02"/>.
/// </summary>
[Serializable]
public partial record RequestToModifyPaymentV02Document : IOuterDocument<RequestToModifyPaymentV02>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="RequestToModifyPaymentV02"/> is required.
    /// </summary>
    [DataMember(Name=RequestToModifyPaymentV02.XmlTag)]
    public required RequestToModifyPaymentV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RequestToModifyPaymentV02.XmlTag);
