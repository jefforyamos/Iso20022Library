...
//
// Generated by MainMessageGenerator for RequestToModifyPaymentV03.  ISO2002 ID# _pmmdtzqxEeWZFYSPlduMhw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.RequestToModifyPaymentV03>;
...
public partial record RequestToModifyPaymentV03 : IOuterRecord<RequestToModifyPaymentV03,RequestToModifyPaymentV03Document>
    ,IIsoXmlSerilizable<RequestToModifyPaymentV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RequestToModifyPaymentV03Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="RequestToModifyPaymentV03Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public RequestToModifyPaymentV03Document ToDocument()
    {
        return new RequestToModifyPaymentV03Document { Message = this };
    }
    ...
    public static RequestToModifyPaymentV03 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="RequestToModifyPaymentV03"/>.
/// </summary>
[Serializable]
public partial record RequestToModifyPaymentV03Document : IOuterDocument<RequestToModifyPaymentV03>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="RequestToModifyPaymentV03"/> is required.
    /// </summary>
    [DataMember(Name=RequestToModifyPaymentV03.XmlTag)]
    public required RequestToModifyPaymentV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RequestToModifyPaymentV03.XmlTag);
