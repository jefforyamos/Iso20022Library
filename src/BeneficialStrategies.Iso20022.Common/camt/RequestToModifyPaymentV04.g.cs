...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.RequestToModifyPaymentV04>;
...
public partial record RequestToModifyPaymentV04 : IOuterRecord<RequestToModifyPaymentV04,RequestToModifyPaymentV04Document>
    ,IIsoXmlSerilizable<RequestToModifyPaymentV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RequestToModifyPaymentV04Document.DocumentNamespace;
    ...
    public static RequestToModifyPaymentV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RequestToModifyPaymentV04Document : IOuterDocument<RequestToModifyPaymentV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RequestToModifyPaymentV04.XmlTag)]
    public required RequestToModifyPaymentV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RequestToModifyPaymentV04.XmlTag);
