...
//
// Generated by MainMessageGenerator for RequestToModifyPaymentV06.  ISO2002 ID# _eYI_m22PEei3KuUgpx7Xcw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.RequestToModifyPaymentV06>;
...
public partial record RequestToModifyPaymentV06 : IOuterRecord<RequestToModifyPaymentV06,RequestToModifyPaymentV06Document>
    ,IIsoXmlSerilizable<RequestToModifyPaymentV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RequestToModifyPaymentV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="RequestToModifyPaymentV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public RequestToModifyPaymentV06Document ToDocument()
    {
        return new RequestToModifyPaymentV06Document { Message = this };
    }
    ...
    public static RequestToModifyPaymentV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="RequestToModifyPaymentV06"/>.
/// </summary>
[Serializable]
public partial record RequestToModifyPaymentV06Document : IOuterDocument<RequestToModifyPaymentV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="RequestToModifyPaymentV06"/> is required.
    /// </summary>
    [DataMember(Name=RequestToModifyPaymentV06.XmlTag)]
    public required RequestToModifyPaymentV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RequestToModifyPaymentV06.XmlTag);
