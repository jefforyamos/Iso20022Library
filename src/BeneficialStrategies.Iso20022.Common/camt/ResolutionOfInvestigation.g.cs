...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigation>;
...
public partial record ResolutionOfInvestigation : IOuterRecord<ResolutionOfInvestigation,ResolutionOfInvestigationDocument>
    ,IIsoXmlSerilizable<ResolutionOfInvestigation>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("camt.029.001.01");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        ResolvedCase.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
        if (Status is InvestigationStatusChoice_ StatusValue)
        {
            writer.WriteStartElement(null, "Sts", xmlNamespace );
            StatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorrectionTransaction is PaymentInstructionExtract CorrectionTransactionValue)
        {
    ...
    public static ResolutionOfInvestigation Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationDocument : IOuterDocument<ResolutionOfInvestigation>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigation.XmlTag)]
    public required ResolutionOfInvestigation Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigation.XmlTag);
