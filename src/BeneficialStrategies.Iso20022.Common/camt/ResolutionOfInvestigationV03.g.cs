...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigationV03>;
...
public partial record ResolutionOfInvestigationV03 : IOuterRecord<ResolutionOfInvestigationV03,ResolutionOfInvestigationV03Document>
    ,IIsoXmlSerilizable<ResolutionOfInvestigationV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CancellationDetails is UnderlyingTransaction3 CancellationDetailsValue)
        {
            writer.WriteStartElement(null, "CxlDtls", xmlNamespace );
            CancellationDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatementDetails is StatementResolutionEntry1 StatementDetailsValue)
        {
    ...
    public static ResolutionOfInvestigationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV03Document : IOuterDocument<ResolutionOfInvestigationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigationV03.XmlTag)]
    public required ResolutionOfInvestigationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigationV03.XmlTag);
