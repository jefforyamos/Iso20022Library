...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigationV04>;
...
public partial record ResolutionOfInvestigationV04 : IOuterRecord<ResolutionOfInvestigationV04,ResolutionOfInvestigationV04Document>
    ,IIsoXmlSerilizable<ResolutionOfInvestigationV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CancellationDetails is UnderlyingTransaction4 CancellationDetailsValue)
        {
            writer.WriteStartElement(null, "CxlDtls", xmlNamespace );
            CancellationDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatementDetails is StatementResolutionEntry2 StatementDetailsValue)
        {
            writer.WriteStartElement(null, "StmtDtls", xmlNamespace );
            StatementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorrectionTransaction is CorrectiveTransaction1Choice_ CorrectionTransactionValue)
        {
    ...
    public static ResolutionOfInvestigationV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV04Document : IOuterDocument<ResolutionOfInvestigationV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigationV04.XmlTag)]
    public required ResolutionOfInvestigationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigationV04.XmlTag);
