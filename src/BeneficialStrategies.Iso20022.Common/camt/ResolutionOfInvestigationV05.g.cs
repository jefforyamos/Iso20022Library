...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigationV05>;
...
public partial record ResolutionOfInvestigationV05 : IOuterRecord<ResolutionOfInvestigationV05,ResolutionOfInvestigationV05Document>
    ,IIsoXmlSerilizable<ResolutionOfInvestigationV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ResolutionOfInvestigationV05Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CancellationDetails is UnderlyingTransaction9 CancellationDetailsValue)
        {
    ...
    public static ResolutionOfInvestigationV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV05Document : IOuterDocument<ResolutionOfInvestigationV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigationV05.XmlTag)]
    public required ResolutionOfInvestigationV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigationV05.XmlTag);
