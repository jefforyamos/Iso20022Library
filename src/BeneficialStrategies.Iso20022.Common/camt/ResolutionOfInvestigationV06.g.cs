...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigationV06>;
...
public partial record ResolutionOfInvestigationV06 : IOuterRecord<ResolutionOfInvestigationV06,ResolutionOfInvestigationV06Document>
    ,IIsoXmlSerilizable<ResolutionOfInvestigationV06>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CancellationDetails is UnderlyingTransaction14 CancellationDetailsValue)
        {
    ...
    public static ResolutionOfInvestigationV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV06Document : IOuterDocument<ResolutionOfInvestigationV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigationV06.XmlTag)]
    public required ResolutionOfInvestigationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigationV06.XmlTag);
