...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigationV07>;
...
public partial record ResolutionOfInvestigationV07 : IOuterRecord<ResolutionOfInvestigationV07,ResolutionOfInvestigationV07Document>
    ,IIsoXmlSerilizable<ResolutionOfInvestigationV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ResolutionOfInvestigationV07Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CancellationDetails is UnderlyingTransaction17 CancellationDetailsValue)
        {
        ...
        if (CorrectionTransaction is CorrectiveTransaction2Choice_ CorrectionTransactionValue)
        {
    ...
    public static ResolutionOfInvestigationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV07Document : IOuterDocument<ResolutionOfInvestigationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigationV07.XmlTag)]
    public required ResolutionOfInvestigationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigationV07.XmlTag);
