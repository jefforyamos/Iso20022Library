...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigationV08>;
...
public partial record ResolutionOfInvestigationV08 : IOuterRecord<ResolutionOfInvestigationV08,ResolutionOfInvestigationV08Document>
    ,IIsoXmlSerilizable<ResolutionOfInvestigationV08>, ISerializeInsideARootElement
{
    ...
    public static ResolutionOfInvestigationV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV08Document : IOuterDocument<ResolutionOfInvestigationV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigationV08.XmlTag)]
    public required ResolutionOfInvestigationV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigationV08.XmlTag);
