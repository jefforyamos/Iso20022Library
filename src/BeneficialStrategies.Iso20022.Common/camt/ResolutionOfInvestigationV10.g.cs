...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV10Document : IOuterDocument<ResolutionOfInvestigationV10>
{
    ...
    #else
    public ResolutionOfInvestigationV10 Message { get; init; }
    #endif
}
