...
//
// Generated by MainMessageGenerator for ResolutionOfInvestigationV10.  ISO2002 ID# _LwBa9cP_Eemsic1bQcEtLA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigationV10>;
...
public partial record ResolutionOfInvestigationV10 : IOuterRecord<ResolutionOfInvestigationV10,ResolutionOfInvestigationV10Document>
    ,IIsoXmlSerilizable<ResolutionOfInvestigationV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ResolutionOfInvestigationV10Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="ResolutionOfInvestigationV10Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public ResolutionOfInvestigationV10Document ToDocument()
    {
        return new ResolutionOfInvestigationV10Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CancellationDetails is UnderlyingTransaction25 CancellationDetailsValue)
        {
            writer.WriteStartElement(null, "CxlDtls", xmlNamespace );
            CancellationDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ModificationDetails is PaymentTransaction116 ModificationDetailsValue)
        {
        ...
        if (ResolutionRelatedInformation is ResolutionData2 ResolutionRelatedInformationValue)
        {
    ...
    public static ResolutionOfInvestigationV10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="ResolutionOfInvestigationV10"/>.
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV10Document : IOuterDocument<ResolutionOfInvestigationV10>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="ResolutionOfInvestigationV10"/> is required.
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigationV10.XmlTag)]
    public required ResolutionOfInvestigationV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigationV10.XmlTag);
