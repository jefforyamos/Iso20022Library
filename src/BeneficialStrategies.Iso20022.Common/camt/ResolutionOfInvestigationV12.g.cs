...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ResolutionOfInvestigationV12>;
...
public partial record ResolutionOfInvestigationV12 : IOuterRecord<ResolutionOfInvestigationV12,ResolutionOfInvestigationV12Document>
    ,IIsoXmlSerilizable<ResolutionOfInvestigationV12>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CancellationDetails is UnderlyingTransaction31 CancellationDetailsValue)
        {
            writer.WriteStartElement(null, "CxlDtls", xmlNamespace );
            CancellationDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ModificationDetails is PaymentTransaction147 ModificationDetailsValue)
        {
    ...
    public static ResolutionOfInvestigationV12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ResolutionOfInvestigationV12Document : IOuterDocument<ResolutionOfInvestigationV12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ResolutionOfInvestigationV12.XmlTag)]
    public required ResolutionOfInvestigationV12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ResolutionOfInvestigationV12.XmlTag);
