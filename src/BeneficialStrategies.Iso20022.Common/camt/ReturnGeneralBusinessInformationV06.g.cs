...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ReturnGeneralBusinessInformationV06>;
...
public partial record ReturnGeneralBusinessInformationV06 : IOuterRecord<ReturnGeneralBusinessInformationV06,ReturnGeneralBusinessInformationV06Document>
    ,IIsoXmlSerilizable<ReturnGeneralBusinessInformationV06>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("RtrGnlBizInf");
    ...
    public static ReturnGeneralBusinessInformationV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ReturnGeneralBusinessInformationV06Document : IOuterDocument<ReturnGeneralBusinessInformationV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ReturnGeneralBusinessInformationV06.XmlTag)]
    public required ReturnGeneralBusinessInformationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ReturnGeneralBusinessInformationV06.XmlTag);
