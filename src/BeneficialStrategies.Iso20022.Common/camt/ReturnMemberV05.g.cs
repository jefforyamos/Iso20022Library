...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ReturnMemberV05>;
...
public partial record ReturnMemberV05 : IOuterRecord<ReturnMemberV05,ReturnMemberV05Document>
    ,IIsoXmlSerilizable<ReturnMemberV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ReturnMemberV05Document.DocumentNamespace;
    ...
    [Description(@"Reports on members.")]
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="ReturnMemberV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public ReturnMemberV05Document ToDocument()
    {
        return new ReturnMemberV05Document { Message = this };
    }
    public static XName RootElement => Helper.CreateXName("RtrMmb");
    ...
    public static ReturnMemberV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="ReturnMemberV05"/>.
/// </summary>
[Serializable]
public partial record ReturnMemberV05Document : IOuterDocument<ReturnMemberV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="ReturnMemberV05"/> is required.
    /// </summary>
    [DataMember(Name=ReturnMemberV05.XmlTag)]
    public required ReturnMemberV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ReturnMemberV05.XmlTag);
