...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.ReturnTransactionV10>;
...
public partial record ReturnTransactionV10 : IOuterRecord<ReturnTransactionV10,ReturnTransactionV10Document>
    ,IIsoXmlSerilizable<ReturnTransactionV10>, ISerializeInsideARootElement
{
    ...
    public static ReturnTransactionV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ReturnTransactionV10Document : IOuterDocument<ReturnTransactionV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ReturnTransactionV10.XmlTag)]
    public required ReturnTransactionV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ReturnTransactionV10.XmlTag);
