...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.UnableToApplyV08>;
...
public partial record UnableToApplyV08 : IOuterRecord<UnableToApplyV08,UnableToApplyV08Document>
    ,IIsoXmlSerilizable<UnableToApplyV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => UnableToApplyV08Document.DocumentNamespace;
    ...
    public static UnableToApplyV08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="UnableToApplyV08"/>.
/// </summary>
[Serializable]
public partial record UnableToApplyV08Document : IOuterDocument<UnableToApplyV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=UnableToApplyV08.XmlTag)]
    public required UnableToApplyV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(UnableToApplyV08.XmlTag);
