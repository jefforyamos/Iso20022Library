...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.camt.UnableToApplyV09>;
...
public partial record UnableToApplyV09 : IOuterRecord<UnableToApplyV09,UnableToApplyV09Document>
    ,IIsoXmlSerilizable<UnableToApplyV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => UnableToApplyV09Document.DocumentNamespace;
    ...
    public static UnableToApplyV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record UnableToApplyV09Document : IOuterDocument<UnableToApplyV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=UnableToApplyV09.XmlTag)]
    public required UnableToApplyV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(UnableToApplyV09.XmlTag);
