...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.casp.SaleToPOIAbortV05>;
...
public partial record SaleToPOIAbortV05 : IOuterRecord<SaleToPOIAbortV05,SaleToPOIAbortV05Document>
    ,IIsoXmlSerilizable<SaleToPOIAbortV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SaleToPOIAbortV05Document.DocumentNamespace;
    ...
    public static SaleToPOIAbortV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SaleToPOIAbortV05Document : IOuterDocument<SaleToPOIAbortV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SaleToPOIAbortV05.XmlTag)]
    public required SaleToPOIAbortV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SaleToPOIAbortV05.XmlTag);
