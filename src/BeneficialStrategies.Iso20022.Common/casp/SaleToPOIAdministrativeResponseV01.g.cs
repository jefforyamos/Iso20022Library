...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.casp.SaleToPOIAdministrativeResponseV01>;
...
public partial record SaleToPOIAdministrativeResponseV01 : IOuterRecord<SaleToPOIAdministrativeResponseV01,SaleToPOIAdministrativeResponseV01Document>
    ,IIsoXmlSerilizable<SaleToPOIAdministrativeResponseV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SaleToPOIAdministrativeResponseV01Document.DocumentNamespace;
    ...
    public static SaleToPOIAdministrativeResponseV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SaleToPOIAdministrativeResponseV01Document : IOuterDocument<SaleToPOIAdministrativeResponseV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SaleToPOIAdministrativeResponseV01.XmlTag)]
    public required SaleToPOIAdministrativeResponseV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SaleToPOIAdministrativeResponseV01.XmlTag);
