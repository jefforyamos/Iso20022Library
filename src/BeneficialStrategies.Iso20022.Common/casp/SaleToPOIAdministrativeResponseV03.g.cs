...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.casp.SaleToPOIAdministrativeResponseV03>;
...
public partial record SaleToPOIAdministrativeResponseV03 : IOuterRecord<SaleToPOIAdministrativeResponseV03,SaleToPOIAdministrativeResponseV03Document>
    ,IIsoXmlSerilizable<SaleToPOIAdministrativeResponseV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SaleToPOIAdministrativeResponseV03Document.DocumentNamespace;
    ...
    public static SaleToPOIAdministrativeResponseV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SaleToPOIAdministrativeResponseV03Document : IOuterDocument<SaleToPOIAdministrativeResponseV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SaleToPOIAdministrativeResponseV03.XmlTag)]
    public required SaleToPOIAdministrativeResponseV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SaleToPOIAdministrativeResponseV03.XmlTag);
