...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.casp.SaleToPOIAdministrativeResponseV05>;
...
public partial record SaleToPOIAdministrativeResponseV05 : IOuterRecord<SaleToPOIAdministrativeResponseV05,SaleToPOIAdministrativeResponseV05Document>
    ,IIsoXmlSerilizable<SaleToPOIAdministrativeResponseV05>, ISerializeInsideARootElement
{
    ...
    public static SaleToPOIAdministrativeResponseV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SaleToPOIAdministrativeResponseV05Document : IOuterDocument<SaleToPOIAdministrativeResponseV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SaleToPOIAdministrativeResponseV05.XmlTag)]
    public required SaleToPOIAdministrativeResponseV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SaleToPOIAdministrativeResponseV05.XmlTag);
