...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.casp.SaleToPOIEventNotificationV05>;
...
public partial record SaleToPOIEventNotificationV05 : IOuterRecord<SaleToPOIEventNotificationV05,SaleToPOIEventNotificationV05Document>
    ,IIsoXmlSerilizable<SaleToPOIEventNotificationV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SaleToPOIEventNotificationV05Document.DocumentNamespace;
    ...
    public static SaleToPOIEventNotificationV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SaleToPOIEventNotificationV05Document : IOuterDocument<SaleToPOIEventNotificationV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SaleToPOIEventNotificationV05.XmlTag)]
    public required SaleToPOIEventNotificationV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SaleToPOIEventNotificationV05.XmlTag);
