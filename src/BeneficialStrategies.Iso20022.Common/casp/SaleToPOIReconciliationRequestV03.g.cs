...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.casp.SaleToPOIReconciliationRequestV03>;
...
public partial record SaleToPOIReconciliationRequestV03 : IOuterRecord<SaleToPOIReconciliationRequestV03,SaleToPOIReconciliationRequestV03Document>
    ,IIsoXmlSerilizable<SaleToPOIReconciliationRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SaleToPOIReconciliationRequestV03Document.DocumentNamespace;
    ...
    public static SaleToPOIReconciliationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SaleToPOIReconciliationRequestV03Document : IOuterDocument<SaleToPOIReconciliationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SaleToPOIReconciliationRequestV03.XmlTag)]
    public required SaleToPOIReconciliationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SaleToPOIReconciliationRequestV03.XmlTag);
