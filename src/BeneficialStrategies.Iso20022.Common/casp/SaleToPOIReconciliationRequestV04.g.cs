...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.casp.SaleToPOIReconciliationRequestV04>;
...
public partial record SaleToPOIReconciliationRequestV04 : IOuterRecord<SaleToPOIReconciliationRequestV04,SaleToPOIReconciliationRequestV04Document>
    ,IIsoXmlSerilizable<SaleToPOIReconciliationRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SaleToPOIReconciliationRequestV04Document.DocumentNamespace;
    ...
    public static SaleToPOIReconciliationRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SaleToPOIReconciliationRequestV04Document : IOuterDocument<SaleToPOIReconciliationRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SaleToPOIReconciliationRequestV04.XmlTag)]
    public required SaleToPOIReconciliationRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SaleToPOIReconciliationRequestV04.XmlTag);
