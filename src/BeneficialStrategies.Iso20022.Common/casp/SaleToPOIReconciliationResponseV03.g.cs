...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.casp.SaleToPOIReconciliationResponseV03>;
...
public partial record SaleToPOIReconciliationResponseV03 : IOuterRecord<SaleToPOIReconciliationResponseV03,SaleToPOIReconciliationResponseV03Document>
    ,IIsoXmlSerilizable<SaleToPOIReconciliationResponseV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SaleToPOIReconciliationResponseV03Document.DocumentNamespace;
    ...
    public static SaleToPOIReconciliationResponseV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SaleToPOIReconciliationResponseV03Document : IOuterDocument<SaleToPOIReconciliationResponseV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SaleToPOIReconciliationResponseV03.XmlTag)]
    public required SaleToPOIReconciliationResponseV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SaleToPOIReconciliationResponseV03.XmlTag);
