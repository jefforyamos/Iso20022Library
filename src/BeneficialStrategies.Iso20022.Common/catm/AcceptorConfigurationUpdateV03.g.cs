...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.AcceptorConfigurationUpdateV03>;
...
public partial record AcceptorConfigurationUpdateV03 : IOuterRecord<AcceptorConfigurationUpdateV03,AcceptorConfigurationUpdateV03Document>
    ,IIsoXmlSerilizable<AcceptorConfigurationUpdateV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorConfigurationUpdateV03Document.DocumentNamespace;
    ...
    public static AcceptorConfigurationUpdateV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorConfigurationUpdateV03Document : IOuterDocument<AcceptorConfigurationUpdateV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorConfigurationUpdateV03.XmlTag)]
    public required AcceptorConfigurationUpdateV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorConfigurationUpdateV03.XmlTag);
