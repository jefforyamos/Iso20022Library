...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.AcceptorConfigurationUpdateV08>;
...
public partial record AcceptorConfigurationUpdateV08 : IOuterRecord<AcceptorConfigurationUpdateV08,AcceptorConfigurationUpdateV08Document>
    ,IIsoXmlSerilizable<AcceptorConfigurationUpdateV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorConfigurationUpdateV08Document.DocumentNamespace;
    ...
    public static AcceptorConfigurationUpdateV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorConfigurationUpdateV08Document : IOuterDocument<AcceptorConfigurationUpdateV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorConfigurationUpdateV08.XmlTag)]
    public required AcceptorConfigurationUpdateV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorConfigurationUpdateV08.XmlTag);
