...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.AcceptorConfigurationUpdateV09>;
...
public partial record AcceptorConfigurationUpdateV09 : IOuterRecord<AcceptorConfigurationUpdateV09,AcceptorConfigurationUpdateV09Document>
    ,IIsoXmlSerilizable<AcceptorConfigurationUpdateV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorConfigurationUpdateV09Document.DocumentNamespace;
    ...
    public static AcceptorConfigurationUpdateV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorConfigurationUpdateV09Document : IOuterDocument<AcceptorConfigurationUpdateV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorConfigurationUpdateV09.XmlTag)]
    public required AcceptorConfigurationUpdateV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorConfigurationUpdateV09.XmlTag);
