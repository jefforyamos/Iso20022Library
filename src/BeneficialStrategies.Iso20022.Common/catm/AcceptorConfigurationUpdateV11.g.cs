...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.AcceptorConfigurationUpdateV11>;
...
public partial record AcceptorConfigurationUpdateV11 : IOuterRecord<AcceptorConfigurationUpdateV11,AcceptorConfigurationUpdateV11Document>
    ,IIsoXmlSerilizable<AcceptorConfigurationUpdateV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AcceptorConfigurationUpdateV11Document.DocumentNamespace;
    ...
    public static AcceptorConfigurationUpdateV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AcceptorConfigurationUpdateV11Document : IOuterDocument<AcceptorConfigurationUpdateV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AcceptorConfigurationUpdateV11.XmlTag)]
    public required AcceptorConfigurationUpdateV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AcceptorConfigurationUpdateV11.XmlTag);
