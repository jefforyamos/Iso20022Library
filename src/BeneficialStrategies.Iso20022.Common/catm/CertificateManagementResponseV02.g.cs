...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.CertificateManagementResponseV02>;
...
public partial record CertificateManagementResponseV02 : IOuterRecord<CertificateManagementResponseV02,CertificateManagementResponseV02Document>
    ,IIsoXmlSerilizable<CertificateManagementResponseV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CertificateManagementResponseV02Document.DocumentNamespace;
    ...
    public static CertificateManagementResponseV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CertificateManagementResponseV02Document : IOuterDocument<CertificateManagementResponseV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CertificateManagementResponseV02.XmlTag)]
    public required CertificateManagementResponseV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CertificateManagementResponseV02.XmlTag);
