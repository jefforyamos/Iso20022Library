...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.CertificateManagementResponseV03>;
...
public partial record CertificateManagementResponseV03 : IOuterRecord<CertificateManagementResponseV03,CertificateManagementResponseV03Document>
    ,IIsoXmlSerilizable<CertificateManagementResponseV03>, ISerializeInsideARootElement
{
    ...
    public static CertificateManagementResponseV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CertificateManagementResponseV03Document : IOuterDocument<CertificateManagementResponseV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CertificateManagementResponseV03.XmlTag)]
    public required CertificateManagementResponseV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CertificateManagementResponseV03.XmlTag);
