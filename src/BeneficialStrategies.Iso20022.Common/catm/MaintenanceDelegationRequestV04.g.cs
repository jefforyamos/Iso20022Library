...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.MaintenanceDelegationRequestV04>;
...
public partial record MaintenanceDelegationRequestV04 : IOuterRecord<MaintenanceDelegationRequestV04,MaintenanceDelegationRequestV04Document>
    ,IIsoXmlSerilizable<MaintenanceDelegationRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MaintenanceDelegationRequestV04Document.DocumentNamespace;
    ...
    public static MaintenanceDelegationRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MaintenanceDelegationRequestV04Document : IOuterDocument<MaintenanceDelegationRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MaintenanceDelegationRequestV04.XmlTag)]
    public required MaintenanceDelegationRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MaintenanceDelegationRequestV04.XmlTag);
