...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.MaintenanceDelegationRequestV05>;
...
public partial record MaintenanceDelegationRequestV05 : IOuterRecord<MaintenanceDelegationRequestV05,MaintenanceDelegationRequestV05Document>
    ,IIsoXmlSerilizable<MaintenanceDelegationRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MaintenanceDelegationRequestV05Document.DocumentNamespace;
    ...
    public static MaintenanceDelegationRequestV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="MaintenanceDelegationRequestV05"/>.
/// </summary>
[Serializable]
public partial record MaintenanceDelegationRequestV05Document : IOuterDocument<MaintenanceDelegationRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MaintenanceDelegationRequestV05.XmlTag)]
    public required MaintenanceDelegationRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MaintenanceDelegationRequestV05.XmlTag);
