...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.MaintenanceDelegationResponseV02>;
...
public partial record MaintenanceDelegationResponseV02 : IOuterRecord<MaintenanceDelegationResponseV02,MaintenanceDelegationResponseV02Document>
    ,IIsoXmlSerilizable<MaintenanceDelegationResponseV02>, ISerializeInsideARootElement
{
    ...
    public static MaintenanceDelegationResponseV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MaintenanceDelegationResponseV02Document : IOuterDocument<MaintenanceDelegationResponseV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MaintenanceDelegationResponseV02.XmlTag)]
    public required MaintenanceDelegationResponseV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MaintenanceDelegationResponseV02.XmlTag);
