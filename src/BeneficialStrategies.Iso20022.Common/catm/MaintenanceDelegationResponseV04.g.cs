...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.MaintenanceDelegationResponseV04>;
...
public partial record MaintenanceDelegationResponseV04 : IOuterRecord<MaintenanceDelegationResponseV04,MaintenanceDelegationResponseV04Document>
    ,IIsoXmlSerilizable<MaintenanceDelegationResponseV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MaintenanceDelegationResponseV04Document.DocumentNamespace;
    ...
    public static MaintenanceDelegationResponseV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MaintenanceDelegationResponseV04Document : IOuterDocument<MaintenanceDelegationResponseV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MaintenanceDelegationResponseV04.XmlTag)]
    public required MaintenanceDelegationResponseV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MaintenanceDelegationResponseV04.XmlTag);
