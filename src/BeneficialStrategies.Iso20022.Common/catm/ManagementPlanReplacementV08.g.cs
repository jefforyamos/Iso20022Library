...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.ManagementPlanReplacementV08>;
...
public partial record ManagementPlanReplacementV08 : IOuterRecord<ManagementPlanReplacementV08,ManagementPlanReplacementV08Document>
    ,IIsoXmlSerilizable<ManagementPlanReplacementV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ManagementPlanReplacementV08Document.DocumentNamespace;
    ...
    public static ManagementPlanReplacementV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ManagementPlanReplacementV08Document : IOuterDocument<ManagementPlanReplacementV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ManagementPlanReplacementV08.XmlTag)]
    public required ManagementPlanReplacementV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ManagementPlanReplacementV08.XmlTag);
