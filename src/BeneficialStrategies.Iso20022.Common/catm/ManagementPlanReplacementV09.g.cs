...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.ManagementPlanReplacementV09>;
...
public partial record ManagementPlanReplacementV09 : IOuterRecord<ManagementPlanReplacementV09,ManagementPlanReplacementV09Document>
    ,IIsoXmlSerilizable<ManagementPlanReplacementV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ManagementPlanReplacementV09Document.DocumentNamespace;
    ...
    public static ManagementPlanReplacementV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ManagementPlanReplacementV09Document : IOuterDocument<ManagementPlanReplacementV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ManagementPlanReplacementV09.XmlTag)]
    public required ManagementPlanReplacementV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ManagementPlanReplacementV09.XmlTag);
