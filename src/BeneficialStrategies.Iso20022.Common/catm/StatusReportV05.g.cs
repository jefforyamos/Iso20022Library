...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.StatusReportV05>;
...
public partial record StatusReportV05 : IOuterRecord<StatusReportV05,StatusReportV05Document>
    ,IIsoXmlSerilizable<StatusReportV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => StatusReportV05Document.DocumentNamespace;
    ...
    public static StatusReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record StatusReportV05Document : IOuterDocument<StatusReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=StatusReportV05.XmlTag)]
    public required StatusReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(StatusReportV05.XmlTag);
