...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catm.StatusReportV12>;
...
public partial record StatusReportV12 : IOuterRecord<StatusReportV12,StatusReportV12Document>
    ,IIsoXmlSerilizable<StatusReportV12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => StatusReportV12Document.DocumentNamespace;
    ...
    public static StatusReportV12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record StatusReportV12Document : IOuterDocument<StatusReportV12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=StatusReportV12.XmlTag)]
    public required StatusReportV12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(StatusReportV12.XmlTag);
