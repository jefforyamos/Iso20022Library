...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catp.ATMCompletionAcknowledgementV01>;
...
public partial record ATMCompletionAcknowledgementV01 : IOuterRecord<ATMCompletionAcknowledgementV01,ATMCompletionAcknowledgementV01Document>
    ,IIsoXmlSerilizable<ATMCompletionAcknowledgementV01>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMCompletionAcknowledgement is ATMCompletionAcknowledgement1 ATMCompletionAcknowledgementValue)
        {
    ...
    public static ATMCompletionAcknowledgementV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMCompletionAcknowledgementV01Document : IOuterDocument<ATMCompletionAcknowledgementV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMCompletionAcknowledgementV01.XmlTag)]
    public required ATMCompletionAcknowledgementV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMCompletionAcknowledgementV01.XmlTag);
