...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catp.ATMInquiryRequestV02>;
...
public partial record ATMInquiryRequestV02 : IOuterRecord<ATMInquiryRequestV02,ATMInquiryRequestV02Document>
    ,IIsoXmlSerilizable<ATMInquiryRequestV02>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMInquiryRequest is ATMInquiryRequest2 ATMInquiryRequestValue)
        {
    ...
    public static ATMInquiryRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMInquiryRequestV02Document : IOuterDocument<ATMInquiryRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMInquiryRequestV02.XmlTag)]
    public required ATMInquiryRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMInquiryRequestV02.XmlTag);
