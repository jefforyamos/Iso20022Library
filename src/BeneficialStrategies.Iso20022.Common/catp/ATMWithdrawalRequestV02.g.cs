...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catp.ATMWithdrawalRequestV02>;
...
public partial record ATMWithdrawalRequestV02 : IOuterRecord<ATMWithdrawalRequestV02,ATMWithdrawalRequestV02Document>
    ,IIsoXmlSerilizable<ATMWithdrawalRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ATMWithdrawalRequestV02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMWithdrawalRequest is ATMWithdrawalRequest2 ATMWithdrawalRequestValue)
        {
    ...
    public static ATMWithdrawalRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMWithdrawalRequestV02Document : IOuterDocument<ATMWithdrawalRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMWithdrawalRequestV02.XmlTag)]
    public required ATMWithdrawalRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMWithdrawalRequestV02.XmlTag);
