...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.catp.ATMWithdrawalResponseV01>;
...
public partial record ATMWithdrawalResponseV01 : IOuterRecord<ATMWithdrawalResponseV01,ATMWithdrawalResponseV01Document>
    ,IIsoXmlSerilizable<ATMWithdrawalResponseV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ATMWithdrawalResponseV01Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ATMWithdrawalResponse is ATMWithdrawalResponse1 ATMWithdrawalResponseValue)
        {
    ...
    public static ATMWithdrawalResponseV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ATMWithdrawalResponseV01Document : IOuterDocument<ATMWithdrawalResponseV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ATMWithdrawalResponseV01.XmlTag)]
    public required ATMWithdrawalResponseV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ATMWithdrawalResponseV01.XmlTag);
