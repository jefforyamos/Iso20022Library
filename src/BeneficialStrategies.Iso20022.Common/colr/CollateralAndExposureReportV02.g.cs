...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.CollateralAndExposureReportV02>;
...
public partial record CollateralAndExposureReportV02 : IOuterRecord<CollateralAndExposureReportV02,CollateralAndExposureReportV02Document>
    ,IIsoXmlSerilizable<CollateralAndExposureReportV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CollateralAndExposureReportV02Document.DocumentNamespace;
    ...
    public static CollateralAndExposureReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CollateralAndExposureReportV02Document : IOuterDocument<CollateralAndExposureReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CollateralAndExposureReportV02.XmlTag)]
    public required CollateralAndExposureReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CollateralAndExposureReportV02.XmlTag);
