...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.CollateralManagementCancellationRequestV06>;
...
public partial record CollateralManagementCancellationRequestV06 : IOuterRecord<CollateralManagementCancellationRequestV06,CollateralManagementCancellationRequestV06Document>
    ,IIsoXmlSerilizable<CollateralManagementCancellationRequestV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CollateralManagementCancellationRequestV06Document.DocumentNamespace;
    ...
    public static CollateralManagementCancellationRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CollateralManagementCancellationRequestV06Document : IOuterDocument<CollateralManagementCancellationRequestV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CollateralManagementCancellationRequestV06.XmlTag)]
    public required CollateralManagementCancellationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CollateralManagementCancellationRequestV06.XmlTag);
