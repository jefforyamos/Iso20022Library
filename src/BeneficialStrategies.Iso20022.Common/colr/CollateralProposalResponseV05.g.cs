...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.CollateralProposalResponseV05>;
...
public partial record CollateralProposalResponseV05 : IOuterRecord<CollateralProposalResponseV05,CollateralProposalResponseV05Document>
    ,IIsoXmlSerilizable<CollateralProposalResponseV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CollateralProposalResponseV05Document.DocumentNamespace;
    ...
    public static CollateralProposalResponseV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CollateralProposalResponseV05Document : IOuterDocument<CollateralProposalResponseV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CollateralProposalResponseV05.XmlTag)]
    public required CollateralProposalResponseV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CollateralProposalResponseV05.XmlTag);
