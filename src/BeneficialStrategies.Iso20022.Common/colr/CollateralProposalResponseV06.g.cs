...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.CollateralProposalResponseV06>;
...
public partial record CollateralProposalResponseV06 : IOuterRecord<CollateralProposalResponseV06,CollateralProposalResponseV06Document>
    ,IIsoXmlSerilizable<CollateralProposalResponseV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CollateralProposalResponseV06Document.DocumentNamespace;
    ...
    public static CollateralProposalResponseV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CollateralProposalResponseV06Document : IOuterDocument<CollateralProposalResponseV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CollateralProposalResponseV06.XmlTag)]
    public required CollateralProposalResponseV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CollateralProposalResponseV06.XmlTag);
