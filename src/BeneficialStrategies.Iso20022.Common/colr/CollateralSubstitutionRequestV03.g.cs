...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.CollateralSubstitutionRequestV03>;
...
public partial record CollateralSubstitutionRequestV03 : IOuterRecord<CollateralSubstitutionRequestV03,CollateralSubstitutionRequestV03Document>
    ,IIsoXmlSerilizable<CollateralSubstitutionRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CollateralSubstitutionRequestV03Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CollateralSubstitutionDeliver is CollateralSubstitution3 CollateralSubstitutionDeliverValue)
        {
    ...
    public static CollateralSubstitutionRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CollateralSubstitutionRequestV03Document : IOuterDocument<CollateralSubstitutionRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CollateralSubstitutionRequestV03.XmlTag)]
    public required CollateralSubstitutionRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CollateralSubstitutionRequestV03.XmlTag);
