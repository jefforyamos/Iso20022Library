...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.CollateralSubstitutionRequestV04>;
...
public partial record CollateralSubstitutionRequestV04 : IOuterRecord<CollateralSubstitutionRequestV04,CollateralSubstitutionRequestV04Document>
    ,IIsoXmlSerilizable<CollateralSubstitutionRequestV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CollateralSubstitutionDeliver is CollateralSubstitution4 CollateralSubstitutionDeliverValue)
        {
    ...
    public static CollateralSubstitutionRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CollateralSubstitutionRequestV04Document : IOuterDocument<CollateralSubstitutionRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CollateralSubstitutionRequestV04.XmlTag)]
    public required CollateralSubstitutionRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CollateralSubstitutionRequestV04.XmlTag);
