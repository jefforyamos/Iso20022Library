...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.InterestPaymentRequestV04>;
...
public partial record InterestPaymentRequestV04 : IOuterRecord<InterestPaymentRequestV04,InterestPaymentRequestV04Document>
    ,IIsoXmlSerilizable<InterestPaymentRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => InterestPaymentRequestV04Document.DocumentNamespace;
    ...
    public static InterestPaymentRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record InterestPaymentRequestV04Document : IOuterDocument<InterestPaymentRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=InterestPaymentRequestV04.XmlTag)]
    public required InterestPaymentRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(InterestPaymentRequestV04.XmlTag);
