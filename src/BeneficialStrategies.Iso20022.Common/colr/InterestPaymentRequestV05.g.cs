...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.InterestPaymentRequestV05>;
...
public partial record InterestPaymentRequestV05 : IOuterRecord<InterestPaymentRequestV05,InterestPaymentRequestV05Document>
    ,IIsoXmlSerilizable<InterestPaymentRequestV05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (InterestDueToA is InterestAmount4 InterestDueToAValue)
        {
            writer.WriteStartElement(null, "IntrstDueToA", xmlNamespace );
            InterestDueToAValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (InterestDueToB is InterestAmount4 InterestDueToBValue)
        {
    ...
    public static InterestPaymentRequestV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record InterestPaymentRequestV05Document : IOuterDocument<InterestPaymentRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=InterestPaymentRequestV05.XmlTag)]
    public required InterestPaymentRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(InterestPaymentRequestV05.XmlTag);
