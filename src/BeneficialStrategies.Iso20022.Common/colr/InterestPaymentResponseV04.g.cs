...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.InterestPaymentResponseV04>;
...
public partial record InterestPaymentResponseV04 : IOuterRecord<InterestPaymentResponseV04,InterestPaymentResponseV04Document>
    ,IIsoXmlSerilizable<InterestPaymentResponseV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => InterestPaymentResponseV04Document.DocumentNamespace;
    ...
    public static InterestPaymentResponseV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record InterestPaymentResponseV04Document : IOuterDocument<InterestPaymentResponseV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=InterestPaymentResponseV04.XmlTag)]
    public required InterestPaymentResponseV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(InterestPaymentResponseV04.XmlTag);
