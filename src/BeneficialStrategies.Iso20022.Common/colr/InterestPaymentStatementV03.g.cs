...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.InterestPaymentStatementV03>;
...
public partial record InterestPaymentStatementV03 : IOuterRecord<InterestPaymentStatementV03,InterestPaymentStatementV03Document>
    ,IIsoXmlSerilizable<InterestPaymentStatementV03>, ISerializeInsideARootElement
{
    ...
    public static InterestPaymentStatementV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record InterestPaymentStatementV03Document : IOuterDocument<InterestPaymentStatementV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=InterestPaymentStatementV03.XmlTag)]
    public required InterestPaymentStatementV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(InterestPaymentStatementV03.XmlTag);
