...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.MarginCallDisputeNotificationV04>;
...
public partial record MarginCallDisputeNotificationV04 : IOuterRecord<MarginCallDisputeNotificationV04,MarginCallDisputeNotificationV04Document>
    ,IIsoXmlSerilizable<MarginCallDisputeNotificationV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MarginCallDisputeNotificationV04Document.DocumentNamespace;
    ...
    public static MarginCallDisputeNotificationV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MarginCallDisputeNotificationV04Document : IOuterDocument<MarginCallDisputeNotificationV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MarginCallDisputeNotificationV04.XmlTag)]
    public required MarginCallDisputeNotificationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MarginCallDisputeNotificationV04.XmlTag);
