...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.colr.MarginCallRequestV03>;
...
public partial record MarginCallRequestV03 : IOuterRecord<MarginCallRequestV03,MarginCallRequestV03Document>
    ,IIsoXmlSerilizable<MarginCallRequestV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ExpectedCollateralDueToB is ExpectedCollateral1Choice_ ExpectedCollateralDueToBValue)
        {
            writer.WriteStartElement(null, "XpctdCollDueToB", xmlNamespace );
            ExpectedCollateralDueToBValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ExpectedCollateralDueToA is ExpectedCollateral1Choice_ ExpectedCollateralDueToAValue)
        {
    ...
    public static MarginCallRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MarginCallRequestV03Document : IOuterDocument<MarginCallRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MarginCallRequestV03.XmlTag)]
    public required MarginCallRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MarginCallRequestV03.XmlTag);
