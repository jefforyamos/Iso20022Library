...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.fxtr.ForeignExchangeTradeBulkStatusNotificationV04>;
...
public partial record ForeignExchangeTradeBulkStatusNotificationV04 : IOuterRecord<ForeignExchangeTradeBulkStatusNotificationV04,ForeignExchangeTradeBulkStatusNotificationV04Document>
    ,IIsoXmlSerilizable<ForeignExchangeTradeBulkStatusNotificationV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ForeignExchangeTradeBulkStatusNotificationV04Document.DocumentNamespace;
    ...
    public static ForeignExchangeTradeBulkStatusNotificationV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeBulkStatusNotificationV04Document : IOuterDocument<ForeignExchangeTradeBulkStatusNotificationV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForeignExchangeTradeBulkStatusNotificationV04.XmlTag)]
    public required ForeignExchangeTradeBulkStatusNotificationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForeignExchangeTradeBulkStatusNotificationV04.XmlTag);
