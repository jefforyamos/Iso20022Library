...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.fxtr.ForeignExchangeTradeCaptureReportAcknowledgementV01>;
...
public partial record ForeignExchangeTradeCaptureReportAcknowledgementV01 : IOuterRecord<ForeignExchangeTradeCaptureReportAcknowledgementV01,ForeignExchangeTradeCaptureReportAcknowledgementV01Document>
    ,IIsoXmlSerilizable<ForeignExchangeTradeCaptureReportAcknowledgementV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("FXTradCaptrRptAck");
    ...
    {
        if (AcknowledgementIdentification is MessageIdentification1 AcknowledgementIdentificationValue)
        {
            writer.WriteStartElement(null, "AckId", xmlNamespace );
            AcknowledgementIdentificationValue.Serialize(writer, xmlNamespace);
    ...
    public static ForeignExchangeTradeCaptureReportAcknowledgementV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeCaptureReportAcknowledgementV01Document : IOuterDocument<ForeignExchangeTradeCaptureReportAcknowledgementV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForeignExchangeTradeCaptureReportAcknowledgementV01.XmlTag)]
    public required ForeignExchangeTradeCaptureReportAcknowledgementV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForeignExchangeTradeCaptureReportAcknowledgementV01.XmlTag);
