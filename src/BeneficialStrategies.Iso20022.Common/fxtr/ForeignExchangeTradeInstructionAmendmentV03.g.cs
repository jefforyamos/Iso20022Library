...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.fxtr.ForeignExchangeTradeInstructionAmendmentV03>;
...
public partial record ForeignExchangeTradeInstructionAmendmentV03 : IOuterRecord<ForeignExchangeTradeInstructionAmendmentV03,ForeignExchangeTradeInstructionAmendmentV03Document>
    ,IIsoXmlSerilizable<ForeignExchangeTradeInstructionAmendmentV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ForeignExchangeTradeInstructionAmendmentV03Document.DocumentNamespace;
    ...
    public static ForeignExchangeTradeInstructionAmendmentV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeInstructionAmendmentV03Document : IOuterDocument<ForeignExchangeTradeInstructionAmendmentV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForeignExchangeTradeInstructionAmendmentV03.XmlTag)]
    public required ForeignExchangeTradeInstructionAmendmentV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForeignExchangeTradeInstructionAmendmentV03.XmlTag);
