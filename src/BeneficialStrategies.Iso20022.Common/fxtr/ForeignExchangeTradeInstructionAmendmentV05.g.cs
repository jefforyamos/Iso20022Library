...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.fxtr.ForeignExchangeTradeInstructionAmendmentV05>;
...
public partial record ForeignExchangeTradeInstructionAmendmentV05 : IOuterRecord<ForeignExchangeTradeInstructionAmendmentV05,ForeignExchangeTradeInstructionAmendmentV05Document>
    ,IIsoXmlSerilizable<ForeignExchangeTradeInstructionAmendmentV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ForeignExchangeTradeInstructionAmendmentV05Document.DocumentNamespace;
    ...
    public static ForeignExchangeTradeInstructionAmendmentV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="ForeignExchangeTradeInstructionAmendmentV05"/>.
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeInstructionAmendmentV05Document : IOuterDocument<ForeignExchangeTradeInstructionAmendmentV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForeignExchangeTradeInstructionAmendmentV05.XmlTag)]
    public required ForeignExchangeTradeInstructionAmendmentV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForeignExchangeTradeInstructionAmendmentV05.XmlTag);
