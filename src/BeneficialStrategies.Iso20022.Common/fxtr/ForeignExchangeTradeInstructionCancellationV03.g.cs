...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.fxtr.ForeignExchangeTradeInstructionCancellationV03>;
...
public partial record ForeignExchangeTradeInstructionCancellationV03 : IOuterRecord<ForeignExchangeTradeInstructionCancellationV03,ForeignExchangeTradeInstructionCancellationV03Document>
    ,IIsoXmlSerilizable<ForeignExchangeTradeInstructionCancellationV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ForeignExchangeTradeInstructionCancellationV03Document.DocumentNamespace;
    ...
    public static ForeignExchangeTradeInstructionCancellationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeInstructionCancellationV03Document : IOuterDocument<ForeignExchangeTradeInstructionCancellationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForeignExchangeTradeInstructionCancellationV03.XmlTag)]
    public required ForeignExchangeTradeInstructionCancellationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForeignExchangeTradeInstructionCancellationV03.XmlTag);
