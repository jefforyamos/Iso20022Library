...
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeInstructionV04Document : IOuterDocument<ForeignExchangeTradeInstructionV04>
{
    ...
    #else
    public ForeignExchangeTradeInstructionV04 Message { get; init; }
    #endif
}
