...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.fxtr.ForeignExchangeTradeStatusAndDetailsNotificationV04>;
...
public partial record ForeignExchangeTradeStatusAndDetailsNotificationV04 : IOuterRecord<ForeignExchangeTradeStatusAndDetailsNotificationV04,ForeignExchangeTradeStatusAndDetailsNotificationV04Document>
    ,IIsoXmlSerilizable<ForeignExchangeTradeStatusAndDetailsNotificationV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GeneralInformation is GeneralInformation5 GeneralInformationValue)
        {
            writer.WriteStartElement(null, "GnlInf", xmlNamespace );
            GeneralInformationValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SplitTradeInformation is SplitTradeDetails3 SplitTradeInformationValue)
        {
    ...
    public static ForeignExchangeTradeStatusAndDetailsNotificationV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeStatusAndDetailsNotificationV04Document : IOuterDocument<ForeignExchangeTradeStatusAndDetailsNotificationV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForeignExchangeTradeStatusAndDetailsNotificationV04.XmlTag)]
    public required ForeignExchangeTradeStatusAndDetailsNotificationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForeignExchangeTradeStatusAndDetailsNotificationV04.XmlTag);
