...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.fxtr.ForeignExchangeTradeStatusAndDetailsNotificationV05>;
...
public partial record ForeignExchangeTradeStatusAndDetailsNotificationV05 : IOuterRecord<ForeignExchangeTradeStatusAndDetailsNotificationV05,ForeignExchangeTradeStatusAndDetailsNotificationV05Document>
    ,IIsoXmlSerilizable<ForeignExchangeTradeStatusAndDetailsNotificationV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ForeignExchangeTradeStatusAndDetailsNotificationV05Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (NonDeliverableForwardConditions is NonDeliverableForwardConditions2 NonDeliverableForwardConditionsValue)
        {
        ...
        if (GeneralInformation is GeneralInformation8 GeneralInformationValue)
        {
            writer.WriteStartElement(null, "GnlInf", xmlNamespace );
            GeneralInformationValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SplitTradeInformation is SplitTradeDetails4 SplitTradeInformationValue)
        {
    ...
    public static ForeignExchangeTradeStatusAndDetailsNotificationV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeStatusAndDetailsNotificationV05Document : IOuterDocument<ForeignExchangeTradeStatusAndDetailsNotificationV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForeignExchangeTradeStatusAndDetailsNotificationV05.XmlTag)]
    public required ForeignExchangeTradeStatusAndDetailsNotificationV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForeignExchangeTradeStatusAndDetailsNotificationV05.XmlTag);
