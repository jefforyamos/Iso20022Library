...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.fxtr.ForeignExchangeTradeStatusNotificationV07>;
...
public partial record ForeignExchangeTradeStatusNotificationV07 : IOuterRecord<ForeignExchangeTradeStatusNotificationV07,ForeignExchangeTradeStatusNotificationV07Document>
    ,IIsoXmlSerilizable<ForeignExchangeTradeStatusNotificationV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => ForeignExchangeTradeStatusNotificationV07Document.DocumentNamespace;
    ...
    public static ForeignExchangeTradeStatusNotificationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ForeignExchangeTradeStatusNotificationV07Document : IOuterDocument<ForeignExchangeTradeStatusNotificationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForeignExchangeTradeStatusNotificationV07.XmlTag)]
    public required ForeignExchangeTradeStatusNotificationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForeignExchangeTradeStatusNotificationV07.XmlTag);
