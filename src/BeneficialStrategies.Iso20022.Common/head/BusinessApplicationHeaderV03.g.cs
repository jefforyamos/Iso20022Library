...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.head.BusinessApplicationHeaderV03>;
...
public partial record BusinessApplicationHeaderV03 : IOuterRecord<BusinessApplicationHeaderV03,BusinessApplicationHeaderV03Document>
    ,IIsoXmlSerilizable<BusinessApplicationHeaderV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BusinessApplicationHeaderV03Document.DocumentNamespace;
    ...
    [Description(@"The Message Definition Identifier of the Business Message instance with which this Business Application Header instance is associated.")]
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Related is BusinessApplicationHeader7 RelatedValue)
        {
    ...
    public static BusinessApplicationHeaderV03 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="BusinessApplicationHeaderV03"/>.
/// </summary>
[Serializable]
public partial record BusinessApplicationHeaderV03Document : IOuterDocument<BusinessApplicationHeaderV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BusinessApplicationHeaderV03.XmlTag)]
    public required BusinessApplicationHeaderV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BusinessApplicationHeaderV03.XmlTag);
