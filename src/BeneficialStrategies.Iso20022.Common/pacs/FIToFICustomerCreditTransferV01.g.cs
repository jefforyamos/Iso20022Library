...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerCreditTransferV01>;
...
public partial record FIToFICustomerCreditTransferV01 : IOuterRecord<FIToFICustomerCreditTransferV01,FIToFICustomerCreditTransferV01Document>
    ,IIsoXmlSerilizable<FIToFICustomerCreditTransferV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("pacs.008.001.01");
    ...
    public static FIToFICustomerCreditTransferV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV01Document : IOuterDocument<FIToFICustomerCreditTransferV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFICustomerCreditTransferV01.XmlTag)]
    public required FIToFICustomerCreditTransferV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerCreditTransferV01.XmlTag);
