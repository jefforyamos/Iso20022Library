...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerCreditTransferV04>;
...
public partial record FIToFICustomerCreditTransferV04 : IOuterRecord<FIToFICustomerCreditTransferV04,FIToFICustomerCreditTransferV04Document>
    ,IIsoXmlSerilizable<FIToFICustomerCreditTransferV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerCreditTransferV04Document.DocumentNamespace;
    ...
    public static FIToFICustomerCreditTransferV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV04Document : IOuterDocument<FIToFICustomerCreditTransferV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFICustomerCreditTransferV04.XmlTag)]
    public required FIToFICustomerCreditTransferV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerCreditTransferV04.XmlTag);
