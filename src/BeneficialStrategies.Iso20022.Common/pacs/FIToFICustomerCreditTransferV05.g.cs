...
[DataContract]
#endif
public partial record FIToFICustomerCreditTransferV05 : IOuterRecord<FIToFICustomerCreditTransferV05,FIToFICustomerCreditTransferV05Document>
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerCreditTransferV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFICustomerCreditTransferV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFICustomerCreditTransferV05Document ToDocument()
    {
        return new FIToFICustomerCreditTransferV05Document { Message = this };
    }
}

/// <summary>
/// This is the outer document that contains the XML serialization wrapper and necessary namespaces for proper serialization.
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFICustomerCreditTransferV05"/>.
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV05Document : IOuterDocument<FIToFICustomerCreditTransferV05>
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFICustomerCreditTransferV05"/> is required.
    /// </summary>
    #if NET8_0_OR_GREATER // C# 12 Global type alias
    public required FIToFICustomerCreditTransferV05 Message { get; init; }
    #else
    public FIToFICustomerCreditTransferV05 Message { get; init; }
    #endif
}
