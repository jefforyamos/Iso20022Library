...
//
// Generated by MainMessageGenerator for FIToFICustomerCreditTransferV06.  ISO2002 ID# _akmeRTqxEeWZFYSPlduMhw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerCreditTransferV06>;
...
public partial record FIToFICustomerCreditTransferV06 : IOuterRecord<FIToFICustomerCreditTransferV06,FIToFICustomerCreditTransferV06Document>
    ,IIsoXmlSerilizable<FIToFICustomerCreditTransferV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerCreditTransferV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFICustomerCreditTransferV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFICustomerCreditTransferV06Document ToDocument()
    {
        return new FIToFICustomerCreditTransferV06Document { Message = this };
    }
    ...
    public static FIToFICustomerCreditTransferV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFICustomerCreditTransferV06"/>.
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV06Document : IOuterDocument<FIToFICustomerCreditTransferV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFICustomerCreditTransferV06"/> is required.
    /// </summary>
    [DataMember(Name=FIToFICustomerCreditTransferV06.XmlTag)]
    public required FIToFICustomerCreditTransferV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerCreditTransferV06.XmlTag);
