...
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV06Document : IOuterDocument<FIToFICustomerCreditTransferV06>
{
    ...
    #else
    public FIToFICustomerCreditTransferV06 Message { get; init; }
    #endif
}
