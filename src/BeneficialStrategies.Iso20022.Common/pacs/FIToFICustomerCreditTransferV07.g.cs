...
//
// Generated by MainMessageGenerator for FIToFICustomerCreditTransferV07.  ISO2002 ID# _37D7EWYLEeaFd-H7jvMAPA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerCreditTransferV07>;
...
public partial record FIToFICustomerCreditTransferV07 : IOuterRecord<FIToFICustomerCreditTransferV07,FIToFICustomerCreditTransferV07Document>
    ,IIsoXmlSerilizable<FIToFICustomerCreditTransferV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerCreditTransferV07Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFICustomerCreditTransferV07Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFICustomerCreditTransferV07Document ToDocument()
    {
        return new FIToFICustomerCreditTransferV07Document { Message = this };
    }
    ...
    public static FIToFICustomerCreditTransferV07 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFICustomerCreditTransferV07"/>.
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV07Document : IOuterDocument<FIToFICustomerCreditTransferV07>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFICustomerCreditTransferV07"/> is required.
    /// </summary>
    [DataMember(Name=FIToFICustomerCreditTransferV07.XmlTag)]
    public required FIToFICustomerCreditTransferV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerCreditTransferV07.XmlTag);
