...
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV09Document : IOuterDocument<FIToFICustomerCreditTransferV09>
{
    ...
    #else
    public FIToFICustomerCreditTransferV09 Message { get; init; }
    #endif
}
