...
//
// Generated by MainMessageGenerator for FIToFICustomerCreditTransferV09.  ISO2002 ID# _LwCB8cP_Eemsic1bQcEtLA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerCreditTransferV09>;
...
public partial record FIToFICustomerCreditTransferV09 : IOuterRecord<FIToFICustomerCreditTransferV09,FIToFICustomerCreditTransferV09Document>
    ,IIsoXmlSerilizable<FIToFICustomerCreditTransferV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerCreditTransferV09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFICustomerCreditTransferV09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFICustomerCreditTransferV09Document ToDocument()
    {
        return new FIToFICustomerCreditTransferV09Document { Message = this };
    }
    ...
    public static FIToFICustomerCreditTransferV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFICustomerCreditTransferV09"/>.
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV09Document : IOuterDocument<FIToFICustomerCreditTransferV09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFICustomerCreditTransferV09"/> is required.
    /// </summary>
    [DataMember(Name=FIToFICustomerCreditTransferV09.XmlTag)]
    public required FIToFICustomerCreditTransferV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerCreditTransferV09.XmlTag);
