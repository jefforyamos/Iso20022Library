...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerCreditTransferV10>;
...
public partial record FIToFICustomerCreditTransferV10 : IOuterRecord<FIToFICustomerCreditTransferV10,FIToFICustomerCreditTransferV10Document>
    ,IIsoXmlSerilizable<FIToFICustomerCreditTransferV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerCreditTransferV10Document.DocumentNamespace;
    ...
    public static FIToFICustomerCreditTransferV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFICustomerCreditTransferV10Document : IOuterDocument<FIToFICustomerCreditTransferV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFICustomerCreditTransferV10.XmlTag)]
    public required FIToFICustomerCreditTransferV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerCreditTransferV10.XmlTag);
