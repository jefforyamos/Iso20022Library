...
/// </summary>
[Serializable]
public partial record FIToFICustomerDirectDebitV04Document : IOuterDocument<FIToFICustomerDirectDebitV04>
{
    ...
    #else
    public FIToFICustomerDirectDebitV04 Message { get; init; }
    #endif
}
