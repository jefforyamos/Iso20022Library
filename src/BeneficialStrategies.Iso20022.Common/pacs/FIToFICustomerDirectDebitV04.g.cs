...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerDirectDebitV04>;
...
public partial record FIToFICustomerDirectDebitV04 : IOuterRecord<FIToFICustomerDirectDebitV04,FIToFICustomerDirectDebitV04Document>
    ,IIsoXmlSerilizable<FIToFICustomerDirectDebitV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerDirectDebitV04Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFICustomerDirectDebitV04Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFICustomerDirectDebitV04Document ToDocument()
    {
        return new FIToFICustomerDirectDebitV04Document { Message = this };
    }
    ...
    public static FIToFICustomerDirectDebitV04 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFICustomerDirectDebitV04"/>.
/// </summary>
[Serializable]
public partial record FIToFICustomerDirectDebitV04Document : IOuterDocument<FIToFICustomerDirectDebitV04>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFICustomerDirectDebitV04"/> is required.
    /// </summary>
    [DataMember(Name=FIToFICustomerDirectDebitV04.XmlTag)]
    public required FIToFICustomerDirectDebitV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerDirectDebitV04.XmlTag);
