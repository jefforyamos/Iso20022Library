...
/// </summary>
[Serializable]
public partial record FIToFICustomerDirectDebitV06Document : IOuterDocument<FIToFICustomerDirectDebitV06>
{
    ...
    #else
    public FIToFICustomerDirectDebitV06 Message { get; init; }
    #endif
}
