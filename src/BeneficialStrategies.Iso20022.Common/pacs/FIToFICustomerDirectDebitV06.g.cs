...
//
// Generated by MainMessageGenerator for FIToFICustomerDirectDebitV06.  ISO2002 ID# _akmeXzqxEeWZFYSPlduMhw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerDirectDebitV06>;
...
public partial record FIToFICustomerDirectDebitV06 : IOuterRecord<FIToFICustomerDirectDebitV06,FIToFICustomerDirectDebitV06Document>
    ,IIsoXmlSerilizable<FIToFICustomerDirectDebitV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerDirectDebitV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFICustomerDirectDebitV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFICustomerDirectDebitV06Document ToDocument()
    {
        return new FIToFICustomerDirectDebitV06Document { Message = this };
    }
    ...
    public static FIToFICustomerDirectDebitV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFICustomerDirectDebitV06"/>.
/// </summary>
[Serializable]
public partial record FIToFICustomerDirectDebitV06Document : IOuterDocument<FIToFICustomerDirectDebitV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFICustomerDirectDebitV06"/> is required.
    /// </summary>
    [DataMember(Name=FIToFICustomerDirectDebitV06.XmlTag)]
    public required FIToFICustomerDirectDebitV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerDirectDebitV06.XmlTag);
