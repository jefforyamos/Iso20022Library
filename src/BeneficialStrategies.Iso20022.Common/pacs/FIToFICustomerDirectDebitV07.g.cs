...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerDirectDebitV07>;
...
public partial record FIToFICustomerDirectDebitV07 : IOuterRecord<FIToFICustomerDirectDebitV07,FIToFICustomerDirectDebitV07Document>
    ,IIsoXmlSerilizable<FIToFICustomerDirectDebitV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerDirectDebitV07Document.DocumentNamespace;
    ...
    public static FIToFICustomerDirectDebitV07 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFICustomerDirectDebitV07"/>.
/// </summary>
[Serializable]
public partial record FIToFICustomerDirectDebitV07Document : IOuterDocument<FIToFICustomerDirectDebitV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFICustomerDirectDebitV07.XmlTag)]
    public required FIToFICustomerDirectDebitV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerDirectDebitV07.XmlTag);
