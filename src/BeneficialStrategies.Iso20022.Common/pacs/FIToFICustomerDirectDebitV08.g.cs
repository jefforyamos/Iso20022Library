...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFICustomerDirectDebitV08>;
...
public partial record FIToFICustomerDirectDebitV08 : IOuterRecord<FIToFICustomerDirectDebitV08,FIToFICustomerDirectDebitV08Document>
    ,IIsoXmlSerilizable<FIToFICustomerDirectDebitV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFICustomerDirectDebitV08Document.DocumentNamespace;
    ...
    public static FIToFICustomerDirectDebitV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFICustomerDirectDebitV08Document : IOuterDocument<FIToFICustomerDirectDebitV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFICustomerDirectDebitV08.XmlTag)]
    public required FIToFICustomerDirectDebitV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFICustomerDirectDebitV08.XmlTag);
