...
//
// Generated by MainMessageGenerator for FIToFIPaymentReversalV02.  ISO2002 ID# _eldZ2dEuEd-BzquC8wXy7w_1408457850.
//
...
public partial record FIToFIPaymentReversalV02 : IOuterRecord
{
    ...
    */
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentReversalV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentReversalV02Document ToDocument()
    {
...
/// The FIToFIPaymentReversal message refers to the original FIToFICustomerDirectDebit message by means of references only or by means of references and a set of elements from the original instruction.
/// The FIToFIPaymentReversal message can be used in domestic and cross-border scenarios.
/// This is the outer document that contains <seealso cref="FIToFIPaymentReversalV02"/>.
/// </summary>
[Serializable]
