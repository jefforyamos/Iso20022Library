...
//
// Generated by MainMessageGenerator for FIToFIPaymentReversalV04.  ISO2002 ID# _RjJo4SGnEeKjd4jizyIDGA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentReversalV04>;
...
public partial record FIToFIPaymentReversalV04 : IOuterRecord<FIToFIPaymentReversalV04,FIToFIPaymentReversalV04Document>
    ,IIsoXmlSerilizable<FIToFIPaymentReversalV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentReversalV04Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentReversalV04Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentReversalV04Document ToDocument()
    {
        return new FIToFIPaymentReversalV04Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionInformation is PaymentTransaction45 TransactionInformationValue)
        {
    ...
    public static FIToFIPaymentReversalV04 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFIPaymentReversalV04"/>.
/// </summary>
[Serializable]
public partial record FIToFIPaymentReversalV04Document : IOuterDocument<FIToFIPaymentReversalV04>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFIPaymentReversalV04"/> is required.
    /// </summary>
    [DataMember(Name=FIToFIPaymentReversalV04.XmlTag)]
    public required FIToFIPaymentReversalV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentReversalV04.XmlTag);
