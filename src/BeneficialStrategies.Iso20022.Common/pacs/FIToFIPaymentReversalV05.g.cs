...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentReversalV05>;
...
public partial record FIToFIPaymentReversalV05 : IOuterRecord<FIToFIPaymentReversalV05,FIToFIPaymentReversalV05Document>
    ,IIsoXmlSerilizable<FIToFIPaymentReversalV05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction51 TransactionInformationValue)
        {
    ...
    public static FIToFIPaymentReversalV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentReversalV05Document : IOuterDocument<FIToFIPaymentReversalV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentReversalV05.XmlTag)]
    public required FIToFIPaymentReversalV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentReversalV05.XmlTag);
