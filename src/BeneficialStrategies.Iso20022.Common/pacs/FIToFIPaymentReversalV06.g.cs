...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentReversalV06>;
...
public partial record FIToFIPaymentReversalV06 : IOuterRecord<FIToFIPaymentReversalV06,FIToFIPaymentReversalV06Document>
    ,IIsoXmlSerilizable<FIToFIPaymentReversalV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentReversalV06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction60 TransactionInformationValue)
        {
    ...
    public static FIToFIPaymentReversalV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentReversalV06Document : IOuterDocument<FIToFIPaymentReversalV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentReversalV06.XmlTag)]
    public required FIToFIPaymentReversalV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentReversalV06.XmlTag);
