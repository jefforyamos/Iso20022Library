...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentReversalV09>;
...
public partial record FIToFIPaymentReversalV09 : IOuterRecord<FIToFIPaymentReversalV09,FIToFIPaymentReversalV09Document>
    ,IIsoXmlSerilizable<FIToFIPaymentReversalV09>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction111 TransactionInformationValue)
        {
    ...
    public static FIToFIPaymentReversalV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentReversalV09Document : IOuterDocument<FIToFIPaymentReversalV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentReversalV09.XmlTag)]
    public required FIToFIPaymentReversalV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentReversalV09.XmlTag);
