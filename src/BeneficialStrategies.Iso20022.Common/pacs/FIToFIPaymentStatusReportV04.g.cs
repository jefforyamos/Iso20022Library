...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentStatusReportV04>;
...
public partial record FIToFIPaymentStatusReportV04 : IOuterRecord<FIToFIPaymentStatusReportV04,FIToFIPaymentStatusReportV04Document>
    ,IIsoXmlSerilizable<FIToFIPaymentStatusReportV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionInformationAndStatus is PaymentTransaction33 TransactionInformationAndStatusValue)
        {
    ...
    public static FIToFIPaymentStatusReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV04Document : IOuterDocument<FIToFIPaymentStatusReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentStatusReportV04.XmlTag)]
    public required FIToFIPaymentStatusReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentStatusReportV04.XmlTag);
