...
//
// Generated by MainMessageGenerator for FIToFIPaymentStatusReportV05.  ISO2002 ID# _FXEtkSGnEeKjd4jizyIDGA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentStatusReportV05>;
...
public partial record FIToFIPaymentStatusReportV05 : IOuterRecord<FIToFIPaymentStatusReportV05,FIToFIPaymentStatusReportV05Document>
    ,IIsoXmlSerilizable<FIToFIPaymentStatusReportV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentStatusReportV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentStatusReportV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentStatusReportV05Document ToDocument()
    {
        return new FIToFIPaymentStatusReportV05Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionInformationAndStatus is PaymentTransaction43 TransactionInformationAndStatusValue)
        {
    ...
    public static FIToFIPaymentStatusReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV05Document : IOuterDocument<FIToFIPaymentStatusReportV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFIPaymentStatusReportV05"/> is required.
    /// </summary>
    [DataMember(Name=FIToFIPaymentStatusReportV05.XmlTag)]
    public required FIToFIPaymentStatusReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentStatusReportV05.XmlTag);
