...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV05Document : IOuterDocument<FIToFIPaymentStatusReportV05>
{
    ...
    #else
    public FIToFIPaymentStatusReportV05 Message { get; init; }
    #endif
}
