...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV07Document : IOuterDocument<FIToFIPaymentStatusReportV07>
{
    ...
    #else
    public FIToFIPaymentStatusReportV07 Message { get; init; }
    #endif
}
