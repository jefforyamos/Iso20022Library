...
//
// Generated by MainMessageGenerator for FIToFIPaymentStatusReportV08.  ISO2002 ID# _YZfuYWXiEeap-P22vGV91g.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentStatusReportV08>;
...
public partial record FIToFIPaymentStatusReportV08 : IOuterRecord<FIToFIPaymentStatusReportV08,FIToFIPaymentStatusReportV08Document>
    ,IIsoXmlSerilizable<FIToFIPaymentStatusReportV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentStatusReportV08Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="FIToFIPaymentStatusReportV08Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public FIToFIPaymentStatusReportV08Document ToDocument()
    {
        return new FIToFIPaymentStatusReportV08Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalGroupInformationAndStatus is OriginalGroupHeader7 OriginalGroupInformationAndStatusValue)
        {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction80 TransactionInformationAndStatusValue)
        {
    ...
    public static FIToFIPaymentStatusReportV08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFIPaymentStatusReportV08"/>.
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV08Document : IOuterDocument<FIToFIPaymentStatusReportV08>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="FIToFIPaymentStatusReportV08"/> is required.
    /// </summary>
    [DataMember(Name=FIToFIPaymentStatusReportV08.XmlTag)]
    public required FIToFIPaymentStatusReportV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentStatusReportV08.XmlTag);
