...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV08Document : IOuterDocument<FIToFIPaymentStatusReportV08>
{
    ...
    #else
    public FIToFIPaymentStatusReportV08 Message { get; init; }
    #endif
}
