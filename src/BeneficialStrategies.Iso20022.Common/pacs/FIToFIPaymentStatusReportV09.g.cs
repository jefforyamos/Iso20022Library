...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentStatusReportV09>;
...
public partial record FIToFIPaymentStatusReportV09 : IOuterRecord<FIToFIPaymentStatusReportV09,FIToFIPaymentStatusReportV09Document>
    ,IIsoXmlSerilizable<FIToFIPaymentStatusReportV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentStatusReportV09Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalGroupInformationAndStatus is OriginalGroupHeader13 OriginalGroupInformationAndStatusValue)
        {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction91 TransactionInformationAndStatusValue)
        {
    ...
    public static FIToFIPaymentStatusReportV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV09Document : IOuterDocument<FIToFIPaymentStatusReportV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentStatusReportV09.XmlTag)]
    public required FIToFIPaymentStatusReportV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentStatusReportV09.XmlTag);
