...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentStatusReportV10>;
...
public partial record FIToFIPaymentStatusReportV10 : IOuterRecord<FIToFIPaymentStatusReportV10,FIToFIPaymentStatusReportV10Document>
    ,IIsoXmlSerilizable<FIToFIPaymentStatusReportV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentStatusReportV10Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction110 TransactionInformationAndStatusValue)
        {
    ...
    public static FIToFIPaymentStatusReportV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV10Document : IOuterDocument<FIToFIPaymentStatusReportV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentStatusReportV10.XmlTag)]
    public required FIToFIPaymentStatusReportV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentStatusReportV10.XmlTag);
