...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentStatusReportV11>;
...
public partial record FIToFIPaymentStatusReportV11 : IOuterRecord<FIToFIPaymentStatusReportV11,FIToFIPaymentStatusReportV11Document>
    ,IIsoXmlSerilizable<FIToFIPaymentStatusReportV11>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformationAndStatus is PaymentTransaction123 TransactionInformationAndStatusValue)
        {
    ...
    public static FIToFIPaymentStatusReportV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV11Document : IOuterDocument<FIToFIPaymentStatusReportV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentStatusReportV11.XmlTag)]
    public required FIToFIPaymentStatusReportV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentStatusReportV11.XmlTag);
