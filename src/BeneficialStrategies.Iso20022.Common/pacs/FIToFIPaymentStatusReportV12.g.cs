...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV12Document : IOuterDocument<FIToFIPaymentStatusReportV12>
{
    ...
    #else
    public FIToFIPaymentStatusReportV12 Message { get; init; }
    #endif
}
