...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusReportV13Document : IOuterDocument<FIToFIPaymentStatusReportV13>
{
    ...
    #else
    public FIToFIPaymentStatusReportV13 Message { get; init; }
    #endif
}
