...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FIToFIPaymentStatusRequestV01>;
...
public partial record FIToFIPaymentStatusRequestV01 : IOuterRecord<FIToFIPaymentStatusRequestV01,FIToFIPaymentStatusRequestV01Document>
    ,IIsoXmlSerilizable<FIToFIPaymentStatusRequestV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FIToFIPaymentStatusRequestV01Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction73 TransactionInformationValue)
        {
    ...
    public static FIToFIPaymentStatusRequestV01 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FIToFIPaymentStatusRequestV01"/>.
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusRequestV01Document : IOuterDocument<FIToFIPaymentStatusRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FIToFIPaymentStatusRequestV01.XmlTag)]
    public required FIToFIPaymentStatusRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FIToFIPaymentStatusRequestV01.XmlTag);
