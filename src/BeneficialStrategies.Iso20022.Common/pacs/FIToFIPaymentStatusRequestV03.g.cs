...
/// </summary>
[Serializable]
public partial record FIToFIPaymentStatusRequestV03Document : IOuterDocument<FIToFIPaymentStatusRequestV03>
{
    ...
    #else
    public FIToFIPaymentStatusRequestV03 Message { get; init; }
    #endif
}
