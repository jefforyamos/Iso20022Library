...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FinancialInstitutionCreditTransferV03>;
...
public partial record FinancialInstitutionCreditTransferV03 : IOuterRecord<FinancialInstitutionCreditTransferV03,FinancialInstitutionCreditTransferV03Document>
    ,IIsoXmlSerilizable<FinancialInstitutionCreditTransferV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FinancialInstitutionCreditTransferV03Document.DocumentNamespace;
    ...
    public static FinancialInstitutionCreditTransferV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FinancialInstitutionCreditTransferV03Document : IOuterDocument<FinancialInstitutionCreditTransferV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FinancialInstitutionCreditTransferV03.XmlTag)]
    public required FinancialInstitutionCreditTransferV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FinancialInstitutionCreditTransferV03.XmlTag);
