...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FinancialInstitutionCreditTransferV05>;
...
public partial record FinancialInstitutionCreditTransferV05 : IOuterRecord<FinancialInstitutionCreditTransferV05,FinancialInstitutionCreditTransferV05Document>
    ,IIsoXmlSerilizable<FinancialInstitutionCreditTransferV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FinancialInstitutionCreditTransferV05Document.DocumentNamespace;
    ...
    public static FinancialInstitutionCreditTransferV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="FinancialInstitutionCreditTransferV05"/>.
/// </summary>
[Serializable]
public partial record FinancialInstitutionCreditTransferV05Document : IOuterDocument<FinancialInstitutionCreditTransferV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FinancialInstitutionCreditTransferV05.XmlTag)]
    public required FinancialInstitutionCreditTransferV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FinancialInstitutionCreditTransferV05.XmlTag);
