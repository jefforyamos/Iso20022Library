...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.FinancialInstitutionCreditTransferV09>;
...
public partial record FinancialInstitutionCreditTransferV09 : IOuterRecord<FinancialInstitutionCreditTransferV09,FinancialInstitutionCreditTransferV09Document>
    ,IIsoXmlSerilizable<FinancialInstitutionCreditTransferV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => FinancialInstitutionCreditTransferV09Document.DocumentNamespace;
    ...
    public static FinancialInstitutionCreditTransferV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record FinancialInstitutionCreditTransferV09Document : IOuterDocument<FinancialInstitutionCreditTransferV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=FinancialInstitutionCreditTransferV09.XmlTag)]
    public required FinancialInstitutionCreditTransferV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(FinancialInstitutionCreditTransferV09.XmlTag);
