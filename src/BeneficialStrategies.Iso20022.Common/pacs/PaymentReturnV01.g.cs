...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.PaymentReturnV01>;
...
public partial record PaymentReturnV01 : IOuterRecord<PaymentReturnV01,PaymentReturnV01Document>
    ,IIsoXmlSerilizable<PaymentReturnV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("pacs.004.001.01");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalGroupInformation is OriginalGroupInformation2 OriginalGroupInformationValue)
        {
            writer.WriteStartElement(null, "OrgnlGrpInf", xmlNamespace );
            OriginalGroupInformationValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TransactionInformation is PaymentTransactionInformation2 TransactionInformationValue)
        {
    ...
    public static PaymentReturnV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PaymentReturnV01Document : IOuterDocument<PaymentReturnV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PaymentReturnV01.XmlTag)]
    public required PaymentReturnV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PaymentReturnV01.XmlTag);
