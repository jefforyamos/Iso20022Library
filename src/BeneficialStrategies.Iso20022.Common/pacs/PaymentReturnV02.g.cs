...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.PaymentReturnV02>;
...
public partial record PaymentReturnV02 : IOuterRecord<PaymentReturnV02,PaymentReturnV02Document>
    ,IIsoXmlSerilizable<PaymentReturnV02>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OriginalGroupInformation is OriginalGroupInformation21 OriginalGroupInformationValue)
        {
            writer.WriteStartElement(null, "OrgnlGrpInf", xmlNamespace );
            OriginalGroupInformationValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TransactionInformation is PaymentTransactionInformation27 TransactionInformationValue)
        {
    ...
    public static PaymentReturnV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PaymentReturnV02Document : IOuterDocument<PaymentReturnV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PaymentReturnV02.XmlTag)]
    public required PaymentReturnV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PaymentReturnV02.XmlTag);
