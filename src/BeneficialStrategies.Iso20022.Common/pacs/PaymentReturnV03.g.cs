...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.PaymentReturnV03>;
...
public partial record PaymentReturnV03 : IOuterRecord<PaymentReturnV03,PaymentReturnV03Document>
    ,IIsoXmlSerilizable<PaymentReturnV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PaymentReturnV03Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction34 TransactionInformationValue)
        {
    ...
    public static PaymentReturnV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PaymentReturnV03Document : IOuterDocument<PaymentReturnV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PaymentReturnV03.XmlTag)]
    public required PaymentReturnV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PaymentReturnV03.XmlTag);
