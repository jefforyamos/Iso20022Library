...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.PaymentReturnV04>;
...
public partial record PaymentReturnV04 : IOuterRecord<PaymentReturnV04,PaymentReturnV04Document>
    ,IIsoXmlSerilizable<PaymentReturnV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction44 TransactionInformationValue)
        {
    ...
    public static PaymentReturnV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PaymentReturnV04Document : IOuterDocument<PaymentReturnV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PaymentReturnV04.XmlTag)]
    public required PaymentReturnV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PaymentReturnV04.XmlTag);
