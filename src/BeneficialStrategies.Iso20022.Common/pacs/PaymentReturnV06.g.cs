...
//
// Generated by MainMessageGenerator for PaymentReturnV06.  ISO2002 ID# _pmmdiTqxEeWZFYSPlduMhw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.PaymentReturnV06>;
...
public partial record PaymentReturnV06 : IOuterRecord<PaymentReturnV06,PaymentReturnV06Document>
    ,IIsoXmlSerilizable<PaymentReturnV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PaymentReturnV06Document.DocumentNamespace;
    ...
    {
        return new PaymentReturnV06Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction65 TransactionInformationValue)
        {
    ...
    public static PaymentReturnV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PaymentReturnV06Document : IOuterDocument<PaymentReturnV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PaymentReturnV06.XmlTag)]
    public required PaymentReturnV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PaymentReturnV06.XmlTag);
