...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.PaymentReturnV07>;
...
public partial record PaymentReturnV07 : IOuterRecord<PaymentReturnV07,PaymentReturnV07Document>
    ,IIsoXmlSerilizable<PaymentReturnV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PaymentReturnV07Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction76 TransactionInformationValue)
        {
    ...
    public static PaymentReturnV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PaymentReturnV07Document : IOuterDocument<PaymentReturnV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PaymentReturnV07.XmlTag)]
    public required PaymentReturnV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PaymentReturnV07.XmlTag);
