...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.PaymentReturnV09>;
...
public partial record PaymentReturnV09 : IOuterRecord<PaymentReturnV09,PaymentReturnV09Document>
    ,IIsoXmlSerilizable<PaymentReturnV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PaymentReturnV09Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction112 TransactionInformationValue)
        {
    ...
    public static PaymentReturnV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="PaymentReturnV09"/>.
/// </summary>
[Serializable]
public partial record PaymentReturnV09Document : IOuterDocument<PaymentReturnV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PaymentReturnV09.XmlTag)]
    public required PaymentReturnV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PaymentReturnV09.XmlTag);
