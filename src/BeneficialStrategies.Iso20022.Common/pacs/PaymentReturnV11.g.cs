...
//
// Generated by MainMessageGenerator for PaymentReturnV11.  ISO2002 ID# _jMZaEdcBEeq_l4BJLVUF2Q.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pacs.PaymentReturnV11>;
...
public partial record PaymentReturnV11 : IOuterRecord<PaymentReturnV11,PaymentReturnV11Document>
    ,IIsoXmlSerilizable<PaymentReturnV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PaymentReturnV11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="PaymentReturnV11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public PaymentReturnV11Document ToDocument()
    {
        return new PaymentReturnV11Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionInformation is PaymentTransaction133 TransactionInformationValue)
        {
    ...
    public static PaymentReturnV11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="PaymentReturnV11"/>.
/// </summary>
[Serializable]
public partial record PaymentReturnV11Document : IOuterDocument<PaymentReturnV11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="PaymentReturnV11"/> is required.
    /// </summary>
    [DataMember(Name=PaymentReturnV11.XmlTag)]
    public required PaymentReturnV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PaymentReturnV11.XmlTag);
