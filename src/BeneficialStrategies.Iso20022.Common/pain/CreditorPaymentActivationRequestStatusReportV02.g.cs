...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestStatusReportV02>;
...
public partial record CreditorPaymentActivationRequestStatusReportV02 : IOuterRecord<CreditorPaymentActivationRequestStatusReportV02,CreditorPaymentActivationRequestStatusReportV02Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestStatusReportV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CreditorPaymentActivationRequestStatusReportV02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInstruction5 OriginalPaymentInformationAndStatusValue)
        {
    ...
    public static CreditorPaymentActivationRequestStatusReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestStatusReportV02Document : IOuterDocument<CreditorPaymentActivationRequestStatusReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestStatusReportV02.XmlTag)]
    public required CreditorPaymentActivationRequestStatusReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestStatusReportV02.XmlTag);
