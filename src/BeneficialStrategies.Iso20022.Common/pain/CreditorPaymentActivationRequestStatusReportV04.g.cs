...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestStatusReportV04>;
...
public partial record CreditorPaymentActivationRequestStatusReportV04 : IOuterRecord<CreditorPaymentActivationRequestStatusReportV04,CreditorPaymentActivationRequestStatusReportV04Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestStatusReportV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CreditorPaymentActivationRequestStatusReportV04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInstruction14 OriginalPaymentInformationAndStatusValue)
        {
    ...
    public static CreditorPaymentActivationRequestStatusReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestStatusReportV04Document : IOuterDocument<CreditorPaymentActivationRequestStatusReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestStatusReportV04.XmlTag)]
    public required CreditorPaymentActivationRequestStatusReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestStatusReportV04.XmlTag);
