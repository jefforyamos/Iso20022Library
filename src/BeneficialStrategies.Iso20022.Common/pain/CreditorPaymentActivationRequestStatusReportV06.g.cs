...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestStatusReportV06>;
...
public partial record CreditorPaymentActivationRequestStatusReportV06 : IOuterRecord<CreditorPaymentActivationRequestStatusReportV06,CreditorPaymentActivationRequestStatusReportV06Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestStatusReportV06>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInstruction24 OriginalPaymentInformationAndStatusValue)
        {
    ...
    public static CreditorPaymentActivationRequestStatusReportV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestStatusReportV06Document : IOuterDocument<CreditorPaymentActivationRequestStatusReportV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestStatusReportV06.XmlTag)]
    public required CreditorPaymentActivationRequestStatusReportV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestStatusReportV06.XmlTag);
