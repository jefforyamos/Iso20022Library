...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestV02>;
...
public partial record CreditorPaymentActivationRequestV02 : IOuterRecord<CreditorPaymentActivationRequestV02,CreditorPaymentActivationRequestV02Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CreditorPaymentActivationRequestV02Document.DocumentNamespace;
    ...
    public static CreditorPaymentActivationRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestV02Document : IOuterDocument<CreditorPaymentActivationRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestV02.XmlTag)]
    public required CreditorPaymentActivationRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestV02.XmlTag);
