...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestV04>;
...
public partial record CreditorPaymentActivationRequestV04 : IOuterRecord<CreditorPaymentActivationRequestV04,CreditorPaymentActivationRequestV04Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestV04>, ISerializeInsideARootElement
{
    ...
    public static CreditorPaymentActivationRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestV04Document : IOuterDocument<CreditorPaymentActivationRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestV04.XmlTag)]
    public required CreditorPaymentActivationRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestV04.XmlTag);
