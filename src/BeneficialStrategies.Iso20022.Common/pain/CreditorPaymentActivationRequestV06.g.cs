...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestV06>;
...
public partial record CreditorPaymentActivationRequestV06 : IOuterRecord<CreditorPaymentActivationRequestV06,CreditorPaymentActivationRequestV06Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestV06>, ISerializeInsideARootElement
{
    ...
    public static CreditorPaymentActivationRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestV06Document : IOuterDocument<CreditorPaymentActivationRequestV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestV06.XmlTag)]
    public required CreditorPaymentActivationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestV06.XmlTag);
