...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestV08>;
...
public partial record CreditorPaymentActivationRequestV08 : IOuterRecord<CreditorPaymentActivationRequestV08,CreditorPaymentActivationRequestV08Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestV08>, ISerializeInsideARootElement
{
    ...
    public static CreditorPaymentActivationRequestV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestV08Document : IOuterDocument<CreditorPaymentActivationRequestV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestV08.XmlTag)]
    public required CreditorPaymentActivationRequestV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestV08.XmlTag);
