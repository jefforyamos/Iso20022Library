...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestV09>;
...
public partial record CreditorPaymentActivationRequestV09 : IOuterRecord<CreditorPaymentActivationRequestV09,CreditorPaymentActivationRequestV09Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CreditorPaymentActivationRequestV09Document.DocumentNamespace;
    ...
    public static CreditorPaymentActivationRequestV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestV09Document : IOuterDocument<CreditorPaymentActivationRequestV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestV09.XmlTag)]
    public required CreditorPaymentActivationRequestV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestV09.XmlTag);
