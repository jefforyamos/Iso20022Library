...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CreditorPaymentActivationRequestV10>;
...
public partial record CreditorPaymentActivationRequestV10 : IOuterRecord<CreditorPaymentActivationRequestV10,CreditorPaymentActivationRequestV10Document>
    ,IIsoXmlSerilizable<CreditorPaymentActivationRequestV10>, ISerializeInsideARootElement
{
    ...
    public static CreditorPaymentActivationRequestV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CreditorPaymentActivationRequestV10Document : IOuterDocument<CreditorPaymentActivationRequestV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CreditorPaymentActivationRequestV10.XmlTag)]
    public required CreditorPaymentActivationRequestV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CreditorPaymentActivationRequestV10.XmlTag);
