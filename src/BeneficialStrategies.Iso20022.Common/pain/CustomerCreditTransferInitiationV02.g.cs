...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerCreditTransferInitiationV02>;
...
public partial record CustomerCreditTransferInitiationV02 : IOuterRecord<CustomerCreditTransferInitiationV02,CustomerCreditTransferInitiationV02Document>
    ,IIsoXmlSerilizable<CustomerCreditTransferInitiationV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerCreditTransferInitiationV02Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("pain.001.001.02");
    ...
    public static CustomerCreditTransferInitiationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerCreditTransferInitiationV02Document : IOuterDocument<CustomerCreditTransferInitiationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerCreditTransferInitiationV02.XmlTag)]
    public required CustomerCreditTransferInitiationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerCreditTransferInitiationV02.XmlTag);
