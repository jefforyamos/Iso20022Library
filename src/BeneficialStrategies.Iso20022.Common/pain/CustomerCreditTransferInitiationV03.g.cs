...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerCreditTransferInitiationV03>;
...
public partial record CustomerCreditTransferInitiationV03 : IOuterRecord<CustomerCreditTransferInitiationV03,CustomerCreditTransferInitiationV03Document>
    ,IIsoXmlSerilizable<CustomerCreditTransferInitiationV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerCreditTransferInitiationV03Document.DocumentNamespace;
    ...
    public static CustomerCreditTransferInitiationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerCreditTransferInitiationV03Document : IOuterDocument<CustomerCreditTransferInitiationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerCreditTransferInitiationV03.XmlTag)]
    public required CustomerCreditTransferInitiationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerCreditTransferInitiationV03.XmlTag);
