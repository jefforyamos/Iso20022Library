...
//
// Generated by MainMessageGenerator for CustomerCreditTransferInitiationV06.  ISO2002 ID# _NasXMRPeEeSVo-TFVwFHvA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerCreditTransferInitiationV06>;
...
public partial record CustomerCreditTransferInitiationV06 : IOuterRecord<CustomerCreditTransferInitiationV06,CustomerCreditTransferInitiationV06Document>
    ,IIsoXmlSerilizable<CustomerCreditTransferInitiationV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerCreditTransferInitiationV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerCreditTransferInitiationV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerCreditTransferInitiationV06Document ToDocument()
    {
        return new CustomerCreditTransferInitiationV06Document { Message = this };
    }
    ...
    public static CustomerCreditTransferInitiationV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerCreditTransferInitiationV06"/>.
/// </summary>
[Serializable]
public partial record CustomerCreditTransferInitiationV06Document : IOuterDocument<CustomerCreditTransferInitiationV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerCreditTransferInitiationV06"/> is required.
    /// </summary>
    [DataMember(Name=CustomerCreditTransferInitiationV06.XmlTag)]
    public required CustomerCreditTransferInitiationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerCreditTransferInitiationV06.XmlTag);
