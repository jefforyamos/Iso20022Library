...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerCreditTransferInitiationV07>;
...
public partial record CustomerCreditTransferInitiationV07 : IOuterRecord<CustomerCreditTransferInitiationV07,CustomerCreditTransferInitiationV07Document>
    ,IIsoXmlSerilizable<CustomerCreditTransferInitiationV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerCreditTransferInitiationV07Document.DocumentNamespace;
    ...
    public static CustomerCreditTransferInitiationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerCreditTransferInitiationV07Document : IOuterDocument<CustomerCreditTransferInitiationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerCreditTransferInitiationV07.XmlTag)]
    public required CustomerCreditTransferInitiationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerCreditTransferInitiationV07.XmlTag);
