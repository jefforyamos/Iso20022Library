...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerCreditTransferInitiationV09>;
...
public partial record CustomerCreditTransferInitiationV09 : IOuterRecord<CustomerCreditTransferInitiationV09,CustomerCreditTransferInitiationV09Document>
    ,IIsoXmlSerilizable<CustomerCreditTransferInitiationV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerCreditTransferInitiationV09Document.DocumentNamespace;
    ...
    public static CustomerCreditTransferInitiationV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerCreditTransferInitiationV09Document : IOuterDocument<CustomerCreditTransferInitiationV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerCreditTransferInitiationV09.XmlTag)]
    public required CustomerCreditTransferInitiationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerCreditTransferInitiationV09.XmlTag);
