...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerCreditTransferInitiationV10>;
...
public partial record CustomerCreditTransferInitiationV10 : IOuterRecord<CustomerCreditTransferInitiationV10,CustomerCreditTransferInitiationV10Document>
    ,IIsoXmlSerilizable<CustomerCreditTransferInitiationV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerCreditTransferInitiationV10Document.DocumentNamespace;
    ...
    public static CustomerCreditTransferInitiationV10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerCreditTransferInitiationV10"/>.
/// </summary>
[Serializable]
public partial record CustomerCreditTransferInitiationV10Document : IOuterDocument<CustomerCreditTransferInitiationV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerCreditTransferInitiationV10.XmlTag)]
    public required CustomerCreditTransferInitiationV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerCreditTransferInitiationV10.XmlTag);
