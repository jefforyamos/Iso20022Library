...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerCreditTransferInitiationV11>;
...
public partial record CustomerCreditTransferInitiationV11 : IOuterRecord<CustomerCreditTransferInitiationV11,CustomerCreditTransferInitiationV11Document>
    ,IIsoXmlSerilizable<CustomerCreditTransferInitiationV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerCreditTransferInitiationV11Document.DocumentNamespace;
    ...
    public static CustomerCreditTransferInitiationV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerCreditTransferInitiationV11Document : IOuterDocument<CustomerCreditTransferInitiationV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerCreditTransferInitiationV11.XmlTag)]
    public required CustomerCreditTransferInitiationV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerCreditTransferInitiationV11.XmlTag);
