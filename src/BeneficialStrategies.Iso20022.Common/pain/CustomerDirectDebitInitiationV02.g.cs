...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerDirectDebitInitiationV02>;
...
public partial record CustomerDirectDebitInitiationV02 : IOuterRecord<CustomerDirectDebitInitiationV02,CustomerDirectDebitInitiationV02Document>
    ,IIsoXmlSerilizable<CustomerDirectDebitInitiationV02>, ISerializeInsideARootElement
{
    ...
    public static CustomerDirectDebitInitiationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerDirectDebitInitiationV02Document : IOuterDocument<CustomerDirectDebitInitiationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerDirectDebitInitiationV02.XmlTag)]
    public required CustomerDirectDebitInitiationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerDirectDebitInitiationV02.XmlTag);
