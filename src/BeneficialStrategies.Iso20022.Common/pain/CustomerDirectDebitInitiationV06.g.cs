...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerDirectDebitInitiationV06>;
...
public partial record CustomerDirectDebitInitiationV06 : IOuterRecord<CustomerDirectDebitInitiationV06,CustomerDirectDebitInitiationV06Document>
    ,IIsoXmlSerilizable<CustomerDirectDebitInitiationV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerDirectDebitInitiationV06Document.DocumentNamespace;
    ...
    public static CustomerDirectDebitInitiationV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerDirectDebitInitiationV06Document : IOuterDocument<CustomerDirectDebitInitiationV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerDirectDebitInitiationV06.XmlTag)]
    public required CustomerDirectDebitInitiationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerDirectDebitInitiationV06.XmlTag);
