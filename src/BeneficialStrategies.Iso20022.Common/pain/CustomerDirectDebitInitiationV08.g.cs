...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerDirectDebitInitiationV08>;
...
public partial record CustomerDirectDebitInitiationV08 : IOuterRecord<CustomerDirectDebitInitiationV08,CustomerDirectDebitInitiationV08Document>
    ,IIsoXmlSerilizable<CustomerDirectDebitInitiationV08>, ISerializeInsideARootElement
{
    ...
    public static CustomerDirectDebitInitiationV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerDirectDebitInitiationV08Document : IOuterDocument<CustomerDirectDebitInitiationV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerDirectDebitInitiationV08.XmlTag)]
    public required CustomerDirectDebitInitiationV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerDirectDebitInitiationV08.XmlTag);
