...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerDirectDebitInitiationV09>;
...
public partial record CustomerDirectDebitInitiationV09 : IOuterRecord<CustomerDirectDebitInitiationV09,CustomerDirectDebitInitiationV09Document>
    ,IIsoXmlSerilizable<CustomerDirectDebitInitiationV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerDirectDebitInitiationV09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerDirectDebitInitiationV09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerDirectDebitInitiationV09Document ToDocument()
    {
        return new CustomerDirectDebitInitiationV09Document { Message = this };
    }
    ...
    public static CustomerDirectDebitInitiationV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerDirectDebitInitiationV09"/>.
/// </summary>
[Serializable]
public partial record CustomerDirectDebitInitiationV09Document : IOuterDocument<CustomerDirectDebitInitiationV09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerDirectDebitInitiationV09"/> is required.
    /// </summary>
    [DataMember(Name=CustomerDirectDebitInitiationV09.XmlTag)]
    public required CustomerDirectDebitInitiationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerDirectDebitInitiationV09.XmlTag);
