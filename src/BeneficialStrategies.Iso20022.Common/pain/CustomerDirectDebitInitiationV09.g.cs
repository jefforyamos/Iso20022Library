...
/// </summary>
[Serializable]
public partial record CustomerDirectDebitInitiationV09Document : IOuterDocument<CustomerDirectDebitInitiationV09>
{
    ...
    #else
    public CustomerDirectDebitInitiationV09 Message { get; init; }
    #endif
}
