...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerDirectDebitInitiationV10>;
...
public partial record CustomerDirectDebitInitiationV10 : IOuterRecord<CustomerDirectDebitInitiationV10,CustomerDirectDebitInitiationV10Document>
    ,IIsoXmlSerilizable<CustomerDirectDebitInitiationV10>, ISerializeInsideARootElement
{
    ...
    public static CustomerDirectDebitInitiationV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerDirectDebitInitiationV10Document : IOuterDocument<CustomerDirectDebitInitiationV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerDirectDebitInitiationV10.XmlTag)]
    public required CustomerDirectDebitInitiationV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerDirectDebitInitiationV10.XmlTag);
