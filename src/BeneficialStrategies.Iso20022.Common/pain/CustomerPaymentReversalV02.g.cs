...
//
// Generated by MainMessageGenerator for CustomerPaymentReversalV02.  ISO2002 ID# _GXLbgtEvEd-BzquC8wXy7w_66905835.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentReversalV02>;
...
public partial record CustomerPaymentReversalV02 : IOuterRecord<CustomerPaymentReversalV02,CustomerPaymentReversalV02Document>
    ,IIsoXmlSerilizable<CustomerPaymentReversalV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentReversalV02Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerPaymentReversalV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerPaymentReversalV02Document ToDocument()
    {
        return new CustomerPaymentReversalV02Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndReversal is OriginalPaymentInformation2 OriginalPaymentInformationAndReversalValue)
        {
    ...
    public static CustomerPaymentReversalV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentReversalV02"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentReversalV02Document : IOuterDocument<CustomerPaymentReversalV02>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerPaymentReversalV02"/> is required.
    /// </summary>
    [DataMember(Name=CustomerPaymentReversalV02.XmlTag)]
    public required CustomerPaymentReversalV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentReversalV02.XmlTag);
