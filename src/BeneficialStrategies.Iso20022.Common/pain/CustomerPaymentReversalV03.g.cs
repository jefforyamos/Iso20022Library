...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentReversalV03>;
...
public partial record CustomerPaymentReversalV03 : IOuterRecord<CustomerPaymentReversalV03,CustomerPaymentReversalV03Document>
    ,IIsoXmlSerilizable<CustomerPaymentReversalV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentReversalV03Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndReversal is OriginalPaymentInstruction2 OriginalPaymentInformationAndReversalValue)
        {
    ...
    public static CustomerPaymentReversalV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentReversalV03Document : IOuterDocument<CustomerPaymentReversalV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentReversalV03.XmlTag)]
    public required CustomerPaymentReversalV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentReversalV03.XmlTag);
