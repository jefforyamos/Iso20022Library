...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentReversalV04>;
...
public partial record CustomerPaymentReversalV04 : IOuterRecord<CustomerPaymentReversalV04,CustomerPaymentReversalV04Document>
    ,IIsoXmlSerilizable<CustomerPaymentReversalV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentReversalV04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndReversal is OriginalPaymentInstruction7 OriginalPaymentInformationAndReversalValue)
        {
    ...
    public static CustomerPaymentReversalV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentReversalV04Document : IOuterDocument<CustomerPaymentReversalV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentReversalV04.XmlTag)]
    public required CustomerPaymentReversalV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentReversalV04.XmlTag);
