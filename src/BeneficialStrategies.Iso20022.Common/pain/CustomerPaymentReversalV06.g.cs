...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentReversalV06>;
...
public partial record CustomerPaymentReversalV06 : IOuterRecord<CustomerPaymentReversalV06,CustomerPaymentReversalV06Document>
    ,IIsoXmlSerilizable<CustomerPaymentReversalV06>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndReversal is OriginalPaymentInstruction16 OriginalPaymentInformationAndReversalValue)
        {
    ...
    public static CustomerPaymentReversalV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentReversalV06Document : IOuterDocument<CustomerPaymentReversalV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentReversalV06.XmlTag)]
    public required CustomerPaymentReversalV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentReversalV06.XmlTag);
