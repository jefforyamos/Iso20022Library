...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentReversalV10>;
...
public partial record CustomerPaymentReversalV10 : IOuterRecord<CustomerPaymentReversalV10,CustomerPaymentReversalV10Document>
    ,IIsoXmlSerilizable<CustomerPaymentReversalV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentReversalV10Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndReversal is OriginalPaymentInstruction37 OriginalPaymentInformationAndReversalValue)
        {
    ...
    public static CustomerPaymentReversalV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentReversalV10Document : IOuterDocument<CustomerPaymentReversalV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentReversalV10.XmlTag)]
    public required CustomerPaymentReversalV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentReversalV10.XmlTag);
