...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentStatusReportV03>;
...
public partial record CustomerPaymentStatusReportV03 : IOuterRecord<CustomerPaymentStatusReportV03,CustomerPaymentStatusReportV03Document>
    ,IIsoXmlSerilizable<CustomerPaymentStatusReportV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInformation1 OriginalPaymentInformationAndStatusValue)
        {
    ...
    public static CustomerPaymentStatusReportV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentStatusReportV03Document : IOuterDocument<CustomerPaymentStatusReportV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentStatusReportV03.XmlTag)]
    public required CustomerPaymentStatusReportV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentStatusReportV03.XmlTag);
