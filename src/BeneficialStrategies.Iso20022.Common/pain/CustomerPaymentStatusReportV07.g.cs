...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentStatusReportV07>;
...
public partial record CustomerPaymentStatusReportV07 : IOuterRecord<CustomerPaymentStatusReportV07,CustomerPaymentStatusReportV07Document>
    ,IIsoXmlSerilizable<CustomerPaymentStatusReportV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentStatusReportV07Document.DocumentNamespace;
    ...
    {
        return new CustomerPaymentStatusReportV07Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInstruction18 OriginalPaymentInformationAndStatusValue)
        {
    ...
    public static CustomerPaymentStatusReportV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentStatusReportV07Document : IOuterDocument<CustomerPaymentStatusReportV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentStatusReportV07.XmlTag)]
    public required CustomerPaymentStatusReportV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentStatusReportV07.XmlTag);
