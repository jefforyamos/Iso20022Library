...
/// </summary>
[Serializable]
public partial record CustomerPaymentStatusReportV09Document : IOuterDocument<CustomerPaymentStatusReportV09>
{
    ...
    #else
    public CustomerPaymentStatusReportV09 Message { get; init; }
    #endif
}
