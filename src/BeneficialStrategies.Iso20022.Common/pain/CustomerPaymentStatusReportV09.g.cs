...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentStatusReportV09>;
...
public partial record CustomerPaymentStatusReportV09 : IOuterRecord<CustomerPaymentStatusReportV09,CustomerPaymentStatusReportV09Document>
    ,IIsoXmlSerilizable<CustomerPaymentStatusReportV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentStatusReportV09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerPaymentStatusReportV09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerPaymentStatusReportV09Document ToDocument()
    {
        return new CustomerPaymentStatusReportV09Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInstruction27 OriginalPaymentInformationAndStatusValue)
        {
    ...
    public static CustomerPaymentStatusReportV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentStatusReportV09"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentStatusReportV09Document : IOuterDocument<CustomerPaymentStatusReportV09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerPaymentStatusReportV09"/> is required.
    /// </summary>
    [DataMember(Name=CustomerPaymentStatusReportV09.XmlTag)]
    public required CustomerPaymentStatusReportV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentStatusReportV09.XmlTag);
