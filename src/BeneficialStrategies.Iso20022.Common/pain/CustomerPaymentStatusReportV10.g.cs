...
/// </summary>
[Serializable]
public partial record CustomerPaymentStatusReportV10Document : IOuterDocument<CustomerPaymentStatusReportV10>
{
    ...
    #else
    public CustomerPaymentStatusReportV10 Message { get; init; }
    #endif
}
