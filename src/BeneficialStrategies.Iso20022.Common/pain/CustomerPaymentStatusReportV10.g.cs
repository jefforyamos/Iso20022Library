...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentStatusReportV10>;
...
public partial record CustomerPaymentStatusReportV10 : IOuterRecord<CustomerPaymentStatusReportV10,CustomerPaymentStatusReportV10Document>
    ,IIsoXmlSerilizable<CustomerPaymentStatusReportV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CustomerPaymentStatusReportV10Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CustomerPaymentStatusReportV10Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CustomerPaymentStatusReportV10Document ToDocument()
    {
        return new CustomerPaymentStatusReportV10Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInstruction32 OriginalPaymentInformationAndStatusValue)
        {
    ...
    public static CustomerPaymentStatusReportV10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CustomerPaymentStatusReportV10"/>.
/// </summary>
[Serializable]
public partial record CustomerPaymentStatusReportV10Document : IOuterDocument<CustomerPaymentStatusReportV10>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CustomerPaymentStatusReportV10"/> is required.
    /// </summary>
    [DataMember(Name=CustomerPaymentStatusReportV10.XmlTag)]
    public required CustomerPaymentStatusReportV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentStatusReportV10.XmlTag);
