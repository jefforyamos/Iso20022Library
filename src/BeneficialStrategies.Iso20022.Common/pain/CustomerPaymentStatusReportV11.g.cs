...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.CustomerPaymentStatusReportV11>;
...
public partial record CustomerPaymentStatusReportV11 : IOuterRecord<CustomerPaymentStatusReportV11,CustomerPaymentStatusReportV11Document>
    ,IIsoXmlSerilizable<CustomerPaymentStatusReportV11>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OriginalPaymentInformationAndStatus is OriginalPaymentInstruction38 OriginalPaymentInformationAndStatusValue)
        {
    ...
    public static CustomerPaymentStatusReportV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CustomerPaymentStatusReportV11Document : IOuterDocument<CustomerPaymentStatusReportV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CustomerPaymentStatusReportV11.XmlTag)]
    public required CustomerPaymentStatusReportV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CustomerPaymentStatusReportV11.XmlTag);
