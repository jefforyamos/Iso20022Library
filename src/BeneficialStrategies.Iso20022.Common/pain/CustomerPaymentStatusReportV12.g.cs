...
/// </summary>
[Serializable]
public partial record CustomerPaymentStatusReportV12Document : IOuterDocument<CustomerPaymentStatusReportV12>
{
    ...
    #else
    public CustomerPaymentStatusReportV12 Message { get; init; }
    #endif
}
