...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.MandateAmendmentRequestV01>;
...
public partial record MandateAmendmentRequestV01 : IOuterRecord<MandateAmendmentRequestV01,MandateAmendmentRequestV01Document>
    ,IIsoXmlSerilizable<MandateAmendmentRequestV01>, ISerializeInsideARootElement
{
    ...
    public static MandateAmendmentRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MandateAmendmentRequestV01Document : IOuterDocument<MandateAmendmentRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MandateAmendmentRequestV01.XmlTag)]
    public required MandateAmendmentRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MandateAmendmentRequestV01.XmlTag);
