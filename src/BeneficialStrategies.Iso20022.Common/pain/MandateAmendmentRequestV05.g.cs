...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.MandateAmendmentRequestV05>;
...
public partial record MandateAmendmentRequestV05 : IOuterRecord<MandateAmendmentRequestV05,MandateAmendmentRequestV05Document>
    ,IIsoXmlSerilizable<MandateAmendmentRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MandateAmendmentRequestV05Document.DocumentNamespace;
    ...
    public static MandateAmendmentRequestV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="MandateAmendmentRequestV05"/>.
/// </summary>
[Serializable]
public partial record MandateAmendmentRequestV05Document : IOuterDocument<MandateAmendmentRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MandateAmendmentRequestV05.XmlTag)]
    public required MandateAmendmentRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MandateAmendmentRequestV05.XmlTag);
