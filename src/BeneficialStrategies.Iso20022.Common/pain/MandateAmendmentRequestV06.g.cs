...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.MandateAmendmentRequestV06>;
...
public partial record MandateAmendmentRequestV06 : IOuterRecord<MandateAmendmentRequestV06,MandateAmendmentRequestV06Document>
    ,IIsoXmlSerilizable<MandateAmendmentRequestV06>, ISerializeInsideARootElement
{
    ...
    public static MandateAmendmentRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MandateAmendmentRequestV06Document : IOuterDocument<MandateAmendmentRequestV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MandateAmendmentRequestV06.XmlTag)]
    public required MandateAmendmentRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MandateAmendmentRequestV06.XmlTag);
