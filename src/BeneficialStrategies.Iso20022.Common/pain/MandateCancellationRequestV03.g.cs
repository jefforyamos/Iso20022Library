...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.MandateCancellationRequestV03>;
...
public partial record MandateCancellationRequestV03 : IOuterRecord<MandateCancellationRequestV03,MandateCancellationRequestV03Document>
    ,IIsoXmlSerilizable<MandateCancellationRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MandateCancellationRequestV03Document.DocumentNamespace;
    ...
    public static MandateCancellationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MandateCancellationRequestV03Document : IOuterDocument<MandateCancellationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MandateCancellationRequestV03.XmlTag)]
    public required MandateCancellationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MandateCancellationRequestV03.XmlTag);
