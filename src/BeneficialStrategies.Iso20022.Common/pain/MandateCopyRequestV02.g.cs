...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.MandateCopyRequestV02>;
...
public partial record MandateCopyRequestV02 : IOuterRecord<MandateCopyRequestV02,MandateCopyRequestV02Document>
    ,IIsoXmlSerilizable<MandateCopyRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MandateCopyRequestV02Document.DocumentNamespace;
    ...
    public static MandateCopyRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MandateCopyRequestV02Document : IOuterDocument<MandateCopyRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MandateCopyRequestV02.XmlTag)]
    public required MandateCopyRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MandateCopyRequestV02.XmlTag);
