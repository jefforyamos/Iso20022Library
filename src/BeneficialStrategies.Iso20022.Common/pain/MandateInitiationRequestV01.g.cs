...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.MandateInitiationRequestV01>;
...
public partial record MandateInitiationRequestV01 : IOuterRecord<MandateInitiationRequestV01,MandateInitiationRequestV01Document>
    ,IIsoXmlSerilizable<MandateInitiationRequestV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MandateInitiationRequestV01Document.DocumentNamespace;
    ...
    public static MandateInitiationRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MandateInitiationRequestV01Document : IOuterDocument<MandateInitiationRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MandateInitiationRequestV01.XmlTag)]
    public required MandateInitiationRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MandateInitiationRequestV01.XmlTag);
