...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.MandateInitiationRequestV05>;
...
public partial record MandateInitiationRequestV05 : IOuterRecord<MandateInitiationRequestV05,MandateInitiationRequestV05Document>
    ,IIsoXmlSerilizable<MandateInitiationRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MandateInitiationRequestV05Document.DocumentNamespace;
    ...
    public static MandateInitiationRequestV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MandateInitiationRequestV05Document : IOuterDocument<MandateInitiationRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MandateInitiationRequestV05.XmlTag)]
    public required MandateInitiationRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MandateInitiationRequestV05.XmlTag);
