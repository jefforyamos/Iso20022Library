...
/// </summary>
[Serializable]
public partial record MandateInitiationRequestV06Document : IOuterDocument<MandateInitiationRequestV06>
{
    ...
    #else
    public MandateInitiationRequestV06 Message { get; init; }
    #endif
}
