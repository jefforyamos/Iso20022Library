...
//
// Generated by MainMessageGenerator for MandateInitiationRequestV06.  ISO2002 ID# _bf9SE22PEei3KuUgpx7Xcw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.pain.MandateInitiationRequestV06>;
...
public partial record MandateInitiationRequestV06 : IOuterRecord<MandateInitiationRequestV06,MandateInitiationRequestV06Document>
    ,IIsoXmlSerilizable<MandateInitiationRequestV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MandateInitiationRequestV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="MandateInitiationRequestV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public MandateInitiationRequestV06Document ToDocument()
    {
        return new MandateInitiationRequestV06Document { Message = this };
    }
    ...
    public static MandateInitiationRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MandateInitiationRequestV06Document : IOuterDocument<MandateInitiationRequestV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="MandateInitiationRequestV06"/> is required.
    /// </summary>
    [DataMember(Name=MandateInitiationRequestV06.XmlTag)]
    public required MandateInitiationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MandateInitiationRequestV06.XmlTag);
