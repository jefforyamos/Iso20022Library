...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.reda.RequestToPayDebtorActivationCancellationRequestV01>;
...
public partial record RequestToPayDebtorActivationCancellationRequestV01 : IOuterRecord<RequestToPayDebtorActivationCancellationRequestV01,RequestToPayDebtorActivationCancellationRequestV01Document>
    ,IIsoXmlSerilizable<RequestToPayDebtorActivationCancellationRequestV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("ReqToPayDbtrActvtnCxlReq");
    ...
    public static RequestToPayDebtorActivationCancellationRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RequestToPayDebtorActivationCancellationRequestV01Document : IOuterDocument<RequestToPayDebtorActivationCancellationRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RequestToPayDebtorActivationCancellationRequestV01.XmlTag)]
    public required RequestToPayDebtorActivationCancellationRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RequestToPayDebtorActivationCancellationRequestV01.XmlTag);
