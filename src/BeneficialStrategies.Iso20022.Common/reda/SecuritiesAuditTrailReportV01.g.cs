...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.reda.SecuritiesAuditTrailReportV01>;
...
public partial record SecuritiesAuditTrailReportV01 : IOuterRecord<SecuritiesAuditTrailReportV01,SecuritiesAuditTrailReportV01Document>
    ,IIsoXmlSerilizable<SecuritiesAuditTrailReportV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesAuditTrailReportV01Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("SctiesAudtTrlRpt");
    ...
    public static SecuritiesAuditTrailReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesAuditTrailReportV01Document : IOuterDocument<SecuritiesAuditTrailReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesAuditTrailReportV01.XmlTag)]
    public required SecuritiesAuditTrailReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesAuditTrailReportV01.XmlTag);
