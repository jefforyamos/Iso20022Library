...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.reda.SecurityDeletionRequestV01>;
...
public partial record SecurityDeletionRequestV01 : IOuterRecord<SecurityDeletionRequestV01,SecurityDeletionRequestV01Document>
    ,IIsoXmlSerilizable<SecurityDeletionRequestV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecurityDeletionRequestV01Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("SctyDeltnReq");
    ...
    public static SecurityDeletionRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecurityDeletionRequestV01Document : IOuterDocument<SecurityDeletionRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecurityDeletionRequestV01.XmlTag)]
    public required SecurityDeletionRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecurityDeletionRequestV01.XmlTag);
