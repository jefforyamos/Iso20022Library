...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.remt.RemittanceAdviceV02>;
...
public partial record RemittanceAdviceV02 : IOuterRecord<RemittanceAdviceV02,RemittanceAdviceV02Document>
    ,IIsoXmlSerilizable<RemittanceAdviceV02>, ISerializeInsideARootElement
{
    ...
    public static RemittanceAdviceV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RemittanceAdviceV02Document : IOuterDocument<RemittanceAdviceV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RemittanceAdviceV02.XmlTag)]
    public required RemittanceAdviceV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RemittanceAdviceV02.XmlTag);
