...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.remt.RemittanceLocationAdviceV01>;
...
public partial record RemittanceLocationAdviceV01 : IOuterRecord<RemittanceLocationAdviceV01,RemittanceLocationAdviceV01Document>
    ,IIsoXmlSerilizable<RemittanceLocationAdviceV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RemittanceLocationAdviceV01Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("RmtLctnAdvc");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteStartElement(null, "RmtLctn", xmlNamespace );
        RemittanceLocation.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
    ...
    public static RemittanceLocationAdviceV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RemittanceLocationAdviceV01Document : IOuterDocument<RemittanceLocationAdviceV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RemittanceLocationAdviceV01.XmlTag)]
    public required RemittanceLocationAdviceV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RemittanceLocationAdviceV01.XmlTag);
