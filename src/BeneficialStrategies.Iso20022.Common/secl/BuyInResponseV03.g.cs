...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.secl.BuyInResponseV03>;
...
public partial record BuyInResponseV03 : IOuterRecord<BuyInResponseV03,BuyInResponseV03Document>
    ,IIsoXmlSerilizable<BuyInResponseV03>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("BuyInRspn");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteStartElement(null, "BuyInRspnDtls", xmlNamespace );
        BuyInResponseDetails.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
        if (OriginalSettlementObligationDetails is SettlementObligation7 OriginalSettlementObligationDetailsValue)
        {
            writer.WriteStartElement(null, "OrgnlSttlmOblgtnDtls", xmlNamespace );
            OriginalSettlementObligationDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    ...
    public static BuyInResponseV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BuyInResponseV03Document : IOuterDocument<BuyInResponseV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BuyInResponseV03.XmlTag)]
    public required BuyInResponseV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BuyInResponseV03.XmlTag);
