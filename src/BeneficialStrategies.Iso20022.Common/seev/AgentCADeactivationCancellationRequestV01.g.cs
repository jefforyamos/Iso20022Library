...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.AgentCADeactivationCancellationRequestV01>;
...
public partial record AgentCADeactivationCancellationRequestV01 : IOuterRecord<AgentCADeactivationCancellationRequestV01,AgentCADeactivationCancellationRequestV01Document>
    ,IIsoXmlSerilizable<AgentCADeactivationCancellationRequestV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AgentCADeactivationCancellationRequestV01Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("AgtCADeactvtnCxlReq");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (DeactivationInstructionDetails is CorporateActionDeactivationInstruction1 DeactivationInstructionDetailsValue)
        {
            writer.WriteStartElement(null, "DeactvtnInstrDtls", xmlNamespace );
            DeactivationInstructionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
    }
    public static AgentCADeactivationCancellationRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AgentCADeactivationCancellationRequestV01Document : IOuterDocument<AgentCADeactivationCancellationRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AgentCADeactivationCancellationRequestV01.XmlTag)]
    public required AgentCADeactivationCancellationRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AgentCADeactivationCancellationRequestV01.XmlTag);
