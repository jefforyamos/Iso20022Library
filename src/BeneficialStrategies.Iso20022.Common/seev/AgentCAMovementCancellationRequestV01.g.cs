...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.AgentCAMovementCancellationRequestV01>;
...
public partial record AgentCAMovementCancellationRequestV01 : IOuterRecord<AgentCAMovementCancellationRequestV01,AgentCAMovementCancellationRequestV01Document>
    ,IIsoXmlSerilizable<AgentCAMovementCancellationRequestV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("AgtCAMvmntCxlReq");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (MovementDetails is MovementInstruction1 MovementDetailsValue)
        {
    ...
    public static AgentCAMovementCancellationRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AgentCAMovementCancellationRequestV01Document : IOuterDocument<AgentCAMovementCancellationRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AgentCAMovementCancellationRequestV01.XmlTag)]
    public required AgentCAMovementCancellationRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AgentCAMovementCancellationRequestV01.XmlTag);
