...
/// </summary>
[Serializable]
public partial record CorporateActionCancellationAdvice002V10Document : IOuterDocument<CorporateActionCancellationAdvice002V10>
{
    ...
    #else
    public CorporateActionCancellationAdvice002V10 Message { get; init; }
    #endif
}
