...
//
// Generated by MainMessageGenerator for CorporateActionCancellationAdvice002V12.  ISO2002 ID# _MJAwI199Ee262vCSVgjImg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionCancellationAdvice002V12>;
...
public partial record CorporateActionCancellationAdvice002V12 : IOuterRecord<CorporateActionCancellationAdvice002V12,CorporateActionCancellationAdvice002V12Document>
    ,IIsoXmlSerilizable<CorporateActionCancellationAdvice002V12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionCancellationAdvice002V12Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionCancellationAdvice002V12Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionCancellationAdvice002V12Document ToDocument()
    {
        return new CorporateActionCancellationAdvice002V12Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction74 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionCancellationAdvice002V12 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionCancellationAdvice002V12"/>.
/// </summary>
[Serializable]
public partial record CorporateActionCancellationAdvice002V12Document : IOuterDocument<CorporateActionCancellationAdvice002V12>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionCancellationAdvice002V12"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionCancellationAdvice002V12.XmlTag)]
    public required CorporateActionCancellationAdvice002V12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionCancellationAdvice002V12.XmlTag);
