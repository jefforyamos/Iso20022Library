...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionCancellationAdviceV04>;
...
public partial record CorporateActionCancellationAdviceV04 : IOuterRecord<CorporateActionCancellationAdviceV04,CorporateActionCancellationAdviceV04Document>
    ,IIsoXmlSerilizable<CorporateActionCancellationAdviceV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionCancellationAdviceV04Document.DocumentNamespace;
    ...
    public static CorporateActionCancellationAdviceV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionCancellationAdviceV04Document : IOuterDocument<CorporateActionCancellationAdviceV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionCancellationAdviceV04.XmlTag)]
    public required CorporateActionCancellationAdviceV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionCancellationAdviceV04.XmlTag);
