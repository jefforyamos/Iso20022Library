...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionCancellationAdviceV07>;
...
public partial record CorporateActionCancellationAdviceV07 : IOuterRecord<CorporateActionCancellationAdviceV07,CorporateActionCancellationAdviceV07Document>
    ,IIsoXmlSerilizable<CorporateActionCancellationAdviceV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionCancellationAdviceV07Document.DocumentNamespace;
    ...
    public static CorporateActionCancellationAdviceV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionCancellationAdviceV07Document : IOuterDocument<CorporateActionCancellationAdviceV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionCancellationAdviceV07.XmlTag)]
    public required CorporateActionCancellationAdviceV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionCancellationAdviceV07.XmlTag);
