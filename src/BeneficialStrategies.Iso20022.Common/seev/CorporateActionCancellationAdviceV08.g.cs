...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionCancellationAdviceV08>;
...
public partial record CorporateActionCancellationAdviceV08 : IOuterRecord<CorporateActionCancellationAdviceV08,CorporateActionCancellationAdviceV08Document>
    ,IIsoXmlSerilizable<CorporateActionCancellationAdviceV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionCancellationAdviceV08Document.DocumentNamespace;
    ...
    public static CorporateActionCancellationAdviceV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionCancellationAdviceV08Document : IOuterDocument<CorporateActionCancellationAdviceV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionCancellationAdviceV08.XmlTag)]
    public required CorporateActionCancellationAdviceV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionCancellationAdviceV08.XmlTag);
