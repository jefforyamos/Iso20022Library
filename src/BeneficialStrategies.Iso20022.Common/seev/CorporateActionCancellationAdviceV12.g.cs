...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionCancellationAdviceV12>;
...
public partial record CorporateActionCancellationAdviceV12 : IOuterRecord<CorporateActionCancellationAdviceV12,CorporateActionCancellationAdviceV12Document>
    ,IIsoXmlSerilizable<CorporateActionCancellationAdviceV12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionCancellationAdviceV12Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction72 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionCancellationAdviceV12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionCancellationAdviceV12Document : IOuterDocument<CorporateActionCancellationAdviceV12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionCancellationAdviceV12.XmlTag)]
    public required CorporateActionCancellationAdviceV12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionCancellationAdviceV12.XmlTag);
