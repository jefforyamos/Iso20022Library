...
//
// Generated by MainMessageGenerator for CorporateActionEventProcessingStatusAdvice002V07.  ISO2002 ID# _Szi5gwVREeqjd8n6wD9JVw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionEventProcessingStatusAdvice002V07>;
...
public partial record CorporateActionEventProcessingStatusAdvice002V07 : IOuterRecord<CorporateActionEventProcessingStatusAdvice002V07,CorporateActionEventProcessingStatusAdvice002V07Document>
    ,IIsoXmlSerilizable<CorporateActionEventProcessingStatusAdvice002V07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionEventProcessingStatusAdvice002V07Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionEventProcessingStatusAdvice002V07Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionEventProcessingStatusAdvice002V07Document ToDocument()
    {
        return new CorporateActionEventProcessingStatusAdvice002V07Document { Message = this };
    }
    ...
    public static CorporateActionEventProcessingStatusAdvice002V07 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionEventProcessingStatusAdvice002V07"/>.
/// </summary>
[Serializable]
public partial record CorporateActionEventProcessingStatusAdvice002V07Document : IOuterDocument<CorporateActionEventProcessingStatusAdvice002V07>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionEventProcessingStatusAdvice002V07"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionEventProcessingStatusAdvice002V07.XmlTag)]
    public required CorporateActionEventProcessingStatusAdvice002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionEventProcessingStatusAdvice002V07.XmlTag);
