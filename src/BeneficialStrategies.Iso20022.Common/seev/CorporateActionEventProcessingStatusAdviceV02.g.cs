...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionEventProcessingStatusAdviceV02>;
...
public partial record CorporateActionEventProcessingStatusAdviceV02 : IOuterRecord<CorporateActionEventProcessingStatusAdviceV02,CorporateActionEventProcessingStatusAdviceV02Document>
    ,IIsoXmlSerilizable<CorporateActionEventProcessingStatusAdviceV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionEventProcessingStatusAdviceV02Document.DocumentNamespace;
    ...
    public static CorporateActionEventProcessingStatusAdviceV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionEventProcessingStatusAdviceV02Document : IOuterDocument<CorporateActionEventProcessingStatusAdviceV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionEventProcessingStatusAdviceV02.XmlTag)]
    public required CorporateActionEventProcessingStatusAdviceV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionEventProcessingStatusAdviceV02.XmlTag);
