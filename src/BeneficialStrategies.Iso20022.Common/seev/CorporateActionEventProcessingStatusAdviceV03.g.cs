...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionEventProcessingStatusAdviceV03>;
...
public partial record CorporateActionEventProcessingStatusAdviceV03 : IOuterRecord<CorporateActionEventProcessingStatusAdviceV03,CorporateActionEventProcessingStatusAdviceV03Document>
    ,IIsoXmlSerilizable<CorporateActionEventProcessingStatusAdviceV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionEventProcessingStatusAdviceV03Document.DocumentNamespace;
    ...
    public static CorporateActionEventProcessingStatusAdviceV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionEventProcessingStatusAdviceV03Document : IOuterDocument<CorporateActionEventProcessingStatusAdviceV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionEventProcessingStatusAdviceV03.XmlTag)]
    public required CorporateActionEventProcessingStatusAdviceV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionEventProcessingStatusAdviceV03.XmlTag);
