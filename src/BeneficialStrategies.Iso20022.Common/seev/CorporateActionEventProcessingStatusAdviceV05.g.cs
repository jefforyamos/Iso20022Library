...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionEventProcessingStatusAdviceV05>;
...
public partial record CorporateActionEventProcessingStatusAdviceV05 : IOuterRecord<CorporateActionEventProcessingStatusAdviceV05,CorporateActionEventProcessingStatusAdviceV05Document>
    ,IIsoXmlSerilizable<CorporateActionEventProcessingStatusAdviceV05>, ISerializeInsideARootElement
{
    ...
    public static CorporateActionEventProcessingStatusAdviceV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionEventProcessingStatusAdviceV05Document : IOuterDocument<CorporateActionEventProcessingStatusAdviceV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionEventProcessingStatusAdviceV05.XmlTag)]
    public required CorporateActionEventProcessingStatusAdviceV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionEventProcessingStatusAdviceV05.XmlTag);
