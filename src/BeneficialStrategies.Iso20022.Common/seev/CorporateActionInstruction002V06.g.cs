...
//
// Generated by MainMessageGenerator for CorporateActionInstruction002V06.  ISO2002 ID# _chT0c5KQEeWHWpTQn1FFVg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstruction002V06>;
...
public partial record CorporateActionInstruction002V06 : IOuterRecord<CorporateActionInstruction002V06,CorporateActionInstruction002V06Document>
    ,IIsoXmlSerilizable<CorporateActionInstruction002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstruction002V06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionInstruction002V06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionInstruction002V06Document ToDocument()
    {
        return new CorporateActionInstruction002V06Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BeneficialOwnerDetails is PartyIdentification101 BeneficialOwnerDetailsValue)
        {
    ...
    public static CorporateActionInstruction002V06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstruction002V06"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstruction002V06Document : IOuterDocument<CorporateActionInstruction002V06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionInstruction002V06"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionInstruction002V06.XmlTag)]
    public required CorporateActionInstruction002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstruction002V06.XmlTag);
