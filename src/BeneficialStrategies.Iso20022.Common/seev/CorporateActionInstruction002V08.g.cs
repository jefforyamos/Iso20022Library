...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstruction002V08>;
...
public partial record CorporateActionInstruction002V08 : IOuterRecord<CorporateActionInstruction002V08,CorporateActionInstruction002V08Document>
    ,IIsoXmlSerilizable<CorporateActionInstruction002V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstruction002V08Document.DocumentNamespace;
    ...
    public static CorporateActionInstruction002V08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstruction002V08"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstruction002V08Document : IOuterDocument<CorporateActionInstruction002V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstruction002V08.XmlTag)]
    public required CorporateActionInstruction002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstruction002V08.XmlTag);
