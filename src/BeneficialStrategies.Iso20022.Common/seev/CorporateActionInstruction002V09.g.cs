...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstruction002V09>;
...
public partial record CorporateActionInstruction002V09 : IOuterRecord<CorporateActionInstruction002V09,CorporateActionInstruction002V09Document>
    ,IIsoXmlSerilizable<CorporateActionInstruction002V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstruction002V09Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BeneficialOwnerDetails is PartyIdentification154 BeneficialOwnerDetailsValue)
        {
    ...
    public static CorporateActionInstruction002V09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstruction002V09"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstruction002V09Document : IOuterDocument<CorporateActionInstruction002V09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstruction002V09.XmlTag)]
    public required CorporateActionInstruction002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstruction002V09.XmlTag);
