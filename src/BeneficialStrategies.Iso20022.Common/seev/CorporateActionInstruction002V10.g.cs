...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstruction002V10>;
...
public partial record CorporateActionInstruction002V10 : IOuterRecord<CorporateActionInstruction002V10,CorporateActionInstruction002V10Document>
    ,IIsoXmlSerilizable<CorporateActionInstruction002V10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstruction002V10Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BeneficialOwnerDetails is PartyIdentification234 BeneficialOwnerDetailsValue)
        {
    ...
    public static CorporateActionInstruction002V10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstruction002V10Document : IOuterDocument<CorporateActionInstruction002V10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstruction002V10.XmlTag)]
    public required CorporateActionInstruction002V10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstruction002V10.XmlTag);
