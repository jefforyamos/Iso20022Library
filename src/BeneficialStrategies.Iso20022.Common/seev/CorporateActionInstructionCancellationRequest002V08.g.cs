...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionCancellationRequest002V08>;
...
public partial record CorporateActionInstructionCancellationRequest002V08 : IOuterRecord<CorporateActionInstructionCancellationRequest002V08,CorporateActionInstructionCancellationRequest002V08Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionCancellationRequest002V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionCancellationRequest002V08Document.DocumentNamespace;
    ...
    public static CorporateActionInstructionCancellationRequest002V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionCancellationRequest002V08Document : IOuterDocument<CorporateActionInstructionCancellationRequest002V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionCancellationRequest002V08.XmlTag)]
    public required CorporateActionInstructionCancellationRequest002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionCancellationRequest002V08.XmlTag);
