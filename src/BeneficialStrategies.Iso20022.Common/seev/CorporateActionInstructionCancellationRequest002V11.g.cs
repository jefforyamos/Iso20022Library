...
//
// Generated by MainMessageGenerator for CorporateActionInstructionCancellationRequest002V11.  ISO2002 ID# _pfHNkzi7Eeydid5dcNPKvg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionCancellationRequest002V11>;
...
public partial record CorporateActionInstructionCancellationRequest002V11 : IOuterRecord<CorporateActionInstructionCancellationRequest002V11,CorporateActionInstructionCancellationRequest002V11Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionCancellationRequest002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionCancellationRequest002V11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionInstructionCancellationRequest002V11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionInstructionCancellationRequest002V11Document ToDocument()
    {
        return new CorporateActionInstructionCancellationRequest002V11Document { Message = this };
    }
    ...
    public static CorporateActionInstructionCancellationRequest002V11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionCancellationRequest002V11Document : IOuterDocument<CorporateActionInstructionCancellationRequest002V11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionInstructionCancellationRequest002V11"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionInstructionCancellationRequest002V11.XmlTag)]
    public required CorporateActionInstructionCancellationRequest002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionCancellationRequest002V11.XmlTag);
