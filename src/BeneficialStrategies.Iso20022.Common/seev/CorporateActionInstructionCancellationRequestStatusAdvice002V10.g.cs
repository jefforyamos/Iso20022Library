...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionCancellationRequestStatusAdvice002V10>;
...
public partial record CorporateActionInstructionCancellationRequestStatusAdvice002V10 : IOuterRecord<CorporateActionInstructionCancellationRequestStatusAdvice002V10,CorporateActionInstructionCancellationRequestStatusAdvice002V10Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionCancellationRequestStatusAdvice002V10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionCancellationRequestStatusAdvice002V10Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption169 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionCancellationRequestStatusAdvice002V10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionCancellationRequestStatusAdvice002V10Document : IOuterDocument<CorporateActionInstructionCancellationRequestStatusAdvice002V10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionCancellationRequestStatusAdvice002V10.XmlTag)]
    public required CorporateActionInstructionCancellationRequestStatusAdvice002V10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionCancellationRequestStatusAdvice002V10.XmlTag);
