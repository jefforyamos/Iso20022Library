...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionCancellationRequestStatusAdviceV08>;
...
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV08 : IOuterRecord<CorporateActionInstructionCancellationRequestStatusAdviceV08,CorporateActionInstructionCancellationRequestStatusAdviceV08Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionCancellationRequestStatusAdviceV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionCancellationRequestStatusAdviceV08Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption141 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionCancellationRequestStatusAdviceV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV08Document : IOuterDocument<CorporateActionInstructionCancellationRequestStatusAdviceV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionCancellationRequestStatusAdviceV08.XmlTag)]
    public required CorporateActionInstructionCancellationRequestStatusAdviceV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionCancellationRequestStatusAdviceV08.XmlTag);
