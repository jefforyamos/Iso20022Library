...
//
// Generated by MainMessageGenerator for CorporateActionInstructionCancellationRequestStatusAdviceV09.  ISO2002 ID# _BBQd1bT-EeiTob_PrFFUxA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionCancellationRequestStatusAdviceV09>;
...
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV09 : IOuterRecord<CorporateActionInstructionCancellationRequestStatusAdviceV09,CorporateActionInstructionCancellationRequestStatusAdviceV09Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionCancellationRequestStatusAdviceV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionCancellationRequestStatusAdviceV09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionInstructionCancellationRequestStatusAdviceV09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdviceV09Document ToDocument()
    {
        return new CorporateActionInstructionCancellationRequestStatusAdviceV09Document { Message = this };
    }
    ...
    public static CorporateActionInstructionCancellationRequestStatusAdviceV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstructionCancellationRequestStatusAdviceV09"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV09Document : IOuterDocument<CorporateActionInstructionCancellationRequestStatusAdviceV09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionInstructionCancellationRequestStatusAdviceV09"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionInstructionCancellationRequestStatusAdviceV09.XmlTag)]
    public required CorporateActionInstructionCancellationRequestStatusAdviceV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionCancellationRequestStatusAdviceV09.XmlTag);
