...
//
// Generated by MainMessageGenerator for CorporateActionInstructionCancellationRequestStatusAdviceV11.  ISO2002 ID# _B3V7W-2zEeqc-LCjwLsUVg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionCancellationRequestStatusAdviceV11>;
...
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV11 : IOuterRecord<CorporateActionInstructionCancellationRequestStatusAdviceV11,CorporateActionInstructionCancellationRequestStatusAdviceV11Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionCancellationRequestStatusAdviceV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionCancellationRequestStatusAdviceV11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionInstructionCancellationRequestStatusAdviceV11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionInstructionCancellationRequestStatusAdviceV11Document ToDocument()
    {
        return new CorporateActionInstructionCancellationRequestStatusAdviceV11Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption182 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionCancellationRequestStatusAdviceV11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstructionCancellationRequestStatusAdviceV11"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstructionCancellationRequestStatusAdviceV11Document : IOuterDocument<CorporateActionInstructionCancellationRequestStatusAdviceV11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionInstructionCancellationRequestStatusAdviceV11"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionInstructionCancellationRequestStatusAdviceV11.XmlTag)]
    public required CorporateActionInstructionCancellationRequestStatusAdviceV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionCancellationRequestStatusAdviceV11.XmlTag);
