...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionCancellationRequestV02>;
...
public partial record CorporateActionInstructionCancellationRequestV02 : IOuterRecord<CorporateActionInstructionCancellationRequestV02,CorporateActionInstructionCancellationRequestV02Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionCancellationRequestV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionCancellationRequestV02Document.DocumentNamespace;
    ...
    public static CorporateActionInstructionCancellationRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionCancellationRequestV02Document : IOuterDocument<CorporateActionInstructionCancellationRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionCancellationRequestV02.XmlTag)]
    public required CorporateActionInstructionCancellationRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionCancellationRequestV02.XmlTag);
