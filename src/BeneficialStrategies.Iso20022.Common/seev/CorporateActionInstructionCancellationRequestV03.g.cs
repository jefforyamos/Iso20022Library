...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionCancellationRequestV03>;
...
public partial record CorporateActionInstructionCancellationRequestV03 : IOuterRecord<CorporateActionInstructionCancellationRequestV03,CorporateActionInstructionCancellationRequestV03Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionCancellationRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionCancellationRequestV03Document.DocumentNamespace;
    ...
    public static CorporateActionInstructionCancellationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionCancellationRequestV03Document : IOuterDocument<CorporateActionInstructionCancellationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionCancellationRequestV03.XmlTag)]
    public required CorporateActionInstructionCancellationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionCancellationRequestV03.XmlTag);
