...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatementReportV06>;
...
public partial record CorporateActionInstructionStatementReportV06 : IOuterRecord<CorporateActionInstructionStatementReportV06,CorporateActionInstructionStatementReportV06Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatementReportV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatementReportV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionInstructionStatementReportV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionInstructionStatementReportV06Document ToDocument()
    {
        return new CorporateActionInstructionStatementReportV06Document { Message = this };
    }
    ...
    public static CorporateActionInstructionStatementReportV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstructionStatementReportV06"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatementReportV06Document : IOuterDocument<CorporateActionInstructionStatementReportV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionInstructionStatementReportV06"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatementReportV06.XmlTag)]
    public required CorporateActionInstructionStatementReportV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatementReportV06.XmlTag);
