...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdvice002V09>;
...
public partial record CorporateActionInstructionStatusAdvice002V09 : IOuterRecord<CorporateActionInstructionStatusAdvice002V09,CorporateActionInstructionStatusAdvice002V09Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdvice002V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatusAdvice002V09Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption144 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionStatusAdvice002V09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdvice002V09Document : IOuterDocument<CorporateActionInstructionStatusAdvice002V09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdvice002V09.XmlTag)]
    public required CorporateActionInstructionStatusAdvice002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdvice002V09.XmlTag);
