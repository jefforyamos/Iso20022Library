...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdvice002V12>;
...
public partial record CorporateActionInstructionStatusAdvice002V12 : IOuterRecord<CorporateActionInstructionStatusAdvice002V12,CorporateActionInstructionStatusAdvice002V12Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdvice002V12>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption187 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionStatusAdvice002V12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdvice002V12Document : IOuterDocument<CorporateActionInstructionStatusAdvice002V12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdvice002V12.XmlTag)]
    public required CorporateActionInstructionStatusAdvice002V12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdvice002V12.XmlTag);
