...
//
// Generated by MainMessageGenerator for CorporateActionInstructionStatusAdviceV02.  ISO2002 ID# _V_mnkd3BEd-KAqAOGQOnnw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdviceV02>;
...
public partial record CorporateActionInstructionStatusAdviceV02 : IOuterRecord<CorporateActionInstructionStatusAdviceV02,CorporateActionInstructionStatusAdviceV02Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdviceV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatusAdviceV02Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionInstructionStatusAdviceV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionInstructionStatusAdviceV02Document ToDocument()
    {
        return new CorporateActionInstructionStatusAdviceV02Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption26 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionStatusAdviceV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstructionStatusAdviceV02"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdviceV02Document : IOuterDocument<CorporateActionInstructionStatusAdviceV02>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionInstructionStatusAdviceV02"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdviceV02.XmlTag)]
    public required CorporateActionInstructionStatusAdviceV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdviceV02.XmlTag);
