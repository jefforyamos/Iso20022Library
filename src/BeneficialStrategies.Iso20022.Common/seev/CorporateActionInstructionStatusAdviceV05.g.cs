...
//
// Generated by MainMessageGenerator for CorporateActionInstructionStatusAdviceV05.  ISO2002 ID# _2B2dMRbDEeOb5dMswipsLQ.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdviceV05>;
...
public partial record CorporateActionInstructionStatusAdviceV05 : IOuterRecord<CorporateActionInstructionStatusAdviceV05,CorporateActionInstructionStatusAdviceV05Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdviceV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatusAdviceV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionInstructionStatusAdviceV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionInstructionStatusAdviceV05Document ToDocument()
    {
        return new CorporateActionInstructionStatusAdviceV05Document { Message = this };
    }
    ...
    public static CorporateActionInstructionStatusAdviceV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstructionStatusAdviceV05"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdviceV05Document : IOuterDocument<CorporateActionInstructionStatusAdviceV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionInstructionStatusAdviceV05"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdviceV05.XmlTag)]
    public required CorporateActionInstructionStatusAdviceV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdviceV05.XmlTag);
