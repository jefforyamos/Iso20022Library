...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdviceV08>;
...
public partial record CorporateActionInstructionStatusAdviceV08 : IOuterRecord<CorporateActionInstructionStatusAdviceV08,CorporateActionInstructionStatusAdviceV08Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdviceV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatusAdviceV08Document.DocumentNamespace;
    ...
    public static CorporateActionInstructionStatusAdviceV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdviceV08Document : IOuterDocument<CorporateActionInstructionStatusAdviceV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdviceV08.XmlTag)]
    public required CorporateActionInstructionStatusAdviceV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdviceV08.XmlTag);
