...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdviceV09>;
...
public partial record CorporateActionInstructionStatusAdviceV09 : IOuterRecord<CorporateActionInstructionStatusAdviceV09,CorporateActionInstructionStatusAdviceV09Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdviceV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatusAdviceV09Document.DocumentNamespace;
    ...
    public static CorporateActionInstructionStatusAdviceV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdviceV09Document : IOuterDocument<CorporateActionInstructionStatusAdviceV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdviceV09.XmlTag)]
    public required CorporateActionInstructionStatusAdviceV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdviceV09.XmlTag);
