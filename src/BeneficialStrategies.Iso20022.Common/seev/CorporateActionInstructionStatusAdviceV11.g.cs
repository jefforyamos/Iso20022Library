...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdviceV11>;
...
public partial record CorporateActionInstructionStatusAdviceV11 : IOuterRecord<CorporateActionInstructionStatusAdviceV11,CorporateActionInstructionStatusAdviceV11Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdviceV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatusAdviceV11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption167 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionStatusAdviceV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdviceV11Document : IOuterDocument<CorporateActionInstructionStatusAdviceV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdviceV11.XmlTag)]
    public required CorporateActionInstructionStatusAdviceV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdviceV11.XmlTag);
