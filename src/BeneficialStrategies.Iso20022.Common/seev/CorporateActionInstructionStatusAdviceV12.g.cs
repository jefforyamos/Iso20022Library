...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdviceV12>;
...
public partial record CorporateActionInstructionStatusAdviceV12 : IOuterRecord<CorporateActionInstructionStatusAdviceV12,CorporateActionInstructionStatusAdviceV12Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdviceV12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatusAdviceV12Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption184 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionStatusAdviceV12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdviceV12Document : IOuterDocument<CorporateActionInstructionStatusAdviceV12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdviceV12.XmlTag)]
    public required CorporateActionInstructionStatusAdviceV12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdviceV12.XmlTag);
