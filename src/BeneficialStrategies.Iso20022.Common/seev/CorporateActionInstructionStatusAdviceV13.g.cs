...
//
// Generated by MainMessageGenerator for CorporateActionInstructionStatusAdviceV13.  ISO2002 ID# _yg7AXxbHEeyroI8qKgB7Mg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionStatusAdviceV13>;
...
public partial record CorporateActionInstructionStatusAdviceV13 : IOuterRecord<CorporateActionInstructionStatusAdviceV13,CorporateActionInstructionStatusAdviceV13Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionStatusAdviceV13>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionStatusAdviceV13Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionInstructionStatusAdviceV13Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionInstructionStatusAdviceV13Document ToDocument()
    {
        return new CorporateActionInstructionStatusAdviceV13Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionInstruction is CorporateActionOption196 CorporateActionInstructionValue)
        {
    ...
    public static CorporateActionInstructionStatusAdviceV13 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionInstructionStatusAdviceV13"/>.
/// </summary>
[Serializable]
public partial record CorporateActionInstructionStatusAdviceV13Document : IOuterDocument<CorporateActionInstructionStatusAdviceV13>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionInstructionStatusAdviceV13"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionInstructionStatusAdviceV13.XmlTag)]
    public required CorporateActionInstructionStatusAdviceV13 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionStatusAdviceV13.XmlTag);
