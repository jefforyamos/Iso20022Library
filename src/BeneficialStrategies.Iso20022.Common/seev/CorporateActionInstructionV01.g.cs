...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionV01>;
...
public partial record CorporateActionInstructionV01 : IOuterRecord<CorporateActionInstructionV01,CorporateActionInstructionV01Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionInstructionV01Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BeneficialOwnerDetails is PartyIdentification33 BeneficialOwnerDetailsValue)
        {
        ...
        writer.WriteEndElement();
        if (AdditionalInformation is CorporateActionNarrative7 AdditionalInformationValue)
        {
    ...
    public static CorporateActionInstructionV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionV01Document : IOuterDocument<CorporateActionInstructionV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionV01.XmlTag)]
    public required CorporateActionInstructionV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionV01.XmlTag);
