...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionV02>;
...
public partial record CorporateActionInstructionV02 : IOuterRecord<CorporateActionInstructionV02,CorporateActionInstructionV02Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionV02>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BeneficialOwnerDetails is PartyIdentification50 BeneficialOwnerDetailsValue)
        {
    ...
    public static CorporateActionInstructionV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionV02Document : IOuterDocument<CorporateActionInstructionV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionV02.XmlTag)]
    public required CorporateActionInstructionV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionV02.XmlTag);
