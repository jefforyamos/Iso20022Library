...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionV08Document : IOuterDocument<CorporateActionInstructionV08>
{
    ...
    #else
    public CorporateActionInstructionV08 Message { get; init; }
    #endif
}
