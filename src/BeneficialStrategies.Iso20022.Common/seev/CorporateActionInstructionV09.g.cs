...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionV09>;
...
public partial record CorporateActionInstructionV09 : IOuterRecord<CorporateActionInstructionV09,CorporateActionInstructionV09Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionV09>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BeneficialOwnerDetails is PartyIdentification142 BeneficialOwnerDetailsValue)
        {
    ...
    public static CorporateActionInstructionV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionV09Document : IOuterDocument<CorporateActionInstructionV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionV09.XmlTag)]
    public required CorporateActionInstructionV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionV09.XmlTag);
