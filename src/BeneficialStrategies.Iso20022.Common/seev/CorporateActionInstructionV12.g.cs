...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionInstructionV12>;
...
public partial record CorporateActionInstructionV12 : IOuterRecord<CorporateActionInstructionV12,CorporateActionInstructionV12Document>
    ,IIsoXmlSerilizable<CorporateActionInstructionV12>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BeneficialOwnerDetails is PartyIdentification251 BeneficialOwnerDetailsValue)
        {
    ...
    public static CorporateActionInstructionV12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionInstructionV12Document : IOuterDocument<CorporateActionInstructionV12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionInstructionV12.XmlTag)]
    public required CorporateActionInstructionV12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionInstructionV12.XmlTag);
