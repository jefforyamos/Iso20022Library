...
//
// Generated by MainMessageGenerator for CorporateActionMovementConfirmation002V07.  ISO2002 ID# _cjrL85KQEeWHWpTQn1FFVg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmation002V07>;
...
public partial record CorporateActionMovementConfirmation002V07 : IOuterRecord<CorporateActionMovementConfirmation002V07,CorporateActionMovementConfirmation002V07Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmation002V07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmation002V07Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementConfirmation002V07Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementConfirmation002V07Document ToDocument()
    {
        return new CorporateActionMovementConfirmation002V07Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction36 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionMovementConfirmation002V07 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementConfirmation002V07"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmation002V07Document : IOuterDocument<CorporateActionMovementConfirmation002V07>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementConfirmation002V07"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmation002V07.XmlTag)]
    public required CorporateActionMovementConfirmation002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmation002V07.XmlTag);
