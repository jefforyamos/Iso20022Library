...
//
// Generated by MainMessageGenerator for CorporateActionMovementConfirmation002V11.  ISO2002 ID# _-ljrUwVSEeqjd8n6wD9JVw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmation002V11>;
...
public partial record CorporateActionMovementConfirmation002V11 : IOuterRecord<CorporateActionMovementConfirmation002V11,CorporateActionMovementConfirmation002V11Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmation002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmation002V11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementConfirmation002V11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementConfirmation002V11Document ToDocument()
    {
        return new CorporateActionMovementConfirmation002V11Document { Message = this };
    }
    ...
    public static CorporateActionMovementConfirmation002V11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementConfirmation002V11"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmation002V11Document : IOuterDocument<CorporateActionMovementConfirmation002V11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementConfirmation002V11"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmation002V11.XmlTag)]
    public required CorporateActionMovementConfirmation002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmation002V11.XmlTag);
