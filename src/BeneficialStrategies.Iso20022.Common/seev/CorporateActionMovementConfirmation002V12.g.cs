...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmation002V12>;
...
public partial record CorporateActionMovementConfirmation002V12 : IOuterRecord<CorporateActionMovementConfirmation002V12,CorporateActionMovementConfirmation002V12Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmation002V12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmation002V12Document.DocumentNamespace;
    ...
    public static CorporateActionMovementConfirmation002V12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmation002V12Document : IOuterDocument<CorporateActionMovementConfirmation002V12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmation002V12.XmlTag)]
    public required CorporateActionMovementConfirmation002V12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmation002V12.XmlTag);
