...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmationV01>;
...
public partial record CorporateActionMovementConfirmationV01 : IOuterRecord<CorporateActionMovementConfirmationV01,CorporateActionMovementConfirmationV01Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmationV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmationV01Document.DocumentNamespace;
    ...
    public static CorporateActionMovementConfirmationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmationV01Document : IOuterDocument<CorporateActionMovementConfirmationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmationV01.XmlTag)]
    public required CorporateActionMovementConfirmationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmationV01.XmlTag);
