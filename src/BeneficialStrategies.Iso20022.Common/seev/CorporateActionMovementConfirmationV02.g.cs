...
//
// Generated by MainMessageGenerator for CorporateActionMovementConfirmationV02.  ISO2002 ID# _-enNAd3BEd-KAqAOGQOnnw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmationV02>;
...
public partial record CorporateActionMovementConfirmationV02 : IOuterRecord<CorporateActionMovementConfirmationV02,CorporateActionMovementConfirmationV02Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmationV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmationV02Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementConfirmationV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementConfirmationV02Document ToDocument()
    {
        return new CorporateActionMovementConfirmationV02Document { Message = this };
    }
    ...
    public static CorporateActionMovementConfirmationV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementConfirmationV02"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmationV02Document : IOuterDocument<CorporateActionMovementConfirmationV02>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementConfirmationV02"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmationV02.XmlTag)]
    public required CorporateActionMovementConfirmationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmationV02.XmlTag);
