...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmationV06>;
...
public partial record CorporateActionMovementConfirmationV06 : IOuterRecord<CorporateActionMovementConfirmationV06,CorporateActionMovementConfirmationV06Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmationV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmationV06Document.DocumentNamespace;
    ...
    public static CorporateActionMovementConfirmationV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementConfirmationV06"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmationV06Document : IOuterDocument<CorporateActionMovementConfirmationV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmationV06.XmlTag)]
    public required CorporateActionMovementConfirmationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmationV06.XmlTag);
