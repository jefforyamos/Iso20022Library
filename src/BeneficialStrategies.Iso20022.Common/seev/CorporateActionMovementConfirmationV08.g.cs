...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmationV08>;
...
public partial record CorporateActionMovementConfirmationV08 : IOuterRecord<CorporateActionMovementConfirmationV08,CorporateActionMovementConfirmationV08Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmationV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmationV08Document.DocumentNamespace;
    ...
    public static CorporateActionMovementConfirmationV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmationV08Document : IOuterDocument<CorporateActionMovementConfirmationV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmationV08.XmlTag)]
    public required CorporateActionMovementConfirmationV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmationV08.XmlTag);
