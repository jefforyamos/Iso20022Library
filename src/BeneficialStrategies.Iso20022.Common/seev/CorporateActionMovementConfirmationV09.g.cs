...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmationV09>;
...
public partial record CorporateActionMovementConfirmationV09 : IOuterRecord<CorporateActionMovementConfirmationV09,CorporateActionMovementConfirmationV09Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmationV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmationV09Document.DocumentNamespace;
    ...
    public static CorporateActionMovementConfirmationV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmationV09Document : IOuterDocument<CorporateActionMovementConfirmationV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmationV09.XmlTag)]
    public required CorporateActionMovementConfirmationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmationV09.XmlTag);
