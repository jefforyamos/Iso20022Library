...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmationV11>;
...
public partial record CorporateActionMovementConfirmationV11 : IOuterRecord<CorporateActionMovementConfirmationV11,CorporateActionMovementConfirmationV11Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmationV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmationV11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction44 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionMovementConfirmationV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmationV11Document : IOuterDocument<CorporateActionMovementConfirmationV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmationV11.XmlTag)]
    public required CorporateActionMovementConfirmationV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmationV11.XmlTag);
