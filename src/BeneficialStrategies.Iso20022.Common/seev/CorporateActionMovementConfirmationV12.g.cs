...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmationV12>;
...
public partial record CorporateActionMovementConfirmationV12 : IOuterRecord<CorporateActionMovementConfirmationV12,CorporateActionMovementConfirmationV12Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmationV12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmationV12Document.DocumentNamespace;
    ...
    public static CorporateActionMovementConfirmationV12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmationV12Document : IOuterDocument<CorporateActionMovementConfirmationV12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmationV12.XmlTag)]
    public required CorporateActionMovementConfirmationV12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmationV12.XmlTag);
