...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementConfirmationV14>;
...
public partial record CorporateActionMovementConfirmationV14 : IOuterRecord<CorporateActionMovementConfirmationV14,CorporateActionMovementConfirmationV14Document>
    ,IIsoXmlSerilizable<CorporateActionMovementConfirmationV14>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementConfirmationV14Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction73 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionMovementConfirmationV14 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementConfirmationV14"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementConfirmationV14Document : IOuterDocument<CorporateActionMovementConfirmationV14>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementConfirmationV14.XmlTag)]
    public required CorporateActionMovementConfirmationV14 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementConfirmationV14.XmlTag);
