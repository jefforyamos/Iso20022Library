...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdvice002V07>;
...
public partial record CorporateActionMovementPreliminaryAdvice002V07 : IOuterRecord<CorporateActionMovementPreliminaryAdvice002V07,CorporateActionMovementPreliminaryAdvice002V07Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdvice002V07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdvice002V07Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionMovementDetails is CorporateActionOption125 CorporateActionMovementDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdvice002V07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdvice002V07Document : IOuterDocument<CorporateActionMovementPreliminaryAdvice002V07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdvice002V07.XmlTag)]
    public required CorporateActionMovementPreliminaryAdvice002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdvice002V07.XmlTag);
