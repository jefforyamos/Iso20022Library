...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdvice002V10>;
...
public partial record CorporateActionMovementPreliminaryAdvice002V10 : IOuterRecord<CorporateActionMovementPreliminaryAdvice002V10,CorporateActionMovementPreliminaryAdvice002V10Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdvice002V10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdvice002V10Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionMovementDetails is CorporateActionOption160 CorporateActionMovementDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdvice002V10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdvice002V10Document : IOuterDocument<CorporateActionMovementPreliminaryAdvice002V10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdvice002V10.XmlTag)]
    public required CorporateActionMovementPreliminaryAdvice002V10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdvice002V10.XmlTag);
