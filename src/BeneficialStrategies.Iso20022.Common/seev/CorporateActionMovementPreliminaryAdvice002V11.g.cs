...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdvice002V11>;
...
public partial record CorporateActionMovementPreliminaryAdvice002V11 : IOuterRecord<CorporateActionMovementPreliminaryAdvice002V11,CorporateActionMovementPreliminaryAdvice002V11Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdvice002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdvice002V11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionMovementDetails is CorporateActionOption174 CorporateActionMovementDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdvice002V11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdvice002V11Document : IOuterDocument<CorporateActionMovementPreliminaryAdvice002V11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdvice002V11.XmlTag)]
    public required CorporateActionMovementPreliminaryAdvice002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdvice002V11.XmlTag);
