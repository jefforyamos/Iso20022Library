...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdvice002V12>;
...
public partial record CorporateActionMovementPreliminaryAdvice002V12 : IOuterRecord<CorporateActionMovementPreliminaryAdvice002V12,CorporateActionMovementPreliminaryAdvice002V12Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdvice002V12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdvice002V12Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionMovementDetails is CorporateActionOption190 CorporateActionMovementDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdvice002V12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdvice002V12Document : IOuterDocument<CorporateActionMovementPreliminaryAdvice002V12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdvice002V12.XmlTag)]
    public required CorporateActionMovementPreliminaryAdvice002V12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdvice002V12.XmlTag);
