...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdviceCancellationAdviceV07>;
...
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV07 : IOuterRecord<CorporateActionMovementPreliminaryAdviceCancellationAdviceV07,CorporateActionMovementPreliminaryAdviceCancellationAdviceV07Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdviceCancellationAdviceV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdviceCancellationAdviceV07Document.DocumentNamespace;
    ...
    public static CorporateActionMovementPreliminaryAdviceCancellationAdviceV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV07Document : IOuterDocument<CorporateActionMovementPreliminaryAdviceCancellationAdviceV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.XmlTag)]
    public required CorporateActionMovementPreliminaryAdviceCancellationAdviceV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdviceCancellationAdviceV07.XmlTag);
