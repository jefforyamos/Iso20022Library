...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdviceCancellationAdviceV10>;
...
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV10 : IOuterRecord<CorporateActionMovementPreliminaryAdviceCancellationAdviceV10,CorporateActionMovementPreliminaryAdviceCancellationAdviceV10Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdviceCancellationAdviceV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdviceCancellationAdviceV10Document.DocumentNamespace;
    ...
    public static CorporateActionMovementPreliminaryAdviceCancellationAdviceV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV10Document : IOuterDocument<CorporateActionMovementPreliminaryAdviceCancellationAdviceV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdviceCancellationAdviceV10.XmlTag)]
    public required CorporateActionMovementPreliminaryAdviceCancellationAdviceV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdviceCancellationAdviceV10.XmlTag);
