...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdviceCancellationAdviceV11>;
...
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV11 : IOuterRecord<CorporateActionMovementPreliminaryAdviceCancellationAdviceV11,CorporateActionMovementPreliminaryAdviceCancellationAdviceV11Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdviceCancellationAdviceV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdviceCancellationAdviceV11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction45 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdviceCancellationAdviceV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdviceCancellationAdviceV11Document : IOuterDocument<CorporateActionMovementPreliminaryAdviceCancellationAdviceV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdviceCancellationAdviceV11.XmlTag)]
    public required CorporateActionMovementPreliminaryAdviceCancellationAdviceV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdviceCancellationAdviceV11.XmlTag);
