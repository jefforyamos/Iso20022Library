...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdviceV04>;
...
public partial record CorporateActionMovementPreliminaryAdviceV04 : IOuterRecord<CorporateActionMovementPreliminaryAdviceV04,CorporateActionMovementPreliminaryAdviceV04Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdviceV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdviceV04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionMovementDetails is CorporateActionOption52 CorporateActionMovementDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdviceV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdviceV04Document : IOuterDocument<CorporateActionMovementPreliminaryAdviceV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdviceV04.XmlTag)]
    public required CorporateActionMovementPreliminaryAdviceV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdviceV04.XmlTag);
