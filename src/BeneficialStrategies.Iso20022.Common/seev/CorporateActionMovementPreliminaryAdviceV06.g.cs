...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdviceV06>;
...
public partial record CorporateActionMovementPreliminaryAdviceV06 : IOuterRecord<CorporateActionMovementPreliminaryAdviceV06,CorporateActionMovementPreliminaryAdviceV06Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdviceV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdviceV06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction24 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdviceV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdviceV06Document : IOuterDocument<CorporateActionMovementPreliminaryAdviceV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdviceV06.XmlTag)]
    public required CorporateActionMovementPreliminaryAdviceV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdviceV06.XmlTag);
