...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdviceV07>;
...
public partial record CorporateActionMovementPreliminaryAdviceV07 : IOuterRecord<CorporateActionMovementPreliminaryAdviceV07,CorporateActionMovementPreliminaryAdviceV07Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdviceV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdviceV07Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionMovementDetails is CorporateActionOption115 CorporateActionMovementDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdviceV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdviceV07Document : IOuterDocument<CorporateActionMovementPreliminaryAdviceV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdviceV07.XmlTag)]
    public required CorporateActionMovementPreliminaryAdviceV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdviceV07.XmlTag);
