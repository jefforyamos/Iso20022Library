...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdviceV11>;
...
public partial record CorporateActionMovementPreliminaryAdviceV11 : IOuterRecord<CorporateActionMovementPreliminaryAdviceV11,CorporateActionMovementPreliminaryAdviceV11Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdviceV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementPreliminaryAdviceV11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionMovementDetails is CorporateActionOption164 CorporateActionMovementDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdviceV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdviceV11Document : IOuterDocument<CorporateActionMovementPreliminaryAdviceV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdviceV11.XmlTag)]
    public required CorporateActionMovementPreliminaryAdviceV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdviceV11.XmlTag);
