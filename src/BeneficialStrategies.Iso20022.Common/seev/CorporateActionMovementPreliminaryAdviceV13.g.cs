...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementPreliminaryAdviceV13>;
...
public partial record CorporateActionMovementPreliminaryAdviceV13 : IOuterRecord<CorporateActionMovementPreliminaryAdviceV13,CorporateActionMovementPreliminaryAdviceV13Document>
    ,IIsoXmlSerilizable<CorporateActionMovementPreliminaryAdviceV13>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction61 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionMovementDetails is CorporateActionOption194 CorporateActionMovementDetailsValue)
        {
    ...
    public static CorporateActionMovementPreliminaryAdviceV13 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementPreliminaryAdviceV13Document : IOuterDocument<CorporateActionMovementPreliminaryAdviceV13>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementPreliminaryAdviceV13.XmlTag)]
    public required CorporateActionMovementPreliminaryAdviceV13 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementPreliminaryAdviceV13.XmlTag);
