...
//
// Generated by MainMessageGenerator for CorporateActionMovementReversalAdvice002V08.  ISO2002 ID# _ZbbRh5wtEeazcsnODTksnQ.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementReversalAdvice002V08>;
...
public partial record CorporateActionMovementReversalAdvice002V08 : IOuterRecord<CorporateActionMovementReversalAdvice002V08,CorporateActionMovementReversalAdvice002V08Document>
    ,IIsoXmlSerilizable<CorporateActionMovementReversalAdvice002V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementReversalAdvice002V08Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementReversalAdvice002V08Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementReversalAdvice002V08Document ToDocument()
    {
        return new CorporateActionMovementReversalAdvice002V08Document { Message = this };
    }
    ...
    public static CorporateActionMovementReversalAdvice002V08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementReversalAdvice002V08"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementReversalAdvice002V08Document : IOuterDocument<CorporateActionMovementReversalAdvice002V08>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementReversalAdvice002V08"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementReversalAdvice002V08.XmlTag)]
    public required CorporateActionMovementReversalAdvice002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementReversalAdvice002V08.XmlTag);
