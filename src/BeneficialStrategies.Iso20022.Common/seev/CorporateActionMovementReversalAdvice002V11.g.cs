...
//
// Generated by MainMessageGenerator for CorporateActionMovementReversalAdvice002V11.  ISO2002 ID# _pT7sOwVTEeqjd8n6wD9JVw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementReversalAdvice002V11>;
...
public partial record CorporateActionMovementReversalAdvice002V11 : IOuterRecord<CorporateActionMovementReversalAdvice002V11,CorporateActionMovementReversalAdvice002V11Document>
    ,IIsoXmlSerilizable<CorporateActionMovementReversalAdvice002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementReversalAdvice002V11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementReversalAdvice002V11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementReversalAdvice002V11Document ToDocument()
    {
        return new CorporateActionMovementReversalAdvice002V11Document { Message = this };
    }
    ...
    public static CorporateActionMovementReversalAdvice002V11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementReversalAdvice002V11"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementReversalAdvice002V11Document : IOuterDocument<CorporateActionMovementReversalAdvice002V11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementReversalAdvice002V11"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementReversalAdvice002V11.XmlTag)]
    public required CorporateActionMovementReversalAdvice002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementReversalAdvice002V11.XmlTag);
