...
//
// Generated by MainMessageGenerator for CorporateActionMovementReversalAdvice002V13.  ISO2002 ID# _p2_iEzi7Eeydid5dcNPKvg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementReversalAdvice002V13>;
...
public partial record CorporateActionMovementReversalAdvice002V13 : IOuterRecord<CorporateActionMovementReversalAdvice002V13,CorporateActionMovementReversalAdvice002V13Document>
    ,IIsoXmlSerilizable<CorporateActionMovementReversalAdvice002V13>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementReversalAdvice002V13Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementReversalAdvice002V13Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementReversalAdvice002V13Document ToDocument()
    {
        return new CorporateActionMovementReversalAdvice002V13Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction66 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionMovementReversalAdvice002V13 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementReversalAdvice002V13"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementReversalAdvice002V13Document : IOuterDocument<CorporateActionMovementReversalAdvice002V13>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementReversalAdvice002V13"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementReversalAdvice002V13.XmlTag)]
    public required CorporateActionMovementReversalAdvice002V13 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementReversalAdvice002V13.XmlTag);
