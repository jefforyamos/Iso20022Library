...
//
// Generated by MainMessageGenerator for CorporateActionMovementReversalAdvice002V14.  ISO2002 ID# _WfifE199Ee262vCSVgjImg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementReversalAdvice002V14>;
...
public partial record CorporateActionMovementReversalAdvice002V14 : IOuterRecord<CorporateActionMovementReversalAdvice002V14,CorporateActionMovementReversalAdvice002V14Document>
    ,IIsoXmlSerilizable<CorporateActionMovementReversalAdvice002V14>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementReversalAdvice002V14Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementReversalAdvice002V14Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementReversalAdvice002V14Document ToDocument()
    {
        return new CorporateActionMovementReversalAdvice002V14Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReversalReason is CorporateActionReversalReason7 ReversalReasonValue)
        {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction78 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionMovementReversalAdvice002V14 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementReversalAdvice002V14"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementReversalAdvice002V14Document : IOuterDocument<CorporateActionMovementReversalAdvice002V14>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementReversalAdvice002V14"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementReversalAdvice002V14.XmlTag)]
    public required CorporateActionMovementReversalAdvice002V14 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementReversalAdvice002V14.XmlTag);
