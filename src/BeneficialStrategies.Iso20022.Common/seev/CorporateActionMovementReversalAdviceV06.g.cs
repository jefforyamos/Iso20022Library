...
//
// Generated by MainMessageGenerator for CorporateActionMovementReversalAdviceV06.  ISO2002 ID# _TpNqwVhBEeSewsfsZR0hxA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementReversalAdviceV06>;
...
public partial record CorporateActionMovementReversalAdviceV06 : IOuterRecord<CorporateActionMovementReversalAdviceV06,CorporateActionMovementReversalAdviceV06Document>
    ,IIsoXmlSerilizable<CorporateActionMovementReversalAdviceV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementReversalAdviceV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementReversalAdviceV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementReversalAdviceV06Document ToDocument()
    {
        return new CorporateActionMovementReversalAdviceV06Document { Message = this };
    }
    ...
    public static CorporateActionMovementReversalAdviceV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementReversalAdviceV06"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementReversalAdviceV06Document : IOuterDocument<CorporateActionMovementReversalAdviceV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementReversalAdviceV06"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementReversalAdviceV06.XmlTag)]
    public required CorporateActionMovementReversalAdviceV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementReversalAdviceV06.XmlTag);
