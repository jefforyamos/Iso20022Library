...
//
// Generated by MainMessageGenerator for CorporateActionMovementReversalAdviceV11.  ISO2002 ID# _hptEZ-XjEemEj48jhmlA0Q.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementReversalAdviceV11>;
...
public partial record CorporateActionMovementReversalAdviceV11 : IOuterRecord<CorporateActionMovementReversalAdviceV11,CorporateActionMovementReversalAdviceV11Document>
    ,IIsoXmlSerilizable<CorporateActionMovementReversalAdviceV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionMovementReversalAdviceV11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionMovementReversalAdviceV11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionMovementReversalAdviceV11Document ToDocument()
    {
        return new CorporateActionMovementReversalAdviceV11Document { Message = this };
    }
    ...
    public static CorporateActionMovementReversalAdviceV11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionMovementReversalAdviceV11"/>.
/// </summary>
[Serializable]
public partial record CorporateActionMovementReversalAdviceV11Document : IOuterDocument<CorporateActionMovementReversalAdviceV11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionMovementReversalAdviceV11"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionMovementReversalAdviceV11.XmlTag)]
    public required CorporateActionMovementReversalAdviceV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementReversalAdviceV11.XmlTag);
