...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionMovementReversalAdviceV13>;
...
public partial record CorporateActionMovementReversalAdviceV13 : IOuterRecord<CorporateActionMovementReversalAdviceV13,CorporateActionMovementReversalAdviceV13Document>
    ,IIsoXmlSerilizable<CorporateActionMovementReversalAdviceV13>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CorporateActionDetails is CorporateAction63 CorporateActionDetailsValue)
        {
    ...
    public static CorporateActionMovementReversalAdviceV13 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionMovementReversalAdviceV13Document : IOuterDocument<CorporateActionMovementReversalAdviceV13>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionMovementReversalAdviceV13.XmlTag)]
    public required CorporateActionMovementReversalAdviceV13 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionMovementReversalAdviceV13.XmlTag);
