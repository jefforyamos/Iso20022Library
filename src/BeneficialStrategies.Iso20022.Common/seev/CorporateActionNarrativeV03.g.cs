...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNarrativeV03>;
...
public partial record CorporateActionNarrativeV03 : IOuterRecord<CorporateActionNarrativeV03,CorporateActionNarrativeV03Document>
    ,IIsoXmlSerilizable<CorporateActionNarrativeV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (UnderlyingSecurity is SecurityIdentification14 UnderlyingSecurityValue)
        {
    ...
    public static CorporateActionNarrativeV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNarrativeV03Document : IOuterDocument<CorporateActionNarrativeV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNarrativeV03.XmlTag)]
    public required CorporateActionNarrativeV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNarrativeV03.XmlTag);
