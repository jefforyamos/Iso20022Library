...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNarrativeV05>;
...
public partial record CorporateActionNarrativeV05 : IOuterRecord<CorporateActionNarrativeV05,CorporateActionNarrativeV05Document>
    ,IIsoXmlSerilizable<CorporateActionNarrativeV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionNarrativeV05Document.DocumentNamespace;
    ...
    {
        if (AccountDetails is AccountIdentification42Choice_ AccountDetailsValue)
        {
    ...
    public static CorporateActionNarrativeV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNarrativeV05Document : IOuterDocument<CorporateActionNarrativeV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNarrativeV05.XmlTag)]
    public required CorporateActionNarrativeV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNarrativeV05.XmlTag);
