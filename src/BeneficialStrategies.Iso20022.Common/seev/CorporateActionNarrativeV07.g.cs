...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNarrativeV07>;
...
public partial record CorporateActionNarrativeV07 : IOuterRecord<CorporateActionNarrativeV07,CorporateActionNarrativeV07Document>
    ,IIsoXmlSerilizable<CorporateActionNarrativeV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionNarrativeV07Document.DocumentNamespace;
    ...
    {
        if (AccountDetails is AccountIdentification48Choice_ AccountDetailsValue)
        {
    ...
    public static CorporateActionNarrativeV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNarrativeV07Document : IOuterDocument<CorporateActionNarrativeV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNarrativeV07.XmlTag)]
    public required CorporateActionNarrativeV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNarrativeV07.XmlTag);
