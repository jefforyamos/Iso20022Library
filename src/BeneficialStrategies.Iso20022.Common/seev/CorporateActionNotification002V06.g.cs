...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotification002V06>;
...
public partial record CorporateActionNotification002V06 : IOuterRecord<CorporateActionNotification002V06,CorporateActionNotification002V06Document>
    ,IIsoXmlSerilizable<CorporateActionNotification002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionNotification002V06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionNotification002V06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionNotification002V06Document ToDocument()
    {
        return new CorporateActionNotification002V06Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionOptionDetails is CorporateActionOption127 CorporateActionOptionDetailsValue)
        {
    ...
    public static CorporateActionNotification002V06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionNotification002V06"/>.
/// </summary>
[Serializable]
public partial record CorporateActionNotification002V06Document : IOuterDocument<CorporateActionNotification002V06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionNotification002V06"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionNotification002V06.XmlTag)]
    public required CorporateActionNotification002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotification002V06.XmlTag);
