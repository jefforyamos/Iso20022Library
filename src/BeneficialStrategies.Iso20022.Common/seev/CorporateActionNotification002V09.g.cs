...
/// </summary>
[Serializable]
public partial record CorporateActionNotification002V09Document : IOuterDocument<CorporateActionNotification002V09>
{
    ...
    #else
    public CorporateActionNotification002V09 Message { get; init; }
    #endif
}
