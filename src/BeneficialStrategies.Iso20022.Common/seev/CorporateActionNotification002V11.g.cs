...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotification002V11>;
...
public partial record CorporateActionNotification002V11 : IOuterRecord<CorporateActionNotification002V11,CorporateActionNotification002V11Document>
    ,IIsoXmlSerilizable<CorporateActionNotification002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionNotification002V11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionDetails is CorporateAction58 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionOptionDetails is CorporateActionOption191 CorporateActionOptionDetailsValue)
        {
        ...
        if (AdditionalInformation is CorporateActionNarrative49 AdditionalInformationValue)
        {
    ...
    public static CorporateActionNotification002V11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNotification002V11Document : IOuterDocument<CorporateActionNotification002V11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNotification002V11.XmlTag)]
    public required CorporateActionNotification002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotification002V11.XmlTag);
