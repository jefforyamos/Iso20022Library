...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotificationV02>;
...
public partial record CorporateActionNotificationV02 : IOuterRecord<CorporateActionNotificationV02,CorporateActionNotificationV02Document>
    ,IIsoXmlSerilizable<CorporateActionNotificationV02>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (IntermediateSecurity is FinancialInstrumentAttributes17 IntermediateSecurityValue)
        {
            writer.WriteStartElement(null, "IntrmdtScty", xmlNamespace );
            IntermediateSecurityValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionDetails is CorporateAction5 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionOptionDetails is CorporateActionOption19 CorporateActionOptionDetailsValue)
        {
    ...
    public static CorporateActionNotificationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNotificationV02Document : IOuterDocument<CorporateActionNotificationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNotificationV02.XmlTag)]
    public required CorporateActionNotificationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotificationV02.XmlTag);
