...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotificationV03>;
...
public partial record CorporateActionNotificationV03 : IOuterRecord<CorporateActionNotificationV03,CorporateActionNotificationV03Document>
    ,IIsoXmlSerilizable<CorporateActionNotificationV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionDetails is CorporateAction7 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionOptionDetails is CorporateActionOption36 CorporateActionOptionDetailsValue)
        {
    ...
    public static CorporateActionNotificationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNotificationV03Document : IOuterDocument<CorporateActionNotificationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNotificationV03.XmlTag)]
    public required CorporateActionNotificationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotificationV03.XmlTag);
