...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotificationV04>;
...
public partial record CorporateActionNotificationV04 : IOuterRecord<CorporateActionNotificationV04,CorporateActionNotificationV04Document>
    ,IIsoXmlSerilizable<CorporateActionNotificationV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionNotificationV04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (IntermediateSecurity is FinancialInstrumentAttributes46 IntermediateSecurityValue)
        {
            writer.WriteStartElement(null, "IntrmdtScty", xmlNamespace );
            IntermediateSecurityValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionDetails is CorporateAction10 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionOptionDetails is CorporateActionOption51 CorporateActionOptionDetailsValue)
        {
    ...
    public static CorporateActionNotificationV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNotificationV04Document : IOuterDocument<CorporateActionNotificationV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNotificationV04.XmlTag)]
    public required CorporateActionNotificationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotificationV04.XmlTag);
