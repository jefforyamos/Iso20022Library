...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotificationV05>;
...
public partial record CorporateActionNotificationV05 : IOuterRecord<CorporateActionNotificationV05,CorporateActionNotificationV05Document>
    ,IIsoXmlSerilizable<CorporateActionNotificationV05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionDetails is CorporateAction12 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionOptionDetails is CorporateActionOption101 CorporateActionOptionDetailsValue)
        {
    ...
    public static CorporateActionNotificationV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNotificationV05Document : IOuterDocument<CorporateActionNotificationV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNotificationV05.XmlTag)]
    public required CorporateActionNotificationV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotificationV05.XmlTag);
