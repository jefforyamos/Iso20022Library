...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotificationV07>;
...
public partial record CorporateActionNotificationV07 : IOuterRecord<CorporateActionNotificationV07,CorporateActionNotificationV07Document>
    ,IIsoXmlSerilizable<CorporateActionNotificationV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionNotificationV07Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionOptionDetails is CorporateActionOption130 CorporateActionOptionDetailsValue)
        {
    ...
    public static CorporateActionNotificationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record CorporateActionNotificationV07Document : IOuterDocument<CorporateActionNotificationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNotificationV07.XmlTag)]
    public required CorporateActionNotificationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotificationV07.XmlTag);
