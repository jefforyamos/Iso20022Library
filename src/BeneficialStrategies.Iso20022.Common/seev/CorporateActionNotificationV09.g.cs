...
/// </summary>
[Serializable]
public partial record CorporateActionNotificationV09Document : IOuterDocument<CorporateActionNotificationV09>
{
    ...
    #else
    public CorporateActionNotificationV09 Message { get; init; }
    #endif
}
