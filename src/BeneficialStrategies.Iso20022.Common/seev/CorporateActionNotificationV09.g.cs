...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotificationV09>;
...
public partial record CorporateActionNotificationV09 : IOuterRecord<CorporateActionNotificationV09,CorporateActionNotificationV09Document>
    ,IIsoXmlSerilizable<CorporateActionNotificationV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionNotificationV09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="CorporateActionNotificationV09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public CorporateActionNotificationV09Document ToDocument()
    {
        return new CorporateActionNotificationV09Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionDetails is CorporateAction52 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionOptionDetails is CorporateActionOption152 CorporateActionOptionDetailsValue)
        {
    ...
    public static CorporateActionNotificationV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionNotificationV09"/>.
/// </summary>
[Serializable]
public partial record CorporateActionNotificationV09Document : IOuterDocument<CorporateActionNotificationV09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="CorporateActionNotificationV09"/> is required.
    /// </summary>
    [DataMember(Name=CorporateActionNotificationV09.XmlTag)]
    public required CorporateActionNotificationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotificationV09.XmlTag);
