...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.CorporateActionNotificationV10>;
...
public partial record CorporateActionNotificationV10 : IOuterRecord<CorporateActionNotificationV10,CorporateActionNotificationV10Document>
    ,IIsoXmlSerilizable<CorporateActionNotificationV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => CorporateActionNotificationV10Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionDetails is CorporateAction56 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionOptionDetails is CorporateActionOption163 CorporateActionOptionDetailsValue)
        {
        ...
        if (AdditionalInformation is CorporateActionNarrative42 AdditionalInformationValue)
        {
    ...
    public static CorporateActionNotificationV10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="CorporateActionNotificationV10"/>.
/// </summary>
[Serializable]
public partial record CorporateActionNotificationV10Document : IOuterDocument<CorporateActionNotificationV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=CorporateActionNotificationV10.XmlTag)]
    public required CorporateActionNotificationV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(CorporateActionNotificationV10.XmlTag);
