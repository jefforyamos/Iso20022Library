...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingCancellationV08>;
...
public partial record MeetingCancellationV08 : IOuterRecord<MeetingCancellationV08,MeetingCancellationV08Document>
    ,IIsoXmlSerilizable<MeetingCancellationV08>, ISerializeInsideARootElement
{
    ...
    public static MeetingCancellationV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingCancellationV08Document : IOuterDocument<MeetingCancellationV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingCancellationV08.XmlTag)]
    public required MeetingCancellationV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingCancellationV08.XmlTag);
