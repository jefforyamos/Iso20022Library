...
/// The MeetingCancellation message is used to advise that the meeting has been cancelled by the account servicer or withdrawn by the issuer. 
/// This message definition is intended for use with the Business Application Header (BAH).
/// This is the outer document that contains <seealso cref="MeetingCancellationV09"/>.
/// </summary>
[Serializable]
[DataContract(Name = DocumentElementName, Namespace = DocumentNamespace )]
[XmlRoot(ElementName = DocumentElementName, Namespace = DocumentNamespace )]
public partial record MeetingCancellationV09Document : IOuterDocument<MeetingCancellationV09>
{
