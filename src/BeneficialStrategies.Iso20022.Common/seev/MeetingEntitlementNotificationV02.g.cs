...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingEntitlementNotificationV02>;
...
public partial record MeetingEntitlementNotificationV02 : IOuterRecord<MeetingEntitlementNotificationV02,MeetingEntitlementNotificationV02Document>
    ,IIsoXmlSerilizable<MeetingEntitlementNotificationV02>, ISerializeInsideARootElement
{
    ...
    {
        writer.WriteStartElement(null, "EntitlmntNtfctnId", xmlNamespace );
        EntitlementNotificationIdentification.Serialize(writer, xmlNamespace);
    ...
    public static MeetingEntitlementNotificationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingEntitlementNotificationV02Document : IOuterDocument<MeetingEntitlementNotificationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingEntitlementNotificationV02.XmlTag)]
    public required MeetingEntitlementNotificationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingEntitlementNotificationV02.XmlTag);
