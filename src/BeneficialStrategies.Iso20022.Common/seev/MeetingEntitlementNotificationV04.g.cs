...
/// </summary>
[Serializable]
public partial record MeetingEntitlementNotificationV04Document : IOuterDocument<MeetingEntitlementNotificationV04>
{
    ...
    #else
    public MeetingEntitlementNotificationV04 Message { get; init; }
    #endif
}
