...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingEntitlementNotificationV06>;
...
public partial record MeetingEntitlementNotificationV06 : IOuterRecord<MeetingEntitlementNotificationV06,MeetingEntitlementNotificationV06Document>
    ,IIsoXmlSerilizable<MeetingEntitlementNotificationV06>, ISerializeInsideARootElement
{
    ...
    public required ValueList<SecurityPosition11> Security { get; init; } = []; // Min=1, Max=200
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (MeetingAttendee is PartyIdentification223Choice_ MeetingAttendeeValue)
        {
    ...
    public static MeetingEntitlementNotificationV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingEntitlementNotificationV06Document : IOuterDocument<MeetingEntitlementNotificationV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingEntitlementNotificationV06.XmlTag)]
    public required MeetingEntitlementNotificationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingEntitlementNotificationV06.XmlTag);
