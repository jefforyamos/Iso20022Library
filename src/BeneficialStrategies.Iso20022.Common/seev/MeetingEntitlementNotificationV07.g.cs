...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingEntitlementNotificationV07>;
...
public partial record MeetingEntitlementNotificationV07 : IOuterRecord<MeetingEntitlementNotificationV07,MeetingEntitlementNotificationV07Document>
    ,IIsoXmlSerilizable<MeetingEntitlementNotificationV07>, ISerializeInsideARootElement
{
    ...
    public required ValueList<SecurityPosition13> Security { get; init; } = []; // Min=1, Max=200
    ...
    public static MeetingEntitlementNotificationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingEntitlementNotificationV07Document : IOuterDocument<MeetingEntitlementNotificationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingEntitlementNotificationV07.XmlTag)]
    public required MeetingEntitlementNotificationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingEntitlementNotificationV07.XmlTag);
