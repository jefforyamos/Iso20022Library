...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingEntitlementNotificationV08>;
...
public partial record MeetingEntitlementNotificationV08 : IOuterRecord<MeetingEntitlementNotificationV08,MeetingEntitlementNotificationV08Document>
    ,IIsoXmlSerilizable<MeetingEntitlementNotificationV08>, ISerializeInsideARootElement
{
    ...
    public required ValueList<SecurityPosition14> Security { get; init; } = []; // Min=1, Max=200
    ...
    public static MeetingEntitlementNotificationV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingEntitlementNotificationV08Document : IOuterDocument<MeetingEntitlementNotificationV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingEntitlementNotificationV08.XmlTag)]
    public required MeetingEntitlementNotificationV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingEntitlementNotificationV08.XmlTag);
