...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingInstructionStatusV08>;
...
public partial record MeetingInstructionStatusV08 : IOuterRecord<MeetingInstructionStatusV08,MeetingInstructionStatusV08Document>
    ,IIsoXmlSerilizable<MeetingInstructionStatusV08>, ISerializeInsideARootElement
{
    ...
    public required ValueList<PartyIdentification237Choice_> RightsHolder { get; init; } = []; // Min=0, Max=250
    ...
    public static MeetingInstructionStatusV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingInstructionStatusV08Document : IOuterDocument<MeetingInstructionStatusV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingInstructionStatusV08.XmlTag)]
    public required MeetingInstructionStatusV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingInstructionStatusV08.XmlTag);
