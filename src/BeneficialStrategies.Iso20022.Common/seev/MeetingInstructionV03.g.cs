...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingInstructionV03>;
...
public partial record MeetingInstructionV03 : IOuterRecord<MeetingInstructionV03,MeetingInstructionV03Document>
    ,IIsoXmlSerilizable<MeetingInstructionV03>, ISerializeInsideARootElement
{
    ...
    public static MeetingInstructionV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingInstructionV03Document : IOuterDocument<MeetingInstructionV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingInstructionV03.XmlTag)]
    public required MeetingInstructionV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingInstructionV03.XmlTag);
