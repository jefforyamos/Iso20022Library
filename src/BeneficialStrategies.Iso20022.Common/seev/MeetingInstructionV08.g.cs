...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingInstructionV08>;
...
public partial record MeetingInstructionV08 : IOuterRecord<MeetingInstructionV08,MeetingInstructionV08Document>
    ,IIsoXmlSerilizable<MeetingInstructionV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => MeetingInstructionV08Document.DocumentNamespace;
    ...
    public static MeetingInstructionV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingInstructionV08Document : IOuterDocument<MeetingInstructionV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingInstructionV08.XmlTag)]
    public required MeetingInstructionV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingInstructionV08.XmlTag);
