...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingNotificationV03>;
...
public partial record MeetingNotificationV03 : IOuterRecord<MeetingNotificationV03,MeetingNotificationV03Document>
    ,IIsoXmlSerilizable<MeetingNotificationV03>, ISerializeInsideARootElement
{
    ...
    public required ValueList<Meeting3> MeetingDetails { get; init; } = []; // Min=1, Max=5
    ...
    public required ValueList<IssuerAgent1> IssuerAgent { get; init; } = []; // Min=0, Max=10
    ...
    public required ValueList<Resolution2> Resolution { get; init; } = []; // Min=0, Max=1000
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Vote is VoteParameters2 VoteValue)
        {
        ...
        EntitlementSpecification.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
        if (PowerOfAttorneyRequirements is PowerOfAttorneyRequirements2 PowerOfAttorneyRequirementsValue)
        {
    ...
    public static MeetingNotificationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingNotificationV03Document : IOuterDocument<MeetingNotificationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingNotificationV03.XmlTag)]
    public required MeetingNotificationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingNotificationV03.XmlTag);
