...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingNotificationV04>;
...
public partial record MeetingNotificationV04 : IOuterRecord<MeetingNotificationV04,MeetingNotificationV04Document>
    ,IIsoXmlSerilizable<MeetingNotificationV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Vote is VoteParameters3 VoteValue)
        {
    ...
    public static MeetingNotificationV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingNotificationV04Document : IOuterDocument<MeetingNotificationV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingNotificationV04.XmlTag)]
    public required MeetingNotificationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingNotificationV04.XmlTag);
