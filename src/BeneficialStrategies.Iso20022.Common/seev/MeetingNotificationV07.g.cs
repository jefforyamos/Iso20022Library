...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingNotificationV07>;
...
public partial record MeetingNotificationV07 : IOuterRecord<MeetingNotificationV07,MeetingNotificationV07Document>
    ,IIsoXmlSerilizable<MeetingNotificationV07>, ISerializeInsideARootElement
{
    ...
    public static MeetingNotificationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingNotificationV07Document : IOuterDocument<MeetingNotificationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingNotificationV07.XmlTag)]
    public required MeetingNotificationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingNotificationV07.XmlTag);
