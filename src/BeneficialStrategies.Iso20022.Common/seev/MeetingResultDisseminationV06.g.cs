...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.MeetingResultDisseminationV06>;
...
public partial record MeetingResultDisseminationV06 : IOuterRecord<MeetingResultDisseminationV06,MeetingResultDisseminationV06Document>
    ,IIsoXmlSerilizable<MeetingResultDisseminationV06>, ISerializeInsideARootElement
{
    ...
    public required ValueList<Vote12> VoteResult { get; init; } = []; // Min=1, Max=1000
    ...
    public static MeetingResultDisseminationV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record MeetingResultDisseminationV06Document : IOuterDocument<MeetingResultDisseminationV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=MeetingResultDisseminationV06.XmlTag)]
    public required MeetingResultDisseminationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(MeetingResultDisseminationV06.XmlTag);
