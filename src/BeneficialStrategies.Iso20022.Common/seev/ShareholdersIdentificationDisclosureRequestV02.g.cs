...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.seev.ShareholdersIdentificationDisclosureRequestV02>;
...
public partial record ShareholdersIdentificationDisclosureRequestV02 : IOuterRecord<ShareholdersIdentificationDisclosureRequestV02,ShareholdersIdentificationDisclosureRequestV02Document>
    ,IIsoXmlSerilizable<ShareholdersIdentificationDisclosureRequestV02>, ISerializeInsideARootElement
{
    ...
    public static ShareholdersIdentificationDisclosureRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ShareholdersIdentificationDisclosureRequestV02Document : IOuterDocument<ShareholdersIdentificationDisclosureRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ShareholdersIdentificationDisclosureRequestV02.XmlTag)]
    public required ShareholdersIdentificationDisclosureRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ShareholdersIdentificationDisclosureRequestV02.XmlTag);
