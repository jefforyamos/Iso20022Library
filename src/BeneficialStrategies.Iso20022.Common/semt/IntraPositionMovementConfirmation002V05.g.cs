...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementConfirmation002V05>;
...
public partial record IntraPositionMovementConfirmation002V05 : IOuterRecord<IntraPositionMovementConfirmation002V05,IntraPositionMovementConfirmation002V05Document>
    ,IIsoXmlSerilizable<IntraPositionMovementConfirmation002V05>, ISerializeInsideARootElement
{
    ...
    public static IntraPositionMovementConfirmation002V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementConfirmation002V05Document : IOuterDocument<IntraPositionMovementConfirmation002V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementConfirmation002V05.XmlTag)]
    public required IntraPositionMovementConfirmation002V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementConfirmation002V05.XmlTag);
