...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementConfirmation002V08>;
...
public partial record IntraPositionMovementConfirmation002V08 : IOuterRecord<IntraPositionMovementConfirmation002V08,IntraPositionMovementConfirmation002V08Document>
    ,IIsoXmlSerilizable<IntraPositionMovementConfirmation002V08>, ISerializeInsideARootElement
{
    ...
    public static IntraPositionMovementConfirmation002V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementConfirmation002V08Document : IOuterDocument<IntraPositionMovementConfirmation002V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementConfirmation002V08.XmlTag)]
    public required IntraPositionMovementConfirmation002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementConfirmation002V08.XmlTag);
