...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementConfirmationV01>;
...
public partial record IntraPositionMovementConfirmationV01 : IOuterRecord<IntraPositionMovementConfirmationV01,IntraPositionMovementConfirmationV01Document>
    ,IIsoXmlSerilizable<IntraPositionMovementConfirmationV01>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalParameters is AdditionalParameters3 AdditionalParametersValue)
        {
    ...
    public static IntraPositionMovementConfirmationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementConfirmationV01Document : IOuterDocument<IntraPositionMovementConfirmationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementConfirmationV01.XmlTag)]
    public required IntraPositionMovementConfirmationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementConfirmationV01.XmlTag);
