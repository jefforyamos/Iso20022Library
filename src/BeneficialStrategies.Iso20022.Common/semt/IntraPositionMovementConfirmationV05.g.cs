...
//
// Generated by MainMessageGenerator for IntraPositionMovementConfirmationV05.  ISO2002 ID# _XVkgMQCUEeW_3KiG8SEjHA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementConfirmationV05>;
...
public partial record IntraPositionMovementConfirmationV05 : IOuterRecord<IntraPositionMovementConfirmationV05,IntraPositionMovementConfirmationV05Document>
    ,IIsoXmlSerilizable<IntraPositionMovementConfirmationV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementConfirmationV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="IntraPositionMovementConfirmationV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public IntraPositionMovementConfirmationV05Document ToDocument()
    {
        return new IntraPositionMovementConfirmationV05Document { Message = this };
    }
    ...
    public static IntraPositionMovementConfirmationV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="IntraPositionMovementConfirmationV05"/>.
/// </summary>
[Serializable]
public partial record IntraPositionMovementConfirmationV05Document : IOuterDocument<IntraPositionMovementConfirmationV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="IntraPositionMovementConfirmationV05"/> is required.
    /// </summary>
    [DataMember(Name=IntraPositionMovementConfirmationV05.XmlTag)]
    public required IntraPositionMovementConfirmationV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementConfirmationV05.XmlTag);
