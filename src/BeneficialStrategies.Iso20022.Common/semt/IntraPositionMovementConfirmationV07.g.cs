...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementConfirmationV07>;
...
public partial record IntraPositionMovementConfirmationV07 : IOuterRecord<IntraPositionMovementConfirmationV07,IntraPositionMovementConfirmationV07Document>
    ,IIsoXmlSerilizable<IntraPositionMovementConfirmationV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementConfirmationV07Document.DocumentNamespace;
    ...
    public static IntraPositionMovementConfirmationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementConfirmationV07Document : IOuterDocument<IntraPositionMovementConfirmationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementConfirmationV07.XmlTag)]
    public required IntraPositionMovementConfirmationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementConfirmationV07.XmlTag);
