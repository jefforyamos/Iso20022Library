...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementInstruction002V04>;
...
public partial record IntraPositionMovementInstruction002V04 : IOuterRecord<IntraPositionMovementInstruction002V04,IntraPositionMovementInstruction002V04Document>
    ,IIsoXmlSerilizable<IntraPositionMovementInstruction002V04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Linkages is Linkages42 LinkagesValue)
        {
    ...
    public static IntraPositionMovementInstruction002V04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementInstruction002V04Document : IOuterDocument<IntraPositionMovementInstruction002V04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementInstruction002V04.XmlTag)]
    public required IntraPositionMovementInstruction002V04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementInstruction002V04.XmlTag);
