...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementInstruction002V05>;
...
public partial record IntraPositionMovementInstruction002V05 : IOuterRecord<IntraPositionMovementInstruction002V05,IntraPositionMovementInstruction002V05Document>
    ,IIsoXmlSerilizable<IntraPositionMovementInstruction002V05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementInstruction002V05Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventIdentification is Identification16 CorporateActionEventIdentificationValue)
        {
        ...
        if (Linkages is Linkages60 LinkagesValue)
        {
    ...
    public static IntraPositionMovementInstruction002V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementInstruction002V05Document : IOuterDocument<IntraPositionMovementInstruction002V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementInstruction002V05.XmlTag)]
    public required IntraPositionMovementInstruction002V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementInstruction002V05.XmlTag);
