...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementInstructionV04>;
...
public partial record IntraPositionMovementInstructionV04 : IOuterRecord<IntraPositionMovementInstructionV04,IntraPositionMovementInstructionV04Document>
    ,IIsoXmlSerilizable<IntraPositionMovementInstructionV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Linkages is Linkages36 LinkagesValue)
        {
    ...
    public static IntraPositionMovementInstructionV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementInstructionV04Document : IOuterDocument<IntraPositionMovementInstructionV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementInstructionV04.XmlTag)]
    public required IntraPositionMovementInstructionV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementInstructionV04.XmlTag);
