...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementInstructionV05>;
...
public partial record IntraPositionMovementInstructionV05 : IOuterRecord<IntraPositionMovementInstructionV05,IntraPositionMovementInstructionV05Document>
    ,IIsoXmlSerilizable<IntraPositionMovementInstructionV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementInstructionV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="IntraPositionMovementInstructionV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public IntraPositionMovementInstructionV05Document ToDocument()
    {
        return new IntraPositionMovementInstructionV05Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionEventIdentification is Identification14 CorporateActionEventIdentificationValue)
        {
    ...
    public static IntraPositionMovementInstructionV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="IntraPositionMovementInstructionV05"/>.
/// </summary>
[Serializable]
public partial record IntraPositionMovementInstructionV05Document : IOuterDocument<IntraPositionMovementInstructionV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="IntraPositionMovementInstructionV05"/> is required.
    /// </summary>
    [DataMember(Name=IntraPositionMovementInstructionV05.XmlTag)]
    public required IntraPositionMovementInstructionV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementInstructionV05.XmlTag);
