...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementPostingReport002V05>;
...
public partial record IntraPositionMovementPostingReport002V05 : IOuterRecord<IntraPositionMovementPostingReport002V05,IntraPositionMovementPostingReport002V05Document>
    ,IIsoXmlSerilizable<IntraPositionMovementPostingReport002V05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrument is FinancialInstrumentDetails22 FinancialInstrumentValue)
        {
    ...
    public static IntraPositionMovementPostingReport002V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementPostingReport002V05Document : IOuterDocument<IntraPositionMovementPostingReport002V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementPostingReport002V05.XmlTag)]
    public required IntraPositionMovementPostingReport002V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementPostingReport002V05.XmlTag);
