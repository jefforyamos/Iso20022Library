...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementPostingReport002V07>;
...
public partial record IntraPositionMovementPostingReport002V07 : IOuterRecord<IntraPositionMovementPostingReport002V07,IntraPositionMovementPostingReport002V07Document>
    ,IIsoXmlSerilizable<IntraPositionMovementPostingReport002V07>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrument is FinancialInstrumentDetails30 FinancialInstrumentValue)
        {
    ...
    public static IntraPositionMovementPostingReport002V07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementPostingReport002V07Document : IOuterDocument<IntraPositionMovementPostingReport002V07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementPostingReport002V07.XmlTag)]
    public required IntraPositionMovementPostingReport002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementPostingReport002V07.XmlTag);
