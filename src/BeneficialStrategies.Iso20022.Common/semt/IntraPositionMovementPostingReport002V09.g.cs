...
//
// Generated by MainMessageGenerator for IntraPositionMovementPostingReport002V09.  ISO2002 ID# _ccnLIzi8Eeydid5dcNPKvg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementPostingReport002V09>;
...
public partial record IntraPositionMovementPostingReport002V09 : IOuterRecord<IntraPositionMovementPostingReport002V09,IntraPositionMovementPostingReport002V09Document>
    ,IIsoXmlSerilizable<IntraPositionMovementPostingReport002V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementPostingReport002V09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="IntraPositionMovementPostingReport002V09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public IntraPositionMovementPostingReport002V09Document ToDocument()
    {
        return new IntraPositionMovementPostingReport002V09Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrument is FinancialInstrumentDetails44 FinancialInstrumentValue)
        {
    ...
    public static IntraPositionMovementPostingReport002V09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="IntraPositionMovementPostingReport002V09"/>.
/// </summary>
[Serializable]
public partial record IntraPositionMovementPostingReport002V09Document : IOuterDocument<IntraPositionMovementPostingReport002V09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="IntraPositionMovementPostingReport002V09"/> is required.
    /// </summary>
    [DataMember(Name=IntraPositionMovementPostingReport002V09.XmlTag)]
    public required IntraPositionMovementPostingReport002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementPostingReport002V09.XmlTag);
