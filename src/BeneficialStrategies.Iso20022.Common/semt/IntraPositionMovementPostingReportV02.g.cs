...
/// </summary>
[Serializable]
public partial record IntraPositionMovementPostingReportV02Document : IOuterDocument<IntraPositionMovementPostingReportV02>
{
    ...
    #else
    public IntraPositionMovementPostingReportV02 Message { get; init; }
    #endif
}
