...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementPostingReportV02>;
...
public partial record IntraPositionMovementPostingReportV02 : IOuterRecord<IntraPositionMovementPostingReportV02,IntraPositionMovementPostingReportV02Document>
    ,IIsoXmlSerilizable<IntraPositionMovementPostingReportV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementPostingReportV02Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="IntraPositionMovementPostingReportV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public IntraPositionMovementPostingReportV02Document ToDocument()
    {
        return new IntraPositionMovementPostingReportV02Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrument is FinancialInstrumentDetails6 FinancialInstrumentValue)
        {
    ...
    public static IntraPositionMovementPostingReportV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="IntraPositionMovementPostingReportV02"/>.
/// </summary>
[Serializable]
public partial record IntraPositionMovementPostingReportV02Document : IOuterDocument<IntraPositionMovementPostingReportV02>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="IntraPositionMovementPostingReportV02"/> is required.
    /// </summary>
    [DataMember(Name=IntraPositionMovementPostingReportV02.XmlTag)]
    public required IntraPositionMovementPostingReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementPostingReportV02.XmlTag);
