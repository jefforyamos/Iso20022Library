...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementPostingReportV04>;
...
public partial record IntraPositionMovementPostingReportV04 : IOuterRecord<IntraPositionMovementPostingReportV04,IntraPositionMovementPostingReportV04Document>
    ,IIsoXmlSerilizable<IntraPositionMovementPostingReportV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrument is FinancialInstrumentDetails14 FinancialInstrumentValue)
        {
    ...
    public static IntraPositionMovementPostingReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementPostingReportV04Document : IOuterDocument<IntraPositionMovementPostingReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementPostingReportV04.XmlTag)]
    public required IntraPositionMovementPostingReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementPostingReportV04.XmlTag);
