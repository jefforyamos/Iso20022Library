...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementPostingReportV05>;
...
public partial record IntraPositionMovementPostingReportV05 : IOuterRecord<IntraPositionMovementPostingReportV05,IntraPositionMovementPostingReportV05Document>
    ,IIsoXmlSerilizable<IntraPositionMovementPostingReportV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementPostingReportV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="IntraPositionMovementPostingReportV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public IntraPositionMovementPostingReportV05Document ToDocument()
    {
        return new IntraPositionMovementPostingReportV05Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrument is FinancialInstrumentDetails21 FinancialInstrumentValue)
        {
    ...
    public static IntraPositionMovementPostingReportV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="IntraPositionMovementPostingReportV05"/>.
/// </summary>
[Serializable]
public partial record IntraPositionMovementPostingReportV05Document : IOuterDocument<IntraPositionMovementPostingReportV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="IntraPositionMovementPostingReportV05"/> is required.
    /// </summary>
    [DataMember(Name=IntraPositionMovementPostingReportV05.XmlTag)]
    public required IntraPositionMovementPostingReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementPostingReportV05.XmlTag);
