...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementPostingReportV09>;
...
public partial record IntraPositionMovementPostingReportV09 : IOuterRecord<IntraPositionMovementPostingReportV09,IntraPositionMovementPostingReportV09Document>
    ,IIsoXmlSerilizable<IntraPositionMovementPostingReportV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementPostingReportV09Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (FinancialInstrument is FinancialInstrumentDetails40 FinancialInstrumentValue)
        {
    ...
    public static IntraPositionMovementPostingReportV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementPostingReportV09Document : IOuterDocument<IntraPositionMovementPostingReportV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementPostingReportV09.XmlTag)]
    public required IntraPositionMovementPostingReportV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementPostingReportV09.XmlTag);
