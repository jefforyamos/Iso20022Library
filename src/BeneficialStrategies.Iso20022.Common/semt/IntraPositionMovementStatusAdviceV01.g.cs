...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementStatusAdviceV01>;
...
public partial record IntraPositionMovementStatusAdviceV01 : IOuterRecord<IntraPositionMovementStatusAdviceV01,IntraPositionMovementStatusAdviceV01Document>
    ,IIsoXmlSerilizable<IntraPositionMovementStatusAdviceV01>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is IntraPositionDetails4 TransactionDetailsValue)
        {
    ...
    public static IntraPositionMovementStatusAdviceV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementStatusAdviceV01Document : IOuterDocument<IntraPositionMovementStatusAdviceV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementStatusAdviceV01.XmlTag)]
    public required IntraPositionMovementStatusAdviceV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementStatusAdviceV01.XmlTag);
