...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementStatusAdviceV05>;
...
public partial record IntraPositionMovementStatusAdviceV05 : IOuterRecord<IntraPositionMovementStatusAdviceV05,IntraPositionMovementStatusAdviceV05Document>
    ,IIsoXmlSerilizable<IntraPositionMovementStatusAdviceV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => IntraPositionMovementStatusAdviceV05Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is IntraPositionDetails39 TransactionDetailsValue)
        {
    ...
    public static IntraPositionMovementStatusAdviceV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementStatusAdviceV05Document : IOuterDocument<IntraPositionMovementStatusAdviceV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementStatusAdviceV05.XmlTag)]
    public required IntraPositionMovementStatusAdviceV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementStatusAdviceV05.XmlTag);
