...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementStatusAdviceV06>;
...
public partial record IntraPositionMovementStatusAdviceV06 : IOuterRecord<IntraPositionMovementStatusAdviceV06,IntraPositionMovementStatusAdviceV06Document>
    ,IIsoXmlSerilizable<IntraPositionMovementStatusAdviceV06>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProcessingStatus is IntraPositionProcessingStatus7Choice_ ProcessingStatusValue)
        {
        ...
        if (TransactionDetails is IntraPositionDetails49 TransactionDetailsValue)
        {
    ...
    public static IntraPositionMovementStatusAdviceV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementStatusAdviceV06Document : IOuterDocument<IntraPositionMovementStatusAdviceV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementStatusAdviceV06.XmlTag)]
    public required IntraPositionMovementStatusAdviceV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementStatusAdviceV06.XmlTag);
