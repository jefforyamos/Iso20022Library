...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.IntraPositionMovementStatusAdviceV07>;
...
public partial record IntraPositionMovementStatusAdviceV07 : IOuterRecord<IntraPositionMovementStatusAdviceV07,IntraPositionMovementStatusAdviceV07Document>
    ,IIsoXmlSerilizable<IntraPositionMovementStatusAdviceV07>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProcessingStatus is IntraPositionProcessingStatus9Choice_ ProcessingStatusValue)
        {
        ...
        if (TransactionDetails is IntraPositionDetails60 TransactionDetailsValue)
        {
    ...
    public static IntraPositionMovementStatusAdviceV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record IntraPositionMovementStatusAdviceV07Document : IOuterDocument<IntraPositionMovementStatusAdviceV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=IntraPositionMovementStatusAdviceV07.XmlTag)]
    public required IntraPositionMovementStatusAdviceV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(IntraPositionMovementStatusAdviceV07.XmlTag);
