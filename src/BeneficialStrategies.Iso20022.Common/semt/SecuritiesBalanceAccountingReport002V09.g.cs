...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceAccountingReport002V09>;
...
public partial record SecuritiesBalanceAccountingReport002V09 : IOuterRecord<SecuritiesBalanceAccountingReport002V09,SecuritiesBalanceAccountingReport002V09Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceAccountingReport002V09>, ISerializeInsideARootElement
{
    ...
    public required ValueList<Intermediary37> IntermediaryInformation { get; init; } = []; // Min=0, Max=10
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AccountServicer is PartyIdentification111 AccountServicerValue)
        {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation32 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification45 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceAccountingReport002V09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceAccountingReport002V09Document : IOuterDocument<SecuritiesBalanceAccountingReport002V09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceAccountingReport002V09.XmlTag)]
    public required SecuritiesBalanceAccountingReport002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceAccountingReport002V09.XmlTag);
