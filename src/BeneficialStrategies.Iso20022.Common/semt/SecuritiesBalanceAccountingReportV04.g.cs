...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceAccountingReportV04>;
...
public partial record SecuritiesBalanceAccountingReportV04 : IOuterRecord<SecuritiesBalanceAccountingReportV04,SecuritiesBalanceAccountingReportV04Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceAccountingReportV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesBalanceAccountingReportV04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation13 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification16 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceAccountingReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceAccountingReportV04Document : IOuterDocument<SecuritiesBalanceAccountingReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceAccountingReportV04.XmlTag)]
    public required SecuritiesBalanceAccountingReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceAccountingReportV04.XmlTag);
