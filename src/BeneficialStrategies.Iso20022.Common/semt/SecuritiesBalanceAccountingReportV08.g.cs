...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceAccountingReportV08>;
...
public partial record SecuritiesBalanceAccountingReportV08 : IOuterRecord<SecuritiesBalanceAccountingReportV08,SecuritiesBalanceAccountingReportV08Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceAccountingReportV08>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation26 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification38 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceAccountingReportV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceAccountingReportV08Document : IOuterDocument<SecuritiesBalanceAccountingReportV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceAccountingReportV08.XmlTag)]
    public required SecuritiesBalanceAccountingReportV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceAccountingReportV08.XmlTag);
