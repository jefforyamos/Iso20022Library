...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceAccountingReportV10>;
...
public partial record SecuritiesBalanceAccountingReportV10 : IOuterRecord<SecuritiesBalanceAccountingReportV10,SecuritiesBalanceAccountingReportV10Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceAccountingReportV10>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation37 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification56 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceAccountingReportV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceAccountingReportV10Document : IOuterDocument<SecuritiesBalanceAccountingReportV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceAccountingReportV10.XmlTag)]
    public required SecuritiesBalanceAccountingReportV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceAccountingReportV10.XmlTag);
