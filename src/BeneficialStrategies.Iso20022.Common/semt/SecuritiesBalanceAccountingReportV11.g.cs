...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceAccountingReportV11>;
...
public partial record SecuritiesBalanceAccountingReportV11 : IOuterRecord<SecuritiesBalanceAccountingReportV11,SecuritiesBalanceAccountingReportV11Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceAccountingReportV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesBalanceAccountingReportV11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SafekeepingAccount is SecuritiesAccount26 SafekeepingAccountValue)
        {
            writer.WriteStartElement(null, "SfkpgAcct", xmlNamespace );
            SafekeepingAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (BlockChainAddressOrWallet is BlockChainAddressWallet1 BlockChainAddressOrWalletValue)
        {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation40 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification65 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceAccountingReportV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceAccountingReportV11Document : IOuterDocument<SecuritiesBalanceAccountingReportV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceAccountingReportV11.XmlTag)]
    public required SecuritiesBalanceAccountingReportV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceAccountingReportV11.XmlTag);
