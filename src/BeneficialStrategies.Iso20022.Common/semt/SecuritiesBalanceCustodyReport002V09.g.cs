...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceCustodyReport002V09>;
...
public partial record SecuritiesBalanceCustodyReport002V09 : IOuterRecord<SecuritiesBalanceCustodyReport002V09,SecuritiesBalanceCustodyReport002V09Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceCustodyReport002V09>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation33 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification46 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceCustodyReport002V09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceCustodyReport002V09Document : IOuterDocument<SecuritiesBalanceCustodyReport002V09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceCustodyReport002V09.XmlTag)]
    public required SecuritiesBalanceCustodyReport002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceCustodyReport002V09.XmlTag);
