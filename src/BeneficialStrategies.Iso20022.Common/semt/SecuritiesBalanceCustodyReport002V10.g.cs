...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceCustodyReport002V10>;
...
public partial record SecuritiesBalanceCustodyReport002V10 : IOuterRecord<SecuritiesBalanceCustodyReport002V10,SecuritiesBalanceCustodyReport002V10Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceCustodyReport002V10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesBalanceCustodyReport002V10Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesBalanceCustodyReport002V10Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesBalanceCustodyReport002V10Document ToDocument()
    {
        return new SecuritiesBalanceCustodyReport002V10Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation39 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification58 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceCustodyReport002V10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesBalanceCustodyReport002V10"/>.
/// </summary>
[Serializable]
public partial record SecuritiesBalanceCustodyReport002V10Document : IOuterDocument<SecuritiesBalanceCustodyReport002V10>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesBalanceCustodyReport002V10"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesBalanceCustodyReport002V10.XmlTag)]
    public required SecuritiesBalanceCustodyReport002V10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceCustodyReport002V10.XmlTag);
