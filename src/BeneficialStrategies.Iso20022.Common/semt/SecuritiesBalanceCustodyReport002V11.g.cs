...
//
// Generated by MainMessageGenerator for SecuritiesBalanceCustodyReport002V11.  ISO2002 ID# _csT0Azi8Eeydid5dcNPKvg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceCustodyReport002V11>;
...
public partial record SecuritiesBalanceCustodyReport002V11 : IOuterRecord<SecuritiesBalanceCustodyReport002V11,SecuritiesBalanceCustodyReport002V11Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceCustodyReport002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesBalanceCustodyReport002V11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesBalanceCustodyReport002V11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesBalanceCustodyReport002V11Document ToDocument()
    {
        return new SecuritiesBalanceCustodyReport002V11Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation44 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification69 SubAccountDetailsValue)
        {
            writer.WriteStartElement(null, "SubAcctDtls", xmlNamespace );
            SubAccountDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (AccountBaseCurrencyTotalAmounts is TotalValueInPageAndStatement3 AccountBaseCurrencyTotalAmountsValue)
        {
    ...
    public static SecuritiesBalanceCustodyReport002V11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesBalanceCustodyReport002V11"/>.
/// </summary>
[Serializable]
public partial record SecuritiesBalanceCustodyReport002V11Document : IOuterDocument<SecuritiesBalanceCustodyReport002V11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesBalanceCustodyReport002V11"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesBalanceCustodyReport002V11.XmlTag)]
    public required SecuritiesBalanceCustodyReport002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceCustodyReport002V11.XmlTag);
