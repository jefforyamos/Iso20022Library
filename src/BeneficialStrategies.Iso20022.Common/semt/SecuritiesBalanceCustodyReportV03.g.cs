...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceCustodyReportV03>;
...
public partial record SecuritiesBalanceCustodyReportV03 : IOuterRecord<SecuritiesBalanceCustodyReportV03,SecuritiesBalanceCustodyReportV03Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceCustodyReportV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation9 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification11 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceCustodyReportV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceCustodyReportV03Document : IOuterDocument<SecuritiesBalanceCustodyReportV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceCustodyReportV03.XmlTag)]
    public required SecuritiesBalanceCustodyReportV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceCustodyReportV03.XmlTag);
