...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceCustodyReportV05>;
...
public partial record SecuritiesBalanceCustodyReportV05 : IOuterRecord<SecuritiesBalanceCustodyReportV05,SecuritiesBalanceCustodyReportV05Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceCustodyReportV05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation16 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification22 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceCustodyReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceCustodyReportV05Document : IOuterDocument<SecuritiesBalanceCustodyReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceCustodyReportV05.XmlTag)]
    public required SecuritiesBalanceCustodyReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceCustodyReportV05.XmlTag);
