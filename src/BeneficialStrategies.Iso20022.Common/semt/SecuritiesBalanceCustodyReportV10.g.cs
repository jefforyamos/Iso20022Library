...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceCustodyReportV10>;
...
public partial record SecuritiesBalanceCustodyReportV10 : IOuterRecord<SecuritiesBalanceCustodyReportV10,SecuritiesBalanceCustodyReportV10Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceCustodyReportV10>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation35 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification55 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceCustodyReportV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesBalanceCustodyReportV10Document : IOuterDocument<SecuritiesBalanceCustodyReportV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceCustodyReportV10.XmlTag)]
    public required SecuritiesBalanceCustodyReportV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceCustodyReportV10.XmlTag);
