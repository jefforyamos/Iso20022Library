...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesBalanceCustodyReportV11>;
...
public partial record SecuritiesBalanceCustodyReportV11 : IOuterRecord<SecuritiesBalanceCustodyReportV11,SecuritiesBalanceCustodyReportV11Document>
    ,IIsoXmlSerilizable<SecuritiesBalanceCustodyReportV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesBalanceCustodyReportV11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (BalanceForAccount is AggregateBalanceInformation42 BalanceForAccountValue)
        {
            writer.WriteStartElement(null, "BalForAcct", xmlNamespace );
            BalanceForAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification67 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesBalanceCustodyReportV11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesBalanceCustodyReportV11"/>.
/// </summary>
[Serializable]
public partial record SecuritiesBalanceCustodyReportV11Document : IOuterDocument<SecuritiesBalanceCustodyReportV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesBalanceCustodyReportV11.XmlTag)]
    public required SecuritiesBalanceCustodyReportV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesBalanceCustodyReportV11.XmlTag);
