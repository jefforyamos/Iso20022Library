...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesMessageCancellationAdvice002V05>;
...
public partial record SecuritiesMessageCancellationAdvice002V05 : IOuterRecord<SecuritiesMessageCancellationAdvice002V05,SecuritiesMessageCancellationAdvice002V05Document>
    ,IIsoXmlSerilizable<SecuritiesMessageCancellationAdvice002V05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesMessageCancellationAdvice002V05Document.DocumentNamespace;
    ...
    public static SecuritiesMessageCancellationAdvice002V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesMessageCancellationAdvice002V05Document : IOuterDocument<SecuritiesMessageCancellationAdvice002V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesMessageCancellationAdvice002V05.XmlTag)]
    public required SecuritiesMessageCancellationAdvice002V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesMessageCancellationAdvice002V05.XmlTag);
