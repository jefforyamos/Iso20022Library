...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesMessageCancellationAdviceV03>;
...
public partial record SecuritiesMessageCancellationAdviceV03 : IOuterRecord<SecuritiesMessageCancellationAdviceV03,SecuritiesMessageCancellationAdviceV03Document>
    ,IIsoXmlSerilizable<SecuritiesMessageCancellationAdviceV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesMessageCancellationAdviceV03Document.DocumentNamespace;
    ...
    public static SecuritiesMessageCancellationAdviceV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesMessageCancellationAdviceV03Document : IOuterDocument<SecuritiesMessageCancellationAdviceV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesMessageCancellationAdviceV03.XmlTag)]
    public required SecuritiesMessageCancellationAdviceV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesMessageCancellationAdviceV03.XmlTag);
