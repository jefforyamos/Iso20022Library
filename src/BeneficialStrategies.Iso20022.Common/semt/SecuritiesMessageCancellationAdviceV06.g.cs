...
//
// Generated by MainMessageGenerator for SecuritiesMessageCancellationAdviceV06.  ISO2002 ID# _d30QMQmEEeuQ1MenzX1l-g.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesMessageCancellationAdviceV06>;
...
public partial record SecuritiesMessageCancellationAdviceV06 : IOuterRecord<SecuritiesMessageCancellationAdviceV06,SecuritiesMessageCancellationAdviceV06Document>
    ,IIsoXmlSerilizable<SecuritiesMessageCancellationAdviceV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesMessageCancellationAdviceV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesMessageCancellationAdviceV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesMessageCancellationAdviceV06Document ToDocument()
    {
        return new SecuritiesMessageCancellationAdviceV06Document { Message = this };
    }
    ...
    public static SecuritiesMessageCancellationAdviceV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesMessageCancellationAdviceV06"/>.
/// </summary>
[Serializable]
public partial record SecuritiesMessageCancellationAdviceV06Document : IOuterDocument<SecuritiesMessageCancellationAdviceV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesMessageCancellationAdviceV06"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesMessageCancellationAdviceV06.XmlTag)]
    public required SecuritiesMessageCancellationAdviceV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesMessageCancellationAdviceV06.XmlTag);
