...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesSettlementTransactionAllegementReport002V10>;
...
public partial record SecuritiesSettlementTransactionAllegementReport002V10 : IOuterRecord<SecuritiesSettlementTransactionAllegementReport002V10,SecuritiesSettlementTransactionAllegementReport002V10Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionAllegementReport002V10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionAllegementReport002V10Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AllegementDetails is SecuritiesTradeDetails140 AllegementDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionAllegementReport002V10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionAllegementReport002V10Document : IOuterDocument<SecuritiesSettlementTransactionAllegementReport002V10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionAllegementReport002V10.XmlTag)]
    public required SecuritiesSettlementTransactionAllegementReport002V10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionAllegementReport002V10.XmlTag);
