...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesSettlementTransactionAllegementReportV01>;
...
public partial record SecuritiesSettlementTransactionAllegementReportV01 : IOuterRecord<SecuritiesSettlementTransactionAllegementReportV01,SecuritiesSettlementTransactionAllegementReportV01Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionAllegementReportV01>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AllegementDetails is SecuritiesTradeDetails4 AllegementDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionAllegementReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionAllegementReportV01Document : IOuterDocument<SecuritiesSettlementTransactionAllegementReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionAllegementReportV01.XmlTag)]
    public required SecuritiesSettlementTransactionAllegementReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionAllegementReportV01.XmlTag);
