...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesSettlementTransactionAllegementReportV05>;
...
public partial record SecuritiesSettlementTransactionAllegementReportV05 : IOuterRecord<SecuritiesSettlementTransactionAllegementReportV05,SecuritiesSettlementTransactionAllegementReportV05Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionAllegementReportV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionAllegementReportV05Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AllegementDetails is SecuritiesTradeDetails49 AllegementDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionAllegementReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionAllegementReportV05Document : IOuterDocument<SecuritiesSettlementTransactionAllegementReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionAllegementReportV05.XmlTag)]
    public required SecuritiesSettlementTransactionAllegementReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionAllegementReportV05.XmlTag);
