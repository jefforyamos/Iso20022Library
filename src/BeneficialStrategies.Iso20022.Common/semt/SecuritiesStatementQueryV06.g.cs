...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesStatementQueryV06>;
...
public partial record SecuritiesStatementQueryV06 : IOuterRecord<SecuritiesStatementQueryV06,SecuritiesStatementQueryV06Document>
    ,IIsoXmlSerilizable<SecuritiesStatementQueryV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesStatementQueryV06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (StatementGeneralDetails is Statement42 StatementGeneralDetailsValue)
        {
    ...
    public static SecuritiesStatementQueryV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesStatementQueryV06Document : IOuterDocument<SecuritiesStatementQueryV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesStatementQueryV06.XmlTag)]
    public required SecuritiesStatementQueryV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesStatementQueryV06.XmlTag);
