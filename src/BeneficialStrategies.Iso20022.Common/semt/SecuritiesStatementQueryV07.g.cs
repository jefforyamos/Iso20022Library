...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesStatementQueryV07>;
...
public partial record SecuritiesStatementQueryV07 : IOuterRecord<SecuritiesStatementQueryV07,SecuritiesStatementQueryV07Document>
    ,IIsoXmlSerilizable<SecuritiesStatementQueryV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesStatementQueryV07Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (StatementGeneralDetails is Statement83 StatementGeneralDetailsValue)
        {
        ...
        writer.WriteEndElement();
        if (AdditionalQueryParameters is AdditionalQueryParameters11 AdditionalQueryParametersValue)
        {
    ...
    public static SecuritiesStatementQueryV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesStatementQueryV07Document : IOuterDocument<SecuritiesStatementQueryV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesStatementQueryV07.XmlTag)]
    public required SecuritiesStatementQueryV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesStatementQueryV07.XmlTag);
