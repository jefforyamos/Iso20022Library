...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesStatementQueryV08>;
...
public partial record SecuritiesStatementQueryV08 : IOuterRecord<SecuritiesStatementQueryV08,SecuritiesStatementQueryV08Document>
    ,IIsoXmlSerilizable<SecuritiesStatementQueryV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesStatementQueryV08Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalQueryParameters is AdditionalQueryParameters13 AdditionalQueryParametersValue)
        {
    ...
    public static SecuritiesStatementQueryV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesStatementQueryV08Document : IOuterDocument<SecuritiesStatementQueryV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesStatementQueryV08.XmlTag)]
    public required SecuritiesStatementQueryV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesStatementQueryV08.XmlTag);
