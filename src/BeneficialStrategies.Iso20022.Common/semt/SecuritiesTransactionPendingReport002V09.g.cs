...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPendingReport002V09>;
...
public partial record SecuritiesTransactionPendingReport002V09 : IOuterRecord<SecuritiesTransactionPendingReport002V09,SecuritiesTransactionPendingReport002V09Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPendingReport002V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPendingReport002V09Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Status is StatusAndReason35 StatusValue)
        {
            writer.WriteStartElement(null, "Sts", xmlNamespace );
            StatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Transactions is Transaction64 TransactionsValue)
        {
    ...
    public static SecuritiesTransactionPendingReport002V09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPendingReport002V09Document : IOuterDocument<SecuritiesTransactionPendingReport002V09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPendingReport002V09.XmlTag)]
    public required SecuritiesTransactionPendingReport002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPendingReport002V09.XmlTag);
