...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPendingReport002V13>;
...
public partial record SecuritiesTransactionPendingReport002V13 : IOuterRecord<SecuritiesTransactionPendingReport002V13,SecuritiesTransactionPendingReport002V13Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPendingReport002V13>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPendingReport002V13Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Status is StatusAndReason45 StatusValue)
        {
            writer.WriteStartElement(null, "Sts", xmlNamespace );
            StatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Transactions is Transaction125 TransactionsValue)
        {
    ...
    public static SecuritiesTransactionPendingReport002V13 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPendingReport002V13Document : IOuterDocument<SecuritiesTransactionPendingReport002V13>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPendingReport002V13.XmlTag)]
    public required SecuritiesTransactionPendingReport002V13 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPendingReport002V13.XmlTag);
