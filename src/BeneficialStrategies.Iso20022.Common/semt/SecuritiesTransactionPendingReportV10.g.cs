...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPendingReportV10>;
...
public partial record SecuritiesTransactionPendingReportV10 : IOuterRecord<SecuritiesTransactionPendingReportV10,SecuritiesTransactionPendingReportV10Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPendingReportV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPendingReportV10Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesTransactionPendingReportV10Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesTransactionPendingReportV10Document ToDocument()
    {
        return new SecuritiesTransactionPendingReportV10Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Status is StatusAndReason36 StatusValue)
        {
            writer.WriteStartElement(null, "Sts", xmlNamespace );
            StatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Transactions is Transaction68 TransactionsValue)
        {
    ...
    public static SecuritiesTransactionPendingReportV10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesTransactionPendingReportV10"/>.
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPendingReportV10Document : IOuterDocument<SecuritiesTransactionPendingReportV10>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesTransactionPendingReportV10"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPendingReportV10.XmlTag)]
    public required SecuritiesTransactionPendingReportV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPendingReportV10.XmlTag);
