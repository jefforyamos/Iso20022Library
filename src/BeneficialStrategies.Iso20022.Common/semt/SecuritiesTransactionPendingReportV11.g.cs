...
//
// Generated by MainMessageGenerator for SecuritiesTransactionPendingReportV11.  ISO2002 ID# _Y9UqUempEemUgrefIx730g.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPendingReportV11>;
...
public partial record SecuritiesTransactionPendingReportV11 : IOuterRecord<SecuritiesTransactionPendingReportV11,SecuritiesTransactionPendingReportV11Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPendingReportV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPendingReportV11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesTransactionPendingReportV11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesTransactionPendingReportV11Document ToDocument()
    {
        return new SecuritiesTransactionPendingReportV11Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (Status is StatusAndReason40 StatusValue)
        {
            writer.WriteStartElement(null, "Sts", xmlNamespace );
            StatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Transactions is Transaction109 TransactionsValue)
        {
    ...
    public static SecuritiesTransactionPendingReportV11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesTransactionPendingReportV11"/>.
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPendingReportV11Document : IOuterDocument<SecuritiesTransactionPendingReportV11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesTransactionPendingReportV11"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPendingReportV11.XmlTag)]
    public required SecuritiesTransactionPendingReportV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPendingReportV11.XmlTag);
