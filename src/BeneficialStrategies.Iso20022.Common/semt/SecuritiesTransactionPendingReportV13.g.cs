...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPendingReportV13>;
...
public partial record SecuritiesTransactionPendingReportV13 : IOuterRecord<SecuritiesTransactionPendingReportV13,SecuritiesTransactionPendingReportV13Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPendingReportV13>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Status is StatusAndReason44 StatusValue)
        {
            writer.WriteStartElement(null, "Sts", xmlNamespace );
            StatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (Transactions is Transaction121 TransactionsValue)
        {
    ...
    public static SecuritiesTransactionPendingReportV13 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPendingReportV13Document : IOuterDocument<SecuritiesTransactionPendingReportV13>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPendingReportV13.XmlTag)]
    public required SecuritiesTransactionPendingReportV13 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPendingReportV13.XmlTag);
