...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReport002V06>;
...
public partial record SecuritiesTransactionPostingReport002V06 : IOuterRecord<SecuritiesTransactionPostingReport002V06,SecuritiesTransactionPostingReport002V06Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReport002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPostingReport002V06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentDetails is FinancialInstrumentDetails23 FinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "FinInstrmDtls", xmlNamespace );
            FinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification47 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReport002V06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesTransactionPostingReport002V06"/>.
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReport002V06Document : IOuterDocument<SecuritiesTransactionPostingReport002V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReport002V06.XmlTag)]
    public required SecuritiesTransactionPostingReport002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReport002V06.XmlTag);
