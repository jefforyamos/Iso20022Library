...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReport002V07>;
...
public partial record SecuritiesTransactionPostingReport002V07 : IOuterRecord<SecuritiesTransactionPostingReport002V07,SecuritiesTransactionPostingReport002V07Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReport002V07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPostingReport002V07Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentDetails is FinancialInstrumentDetails27 FinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "FinInstrmDtls", xmlNamespace );
            FinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification50 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReport002V07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReport002V07Document : IOuterDocument<SecuritiesTransactionPostingReport002V07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReport002V07.XmlTag)]
    public required SecuritiesTransactionPostingReport002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReport002V07.XmlTag);
