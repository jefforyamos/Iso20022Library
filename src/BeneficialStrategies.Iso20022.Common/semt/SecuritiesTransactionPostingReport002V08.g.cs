...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReport002V08>;
...
public partial record SecuritiesTransactionPostingReport002V08 : IOuterRecord<SecuritiesTransactionPostingReport002V08,SecuritiesTransactionPostingReport002V08Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReport002V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPostingReport002V08Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentDetails is FinancialInstrumentDetails31 FinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "FinInstrmDtls", xmlNamespace );
            FinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification52 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReport002V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReport002V08Document : IOuterDocument<SecuritiesTransactionPostingReport002V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReport002V08.XmlTag)]
    public required SecuritiesTransactionPostingReport002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReport002V08.XmlTag);
