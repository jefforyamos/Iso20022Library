...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReport002V10>;
...
public partial record SecuritiesTransactionPostingReport002V10 : IOuterRecord<SecuritiesTransactionPostingReport002V10,SecuritiesTransactionPostingReport002V10Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReport002V10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPostingReport002V10Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SubAccountDetails is SubAccountIdentification61 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReport002V10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReport002V10Document : IOuterDocument<SecuritiesTransactionPostingReport002V10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReport002V10.XmlTag)]
    public required SecuritiesTransactionPostingReport002V10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReport002V10.XmlTag);
