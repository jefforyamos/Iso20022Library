...
//
// Generated by MainMessageGenerator for SecuritiesTransactionPostingReport002V11.  ISO2002 ID# _2xkF0yAeEeuyDZ-ukt4YRg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReport002V11>;
...
public partial record SecuritiesTransactionPostingReport002V11 : IOuterRecord<SecuritiesTransactionPostingReport002V11,SecuritiesTransactionPostingReport002V11Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReport002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPostingReport002V11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesTransactionPostingReport002V11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesTransactionPostingReport002V11Document ToDocument()
    {
        return new SecuritiesTransactionPostingReport002V11Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentDetails is FinancialInstrumentDetails39 FinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "FinInstrmDtls", xmlNamespace );
            FinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification63 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReport002V11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesTransactionPostingReport002V11"/>.
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReport002V11Document : IOuterDocument<SecuritiesTransactionPostingReport002V11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesTransactionPostingReport002V11"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReport002V11.XmlTag)]
    public required SecuritiesTransactionPostingReport002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReport002V11.XmlTag);
