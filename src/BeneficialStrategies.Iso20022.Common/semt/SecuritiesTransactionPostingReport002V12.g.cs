...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReport002V12>;
...
public partial record SecuritiesTransactionPostingReport002V12 : IOuterRecord<SecuritiesTransactionPostingReport002V12,SecuritiesTransactionPostingReport002V12Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReport002V12>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SafekeepingAccount is SecuritiesAccount40 SafekeepingAccountValue)
        {
            writer.WriteStartElement(null, "SfkpgAcct", xmlNamespace );
            SafekeepingAccountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (BlockChainAddressOrWallet is BlockChainAddressWallet8 BlockChainAddressOrWalletValue)
        {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentDetails is FinancialInstrumentDetails43 FinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "FinInstrmDtls", xmlNamespace );
            FinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification70 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReport002V12 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReport002V12Document : IOuterDocument<SecuritiesTransactionPostingReport002V12>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReport002V12.XmlTag)]
    public required SecuritiesTransactionPostingReport002V12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReport002V12.XmlTag);
