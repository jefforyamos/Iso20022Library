...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReportV02>;
...
public partial record SecuritiesTransactionPostingReportV02 : IOuterRecord<SecuritiesTransactionPostingReportV02,SecuritiesTransactionPostingReportV02Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReportV02>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentDetails is FinancialInstrumentDetails5 FinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "FinInstrmDtls", xmlNamespace );
            FinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification15 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReportV02Document : IOuterDocument<SecuritiesTransactionPostingReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReportV02.XmlTag)]
    public required SecuritiesTransactionPostingReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReportV02.XmlTag);
