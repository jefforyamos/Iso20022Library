...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReportV04>;
...
public partial record SecuritiesTransactionPostingReportV04 : IOuterRecord<SecuritiesTransactionPostingReportV04,SecuritiesTransactionPostingReportV04Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReportV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentDetails is FinancialInstrumentDetails13 FinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "FinInstrmDtls", xmlNamespace );
            FinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification30 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReportV04Document : IOuterDocument<SecuritiesTransactionPostingReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReportV04.XmlTag)]
    public required SecuritiesTransactionPostingReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReportV04.XmlTag);
