...
//
// Generated by MainMessageGenerator for SecuritiesTransactionPostingReportV09.  ISO2002 ID# _rrd-MdBnEeihG9bKfarOOA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.semt.SecuritiesTransactionPostingReportV09>;
...
public partial record SecuritiesTransactionPostingReportV09 : IOuterRecord<SecuritiesTransactionPostingReportV09,SecuritiesTransactionPostingReportV09Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionPostingReportV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionPostingReportV09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesTransactionPostingReportV09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesTransactionPostingReportV09Document ToDocument()
    {
        return new SecuritiesTransactionPostingReportV09Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentDetails is FinancialInstrumentDetails32 FinancialInstrumentDetailsValue)
        {
            writer.WriteStartElement(null, "FinInstrmDtls", xmlNamespace );
            FinancialInstrumentDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SubAccountDetails is SubAccountIdentification53 SubAccountDetailsValue)
        {
    ...
    public static SecuritiesTransactionPostingReportV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesTransactionPostingReportV09"/>.
/// </summary>
[Serializable]
public partial record SecuritiesTransactionPostingReportV09Document : IOuterDocument<SecuritiesTransactionPostingReportV09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesTransactionPostingReportV09"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesTransactionPostingReportV09.XmlTag)]
    public required SecuritiesTransactionPostingReportV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionPostingReportV09.XmlTag);
