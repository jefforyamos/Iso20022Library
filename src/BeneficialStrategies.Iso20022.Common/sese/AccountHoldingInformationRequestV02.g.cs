...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.AccountHoldingInformationRequestV02>;
...
public partial record AccountHoldingInformationRequestV02 : IOuterRecord<AccountHoldingInformationRequestV02,AccountHoldingInformationRequestV02Document>
    ,IIsoXmlSerilizable<AccountHoldingInformationRequestV02>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("AcctHldgInfReq");
    ...
    public static AccountHoldingInformationRequestV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountHoldingInformationRequestV02Document : IOuterDocument<AccountHoldingInformationRequestV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountHoldingInformationRequestV02.XmlTag)]
    public required AccountHoldingInformationRequestV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountHoldingInformationRequestV02.XmlTag);
