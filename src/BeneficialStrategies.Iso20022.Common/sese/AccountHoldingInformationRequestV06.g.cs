...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.AccountHoldingInformationRequestV06>;
...
public partial record AccountHoldingInformationRequestV06 : IOuterRecord<AccountHoldingInformationRequestV06,AccountHoldingInformationRequestV06Document>
    ,IIsoXmlSerilizable<AccountHoldingInformationRequestV06>, ISerializeInsideARootElement
{
    ...
    public static AccountHoldingInformationRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountHoldingInformationRequestV06Document : IOuterDocument<AccountHoldingInformationRequestV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountHoldingInformationRequestV06.XmlTag)]
    public required AccountHoldingInformationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountHoldingInformationRequestV06.XmlTag);
