...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.AccountHoldingInformationRequestV07>;
...
public partial record AccountHoldingInformationRequestV07 : IOuterRecord<AccountHoldingInformationRequestV07,AccountHoldingInformationRequestV07Document>
    ,IIsoXmlSerilizable<AccountHoldingInformationRequestV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountHoldingInformationRequestV07Document.DocumentNamespace;
    ...
    public static AccountHoldingInformationRequestV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountHoldingInformationRequestV07Document : IOuterDocument<AccountHoldingInformationRequestV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountHoldingInformationRequestV07.XmlTag)]
    public required AccountHoldingInformationRequestV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountHoldingInformationRequestV07.XmlTag);
