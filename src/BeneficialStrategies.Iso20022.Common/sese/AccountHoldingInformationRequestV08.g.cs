...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.AccountHoldingInformationRequestV08>;
...
public partial record AccountHoldingInformationRequestV08 : IOuterRecord<AccountHoldingInformationRequestV08,AccountHoldingInformationRequestV08Document>
    ,IIsoXmlSerilizable<AccountHoldingInformationRequestV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountHoldingInformationRequestV08Document.DocumentNamespace;
    ...
    public static AccountHoldingInformationRequestV08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="AccountHoldingInformationRequestV08"/>.
/// </summary>
[Serializable]
public partial record AccountHoldingInformationRequestV08Document : IOuterDocument<AccountHoldingInformationRequestV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountHoldingInformationRequestV08.XmlTag)]
    public required AccountHoldingInformationRequestV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountHoldingInformationRequestV08.XmlTag);
