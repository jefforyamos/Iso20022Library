...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.AccountHoldingInformationV02>;
...
public partial record AccountHoldingInformationV02 : IOuterRecord<AccountHoldingInformationV02,AccountHoldingInformationV02Document>
    ,IIsoXmlSerilizable<AccountHoldingInformationV02>, ISerializeInsideARootElement
{
    ...
    public static AccountHoldingInformationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountHoldingInformationV02Document : IOuterDocument<AccountHoldingInformationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountHoldingInformationV02.XmlTag)]
    public required AccountHoldingInformationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountHoldingInformationV02.XmlTag);
