...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.AccountHoldingInformationV04>;
...
public partial record AccountHoldingInformationV04 : IOuterRecord<AccountHoldingInformationV04,AccountHoldingInformationV04Document>
    ,IIsoXmlSerilizable<AccountHoldingInformationV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => AccountHoldingInformationV04Document.DocumentNamespace;
    ...
    public static AccountHoldingInformationV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record AccountHoldingInformationV04Document : IOuterDocument<AccountHoldingInformationV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=AccountHoldingInformationV04.XmlTag)]
    public required AccountHoldingInformationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(AccountHoldingInformationV04.XmlTag);
