...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferCancellationRequestV05>;
...
public partial record PortfolioTransferCancellationRequestV05 : IOuterRecord<PortfolioTransferCancellationRequestV05,PortfolioTransferCancellationRequestV05Document>
    ,IIsoXmlSerilizable<PortfolioTransferCancellationRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferCancellationRequestV05Document.DocumentNamespace;
    ...
    public static PortfolioTransferCancellationRequestV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferCancellationRequestV05Document : IOuterDocument<PortfolioTransferCancellationRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferCancellationRequestV05.XmlTag)]
    public required PortfolioTransferCancellationRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferCancellationRequestV05.XmlTag);
