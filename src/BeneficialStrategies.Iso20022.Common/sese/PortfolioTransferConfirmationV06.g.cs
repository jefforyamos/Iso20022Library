...
/// </summary>
[Serializable]
public partial record PortfolioTransferConfirmationV06Document : IOuterDocument<PortfolioTransferConfirmationV06>
{
    ...
    #else
    public PortfolioTransferConfirmationV06 Message { get; init; }
    #endif
}
