...
//
// Generated by MainMessageGenerator for PortfolioTransferConfirmationV06.  ISO2002 ID# _8RfRkQgLEeSFYfyUKDXKaw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferConfirmationV06>;
...
public partial record PortfolioTransferConfirmationV06 : IOuterRecord<PortfolioTransferConfirmationV06,PortfolioTransferConfirmationV06Document>
    ,IIsoXmlSerilizable<PortfolioTransferConfirmationV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferConfirmationV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="PortfolioTransferConfirmationV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public PortfolioTransferConfirmationV06Document ToDocument()
    {
        return new PortfolioTransferConfirmationV06Document { Message = this };
    }
    ...
    public static PortfolioTransferConfirmationV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="PortfolioTransferConfirmationV06"/>.
/// </summary>
[Serializable]
public partial record PortfolioTransferConfirmationV06Document : IOuterDocument<PortfolioTransferConfirmationV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="PortfolioTransferConfirmationV06"/> is required.
    /// </summary>
    [DataMember(Name=PortfolioTransferConfirmationV06.XmlTag)]
    public required PortfolioTransferConfirmationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferConfirmationV06.XmlTag);
