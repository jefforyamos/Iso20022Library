...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferConfirmationV09>;
...
public partial record PortfolioTransferConfirmationV09 : IOuterRecord<PortfolioTransferConfirmationV09,PortfolioTransferConfirmationV09Document>
    ,IIsoXmlSerilizable<PortfolioTransferConfirmationV09>, ISerializeInsideARootElement
{
    ...
    public static PortfolioTransferConfirmationV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferConfirmationV09Document : IOuterDocument<PortfolioTransferConfirmationV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferConfirmationV09.XmlTag)]
    public required PortfolioTransferConfirmationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferConfirmationV09.XmlTag);
