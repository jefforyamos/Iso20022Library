...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferConfirmationV10>;
...
public partial record PortfolioTransferConfirmationV10 : IOuterRecord<PortfolioTransferConfirmationV10,PortfolioTransferConfirmationV10Document>
    ,IIsoXmlSerilizable<PortfolioTransferConfirmationV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferConfirmationV10Document.DocumentNamespace;
    ...
    public static PortfolioTransferConfirmationV10 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferConfirmationV10Document : IOuterDocument<PortfolioTransferConfirmationV10>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferConfirmationV10.XmlTag)]
    public required PortfolioTransferConfirmationV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferConfirmationV10.XmlTag);
