...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferInstructionV04>;
...
public partial record PortfolioTransferInstructionV04 : IOuterRecord<PortfolioTransferInstructionV04,PortfolioTransferInstructionV04Document>
    ,IIsoXmlSerilizable<PortfolioTransferInstructionV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferInstructionV04Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="PortfolioTransferInstructionV04Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public PortfolioTransferInstructionV04Document ToDocument()
    {
        return new PortfolioTransferInstructionV04Document { Message = this };
    }
    ...
    public static PortfolioTransferInstructionV04 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="PortfolioTransferInstructionV04"/>.
/// </summary>
[Serializable]
public partial record PortfolioTransferInstructionV04Document : IOuterDocument<PortfolioTransferInstructionV04>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="PortfolioTransferInstructionV04"/> is required.
    /// </summary>
    [DataMember(Name=PortfolioTransferInstructionV04.XmlTag)]
    public required PortfolioTransferInstructionV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferInstructionV04.XmlTag);
