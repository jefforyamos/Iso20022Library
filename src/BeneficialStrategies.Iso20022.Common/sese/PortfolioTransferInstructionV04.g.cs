...
/// </summary>
[Serializable]
public partial record PortfolioTransferInstructionV04Document : IOuterDocument<PortfolioTransferInstructionV04>
{
    ...
    #else
    public PortfolioTransferInstructionV04 Message { get; init; }
    #endif
}
