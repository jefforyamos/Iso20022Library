...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferInstructionV06>;
...
public partial record PortfolioTransferInstructionV06 : IOuterRecord<PortfolioTransferInstructionV06,PortfolioTransferInstructionV06Document>
    ,IIsoXmlSerilizable<PortfolioTransferInstructionV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferInstructionV06Document.DocumentNamespace;
    ...
    public static PortfolioTransferInstructionV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferInstructionV06Document : IOuterDocument<PortfolioTransferInstructionV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferInstructionV06.XmlTag)]
    public required PortfolioTransferInstructionV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferInstructionV06.XmlTag);
