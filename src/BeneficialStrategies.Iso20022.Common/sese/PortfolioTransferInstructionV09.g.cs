...
//
// Generated by MainMessageGenerator for PortfolioTransferInstructionV09.  ISO2002 ID# _63pq8UyFEeir2sRRVd9XhA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferInstructionV09>;
...
public partial record PortfolioTransferInstructionV09 : IOuterRecord<PortfolioTransferInstructionV09,PortfolioTransferInstructionV09Document>
    ,IIsoXmlSerilizable<PortfolioTransferInstructionV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferInstructionV09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="PortfolioTransferInstructionV09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public PortfolioTransferInstructionV09Document ToDocument()
    {
        return new PortfolioTransferInstructionV09Document { Message = this };
    }
    ...
    public static PortfolioTransferInstructionV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="PortfolioTransferInstructionV09"/>.
/// </summary>
[Serializable]
public partial record PortfolioTransferInstructionV09Document : IOuterDocument<PortfolioTransferInstructionV09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="PortfolioTransferInstructionV09"/> is required.
    /// </summary>
    [DataMember(Name=PortfolioTransferInstructionV09.XmlTag)]
    public required PortfolioTransferInstructionV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferInstructionV09.XmlTag);
