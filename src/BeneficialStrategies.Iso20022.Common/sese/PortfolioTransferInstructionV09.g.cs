...
/// </summary>
[Serializable]
public partial record PortfolioTransferInstructionV09Document : IOuterDocument<PortfolioTransferInstructionV09>
{
    ...
    #else
    public PortfolioTransferInstructionV09 Message { get; init; }
    #endif
}
