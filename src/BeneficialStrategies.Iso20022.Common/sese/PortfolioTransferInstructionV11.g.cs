...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferInstructionV11>;
...
public partial record PortfolioTransferInstructionV11 : IOuterRecord<PortfolioTransferInstructionV11,PortfolioTransferInstructionV11Document>
    ,IIsoXmlSerilizable<PortfolioTransferInstructionV11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferInstructionV11Document.DocumentNamespace;
    ...
    public static PortfolioTransferInstructionV11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferInstructionV11Document : IOuterDocument<PortfolioTransferInstructionV11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferInstructionV11.XmlTag)]
    public required PortfolioTransferInstructionV11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferInstructionV11.XmlTag);
