...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferNotification002V04>;
...
public partial record PortfolioTransferNotification002V04 : IOuterRecord<PortfolioTransferNotification002V04,PortfolioTransferNotification002V04Document>
    ,IIsoXmlSerilizable<PortfolioTransferNotification002V04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransferNotificationDetails is SecuritiesTradeDetails57 TransferNotificationDetailsValue)
        {
    ...
    public static PortfolioTransferNotification002V04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferNotification002V04Document : IOuterDocument<PortfolioTransferNotification002V04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferNotification002V04.XmlTag)]
    public required PortfolioTransferNotification002V04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferNotification002V04.XmlTag);
