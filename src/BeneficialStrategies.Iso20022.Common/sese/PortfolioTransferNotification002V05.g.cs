...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferNotification002V05>;
...
public partial record PortfolioTransferNotification002V05 : IOuterRecord<PortfolioTransferNotification002V05,PortfolioTransferNotification002V05Document>
    ,IIsoXmlSerilizable<PortfolioTransferNotification002V05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransferNotificationDetails is SecuritiesTradeDetails81 TransferNotificationDetailsValue)
        {
    ...
    public static PortfolioTransferNotification002V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferNotification002V05Document : IOuterDocument<PortfolioTransferNotification002V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferNotification002V05.XmlTag)]
    public required PortfolioTransferNotification002V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferNotification002V05.XmlTag);
