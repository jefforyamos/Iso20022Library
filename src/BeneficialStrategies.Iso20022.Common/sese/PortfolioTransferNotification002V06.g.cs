...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferNotification002V06>;
...
public partial record PortfolioTransferNotification002V06 : IOuterRecord<PortfolioTransferNotification002V06,PortfolioTransferNotification002V06Document>
    ,IIsoXmlSerilizable<PortfolioTransferNotification002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferNotification002V06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransferNotificationDetails is SecuritiesTradeDetails114 TransferNotificationDetailsValue)
        {
    ...
    public static PortfolioTransferNotification002V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferNotification002V06Document : IOuterDocument<PortfolioTransferNotification002V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferNotification002V06.XmlTag)]
    public required PortfolioTransferNotification002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferNotification002V06.XmlTag);
