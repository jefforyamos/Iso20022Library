...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferNotificationV02>;
...
public partial record PortfolioTransferNotificationV02 : IOuterRecord<PortfolioTransferNotificationV02,PortfolioTransferNotificationV02Document>
    ,IIsoXmlSerilizable<PortfolioTransferNotificationV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferNotificationV02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransferNotificationDetails is SecuritiesTradeDetails19 TransferNotificationDetailsValue)
        {
    ...
    public static PortfolioTransferNotificationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferNotificationV02Document : IOuterDocument<PortfolioTransferNotificationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferNotificationV02.XmlTag)]
    public required PortfolioTransferNotificationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferNotificationV02.XmlTag);
