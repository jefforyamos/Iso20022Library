...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferNotificationV04>;
...
public partial record PortfolioTransferNotificationV04 : IOuterRecord<PortfolioTransferNotificationV04,PortfolioTransferNotificationV04Document>
    ,IIsoXmlSerilizable<PortfolioTransferNotificationV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransferNotificationDetails is SecuritiesTradeDetails48 TransferNotificationDetailsValue)
        {
    ...
    public static PortfolioTransferNotificationV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferNotificationV04Document : IOuterDocument<PortfolioTransferNotificationV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferNotificationV04.XmlTag)]
    public required PortfolioTransferNotificationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferNotificationV04.XmlTag);
