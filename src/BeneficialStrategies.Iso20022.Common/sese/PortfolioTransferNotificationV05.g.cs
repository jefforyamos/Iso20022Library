...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferNotificationV05>;
...
public partial record PortfolioTransferNotificationV05 : IOuterRecord<PortfolioTransferNotificationV05,PortfolioTransferNotificationV05Document>
    ,IIsoXmlSerilizable<PortfolioTransferNotificationV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => PortfolioTransferNotificationV05Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransferNotificationDetails is SecuritiesTradeDetails72 TransferNotificationDetailsValue)
        {
    ...
    public static PortfolioTransferNotificationV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferNotificationV05Document : IOuterDocument<PortfolioTransferNotificationV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferNotificationV05.XmlTag)]
    public required PortfolioTransferNotificationV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferNotificationV05.XmlTag);
