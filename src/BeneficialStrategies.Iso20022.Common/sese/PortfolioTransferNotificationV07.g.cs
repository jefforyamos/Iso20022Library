...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.PortfolioTransferNotificationV07>;
...
public partial record PortfolioTransferNotificationV07 : IOuterRecord<PortfolioTransferNotificationV07,PortfolioTransferNotificationV07Document>
    ,IIsoXmlSerilizable<PortfolioTransferNotificationV07>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransferNotificationDetails is SecuritiesTradeDetails138 TransferNotificationDetailsValue)
        {
    ...
    public static PortfolioTransferNotificationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record PortfolioTransferNotificationV07Document : IOuterDocument<PortfolioTransferNotificationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=PortfolioTransferNotificationV07.XmlTag)]
    public required PortfolioTransferNotificationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(PortfolioTransferNotificationV07.XmlTag);
