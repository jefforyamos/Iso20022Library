...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.RequestForTransferStatusReportV02>;
...
public partial record RequestForTransferStatusReportV02 : IOuterRecord<RequestForTransferStatusReportV02,RequestForTransferStatusReportV02Document>
    ,IIsoXmlSerilizable<RequestForTransferStatusReportV02>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("ReqForTrfStsRptV02");
    ...
    public static RequestForTransferStatusReportV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RequestForTransferStatusReportV02Document : IOuterDocument<RequestForTransferStatusReportV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RequestForTransferStatusReportV02.XmlTag)]
    public required RequestForTransferStatusReportV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RequestForTransferStatusReportV02.XmlTag);
