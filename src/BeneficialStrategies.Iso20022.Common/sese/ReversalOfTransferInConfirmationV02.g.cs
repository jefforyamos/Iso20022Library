...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.ReversalOfTransferInConfirmationV02>;
...
public partial record ReversalOfTransferInConfirmationV02 : IOuterRecord<ReversalOfTransferInConfirmationV02,ReversalOfTransferInConfirmationV02Document>
    ,IIsoXmlSerilizable<ReversalOfTransferInConfirmationV02>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("RvslOfTrfInConfV02");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReversalByTransferInConfirmationDetails is TransferIn4 ReversalByTransferInConfirmationDetailsValue)
        {
    ...
    public static ReversalOfTransferInConfirmationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ReversalOfTransferInConfirmationV02Document : IOuterDocument<ReversalOfTransferInConfirmationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ReversalOfTransferInConfirmationV02.XmlTag)]
    public required ReversalOfTransferInConfirmationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ReversalOfTransferInConfirmationV02.XmlTag);
