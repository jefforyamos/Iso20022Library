...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingConfirmation002V06>;
...
public partial record SecuritiesFinancingConfirmation002V06 : IOuterRecord<SecuritiesFinancingConfirmation002V06,SecuritiesFinancingConfirmation002V06Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingConfirmation002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingConfirmation002V06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesFinancingDetails is SecuritiesFinancingTransactionDetails30 SecuritiesFinancingDetailsValue)
        {
        ...
        if (SettlementParameters is SettlementDetails104 SettlementParametersValue)
        {
        ...
        if (OtherAmounts is OtherAmounts34 OtherAmountsValue)
        {
    ...
    public static SecuritiesFinancingConfirmation002V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingConfirmation002V06Document : IOuterDocument<SecuritiesFinancingConfirmation002V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingConfirmation002V06.XmlTag)]
    public required SecuritiesFinancingConfirmation002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingConfirmation002V06.XmlTag);
