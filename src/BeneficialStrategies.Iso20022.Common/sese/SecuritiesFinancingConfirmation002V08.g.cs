...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingConfirmation002V08>;
...
public partial record SecuritiesFinancingConfirmation002V08 : IOuterRecord<SecuritiesFinancingConfirmation002V08,SecuritiesFinancingConfirmation002V08Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingConfirmation002V08>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesFinancingDetails is SecuritiesFinancingTransactionDetails39 SecuritiesFinancingDetailsValue)
        {
    ...
    public static SecuritiesFinancingConfirmation002V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingConfirmation002V08Document : IOuterDocument<SecuritiesFinancingConfirmation002V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingConfirmation002V08.XmlTag)]
    public required SecuritiesFinancingConfirmation002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingConfirmation002V08.XmlTag);
