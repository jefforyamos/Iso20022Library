...
//
// Generated by MainMessageGenerator for SecuritiesFinancingConfirmation002V09.  ISO2002 ID# _6sbsQ_fVEeiNZp_PtLohLw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingConfirmation002V09>;
...
public partial record SecuritiesFinancingConfirmation002V09 : IOuterRecord<SecuritiesFinancingConfirmation002V09,SecuritiesFinancingConfirmation002V09Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingConfirmation002V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingConfirmation002V09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesFinancingConfirmation002V09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesFinancingConfirmation002V09Document ToDocument()
    {
        return new SecuritiesFinancingConfirmation002V09Document { Message = this };
    }
    ...
    public static SecuritiesFinancingConfirmation002V09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesFinancingConfirmation002V09"/>.
/// </summary>
[Serializable]
public partial record SecuritiesFinancingConfirmation002V09Document : IOuterDocument<SecuritiesFinancingConfirmation002V09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesFinancingConfirmation002V09"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesFinancingConfirmation002V09.XmlTag)]
    public required SecuritiesFinancingConfirmation002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingConfirmation002V09.XmlTag);
