...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingConfirmationV02>;
...
public partial record SecuritiesFinancingConfirmationV02 : IOuterRecord<SecuritiesFinancingConfirmationV02,SecuritiesFinancingConfirmationV02Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingConfirmationV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingConfirmationV02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettlementParameters is SettlementDetails30 SettlementParametersValue)
        {
    ...
    public static SecuritiesFinancingConfirmationV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingConfirmationV02Document : IOuterDocument<SecuritiesFinancingConfirmationV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingConfirmationV02.XmlTag)]
    public required SecuritiesFinancingConfirmationV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingConfirmationV02.XmlTag);
