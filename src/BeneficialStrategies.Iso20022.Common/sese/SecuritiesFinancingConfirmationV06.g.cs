...
//
// Generated by MainMessageGenerator for SecuritiesFinancingConfirmationV06.  ISO2002 ID# _YSMWZQCTEeW_3KiG8SEjHA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingConfirmationV06>;
...
public partial record SecuritiesFinancingConfirmationV06 : IOuterRecord<SecuritiesFinancingConfirmationV06,SecuritiesFinancingConfirmationV06Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingConfirmationV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingConfirmationV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesFinancingConfirmationV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesFinancingConfirmationV06Document ToDocument()
    {
        return new SecuritiesFinancingConfirmationV06Document { Message = this };
    }
    ...
    public static SecuritiesFinancingConfirmationV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesFinancingConfirmationV06"/>.
/// </summary>
[Serializable]
public partial record SecuritiesFinancingConfirmationV06Document : IOuterDocument<SecuritiesFinancingConfirmationV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesFinancingConfirmationV06"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesFinancingConfirmationV06.XmlTag)]
    public required SecuritiesFinancingConfirmationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingConfirmationV06.XmlTag);
