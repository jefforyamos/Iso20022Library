...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingConfirmationV07>;
...
public partial record SecuritiesFinancingConfirmationV07 : IOuterRecord<SecuritiesFinancingConfirmationV07,SecuritiesFinancingConfirmationV07Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingConfirmationV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingConfirmationV07Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesFinancingDetails is SecuritiesFinancingTransactionDetails28 SecuritiesFinancingDetailsValue)
        {
        ...
        if (SettlementParameters is SettlementDetails96 SettlementParametersValue)
        {
        ...
        if (OtherAmounts is OtherAmounts31 OtherAmountsValue)
        {
    ...
    public static SecuritiesFinancingConfirmationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingConfirmationV07Document : IOuterDocument<SecuritiesFinancingConfirmationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingConfirmationV07.XmlTag)]
    public required SecuritiesFinancingConfirmationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingConfirmationV07.XmlTag);
