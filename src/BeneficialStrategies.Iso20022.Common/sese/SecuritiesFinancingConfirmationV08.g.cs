...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingConfirmationV08>;
...
public partial record SecuritiesFinancingConfirmationV08 : IOuterRecord<SecuritiesFinancingConfirmationV08,SecuritiesFinancingConfirmationV08Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingConfirmationV08>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SecuritiesFinancingDetails is SecuritiesFinancingTransactionDetails37 SecuritiesFinancingDetailsValue)
        {
    ...
    public static SecuritiesFinancingConfirmationV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingConfirmationV08Document : IOuterDocument<SecuritiesFinancingConfirmationV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingConfirmationV08.XmlTag)]
    public required SecuritiesFinancingConfirmationV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingConfirmationV08.XmlTag);
