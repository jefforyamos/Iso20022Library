...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingInstruction002V08>;
...
public partial record SecuritiesFinancingInstruction002V08 : IOuterRecord<SecuritiesFinancingInstruction002V08,SecuritiesFinancingInstruction002V08Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingInstruction002V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingInstruction002V08Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OpeningSettlementAmount is AmountAndDirection90 OpeningSettlementAmountValue)
        {
    ...
    public static SecuritiesFinancingInstruction002V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingInstruction002V08Document : IOuterDocument<SecuritiesFinancingInstruction002V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingInstruction002V08.XmlTag)]
    public required SecuritiesFinancingInstruction002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingInstruction002V08.XmlTag);
