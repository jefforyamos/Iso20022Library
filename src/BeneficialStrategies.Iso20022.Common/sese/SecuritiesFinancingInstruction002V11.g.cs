...
//
// Generated by MainMessageGenerator for SecuritiesFinancingInstruction002V11.  ISO2002 ID# _dJb04zi8Eeydid5dcNPKvg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingInstruction002V11>;
...
public partial record SecuritiesFinancingInstruction002V11 : IOuterRecord<SecuritiesFinancingInstruction002V11,SecuritiesFinancingInstruction002V11Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingInstruction002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingInstruction002V11Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesFinancingInstruction002V11Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesFinancingInstruction002V11Document ToDocument()
    {
        return new SecuritiesFinancingInstruction002V11Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails152 SettlementParametersValue)
        {
        ...
        if (OpeningSettlementAmount is AmountAndDirection96 OpeningSettlementAmountValue)
        {
    ...
    public static SecuritiesFinancingInstruction002V11 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesFinancingInstruction002V11"/>.
/// </summary>
[Serializable]
public partial record SecuritiesFinancingInstruction002V11Document : IOuterDocument<SecuritiesFinancingInstruction002V11>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesFinancingInstruction002V11"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesFinancingInstruction002V11.XmlTag)]
    public required SecuritiesFinancingInstruction002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingInstruction002V11.XmlTag);
