...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingInstructionV02Document : IOuterDocument<SecuritiesFinancingInstructionV02>
{
    ...
    #else
    public SecuritiesFinancingInstructionV02 Message { get; init; }
    #endif
}
