...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingInstructionV06>;
...
public partial record SecuritiesFinancingInstructionV06 : IOuterRecord<SecuritiesFinancingInstructionV06,SecuritiesFinancingInstructionV06Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingInstructionV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingInstructionV06Document.DocumentNamespace;
    ...
    public static SecuritiesFinancingInstructionV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingInstructionV06Document : IOuterDocument<SecuritiesFinancingInstructionV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingInstructionV06.XmlTag)]
    public required SecuritiesFinancingInstructionV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingInstructionV06.XmlTag);
