...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingInstructionV08>;
...
public partial record SecuritiesFinancingInstructionV08 : IOuterRecord<SecuritiesFinancingInstructionV08,SecuritiesFinancingInstructionV08Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingInstructionV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingInstructionV08Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OpeningSettlementAmount is AmountAndDirection87 OpeningSettlementAmountValue)
        {
    ...
    public static SecuritiesFinancingInstructionV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingInstructionV08Document : IOuterDocument<SecuritiesFinancingInstructionV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingInstructionV08.XmlTag)]
    public required SecuritiesFinancingInstructionV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingInstructionV08.XmlTag);
