...
//
// Generated by MainMessageGenerator for SecuritiesFinancingModificationInstruction002V06.  ISO2002 ID# _yYMhQ5w2EeazcsnODTksnQ.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingModificationInstruction002V06>;
...
public partial record SecuritiesFinancingModificationInstruction002V06 : IOuterRecord<SecuritiesFinancingModificationInstruction002V06,SecuritiesFinancingModificationInstruction002V06Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingModificationInstruction002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingModificationInstruction002V06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesFinancingModificationInstruction002V06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesFinancingModificationInstruction002V06Document ToDocument()
    {
        return new SecuritiesFinancingModificationInstruction002V06Document { Message = this };
    }
    ...
    public static SecuritiesFinancingModificationInstruction002V06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesFinancingModificationInstruction002V06"/>.
/// </summary>
[Serializable]
public partial record SecuritiesFinancingModificationInstruction002V06Document : IOuterDocument<SecuritiesFinancingModificationInstruction002V06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesFinancingModificationInstruction002V06"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesFinancingModificationInstruction002V06.XmlTag)]
    public required SecuritiesFinancingModificationInstruction002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingModificationInstruction002V06.XmlTag);
