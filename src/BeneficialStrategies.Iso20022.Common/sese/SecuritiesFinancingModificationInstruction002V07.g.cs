...
//
// Generated by MainMessageGenerator for SecuritiesFinancingModificationInstruction002V07.  ISO2002 ID# _SsHYg_fWEeiNZp_PtLohLw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingModificationInstruction002V07>;
...
public partial record SecuritiesFinancingModificationInstruction002V07 : IOuterRecord<SecuritiesFinancingModificationInstruction002V07,SecuritiesFinancingModificationInstruction002V07Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingModificationInstruction002V07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingModificationInstruction002V07Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesFinancingModificationInstruction002V07Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesFinancingModificationInstruction002V07Document ToDocument()
    {
        return new SecuritiesFinancingModificationInstruction002V07Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementParameters is SettlementDetails172 SettlementParametersValue)
        {
    ...
    public static SecuritiesFinancingModificationInstruction002V07 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesFinancingModificationInstruction002V07"/>.
/// </summary>
[Serializable]
public partial record SecuritiesFinancingModificationInstruction002V07Document : IOuterDocument<SecuritiesFinancingModificationInstruction002V07>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesFinancingModificationInstruction002V07"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesFinancingModificationInstruction002V07.XmlTag)]
    public required SecuritiesFinancingModificationInstruction002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingModificationInstruction002V07.XmlTag);
