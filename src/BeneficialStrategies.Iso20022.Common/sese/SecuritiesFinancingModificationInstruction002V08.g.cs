...
//
// Generated by MainMessageGenerator for SecuritiesFinancingModificationInstruction002V08.  ISO2002 ID# _daqHwzi8Eeydid5dcNPKvg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingModificationInstruction002V08>;
...
public partial record SecuritiesFinancingModificationInstruction002V08 : IOuterRecord<SecuritiesFinancingModificationInstruction002V08,SecuritiesFinancingModificationInstruction002V08Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingModificationInstruction002V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingModificationInstruction002V08Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesFinancingModificationInstruction002V08Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesFinancingModificationInstruction002V08Document ToDocument()
    {
        return new SecuritiesFinancingModificationInstruction002V08Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeliveringSettlementParties is SettlementParties107 DeliveringSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "DlvrgSttlmPties", xmlNamespace );
            DeliveringSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingSettlementParties is SettlementParties107 ReceivingSettlementPartiesValue)
        {
    ...
    public static SecuritiesFinancingModificationInstruction002V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingModificationInstruction002V08Document : IOuterDocument<SecuritiesFinancingModificationInstruction002V08>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesFinancingModificationInstruction002V08"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesFinancingModificationInstruction002V08.XmlTag)]
    public required SecuritiesFinancingModificationInstruction002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingModificationInstruction002V08.XmlTag);
