...
//
// Generated by MainMessageGenerator for SecuritiesFinancingModificationInstructionV05.  ISO2002 ID# _YSMW1wCTEeW_3KiG8SEjHA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingModificationInstructionV05>;
...
public partial record SecuritiesFinancingModificationInstructionV05 : IOuterRecord<SecuritiesFinancingModificationInstructionV05,SecuritiesFinancingModificationInstructionV05Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingModificationInstructionV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingModificationInstructionV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesFinancingModificationInstructionV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesFinancingModificationInstructionV05Document ToDocument()
    {
        return new SecuritiesFinancingModificationInstructionV05Document { Message = this };
    }
    ...
    public static SecuritiesFinancingModificationInstructionV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesFinancingModificationInstructionV05"/>.
/// </summary>
[Serializable]
public partial record SecuritiesFinancingModificationInstructionV05Document : IOuterDocument<SecuritiesFinancingModificationInstructionV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesFinancingModificationInstructionV05"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesFinancingModificationInstructionV05.XmlTag)]
    public required SecuritiesFinancingModificationInstructionV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingModificationInstructionV05.XmlTag);
