...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingModificationInstructionV07>;
...
public partial record SecuritiesFinancingModificationInstructionV07 : IOuterRecord<SecuritiesFinancingModificationInstructionV07,SecuritiesFinancingModificationInstructionV07Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingModificationInstructionV07>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeliveringSettlementParties is SettlementParties77 DeliveringSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "DlvrgSttlmPties", xmlNamespace );
            DeliveringSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingSettlementParties is SettlementParties77 ReceivingSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "RcvgSttlmPties", xmlNamespace );
            ReceivingSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (OpeningSettlementAmount is AmountAndDirection49 OpeningSettlementAmountValue)
        {
    ...
    public static SecuritiesFinancingModificationInstructionV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingModificationInstructionV07Document : IOuterDocument<SecuritiesFinancingModificationInstructionV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingModificationInstructionV07.XmlTag)]
    public required SecuritiesFinancingModificationInstructionV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingModificationInstructionV07.XmlTag);
