...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingModificationInstructionV08>;
...
public partial record SecuritiesFinancingModificationInstructionV08 : IOuterRecord<SecuritiesFinancingModificationInstructionV08,SecuritiesFinancingModificationInstructionV08Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingModificationInstructionV08>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (DeliveringSettlementParties is SettlementParties101 DeliveringSettlementPartiesValue)
        {
            writer.WriteStartElement(null, "DlvrgSttlmPties", xmlNamespace );
            DeliveringSettlementPartiesValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (ReceivingSettlementParties is SettlementParties101 ReceivingSettlementPartiesValue)
        {
    ...
    public static SecuritiesFinancingModificationInstructionV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesFinancingModificationInstructionV08Document : IOuterDocument<SecuritiesFinancingModificationInstructionV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesFinancingModificationInstructionV08.XmlTag)]
    public required SecuritiesFinancingModificationInstructionV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingModificationInstructionV08.XmlTag);
