...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesFinancingStatusAdvice002V06>;
...
public partial record SecuritiesFinancingStatusAdvice002V06 : IOuterRecord<SecuritiesFinancingStatusAdvice002V06,SecuritiesFinancingStatusAdvice002V06Document>
    ,IIsoXmlSerilizable<SecuritiesFinancingStatusAdvice002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesFinancingStatusAdvice002V06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesFinancingStatusAdvice002V06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesFinancingStatusAdvice002V06Document ToDocument()
    {
        return new SecuritiesFinancingStatusAdvice002V06Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is SecuritiesFinancingTransactionDetails33 TransactionDetailsValue)
        {
    ...
    public static SecuritiesFinancingStatusAdvice002V06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesFinancingStatusAdvice002V06"/>.
/// </summary>
[Serializable]
public partial record SecuritiesFinancingStatusAdvice002V06Document : IOuterDocument<SecuritiesFinancingStatusAdvice002V06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesFinancingStatusAdvice002V06"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesFinancingStatusAdvice002V06.XmlTag)]
    public required SecuritiesFinancingStatusAdvice002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesFinancingStatusAdvice002V06.XmlTag);
