...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementAllegementRemovalAdvice002V05>;
...
public partial record SecuritiesSettlementAllegementRemovalAdvice002V05 : IOuterRecord<SecuritiesSettlementAllegementRemovalAdvice002V05,SecuritiesSettlementAllegementRemovalAdvice002V05Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementAllegementRemovalAdvice002V05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementAllegementRemovalAdvice002V05Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails139 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementAllegementRemovalAdvice002V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementAllegementRemovalAdvice002V05Document : IOuterDocument<SecuritiesSettlementAllegementRemovalAdvice002V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementAllegementRemovalAdvice002V05.XmlTag)]
    public required SecuritiesSettlementAllegementRemovalAdvice002V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementAllegementRemovalAdvice002V05.XmlTag);
