...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementAllegementRemovalAdvice002V06>;
...
public partial record SecuritiesSettlementAllegementRemovalAdvice002V06 : IOuterRecord<SecuritiesSettlementAllegementRemovalAdvice002V06,SecuritiesSettlementAllegementRemovalAdvice002V06Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementAllegementRemovalAdvice002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementAllegementRemovalAdvice002V06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails156 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementAllegementRemovalAdvice002V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementAllegementRemovalAdvice002V06Document : IOuterDocument<SecuritiesSettlementAllegementRemovalAdvice002V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementAllegementRemovalAdvice002V06.XmlTag)]
    public required SecuritiesSettlementAllegementRemovalAdvice002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementAllegementRemovalAdvice002V06.XmlTag);
