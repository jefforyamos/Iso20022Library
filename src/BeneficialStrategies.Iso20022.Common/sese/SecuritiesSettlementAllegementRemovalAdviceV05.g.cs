...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementAllegementRemovalAdviceV05>;
...
public partial record SecuritiesSettlementAllegementRemovalAdviceV05 : IOuterRecord<SecuritiesSettlementAllegementRemovalAdviceV05,SecuritiesSettlementAllegementRemovalAdviceV05Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementAllegementRemovalAdviceV05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails135 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementAllegementRemovalAdviceV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementAllegementRemovalAdviceV05Document : IOuterDocument<SecuritiesSettlementAllegementRemovalAdviceV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementAllegementRemovalAdviceV05.XmlTag)]
    public required SecuritiesSettlementAllegementRemovalAdviceV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementAllegementRemovalAdviceV05.XmlTag);
