...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementConditionModificationStatusAdviceV02>;
...
public partial record SecuritiesSettlementConditionModificationStatusAdviceV02 : IOuterRecord<SecuritiesSettlementConditionModificationStatusAdviceV02,SecuritiesSettlementConditionModificationStatusAdviceV02Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementConditionModificationStatusAdviceV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementConditionModificationStatusAdviceV02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RequestDetails is RequestDetails6 RequestDetailsValue)
        {
    ...
    public static SecuritiesSettlementConditionModificationStatusAdviceV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementConditionModificationStatusAdviceV02Document : IOuterDocument<SecuritiesSettlementConditionModificationStatusAdviceV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementConditionModificationStatusAdviceV02.XmlTag)]
    public required SecuritiesSettlementConditionModificationStatusAdviceV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementConditionModificationStatusAdviceV02.XmlTag);
