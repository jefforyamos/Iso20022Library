...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementConditionModificationStatusAdviceV03>;
...
public partial record SecuritiesSettlementConditionModificationStatusAdviceV03 : IOuterRecord<SecuritiesSettlementConditionModificationStatusAdviceV03,SecuritiesSettlementConditionModificationStatusAdviceV03Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementConditionModificationStatusAdviceV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementConditionModificationStatusAdviceV03Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (RequestDetails is RequestDetails8 RequestDetailsValue)
        {
    ...
    public static SecuritiesSettlementConditionModificationStatusAdviceV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementConditionModificationStatusAdviceV03Document : IOuterDocument<SecuritiesSettlementConditionModificationStatusAdviceV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementConditionModificationStatusAdviceV03.XmlTag)]
    public required SecuritiesSettlementConditionModificationStatusAdviceV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementConditionModificationStatusAdviceV03.XmlTag);
