...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementConditionsModificationRequestV06>;
...
public partial record SecuritiesSettlementConditionsModificationRequestV06 : IOuterRecord<SecuritiesSettlementConditionsModificationRequestV06,SecuritiesSettlementConditionsModificationRequestV06Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementConditionsModificationRequestV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementConditionsModificationRequestV06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AdditionalInformation is AdditionalInformation11 AdditionalInformationValue)
        {
    ...
    public static SecuritiesSettlementConditionsModificationRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementConditionsModificationRequestV06Document : IOuterDocument<SecuritiesSettlementConditionsModificationRequestV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementConditionsModificationRequestV06.XmlTag)]
    public required SecuritiesSettlementConditionsModificationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementConditionsModificationRequestV06.XmlTag);
