...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionAllegementNotificationV06>;
...
public partial record SecuritiesSettlementTransactionAllegementNotificationV06 : IOuterRecord<SecuritiesSettlementTransactionAllegementNotificationV06,SecuritiesSettlementTransactionAllegementNotificationV06Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionAllegementNotificationV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionAllegementNotificationV06Document.DocumentNamespace;
    ...
    public static SecuritiesSettlementTransactionAllegementNotificationV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionAllegementNotificationV06"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionAllegementNotificationV06Document : IOuterDocument<SecuritiesSettlementTransactionAllegementNotificationV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionAllegementNotificationV06.XmlTag)]
    public required SecuritiesSettlementTransactionAllegementNotificationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionAllegementNotificationV06.XmlTag);
