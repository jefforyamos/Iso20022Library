...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionConfirmation002V06>;
...
public partial record SecuritiesSettlementTransactionConfirmation002V06 : IOuterRecord<SecuritiesSettlementTransactionConfirmation002V06,SecuritiesSettlementTransactionConfirmation002V06Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionConfirmation002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionConfirmation002V06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalParameters is AdditionalParameters27 AdditionalParametersValue)
        {
    ...
    public static SecuritiesSettlementTransactionConfirmation002V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionConfirmation002V06Document : IOuterDocument<SecuritiesSettlementTransactionConfirmation002V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionConfirmation002V06.XmlTag)]
    public required SecuritiesSettlementTransactionConfirmation002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionConfirmation002V06.XmlTag);
