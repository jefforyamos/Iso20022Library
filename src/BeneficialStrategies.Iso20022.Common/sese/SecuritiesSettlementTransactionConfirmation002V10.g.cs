...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionConfirmation002V10>;
...
public partial record SecuritiesSettlementTransactionConfirmation002V10 : IOuterRecord<SecuritiesSettlementTransactionConfirmation002V10,SecuritiesSettlementTransactionConfirmation002V10Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionConfirmation002V10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionConfirmation002V10Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionConfirmation002V10Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionConfirmation002V10Document ToDocument()
    {
        return new SecuritiesSettlementTransactionConfirmation002V10Document { Message = this };
    }
    ...
    public static SecuritiesSettlementTransactionConfirmation002V10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionConfirmation002V10"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionConfirmation002V10Document : IOuterDocument<SecuritiesSettlementTransactionConfirmation002V10>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionConfirmation002V10"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionConfirmation002V10.XmlTag)]
    public required SecuritiesSettlementTransactionConfirmation002V10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionConfirmation002V10.XmlTag);
