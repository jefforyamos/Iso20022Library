...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionConfirmationV01>;
...
public partial record SecuritiesSettlementTransactionConfirmationV01 : IOuterRecord<SecuritiesSettlementTransactionConfirmationV01,SecuritiesSettlementTransactionConfirmationV01Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionConfirmationV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionConfirmationV01Document.DocumentNamespace;
    ...
    public static SecuritiesSettlementTransactionConfirmationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionConfirmationV01Document : IOuterDocument<SecuritiesSettlementTransactionConfirmationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionConfirmationV01.XmlTag)]
    public required SecuritiesSettlementTransactionConfirmationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionConfirmationV01.XmlTag);
