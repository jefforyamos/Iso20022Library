...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionConfirmationV06.  ISO2002 ID# _YSWHDQCTEeW_3KiG8SEjHA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionConfirmationV06>;
...
public partial record SecuritiesSettlementTransactionConfirmationV06 : IOuterRecord<SecuritiesSettlementTransactionConfirmationV06,SecuritiesSettlementTransactionConfirmationV06Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionConfirmationV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionConfirmationV06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionConfirmationV06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionConfirmationV06Document ToDocument()
    {
        return new SecuritiesSettlementTransactionConfirmationV06Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (AdditionalParameters is AdditionalParameters22 AdditionalParametersValue)
        {
    ...
    public static SecuritiesSettlementTransactionConfirmationV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionConfirmationV06"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionConfirmationV06Document : IOuterDocument<SecuritiesSettlementTransactionConfirmationV06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionConfirmationV06"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionConfirmationV06.XmlTag)]
    public required SecuritiesSettlementTransactionConfirmationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionConfirmationV06.XmlTag);
