...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionCounterpartyResponse002V03.  ISO2002 ID# _hj7N8yAfEeuyDZ-ukt4YRg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionCounterpartyResponse002V03>;
...
public partial record SecuritiesSettlementTransactionCounterpartyResponse002V03 : IOuterRecord<SecuritiesSettlementTransactionCounterpartyResponse002V03,SecuritiesSettlementTransactionCounterpartyResponse002V03Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionCounterpartyResponse002V03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionCounterpartyResponse002V03Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionCounterpartyResponse002V03Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionCounterpartyResponse002V03Document ToDocument()
    {
        return new SecuritiesSettlementTransactionCounterpartyResponse002V03Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails146 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionCounterpartyResponse002V03 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionCounterpartyResponse002V03"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionCounterpartyResponse002V03Document : IOuterDocument<SecuritiesSettlementTransactionCounterpartyResponse002V03>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionCounterpartyResponse002V03"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionCounterpartyResponse002V03.XmlTag)]
    public required SecuritiesSettlementTransactionCounterpartyResponse002V03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionCounterpartyResponse002V03.XmlTag);
