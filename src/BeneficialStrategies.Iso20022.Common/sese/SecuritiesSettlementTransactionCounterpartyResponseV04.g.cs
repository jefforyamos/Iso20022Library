...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionCounterpartyResponseV04>;
...
public partial record SecuritiesSettlementTransactionCounterpartyResponseV04 : IOuterRecord<SecuritiesSettlementTransactionCounterpartyResponseV04,SecuritiesSettlementTransactionCounterpartyResponseV04Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionCounterpartyResponseV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionCounterpartyResponseV04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails149 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionCounterpartyResponseV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionCounterpartyResponseV04Document : IOuterDocument<SecuritiesSettlementTransactionCounterpartyResponseV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionCounterpartyResponseV04.XmlTag)]
    public required SecuritiesSettlementTransactionCounterpartyResponseV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionCounterpartyResponseV04.XmlTag);
