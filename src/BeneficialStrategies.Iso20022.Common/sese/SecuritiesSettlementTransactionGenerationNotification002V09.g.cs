...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionGenerationNotification002V09.  ISO2002 ID# _J4Co4_fYEeiNZp_PtLohLw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionGenerationNotification002V09>;
...
public partial record SecuritiesSettlementTransactionGenerationNotification002V09 : IOuterRecord<SecuritiesSettlementTransactionGenerationNotification002V09,SecuritiesSettlementTransactionGenerationNotification002V09Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionGenerationNotification002V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionGenerationNotification002V09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionGenerationNotification002V09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionGenerationNotification002V09Document ToDocument()
    {
        return new SecuritiesSettlementTransactionGenerationNotification002V09Document { Message = this };
    }
    ...
    public static SecuritiesSettlementTransactionGenerationNotification002V09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionGenerationNotification002V09"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionGenerationNotification002V09Document : IOuterDocument<SecuritiesSettlementTransactionGenerationNotification002V09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionGenerationNotification002V09"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionGenerationNotification002V09.XmlTag)]
    public required SecuritiesSettlementTransactionGenerationNotification002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionGenerationNotification002V09.XmlTag);
