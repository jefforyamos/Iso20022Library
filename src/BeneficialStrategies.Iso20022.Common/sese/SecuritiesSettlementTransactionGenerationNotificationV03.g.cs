...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionGenerationNotificationV03>;
...
public partial record SecuritiesSettlementTransactionGenerationNotificationV03 : IOuterRecord<SecuritiesSettlementTransactionGenerationNotificationV03,SecuritiesSettlementTransactionGenerationNotificationV03Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionGenerationNotificationV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashParties is CashParties8 CashPartiesValue)
        {
        ...
        if (GeneratedReason is GeneratedReason1 GeneratedReasonValue)
        {
            writer.WriteStartElement(null, "GnrtdRsn", xmlNamespace );
            GeneratedReasonValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (StatusAndReason is StatusAndReason12 StatusAndReasonValue)
        {
    ...
    public static SecuritiesSettlementTransactionGenerationNotificationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionGenerationNotificationV03Document : IOuterDocument<SecuritiesSettlementTransactionGenerationNotificationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionGenerationNotificationV03.XmlTag)]
    public required SecuritiesSettlementTransactionGenerationNotificationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionGenerationNotificationV03.XmlTag);
