...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionGenerationNotificationV08.  ISO2002 ID# _VMWXkaz1EeeBIMhGLpLUsQ.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionGenerationNotificationV08>;
...
public partial record SecuritiesSettlementTransactionGenerationNotificationV08 : IOuterRecord<SecuritiesSettlementTransactionGenerationNotificationV08,SecuritiesSettlementTransactionGenerationNotificationV08Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionGenerationNotificationV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionGenerationNotificationV08Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionGenerationNotificationV08Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionGenerationNotificationV08Document ToDocument()
    {
        return new SecuritiesSettlementTransactionGenerationNotificationV08Document { Message = this };
    }
    ...
    public static SecuritiesSettlementTransactionGenerationNotificationV08 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionGenerationNotificationV08"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionGenerationNotificationV08Document : IOuterDocument<SecuritiesSettlementTransactionGenerationNotificationV08>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionGenerationNotificationV08"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionGenerationNotificationV08.XmlTag)]
    public required SecuritiesSettlementTransactionGenerationNotificationV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionGenerationNotificationV08.XmlTag);
