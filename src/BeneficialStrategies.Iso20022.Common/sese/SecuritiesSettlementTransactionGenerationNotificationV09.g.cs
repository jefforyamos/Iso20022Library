...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionGenerationNotificationV09>;
...
public partial record SecuritiesSettlementTransactionGenerationNotificationV09 : IOuterRecord<SecuritiesSettlementTransactionGenerationNotificationV09,SecuritiesSettlementTransactionGenerationNotificationV09Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionGenerationNotificationV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionGenerationNotificationV09Document.DocumentNamespace;
    ...
    public static SecuritiesSettlementTransactionGenerationNotificationV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionGenerationNotificationV09Document : IOuterDocument<SecuritiesSettlementTransactionGenerationNotificationV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionGenerationNotificationV09.XmlTag)]
    public required SecuritiesSettlementTransactionGenerationNotificationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionGenerationNotificationV09.XmlTag);
