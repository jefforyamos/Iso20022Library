...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionInstruction002V06>;
...
public partial record SecuritiesSettlementTransactionInstruction002V06 : IOuterRecord<SecuritiesSettlementTransactionInstruction002V06,SecuritiesSettlementTransactionInstruction002V06Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionInstruction002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionInstruction002V06Document.DocumentNamespace;
    ...
    public static SecuritiesSettlementTransactionInstruction002V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionInstruction002V06Document : IOuterDocument<SecuritiesSettlementTransactionInstruction002V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionInstruction002V06.XmlTag)]
    public required SecuritiesSettlementTransactionInstruction002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionInstruction002V06.XmlTag);
