...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionInstruction002V11>;
...
public partial record SecuritiesSettlementTransactionInstruction002V11 : IOuterRecord<SecuritiesSettlementTransactionInstruction002V11,SecuritiesSettlementTransactionInstruction002V11Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionInstruction002V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionInstruction002V11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Linkages is Linkages65 LinkagesValue)
        {
    ...
    public static SecuritiesSettlementTransactionInstruction002V11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionInstruction002V11Document : IOuterDocument<SecuritiesSettlementTransactionInstruction002V11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionInstruction002V11.XmlTag)]
    public required SecuritiesSettlementTransactionInstruction002V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionInstruction002V11.XmlTag);
