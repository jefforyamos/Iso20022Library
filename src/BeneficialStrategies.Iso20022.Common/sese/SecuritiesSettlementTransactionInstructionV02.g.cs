...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionInstructionV02>;
...
public partial record SecuritiesSettlementTransactionInstructionV02 : IOuterRecord<SecuritiesSettlementTransactionInstructionV02,SecuritiesSettlementTransactionInstructionV02Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionInstructionV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionInstructionV02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Linkages is Linkages7 LinkagesValue)
        {
        ...
        if (OtherAmounts is OtherAmounts12 OtherAmountsValue)
        {
            writer.WriteStartElement(null, "OthrAmts", xmlNamespace );
            OtherAmountsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (OtherBusinessParties is OtherParties8 OtherBusinessPartiesValue)
        {
    ...
    public static SecuritiesSettlementTransactionInstructionV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionInstructionV02Document : IOuterDocument<SecuritiesSettlementTransactionInstructionV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionInstructionV02.XmlTag)]
    public required SecuritiesSettlementTransactionInstructionV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionInstructionV02.XmlTag);
