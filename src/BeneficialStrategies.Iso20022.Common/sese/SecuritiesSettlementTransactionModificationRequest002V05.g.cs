...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionModificationRequest002V05>;
...
public partial record SecuritiesSettlementTransactionModificationRequest002V05 : IOuterRecord<SecuritiesSettlementTransactionModificationRequest002V05,SecuritiesSettlementTransactionModificationRequest002V05Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionModificationRequest002V05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionModificationRequest002V05Document.DocumentNamespace;
    ...
    public required ValueList<UpdateType26Choice_> UpdateType { get; init; } = []; // Min=1, Max=3
    ...
    public static SecuritiesSettlementTransactionModificationRequest002V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionModificationRequest002V05Document : IOuterDocument<SecuritiesSettlementTransactionModificationRequest002V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionModificationRequest002V05.XmlTag)]
    public required SecuritiesSettlementTransactionModificationRequest002V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionModificationRequest002V05.XmlTag);
