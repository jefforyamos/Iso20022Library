...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionModificationRequest002V07>;
...
public partial record SecuritiesSettlementTransactionModificationRequest002V07 : IOuterRecord<SecuritiesSettlementTransactionModificationRequest002V07,SecuritiesSettlementTransactionModificationRequest002V07Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionModificationRequest002V07>, ISerializeInsideARootElement
{
    ...
    public required ValueList<UpdateType30Choice_> UpdateType { get; init; } = []; // Min=1, Max=3
    ...
    public static SecuritiesSettlementTransactionModificationRequest002V07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionModificationRequest002V07Document : IOuterDocument<SecuritiesSettlementTransactionModificationRequest002V07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionModificationRequest002V07.XmlTag)]
    public required SecuritiesSettlementTransactionModificationRequest002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionModificationRequest002V07.XmlTag);
