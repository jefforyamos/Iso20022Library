...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionModificationRequest002V08>;
...
public partial record SecuritiesSettlementTransactionModificationRequest002V08 : IOuterRecord<SecuritiesSettlementTransactionModificationRequest002V08,SecuritiesSettlementTransactionModificationRequest002V08Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionModificationRequest002V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionModificationRequest002V08Document.DocumentNamespace;
    ...
    public required ValueList<UpdateType34Choice_> UpdateType { get; init; } = []; // Min=1, Max=3
    ...
    public static SecuritiesSettlementTransactionModificationRequest002V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionModificationRequest002V08Document : IOuterDocument<SecuritiesSettlementTransactionModificationRequest002V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionModificationRequest002V08.XmlTag)]
    public required SecuritiesSettlementTransactionModificationRequest002V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionModificationRequest002V08.XmlTag);
