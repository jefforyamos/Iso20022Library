...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionModificationRequestV01>;
...
public partial record SecuritiesSettlementTransactionModificationRequestV01 : IOuterRecord<SecuritiesSettlementTransactionModificationRequestV01,SecuritiesSettlementTransactionModificationRequestV01Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionModificationRequestV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionModificationRequestV01Document.DocumentNamespace;
    ...
    public required ValueList<UpdateType5Choice_> UpdateType { get; init; } = []; // Min=1, Max=3
    ...
    public static SecuritiesSettlementTransactionModificationRequestV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionModificationRequestV01Document : IOuterDocument<SecuritiesSettlementTransactionModificationRequestV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionModificationRequestV01.XmlTag)]
    public required SecuritiesSettlementTransactionModificationRequestV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionModificationRequestV01.XmlTag);
