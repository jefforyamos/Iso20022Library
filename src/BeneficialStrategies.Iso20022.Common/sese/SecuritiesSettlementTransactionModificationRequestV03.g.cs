...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionModificationRequestV03>;
...
public partial record SecuritiesSettlementTransactionModificationRequestV03 : IOuterRecord<SecuritiesSettlementTransactionModificationRequestV03,SecuritiesSettlementTransactionModificationRequestV03Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionModificationRequestV03>, ISerializeInsideARootElement
{
    ...
    public required ValueList<UpdateType11Choice_> UpdateType { get; init; } = []; // Min=1, Max=3
    ...
    public static SecuritiesSettlementTransactionModificationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionModificationRequestV03Document : IOuterDocument<SecuritiesSettlementTransactionModificationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionModificationRequestV03.XmlTag)]
    public required SecuritiesSettlementTransactionModificationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionModificationRequestV03.XmlTag);
