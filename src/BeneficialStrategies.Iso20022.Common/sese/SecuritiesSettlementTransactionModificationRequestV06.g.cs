...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionModificationRequestV06>;
...
public partial record SecuritiesSettlementTransactionModificationRequestV06 : IOuterRecord<SecuritiesSettlementTransactionModificationRequestV06,SecuritiesSettlementTransactionModificationRequestV06Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionModificationRequestV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionModificationRequestV06Document.DocumentNamespace;
    ...
    public required ValueList<UpdateType27Choice_> UpdateType { get; init; } = []; // Min=1, Max=3
    ...
    public static SecuritiesSettlementTransactionModificationRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionModificationRequestV06Document : IOuterDocument<SecuritiesSettlementTransactionModificationRequestV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionModificationRequestV06.XmlTag)]
    public required SecuritiesSettlementTransactionModificationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionModificationRequestV06.XmlTag);
