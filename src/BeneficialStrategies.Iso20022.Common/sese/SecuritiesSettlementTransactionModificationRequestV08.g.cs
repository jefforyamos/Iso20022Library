...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionModificationRequestV08>;
...
public partial record SecuritiesSettlementTransactionModificationRequestV08 : IOuterRecord<SecuritiesSettlementTransactionModificationRequestV08,SecuritiesSettlementTransactionModificationRequestV08Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionModificationRequestV08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionModificationRequestV08Document.DocumentNamespace;
    ...
    public required ValueList<UpdateType33Choice_> UpdateType { get; init; } = []; // Min=1, Max=3
    ...
    public static SecuritiesSettlementTransactionModificationRequestV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionModificationRequestV08Document : IOuterDocument<SecuritiesSettlementTransactionModificationRequestV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionModificationRequestV08.XmlTag)]
    public required SecuritiesSettlementTransactionModificationRequestV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionModificationRequestV08.XmlTag);
