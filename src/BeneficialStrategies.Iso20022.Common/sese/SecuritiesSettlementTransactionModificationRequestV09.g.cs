...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionModificationRequestV09>;
...
public partial record SecuritiesSettlementTransactionModificationRequestV09 : IOuterRecord<SecuritiesSettlementTransactionModificationRequestV09,SecuritiesSettlementTransactionModificationRequestV09Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionModificationRequestV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionModificationRequestV09Document.DocumentNamespace;
    ...
    public required ValueList<UpdateType37Choice_> UpdateType { get; init; } = []; // Min=1, Max=3
    ...
    public static SecuritiesSettlementTransactionModificationRequestV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionModificationRequestV09Document : IOuterDocument<SecuritiesSettlementTransactionModificationRequestV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionModificationRequestV09.XmlTag)]
    public required SecuritiesSettlementTransactionModificationRequestV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionModificationRequestV09.XmlTag);
