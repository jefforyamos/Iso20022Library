...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionReversalAdviceV02.  ISO2002 ID# __VmJQdtZEd-RF5yaMAVhAw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionReversalAdviceV02>;
...
public partial record SecuritiesSettlementTransactionReversalAdviceV02 : IOuterRecord<SecuritiesSettlementTransactionReversalAdviceV02,SecuritiesSettlementTransactionReversalAdviceV02Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionReversalAdviceV02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionReversalAdviceV02Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionReversalAdviceV02Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV02Document ToDocument()
    {
        return new SecuritiesSettlementTransactionReversalAdviceV02Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAttributes is FinancialInstrumentAttributes20 FinancialInstrumentAttributesValue)
        {
        ...
        if (OtherAmounts is OtherAmounts9 OtherAmountsValue)
        {
            writer.WriteStartElement(null, "OthrAmts", xmlNamespace );
            OtherAmountsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (OtherBusinessParties is OtherParties12 OtherBusinessPartiesValue)
        {
    ...
    public static SecuritiesSettlementTransactionReversalAdviceV02 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionReversalAdviceV02"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionReversalAdviceV02Document : IOuterDocument<SecuritiesSettlementTransactionReversalAdviceV02>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionReversalAdviceV02"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionReversalAdviceV02.XmlTag)]
    public required SecuritiesSettlementTransactionReversalAdviceV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionReversalAdviceV02.XmlTag);
