...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionReversalAdviceV05.  ISO2002 ID# _YSWH7wCTEeW_3KiG8SEjHA.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionReversalAdviceV05>;
...
public partial record SecuritiesSettlementTransactionReversalAdviceV05 : IOuterRecord<SecuritiesSettlementTransactionReversalAdviceV05,SecuritiesSettlementTransactionReversalAdviceV05Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionReversalAdviceV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionReversalAdviceV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionReversalAdviceV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV05Document ToDocument()
    {
        return new SecuritiesSettlementTransactionReversalAdviceV05Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (AdditionalParameters is AdditionalParameters23 AdditionalParametersValue)
        {
    ...
    public static SecuritiesSettlementTransactionReversalAdviceV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionReversalAdviceV05"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionReversalAdviceV05Document : IOuterDocument<SecuritiesSettlementTransactionReversalAdviceV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionReversalAdviceV05"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionReversalAdviceV05.XmlTag)]
    public required SecuritiesSettlementTransactionReversalAdviceV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionReversalAdviceV05.XmlTag);
