...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionReversalAdviceV06>;
...
public partial record SecuritiesSettlementTransactionReversalAdviceV06 : IOuterRecord<SecuritiesSettlementTransactionReversalAdviceV06,SecuritiesSettlementTransactionReversalAdviceV06Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionReversalAdviceV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionReversalAdviceV06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (SettledAmount is AmountAndDirection46 SettledAmountValue)
        {
            writer.WriteStartElement(null, "SttldAmt", xmlNamespace );
            SettledAmountValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (OtherAmounts is OtherAmounts30 OtherAmountsValue)
        {
    ...
    public static SecuritiesSettlementTransactionReversalAdviceV06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionReversalAdviceV06"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionReversalAdviceV06Document : IOuterDocument<SecuritiesSettlementTransactionReversalAdviceV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionReversalAdviceV06.XmlTag)]
    public required SecuritiesSettlementTransactionReversalAdviceV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionReversalAdviceV06.XmlTag);
