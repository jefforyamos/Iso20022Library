...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionReversalAdviceV09.  ISO2002 ID# _9Zb5UQmDEeuQ1MenzX1l-g.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionReversalAdviceV09>;
...
public partial record SecuritiesSettlementTransactionReversalAdviceV09 : IOuterRecord<SecuritiesSettlementTransactionReversalAdviceV09,SecuritiesSettlementTransactionReversalAdviceV09Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionReversalAdviceV09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionReversalAdviceV09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionReversalAdviceV09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV09Document ToDocument()
    {
        return new SecuritiesSettlementTransactionReversalAdviceV09Document { Message = this };
    }
    ...
    public static SecuritiesSettlementTransactionReversalAdviceV09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionReversalAdviceV09"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionReversalAdviceV09Document : IOuterDocument<SecuritiesSettlementTransactionReversalAdviceV09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionReversalAdviceV09"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionReversalAdviceV09.XmlTag)]
    public required SecuritiesSettlementTransactionReversalAdviceV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionReversalAdviceV09.XmlTag);
