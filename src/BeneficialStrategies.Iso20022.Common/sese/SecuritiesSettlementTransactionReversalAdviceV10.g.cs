...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionReversalAdviceV10.  ISO2002 ID# _x9gWwSgTEeym1_Zp1BTvEw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionReversalAdviceV10>;
...
public partial record SecuritiesSettlementTransactionReversalAdviceV10 : IOuterRecord<SecuritiesSettlementTransactionReversalAdviceV10,SecuritiesSettlementTransactionReversalAdviceV10Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionReversalAdviceV10>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionReversalAdviceV10Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionReversalAdviceV10Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionReversalAdviceV10Document ToDocument()
    {
        return new SecuritiesSettlementTransactionReversalAdviceV10Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoMax35Text(ConfirmationReference)); // data type Max35Text System.String
        writer.WriteEndElement();
    ...
    public static SecuritiesSettlementTransactionReversalAdviceV10 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionReversalAdviceV10"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionReversalAdviceV10Document : IOuterDocument<SecuritiesSettlementTransactionReversalAdviceV10>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionReversalAdviceV10"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionReversalAdviceV10.XmlTag)]
    public required SecuritiesSettlementTransactionReversalAdviceV10 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionReversalAdviceV10.XmlTag);
