...
//
// Generated by MainMessageGenerator for SecuritiesSettlementTransactionStatusAdvice002V07.  ISO2002 ID# _8NnkM5NLEeWGlc8L7oPDIg.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionStatusAdvice002V07>;
...
public partial record SecuritiesSettlementTransactionStatusAdvice002V07 : IOuterRecord<SecuritiesSettlementTransactionStatusAdvice002V07,SecuritiesSettlementTransactionStatusAdvice002V07Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionStatusAdvice002V07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionStatusAdvice002V07Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionStatusAdvice002V07Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionStatusAdvice002V07Document ToDocument()
    {
        return new SecuritiesSettlementTransactionStatusAdvice002V07Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails87 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionStatusAdvice002V07 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionStatusAdvice002V07"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionStatusAdvice002V07Document : IOuterDocument<SecuritiesSettlementTransactionStatusAdvice002V07>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionStatusAdvice002V07"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionStatusAdvice002V07.XmlTag)]
    public required SecuritiesSettlementTransactionStatusAdvice002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionStatusAdvice002V07.XmlTag);
