...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionStatusAdvice002V09>;
...
public partial record SecuritiesSettlementTransactionStatusAdvice002V09 : IOuterRecord<SecuritiesSettlementTransactionStatusAdvice002V09,SecuritiesSettlementTransactionStatusAdvice002V09Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionStatusAdvice002V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionStatusAdvice002V09Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails110 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionStatusAdvice002V09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionStatusAdvice002V09Document : IOuterDocument<SecuritiesSettlementTransactionStatusAdvice002V09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionStatusAdvice002V09.XmlTag)]
    public required SecuritiesSettlementTransactionStatusAdvice002V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionStatusAdvice002V09.XmlTag);
