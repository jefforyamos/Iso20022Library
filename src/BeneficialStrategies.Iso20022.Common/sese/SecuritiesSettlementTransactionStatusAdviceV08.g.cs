...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionStatusAdviceV08>;
...
public partial record SecuritiesSettlementTransactionStatusAdviceV08 : IOuterRecord<SecuritiesSettlementTransactionStatusAdviceV08,SecuritiesSettlementTransactionStatusAdviceV08Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionStatusAdviceV08>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TransactionDetails is TransactionDetails97 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionStatusAdviceV08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionStatusAdviceV08Document : IOuterDocument<SecuritiesSettlementTransactionStatusAdviceV08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionStatusAdviceV08.XmlTag)]
    public required SecuritiesSettlementTransactionStatusAdviceV08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionStatusAdviceV08.XmlTag);
