...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesSettlementTransactionStatusAdviceV12>;
...
public partial record SecuritiesSettlementTransactionStatusAdviceV12 : IOuterRecord<SecuritiesSettlementTransactionStatusAdviceV12,SecuritiesSettlementTransactionStatusAdviceV12Document>
    ,IIsoXmlSerilizable<SecuritiesSettlementTransactionStatusAdviceV12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesSettlementTransactionStatusAdviceV12Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="SecuritiesSettlementTransactionStatusAdviceV12Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public SecuritiesSettlementTransactionStatusAdviceV12Document ToDocument()
    {
        return new SecuritiesSettlementTransactionStatusAdviceV12Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ProcessingStatus is ProcessingStatus88Choice_ ProcessingStatusValue)
        {
        ...
        if (SettlementStatus is SettlementStatus30Choice_ SettlementStatusValue)
        {
            writer.WriteStartElement(null, "SttlmSts", xmlNamespace );
            SettlementStatusValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TransactionDetails is TransactionDetails148 TransactionDetailsValue)
        {
    ...
    public static SecuritiesSettlementTransactionStatusAdviceV12 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="SecuritiesSettlementTransactionStatusAdviceV12"/>.
/// </summary>
[Serializable]
public partial record SecuritiesSettlementTransactionStatusAdviceV12Document : IOuterDocument<SecuritiesSettlementTransactionStatusAdviceV12>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="SecuritiesSettlementTransactionStatusAdviceV12"/> is required.
    /// </summary>
    [DataMember(Name=SecuritiesSettlementTransactionStatusAdviceV12.XmlTag)]
    public required SecuritiesSettlementTransactionStatusAdviceV12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesSettlementTransactionStatusAdviceV12.XmlTag);
