...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesStatusOrStatementQueryStatusAdviceV03>;
...
public partial record SecuritiesStatusOrStatementQueryStatusAdviceV03 : IOuterRecord<SecuritiesStatusOrStatementQueryStatusAdviceV03,SecuritiesStatusOrStatementQueryStatusAdviceV03Document>
    ,IIsoXmlSerilizable<SecuritiesStatusOrStatementQueryStatusAdviceV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (StatusOrStatementRequested is StatusOrStatement5Choice_ StatusOrStatementRequestedValue)
        {
    ...
    public static SecuritiesStatusOrStatementQueryStatusAdviceV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesStatusOrStatementQueryStatusAdviceV03Document : IOuterDocument<SecuritiesStatusOrStatementQueryStatusAdviceV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesStatusOrStatementQueryStatusAdviceV03.XmlTag)]
    public required SecuritiesStatusOrStatementQueryStatusAdviceV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesStatusOrStatementQueryStatusAdviceV03.XmlTag);
