...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesStatusOrStatementQueryStatusAdviceV04>;
...
public partial record SecuritiesStatusOrStatementQueryStatusAdviceV04 : IOuterRecord<SecuritiesStatusOrStatementQueryStatusAdviceV04,SecuritiesStatusOrStatementQueryStatusAdviceV04Document>
    ,IIsoXmlSerilizable<SecuritiesStatusOrStatementQueryStatusAdviceV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (StatusOrStatementRequested is StatusOrStatement7Choice_ StatusOrStatementRequestedValue)
        {
    ...
    public static SecuritiesStatusOrStatementQueryStatusAdviceV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesStatusOrStatementQueryStatusAdviceV04Document : IOuterDocument<SecuritiesStatusOrStatementQueryStatusAdviceV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesStatusOrStatementQueryStatusAdviceV04.XmlTag)]
    public required SecuritiesStatusOrStatementQueryStatusAdviceV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesStatusOrStatementQueryStatusAdviceV04.XmlTag);
