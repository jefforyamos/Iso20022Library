...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesTransactionCancellationRequest002V06>;
...
public partial record SecuritiesTransactionCancellationRequest002V06 : IOuterRecord<SecuritiesTransactionCancellationRequest002V06,SecuritiesTransactionCancellationRequest002V06Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionCancellationRequest002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionCancellationRequest002V06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails120 TransactionDetailsValue)
        {
    ...
    public static SecuritiesTransactionCancellationRequest002V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionCancellationRequest002V06Document : IOuterDocument<SecuritiesTransactionCancellationRequest002V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionCancellationRequest002V06.XmlTag)]
    public required SecuritiesTransactionCancellationRequest002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionCancellationRequest002V06.XmlTag);
