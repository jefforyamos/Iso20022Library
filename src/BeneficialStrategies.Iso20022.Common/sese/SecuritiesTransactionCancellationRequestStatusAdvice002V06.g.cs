...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesTransactionCancellationRequestStatusAdvice002V06>;
...
public partial record SecuritiesTransactionCancellationRequestStatusAdvice002V06 : IOuterRecord<SecuritiesTransactionCancellationRequestStatusAdvice002V06,SecuritiesTransactionCancellationRequestStatusAdvice002V06Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionCancellationRequestStatusAdvice002V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionCancellationRequestStatusAdvice002V06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails143 TransactionDetailsValue)
        {
    ...
    public static SecuritiesTransactionCancellationRequestStatusAdvice002V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionCancellationRequestStatusAdvice002V06Document : IOuterDocument<SecuritiesTransactionCancellationRequestStatusAdvice002V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionCancellationRequestStatusAdvice002V06.XmlTag)]
    public required SecuritiesTransactionCancellationRequestStatusAdvice002V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionCancellationRequestStatusAdvice002V06.XmlTag);
