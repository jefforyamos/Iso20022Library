...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesTransactionCancellationRequestStatusAdvice002V07>;
...
public partial record SecuritiesTransactionCancellationRequestStatusAdvice002V07 : IOuterRecord<SecuritiesTransactionCancellationRequestStatusAdvice002V07,SecuritiesTransactionCancellationRequestStatusAdvice002V07Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionCancellationRequestStatusAdvice002V07>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteValue(SerializationFormatter.IsoRestrictedFINXMax16Text(CancellationRequestReference)); // data type RestrictedFINXMax16Text System.String
        writer.WriteEndElement();
        if (TransactionIdentification is TransactionIdentifications50 TransactionIdentificationValue)
        {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails162 TransactionDetailsValue)
        {
    ...
    public static SecuritiesTransactionCancellationRequestStatusAdvice002V07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionCancellationRequestStatusAdvice002V07Document : IOuterDocument<SecuritiesTransactionCancellationRequestStatusAdvice002V07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionCancellationRequestStatusAdvice002V07.XmlTag)]
    public required SecuritiesTransactionCancellationRequestStatusAdvice002V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionCancellationRequestStatusAdvice002V07.XmlTag);
