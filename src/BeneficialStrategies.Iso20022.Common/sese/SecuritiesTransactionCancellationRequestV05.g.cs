...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesTransactionCancellationRequestV05>;
...
public partial record SecuritiesTransactionCancellationRequestV05 : IOuterRecord<SecuritiesTransactionCancellationRequestV05,SecuritiesTransactionCancellationRequestV05Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionCancellationRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTransactionCancellationRequestV05Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CancellationReason is CancellationReason13 CancellationReasonValue)
        {
    ...
    public static SecuritiesTransactionCancellationRequestV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionCancellationRequestV05Document : IOuterDocument<SecuritiesTransactionCancellationRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionCancellationRequestV05.XmlTag)]
    public required SecuritiesTransactionCancellationRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionCancellationRequestV05.XmlTag);
