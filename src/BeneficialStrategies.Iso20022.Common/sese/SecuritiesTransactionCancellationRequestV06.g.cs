...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.SecuritiesTransactionCancellationRequestV06>;
...
public partial record SecuritiesTransactionCancellationRequestV06 : IOuterRecord<SecuritiesTransactionCancellationRequestV06,SecuritiesTransactionCancellationRequestV06Document>
    ,IIsoXmlSerilizable<SecuritiesTransactionCancellationRequestV06>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (TransactionDetails is TransactionDetails117 TransactionDetailsValue)
        {
    ...
    public static SecuritiesTransactionCancellationRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTransactionCancellationRequestV06Document : IOuterDocument<SecuritiesTransactionCancellationRequestV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTransactionCancellationRequestV06.XmlTag)]
    public required SecuritiesTransactionCancellationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTransactionCancellationRequestV06.XmlTag);
