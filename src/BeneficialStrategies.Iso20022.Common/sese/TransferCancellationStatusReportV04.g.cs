...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferCancellationStatusReportV04>;
...
public partial record TransferCancellationStatusReportV04 : IOuterRecord<TransferCancellationStatusReportV04,TransferCancellationStatusReportV04Document>
    ,IIsoXmlSerilizable<TransferCancellationStatusReportV04>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("TrfCxlStsRpt");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Reference is References40Choice_ ReferenceValue)
        {
    ...
    public static TransferCancellationStatusReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferCancellationStatusReportV04Document : IOuterDocument<TransferCancellationStatusReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferCancellationStatusReportV04.XmlTag)]
    public required TransferCancellationStatusReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferCancellationStatusReportV04.XmlTag);
