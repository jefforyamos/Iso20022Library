...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferCancellationStatusReportV05>;
...
public partial record TransferCancellationStatusReportV05 : IOuterRecord<TransferCancellationStatusReportV05,TransferCancellationStatusReportV05Document>
    ,IIsoXmlSerilizable<TransferCancellationStatusReportV05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (Reference is References49Choice_ ReferenceValue)
        {
    ...
    public static TransferCancellationStatusReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferCancellationStatusReportV05Document : IOuterDocument<TransferCancellationStatusReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferCancellationStatusReportV05.XmlTag)]
    public required TransferCancellationStatusReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferCancellationStatusReportV05.XmlTag);
