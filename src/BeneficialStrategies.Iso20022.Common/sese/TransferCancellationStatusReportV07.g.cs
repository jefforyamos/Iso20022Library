...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferCancellationStatusReportV07>;
...
public partial record TransferCancellationStatusReportV07 : IOuterRecord<TransferCancellationStatusReportV07,TransferCancellationStatusReportV07Document>
    ,IIsoXmlSerilizable<TransferCancellationStatusReportV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransferCancellationStatusReportV07Document.DocumentNamespace;
    ...
    public static TransferCancellationStatusReportV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferCancellationStatusReportV07Document : IOuterDocument<TransferCancellationStatusReportV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferCancellationStatusReportV07.XmlTag)]
    public required TransferCancellationStatusReportV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferCancellationStatusReportV07.XmlTag);
