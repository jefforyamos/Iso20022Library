...
//
// Generated by MainMessageGenerator for TransferInConfirmationV04.  ISO2002 ID# _EmP8oRgCEeKqWJINzXcn5g.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInConfirmationV04>;
...
public partial record TransferInConfirmationV04 : IOuterRecord<TransferInConfirmationV04,TransferInConfirmationV04Document>
    ,IIsoXmlSerilizable<TransferInConfirmationV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransferInConfirmationV04Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="TransferInConfirmationV04Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public TransferInConfirmationV04Document ToDocument()
    {
        return new TransferInConfirmationV04Document { Message = this };
    }
    ...
    public static TransferInConfirmationV04 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="TransferInConfirmationV04"/>.
/// </summary>
[Serializable]
public partial record TransferInConfirmationV04Document : IOuterDocument<TransferInConfirmationV04>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="TransferInConfirmationV04"/> is required.
    /// </summary>
    [DataMember(Name=TransferInConfirmationV04.XmlTag)]
    public required TransferInConfirmationV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInConfirmationV04.XmlTag);
