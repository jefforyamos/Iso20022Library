...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInConfirmationV07>;
...
public partial record TransferInConfirmationV07 : IOuterRecord<TransferInConfirmationV07,TransferInConfirmationV07Document>
    ,IIsoXmlSerilizable<TransferInConfirmationV07>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementDetails is DeliverInformation17 SettlementDetailsValue)
        {
    ...
    public static TransferInConfirmationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInConfirmationV07Document : IOuterDocument<TransferInConfirmationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInConfirmationV07.XmlTag)]
    public required TransferInConfirmationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInConfirmationV07.XmlTag);
