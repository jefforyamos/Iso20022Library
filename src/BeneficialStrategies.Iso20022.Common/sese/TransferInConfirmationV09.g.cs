...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInConfirmationV09>;
...
public partial record TransferInConfirmationV09 : IOuterRecord<TransferInConfirmationV09,TransferInConfirmationV09Document>
    ,IIsoXmlSerilizable<TransferInConfirmationV09>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementDetails is DeliverInformation20 SettlementDetailsValue)
        {
    ...
    public static TransferInConfirmationV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInConfirmationV09Document : IOuterDocument<TransferInConfirmationV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInConfirmationV09.XmlTag)]
    public required TransferInConfirmationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInConfirmationV09.XmlTag);
