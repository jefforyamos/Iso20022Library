...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInInstruction>;
...
public partial record TransferInInstruction : IOuterRecord<TransferInInstruction,TransferInInstructionDocument>
    ,IIsoXmlSerilizable<TransferInInstruction>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransferInInstructionDocument.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("sese.005.001.01");
    ...
    public static TransferInInstruction Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInInstructionDocument : IOuterDocument<TransferInInstruction>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInInstruction.XmlTag)]
    public required TransferInInstruction Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInInstruction.XmlTag);
