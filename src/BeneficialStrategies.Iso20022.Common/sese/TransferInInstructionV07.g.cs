...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInInstructionV07>;
...
public partial record TransferInInstructionV07 : IOuterRecord<TransferInInstructionV07,TransferInInstructionV07Document>
    ,IIsoXmlSerilizable<TransferInInstructionV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransferInInstructionV07Document.DocumentNamespace;
    ...
    public static TransferInInstructionV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInInstructionV07Document : IOuterDocument<TransferInInstructionV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInInstructionV07.XmlTag)]
    public required TransferInInstructionV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInInstructionV07.XmlTag);
