...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInInstructionV09>;
...
public partial record TransferInInstructionV09 : IOuterRecord<TransferInInstructionV09,TransferInInstructionV09Document>
    ,IIsoXmlSerilizable<TransferInInstructionV09>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementDetails is DeliverInformation21 SettlementDetailsValue)
        {
    ...
    public static TransferInInstructionV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInInstructionV09Document : IOuterDocument<TransferInInstructionV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInInstructionV09.XmlTag)]
    public required TransferInInstructionV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInInstructionV09.XmlTag);
