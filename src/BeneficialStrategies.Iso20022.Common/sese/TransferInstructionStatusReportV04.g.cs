...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInstructionStatusReportV04>;
...
public partial record TransferInstructionStatusReportV04 : IOuterRecord<TransferInstructionStatusReportV04,TransferInstructionStatusReportV04Document>
    ,IIsoXmlSerilizable<TransferInstructionStatusReportV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransferInstructionStatusReportV04Document.DocumentNamespace;
    ...
    public static TransferInstructionStatusReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInstructionStatusReportV04Document : IOuterDocument<TransferInstructionStatusReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInstructionStatusReportV04.XmlTag)]
    public required TransferInstructionStatusReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInstructionStatusReportV04.XmlTag);
