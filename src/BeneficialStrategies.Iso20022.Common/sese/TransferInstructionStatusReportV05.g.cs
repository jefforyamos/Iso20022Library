...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInstructionStatusReportV05>;
...
public partial record TransferInstructionStatusReportV05 : IOuterRecord<TransferInstructionStatusReportV05,TransferInstructionStatusReportV05Document>
    ,IIsoXmlSerilizable<TransferInstructionStatusReportV05>, ISerializeInsideARootElement
{
    ...
    public static TransferInstructionStatusReportV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInstructionStatusReportV05Document : IOuterDocument<TransferInstructionStatusReportV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInstructionStatusReportV05.XmlTag)]
    public required TransferInstructionStatusReportV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInstructionStatusReportV05.XmlTag);
