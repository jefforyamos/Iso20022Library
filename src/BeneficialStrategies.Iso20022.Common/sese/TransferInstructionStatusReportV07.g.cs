...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInstructionStatusReportV07>;
...
public partial record TransferInstructionStatusReportV07 : IOuterRecord<TransferInstructionStatusReportV07,TransferInstructionStatusReportV07Document>
    ,IIsoXmlSerilizable<TransferInstructionStatusReportV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransferInstructionStatusReportV07Document.DocumentNamespace;
    ...
    public static TransferInstructionStatusReportV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInstructionStatusReportV07Document : IOuterDocument<TransferInstructionStatusReportV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInstructionStatusReportV07.XmlTag)]
    public required TransferInstructionStatusReportV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInstructionStatusReportV07.XmlTag);
