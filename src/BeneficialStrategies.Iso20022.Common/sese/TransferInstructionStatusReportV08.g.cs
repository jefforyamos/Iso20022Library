...
//
// Generated by MainMessageGenerator for TransferInstructionStatusReportV08.  ISO2002 ID# _kFCMMZDhEem7fvtoGpNpow.
//
...
public partial record TransferInstructionStatusReportV08 : IOuterRecord
{
    ...
    */
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="TransferInstructionStatusReportV08Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public TransferInstructionStatusReportV08Document ToDocument()
    {
...
/// - a cancelled status and the reason for the status, or,|
/// - a cancellation pending status and the reason for the status.
/// This is the outer document that contains <seealso cref="TransferInstructionStatusReportV08"/>.
/// </summary>
[Serializable]
