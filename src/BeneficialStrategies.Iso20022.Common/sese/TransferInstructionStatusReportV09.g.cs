...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferInstructionStatusReportV09>;
...
public partial record TransferInstructionStatusReportV09 : IOuterRecord<TransferInstructionStatusReportV09,TransferInstructionStatusReportV09Document>
    ,IIsoXmlSerilizable<TransferInstructionStatusReportV09>, ISerializeInsideARootElement
{
    ...
    public static TransferInstructionStatusReportV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferInstructionStatusReportV09Document : IOuterDocument<TransferInstructionStatusReportV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferInstructionStatusReportV09.XmlTag)]
    public required TransferInstructionStatusReportV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferInstructionStatusReportV09.XmlTag);
