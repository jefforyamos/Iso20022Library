...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferOutCancellationRequestV03>;
...
public partial record TransferOutCancellationRequestV03 : IOuterRecord<TransferOutCancellationRequestV03,TransferOutCancellationRequestV03Document>
    ,IIsoXmlSerilizable<TransferOutCancellationRequestV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CancellationByTransferOutDetails is TransferOut7 CancellationByTransferOutDetailsValue)
        {
    ...
    public static TransferOutCancellationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferOutCancellationRequestV03Document : IOuterDocument<TransferOutCancellationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferOutCancellationRequestV03.XmlTag)]
    public required TransferOutCancellationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferOutCancellationRequestV03.XmlTag);
