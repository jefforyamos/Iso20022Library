...
/// </summary>
[Serializable]
public partial record TransferOutCancellationRequestV05Document : IOuterDocument<TransferOutCancellationRequestV05>
{
    ...
    #else
    public TransferOutCancellationRequestV05 Message { get; init; }
    #endif
}
