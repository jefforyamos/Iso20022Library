...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferOutCancellationRequestV06>;
...
public partial record TransferOutCancellationRequestV06 : IOuterRecord<TransferOutCancellationRequestV06,TransferOutCancellationRequestV06Document>
    ,IIsoXmlSerilizable<TransferOutCancellationRequestV06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransferOutCancellationRequestV06Document.DocumentNamespace;
    ...
    public static TransferOutCancellationRequestV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferOutCancellationRequestV06Document : IOuterDocument<TransferOutCancellationRequestV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferOutCancellationRequestV06.XmlTag)]
    public required TransferOutCancellationRequestV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferOutCancellationRequestV06.XmlTag);
