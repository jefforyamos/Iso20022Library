...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferOutConfirmationV06>;
...
public partial record TransferOutConfirmationV06 : IOuterRecord<TransferOutConfirmationV06,TransferOutConfirmationV06Document>
    ,IIsoXmlSerilizable<TransferOutConfirmationV06>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementDetails is ReceiveInformation14 SettlementDetailsValue)
        {
    ...
    public static TransferOutConfirmationV06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferOutConfirmationV06Document : IOuterDocument<TransferOutConfirmationV06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferOutConfirmationV06.XmlTag)]
    public required TransferOutConfirmationV06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferOutConfirmationV06.XmlTag);
