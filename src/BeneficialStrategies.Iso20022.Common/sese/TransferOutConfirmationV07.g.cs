...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferOutConfirmationV07>;
...
public partial record TransferOutConfirmationV07 : IOuterRecord<TransferOutConfirmationV07,TransferOutConfirmationV07Document>
    ,IIsoXmlSerilizable<TransferOutConfirmationV07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TransferOutConfirmationV07Document.DocumentNamespace;
    ...
    public static TransferOutConfirmationV07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferOutConfirmationV07Document : IOuterDocument<TransferOutConfirmationV07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferOutConfirmationV07.XmlTag)]
    public required TransferOutConfirmationV07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferOutConfirmationV07.XmlTag);
