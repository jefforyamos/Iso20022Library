...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.sese.TransferOutConfirmationV09>;
...
public partial record TransferOutConfirmationV09 : IOuterRecord<TransferOutConfirmationV09,TransferOutConfirmationV09Document>
    ,IIsoXmlSerilizable<TransferOutConfirmationV09>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (SettlementDetails is ReceiveInformation20 SettlementDetailsValue)
        {
    ...
    public static TransferOutConfirmationV09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TransferOutConfirmationV09Document : IOuterDocument<TransferOutConfirmationV09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TransferOutConfirmationV09.XmlTag)]
    public required TransferOutConfirmationV09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TransferOutConfirmationV09.XmlTag);
