...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.OrderInstructionStatusReportV03>;
...
public partial record OrderInstructionStatusReportV03 : IOuterRecord<OrderInstructionStatusReportV03,OrderInstructionStatusReportV03Document>
    ,IIsoXmlSerilizable<OrderInstructionStatusReportV03>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("OrdrInstrStsRptV03");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        writer.WriteStartElement(null, "SwtchOrdrDtlsRpt", xmlNamespace );
        SwitchOrderDetailsReport.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
    ...
    public static OrderInstructionStatusReportV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record OrderInstructionStatusReportV03Document : IOuterDocument<OrderInstructionStatusReportV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=OrderInstructionStatusReportV03.XmlTag)]
    public required OrderInstructionStatusReportV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(OrderInstructionStatusReportV03.XmlTag);
