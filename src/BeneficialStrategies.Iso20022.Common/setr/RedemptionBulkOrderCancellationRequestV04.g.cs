...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.RedemptionBulkOrderCancellationRequestV04>;
...
public partial record RedemptionBulkOrderCancellationRequestV04 : IOuterRecord<RedemptionBulkOrderCancellationRequestV04,RedemptionBulkOrderCancellationRequestV04Document>
    ,IIsoXmlSerilizable<RedemptionBulkOrderCancellationRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RedemptionBulkOrderCancellationRequestV04Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("RedBlkOrdrCxlReq");
    ...
    public static RedemptionBulkOrderCancellationRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RedemptionBulkOrderCancellationRequestV04Document : IOuterDocument<RedemptionBulkOrderCancellationRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RedemptionBulkOrderCancellationRequestV04.XmlTag)]
    public required RedemptionBulkOrderCancellationRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RedemptionBulkOrderCancellationRequestV04.XmlTag);
