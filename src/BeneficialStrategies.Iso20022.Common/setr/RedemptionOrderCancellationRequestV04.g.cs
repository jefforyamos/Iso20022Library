...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.RedemptionOrderCancellationRequestV04>;
...
public partial record RedemptionOrderCancellationRequestV04 : IOuterRecord<RedemptionOrderCancellationRequestV04,RedemptionOrderCancellationRequestV04Document>
    ,IIsoXmlSerilizable<RedemptionOrderCancellationRequestV04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => RedemptionOrderCancellationRequestV04Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("RedOrdrCxlReq");
    ...
    public static RedemptionOrderCancellationRequestV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record RedemptionOrderCancellationRequestV04Document : IOuterDocument<RedemptionOrderCancellationRequestV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=RedemptionOrderCancellationRequestV04.XmlTag)]
    public required RedemptionOrderCancellationRequestV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(RedemptionOrderCancellationRequestV04.XmlTag);
