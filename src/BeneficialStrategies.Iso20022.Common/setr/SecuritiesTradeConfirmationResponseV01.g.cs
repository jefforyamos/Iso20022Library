...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.SecuritiesTradeConfirmationResponseV01>;
...
public partial record SecuritiesTradeConfirmationResponseV01 : IOuterRecord<SecuritiesTradeConfirmationResponseV01,SecuritiesTradeConfirmationResponseV01Document>
    ,IIsoXmlSerilizable<SecuritiesTradeConfirmationResponseV01>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ConfirmationParties is ConfirmationParties3 ConfirmationPartiesValue)
        {
    ...
    public static SecuritiesTradeConfirmationResponseV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTradeConfirmationResponseV01Document : IOuterDocument<SecuritiesTradeConfirmationResponseV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTradeConfirmationResponseV01.XmlTag)]
    public required SecuritiesTradeConfirmationResponseV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTradeConfirmationResponseV01.XmlTag);
