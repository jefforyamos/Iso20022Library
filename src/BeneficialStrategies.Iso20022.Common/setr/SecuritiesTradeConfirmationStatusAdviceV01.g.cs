...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.SecuritiesTradeConfirmationStatusAdviceV01>;
...
public partial record SecuritiesTradeConfirmationStatusAdviceV01 : IOuterRecord<SecuritiesTradeConfirmationStatusAdviceV01,SecuritiesTradeConfirmationStatusAdviceV01Document>
    ,IIsoXmlSerilizable<SecuritiesTradeConfirmationStatusAdviceV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTradeConfirmationStatusAdviceV01Document.DocumentNamespace;
    ...
    public static SecuritiesTradeConfirmationStatusAdviceV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTradeConfirmationStatusAdviceV01Document : IOuterDocument<SecuritiesTradeConfirmationStatusAdviceV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTradeConfirmationStatusAdviceV01.XmlTag)]
    public required SecuritiesTradeConfirmationStatusAdviceV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTradeConfirmationStatusAdviceV01.XmlTag);
