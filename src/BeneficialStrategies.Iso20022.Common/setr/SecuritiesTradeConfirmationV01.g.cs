...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.SecuritiesTradeConfirmationV01>;
...
public partial record SecuritiesTradeConfirmationV01 : IOuterRecord<SecuritiesTradeConfirmationV01,SecuritiesTradeConfirmationV01Document>
    ,IIsoXmlSerilizable<SecuritiesTradeConfirmationV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => SecuritiesTradeConfirmationV01Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAttributes is FinancialInstrumentAttributes31 FinancialInstrumentAttributesValue)
        {
        ...
        if (UnderlyingFinancialInstrument is UnderlyingFinancialInstrument1 UnderlyingFinancialInstrumentValue)
        {
        ...
        if (CashParties is CashParties6 CashPartiesValue)
        {
    ...
    public static SecuritiesTradeConfirmationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTradeConfirmationV01Document : IOuterDocument<SecuritiesTradeConfirmationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTradeConfirmationV01.XmlTag)]
    public required SecuritiesTradeConfirmationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTradeConfirmationV01.XmlTag);
