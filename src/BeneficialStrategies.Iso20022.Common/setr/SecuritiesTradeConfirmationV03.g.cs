...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.SecuritiesTradeConfirmationV03>;
...
public partial record SecuritiesTradeConfirmationV03 : IOuterRecord<SecuritiesTradeConfirmationV03,SecuritiesTradeConfirmationV03Document>
    ,IIsoXmlSerilizable<SecuritiesTradeConfirmationV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (FinancialInstrumentAttributes is FinancialInstrumentAttributes44 FinancialInstrumentAttributesValue)
        {
        ...
        if (UnderlyingFinancialInstrument is UnderlyingFinancialInstrument2 UnderlyingFinancialInstrumentValue)
        {
        ...
        if (Stipulations is FinancialInstrumentStipulations2 StipulationsValue)
        {
        ...
        if (OtherPrices is OtherPrices2 OtherPricesValue)
        {
        ...
        if (TwoLegTransactionDetails is TwoLegTransactionDetails1 TwoLegTransactionDetailsValue)
        {
    ...
    public static SecuritiesTradeConfirmationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SecuritiesTradeConfirmationV03Document : IOuterDocument<SecuritiesTradeConfirmationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SecuritiesTradeConfirmationV03.XmlTag)]
    public required SecuritiesTradeConfirmationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SecuritiesTradeConfirmationV03.XmlTag);
