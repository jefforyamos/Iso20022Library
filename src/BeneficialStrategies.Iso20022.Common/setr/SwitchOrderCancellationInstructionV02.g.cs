...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.SwitchOrderCancellationInstructionV02>;
...
public partial record SwitchOrderCancellationInstructionV02 : IOuterRecord<SwitchOrderCancellationInstructionV02,SwitchOrderCancellationInstructionV02Document>
    ,IIsoXmlSerilizable<SwitchOrderCancellationInstructionV02>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("setr.014.001.02");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (OrderToBeCancelled is SwitchOrderInstruction1 OrderToBeCancelledValue)
        {
    ...
    public static SwitchOrderCancellationInstructionV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SwitchOrderCancellationInstructionV02Document : IOuterDocument<SwitchOrderCancellationInstructionV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SwitchOrderCancellationInstructionV02.XmlTag)]
    public required SwitchOrderCancellationInstructionV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SwitchOrderCancellationInstructionV02.XmlTag);
