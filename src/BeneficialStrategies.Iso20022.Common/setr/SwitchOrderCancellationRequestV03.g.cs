...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.setr.SwitchOrderCancellationRequestV03>;
...
public partial record SwitchOrderCancellationRequestV03 : IOuterRecord<SwitchOrderCancellationRequestV03,SwitchOrderCancellationRequestV03Document>
    ,IIsoXmlSerilizable<SwitchOrderCancellationRequestV03>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("SwtchOrdrCxlReqV03");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CancellationByOrderDetails is SwitchOrderInstruction2 CancellationByOrderDetailsValue)
        {
    ...
    public static SwitchOrderCancellationRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record SwitchOrderCancellationRequestV03Document : IOuterDocument<SwitchOrderCancellationRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=SwitchOrderCancellationRequestV03.XmlTag)]
    public required SwitchOrderCancellationRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(SwitchOrderCancellationRequestV03.XmlTag);
