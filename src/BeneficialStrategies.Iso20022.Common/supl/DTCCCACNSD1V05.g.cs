...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCACNSD1V05>;
...
public partial record DTCCCACNSD1V05 : IOuterRecord<DTCCCACNSD1V05,DTCCCACNSD1V05Document>
    ,IIsoXmlSerilizable<DTCCCACNSD1V05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GeneralInformation is CorporateActionGeneralInformationSD19 GeneralInformationValue)
        {
    ...
    public static DTCCCACNSD1V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCACNSD1V05Document : IOuterDocument<DTCCCACNSD1V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCACNSD1V05.XmlTag)]
    public required DTCCCACNSD1V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCACNSD1V05.XmlTag);
