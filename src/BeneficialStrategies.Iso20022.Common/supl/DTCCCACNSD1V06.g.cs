...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCACNSD1V06>;
...
public partial record DTCCCACNSD1V06 : IOuterRecord<DTCCCACNSD1V06,DTCCCACNSD1V06Document>
    ,IIsoXmlSerilizable<DTCCCACNSD1V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCACNSD1V06Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GeneralInformation is CorporateActionGeneralInformationSD24 GeneralInformationValue)
        {
    ...
    public static DTCCCACNSD1V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCACNSD1V06Document : IOuterDocument<DTCCCACNSD1V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCACNSD1V06.XmlTag)]
    public required DTCCCACNSD1V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCACNSD1V06.XmlTag);
