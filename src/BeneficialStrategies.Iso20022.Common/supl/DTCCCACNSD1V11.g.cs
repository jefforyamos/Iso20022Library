...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCACNSD1V11>;
...
public partial record DTCCCACNSD1V11 : IOuterRecord<DTCCCACNSD1V11,DTCCCACNSD1V11Document>
    ,IIsoXmlSerilizable<DTCCCACNSD1V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCACNSD1V11Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (GeneralInformation is CorporateActionGeneralInformationSD48 GeneralInformationValue)
        {
    ...
    public static DTCCCACNSD1V11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCACNSD1V11Document : IOuterDocument<DTCCCACNSD1V11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCACNSD1V11.XmlTag)]
    public required DTCCCACNSD1V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCACNSD1V11.XmlTag);
