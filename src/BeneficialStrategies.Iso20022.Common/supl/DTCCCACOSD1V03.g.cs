...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCACOSD1V03>;
...
public partial record DTCCCACOSD1V03 : IOuterRecord<DTCCCACOSD1V03,DTCCCACOSD1V03Document>
    ,IIsoXmlSerilizable<DTCCCACOSD1V03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionConfirmationSecuritiesMovementDetails is CorporateActionConfirmationSecuritiesMovementDetailsSD3 CorporateActionConfirmationSecuritiesMovementDetailsValue)
        {
    ...
    public static DTCCCACOSD1V03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCACOSD1V03Document : IOuterDocument<DTCCCACOSD1V03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCACOSD1V03.XmlTag)]
    public required DTCCCACOSD1V03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCACOSD1V03.XmlTag);
