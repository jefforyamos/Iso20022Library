...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCACOSD1V04>;
...
public partial record DTCCCACOSD1V04 : IOuterRecord<DTCCCACOSD1V04,DTCCCACOSD1V04Document>
    ,IIsoXmlSerilizable<DTCCCACOSD1V04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionConfirmationSecuritiesMovementDetails is CorporateActionConfirmationSecuritiesMovementDetailsSD4 CorporateActionConfirmationSecuritiesMovementDetailsValue)
        {
        ...
        if (CorporateActionConfirmationCashMovementDetails is CorporateActionConfirmationCashMovementDetailsSD3 CorporateActionConfirmationCashMovementDetailsValue)
        {
    ...
    public static DTCCCACOSD1V04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCACOSD1V04Document : IOuterDocument<DTCCCACOSD1V04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCACOSD1V04.XmlTag)]
    public required DTCCCACOSD1V04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCACOSD1V04.XmlTag);
