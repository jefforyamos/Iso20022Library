...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCACOSD1V06>;
...
public partial record DTCCCACOSD1V06 : IOuterRecord<DTCCCACOSD1V06,DTCCCACOSD1V06Document>
    ,IIsoXmlSerilizable<DTCCCACOSD1V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCACOSD1V06Document.DocumentNamespace;
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD32 CorporateActionGeneralInformationValue)
        {
        ...
        if (AccountBalance is AccountBalanceSD13 AccountBalanceValue)
        {
        ...
        if (OptionTransactionDetails is OptionTransactionDetailsSD4 OptionTransactionDetailsValue)
        {
    ...
    public static DTCCCACOSD1V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCACOSD1V06Document : IOuterDocument<DTCCCACOSD1V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCACOSD1V06.XmlTag)]
    public required DTCCCACOSD1V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCACOSD1V06.XmlTag);
