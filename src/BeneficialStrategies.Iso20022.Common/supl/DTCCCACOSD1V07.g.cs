...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCACOSD1V07>;
...
public partial record DTCCCACOSD1V07 : IOuterRecord<DTCCCACOSD1V07,DTCCCACOSD1V07Document>
    ,IIsoXmlSerilizable<DTCCCACOSD1V07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCACOSD1V07Document.DocumentNamespace;
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD37 CorporateActionGeneralInformationValue)
        {
        ...
        if (OptionTransactionDetails is OptionTransactionSD5 OptionTransactionDetailsValue)
        {
    ...
    public static DTCCCACOSD1V07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCACOSD1V07Document : IOuterDocument<DTCCCACOSD1V07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCACOSD1V07.XmlTag)]
    public required DTCCCACOSD1V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCACOSD1V07.XmlTag);
