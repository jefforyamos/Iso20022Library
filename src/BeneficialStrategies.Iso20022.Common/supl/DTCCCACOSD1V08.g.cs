...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCACOSD1V08>;
...
public partial record DTCCCACOSD1V08 : IOuterRecord<DTCCCACOSD1V08,DTCCCACOSD1V08Document>
    ,IIsoXmlSerilizable<DTCCCACOSD1V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCACOSD1V08Document.DocumentNamespace;
    ...
    public static DTCCCACOSD1V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCACOSD1V08Document : IOuterDocument<DTCCCACOSD1V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCACOSD1V08.XmlTag)]
    public required DTCCCACOSD1V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCACOSD1V08.XmlTag);
