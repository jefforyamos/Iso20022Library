...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAINSD1V06>;
...
public partial record DTCCCAINSD1V06 : IOuterRecord<DTCCCAINSD1V06,DTCCCAINSD1V06Document>
    ,IIsoXmlSerilizable<DTCCCAINSD1V06>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (ReorganisationInstructionDetails is ReorganisationInstructionSD10 ReorganisationInstructionDetailsValue)
        {
    ...
    public static DTCCCAINSD1V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAINSD1V06Document : IOuterDocument<DTCCCAINSD1V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAINSD1V06.XmlTag)]
    public required DTCCCAINSD1V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAINSD1V06.XmlTag);
