...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAISSD1V01>;
...
public partial record DTCCCAISSD1V01 : IOuterRecord<DTCCCAISSD1V01,DTCCCAISSD1V01Document>
    ,IIsoXmlSerilizable<DTCCCAISSD1V01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCAISSD1V01Document.DocumentNamespace;
    ...
    public static DTCCCAISSD1V01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAISSD1V01Document : IOuterDocument<DTCCCAISSD1V01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAISSD1V01.XmlTag)]
    public required DTCCCAISSD1V01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAISSD1V01.XmlTag);
