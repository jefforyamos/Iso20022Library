...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAISSD1V03>;
...
public partial record DTCCCAISSD1V03 : IOuterRecord<DTCCCAISSD1V03,DTCCCAISSD1V03Document>
    ,IIsoXmlSerilizable<DTCCCAISSD1V03>, ISerializeInsideARootElement
{
    ...
    {
        if (ReorganisationInstructionDetails is ReorganisationInstructionSD6 ReorganisationInstructionDetailsValue)
        {
    ...
    public static DTCCCAISSD1V03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAISSD1V03Document : IOuterDocument<DTCCCAISSD1V03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAISSD1V03.XmlTag)]
    public required DTCCCAISSD1V03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAISSD1V03.XmlTag);
