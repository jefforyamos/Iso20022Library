...
//
// Generated by MainMessageGenerator for DTCCCAISSD1V06.  ISO2002 ID# _Vk6qyzDmEey2N-DB7H7A5A.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAISSD1V06>;
...
public partial record DTCCCAISSD1V06 : IOuterRecord<DTCCCAISSD1V06,DTCCCAISSD1V06Document>
    ,IIsoXmlSerilizable<DTCCCAISSD1V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCAISSD1V06Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="DTCCCAISSD1V06Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public DTCCCAISSD1V06Document ToDocument()
    {
        return new DTCCCAISSD1V06Document { Message = this };
    }
    ...
    public static DTCCCAISSD1V06 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="DTCCCAISSD1V06"/>.
/// </summary>
[Serializable]
public partial record DTCCCAISSD1V06Document : IOuterDocument<DTCCCAISSD1V06>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="DTCCCAISSD1V06"/> is required.
    /// </summary>
    [DataMember(Name=DTCCCAISSD1V06.XmlTag)]
    public required DTCCCAISSD1V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAISSD1V06.XmlTag);
