...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V04>;
...
public partial record DTCCCANOCSDDataSD1V04 : IOuterRecord<DTCCCANOCSDDataSD1V04,DTCCCANOCSDDataSD1V04Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V04>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCANOCSDDataSD1V04Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD10 CorporateActionGeneralInformationValue)
        {
        ...
        if (CorporateActionDetails is CorporateActionSD7 CorporateActionDetailsValue)
        {
        ...
        if (OptionDetails is CorporateActionOptionSD6 OptionDetailsValue)
        {
            writer.WriteStartElement(null, "OptnDtls", xmlNamespace );
            OptionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SecuritiesMovementDetails is SecuritiesOptionSD5 SecuritiesMovementDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V04Document : IOuterDocument<DTCCCANOCSDDataSD1V04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V04.XmlTag)]
    public required DTCCCANOCSDDataSD1V04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V04.XmlTag);
