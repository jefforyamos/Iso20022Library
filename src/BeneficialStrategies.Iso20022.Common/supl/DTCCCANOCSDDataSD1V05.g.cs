...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V05>;
...
public partial record DTCCCANOCSDDataSD1V05 : IOuterRecord<DTCCCANOCSDDataSD1V05,DTCCCANOCSDDataSD1V05Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V05>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (OptionDetails is CorporateActionOptionSD8 OptionDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOptionSD6 CashMovementDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V05Document : IOuterDocument<DTCCCANOCSDDataSD1V05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V05.XmlTag)]
    public required DTCCCANOCSDDataSD1V05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V05.XmlTag);
