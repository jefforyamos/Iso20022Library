...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V06>;
...
public partial record DTCCCANOCSDDataSD1V06 : IOuterRecord<DTCCCANOCSDDataSD1V06,DTCCCANOCSDDataSD1V06Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V06>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCANOCSDDataSD1V06Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("DTCCCNCSDDataSD1");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD12 CorporateActionGeneralInformationValue)
        {
        ...
        if (UnderlyingSecurity is FinancialInstrumentAttributesSD11 UnderlyingSecurityValue)
        {
            writer.WriteStartElement(null, "UndrlygScty", xmlNamespace );
            UnderlyingSecurityValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionDetails is CorporateActionSD13 CorporateActionDetailsValue)
        {
        ...
        if (OptionDetails is CorporateActionOptionSD10 OptionDetailsValue)
        {
            writer.WriteStartElement(null, "OptnDtls", xmlNamespace );
            OptionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SecuritiesMovementDetails is SecuritiesOptionSD7 SecuritiesMovementDetailsValue)
        {
        ...
        if (SecuritiesMovementRateDetails is CorporateActionRateSD8 SecuritiesMovementRateDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOptionSD8 CashMovementDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V06Document : IOuterDocument<DTCCCANOCSDDataSD1V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V06.XmlTag)]
    public required DTCCCANOCSDDataSD1V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V06.XmlTag);
