...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V08>;
...
public partial record DTCCCANOCSDDataSD1V08 : IOuterRecord<DTCCCANOCSDDataSD1V08,DTCCCANOCSDDataSD1V08Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V08>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD22 CorporateActionGeneralInformationValue)
        {
        ...
        if (UnderlyingSecurity is FinancialInstrumentAttributesSD12 UnderlyingSecurityValue)
        {
        ...
        if (CashMovementDetails is CashOptionSD9 CashMovementDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V08Document : IOuterDocument<DTCCCANOCSDDataSD1V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V08.XmlTag)]
    public required DTCCCANOCSDDataSD1V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V08.XmlTag);
