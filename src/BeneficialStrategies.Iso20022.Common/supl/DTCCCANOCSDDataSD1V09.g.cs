...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V09>;
...
public partial record DTCCCANOCSDDataSD1V09 : IOuterRecord<DTCCCANOCSDDataSD1V09,DTCCCANOCSDDataSD1V09Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCANOCSDDataSD1V09Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="DTCCCANOCSDDataSD1V09Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public DTCCCANOCSDDataSD1V09Document ToDocument()
    {
        return new DTCCCANOCSDDataSD1V09Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD23 CorporateActionGeneralInformationValue)
        {
        ...
        if (UnderlyingSecurity is FinancialInstrumentAttributesSD14 UnderlyingSecurityValue)
        {
            writer.WriteStartElement(null, "UndrlygScty", xmlNamespace );
            UnderlyingSecurityValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionDetails is CorporateActionSD14 CorporateActionDetailsValue)
        {
        ...
        if (OptionDateDetails is CorporateActionDateSD7 OptionDateDetailsValue)
        {
            writer.WriteStartElement(null, "OptnDtDtls", xmlNamespace );
            OptionDateDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SecuritiesMovementDetails is SecuritiesOptionSD8 SecuritiesMovementDetailsValue)
        {
            writer.WriteStartElement(null, "SctiesMvmntDtls", xmlNamespace );
            SecuritiesMovementDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (SecuritiesMovementSecurityDetails is FinancialInstrumentAttributesSD13 SecuritiesMovementSecurityDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOptionSD10 CashMovementDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V09 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="DTCCCANOCSDDataSD1V09"/>.
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V09Document : IOuterDocument<DTCCCANOCSDDataSD1V09>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="DTCCCANOCSDDataSD1V09"/> is required.
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V09.XmlTag)]
    public required DTCCCANOCSDDataSD1V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V09.XmlTag);
