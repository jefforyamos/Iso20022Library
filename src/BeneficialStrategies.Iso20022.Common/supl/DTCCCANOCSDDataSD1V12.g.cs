...
//
// Generated by MainMessageGenerator for DTCCCANOCSDDataSD1V12.  ISO2002 ID# _x6QR0QB6EeqouY-yI_q3qQ.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V12>;
...
public partial record DTCCCANOCSDDataSD1V12 : IOuterRecord<DTCCCANOCSDDataSD1V12,DTCCCANOCSDDataSD1V12Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V12>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCANOCSDDataSD1V12Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="DTCCCANOCSDDataSD1V12Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public DTCCCANOCSDDataSD1V12Document ToDocument()
    {
        return new DTCCCANOCSDDataSD1V12Document { Message = this };
    }
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD41 CorporateActionGeneralInformationValue)
        {
        ...
        if (OptionDetails is CorporateActionOptionSD13 OptionDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V12 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="DTCCCANOCSDDataSD1V12"/>.
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V12Document : IOuterDocument<DTCCCANOCSDDataSD1V12>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="DTCCCANOCSDDataSD1V12"/> is required.
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V12.XmlTag)]
    public required DTCCCANOCSDDataSD1V12 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V12.XmlTag);
