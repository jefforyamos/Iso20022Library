...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V13>;
...
public partial record DTCCCANOCSDDataSD1V13 : IOuterRecord<DTCCCANOCSDDataSD1V13,DTCCCANOCSDDataSD1V13Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V13>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CashMovementDetails is CashOptionSD12 CashMovementDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V13 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V13Document : IOuterDocument<DTCCCANOCSDDataSD1V13>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V13.XmlTag)]
    public required DTCCCANOCSDDataSD1V13 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V13.XmlTag);
