...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V14>;
...
public partial record DTCCCANOCSDDataSD1V14 : IOuterRecord<DTCCCANOCSDDataSD1V14,DTCCCANOCSDDataSD1V14Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V14>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCANOCSDDataSD1V14Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD47 CorporateActionGeneralInformationValue)
        {
        ...
        if (UnderlyingSecurity is FinancialInstrumentAttributesSD19 UnderlyingSecurityValue)
        {
            writer.WriteStartElement(null, "UndrlygScty", xmlNamespace );
            UnderlyingSecurityValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionDetails is CorporateActionSD22 CorporateActionDetailsValue)
        {
            writer.WriteStartElement(null, "CorpActnDtls", xmlNamespace );
            CorporateActionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (CorporateActionDateDetails is CorporateActionDateSD10 CorporateActionDateDetailsValue)
        {
        ...
        if (OptionDetails is CorporateActionOptionSD14 OptionDetailsValue)
        {
            writer.WriteStartElement(null, "OptnDtls", xmlNamespace );
            OptionDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (OptionDateDetails is CorporateActionDateSD11 OptionDateDetailsValue)
        {
        ...
        if (CashMovementDetails is CashOptionSD13 CashMovementDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V14 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V14Document : IOuterDocument<DTCCCANOCSDDataSD1V14>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V14.XmlTag)]
    public required DTCCCANOCSDDataSD1V14 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V14.XmlTag);
