...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOCSDDataSD1V15>;
...
public partial record DTCCCANOCSDDataSD1V15 : IOuterRecord<DTCCCANOCSDDataSD1V15,DTCCCANOCSDDataSD1V15Document>
    ,IIsoXmlSerilizable<DTCCCANOCSDDataSD1V15>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (CorporateActionDetails is CorporateActionSD23 CorporateActionDetailsValue)
        {
    ...
    public static DTCCCANOCSDDataSD1V15 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOCSDDataSD1V15Document : IOuterDocument<DTCCCANOCSDDataSD1V15>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOCSDDataSD1V15.XmlTag)]
    public required DTCCCANOCSDDataSD1V15 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOCSDDataSD1V15.XmlTag);
