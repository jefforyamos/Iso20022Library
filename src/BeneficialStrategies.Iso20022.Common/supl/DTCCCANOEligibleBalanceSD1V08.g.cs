...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOEligibleBalanceSD1V08>;
...
public partial record DTCCCANOEligibleBalanceSD1V08 : IOuterRecord<DTCCCANOEligibleBalanceSD1V08,DTCCCANOEligibleBalanceSD1V08Document>
    ,IIsoXmlSerilizable<DTCCCANOEligibleBalanceSD1V08>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCANOEligibleBalanceSD1V08Document.DocumentNamespace;
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD38 CorporateActionGeneralInformationValue)
        {
    ...
    public static DTCCCANOEligibleBalanceSD1V08 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOEligibleBalanceSD1V08Document : IOuterDocument<DTCCCANOEligibleBalanceSD1V08>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOEligibleBalanceSD1V08.XmlTag)]
    public required DTCCCANOEligibleBalanceSD1V08 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOEligibleBalanceSD1V08.XmlTag);
