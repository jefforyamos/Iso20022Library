...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCANOEligibleBalanceSD1V11>;
...
public partial record DTCCCANOEligibleBalanceSD1V11 : IOuterRecord<DTCCCANOEligibleBalanceSD1V11,DTCCCANOEligibleBalanceSD1V11Document>
    ,IIsoXmlSerilizable<DTCCCANOEligibleBalanceSD1V11>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCANOEligibleBalanceSD1V11Document.DocumentNamespace;
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD49 CorporateActionGeneralInformationValue)
        {
    ...
    public static DTCCCANOEligibleBalanceSD1V11 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCANOEligibleBalanceSD1V11Document : IOuterDocument<DTCCCANOEligibleBalanceSD1V11>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCANOEligibleBalanceSD1V11.XmlTag)]
    public required DTCCCANOEligibleBalanceSD1V11 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCANOEligibleBalanceSD1V11.XmlTag);
