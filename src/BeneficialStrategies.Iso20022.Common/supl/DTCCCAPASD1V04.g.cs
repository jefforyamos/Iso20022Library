...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAPASD1V04>;
...
public partial record DTCCCAPASD1V04 : IOuterRecord<DTCCCAPASD1V04,DTCCCAPASD1V04Document>
    ,IIsoXmlSerilizable<DTCCCAPASD1V04>, ISerializeInsideARootElement
{
    ...
    public static DTCCCAPASD1V04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAPASD1V04Document : IOuterDocument<DTCCCAPASD1V04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAPASD1V04.XmlTag)]
    public required DTCCCAPASD1V04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAPASD1V04.XmlTag);
