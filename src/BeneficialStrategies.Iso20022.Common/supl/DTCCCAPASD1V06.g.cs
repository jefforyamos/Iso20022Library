...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAPASD1V06>;
...
public partial record DTCCCAPASD1V06 : IOuterRecord<DTCCCAPASD1V06,DTCCCAPASD1V06Document>
    ,IIsoXmlSerilizable<DTCCCAPASD1V06>, ISerializeInsideARootElement
{
    ...
    public static DTCCCAPASD1V06 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAPASD1V06Document : IOuterDocument<DTCCCAPASD1V06>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAPASD1V06.XmlTag)]
    public required DTCCCAPASD1V06 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAPASD1V06.XmlTag);
