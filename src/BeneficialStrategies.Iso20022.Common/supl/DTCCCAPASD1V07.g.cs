...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAPASD1V07>;
...
public partial record DTCCCAPASD1V07 : IOuterRecord<DTCCCAPASD1V07,DTCCCAPASD1V07Document>
    ,IIsoXmlSerilizable<DTCCCAPASD1V07>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCAPASD1V07Document.DocumentNamespace;
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD39 CorporateActionGeneralInformationValue)
        {
    ...
    public static DTCCCAPASD1V07 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAPASD1V07Document : IOuterDocument<DTCCCAPASD1V07>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAPASD1V07.XmlTag)]
    public required DTCCCAPASD1V07 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAPASD1V07.XmlTag);
