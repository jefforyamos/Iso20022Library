...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAPASD1V09>;
...
public partial record DTCCCAPASD1V09 : IOuterRecord<DTCCCAPASD1V09,DTCCCAPASD1V09Document>
    ,IIsoXmlSerilizable<DTCCCAPASD1V09>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCAPASD1V09Document.DocumentNamespace;
    ...
    public static DTCCCAPASD1V09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAPASD1V09Document : IOuterDocument<DTCCCAPASD1V09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAPASD1V09.XmlTag)]
    public required DTCCCAPASD1V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAPASD1V09.XmlTag);
