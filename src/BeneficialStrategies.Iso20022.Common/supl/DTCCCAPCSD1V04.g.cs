...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAPCSD1V04>;
...
public partial record DTCCCAPCSD1V04 : IOuterRecord<DTCCCAPCSD1V04,DTCCCAPCSD1V04Document>
    ,IIsoXmlSerilizable<DTCCCAPCSD1V04>, ISerializeInsideARootElement
{
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD54 CorporateActionGeneralInformationValue)
        {
    ...
    public static DTCCCAPCSD1V04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAPCSD1V04Document : IOuterDocument<DTCCCAPCSD1V04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAPCSD1V04.XmlTag)]
    public required DTCCCAPCSD1V04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAPCSD1V04.XmlTag);
