...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAPSSD1V02>;
...
public partial record DTCCCAPSSD1V02 : IOuterRecord<DTCCCAPSSD1V02,DTCCCAPSSD1V02Document>
    ,IIsoXmlSerilizable<DTCCCAPSSD1V02>, ISerializeInsideARootElement
{
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD16 CorporateActionGeneralInformationValue)
        {
    ...
    public static DTCCCAPSSD1V02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAPSSD1V02Document : IOuterDocument<DTCCCAPSSD1V02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAPSSD1V02.XmlTag)]
    public required DTCCCAPSSD1V02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAPSSD1V02.XmlTag);
