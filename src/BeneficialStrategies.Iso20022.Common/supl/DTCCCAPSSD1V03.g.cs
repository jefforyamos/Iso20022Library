...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAPSSD1V03>;
...
public partial record DTCCCAPSSD1V03 : IOuterRecord<DTCCCAPSSD1V03,DTCCCAPSSD1V03Document>
    ,IIsoXmlSerilizable<DTCCCAPSSD1V03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCAPSSD1V03Document.DocumentNamespace;
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD17 CorporateActionGeneralInformationValue)
        {
    ...
    public static DTCCCAPSSD1V03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAPSSD1V03Document : IOuterDocument<DTCCCAPSSD1V03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAPSSD1V03.XmlTag)]
    public required DTCCCAPSSD1V03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAPSSD1V03.XmlTag);
