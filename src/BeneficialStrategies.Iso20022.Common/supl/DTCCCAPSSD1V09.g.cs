...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCAPSSD1V09>;
...
public partial record DTCCCAPSSD1V09 : IOuterRecord<DTCCCAPSSD1V09,DTCCCAPSSD1V09Document>
    ,IIsoXmlSerilizable<DTCCCAPSSD1V09>, ISerializeInsideARootElement
{
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD51 CorporateActionGeneralInformationValue)
        {
    ...
    public static DTCCCAPSSD1V09 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCAPSSD1V09Document : IOuterDocument<DTCCCAPSSD1V09>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCAPSSD1V09.XmlTag)]
    public required DTCCCAPSSD1V09 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCAPSSD1V09.XmlTag);
