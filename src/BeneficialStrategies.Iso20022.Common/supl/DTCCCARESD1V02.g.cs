...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCARESD1V02>;
...
public partial record DTCCCARESD1V02 : IOuterRecord<DTCCCARESD1V02,DTCCCARESD1V02Document>
    ,IIsoXmlSerilizable<DTCCCARESD1V02>, ISerializeInsideARootElement
{
    ...
    public static DTCCCARESD1V02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCARESD1V02Document : IOuterDocument<DTCCCARESD1V02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCARESD1V02.XmlTag)]
    public required DTCCCARESD1V02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCARESD1V02.XmlTag);
