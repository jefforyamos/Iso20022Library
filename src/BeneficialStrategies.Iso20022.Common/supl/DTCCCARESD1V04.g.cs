...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCARESD1V04>;
...
public partial record DTCCCARESD1V04 : IOuterRecord<DTCCCARESD1V04,DTCCCARESD1V04Document>
    ,IIsoXmlSerilizable<DTCCCARESD1V04>, ISerializeInsideARootElement
{
    ...
    {
        if (CorporateActionGeneralInformation is CorporateActionGeneralInformationSD53 CorporateActionGeneralInformationValue)
        {
    ...
    public static DTCCCARESD1V04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCARESD1V04Document : IOuterDocument<DTCCCARESD1V04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCARESD1V04.XmlTag)]
    public required DTCCCARESD1V04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCARESD1V04.XmlTag);
