...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCASTSD1V01>;
...
public partial record DTCCCASTSD1V01 : IOuterRecord<DTCCCASTSD1V01,DTCCCASTSD1V01Document>
    ,IIsoXmlSerilizable<DTCCCASTSD1V01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCASTSD1V01Document.DocumentNamespace;
    ...
    {
        if (EventBalanceDetails is CorporateActionBalanceSD2 EventBalanceDetailsValue)
        {
            writer.WriteStartElement(null, "EvtBalDtls", xmlNamespace );
            EventBalanceDetailsValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TotalInstructedBalanceOptionBalanceDetails is CorporateActionInstructedBalanceOptionBalanceDetailsSD1 TotalInstructedBalanceOptionBalanceDetailsValue)
        {
        ...
        if (TotalInstructedBalanceOptionInstructionDetails is CorporateActionInstructedBalanceOptionInstructionDetailsSD1 TotalInstructedBalanceOptionInstructionDetailsValue)
        {
        ...
        if (TotalInstructedBalanceOptionProtectInstructionDetails is CorporateActionInstructedBalanceOptionProtectInstructionDetailsSD1 TotalInstructedBalanceOptionProtectInstructionDetailsValue)
        {
    ...
    public static DTCCCASTSD1V01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCASTSD1V01Document : IOuterDocument<DTCCCASTSD1V01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCASTSD1V01.XmlTag)]
    public required DTCCCASTSD1V01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCASTSD1V01.XmlTag);
