...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCASTSD1V02>;
...
public partial record DTCCCASTSD1V02 : IOuterRecord<DTCCCASTSD1V02,DTCCCASTSD1V02Document>
    ,IIsoXmlSerilizable<DTCCCASTSD1V02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCASTSD1V02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TotalInstructedBalanceOptionBalanceDetails is CorporateActionInstructedBalanceOptionBalanceDetailsSD2 TotalInstructedBalanceOptionBalanceDetailsValue)
        {
        ...
        if (TotalInstructedBalanceOptionInstructionDetails is CorporateActionInstructedBalanceOptionInstructionDetailsSD2 TotalInstructedBalanceOptionInstructionDetailsValue)
        {
        ...
        if (TotalInstructedBalanceOptionProtectInstructionDetails is CorporateActionInstructedBalanceOptionProtectInstructionDetailsSD2 TotalInstructedBalanceOptionProtectInstructionDetailsValue)
        {
    ...
    public static DTCCCASTSD1V02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCASTSD1V02Document : IOuterDocument<DTCCCASTSD1V02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCASTSD1V02.XmlTag)]
    public required DTCCCASTSD1V02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCASTSD1V02.XmlTag);
