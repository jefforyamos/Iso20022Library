...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.DTCCCASTSD1V03>;
...
public partial record DTCCCASTSD1V03 : IOuterRecord<DTCCCASTSD1V03,DTCCCASTSD1V03Document>
    ,IIsoXmlSerilizable<DTCCCASTSD1V03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => DTCCCASTSD1V03Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TotalInstructedBalanceOptionProtectInstructionDetails is CorporateActionInstructedBalanceOptionProtectInstructionSD3 TotalInstructedBalanceOptionProtectInstructionDetailsValue)
        {
    ...
    public static DTCCCASTSD1V03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record DTCCCASTSD1V03Document : IOuterDocument<DTCCCASTSD1V03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=DTCCCASTSD1V03.XmlTag)]
    public required DTCCCASTSD1V03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(DTCCCASTSD1V03.XmlTag);
