...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.supl.TSEJASDECCorporateActionNotificationSubsetSD1V02>;
...
public partial record TSEJASDECCorporateActionNotificationSubsetSD1V02 : IOuterRecord<TSEJASDECCorporateActionNotificationSubsetSD1V02,TSEJASDECCorporateActionNotificationSubsetSD1V02Document>
    ,IIsoXmlSerilizable<TSEJASDECCorporateActionNotificationSubsetSD1V02>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => TSEJASDECCorporateActionNotificationSubsetSD1V02Document.DocumentNamespace;
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        if (TaxationConditions is UpdatedAdditionalInformation5SD1 TaxationConditionsValue)
        {
    ...
    public static TSEJASDECCorporateActionNotificationSubsetSD1V02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TSEJASDECCorporateActionNotificationSubsetSD1V02Document : IOuterDocument<TSEJASDECCorporateActionNotificationSubsetSD1V02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TSEJASDECCorporateActionNotificationSubsetSD1V02.XmlTag)]
    public required TSEJASDECCorporateActionNotificationSubsetSD1V02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TSEJASDECCorporateActionNotificationSubsetSD1V02.XmlTag);
