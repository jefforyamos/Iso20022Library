...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsin.InvoiceAssignmentNotificationV01>;
...
public partial record InvoiceAssignmentNotificationV01 : IOuterRecord<InvoiceAssignmentNotificationV01,InvoiceAssignmentNotificationV01Document>
    ,IIsoXmlSerilizable<InvoiceAssignmentNotificationV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("InvcAssgnmtNtfctn");
    ...
    public static InvoiceAssignmentNotificationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record InvoiceAssignmentNotificationV01Document : IOuterDocument<InvoiceAssignmentNotificationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=InvoiceAssignmentNotificationV01.XmlTag)]
    public required InvoiceAssignmentNotificationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(InvoiceAssignmentNotificationV01.XmlTag);
