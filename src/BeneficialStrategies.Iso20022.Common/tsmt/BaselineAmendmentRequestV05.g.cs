...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsmt.BaselineAmendmentRequestV05>;
...
public partial record BaselineAmendmentRequestV05 : IOuterRecord<BaselineAmendmentRequestV05,BaselineAmendmentRequestV05Document>
    ,IIsoXmlSerilizable<BaselineAmendmentRequestV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BaselineAmendmentRequestV05Document.DocumentNamespace;
    ...
    public static BaselineAmendmentRequestV05 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record BaselineAmendmentRequestV05Document : IOuterDocument<BaselineAmendmentRequestV05>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=BaselineAmendmentRequestV05.XmlTag)]
    public required BaselineAmendmentRequestV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BaselineAmendmentRequestV05.XmlTag);
