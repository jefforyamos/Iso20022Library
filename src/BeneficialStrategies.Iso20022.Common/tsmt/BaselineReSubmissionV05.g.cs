...
//
// Generated by MainMessageGenerator for BaselineReSubmissionV05.  ISO2002 ID# _XtCPcQgGEeSeS5xdjFfOTw.
//
...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsmt.BaselineReSubmissionV05>;
...
public partial record BaselineReSubmissionV05 : IOuterRecord<BaselineReSubmissionV05,BaselineReSubmissionV05Document>
    ,IIsoXmlSerilizable<BaselineReSubmissionV05>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => BaselineReSubmissionV05Document.DocumentNamespace;
    ...
    /// <summary>
    /// Using the state of this record, returns a populated <seealso cref="BaselineReSubmissionV05Document"/>, usually for the purpose of ISO20022 standard serialization.
    /// </summary>
    public BaselineReSubmissionV05Document ToDocument()
    {
        return new BaselineReSubmissionV05Document { Message = this };
    }
    ...
    public static BaselineReSubmissionV05 Deserialize(XElement element)
    {
...
/// For a more complete description of the business meaning of the message, see the underlying <seealso cref="BaselineReSubmissionV05"/>.
/// </summary>
[Serializable]
public partial record BaselineReSubmissionV05Document : IOuterDocument<BaselineReSubmissionV05>, IXmlSerializable
{
    ...
    /// <summary>
    /// The instance of <seealso cref="BaselineReSubmissionV05"/> is required.
    /// </summary>
    [DataMember(Name=BaselineReSubmissionV05.XmlTag)]
    public required BaselineReSubmissionV05 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(BaselineReSubmissionV05.XmlTag);
