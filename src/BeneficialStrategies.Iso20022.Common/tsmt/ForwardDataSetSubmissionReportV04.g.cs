...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsmt.ForwardDataSetSubmissionReportV04>;
...
public partial record ForwardDataSetSubmissionReportV04 : IOuterRecord<ForwardDataSetSubmissionReportV04,ForwardDataSetSubmissionReportV04Document>
    ,IIsoXmlSerilizable<ForwardDataSetSubmissionReportV04>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (CommercialDataSet is CommercialDataSet4 CommercialDataSetValue)
        {
            writer.WriteStartElement(null, "ComrclDataSet", xmlNamespace );
            CommercialDataSetValue.Serialize(writer, xmlNamespace);
            writer.WriteEndElement();
        }
        if (TransportDataSet is TransportDataSet4 TransportDataSetValue)
        {
        ...
        if (OtherCertificateDataSet is OtherCertificateDataSet1 OtherCertificateDataSetValue)
        {
    ...
    public static ForwardDataSetSubmissionReportV04 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record ForwardDataSetSubmissionReportV04Document : IOuterDocument<ForwardDataSetSubmissionReportV04>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=ForwardDataSetSubmissionReportV04.XmlTag)]
    public required ForwardDataSetSubmissionReportV04 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(ForwardDataSetSubmissionReportV04.XmlTag);
