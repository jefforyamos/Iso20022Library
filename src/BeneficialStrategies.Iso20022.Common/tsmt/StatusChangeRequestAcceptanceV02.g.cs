...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsmt.StatusChangeRequestAcceptanceV02>;
...
public partial record StatusChangeRequestAcceptanceV02 : IOuterRecord<StatusChangeRequestAcceptanceV02,StatusChangeRequestAcceptanceV02Document>
    ,IIsoXmlSerilizable<StatusChangeRequestAcceptanceV02>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("StsChngReqAccptnc");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteStartElement(null, "AccptdSts", xmlNamespace );
        AcceptedStatus.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
    }
    public static StatusChangeRequestAcceptanceV02 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record StatusChangeRequestAcceptanceV02Document : IOuterDocument<StatusChangeRequestAcceptanceV02>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=StatusChangeRequestAcceptanceV02.XmlTag)]
    public required StatusChangeRequestAcceptanceV02 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(StatusChangeRequestAcceptanceV02.XmlTag);
