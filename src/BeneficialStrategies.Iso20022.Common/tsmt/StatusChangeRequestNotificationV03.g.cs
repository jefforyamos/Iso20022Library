...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsmt.StatusChangeRequestNotificationV03>;
...
public partial record StatusChangeRequestNotificationV03 : IOuterRecord<StatusChangeRequestNotificationV03,StatusChangeRequestNotificationV03Document>
    ,IIsoXmlSerilizable<StatusChangeRequestNotificationV03>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("StsChngReqNtfctn");
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        writer.WriteStartElement(null, "PropsdStsChng", xmlNamespace );
        ProposedStatusChange.Serialize(writer, xmlNamespace);
        writer.WriteEndElement();
    ...
    public static StatusChangeRequestNotificationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record StatusChangeRequestNotificationV03Document : IOuterDocument<StatusChangeRequestNotificationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=StatusChangeRequestNotificationV03.XmlTag)]
    public required StatusChangeRequestNotificationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(StatusChangeRequestNotificationV03.XmlTag);
