...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsmt.StatusExtensionNotificationV03>;
...
public partial record StatusExtensionNotificationV03 : IOuterRecord<StatusExtensionNotificationV03,StatusExtensionNotificationV03Document>
    ,IIsoXmlSerilizable<StatusExtensionNotificationV03>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("StsXtnsnNtfctn");
    ...
    public static StatusExtensionNotificationV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record StatusExtensionNotificationV03Document : IOuterDocument<StatusExtensionNotificationV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=StatusExtensionNotificationV03.XmlTag)]
    public required StatusExtensionNotificationV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(StatusExtensionNotificationV03.XmlTag);
