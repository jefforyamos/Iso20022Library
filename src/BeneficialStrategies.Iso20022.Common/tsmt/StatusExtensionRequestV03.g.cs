...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsmt.StatusExtensionRequestV03>;
...
public partial record StatusExtensionRequestV03 : IOuterRecord<StatusExtensionRequestV03,StatusExtensionRequestV03Document>
    ,IIsoXmlSerilizable<StatusExtensionRequestV03>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => StatusExtensionRequestV03Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("StsXtnsnReq");
    ...
    public static StatusExtensionRequestV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record StatusExtensionRequestV03Document : IOuterDocument<StatusExtensionRequestV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=StatusExtensionRequestV03.XmlTag)]
    public required StatusExtensionRequestV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(StatusExtensionRequestV03.XmlTag);
