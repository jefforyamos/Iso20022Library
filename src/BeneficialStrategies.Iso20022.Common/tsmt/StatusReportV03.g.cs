...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsmt.StatusReportV03>;
...
public partial record StatusReportV03 : IOuterRecord<StatusReportV03,StatusReportV03Document>
    ,IIsoXmlSerilizable<StatusReportV03>, ISerializeInsideARootElement
{
    ...
    public void Serialize(XmlWriter writer, string xmlNamespace)
    {
        ...
        writer.WriteEndElement();
        if (ReportedItems is StatusReportItems2 ReportedItemsValue)
        {
    ...
    public static StatusReportV03 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record StatusReportV03Document : IOuterDocument<StatusReportV03>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=StatusReportV03.XmlTag)]
    public required StatusReportV03 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(StatusReportV03.XmlTag);
