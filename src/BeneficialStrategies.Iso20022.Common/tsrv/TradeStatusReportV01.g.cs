...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsrv.TradeStatusReportV01>;
...
public partial record TradeStatusReportV01 : IOuterRecord<TradeStatusReportV01,TradeStatusReportV01Document>
    ,IIsoXmlSerilizable<TradeStatusReportV01>, ISerializeInsideARootElement
{
    ...
    public static XName RootElement => Helper.CreateXName("TradStsRpt");
    ...
    {
        writer.WriteStartElement(null, "TradStsAdvcDtls", xmlNamespace );
        TradeStatusAdviceDetails.Serialize(writer, xmlNamespace);
    ...
    public static TradeStatusReportV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record TradeStatusReportV01Document : IOuterDocument<TradeStatusReportV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=TradeStatusReportV01.XmlTag)]
    public required TradeStatusReportV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(TradeStatusReportV01.XmlTag);
