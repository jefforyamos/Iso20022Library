...
using Helper = BeneficialStrategies.Iso20022.Framework.IsoXmlSerializationHelper<BeneficialStrategies.Iso20022.tsrv.UndertakingNonExtensionNotificationV01>;
...
public partial record UndertakingNonExtensionNotificationV01 : IOuterRecord<UndertakingNonExtensionNotificationV01,UndertakingNonExtensionNotificationV01Document>
    ,IIsoXmlSerilizable<UndertakingNonExtensionNotificationV01>, ISerializeInsideARootElement
{
    ...
    /// </summary>
    public static string IsoXmlNamspace => UndertakingNonExtensionNotificationV01Document.DocumentNamespace;
    ...
    public static XName RootElement => Helper.CreateXName("UdrtkgNonXtnsnNtfctn");
    ...
    {
        writer.WriteStartElement(null, "UdrtkgNonXtnsnNtfctnDtls", xmlNamespace );
        UndertakingNonExtensionNotificationDetails.Serialize(writer, xmlNamespace);
    ...
    public static UndertakingNonExtensionNotificationV01 Deserialize(XElement element)
    {
...
/// </summary>
[Serializable]
public partial record UndertakingNonExtensionNotificationV01Document : IOuterDocument<UndertakingNonExtensionNotificationV01>, IXmlSerializable
{
    ...
    /// </summary>
    [DataMember(Name=UndertakingNonExtensionNotificationV01.XmlTag)]
    public required UndertakingNonExtensionNotificationV01 Message { get; init; }
    public void WriteXml(XmlWriter writer)
    {
        writer.WriteStartElement(null, DocumentElementName, DocumentNamespace );
        writer.WriteStartElement(UndertakingNonExtensionNotificationV01.XmlTag);
