...
//  <topLevelCatalogueEntry xsi:type="iso20022:BusinessProcess" 
public class BusinessProcess : TopLevelCatalogueElement
{
    public IEnumerable<BusinessRole> BusinessRoles => ElementValue
        .Elements(IsoXmlElements.Default.BusinessRole )
        .Select( e => new BusinessRole { ElementValue = e});
